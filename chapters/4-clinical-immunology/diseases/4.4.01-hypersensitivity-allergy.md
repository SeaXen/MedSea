...
## 2. 2. 🧠 Core Concept: Gell & Coombs Classification
...
## 3. 3. ️⃣ Type I Hypersensitivity (IgE-Mediated / Immediate)
...
### 2. Emergency Algorithm (RCUK/WAO/RCUK 2021)
```mermaid
flowchart TD
    A[Recognise Anaphylaxis] --> B[Call for Help / Code Blue]
    B --> C[**ADRENALINE IM 0.5mg (1:1000) Anterolateral Thigh**]
    C --> D{Response?}
    D -->|No improvement in 5 min| E[**Repeat Adrenaline IM q5min**
Max 3 doses]
    D -->|Improving| F[Position: Supine + Legs Raised
(If Breathless: Semi-recumbent)]
    F --> G[**O2 High Flow** (15L/min)]
    F --> H[**IV Fluid Challenge**
...
ECG, SpO2, BP, RR, Peak Flow]
    L --> M[Observe 6-12h
(Biphasic Reaction Risk 20%)]
```
...
## 5. 5. ️⃣ Bronchial Asthma

### 1. Phenotypes & Endotypes
...
### 2. BTS/SIGN 2024 Stepwise Management (Adults)
...
### 3. Severe Asthma Biologics (GINA 2024 / NICE)
...
### 4. Acute Severe Asthma (Life-Threatening)
| Feature | Threshold |
|---------|-----------|
...
## 6. 6. ️⃣ Allergic Rhinitis & Conjunctivitis (ARIA Guidelines)
...
### 3. Component-Resolved Diagnostics (CRD) — Peanut Example
...
## 8. 8. ️⃣ Drug Hypersensitivity

### 1. Classification (Pichler)
...
### 6. HLA-Drug Hypersensitivity Associations (High-Yield)
...
- Q: What is the definition of Clinical Immunology?
  A: Parent Topic: Clinical Immunology MOC → Chapter 4 Hierarchy
- Q: What is the epidemiology of Clinical Immunology?
  A: 1-20% (Higher if delayed adrenaline)
- Q: What is Timing of Clinical Immunology?
  A: 1-72h after initial resolution (Peak 3-10h)
- Q: What causes Clinical Immunology?
  A: Delayed adrenaline, Severe initial reaction, Inadequate initial dose, No observation
- Q: How is Clinical Immunology managed?
  A: Observe 6-12h post-resolution; Adrenaline available
- Q: What is History of Clinical Immunology?
  A: Cornerstone — Timing, Reproducibility, Co-factors (Exercise, Alcohol, NSAIDs)
- Q: What is SPT of Clinical Immunology?
  A: Sensitivity 90%, PPV ~50% (Wheal ≥3mm)
- Q: What is sIgE of Clinical Immunology?
  A: Sensitivity 90%, Component-resolved useful
- Q: What is Component-Resolved Diagnostics (CRD) of Clinical Immunology?
  A: Identifies specific proteins (Ara h 2 for Peanut, Ara h 8 for Cross-reactivity)
- Q: What is the investigation of choice for Clinical Immunology?
  A: Functional, High specificity, Research/Refractory
- Q: What is Oral Food Challenge (OFC) of Clinical Immunology?
  A: Gold Standard — Double-blind, Placebo-controlled (DBPCFC)
- Q: What is Principle of Clinical Immunology?
  A: Allergen → Mast cell degranulation → Wheal/Flare
- Q: What is Positive of Clinical Immunology?
  A: Wheal ≥3mm (vs Negative Control)
- Q: What is Controls of Clinical Immunology?
  A: Positive: Histamine 10mg/mL; Negative: Saline/Glycerol
- Q: What is Clinical Immunology indicated for?
  A: Severe anaphylaxis risk, Severe uncontrolled asthma, Antihistamines (Stop 48-72h), Tricyclics, Severe Dermographism
- Q: What is Sensitivity/Specificity of Clinical Immunology?
  A: 90%/90% (Aeroallergens), Food: Sens 90%, PPV 50%
- Q: What is Principle of Clinical Immunology?
  A: Allergen injected intradermally (0.02-0.05 mL) → Wheal/Flare
- Q: What is Clinical Immunology indicated for?
  A: Drug allergy (Penicillin, Venom), Aeroallergens when SPT negative but high suspicion
- Q: What is Positive of Clinical Immunology?
  A: Wheal ≥5mm (erythema) at 15-20 min
- Q: What is Sensitivity of Clinical Immunology?
  A: Higher than SPT (esp. drug/venom), but ↓ specificity
- Q: What is Risk of Clinical Immunology?
  A: Higher anaphylaxis risk than SPT — Resuscitation equipment required
- Q: What is Concentrations of Clinical Immunology?
  A: 1:100 to 1:1000 of SPT concentration
- Q: What is Principle of Clinical Immunology?
  A: Allergen → Basophil CD63/CD203c upregulation (Flow Cytometry)
- Q: What is Sensitivity/Specificity of Clinical Immunology?
  A: 90-95% / 90-95% (Superior to sIgE for some foods/drugs)
- Q: What is Clinical Immunology indicated for?
  A: Food/Drug Allergy (sIgE/SPT discordant), Venom, CRD Equivocal
- Q: What is Allergens of Clinical Immunology?
  A: Baseline Series (Fragrance, Nickel, Cobalt, Potassium Dichromate, Balsam of Peru, Parabens, Formaldehyde, etc.)
- Q: What is Reading of Clinical Immunology?
  A: Day 2 (48h) + Day 3-4 (72-96h)
- Q: What is Grading (ICDRG) of Clinical Immunology?
  A: + (Erythema), ++ (Papules/Infiltration), +++ (Vesicles)
- Q: What is Irritant vs Allergic of Clinical Immunology?
  A: Irritant: Fades by Day 3; Allergic: Persists/Increases
- Q: What is the epidemiology of Clinical Immunology?
  A: 1-20% (Higher if delayed adrenaline)
- Q: What is Timing of Clinical Immunology?
  A: 1-72h after initial resolution (Peak 3-10h)
...
- Q: How is Clinical Immunology classified?
  A: Type I: IgE, Mast cells, Anaphylaxis/Asthma; Type II: Antibody-mediated (AIHA, ITP); Type III: Immune complexes (SLE, Serum Sickness); Type IV: T-cell (Contact, TB, Drug); Type V: Stimulatory (Graves)
- Q: What is Anaphylaxis of Clinical Immunology?
  A: Adrenaline IM 0.5mg (1:1000) Anterolateral Thigh — Repeat q5min; Obs 6-12h (Biphasic); Tryptase 1-2h peak
- Q: What is Asthma of Clinical Immunology?
  A: BTS/SIGN Steps 1-6; SMART/MART (Buda/Form, Beclo/Form); Biologics: Anti-IgE, Anti-IL5/5R, Anti-IL4Rα, Anti-TSLP
- Q: What is Allergic Rhinitis of Clinical Immunology?
  A: ARIA: Intermittent/Persistent × Mild/Mod-Severe → INCS ± H1 ± LTRA; AIT (SCIT/SLIT) 3-5y
- Q: What is Food Allergy of Clinical Immunology?
  A: IgE (Minutes-2h) vs Non-IgE (Hours-Days); CRD (Ara h 1/2/3 = Risk, Ara h 8/9 = Cross-reactivity); OFC = Gold Standard
- Q: What is Drug Hypersensitivity of Clinical Immunology?
  A: SJS/TEN/DRESS/AGEP — SCORTEN (TEN); Stop Drug → ICU/Supportive/IVIG/PLEX; Desensitisation (Penicillin, Aspirin, Carboplatin)
- Q: What is the investigation of choice for Clinical Immunology?
  A: SPT (Wheal ≥3mm); sIgE (ImmunoCAP); CRD (Ara h 1/2/3 = Risk, 8/9 = Cross-reactivity); BAT (CD63/CD203c); Patch (Type IV); OFC = Gold Standard
...
1. A patient with suspected Clinical Immunology presents with: A[Hypersensitivity Reactions] --> B[Type I: IgE-Mediated (Immediate)]; A --> C[Type II: Antibody-Mediated (Cytotoxic)]; A --> D[Type III: Immune Complex-Mediated]. What is the most likely diagnosis?
