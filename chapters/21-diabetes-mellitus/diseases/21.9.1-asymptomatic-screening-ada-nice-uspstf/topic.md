---
tags: [medicine, diabetes, davidson, t2dm-screening, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - T2DM screening: ADA age >=35, BMI>=25+1 risk factor; NICE risk assessment then HbA1c/FPG; USPSTF 35-70 BMI>=25"
see_also: ["Symptomatic presentation", "Classification and Diagnosis of Diabetes Mellitus", "Prediabetic states"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
mindmap
  root((T2DM Asymptomatic Screening))
    ADA
      Age>=35 or BMI>=25+1 RF
      HbA1c/FPG/OGTT
      3-yearly if normal
    NICE
      Risk score first
    ...
    Confirmatory
      ...
      Symptomatic: 1 test
    Special
      Children: BMI 85th% + 2 RF
      HIV: annual on ART
      Antipsychotics: baseline, 12wk, annual
```
