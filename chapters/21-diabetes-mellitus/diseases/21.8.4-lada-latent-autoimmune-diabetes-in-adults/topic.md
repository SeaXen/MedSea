---
tags: [medicine, diabetes, davidson, lada, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - LADA: adult-onset autoimmune diabetes; GAD65+; slow progression; initial non-insulin response"
see_also: ["Classic symptomatic presentation", "Diabetic ketoacidosis (DKA)", "Autoimmune beta-cell destruction", "Genetic susceptibility (HLA, INS, PTPN22)"]
created: 2026-06-13
modified: 2026-06-13
---
...
mindmap
  root((LADA))
    ...
    vs T2DM
      ...
      C-peptide low-normal
    Management
      Initial: Met/DPP-4i/GLP-1
      Avoid SU
      Insulin when C-peptide low
```
