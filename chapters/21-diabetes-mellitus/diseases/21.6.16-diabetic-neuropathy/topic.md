---
tags: [medicine, diabetes, davidson, diabetic-neuropathy, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Diabetic neuropathy: DSPN (stocking-glove, 50% T2DM); autonomic (CV: orthostatic hypotension, silent MI; GI: gastroparesis; GU: ED); screening (10g monofilament, vibration, ANNS); pain management (duloxetine, pregabalin, gabapentin, amitriptyline)"
see_also: ["Neuropathy screening (10g monofilament, vibration, ANNS)", "Neuropathic pain management", "Diabetic foot disease", "Autonomic neuropathy (cardiovascular, GI, genitourinary)"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
flowchart TD
    A[Diabetic Neuropathy Suspected] --> B{Type?}
    B -->|DSPN| C[Screen: 10g monofilament + vibration + ANNS]
    B -->|Autonomic CV| D[Orthostatic BP, HRV, resting HR]
    B -->|Autonomic GI| E[Gastric emptying study]
    B -->|Autonomic GU| F[Urodynamics, IIEF]
    B -->|Mononeuropathy| G[NCS - confirm localisation]
    C --> H{LOPS?}
    H -->|Yes| I[Refer podiatry/foot clinic]
    H -->|No| J[Annual rescreen]
    C --> K{Painful?}
    K -->|Yes| L[1st line: Duloxetine/Pregabalin/Gabapentin/Amitriptyline]
    K -->|No| M[Reassure + foot care education]
```
...
```mermaid
mindmap
  root((Diabetic Neuropathy))
    DSPN
      Stocking-glove
      Absent ankle reflex
      Painful 10-20%
    Autonomic
      CV: Orthostatic HTN, silent MI, HRV
      GI: Gastroparesis
      GU: ED, bladder
      Sudomotor
    Mononeuropathy
