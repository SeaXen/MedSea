---
tags: [medicine, diabetes, davidson, classification, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Cornerstone diagnostic criteria used in every diabetes question; distinguishes diabetes types, guides management"
see_also: ["Type 1 diabetes mellitus", "Type 2 diabetes mellitus", "Impaired fasting glucose (IFG)", "Impaired glucose tolerance (IGT)"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
mindmap
  root((Fasting Plasma Glucose))
    Definition
      FPG ≥7.0 mmol/L = DM
      IFG 6.1–6.9
    Classification
      Normal / Prediabetes / DM
      Aetiology: T1/T2/LADA/MODY/Secondary/GDM
    Clinical
      Asymptomatic 50%
      Osmotic symptoms
      DKA/HHS at presentation
    Diagnosis
      FPG / HbA1c / OGTT / Random+symptoms
      Confirmatory rule (2 tests if asymptomatic)
      Pre-analytical: fluoride tube, fast, process fast
    DDx
      Stress / Steroid / Type 3c / MODY / GDM
    Management
      Lifestyle + metformin (IFG)
      Type-specific Rx
      Screening
```
