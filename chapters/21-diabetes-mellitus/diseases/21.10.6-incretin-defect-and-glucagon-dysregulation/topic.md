...
```mermaid
mindmap
  root((Incretin Defect))
    Normal
      Oral > IV insulin
      50-70% augmentation
      GLP-1 + GIP
    T2DM
      Incretin effect 20-30%
      GIP action LOST
      GLP-1 secretion down
    Hormones
      GLP-1: L-cells, insulin, glucagon, gastric emptying
      GIP: K-cells, insulin, adipocyte lipid storage
    DPP-4
      Degrades both (t1/2 2 min)
    Therapeutics
      GLP-1 RA: replace
      DPP-4i: augment
      Tirzepatide: dual
