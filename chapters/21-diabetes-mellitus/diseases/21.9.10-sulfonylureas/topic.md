---
tags: [medicine, diabetes, davidson, sulfonylureas, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Sulfonylureas: 2nd/3rd line; hypoglycaemia risk (esp elderly/CKD), weight gain; CAROLINA trial vs linagliptin; gliclazide MR preferred in CKD"
see_also: ["Metformin", "DPP-4 inhibitors", "ADA/EASD 2023+ consensus algorithm", "Hypoglycaemia classification"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
flowchart TD
    A[Sulfonylurea Indicated] --> B{Agent Selection}
    B -->|1st choice| C[Gliclazide MR 30mg OD]
    B -->|Short-acting needed| D[Glipizide 2.5mg BD]
    B -->|Once daily alternative| E[Glimepiride 1mg OD - caution elderly/CKD]
    B -->|AVOID| F[Glibenclamide - prolonged hypo]
    C --> G[Titrate q2-4wk to max]
    D --> G
    E --> G
    G --> H{Recurrent hypo?}
    H -->|Yes| I[↓Dose or STOP; switch to DPP-4i/SGLT2i/GLP-1 RA]
    H -->|No| J[Continue + monitor HbA1c 6-monthly]
    G --> K{Starting insulin?}
    K -->|Yes| L[STOP SU; continue Met ± SGLT2i/GLP-1 RA]
```
...
mindmap
  root((Sulfonylureas))
    ...
    Renal
      ...
      Glipizide safe
      Glimepiride caution
      Glibenclamide CONTRAINDICATED
    With Insulin
      STOP SU
      Continue Met ± SGLT2i/GLP-1
```
