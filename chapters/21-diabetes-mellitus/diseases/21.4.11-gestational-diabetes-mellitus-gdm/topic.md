---
tags: [medicine, diabetes, davidson, gdm, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - GDM: IADPSG universal 75g OGTT 24-28wk (FBG>=5.1, 1h>=10.0, 2h>=8.5); NICE risk-based; targets FBG<5.3, 1h<7.8, 2h<6.4; management: diet -> metformin -> insulin; pre-existing DM: pre-conception HbA1c<48, folic acid 5mg; postpartum OGTT 6-13wk"
see_also: ["Pre-existing diabetes in pregnancy (type 1, type 2)", "GDM screening (IADPSG, NICE, ADA)", "Postpartum follow-up and future risk"]
created: 2026-06-13
modified: 2026-06-13
---
...
|----------|----------|----------------------------|-----------|
| **IADPSG / WHO 2013 / ADA** | **Universal** (all pregnant) | FBG >=5.1<br>1h >=10.0<br>2h >=8.5 | **>=1 abnormal value = GDM** |
...
```mermaid
mindmap
  root((Gestational Diabetes Mellitus))
    Diagnosis
      IADPSG: universal 75g OGTT
      FBG>=5.1, 1h>=10.0, 2h>=8.5
      NICE: risk-based
    Targets
      FBG <5.3
      1h <7.8
    ...
    Management
      Diet (MNT)
      Metformin 1st line oral
      Insulin (basal-bolus)
    Pre-existing DM
      Pre-conception HbA1c<48
      Folic 5mg OD
      Stop teratogens
    Postpartum
      OGTT 6-13wk
