---
tags: [medicine, diabetes, davidson, diabetic-kidney-disease, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - DKD: leading cause of ESRD; KDIGO staging (G1-5 × A1-3); ACEi/ARB max dose; SGLT2i 1st line (eGFR≥20); finerenone (eGFR≥25); GLP-1 RA; ACR/eGFR monitoring; proteinuria reduction targets"
see_also: ["Albuminuria categories (A1/A2/A3)", "GFR categories (G1-G5)", "SGLT2 inhibitors", "GLP-1 receptor agonists"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
mindmap
  root((Diabetic Kidney Disease))
    Diagnosis
      ACR ≥3 (2/3 in 3-6mo)
      DM 10y or retinopathy
    Staging (KDIGO)
      G1-5 (eGFR)
      A1-3 (ACR)
      Heat map
