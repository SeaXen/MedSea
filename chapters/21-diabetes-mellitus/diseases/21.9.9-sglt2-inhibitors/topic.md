---
tags: [medicine, diabetes, davidson, sgli2-inhibitors, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - SGLT2i are 1st-line for HF/CKD/ASCVD per ADA/EASD; unique CV/renal benefits; euglycaemic DKA risk"
see_also: ["CKD and HF guided therapy", "ADA/EASD 2023+ consensus algorithm", "Diabetic ketoacidosis (DKA)"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
flowchart TD
    A[SGLT2i Candidate] --> B{eGFR Check}
    B -->|≥45 T2DM| C[Start standard dose]
    B -->|≥20-25 HF/CKD| D[Start per HF/CKD indication]
    B -->|<threshold| E[Do NOT initiate]
    C --> F[Counsel sick-day rules: STOP if ill/fasting/surgery]
    D --> F
    F --> G[Monitor eGFR 2-4 weeks]
    G --> H{Unwell?}
    H -->|Yes| I[STOP SGLT2i, check ketones]
    I --> J{Ketones >3?}
    J -->|Yes| K[Euglycaemic DKA protocol]
    J -->|No| L[Restart when well]
```
...
```mermaid
mindmap
  root((SGLT2 Inhibitors))
    Mechanism
      SGLT2 inhibition
      Glucosuria 70-90g/day
    Agents
      Empagliflozin 10/25
      Dapagliflozin 10
