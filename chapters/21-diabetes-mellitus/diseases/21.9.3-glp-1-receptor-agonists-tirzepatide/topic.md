---
tags: [medicine, diabetes, davidson, tirzepatide, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Endocrinology and Diabetes
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Tirzepatide: dual GIP/GLP-1; superior weight/HbA1c vs semaglutide; SURPASS/SURMOUNT trials; CVOT ongoing"
see_also: ["GLP-1 receptor agonists", "ADA/EASD 2023+ consensus algorithm", "Obesity management"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
flowchart TD
    A[Tirzepatide Candidate] --> B{Contraindications?}
    B -->|MTC/MEN2/Pancreatitis| C[Contraindicated]
    B -->|Pregnancy| D[Contraindicated]
    B -->|None| E[Start 2.5mg weekly]
    E --> F[Titrate q4wk: 2.5->5->7.5->10->12.5->15mg]
    F --> G{GI intolerant?}
    G -->|Yes| H[Slow titration / anti-emetics / stay at tolerated dose]
    G -->|No| I[Continue to max tolerated dose]
    I --> J[Monitor HbA1c/weight 3-monthly]
```
...
mindmap
  root((Tirzepatide))
    Mechanism
      ...
      GIP: insulin synergy, adipocyte lipid storage
      GLP-1: insulin, glucagon, gastric emptying, satiety
    Doses
      2.5 -> 5 -> 7.5 -> 10 -> 12.5 -> 15 mg weekly
      Titrate q4wk
    Trials
      SURPASS-1: monotherapy
      SURPASS-2: beat semaglutide
      SURPASS-3/4: vs insulin
      SURPASS-5: + SGLT2i
      SURMOUNT: obesity 20% weight loss
    CVOT
      SURPASS-CVOT ongoing
      SURPASS-4: CV safety high risk
    Adverse
      GI nausea 20-30%
      Pancreatitis (rare)
      MTC/MEN2 contraindicated
    Contraindications
      MTC/MEN2
      Pancreatitis history
      Pregnancy
    Renal
      No dose adjust (all stages)
```
