---
tags: [hepatology, portal_hypertension, varices, overview, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Varices overview - anatomy, grading, natural history, complications - FCPS/MRCP portal hypertension"
see_also: ["Portal Hypertension and Complications/Screening endoscopy", "Portal Hypertension and Complications/Primary prophylaxis (NSBB vs EVL)", "Portal Hypertension and Complications/Secondary prophylaxis", "Portal Hypertension and Complications/Acute variceal bleeding management", "Portal Hypertension and Complications/Gastric varices (glue injection)"]
created: 2025-06-13
modified: 2025-06-13
---

# Varices: Overview, Grading, and Natural History
...
```mermaid
flowchart LR
    A[Portal Hypertension] --> B[Portosystemic Collateral Formation]
    B --> C[Gastro-oesophageal Varices]
    B --> D[Gastric Varices]
    B --> E[Rectal/Periumbilical/Other Collaterals]
    C --> F[Lower Oesophagus / Proximal Stomach]
    C --> G[Submucosal Venous Dilatation]
    G --> H[Risk of Rupture]
```
...
## Oesophageal Variceal Grading (Endoscopic)
...
## Acute Variceal Bleeding: Key Points
...
```mermaid
mindmap
  root((Oesophageal Varices))
    Anatomy
      Lower 1/3 oesophagus
      Left gastric vein supply
      Submucosal location
    Grading
      Grade 1: <5mm straight
      Grade 2: 5-10mm tortuous
      Grade 3: >10mm tortuous
    Red Signs
      Red Wale, Cherry Red, Hematocystic
      G1 + Red Signs = Prophylaxis
    Natural History
      Risk: G1 1-2%, G2 5-10%, G3 10-15%/yr
      Red signs ↑ risk 2-3x
      Child C ↑ risk 2-3x
    Screening (Baveno VII)
      LSM<20 + Plt>150 = No endo
      Decompensated = Always scope
    Prophylaxis
      G2/3: Always
      G1 + Red/Child C: NSBB
      G1 No Risk: Surveillance
    Acute Bleed
      Terlipressin + Ceftriaxone + EVL <12h
      TIPS if failed/Child B-C
```
