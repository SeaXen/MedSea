---
tags: [hepatology, chronic_liver_disease, cirrhosis, definition, classification, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Definition and classification of chronic liver disease and cirrhosis - compensated vs decompensated, Child-Pugh, MELD - FCPS/MRCP fundamental"
see_also: ["Chronic Liver Disease and Cirrhosis/Compensated vs decompensated cirrhosis", "Chronic Liver Disease and Cirrhosis/Child-Pugh and MELD scores", "Portal Hypertension and Complications/Ascites", "Portal Hypertension and Complications/Varices", "Liver Transplantation/Liver Transplantation"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart TD
    A[Cirrhosis Aetiology] --> B[Alcohol]
    A --> C[Viral: HBV, HCV]
    A --> D[Metabolic: NAFLD/NASH]
    A --> E[Autoimmune: AIH, PBC, PSC]
    A --> F[Genetic: Wilson, Haemochromatosis, Alpha-1 AT]
    A --> G[Drug-Induced]
    A --> H[Cardiac: Chronic CHF, Budd-Chiari]
    A --> I[Cryptogenic: No Identifiable Cause]
```
...
mindmap
  root((Chronic Liver Disease & Cirrhosis))
    Definitions
      CLD: >6 Months Injury
      Cirrhosis: Fibrosis + Nodules + Distortion
    Compensated vs Decompensated
      Compensated: No Ascites/Bleed/HE/Jaundice
      Decompensated: Any 1 of Above
      Events: Ascites, Bleed, HE, Jaundice
    Scoring
      Child-Pugh: Bil, Alb, INR, Ascites, HE (5-15)
      MELD: Bil, INR, Cr, Na (6-40)
      MELD-Na: Current Standard
    Classes
      Child A: 5-6 (Survival 100% 1yr)
      Child B: 7-9 (Survival 80% 1yr)
      Child C: 10-15 (Survival 45% 1yr)
    Transplant
      MELD >=15 = Referral
      Decompensated = Urgent
    Survival
      Compensated: 12+ Years
      Decompensated: 2-5 Years (No Tx)
```
...
- Q: What is the definition of Chronic Liver Disease and Cirrhosis?
  A: Diffuse Fibrosis + Nodules + Architectural Distortion
- Q: What is Compensated vs Decompensated of Chronic Liver Disease and Cirrhosis?
  A: Decompensated = Ascites/Bleed/HE/Jaundice
- Q: What is Child-Pugh of Chronic Liver Disease and Cirrhosis?
  A: 5 Parameters (Bil, Alb, INR, Ascites, HE); A:5-6, B:7-9, C:10-15
- Q: What is MELD of Chronic Liver Disease and Cirrhosis?
  A: Bil, INR, Cr (+ Na for MELD-Na); Range 6-40
- Q: What is Transplant Threshold of Chronic Liver Disease and Cirrhosis?
  A: MELD ≥15 (or Child B/C with Complications)
- Q: What is 1-Year Survival of Chronic Liver Disease and Cirrhosis?
  A: Child A: 100%, B: 80%, C: 45%
- Q: What is Decompensation Events of Chronic Liver Disease and Cirrhosis?
  A: Ascites, Variceal Bleed, HE, Jaundice
- Q: What is HCC Surveillance of Chronic Liver Disease and Cirrhosis?
  A: Cirrhosis: 6m US ± AFP (All Aetiologies)

## MCQs (1 generated)

1. **Which of the following best describes Chronic Liver Disease and Cirrhosis?**
   A. **# Chronic Liver Disease and Cirrhosis: Definition & Classification**
...
1. A patient with suspected Chronic Liver Disease and Cirrhosis presents with: Bridging Fibrosis connecting portal tracts; Regenerative Nodules (surrounded by fibrosis); Architectural Distortion (vascular, biliary). What is the most likely diagnosis?
