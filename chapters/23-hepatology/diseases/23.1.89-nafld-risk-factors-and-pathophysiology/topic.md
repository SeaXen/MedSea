...
```mermaid
mindmap
  root((NAFLD Risk Factors & Pathophysiology))
    Central Driver
      Insulin Resistance
    Metabolic Syndrome
      Central Obesity
      ...
      Dyslipidaemia
    Genetics
      PNPLA3 I148M (OR 3-5x)
      TM6SF2 E167K
      MBOAT7
      HSD17B13 (Protective)
    Pathophysiology (Multiple-Hit)
      Hit 1: Steatosis (IR → FFA Flux, DNL, Impaired VLDL)
      Hit 2: Inflammation/Fibrosis
        Oxidative Stress
        Lipotoxicity
        ER Stress
        Mitochondrial Dysfunction
        Gut-Liver Axis (LPS-TLR4)
        Adipokine Imbalance
    Secondary Causes (Exclude)
      Alcohol, Drugs, HCV GT3, Starvation
      Wilson, Hypothyroid, Lipodystrophy
```
