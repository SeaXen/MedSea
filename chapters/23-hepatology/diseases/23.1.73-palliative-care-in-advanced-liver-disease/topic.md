---
tags: [hepatology, palliative_care, end_of_life, cirrhosis, decompensated, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Palliative care in advanced liver disease - symptom management, advance care planning, ethical issues - FCPS/MRCP palliative hepatology"
see_also: ["Chronic Liver Disease and Cirrhosis/Complications", "Portal Hypertension and Complications/Ascites", "Portal Hypertension and Complications/Hepatic Encephalopathy", "Liver Transplantation/Liver Transplantation", "Acute Liver Failure/ICU supportive care"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart TD
    A[Advanced Liver Disease] --> B{Triggers for Palliative Care}
    B --> C[Decompensated Cirrhosis + MELD ≥20]
    B --> D[Refractory Ascites Despite Max Therapy]
    B --> E[Recurrent HE Despite Max Therapy]
    B --> F[Recurrent Variceal Bleed / Failed TIPS]
    B --> G[HRS-AKI Non-Responsive / Not Transplant Candidate]
    B --> H[HPS/PoPH Not Transplant Candidate]
    B --> I[HCC Beyond Transplant Criteria / Unresectable]
    B --> J[Patient/Family Requests Comfort-Focused Care]
    C & D & E & F & G & H & I & J --> K[Initiate Palliative Care]
```
...
```mermaid
mindmap
  root((Palliative Care in Liver Disease))
    Timing
      Early Integration (MELD ≥20, Refractory Symptoms)
      Not Just End-of-Life
    Symptom Management
      Ascites: LVP + Albumin / Indwelling Catheter
      Pain: Low-Dose Morphine
      HE: Lactulose + Rifaximin / Sedation if Severe
      Pruritus: Cholestyramine → Rifampicin → Naltrexone
      Fatigue: Pacing, BCAA, Methylphenidate
    Advance Care Planning
      Early & Ongoing
      DNACPR, Ceiling of Care, Preferred Place
      Parallel with Transplant Workup
    End-of-Life
      Syringe Driver: Morphine + Midazolam + Levomepromazine + Hyoscine
      Symptom Control: Pain, Agitation, Secretions, Nausea, Dyspnoea
    Ethics
      Autonomy > Beneficence > Non-Maleficence > Justice
      Parallel Pathways: Transplant + Palliative
```
