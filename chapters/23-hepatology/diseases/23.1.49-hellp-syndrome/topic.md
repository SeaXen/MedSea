...
mindmap
  root((HELLP Syndrome))
    Definition
      H: Haemolysis (LDH>600, Schistocytes)
      E: Elevated LFTs (AST/ALT>120)
      L: Low Platelets (<100)
      P: (Mississippi Classification)
    Classification
      Class I: Plt<50 (Urgent Delivery)
      Class II: Plt 50-100 (Delivery if ≥34wks)
      Class III: Plt 100-150 (Monitor)
    Labs
      LDH>600, Schistocytes, ↓Haptoglobin
      AST/ALT>120, Bilirubin (Indirect↑)
      Platelets <100
    Management
      MgSO4 4g+1g/h (Neuroprotection)
      BP<160/110 (Labetalol/Hydralazine)
      Steroids <34wks (Betamethasone)
      Delivery Decision by Class/Gestation
    Complications
      DIC (Class I 10-20%)
      Renal Failure, ARDS
      Abruption, Subcapsular Haematoma
    Delivery
      Class I <34wks: Urgent
      Class II/III <34wks Stable: Expectant + Steroids
      ≥34wks: Delivery
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 23: Hepatology — HELLP Syndrome*

**Q1.** Which of the following features is most specific or characteristic of HELLP Syndrome?
...
**Q2.** What is the most appropriate first-line therapy for HELLP Syndrome?

  - **A.** <34 weeks + Urgent delivery
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — <34 weeks + Urgent delivery
  >
  > *Source:* **<34 weeks**   Class I (Plt<50) or maternal/fetal compromise   **Urgent delivery** (give steroids first if <34wks)
