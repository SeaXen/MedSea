...
## 5. Differentiation: IgG4-SC vs PSC vs Cholangiocarcinoma

```mermaid
flowchart TD
    A[Biliary Stricture on MRCP] --> B{Clinical Context}
    B -->|Young Male, IBD| C[PSC]
    B -->|Older Male, Multi-organ, High IgG4| D[IgG4-SC]
    B -->|Older, Weight Loss, Mass, CA19-9↑| E[Cholangiocarcinoma]
    C --> F[Beading, No Steroid Response]
    D --> G[Diffuse/Pancreatic, Steroid Response, IgG4↑]
    E --> H[Mass, Vascular Encasement, CA19-9↑↑]
```
...
mindmap
  root((IgG4-SC))
    ...
    Diagnosis (HISORt)
      ...
      Serology: IgG4 >135 mg/dL
      Other Organ: AIP, Mikulicz, Retroperitoneal Fibrosis
      Response: Rapid Steroid Response (2-4w)
    Differentiation
      vs PSC: No IBD, IgG4↑, Pancreas, Steroid Response
      vs CCA: No Mass, IgG4↑, Steroid Response
    Treatment
      Pred 40mg → Taper 6mo → Maintenance 5-10mg
