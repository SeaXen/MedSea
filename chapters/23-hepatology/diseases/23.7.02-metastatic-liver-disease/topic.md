...
## 2. Epidemiology & Common Primaries
...
## 5. Common Primary Tumours: Specific Features
...
## 8. Differentiation: Metastases vs HCC vs Benign
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 23: Hepatology — Metastatic liver disease*

**Q1.** What is the most appropriate first-line therapy for Metastatic liver disease?
  ...
  > **Answer: A** — Systemic Therapy
  >
  > *Source:* **Systemic Therapy**   Primary if unresectable, not candidate for local therapy  
