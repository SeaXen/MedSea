...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 23: Hepatology — Benign liver tumours*

**Q1.** What is the most appropriate first-line therapy for Benign liver tumours?
  ...
  > **Answer: A** — Contraindications for Surgery
  >
  > *Source:* **Contraindications for Surgery**   None (benign, no malignant potential)  
