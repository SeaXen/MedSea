...
mindmap
  root((HBV Treatment))
    Indications
      Universal: Cirrhosis, ALF, Extrahepatic, Immunosuppression
      Phase-based: Active phases + Fibrosis F>=2
      NO: Immune Tolerant, Inactive Carrier
    First-Line NAs
      ETV 0.5mg: High barrier, renal adjust
      TDF 245mg: High barrier, renal/bone tox
      TAF 25mg: High barrier, less tox
    Special Pops
      Decompensated: ETV/TDF urgent
      ALF: ETV/TDF emergency
      Pregnancy: TDF from 24w if DNA>200k
      HIV: TDF/FTC or TAF/FTC in ART
      Immunosuppression: Prophylaxis HBsAg+
    Monitoring
      DNA q3-6mo -> undetectable
      ALT q3-6mo
      HBeAg/anti-HBe q6-12mo
      HBsAg q12mo
      Renal q6mo (TDF)
    Stopping Rules
      HBeAg+: Seroconversion + 12mo consolidation
      HBeAg-: Usually lifelong
      HBsAg loss = functional cure = STOP
```
