---
tags: [hepatology, viral_hepatitis, hbv, phases, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "HBV phases of chronic infection - core FCPS/MRCP knowledge for treatment decisions"
see_also: ["Viral Hepatitis/Hepatitis B", "Viral Hepatitis/Hepatitis B serology interpretation", "Viral Hepatitis/Hepatitis B treatment indications", "Viral Hepatitis/Hepatitis B HCC surveillance", "Viral Hepatitis/Hepatitis B reactivation"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart LR
    A[Immune Tolerant] -->|HBeAg seroconversion| B[Immune Active/Clearance]
    B -->|HBeAg loss, anti-HBe+| C[Inactive Carrier]
    C -->|Reactivation| D[HBeAg-Negative Reactivation]
    D -->|HBeAg loss| C
    B -->|Spontaneous| C
```
...
mindmap
  root((HBV Chronic Phases))
    ...
    Immune Active
      ...
      TREAT if F>=2
      ETV/TDF/TAF
      Seroconversion 8-15%/yr
    Inactive Carrier
      HBeAg -, DNA <2000
      ALT Normal
      NO treatment
      Monitor for reactivation
    HBeAg-Neg Reactivation
      HBeAg -, DNA >2000
      ALT ↑, Precore mutation
      TREAT if F>=2
      Usually lifelong treatment
    Transitions
      Tolerant -> Seroconversion -> Active or Carrier
      Carrier -> Reactivation (immunosuppression)
      Active -> Seroconversion -> Carrier
```
