---
tags: [hepatology, jaundice, obstructive, malignant, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Malignant biliary obstruction - painless jaundice, Courvoisier's law, pancreatic cancer, cholangiocarcinoma - FCPS/MRCP surgical emergency"
see_also: ["Jaundice and LFT Interpretation/Post-hepatic (obstructive) jaundice", "Biliary Tract Disease/Cholangiocarcinoma", "Biliary Tract Disease/Gallbladder cancer", "Biliary Tract Disease/Ampullary carcinoma", "Liver Tumours/HCC (Hepatocellular Carcinoma)"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Malignant vs Benign Obstruction
...
## Courvoisier's Law & Clinical Signs
...
```mermaid
flowchart TD
    A[Painless Jaundice] --> B[Abdominal US]
    B --> C{CBD Dilated?}
    C -->|No| D[Intrahepatic Cause / Medical Jaundice]
    C -->|Yes| E{GB Palpable / US: Distended GB?}
    E -->|Yes| F[Malignant Obstruction Likely]
    E -->|No| G[Consider Stone / Mirizzi / Chronic Pancreatitis]
    F --> H[CT Abdomen/Pelvis + CA19-9]
    H --> I{Mass Seen?}
    I -->|Pancreatic Head Mass| J[Pancreatic Cancer]
    I -->|CBD Stricture/Mass| K[Cholangiocarcinoma]
    I -->|Ampullary Mass| L[Ampullary Cancer]
    I -->|GB Mass/Wall Thickening| M[GB Cancer]
    I -->|Lymphadenopathy| N[Metastatic Nodes]
    J & K & L & M & N --> O[Staging CT Chest/Abd/Pelvis]
    O --> P[EUS for Tissue Diagnosis / ERCP Stenting]
    P --> Q[MDT Discussion]
    Q --> R[Surgery / Chemo / Biliary Drainage / Palliative]
```

---

## ERCP vs PTC for Drainage
