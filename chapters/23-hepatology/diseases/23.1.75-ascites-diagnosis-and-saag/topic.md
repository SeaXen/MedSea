---
tags: [hepatology, portal_hypertension, ascites, saag, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Ascites diagnosis with SAAG - fundamental hepatology skill for FCPS/MRCP"
see_also: ["Portal Hypertension and Complications/Ascites management", "Portal Hypertension and Complications/Spontaneous bacterial peritonitis (SBP)", "Portal Hypertension and Complications/Refractory ascites", "Portal Hypertension and Complications/Hepatorenal Syndrome"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart TD
    A[Ascitic Fluid] --> B{SAAG ≥1.1 g/dL?}
    B -->|Yes| C[High SAAG = Portal Hypertension]
    C --> D{Total Protein ≥2.5 g/dL?}
    D -->|Yes| E[High SAAG + High Protein]
    D -->|No| F[High SAAG + Low Protein]
    B -->|No| G[Low SAAG = Non-Portal Hypertensive]
    G --> H{Total Protein ≥2.5 g/dL?}
    H -->|Yes| I[Low SAAG + High Protein]
    H -->|No| J[Low SAAG + Low Protein]
```
...
```mermaid
mindmap
  root((Ascites Diagnosis))
    SAAG
      >=1.1 = Portal HTN (Cirrhosis, Cardiac, Budd-Chiari)
      <1.1 = Non-Portal HTN (TB, Cancer, Pancreatic, Nephrotic, Serositis)
    SAAG + Protein Quadrants
      High SAAG + Low Protein = Cirrhosis (classic)
      High SAAG + High Protein = Cardiac/Budd-Chiari
      Low SAAG + High Protein = TB/Cancer/Pancreatic
      Low SAAG + Low Protein = Nephrotic/Meigs
    Diagnostic Paracentesis
      New onset, Admission, Deterioration
      Tests: Albumin, Protein, PMN, Culture, Glucose, LDH, ADA, Amylase
    SBP
      PMN >=250
      Ceftriaxone + Albumin
    Therapeutic Paracentesis
      >5L = Albumin 8g/L
    Refractory Ascites
      Failed max diuretics + salt
      LVP + Albumin -> TIPS -> Transplant
```
