...
```mermaid
pie title ALF Aetiology: UK/West vs Asia
    "Paracetamol" : 50
    "Indeterminate" : 15
    "Drug-induced (non-paracetamol)" : 12
    "Autoimmune" : 8
    "Viral (HAV, HBV, HEV, HSV, EBV)" : 10
    "Wilson Disease" : 3
    "Other (Budd-Chiari, AFLP, etc.)" : 2
```
...
mindmap
  root((ALF Definition & Aetiology))
    ...
    Subtypes
      Hyperacute <7d Best
      Acute 8-28d Intermediate
      Subacute 29d-26w Worst
    Aetiology West
      Paracetamol 50-70%
      Indeterminate 15%
      Non-PCM DILI 12%
    ...
    Aetiology Asia
      ...
      Indeterminate
    ALF_vs_ACLF
      ALF no prior disease
      ACLF chronic liver disease
      ACLF multi-organ failure
      ACLF grades 1-3
```
