...
```mermaid
mindmap
  root((HCV Renal Impairment))
    SOF
      Contraindicated <30
      GS-331007 Renal Clearance
      Accumulation → Toxicity
    GLE/PIB
      PREFERRED ALL CKD
      No Dose Adjustment
      12 Weeks (8w Naive Non-cirr)
      Dialysis: Dose After
    Alternatives
      OBV/PTV/r+DSV ± RBV
      ELB/GZR (GT1,4)
    Dialysis
      GLE/PIB After Dialysis
      Monitor Hb, LFTs, Electrolytes
    Transplant
      Pre-Tx: Treat with GLE/PIB
      Post-Tx: GLE/PIB or SOF/VEL (eGFR>30)
      CNI Interaction: Monitor Levels
    Post-Transplant
      SVR >95%
```
