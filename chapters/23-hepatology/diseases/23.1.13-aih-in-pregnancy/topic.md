---
tags: [hepatology, autoimmune_liver, ai_h, pregnancy, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "AIH in pregnancy - management, safety of immunosuppressants, postpartum flare - FCPS/MRCP obstetric hepatology"
see_also: ["Autoimmune Liver Disease/Autoimmune hepatitis (AIH)", "Autoimmune Liver Disease/AIH treatment", "Autoimmune Liver Disease/AIH diagnostic criteria (IAIHG simplified)", "Hepatology in Special Situations/Viral Hepatitis in Pregnancy"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart TD
    A[Delivery] --> B[Postpartum Immune Reconstitution]
    B --> C[Flare Risk: 30-50% at 4-12 Weeks]
    C --> D[Monitor LFTs Weekly ×4, Then Fortnightly ×4]
    D --> E{Flare?}
    E -->|Yes| F[Increase Prednisolone / Restart Induction]
    E -->|No| G[Taper to Maintenance]
    F --> H[Reassess Azathioprine Dose]
```
...
## AIH Presenting de Novo in Pregnancy
