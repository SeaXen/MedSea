---
tags: [hepatology, portal_hypertension, pathophysiology, hvpg, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Portal hypertension pathophysiology and HVPG measurement - FCPS/MRCP fundamental concepts"
see_also: ["Portal Hypertension and Complications/Ascites", "Portal Hypertension and Complications/Varices", "Portal Hypertension and Complications/Screening endoscopy", "Portal Hypertension and Complications/Primary prophylaxis (NSBB vs EVL)", "Portal Hypertension and Complications/Acute variceal bleeding management"]
created: 2025-06-13
modified: 2025-06-13
---
...
```mermaid
flowchart LR
    A[Jugular/Femoral Vein Access] --> B[Balloon Catheter in Hepatic Vein]
    B --> C[Measure FHVP: Free Hepatic Venous Pressure]
    C --> D[Inflate Balloon → Wedged Position]
    D --> E[Measure WHVP: Wedged Hepatic Venous Pressure]
    E --> F[HVPG = WHVP - FHVP]
    F --> G[Deflate Balloon, Remove Catheter]
```
...
```mermaid
mindmap
  root((Portal HTN Pathophysiology & HVPG))
    Mechanisms
      Increased Resistance (Structural + Dynamic)
      Increased Inflow (Splanchnic Vasodilation)
    Classification
      Pre-sinusoidal: PVT, Schisto (HVPG Normal)
      Sinusoidal: Cirrhosis, ALD (HVPG ↑↑)
      Post-sinusoidal: Budd-Chiari, CHF (WHVP=FHVP ↑)
    HVPG Measurement
      WHVP - FHVP
      Normal 1-5 mmHg
    Thresholds
      1-5: Normal
      6-9: PH Not Significant
      >=10: CSPH
      >=12: Varices
      >=16: Bleeding Risk
      >=20: High Mortality
