---
tags: [medicine, hepatology, davidson, ascites, sbp, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 24: Hepatology
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Ascites: SAAG ≥11 g/L = portal hypertension; SBP = PMNs ≥250/mm³ → ceftriaxone + albumin; refractory ascites = LVP + albumin 8g/L removed → TIPS/transplant"
see_also: ["Portal Hypertension and Complications", "Cirrhosis and Portal Hypertension", "Spontaneous Bacterial Peritonitis", "Hepatorenal Syndrome", "Hepatopulmonary Syndrome"]
created: 2026-06-13
modified: 2026-06-13
---
...
|------------|------------|
| **No response** to 400mg spironolactone + 160mg furosemide OR early recurrence after LVP OR diuretic-induced complications | **1. Large Volume Paracentesis (LVP)** 5-8L + **Albumin 8g/L removed** (if >5L) <br> **2. TIPS** (if preserved liver function, no HE) <br> **3. Peritoneovenous Shunt** (Denver/LeVeen) — last resort <br> **4. Transplant evaluation** |
...
flowchart TD
    ...
    B -->|≥11 g/L| C[Portal HTN: Cirrhosis, Cardiac, Budd-Chiari, PVT]
    B -->|<11 g/L| D[Non-Portal: Malignancy, TB, Pancreatitis, Nephrotic]
    C --> E[Diagnostic Paracentesis]
    E --> F{PMNs ≥250?}
    F -->|Yes| G[SBP: Ceftriaxone 2g + Albumin 1.5g/kg D1, 1g/kg D3]
    F -->|No| H[LVP if tense + Diuretics]
```
...
mindmap
  root((Ascites))
    Pathophysiology
      Portal HTN + Hypoalbuminaemia + Splanchnic Vasodilation
    SAAG
      ≥11 g/L = Portal HTN
      <11 g/L = Non-Portal
    Diagnosis
      Paracentesis: PMNs, Culture, Protein, SAAG
    SBP
      PMNs ≥250
      Ceftriaxone 2g + Albumin
      Prophylaxis: Norfloxacin
    Refractory
      LVP + Albumin 8g/L (>5L)
      TIPS / Transplant
    Diuretics
      Spiro 100 + Furosemide 40 (100:40)
      Max 400/160
    Prophylaxis
      Prior SBP → Norfloxacin
      Protein<15 + Child≥9 → Norfloxacin
      GI Bleed → Ceftriaxone 1g×7d
```
