...
```mermaid
flowchart TD
    A[Klatskin Tumour] --> B{Extent}
    B -->|Confined to Common Hepatic Duct| B1[Type I]
    B -->|Extending to Right/Left Hepatic Duct| B2[Type II]
    B -->|Involving Right & Left Hepatic Ducts| B3[Type III]
    B -->|Involving Secondary Intrahepatic Ducts| B4[Type IV]
```
