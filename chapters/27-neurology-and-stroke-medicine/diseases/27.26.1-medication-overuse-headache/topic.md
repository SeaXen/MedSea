---
tags: [medicine, neurology, davidson, headache, medication-overuse, full-note]
chapter: Neurology
...
```mermaid
flowchart TD
A[Frequent headache] --> B[Count headache days per month]
B --> C[Count acute medication use days per month]
C --> D{Overuse threshold crossed?}
D -- Yes --> E[Suspect medication-overuse headache]
E --> F[Educate and withdraw overused drug]
F --> G[Start/optimize preventive strategy]
D -- No --> H[Assess other chronic headache causes]
```
