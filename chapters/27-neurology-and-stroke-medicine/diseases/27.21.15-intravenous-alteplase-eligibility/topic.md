---
tags: [medicine, stroke-medicine, davidson, full-note, reperfusion, alteplase]
...
topic: Intravenous alteplase eligibility
...
```mermaid
flowchart LR
  A[Suspected ischemic stroke] --> B[Time / LKW]
  B --> C[NCCT excludes hemorrhage]
  C --> D[Disabling deficit?]
  D --> E[BP + anticoagulant + bleeding-risk review]
  E --> F{Eligible?}
  F -->|Yes| G[Give alteplase]
  F -->|No| H[Alternative pathway]
  G --> I[Monitor for bleed / angioedema]
```
