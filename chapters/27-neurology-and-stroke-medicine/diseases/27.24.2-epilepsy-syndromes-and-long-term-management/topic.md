---
tags: [medicine, neurology, davidson, epilepsy, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Epilepsy
topic: Epilepsy syndromes and long-term management
exam: [FCPS, MRCP]
...
```mermaid
flowchart TD
  A[Paroxysmal event] --> B{Provoked or unprovoked?}
  B -->|Provoked| C[Treat metabolic, toxic, vascular, or infective cause]
  B -->|Unprovoked / recurrent| D[Classify seizure type from history and witness account]
  D --> E{Focal clues?}
  E -->|Yes| F[Look for focal lesion: MRI brain epilepsy protocol]
  E -->|No / generalized pattern| G[Consider generalized epilepsy syndrome and EEG pattern]
  F --> H[Choose antiseizure drug suited to focal epilepsy]
  G --> I[Choose drug suited to generalized epilepsy]
  H --> J[Counsel on adherence, driving, pregnancy, safety, SUDEP]
  I --> J
  J --> K[Review response, adverse effects, and seizure freedom]
```
...
```mermaid
mindmap
  root((Epilepsy syndromes and long-term management))
    Classification
      Focal onset
      Generalized onset
      Unknown onset
    Localization
      Temporal aura and automatisms
      Frontal hypermotor nocturnal
    ...
    Syndromes
      ...
      Self-limited childhood focal epilepsy
    Investigations
      EEG
    ...
    Long-term management
      ...
      Driving advice
      SUDEP prevention
      Drug-resistant epilepsy referral
```
