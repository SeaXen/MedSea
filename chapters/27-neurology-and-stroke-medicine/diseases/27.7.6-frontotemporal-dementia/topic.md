...
mindmap
  root((Frontotemporal Dementia))
    ...
    Pathology
      ...
      TDP43_Inclusions
      FUS_Inclusions
      Frontotemporal_Atrophy
    Genetics
      MAPT_Tau
      GRN_Progranulin
      C9orf72_Hexanucleotide
    Clinical
      Disinhibition_Apathy
      Loss_Empathy
      Hyperorality
      Language_Changes
      FTD_MND_Overlap
    Diagnosis
      MRI_Frontal_Temporal_Atrophy
      PET_FDG_Hypometabolism
      CSF_Negative_Amyloid
      Genetics
    Management
      SSRI_Behaviour
      AVOID_Cholinesterase_Inhibitors
      Speech_Therapy
      Carer_Support
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Frontotemporal Dementia*

**Q1.** Which of the following features is most specific or characteristic of Frontotemporal Dementia?
...
**Q2.** What is the most appropriate first-line therapy for Frontotemporal Dementia?
