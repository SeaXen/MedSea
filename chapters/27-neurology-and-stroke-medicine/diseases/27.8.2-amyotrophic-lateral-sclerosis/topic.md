---
tags: [medicine, neurology, motor-neurone, als, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: ['Corticospinal tracts', 'Anterior horn cells', 'Brainstem motor nuclei']
  physiology: ['Upper and lower motor neuron pathways']
  clinical: ['Davidson 24th Ed Ch25', 'Gold Coast Criteria 2020', 'EFNS/ENMC 2020', 'NICE NG42', 'PasTest', 'MRCP Notes']
related: ['Primary Lateral Sclerosis', 'Progressive Muscular Atrophy', 'Kennedy Disease', 'Multifocal Motor Neuropathy', 'Inclusion Body Myositis']
...
flowchart TD
    ...
    B --> C[TDP-43/FUS Mislocalisation]
    C --> D[Protein Aggregation]
    D --> E[Mitochondrial Dysfunction]
    E --> F[Glutamate Excitotoxicity]
    F --> G[Free Radical Injury]
    G --> H[UMN + LMN Loss]
    H --> I[Progressive Weakness + Paralysis]
```
