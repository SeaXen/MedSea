---
tags: [medicine, neurology, davidson, movement-disorders, parkinsonism, parkinson-disease, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Movement Disorders
topic_group: Parkinsonism
topic: Idiopathic Parkinson disease
exam: [FCPS, MRCP]
...
```mermaid
flowchart TD
  A[Patient with slowness, tremor, gait change] --> B{Bradykinesia present?}
  B -->|No| C[Consider tremor disorder, neuropathy, cerebellar or functional disorder]
  B -->|Yes| D{Rest tremor or rigidity/postural features present?}
  D -->|No| C
  D -->|Yes| E[Establish parkinsonism]
  E --> F{Typical idiopathic PD clues? asymmetry, rest tremor, gradual progression, good levodopa response}
  F -->|Yes| G[Clinical diagnosis of probable idiopathic PD]
  F -->|No| H[Look for secondary or atypical causes]
  H --> I[Drug history, vascular clues, early falls, gaze palsy, autonomic failure, dementia]
  G --> J[Assess motor and non-motor burden, function, cognition, falls]
  I --> J
```
...
```mermaid
mindmap
  root((Idiopathic Parkinson disease))
    Definition
      Parkinsonism
        Bradykinesia
        Rest tremor
