---
tags: [medicine, neurology, davidson, functional-neurological-disorder, gait, speech, visual, movement, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Functional Neurological Disorder
topic_group: Presentations
topic: Gait, speech, visual, and movement presentations
status: full-note
---
...
```mermaid
flowchart TD
A[Abnormal gait/speech/vision/movement] --> B[Check structural red flags]
B --> C{Organic pattern present?}
C -- Yes --> D[Investigate/treat structural disorder]
C -- No --> E[Look for variability distractibility entrainment]
E --> F[Positive diagnosis of FND presentation]
F --> G[Targeted rehab + MDT care]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Gait, speech, visual, and movement presentations*

**Q1.** What is the most appropriate first-line therapy for Gait, speech, visual, and movement presentations?

  - **A.** Give a specific positive diagnosis
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Give a specific positive diagnosis
  >
  > *Source:* Give a specific positive diagnosis.
