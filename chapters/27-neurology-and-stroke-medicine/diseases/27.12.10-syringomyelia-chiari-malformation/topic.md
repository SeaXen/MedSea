---
tags: [medicine, neurology, spinal-cord, chiari, syrinx, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Neurology
topic: Syringomyelia & Chiari Malformation
...
related: ['Tethered Cord Syndrome', 'Spinal Cord Tumours', 'CNS Infections']
...
```mermaid
flowchart TD
    A[CSF Flow Obstruction] --> B[Altered Dynamics]
    B --> C[Foramen Mag Obstruction Chiari]
    B --> D[Central Canal Pressure]
    C --> E[Tonsillar Descent]
    D --> F[Syrinx Formation]
    E --> F
    F --> G[Central Cord Damage]
    G --> H[Crossing Spinothalamic Fibres Affected]
    H --> I[Cape Sensory Loss]
```
...
```mermaid
flowchart TD
    A[Cape Sensory Loss / Hand Wasting] --> B[MRI Whole Spine + Brain]
    B --> C{Chiari Present?}
    C -->|Yes| D[Chiari I + Syrinx]
    C -->|No Syrinx Alone| E[Excl Tumour/Adhesions]
    D --> F[Measure Tonsillar Descent + Syrinx Length]
    F --> G{Symptomatic?}
    G -->|Yes| H[Posterior Fossa Decompression]
    G -->|No| I[Monitor]
    E --> J[Syrinx Drainage/Shunt]
```
