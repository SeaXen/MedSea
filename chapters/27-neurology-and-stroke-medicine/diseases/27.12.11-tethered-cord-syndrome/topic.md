---
tags: [medicine, neurology, spinal-cord, tethered, fcps, mrcp]
chapter: Neurology
...
related: ['Spinal Dysraphism', 'Syringomyelia', 'Spina Bifida', 'Chiari Malformation']
...
```mermaid
flowchart TD
    A[Low Conus/Tight Filum] --> B[Anchored Cord]
    B --> C[Normal Cord Ascent Impaired]
    C --> D[Stretching with Growth/Activity]
    D --> E[Ischaemia]
    D --> F[Metabolic Dysfunction]
    E --> G[Neurological Deficit]
    F --> G
    G --> H[Pain, Motor, Sensory, Bladder]
```
...
```mermaid
flowchart TD
    A[Back Pain + Lumbosacral Stigmata / Bladder] --> B[MRI Lumbosacral Spine]
    B --> C{Conus Position}
    C -->|Below L2| D[Low-Lying Conus]
    C -->|Normal Position + Tight Filum| E[Tight Filum]
    D --> F[Filum Thickness + Fatty Changes]
    E --> F
    F --> G{Symptomatic}
    G -->|Yes| H[Detethering Surgery]
    G -->|No| I[Monitor + Urodynamics]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Tethered Cord Syndrome*

**Q1.** What is the most appropriate first-line therapy for Tethered Cord Syndrome?

  - **A.** Spinal fusion + Early intervention + Release tension
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Spinal fusion + Early intervention + Release tension
  >
  > *Source:* **Spinal fusion (long-term)**   Scoliosis, instability   Orthopaedic  

### Surgical Principles
- **Early intervention** for symptomatic patients (especially children)
- **Release tension** (filum sec
