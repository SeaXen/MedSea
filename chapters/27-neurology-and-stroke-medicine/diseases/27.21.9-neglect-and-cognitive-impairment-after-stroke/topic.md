---
tags: [medicine, stroke-medicine, davidson, full-note, recovery-rehabilitation-prognosis, neglect, cognition]
chapter: Stroke Medicine
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 29: Stroke medicine
heading: Recovery, Rehabilitation, and Prognosis
topic_group: Communication and swallowing sequelae
topic: Neglect and cognitive impairment after stroke
...
```mermaid
flowchart TD
  A[Stroke patient with poor function/safety] --> B[Assess attention, scanning, insight, orientation, memory]
  B --> C{Neglect or broader cognitive deficit?}
  C -->|Neglect| D[Visual scanning training + environmental cues + supervised safety]
  C -->|Cognitive impairment| E[Structured tasks, repetition, simplification, family education]
  D --> F[OT/physio/neuro rehab plan]
  E --> F
  F --> G[Reassess falls risk, ADLs, and discharge capacity]
```
...
```mermaid
flowchart LR
  A[Poor post-stroke function] --> B[Assess attention, insight, scanning]
  B --> C[Identify neglect/cognitive deficits]
  C --> D[Cueing + supervised functional rehab]
  D --> E[Reassess safety and discharge readiness]
```
