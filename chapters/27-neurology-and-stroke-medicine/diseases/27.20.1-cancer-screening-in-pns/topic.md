...
```mermaid
mindmap
  root((Cancer Screening in PNS))
    Indications
      Antibody positive
      High risk PNS syndrome
      Smoker over 50
      New encephalitis cerebellar neuropathy SPS
    Antibody first
      Anti-Hu SCLC
      Anti-Yo breast ovarian
      Anti-Ma2 testicular
      Anti-Ri breast SCLC
      Anti-CRMP5 SCLC thymoma
      Anti-Tr Hodgkin
      Anti-mGluR1 Hodgkin
      Anti-amphiphysin breast SCLC
      Anti-LGI1 thymoma
    ...
    Cadence
      ...
      For 2 to 4 years
      Reassess at 4 years
      Stop if no tumour at 4 years and antibody stable
    Special cases
      Antibody negative high suspicion
        Repeat antibodies at 3 to 6 months
      PET negative antibody positive
        Continue imaging
      Autoimmune mimic
        LGI1 CASPR2
        GAD65 SPS
