---
tags: [medicine, neurology, spinal cord, demyelinating, fcps, mrcp]
chapter: Neurology
...
references:
  clinical: ['Davidson 24th Ed Ch25', "Adams & Victor's Principles of Neurology", 'Transverse Myelitis Consortium Working Group 2002', 'International Panel for NMO Diagnosis 2015', 'PasTest', 'MRCP Notes']
...
```mermaid
flowchart TD
    A[Trigger - Infection/Autoantibody] --> B[Antigen Cross-reactivity]
    A --> C[Direct infection]
    B --> D[CD4+/CD8+ T cell + B cell]
    D --> E[Spinal cord inflammation]
    E --> F[Demyelination + axonal loss]
    E --> G[Microvascular injury]
    F --> H[Sensorimotor + autonomic dysfunction]
    G --> H
```
