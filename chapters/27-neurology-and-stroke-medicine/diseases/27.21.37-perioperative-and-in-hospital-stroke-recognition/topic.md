---
tags: [medicine, stroke-medicine, davidson, full-note, special-stroke-scenarios, perioperative, in-hospital]
chapter: Stroke Medicine
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 29: Stroke medicine
heading: Special Stroke Scenarios
topic_group: Special populations and situations
topic: Perioperative and in-hospital stroke recognition
...
```mermaid
flowchart TD
  A[Perioperative or in-hospital patient with new neuro change] --> B[ABC + glucose + oxygen + vitals]
  B --> C[Rapid focused neuro exam and last-known-well time]
  C --> D{Focal stroke pattern?}
  D -->|Yes| E[Activate stroke pathway urgently]
  D -->|Unclear| F[Correct reversible mimics but do not delay imaging]
  E --> G[CT head +/- CTA]
  F --> G
  G --> H{Ischemic / hemorrhagic / mimic?}
  H -->|Ischemic / LVO| I[Reperfusion eligibility + BP/hemodynamic optimization]
  H -->|Hemorrhagic| J[Reverse coagulopathy + neurocritical care]
  H -->|Mimic| K[Treat cause]
```
...
```mermaid
flowchart LR
  A[New inpatient neuro deficit] --> B[ABC + glucose + vitals]
  B --> C[Focused neuro exam + last-known-well]
  C --> D[Stroke-team activation]
  D --> E[CT head +/- CTA]
  E --> F{Result}
  F -->|Ischemic| G[Reperfusion / hemodynamic plan]
  F -->|Hemorrhagic| H[Reversal + neurocritical care]
  F -->|Mimic| I[Treat alternate cause]
```
