---
tags: [medicine, stroke-medicine, davidson, full-note, lacunar, small-vessel-disease]
...
```mermaid
flowchart TD
A[Acute focal deficit] --> B{Cortical signs present? aphasia neglect gaze deviation field loss}
B -- Yes --> C[Think cortical/anterior or PCA syndrome]
B -- No --> D{Syndrome is pure motor / pure sensory / sensorimotor / ataxic hemiparesis / dysarthria-clumsy hand?}
D -- Yes --> E[Consider lacunar syndrome]
D -- No --> F[Consider mimic or other brainstem/subcortical localization]
E --> G[CT/MRI + acute stroke pathway]
```
