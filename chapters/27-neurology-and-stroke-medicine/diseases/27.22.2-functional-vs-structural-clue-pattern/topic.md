---
tags: [medicine, neurology, davidson, examination, localization, functional-neurological-disorder, structural, differential-diagnosis, fcps, mrcp]
chapter: Neurology
...
topic: Functional vs structural clue pattern
exam: [FCPS, MRCP]
...
```mermaid
flowchart TD
A[Neurological symptom] --> B[Look for red flags and anatomical localization]
B --> C{Consistent structural pattern?}
C -->|Yes| D[Structural disorder likely -> targeted investigations]
C -->|No| E[Look for positive functional signs]
E --> F{Positive functional signs present and no dangerous missed disease clues?}
F -->|Yes| G[FND likely / functional pattern]
F -->|No| H[Reassess: mixed, atypical, or evolving disorder]
```
