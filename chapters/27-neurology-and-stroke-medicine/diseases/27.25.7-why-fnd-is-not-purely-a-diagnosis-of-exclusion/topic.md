---
tags: [medicine, neurology, davidson, functional-neurological-disorder, diagnosis, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Functional Neurological Disorder
topic_group: Diagnosis
topic: Why FND is not purely a diagnosis of exclusion
status: full-note
---
...
```mermaid
flowchart TD
A[Neurological symptom] --> B[Exclude dangerous acute mimic]
B --> C[Search for positive FND signs]
C --> D{Signs + incongruity present?}
D -- Yes --> E[Targeted tests only if needed]
E --> F[Positive diagnosis of FND]
F --> G[Explain and treat]
D -- No --> H[Reassess structural differential]
```
