---
tags: [medicine, neurology, davidson, functional-neurological-disorder, weakness, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Functional Neurological Disorder
topic_group: Presentations
topic: Functional weakness
status: full-note
---
...
```mermaid
flowchart TD
A[Patient reports weakness] --> B[Look for neurological red flags]
B --> C{Structural pattern present?}
C -- Yes --> D[Investigate/treat structural cause]
C -- No --> E[Look for positive functional signs]
E --> F[Explain positive diagnosis of FND]
F --> G[Physiotherapy + MDT management]
```
