---
tags: [medicine, neurology, cns-infections, chronic-meningitis, tb, fungal, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Neurology
topic: Chronic Meningitis
exam: [FCPS, MRCP Part 1, MRCP Part 2, PACES]
references: ['Davidson 24th Ed Ch25', 'IDSA 2004 Guidelines', 'WHO TB Guidelines', 'PasTest', 'MRCP Notes']
related: ['Tuberculous Meningitis', 'Fungal Meningitis', 'Acute Bacterial Meningitis', 'Viral Meningitis']
...
```mermaid
flowchart TD
    A[Pathogen entry - haematogenous/perineural] --> B[Basal meninges/exudate]
    B --> C[CSF flow obstruction]
    C --> D[Hydrocephalus]
    B --> E[Vasculitis of perforators]
    E --> F[Infarction - basal ganglia/internal capsule]
    B --> G[Cranial nerve entrapment]
    G --> H[CN palsies: VI, III, VII, VIII]
```
...
```mermaid
flowchart TD
    A[Subacute headache + CN palsy + fever] --> B[Bloods: HIV, TB IGRA, ACE, autoimmune]
    B --> C[CT/MRI with contrast]
    C --> D[LP - high volume, repeat if needed]
    D --> E{CSF pattern}
    E -->|Very low glucose, ↑protein, lymphocytes| F[TBM - TB PCR, ADA]
    E -->|↑OP, lymphocytes| G[Crypto Ag, India ink]
    E -->|Mixed pleocytosis, known cancer| H[Cytology ×3 LPs]
    E -->|Normal glucose, mild ↑protein| I[Syphilis, Lyme, Brucella serology]
    F --> J[TBM stage and treat]
    G --> K[Antifungal]
    H --> L[Oncology referral]
```
