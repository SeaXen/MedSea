...
```mermaid
mindmap
  root((Hereditary Spastic Paraplegia))
    Genetics
      SPG4 spastin AD 40 percent
      SPG7 paraplegin AR mito
      SPG11 spatacsin AR thin CC
      Many other loci
    Clinical
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Hereditary Spastic Paraplegia*

**Q1.** Which of the following features is most specific or characteristic of Hereditary Spastic Paraplegia?
...
**Q2.** What is the most appropriate first-line therapy for Hereditary Spastic Paraplegia?
