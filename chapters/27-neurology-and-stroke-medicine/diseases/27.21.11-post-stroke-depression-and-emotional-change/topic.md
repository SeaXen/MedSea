---
tags: [medicine, stroke-medicine, davidson, full-note, recovery-rehabilitation-prognosis, depression, emotional-change]
chapter: Stroke Medicine
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 29: Stroke medicine
heading: Recovery, Rehabilitation, and Prognosis
topic_group: Long-term outcomes
topic: Post-stroke depression and emotional change
...
```mermaid
flowchart TD
  A[Stroke survivor with low mood or poor rehab engagement] --> B[Screen for depression, suicidality, anxiety, sleep, pain, cognition]
  B --> C[Exclude delirium, medication/sedation effects, major metabolic causes]
  C --> D[Assess aphasia, disability burden, support system, caregiver strain]
  D --> E{Depression/emotional syndrome likely?}
  E -->|Yes| F[Start psychosocial support + rehab adaptation +/- antidepressant]
  E -->|Unclear| G[Reassess, use supported communication, consider psychiatry/psychology input]
  F --> H[Monitor mood, adherence, sleep, appetite, suicidality, function]
```
...
```mermaid
flowchart LR
  A[Stroke survivor with mood/behavior change] --> B[Screen mood, sleep, appetite, suicidality]
  B --> C[Exclude delirium, sedation, metabolic causes]
  C --> D[Assess aphasia, cognition, disability, support]
  D --> E[Diagnose depression / apathy / emotionalism]
  E --> F[Support + rehab adaptation +/- antidepressant]
  F --> G[Follow functional and emotional response]
```
