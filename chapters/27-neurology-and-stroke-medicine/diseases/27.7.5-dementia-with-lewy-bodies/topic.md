---
tags: [medicine, neurology, dementia, lewy bodies, DLB, parkinson, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: []
  physiology: []
  clinical: ['Davidson 24th Ed Ch25', 'NICE NG97', 'DLB Consortium Criteria 2017', 'PasTest', 'MRCP Part 1/2 Notes', 'Personal notes']
related: ['Parkinson Disease Dementia', 'Dementia Overview', 'Alzheimer Disease', 'REM Sleep Behaviour Disorder']
...
```mermaid
flowchart TD
    A[α-synuclein Misfolding] --> B[Lewy Body Formation]
    B --> C[Cortical + Subcortical Deposition]
    C --> D[Cholinergic Deficiency]
    C --> E[Dopaminergic Deficiency]
    D --> F[Cognitive Decline + Hallucinations]
    E --> G[Parkinsonism]
    H[REM Sleep Nuclei] --> I[REM Sleep Behaviour Disorder]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Dementia with Lewy Bodies*

**Q1.** Which of the following features is most specific or characteristic of Dementia with Lewy Bodies?
...
**Q2.** What is the most appropriate first-line therapy for Dementia with Lewy Bodies?
