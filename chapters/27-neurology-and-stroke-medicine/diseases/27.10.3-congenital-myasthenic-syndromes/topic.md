...
topic: Congenital Myasthenic Syndromes
...
```mermaid
mindmap
  root((Congenital Myasthenic Syndromes))
    Definition
      Genetic_NMJ
      AR_mostly
    Classification
      Presynaptic_ChAT
      Synaptic_COLQ
      Postsynaptic_AChR_Rapsyn
    Clinical
      Neonatal_onset
      Fatigable_weakness
      Ptosis_opthalmoplegia
      Variable_course
    Investigations
      SFEMG_jitter
      RNS_decrement
      Genetic_panel
    Management
      Pyridostigmine_variable
      3_4_DAP_some
      Ephedrine_salbutamol_DOK7
      Avoid_aminoglycosides
    Prognosis
      Static_or_progressive
```
