---
tags: [medicine, stroke-medicine, davidson, full-note, recovery-rehabilitation-prognosis, spasticity, contracture, shoulder-pain]
chapter: Stroke Medicine
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 29: Stroke medicine
heading: Recovery, Rehabilitation, and Prognosis
topic_group: Rehabilitation fundamentals
topic: Spasticity, contracture, and shoulder pain prevention
...
```mermaid
flowchart TD
  A[Stroke patient with weak upper limb] --> B[Assess tone, range, positioning, pain, subluxation]
  B --> C{Main issue?}
  C -->|Flaccid/unsupported shoulder| D[Position/support and handle safely]
  C -->|Increasing tone| E[Stretching, positioning, functional therapy]
  C -->|Restricted passive range| F[Prevent/treat contracture early]
  C -->|Painful shoulder| G[Find cause and avoid painful handling]
  D --> H[Daily multidisciplinary review]
  E --> H
  F --> H
  G --> H
```
...
```mermaid
flowchart LR
  A[Weak post-stroke upper limb] --> B[Assess tone + range + pain + alignment]
  B --> C[Protect shoulder and position correctly]
  C --> D[Daily ROM and guided functional use]
  D --> E{Persistent problem?}
  E -->|Tone| F[Spasticity-focused treatment]
  E -->|Pain/stiffness| G[Cause-specific shoulder management]
  E -->|Contracture risk| H[Splinting/stretching/therapy]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Spasticity, contracture, and shoulder pain prevention*

**Q1.** Which of the following features is most specific or characteristic of Spasticity, contracture, and shoulder pain prevention?
  ...
  > **Answer: A** — A. Spasticity
  >
  > *Source:* **A. Spasticity** — typical flexor posture with increased tone

**Q2.** What is the most appropriate first-line therapy for Spasticity, contracture, and shoulder pain prevention?

  - **A.** Start from the first days after stroke
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Start from the first days after stroke
  >
  > *Source:* Start from the first days after stroke.
