...
```mermaid
mindmap
  root((Rapidly Progressive Dementia))
    Definition
      Dementia_lt_2_Years
      Weeks_to_Months
      Acute_to_Subacute
    Common_Causes
      CJD_Most_Common_Prion
      Autoimmune_Encephalitis
      Paraneoplastic
      Infections_HIV_Syphilis
      Metabolic_Vitamin
      Toxic_Heavy_Metals
      Vascular_Strategic_Infarct
      Neurodegenerative_Fast_AD
    CJD_sCJD
      Dementia_Myoclonus_PSWCs
      Cortical_Ribboning_DWI
      Basal_Ganglia_Hyperintensity
      RT_QuIC_Positive
      14_3_3_CSF
      t_tau_Very_High
      Rapid_Death_Months
    ...
    Investigations
      ...
      EEG_PSWCs
      CSF_Routine_OCBs
      RT_QuIC_14_3_3_t_tau
      Autoimmune_Panel
      Paraneoplastic_Panel
      HIV_Syphilis_Hepatitis
      CT_PET_Tumour_Screen
      Brain_Biopsy_Last_Resort
    Management
      Treat_Underlying_Cause
      Autoimmune_Steroids_IVIG
      Paraneoplastic_Treat_Tumour
      CJD_Symptomatic_Palliative
      Supportive_MDT
      Palliative_EOL_Care
      Family_Support
      Genetic_Counselling
