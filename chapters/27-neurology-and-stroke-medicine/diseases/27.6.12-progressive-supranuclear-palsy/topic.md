---
tags: [medicine, neurology, parkinsonism, psp, fcps, mrcp]
chapter: Neurology
davidson_chapter: Chapter 25: Neurology
topic: Progressive Supranuclear Palsy
exam: [FCPS, MRCP Part 1, MRCP Part 2, PACES]
references:
  clinical: ['Davidson 24th Ed Ch25', 'Adams & Victor', 'Bradley''s Neurology', 'PSP Consensus Criteria 2017', 'PasTest', 'MRCP Notes']
...
```mermaid
flowchart TD
    A[Parkinsonism + Falls] --> B{Vertical gaze palsy?}
    B -->|Yes| C[PSP suspected]
    B -->|No| D[PD / MSA / Other]
    C --> E[MRI: Hummingbird sign?]
    E -->|Yes| F[Probable PSP]
    E -->|No| G[Consider PSP-P / DAT-SPECT]
    F --> H[Levodopa trial — usually fails]
    H --> I[Symptomatic MDT management]
```
