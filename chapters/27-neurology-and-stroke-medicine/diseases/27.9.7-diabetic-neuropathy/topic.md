---
tags: [medicine, neurology, neuropathy, diabetes, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: []
  physiology: []
  clinical: ['Davidson 24th Ed Ch25', "Adams & Victor's Principles of Neurology", 'ADA Standards of Care 2024', "NICE NG19", 'PasTest', 'MRCP Part 1/2 Notes', 'Personal notes']
related: ['Peripheral Neuropathy Hub', 'Chronic & Systemic Neuropathies Hub', 'Diabetic Foot', 'Autonomic Neuropathy']
...
```mermaid
flowchart TD
    A[Hyperglycaemia] --> B[Polyol Pathway Flux<br/>Aldose reductase]
    B --> C[Intracellular myo-inositol depletion]
    C --> D[Na/K-ATPase dysfunction]
    A --> E[Advanced Glycation End-products<br/>AGEs]
    E --> F[Schwann cell & axonal injury]
    A --> G[PKC activation]
    G --> H[Microvascular ischaemia]
    A --> I[Oxidative stress + impaired nerve growth factor]
    I --> J[Distal axonal degeneration]
    H --> J
    F --> J
    J --> K[Small fibre loss first → large fibre]
```
