...
topic: HTLV-1 Associated Myelopathy
...
```mermaid
mindmap
  root((HTLV-1<br/>Associated<br/>Myelopathy<br/>HAM/TSP))
    Virology
      Retrovirus Deltaretrovirus
      HTLV-1 tax / HBZ
      CD4+ Tropism
      Proviral load
    Epidemiology
      ...
      Middle East Iran
    Transmission
      Mother to child breast
      Sexual male to female
      Blood transfusion
      IVDU needle sharing
    Pathogenesis
    ...
    Clinical
      ...
      Strongyloides risk
    Diagnosis
      HTLV-1 serology ELISA WB
      CSF HTLV-1 antibody
      Proviral load PCR
      MRI cord atrophy thoracic
      Exclude MS HIV SCD
    Treatment
      Physiotherapy
      Baclofen tizanidine
    ...
    Prognosis
      Slowly progressive
      Wheelchair 30-40 percent
      Survival 20 to 30 yr
```
