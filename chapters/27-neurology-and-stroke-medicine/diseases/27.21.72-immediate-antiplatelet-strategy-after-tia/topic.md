---
tags: [medicine, stroke-medicine, davidson, full-note, tia, antiplatelet]
chapter: Stroke Medicine
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 29: Stroke medicine
heading: Transient Ischaemic Attack
topic_group: TIA workup and immediate prevention
topic: Immediate antiplatelet strategy after TIA
...
```mermaid
flowchart TD
  A[Suspected TIA] --> B[Exclude hemorrhage and obvious mimic]
  B --> C[Is mechanism likely non-cardioembolic?]
  C -->|Yes| D[Start aspirin or selected early DAPT if high-risk and suitable]
  C -->|No/AF likely| E[Consider anticoagulation pathway after assessment]
  D --> F[Continue mechanism workup and secondary prevention]
```
