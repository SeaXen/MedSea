---
tags: [medicine, neurology, neuroophthalmology, visual-field, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Neurology
topic: Visual Field Defects
exam: [FCPS, MRCP Part 1, MRCP Part 2, PACES]
references:
  anatomy: ['Retina', 'Optic nerve', 'Optic chiasm', 'Optic tract', 'LGN', 'Optic radiations', 'Visual cortex']
  physiology: ['Visual pathway organisation', 'Retinotopic mapping']
  clinical: ['Davidson 24th Ed Ch25', 'Bradley 7th Ed', 'Kanski 9th Ed', 'MRCP PACES notes']
related: ['Optic Neuritis', 'Idiopathic Intracranial Hypertension', 'Pituitary Tumours', 'Stroke']
...
```mermaid
flowchart TD
    A[Visual Field Defect] --> B{Monocular or Binocular?}
    B -->|Monocular| C[Retina / Optic nerve]
    C --> D{Disc appearance}
    D -->|Swollen| E[Papillitis, NAION, CRVO]
    D -->|Pale| F[Optic neuritis, LHON, toxic]
    D -->|Normal| G[Retrobulbar ON, functional]
    B -->|Binocular| H{Pattern}
    H -->|Bitemporal| I[Chiasm → MRI pituitary + gad]
    H -->|Homonymous| J[Retrochiasmal → CT/MRI + CTA]
    J --> K{Congruity + Macula}
    K -->|Incongruous| L[Optic tract]
    K -->|Congruous, macular sparing| M[Occipital PCA]
    K -->|Superior quadrantanopia| N[Temporal lobe]
    K -->|Inferior quadrantanopia| O[Parietal lobe]
```
