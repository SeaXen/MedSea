...
```mermaid
mindmap
  root((Multiple System Atrophy))
    Pathology
      α-synucleinopathy
      Papp-Lantos inclusions
      Oligodendroglial
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Multiple System Atrophy*

**Q1.** Which of the following features is most specific or characteristic of Multiple System Atrophy?
...
**Q2.** What is the most appropriate first-line therapy for Multiple System Atrophy?
