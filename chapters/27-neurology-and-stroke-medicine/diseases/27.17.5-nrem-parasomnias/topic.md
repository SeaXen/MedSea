...
mindmap
  root((NREM Parasomnias))
    ...
    Pathophysiology
      Dissociation of sleep
      Arousal from N3 with incomplete awakening
      Motor cortex active
      Higher cognition asleep
    Clinical Features
      Confusion on waking
      Incomplete recall
      Automatic behaviour
    ...
    Differential
      ...
      OSA confusional arousals
    Investigations
      Polysomnography with extended EEG
      Video PSG
      Exclude OSA PLMD
    Management
      Reassurance
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — NREM Parasomnias*

**Q1.** Which of the following features is most specific or characteristic of NREM Parasomnias?
...
**Q2.** What is the most appropriate first-line therapy for NREM Parasomnias?
