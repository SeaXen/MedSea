---
tags: [medicine, neurology, myopathy, autoimmune, fcps, mrcp]
chapter: Neurology
...
references:
  clinical: ['Davidson 24th Ed Ch25', "Adams & Victor's Principles of Neurology", 'ENMC 2011 IBM Criteria', 'PasTest', 'MRCP Notes']
related: ['Polymyositis', 'Dermatomyositis', 'Inclusion Body Myositis', 'Muscle Disorders Hub']
...
```mermaid
flowchart TD
    A[Unknown Trigger in Older Adults] --> B[T-cell Mediated Inflammation]
    B --> C[CD8+ T cells invade MHC-I+ fibres]
    A --> D[Degenerative Proteinopathy]
    D --> E[TDP-43, p62, ubiquitin aggregates]
    E --> F[Rimmed vacuoles]
    E --> G[Mitochondrial dysfunction]
    C --> F
    F --> H[Segmental fibre loss]
    G --> H
```
