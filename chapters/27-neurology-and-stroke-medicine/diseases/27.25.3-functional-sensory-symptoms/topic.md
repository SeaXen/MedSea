---
tags: [medicine, neurology, davidson, functional-neurological-disorder, sensory-symptoms, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Functional Neurological Disorder
topic_group: Presentations
topic: Functional sensory symptoms
status: full-note
---
...
```mermaid
flowchart TD
A[Sensory complaint] --> B[Check for acute structural red flags]
B --> C{Pattern fits neuroanatomy?}
C -- Yes --> D[Investigate structural cause]
C -- No --> E[Repeat testing and look for positive functional clues]
E --> F[Diagnose functional sensory symptoms if supported]
F --> G[Explain positively and start rehab-oriented care]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Functional sensory symptoms*

**Q1.** What is the most appropriate first-line therapy for Functional sensory symptoms?

  - **A.** Give a positive and validating explanation
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Give a positive and validating explanation
  >
  > *Source:* Give a positive and validating explanation.
