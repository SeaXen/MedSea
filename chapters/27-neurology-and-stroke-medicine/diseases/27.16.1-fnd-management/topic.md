...
mindmap
  root((FND Management))
    ...
    Treatment pillars
      ...
      Pharmacotherapy
        SSRIs/SNRIs for comorbidity
        NOT for FND directly
        Treat migraine / pain / sleep
    Prognosis
      Better if
        Early diagnosis
        Belief in diagnosis
