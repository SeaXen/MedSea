...
```mermaid
mindmap
  root((Posterior Cortical Atrophy))
    Definition
      Visual_Variant_AD
      Posterior_Cortical_Degeneration
      AD_Pathology_Posterior_Predominance
    Epidemiology
      Onset_50_to_65_years
      Female_Predominance
      5_to_15_pct_of_AD
      Often_Presenilin_1
    Clinical_Balint
      ...
      Optic_Ataxia
      Oculomotor_Apraxia
      Cannot_Perceive_Whole
    Clinical_Gerstmann
      Acalculia
      Agraphia
      Finger_Agnosia
      Left_Right_Disorientation
    Other_Visual
      Visual_Agnosia
      Prosopagnosia
      Alexia_Without_Agraphia
      Dressing_Apraxia
      Visual_Field_Defects
      Visual_Hallucinations
    Memory_Language
      Relatively_Preserved_Early
      Insight_Often_Preserved
      Depression_Common
      Anxiety_About_Misdiagnosis
    Imaging
      Posterior_Atrophy_Knife_Edge
      Parieto_Occipital_Temporal
      Hippocampal_Sparing
      Boxcar_Ventricles
      FDG_PET_Posterior_Hypometabolism
    Biomarkers
      Amyloid_PET_Positive_80pct
      CSF_AB42_Low_Tau_High
      Tau_PET_Posterior
      APOE_4_Association
    Differential
      Typical_AD
    ...
    Management
      ...
      Memantine
      Visual_Aids_Environmental
      Occupational_Therapy
      Visual_Rehabilitation
      Support_Depression
    Prognosis
      Slower_than_AD
      Memory_Late
      Functional_Disability_Early
      Years_to_Dementia
```
