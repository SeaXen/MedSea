---
tags: [medicine, neurology, epilepsy, first-seizure, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: []
  physiology: []
  clinical: ['Davidson 24th Ed Ch25', 'NICE NG217', 'AAN Guidelines 2015', 'ILAE 2014 Practical Definition of Epilepsy', 'PasTest', 'MRCP Part 1/2 Notes']
related: ['Epilepsy & Seizure Disorders Hub', 'Seizure Classification & Diagnosis Hub', 'ILAE 2017 Seizure Classification', 'Status Epilepticus Management']
...
```mermaid
flowchart TD
    A[First Seizure Presentation] --> B[ABCDE + Stabilisation]
    B --> C[Detailed History + Witness]
    C --> D{Provoked or Unprovoked?}
    D -->|Provoked| E[Treat Cause + Limited ASM]
    D -->|Unprovoked| F[First-Line Investigations]
    E --> G[Identify Trigger]
    F --> H[Bloods + MRI + EEG]
    H --> I{Lesion or Epileptiform EEG?}
    I -->|Yes| J[High Recurrence Risk → ASM]
    I -->|No| K[Counsel on Recurrence + Safety]
    J --> L[Start ASM + Follow-up]
    K --> M[Watchful Waiting; Reassess if Recurs]
```
