...
topic: Paraneoplastic Neuropathy
...
```mermaid
mindmap
  root((Paraneoplastic Neuropathy))
    Subtypes
    ...
    Antibodies
      ...
      Anti-Ri ANNA2 SCLC breast
      Anti-Yo PCA1 less common
      Anti-GAD65 SPS associated
      Anti-MAG non-PNS WM
    Clinical features
      ...
      Asymmetric onset
    Investigations
      Nerve conduction absent SNAPs
      EMG denervation if motor
      CSF pleocytosis OCB
      Anti-neuronal antibodies
      Nerve biopsy axonal loss
      PET CT cancer screen
      CT chest mammogram pelvic US
    Management
      Tumour treatment
      Steroids IVIG PLEX
      ...
      Rehab physio OT
    Prognosis
      Better if tumour treated early
      Sensory neuronopathy often poor
      Anti-Hu worst
```
