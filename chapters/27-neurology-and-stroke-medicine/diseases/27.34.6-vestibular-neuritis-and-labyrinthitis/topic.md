---
tags: [medicine, neurology, davidson, vestibular, vertigo, vestibular-neuritis, labyrinthitis, peripheral-vertigo, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Vestibular Disorders
topic_group: Peripheral vestibular disorders
topic: Vestibular neuritis and labyrinthitis
exam: [FCPS, MRCP]
...
```mermaid
flowchart TD
A[Acute vertigo lasting hours-days] --> B{Hearing loss/tinnitus?}
B -->|No| C[Vestibular neuritis more likely]
B -->|Yes| D[Labyrinthitis / Ménière / other otologic causes]
C --> E[Assess for central red flags + bedside vestibular exam]
D --> E
E --> F{Peripheral pattern convincing and no red flags?}
F -->|Yes| G[Supportive treatment + vestibular rehabilitation]
F -->|No| H[Urgent neuroimaging/ENT-neuro reassessment]
```
