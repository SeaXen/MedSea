...
references:
  anatomy: []
  physiology: []
  clinical: ['Davidson 24th Ed Ch25', 'Neurology: A Clinician Approach', 'Adams and Victor Principles of Neurology', 'PasTest', 'MRCP Part 1/2 Notes', 'Personal notes']
related: []
...
```mermaid
flowchart TD
    A[Etiological Trigger] --> B[Pathophysiological Mechanism]
    B --> C[Cellular/Molecular Damage]
    C --> D[Structural/Functional Impairment]
    D --> E[Clinical Manifestations]
    E --> F[Diagnosis]
    F --> G[Management]
```
...
```mermaid
mindmap
  root((Vascular Dementia))
    Definition
      Dementia_Due_to_Cerebrovascular_Disease
      Second_Most_Common_Dementia
      Often_Preventable
    Epidemiology
      15_to_20_pct_of_Dementia
      Post_Stroke_Risk_5x
      Risk_Doubles_Every_5y
      Age_HTN_DM_Smoking
    Subtypes
      Multi_Infarct_Cortical
      Strategic_Infarct
      Subcortical_Binswanger
      Mixed_AD_Plus_Vascular
    Risk_Factors
      Hypertension_Most_Important
      Diabetes_Mellitus
      Atrial_Fibrillation
      Hyperlipidaemia
      Smoking
    ...
    Clinical_Features
      ...
      Memory_Less_Prominent_Early
      Pseudobulbar_Palsy
      Urinary_Symptoms
      Depression_Common
    Diagnosis_Criteria
      Hachinski_Ischaemic_Score_geq_7
      NINDS_AIREN_Probable_VaD
      DSM_5_Major_Vascular_Neurocognitive
      ICD_10
      Vascular_Impairment_Scale
    Investigations
      MRI_Brain_Mandatory
      White_Matter_Hyperintensities
      Lacunes
    ...
    Differential
      ...
      NPH
      Delirium
      Depression_Pseudodementia
    Management
      Vascular_Risk_Factor_Control
      Antihypertensives_Statin
      Anticoagulation_AF
      Antiplatelet_Stroke
      Cholinesterase_Inhibitors_Modest
      Memantine
      Rehabilitation
      Lifestyle
    Prognosis
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — Vascular Dementia*

**Q1.** Which of the following features is most specific or characteristic of Vascular Dementia?
...
**Q2.** What is the most appropriate first-line therapy for Vascular Dementia?
