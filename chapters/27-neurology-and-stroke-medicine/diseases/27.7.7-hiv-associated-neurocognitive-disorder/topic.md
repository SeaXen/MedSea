---
tags: [medicine, neurology, hiv, dementia, cognitive, hand, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: []
  physiology: []
  clinical: ['Davidson 24th Ed Ch25', 'Frascati Criteria 2007', 'BHIVA Guidelines', 'Adams and Victor Principles of Neurology', 'PasTest', 'MRCP Part 1/2 Notes', 'Personal notes']
related: ['Dementia Overview', 'HIV Neurology', 'PML', 'CNS Toxoplasmosis', 'Cryptococcal Meningitis']
...
```mermaid
flowchart TD
    A[HIV Infection] --> B[Monocyte/Macrophage Migration to CNS]
    B --> C[Microglial Activation]
    C --> D[Neurotoxic Viral Proteins gp120/Tat]
    D --> E[Excitotoxicity, Oxidative Stress]
    E --> F[Synaptic + Neuronal Loss]
    F --> G[Subcortical Cognitive Decline]
    H[Low CD4, High VL] --> I[OIs: Toxo, PML, Crypto, TB]
    I --> J[Differential for cognitive decline]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 27: Neurology & Stroke — HIV-Associated Neurocognitive Disorder*

**Q1.** What is the most appropriate first-line therapy for HIV-Associated Neurocognitive Disorder?
  ...
  > **Answer: A** — HAD: + immediately
  >
  > *Source:* **HAD:** Start ART **immediately** (no delay needed)
