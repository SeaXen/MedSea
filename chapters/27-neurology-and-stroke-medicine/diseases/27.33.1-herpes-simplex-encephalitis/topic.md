---
tags: [medicine, neurology, davidson, encephalitis, hsv, infection, emergency, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Parenchymal Viral Infections
topic_group: Encephalitis syndromes
...
references:
  ...
  physiology: [Guyton and Hall, Ganong]
related:
  - "[[../Neurology MOC|Neurology MOC]]"
  - "[[../Parenchymal Viral Infections|Parenchymal Viral Infections]]"
  - "[[Encephalitis syndromes|Encephalitis syndromes]]"
  - "[[Emergency treatment principles in viral encephalitis|Emergency treatment principles in viral encephalitis]]"
...
```mermaid
flowchart TD
  A[Acute febrile encephalopathy or temporal lobe syndrome] --> B[ABCDE, bedside glucose, IV access, bloods]
  B --> C[Take blood cultures if sepsis differential significant]
  C --> D[Start IV acyclovir immediately if HSE suspected]
  D --> E{Safe for LP now?}
  E -->|Yes| F[LP for CSF cells protein glucose PCR]
  E -->|No / focal deficit / reduced GCS / seizures / raised ICP concern| G[Urgent CT or MRI first]
  G --> H[Continue acyclovir and supportive care]
  F --> I[Send CSF HSV PCR and other tests as indicated]
  H --> I
  I --> J[Review MRI EEG CSF together]
  J --> K[Continue or stop acyclovir based on total clinical evidence]
```
...
```mermaid
mindmap
  root((Herpes simplex encephalitis))
    Emergency
    ...
    CSF
      ...
      HSV PCR
    MRI
      Medial temporal hyperintensity
    ...
    EEG
      Temporal slowing
      Periodic discharges
      Non-convulsive seizure detection
    Complications
      Status epilepticus
      Raised ICP
      SIADH hyponatremia
