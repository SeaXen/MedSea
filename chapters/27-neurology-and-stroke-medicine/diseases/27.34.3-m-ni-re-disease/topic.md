---
tags: [medicine, neurology, davidson, vestibular, meniere, vertigo, tinnitus, hearing-loss, fcps, mrcp]
chapter: Neurology
...
```mermaid
flowchart TD
A[Recurrent vertigo] --> B{Hearing symptoms present?}
B -->|Yes| C[Ménière/labyrinthine disorder more likely]
B -->|No| D[Consider BPPV, vestibular migraine, central causes]
C --> E{Minutes-hours recurrent attacks?}
E -->|Yes| F[Ménière disease favored]
E -->|No, continuous days| G[Think neuritis/labyrinthitis]
F --> H[Exclude red flags and arrange audiologic/ENT-neuro assessment]
```
