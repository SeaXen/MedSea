---
tags: [medicine, neurology, movement-disorders, parkinson, fcps, mrcp]
chapter: Neurology
...
references:
  anatomy: ['Basal Ganglia', 'Substantia Nigra pars compacta']
  physiology: ['Dopaminergic pathways']
  clinical: ['Davidson 24th Ed Ch25', 'MDS 2015 Criteria', 'NICE NG71', 'EAN 2023', 'PasTest', 'MRCP Notes']
related: ['Atypical Parkinsonism', 'Essential Tremor', 'Dystonia', 'Dementia with Lewy Bodies', 'REM Sleep Behaviour Disorder']
...
```mermaid
flowchart TD
    A[Genetic Susceptibility + Environmental Toxins] --> B[Mitochondrial Dysfunction]
    B --> C[α-Synuclein Misfolding/Aggregation]
    C --> D[Lewy Body Formation]
    D --> E[Substantia Nigra pars compacta Neuron Loss]
    E --> F[↓ Striatal Dopamine]
    F --> G[Direct Pathway↓ / Indirect Pathway↑]
    G --> H[Bradykinesia, Rigidity, Tremor]
```
...
mindmap
  root((Parkinson's Disease))
    ...
    Differential
      ET
      Atypical_MSA_PSP_CBD_DLB
      Drug_Induced
      Vascular
    Treatment
      Levodopa_DDCI
      DA_Ropi_Pramipexole
      MAOB_Selegiline_Rasagiline
      COMTi_Entacapone
      Advanced_DBS_Apomorphine_Duodopa
      NonMotor
    Complications
      Motor_Fluctuations
      Dyskinesias
