# Staphylococcal scalded skin syndrome emergency_full
...
heading: Emergencies
topic: Staphylococcal scalded skin syndrome emergency
...
Staphylococcal scalded skin syndrome (SSSS) is a dermatological emergency, generalised form of bullous impetigo from haematogenous spread of staphylococcal exfoliative toxins (ETA, ETB) cleaving desmoglein-1. Common in children <5 years (immature renal clearance of toxin); rare in adults (unless immunocompromised, renal failure). Features: fever, diffuse erythema, flaccid bullae, sheet-like desquamation, NO mucosal involvement (key distinguishing from SJS/TEN). Mortality children <5%, adults >50%. Treatment: IV antistaphylococcal antibiotics (flucloxacillin, vancomycin if MRSA), supportive (fluid, electrolyte), infection source identification.

## Clinical Features and Presentation

Staphylococcal scalded skin syndrome emergency presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Staph aureus exfoliative toxins (ETA, ETB) cleave Dsg1 |
| Age | Children <5 years (most common) |
| Mucosa | SPARED (vs SJS/TEN) |
| Skin | Diffuse erythema, flaccid bullae, sheet-like desquamation |
| Mortality | Children <5%; adults >50% |
| Source | Distant S. aureus (nasopharynx, conjunctiva, umbilicus) |
| Treatment | IV antistaphylococcal antibiotics; supportive |
| Differential | SJS/TEN (mucosa involved), TEN, pemphigus foliaceus |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| SJS/TEN | Mucosa involved |

## Viva Questions

1. **Q:** Define Staphylococcal scalded skin syndrome emergency and outline its classification.
   **A:** Staphylococcal scalded skin syndrome (SSSS) is a dermatological emergency, generalised form of bullous impetigo from haematogenous spread of staphylococcal exfoliative toxins (ETA, ETB) cleaving desmo

2. **Q:** What are the key clinical features of Staphylococcal scalded skin syndrome emergency?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Staphylococcal scalded skin syndrome emergency.
...
| **Topic** | **Staphylococcal scalded skin syndrome emergency** |
|-----------|-----------|
| **Definition** | Staphylococcal scalded skin syndrome (SSSS) is a dermatological emergency, generalised form of bullo |
| **Key Features** | Staph aureus exfoliative toxins (ETA, ETB) cleave Dsg1 |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Staphylococcal scalded skin syndrome emergency?
   A. Staph aureus exfoliative toxins (ETA, ETB) cleave Dsg1
...
5. **Q:** Key histological/serological feature?
   A. SJS/TEN (mucosa involved), TEN, pemphigus foliaceus
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Staphylococcal scalded skin syndrome emergency?
  **A:** Staph aureus exfoliative toxins (ETA, ETB) cleave Dsg1
- **Q:** Another key point?
  **A:** Children <5 years (most common)
- **Q:** Most important complication?
  **A:** SPARED (vs SJS/TEN)
- **Q:** First-line treatment?
  **A:** Diffuse erythema, flaccid bullae, sheet-like desquamation
- **Q:** Key histological/serological feature?
  **A:** Children <5%; adults >50%

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Staph aureus exfoliative toxins (ETA, ETB) cleave Dsg1
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: SJS/TEN (mucosa involved), TEN, pemphigus foliaceus
...
5. **A** — SJS/TEN (mucosa involved), TEN, pemphigus foliaceus
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Staphylococcal scalded skin syndrome emergency full*

**Q1.** What is the most appropriate first-line therapy for Staphylococcal scalded skin syndrome emergency full?
