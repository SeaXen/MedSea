...
Ataxia-telangiectasia (AT) is an autosomal recessive disorder due to ATM mutation (DNA repair, chromosome 11q22-23). Cerebellar ataxia (progressive, onset 1-4 years), oculocutaneous telangiectasias (conjunctiva, face, ears; onset 3-6 years), immunodeficiency (IgA deficiency, recurrent sinopulmonary infections), increased malignancy risk (especially lymphoma, leukaemia). Cutaneous: telangiectasias, café-au-lait macules, premature ageing, granulomas, hypopigmentation. Treatment: supportive (IVIG, antibiotics), surveillance for malignancy, ATM kinase inhibitors under investigation.

## Clinical Features and Presentation

Ataxia-telangiectasia presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
|----------|------------|
| Gene | ATM (DNA repair) |
| Onset | Cerebellar ataxia 1-4 years |
| Telangiectasia | Conjunctiva (classic), face, ears; 3-6 years |
| Immunodeficiency | IgA deficiency, recurrent sinopulmonary infections |
| Malignancy | Lymphoma, leukaemia, breast (heterozygous) |
| Skin | Telangiectasias, CALMs, premature ageing, granulomas |
| Sensitivity | Ionising radiation (avoid CT, use MRI) |
| AFP | Elevated serum AFP |
| Treatment | Supportive (IVIG, antibiotics), surveillance |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Cockayne | Photosensitivity, dwarfism, no ataxia |

## Viva Questions

1. **Q:** Define Ataxia-telangiectasia and outline its classification.
   **A:** Ataxia-telangiectasia (AT) is an autosomal recessive disorder due to ATM mutation (DNA repair, chromosome 11q22-23). Cerebellar ataxia (progressive, onset 1-4 years), oculocutaneous telangiectasias (c

2. **Q:** What are the key clinical features of Ataxia-telangiectasia?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Ataxia-telangiectasia.
...
| **Topic** | **Ataxia-telangiectasia** |
|-----------|-----------|
| **Definition** | Ataxia-telangiectasia (AT) is an autosomal recessive disorder due to ATM mutation (DNA repair, chrom |
| **Key Features** | ATM (DNA repair) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Ataxia-telangiectasia?
   A. ATM (DNA repair)
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Ataxia-telangiectasia?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Ataxia-telangiectasia?
...
5. **Q:** What is the key histological/serological feature?
   A. Supportive (IVIG, antibiotics), surveillance
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Ataxia-telangiectasia; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Ataxia-telangiectasia?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Ataxia-telangiectasia?
   A. Supportive (IVIG, antibiotics), surveillance
...
- **Q:** Key fact about Ataxia-telangiectasia?
  **A:** ATM (DNA repair)
- **Q:** Another key point?
  **A:** Cerebellar ataxia 1-4 years
- **Q:** Most important complication?
  **A:** Conjunctiva (classic), face, ears; 3-6 years
- **Q:** First-line treatment?
  **A:** IgA deficiency, recurrent sinopulmonary infections
- **Q:** Key histological/serological feature?
  **A:** Lymphoma, leukaemia, breast (heterozygous)

## Answer Key with Explanations

### MCQs
1. **A** — Gene: ATM (DNA repair)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Supportive (IVIG, antibiotics), surveillance
...
5. **A** — Supportive (IVIG, antibiotics), surveillance
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Ataxia-telangiectasia full*

**Q1.** What is the most appropriate first-line therapy for Ataxia-telangiectasia full?
