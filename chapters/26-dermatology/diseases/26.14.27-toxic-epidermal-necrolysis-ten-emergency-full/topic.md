...
heading: Emergencies
topic: Toxic epidermal necrolysis (TEN) emergency
...
# Toxic epidermal necrolysis (TEN) emergency
...
Toxic epidermal necrolysis (TEN) is a dermatological emergency with skin detachment >30% BSA, with similar features to SJS but more severe. Mortality 25-35%. Most commonly drug-induced. Treatment: stop drug, ICU/burns unit, supportive (fluid, electrolyte, nutrition, wound care, infection control), IVIG, ciclosporin, etanercept. SCORTEN score predicts mortality. Long-term sequelae: ocular (SJS/TEN), skin scarring, pigmentation, psychological.

## Clinical Features and Presentation

Toxic epidermal necrolysis (TEN) emergency presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| BSA | >30% (overlap 10-30%) |
| Mortality | 25-35% (SCORTEN ≥3) |
| Triggers | Drugs (sulfonamides, anticonvulsants, allopurinol) |
| Treatment | STOP drug; ICU/burns unit; supportive; IVIG, ciclosporin, etanercept |
| SCORTEN | Age, malignancy, HR, BSA, BUN, glucose, bicarb |
| Sequelae | Ocular, skin, pigmentation, psychological |
...
1. **Q:** Define Toxic epidermal necrolysis (TEN) emergency and outline its classification.
   **A:** Toxic epidermal necrolysis (TEN) is a dermatological emergency with skin detachment >30% BSA, with similar features to SJS but more severe. Mortality 25-35%. Most commonly drug-induced. Treatment: sto

2. **Q:** What are the key clinical features of Toxic epidermal necrolysis (TEN) emergency?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Toxic epidermal necrolysis (TEN) emergency.
...
| **Topic** | **Toxic epidermal necrolysis (TEN) emergency** |
|-----------|-----------|
| **Definition** | Toxic epidermal necrolysis (TEN) is a dermatological emergency with skin detachment >30% BSA, with s |
| **Key Features** | >30% (overlap 10-30%) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Toxic epidermal necrolysis (TEN) emergency?
   A. >30% (overlap 10-30%)
...
5. **Q:** Key histological/serological feature?
   A. Ocular, skin, pigmentation, psychological
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Toxic epidermal necrolysis (TEN) emergency?
  **A:** >30% (overlap 10-30%)
- **Q:** Another key point?
  **A:** 25-35% (SCORTEN ≥3)
- **Q:** Most important complication?
  **A:** Drugs (sulfonamides, anticonvulsants, allopurinol)
- **Q:** First-line treatment?
  **A:** STOP drug; ICU/burns unit; supportive; IVIG, ciclosporin, etanercept
- **Q:** Key histological/serological feature?
  **A:** Age, malignancy, HR, BSA, BUN, glucose, bicarb

## Answer Key with Explanations

### MCQs
1. **A** — BSA: >30% (overlap 10-30%)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Sequelae: Ocular, skin, pigmentation, psychological
...
5. **A** — Ocular, skin, pigmentation, psychological
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Toxic epidermal necrolysis (TEN) emergency full*

**Q1.** What is the most appropriate first-line therapy for Toxic epidermal necrolysis (TEN) emergency full?
