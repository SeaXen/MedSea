...
Drug-induced lupus (DIL) is a lupus-like syndrome triggered by medications. Most common drugs: hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors. Typically presents with arthralgia, myalgia, serositis, but skin involvement is less common than in idiopathic SLE (rash in 10-20%). Anti-histone antibodies are the hallmark (95% of DIL). Resolves with drug withdrawal.
...
| Category | Key Points |
|----------|------------|
| Common drugs | Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors |
| Anti-histone | Positive in 95% (hallmark) |
| Anti-dsDNA | Usually negative (vs idiopathic SLE positive) |
| ANA | Positive |
| Skin | Less common than idiopathic SLE (10-20%) |
| Symptoms | Arthralgia, myalgia, serositis (pleuritis, pericarditis), fever |
| Renal/CNS | Rare (vs idiopathic SLE) |
| Onset | Months to years of drug use |
| Resolution | Weeks-months after drug withdrawal (usually complete) |
| Slow acetylators | Higher risk (hydralazine, procainamide) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Idiopathic SLE | Anti-dsDNA+, more skin involvement, renal/CNS |

## Viva Questions

1. **Q:** Define Drug-induced lupus and outline its classification.
   **A:** Drug-induced lupus (DIL) is a lupus-like syndrome triggered by medications. Most common drugs: hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors.

2. **Q:** What are the key clinical features of Drug-induced lupus?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Drug-induced lupus.
...
1. **DIL drugs SHIPP-MC** = Sulfasalazine, Hydralazine, Isoniazid, Procainamide, Phenytoin, Minocycline, Chlorpromazine
...
| **Topic** | **Drug-induced lupus** |
|-----------|-----------|
| **Definition** | Drug-induced lupus (DIL) is a lupus-like syndrome triggered by medications. Most common drugs: hydra |
| **Key Features** | Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Drug-induced lupus?
   A. Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Common drugs: Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors*
2. **Q:** What is the first-line treatment for Drug-induced lupus?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Drug-induced lupus?
...
4. **Q:** What is the most important complication of Drug-induced lupus?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Drug-induced lupus?
   A. Higher risk (hydralazine, procainamide)
...
## SBA Questions (5)
1. **Scenario:** Patient with Drug-induced lupus; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Drug-induced lupus failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Drug-induced lupus?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Drug-induced lupus?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Drug-induced lupus?
   A. Higher risk (hydralazine, procainamide)
...
- **Q:** Key fact about Drug-induced lupus?
  **A:** Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors
- **Q:** Another key point?
  **A:** Positive in 95% (hallmark)
- **Q:** Most important complication?
  **A:** Usually negative (vs idiopathic SLE positive)
- **Q:** First-line treatment?
  **A:** Positive
- **Q:** Key histological/serological feature?
  **A:** Less common than idiopathic SLE (10-20%)

## Answer Key with Explanations

### MCQs
1. **A** — Common drugs: Hydralazine, procainamide, isoniazid, minocycline, quinidine, methyldopa, chlorpromazine, TNF inhibitors
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Slow acetylators: Higher risk (hydralazine, procainamide)
...
5. **A** — Higher risk (hydralazine, procainamide)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Drug-induced lupus full*

**Q1.** What is the most appropriate first-line therapy for Drug-induced lupus full?
