...
topic: Herpes simplex, varicella-zoster
...
Herpes simplex virus (HSV-1, HSV-2) and varicella-zoster virus (VZV) are enveloped DNA viruses. HSV-1: predominantly orolabial; HSV-2: predominantly genital. VZV: varicella (primary), herpes zoster (reactivation). All establish lifelong latency in sensory ganglia. Both present as grouped vesicles on erythematous base.

## Clinical Features and Presentation

Herpes simplex, varicella-zoster presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| HSV-1 | Predominantly orolabial (gingivostomatitis, herpes labialis) |
| HSV-2 | Predominantly genital |
| VZV primary | Varicella (chickenpox) — centripetal, fever |
| VZV reactivation | Herpes zoster (shingles) — dermatomal |
| Latency | HSV: trigeminal/sacral ganglia; VZV: dorsal root ganglia |
| Lesions | Grouped vesicles on erythematous base, pustules, erosions, crust |
| Tzanck smear | Multinucleated giant cells (positive in HSV, VZV) |
| Diagnosis | PCR (gold standard), viral culture, DFA, Tzanck |
| Treatment | Aciclovir, valaciclovir, famciclovir; topical aciclovir for mild HSV labialis |
| Complications | Eczema herpeticum, neonatal HSV, VZV pneumonia, post-herpetic neuralgia |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Impetigo | Honey crust, not grouped vesicles |

## Viva Questions

1. **Q:** Define Herpes simplex, varicella-zoster and outline its classification.
   **A:** Herpes simplex virus (HSV-1, HSV-2) and varicella-zoster virus (VZV) are enveloped DNA viruses. HSV-1: predominantly orolabial; HSV-2: predominantly genital. VZV: varicella (primary), herpes zoster (r

2. **Q:** What are the key clinical features of Herpes simplex, varicella-zoster?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Herpes simplex, varicella-zoster.
...
1. **HSV/VZV** = Grouped vesicles, dermatomal, Tzanck+, PCR+
...
| **Topic** | **Herpes simplex, varicella-zoster** |
|-----------|-----------|
| **Definition** | Herpes simplex virus (HSV-1, HSV-2) and varicella-zoster virus (VZV) are enveloped DNA viruses. HSV- |
| **Key Features** | Predominantly orolabial (gingivostomatitis, herpes labialis) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Herpes simplex, varicella-zoster?
   A. Predominantly orolabial (gingivostomatitis, herpes labialis)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *HSV-1: Predominantly orolabial (gingivostomatitis, herpes labialis)*
2. **Q:** What is the first-line treatment for Herpes simplex, varicella-zoster?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Herpes simplex, varicella-zoster?
...
4. **Q:** What is the most important complication of Herpes simplex, varicella-zoster?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Herpes simplex, varicella-zoster?
   A. Eczema herpeticum, neonatal HSV, VZV pneumonia, post-herpetic neuralgia
...
## SBA Questions (5)
1. **Scenario:** Patient with Herpes simplex, varicella-zoster; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Herpes simplex, varicella-zoster failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Herpes simplex, varicella-zoster?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Herpes simplex, varicella-zoster?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Herpes simplex, varicella-zoster?
   A. Eczema herpeticum, neonatal HSV, VZV pneumonia, post-herpetic neuralgia
...
- **Q:** Key fact about Herpes simplex, varicella-zoster?
  **A:** Predominantly orolabial (gingivostomatitis, herpes labialis)
- **Q:** Another key point?
  **A:** Predominantly genital
- **Q:** Most important complication?
  **A:** Varicella (chickenpox) — centripetal, fever
- **Q:** First-line treatment?
  **A:** Herpes zoster (shingles) — dermatomal
- **Q:** Key histological/serological feature?
  **A:** HSV: trigeminal/sacral ganglia; VZV: dorsal root ganglia

## Answer Key with Explanations

### MCQs
1. **A** — HSV-1: Predominantly orolabial (gingivostomatitis, herpes labialis)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Complications: Eczema herpeticum, neonatal HSV, VZV pneumonia, post-herpetic neuralgia
...
5. **A** — Eczema herpeticum, neonatal HSV, VZV pneumonia, post-herpetic neuralgia
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Herpes simplex, varicella-zoster full*

**Q1.** What is the most appropriate first-line therapy for Herpes simplex, varicella-zoster full?
