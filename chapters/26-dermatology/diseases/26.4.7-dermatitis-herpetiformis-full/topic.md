...
Dermatitis herpetiformis (DH) is an intensely pruritic, chronic, recurrent, autoimmune blistering disease with IgA deposits at dermal papillae tips. Strong association with coeliac disease (95% have gluten-sensitive enteropathy, often subclinical) and HLA-DQ2/DQ8. Treatment: gluten-free diet plus dapsone.
...
| Category | Key Points |
|----------|------------|
| Distribution | Extensor surfaces (elbows, knees, buttocks), scalp, back |
| Lesions | Grouped vesicles/papules on erythematous base (herpetiform) |
| Pruritus | Intensely pruritic (often excoriations, not intact vesicles) |
| Coeliac | 95% have gluten-sensitive enteropathy (often subclinical) |
| HLA | DQ2/DQ8 |
| DIF | Granular IgA (±C3) at dermal papillae tips (pathognomonic) |
| Serology | Anti-tissue transglutaminase (anti-tTG), anti-endomysial (EMA), anti-DGP |
| Histology | Subepidermal split with neutrophils in papillary tips |
| Treatment | Gluten-free diet (GFD) + dapsone first-line drug |
| Complications | Lymphoma (enteropathy-associated T-cell), small bowel lymphoma |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Scabies | Burrows, web spaces, family |

## Viva Questions

1. **Q:** Define Dermatitis herpetiformis and outline its classification.
   **A:** Dermatitis herpetiformis (DH) is an intensely pruritic, chronic, recurrent, autoimmune blistering disease with IgA deposits at dermal papillae tips. Strong association with coeliac disease (95% have g

2. **Q:** What are the key clinical features of Dermatitis herpetiformis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Dermatitis herpetiformis.
...
1. **DH = gluten** = Dermatitis Herpetiformis = gluten-sensitive enteropathy
...
| **Topic** | **Dermatitis herpetiformis** |
|-----------|-----------|
| **Definition** | Dermatitis herpetiformis (DH) is an intensely pruritic, chronic, recurrent, autoimmune blistering di |
| **Key Features** | Extensor surfaces (elbows, knees, buttocks), scalp, back |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Dermatitis herpetiformis?
   A. Extensor surfaces (elbows, knees, buttocks), scalp, back
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Distribution: Extensor surfaces (elbows, knees, buttocks), scalp, back*
2. **Q:** What is the first-line treatment for Dermatitis herpetiformis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Dermatitis herpetiformis?
...
4. **Q:** What is the most important complication of Dermatitis herpetiformis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Dermatitis herpetiformis?
   A. Lymphoma (enteropathy-associated T-cell), small bowel lymphoma
...
## SBA Questions (5)
1. **Scenario:** Patient with Dermatitis herpetiformis; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Dermatitis herpetiformis failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Dermatitis herpetiformis?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Dermatitis herpetiformis?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Dermatitis herpetiformis?
   A. Lymphoma (enteropathy-associated T-cell), small bowel lymphoma
...
- **Q:** Key fact about Dermatitis herpetiformis?
  **A:** Extensor surfaces (elbows, knees, buttocks), scalp, back
- **Q:** Another key point?
  **A:** Grouped vesicles/papules on erythematous base (herpetiform)
- **Q:** Most important complication?
  **A:** Intensely pruritic (often excoriations, not intact vesicles)
- **Q:** First-line treatment?
  **A:** 95% have gluten-sensitive enteropathy (often subclinical)
...
### MCQs
1. **A** — Distribution: Extensor surfaces (elbows, knees, buttocks), scalp, back
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Complications: Lymphoma (enteropathy-associated T-cell), small bowel lymphoma
...
5. **A** — Lymphoma (enteropathy-associated T-cell), small bowel lymphoma
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Dermatitis herpetiformis full*

**Q1.** What is the most appropriate first-line therapy for Dermatitis herpetiformis full?
