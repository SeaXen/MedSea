...
Epidermal growth factor receptor (EGFR) inhibitor rash is a common cutaneous adverse effect of EGFR-targeted therapies (cetuximab, panitumumab, gefitinib, erlotinib, afatinib, osimertinib). Occurs in 60-80% of patients, usually within first 1-2 weeks. Characterised by papulopustular (acneiform) eruption on face, scalp, chest, back; sterile follicular papules/pustules; may be severe. Not true acne (no comedones).

## Clinical Features and Presentation

EGFR inhibitor rash presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Incidence | 60-80% of patients on EGFR inhibitors |
| Onset | Days to weeks of starting therapy |
| Drugs | Cetuximab, panitumumab, gefitinib, erlotinib, afatinib, osimertinib |
| Distribution | Face, scalp, chest, back (seborrheic areas) |
| Morphology | Papulopustular (acneiform); sterile follicular papules/pustules |
| Comedones | Absent (vs true acne) |
| Grading | CTCAE v5: G1 (less than 10% BSA), G2 (10-30%), G3 (more than 30%), G4 (any with extensive superinfection) |
| Other cutaneous | Xerosis, paronychia, hair changes (curly, brittle, alopecia) |
| Treatment | Topical metronidazole, clindamycin; oral tetracyclines (doxycycline 100mg BD); isotretinoin for severe |
| Prophylaxis | Oral tetracyclines reduce incidence and severity |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Acne vulgaris | Comedones present, slower onset |

## Viva Questions

1. **Q:** Define EGFR inhibitor rash and outline its classification.
   **A:** Epidermal growth factor receptor (EGFR) inhibitor rash is a common cutaneous adverse effect of EGFR-targeted therapies (cetuximab, panitumumab, gefitinib, erlotinib, afatinib, osimertinib). Occurs in 

2. **Q:** What are the key clinical features of EGFR inhibitor rash?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of EGFR inhibitor rash.
...
1. **EGFR rash** = Papulopustular, no comedones, seborrheic areas
...
| **Topic** | **EGFR inhibitor rash** |
|-----------|-----------|
| **Definition** | Epidermal growth factor receptor (EGFR) inhibitor rash is a common cutaneous adverse effect of EGFR- |
| **Key Features** | 60-80% of patients on EGFR inhibitors |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of EGFR inhibitor rash?
   A. 60-80% of patients on EGFR inhibitors
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Incidence: 60-80% of patients on EGFR inhibitors*
2. **Q:** What is the first-line treatment for EGFR inhibitor rash?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for EGFR inhibitor rash?
...
4. **Q:** What is the most important complication of EGFR inhibitor rash?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of EGFR inhibitor rash?
   A. Oral tetracyclines reduce incidence and severity
...
## SBA Questions (5)
1. **Scenario:** Patient with EGFR inhibitor rash; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** EGFR inhibitor rash failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of EGFR inhibitor rash?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for EGFR inhibitor rash?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in EGFR inhibitor rash?
   A. Oral tetracyclines reduce incidence and severity
...
- **Q:** Key fact about EGFR inhibitor rash?
  **A:** 60-80% of patients on EGFR inhibitors
- **Q:** Another key point?
  **A:** Days to weeks of starting therapy
- **Q:** Most important complication?
  **A:** Cetuximab, panitumumab, gefitinib, erlotinib, afatinib, osimertinib
- **Q:** First-line treatment?
  **A:** Face, scalp, chest, back (seborrheic areas)
- **Q:** Key histological/serological feature?
  **A:** Papulopustular (acneiform); sterile follicular papules/pustules

## Answer Key with Explanations

### MCQs
1. **A** — Incidence: 60-80% of patients on EGFR inhibitors
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prophylaxis: Oral tetracyclines reduce incidence and severity
...
5. **A** — Oral tetracyclines reduce incidence and severity
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — EGFR inhibitor rash full*

**Q1.** What is the most appropriate first-line therapy for EGFR inhibitor rash full?
