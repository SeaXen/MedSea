...
Keratosis pilaris (KP, 'chicken skin') is a common, benign, follicular hyperkeratosis disorder, with rough follicular papules, often with surrounding erythema, on extensor surfaces (upper arms, thighs, buttocks, cheeks). Common in children, improves with age. Strongly associated with atopic dermatitis, ichthyosis vulgaris (FLG mutations). Histology: keratin plug in hair follicle, mild inflammation. Treatment: emollients, urea 10-20%, salicylic acid, lactic acid, topical retinoids (low concentration). Self-limiting.

## Clinical Features and Presentation

Keratosis pilaris presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Common | Very common, especially in children, atopic |
| Cause | Follicular hyperkeratosis, FLG mutation |
| Distribution | Extensor: upper arms, thighs, buttocks, cheeks |
| Appearance | Rough follicular papules, ±erythema |
| Associations | Atopic dermatitis, ichthyosis vulgaris |
| Types | KP rubra (red), KP alba (white, no erythema), KP atrophicans (atrophy, facial) |
| Histology | Keratin plug in hair follicle |
| Differential | Folliculitis, acne, milia, phrynoderma (vit A) |
| Treatment | Emollients, urea 10-20%, salicylic acid, lactic acid, topical retinoids |
...
|--------------|------------------------|
| Folliculitis | Pustular, infected |

## Viva Questions

1. **Q:** Define Keratosis pilaris and outline its classification.
   **A:** Keratosis pilaris (KP, 'chicken skin') is a common, benign, follicular hyperkeratosis disorder, with rough follicular papules, often with surrounding erythema, on extensor surfaces (upper arms, thighs

2. **Q:** What are the key clinical features of Keratosis pilaris?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Keratosis pilaris.
...
| **Topic** | **Keratosis pilaris** |
|-----------|-----------|
| **Definition** | Keratosis pilaris (KP, 'chicken skin') is a common, benign, follicular hyperkeratosis disorder, with |
| **Key Features** | Very common, especially in children, atopic |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Keratosis pilaris?
   A. Very common, especially in children, atopic
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Keratosis pilaris?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Keratosis pilaris?
...
## SBA Questions (5)
1. **Scenario:** Patient with Keratosis pilaris; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Keratosis pilaris?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Keratosis pilaris?
   A. Improves with age
...
- **Q:** Key fact about Keratosis pilaris?
  **A:** Very common, especially in children, atopic
- **Q:** Another key point?
  **A:** Follicular hyperkeratosis, FLG mutation
- **Q:** Most important complication?
  **A:** Extensor: upper arms, thighs, buttocks, cheeks
- **Q:** First-line treatment?
  **A:** Rough follicular papules, ±erythema
- **Q:** Key histological/serological feature?
  **A:** Atopic dermatitis, ichthyosis vulgaris

## Answer Key with Explanations

### MCQs
1. **A** — Common: Very common, especially in children, atopic
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prognosis: Improves with age
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Keratosis pilaris full*

**Q1.** What is the most appropriate first-line therapy for Keratosis pilaris full?
