...
Darier disease (keratosis follicularis) is an autosomal dominant disorder due to ATP2A2 mutation (SERCA2, calcium pump). Onset in adolescence. Greasy, hyperkeratotic, skin-coloured/brown papules in seborrhoeic areas (chest, back, face, scalp), with characteristic 'dirty' appearance, coalescing into plaques, malodorous. Other: palmoplantar pits, nail changes (V-shaped nick at free edge, longitudinal red/white lines, subungual hyperkeratosis), oral papules, acrokeratosis verruciformis-like lesions on dorsa of hands/feet. Histology: acantholysis with corps ronds (large dyskeratotic cells in upper epidermis) and grains (smaller dyskeratotic cells). Treatment: topical retinoids, keratolytics, oral retinoids (acitretin), antibiotics for secondary infection.

## Clinical Features and Presentation

Darier disease presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Gene | ATP2A2 (SERCA2, calcium pump) |
| Inheritance | Autosomal dominant |
| Onset | Adolescence |
| Sites | Seborrhoeic (chest, back, face, scalp, flexures) |
| Papules | Greasy, hyperkeratotic, brown, coalesce; malodorous |
| Nails | V-shaped nick at free edge, longitudinal red/white lines, subungual hyperkeratosis |
| Acrokeratosis | Verrucous papules on dorsa of hands/feet |
| Mucosa | Oral papules (cobblestone) |
| Histology | Corps ronds (large dyskeratotic), grains (small dyskeratotic), acantholysis |
| Treatment | Topical/oral retinoids (acitretin), keratolytics, emollients, antibiotics for infection |
| Flares | Heat, sweat, sunlight, lithium |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Hailey-Hailey | Intertriginous, no nail changes |

## Viva Questions

1. **Q:** Define Darier disease and outline its classification.
   **A:** Darier disease (keratosis follicularis) is an autosomal dominant disorder due to ATP2A2 mutation (SERCA2, calcium pump). Onset in adolescence. Greasy, hyperkeratotic, skin-coloured/brown papules in se

2. **Q:** What are the key clinical features of Darier disease?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Darier disease.
...
| **Topic** | **Darier disease** |
|-----------|-----------|
| **Definition** | Darier disease (keratosis follicularis) is an autosomal dominant disorder due to ATP2A2 mutation (SE |
| **Key Features** | ATP2A2 (SERCA2, calcium pump) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Darier disease?
   A. ATP2A2 (SERCA2, calcium pump)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Darier disease?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Darier disease?
...
## SBA Questions (5)
1. **Scenario:** Patient with Darier disease; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Darier disease?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Darier disease?
   A. Heat, sweat, sunlight, lithium
...
- **Q:** Key fact about Darier disease?
  **A:** ATP2A2 (SERCA2, calcium pump)
- **Q:** Another key point?
...
- **Q:** First-line treatment?
  **A:** Seborrhoeic (chest, back, face, scalp, flexures)
- **Q:** Key histological/serological feature?
  **A:** Greasy, hyperkeratotic, brown, coalesce; malodorous

## Answer Key with Explanations

### MCQs
1. **A** — Gene: ATP2A2 (SERCA2, calcium pump)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Flares: Heat, sweat, sunlight, lithium
...
5. **A** — Heat, sweat, sunlight, lithium
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Darier disease full*

**Q1.** What is the most appropriate first-line therapy for Darier disease full?
