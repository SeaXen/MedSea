...
topic: mTOR inhibitor stomatitis-rash
...
mTOR inhibitors (sirolimus, everolimus, temsirolimus) are used in transplant immunosuppression and cancer (renal cell carcinoma, breast cancer, neuroendocrine tumours). Common cutaneous/mucosal adverse effects: aphthous stomatitis (very common, ~50%), maculopapular rash, acneiform eruption, oedema, delayed wound healing.

## Clinical Features and Presentation

mTOR inhibitor stomatitis-rash presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Drugs | Sirolimus, everolimus, temsirolimus |
| Aphthous stomatitis | Most common AE (40-60%); oral ulcers, often dose-limiting |
| Timing | Often within first 2-4 weeks |
| Rash | Maculopapular, acneiform (15-25%) |
| Oedema | Peripheral, facial, lymphoedema |
| Wound healing | Delayed (mTOR important in healing) |
| Hyperglycaemia | Common |
| Hyperlipidaemia | Common (hypertriglyceridaemia, hypercholesterolaemia |
| Treatment | Topical steroids for stomatitis; dose reduction; topical clindamycin for rash; metformin for hyperglycaemia |
| Differential | HSV, aphthous stomatitis (idiopathic), Behçet |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| HSV stomatitis | Widespread, fever, vesicles, lymphadenopathy |

## Viva Questions

1. **Q:** Define mTOR inhibitor stomatitis-rash and outline its classification.
   **A:** mTOR inhibitors (sirolimus, everolimus, temsirolimus) are used in transplant immunosuppression and cancer (renal cell carcinoma, breast cancer, neuroendocrine tumours). Common cutaneous/mucosal advers

2. **Q:** What are the key clinical features of mTOR inhibitor stomatitis-rash?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of mTOR inhibitor stomatitis-rash.
...
1. **mTORi AEs** = Stomatitis, rash, oedema, poor healing, hyperglycaemia, lipids
...
| **Topic** | **mTOR inhibitor stomatitis-rash** |
|-----------|-----------|
| **Definition** | mTOR inhibitors (sirolimus, everolimus, temsirolimus) are used in transplant immunosuppression and c |
| **Key Features** | Sirolimus, everolimus, temsirolimus |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of mTOR inhibitor stomatitis-rash?
   A. Sirolimus, everolimus, temsirolimus
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Drugs: Sirolimus, everolimus, temsirolimus*
2. **Q:** What is the first-line treatment for mTOR inhibitor stomatitis-rash?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for mTOR inhibitor stomatitis-rash?
...
4. **Q:** What is the most important complication of mTOR inhibitor stomatitis-rash?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of mTOR inhibitor stomatitis-rash?
   A. HSV, aphthous stomatitis (idiopathic), Behçet
...
## SBA Questions (5)
1. **Scenario:** Patient with mTOR inhibitor stomatitis-rash; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** mTOR inhibitor stomatitis-rash failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of mTOR inhibitor stomatitis-rash?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for mTOR inhibitor stomatitis-rash?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in mTOR inhibitor stomatitis-rash?
   A. HSV, aphthous stomatitis (idiopathic), Behçet
...
- **Q:** Key fact about mTOR inhibitor stomatitis-rash?
  **A:** Sirolimus, everolimus, temsirolimus
- **Q:** Another key point?
  **A:** Most common AE (40-60%); oral ulcers, often dose-limiting
- **Q:** Most important complication?
  **A:** Often within first 2-4 weeks
- **Q:** First-line treatment?
  **A:** Maculopapular, acneiform (15-25%)
- **Q:** Key histological/serological feature?
  **A:** Peripheral, facial, lymphoedema

## Answer Key with Explanations

### MCQs
1. **A** — Drugs: Sirolimus, everolimus, temsirolimus
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: HSV, aphthous stomatitis (idiopathic), Behçet
...
5. **A** — HSV, aphthous stomatitis (idiopathic), Behçet
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — mTOR inhibitor stomatitis-rash full*

**Q1.** What is the most appropriate first-line therapy for mTOR inhibitor stomatitis-rash full?
