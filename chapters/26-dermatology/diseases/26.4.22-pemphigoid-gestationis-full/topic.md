...
Pemphigoid gestationis (formerly herpes gestationis) is a rare autoimmune subepidermal blistering disease of pregnancy (typically 2nd to 3rd trimester, sometimes postpartum). Autoantibodies against BP180 (collagen XVII) — NC16A domain. Cross-reactivity with placental antigens. Associated with preterm and small-for-gestational-age babies.

## Clinical Features and Presentation

Pemphigoid gestationis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Timing | 2nd to 3rd trimester (most common); may flare postpartum |
| Target | BP180 NC16A domain; cross-reacts with placenta |
| DIF | Linear C3 (±IgG) at BMZ |
| ELISA | BP180 NC16A positive |
| Distribution | Periumbilical early, then trunk, limbs; spares face, mucosa, palms/soles |
| Lesions | Urticarial papules/plaques, vesicles, bullae |
| Pruritus | Severe |
| Foetal risk | Preterm, SGA; transient neonatal rash 5-10% |
| Treatment | Topical/superpotent steroids, antihistamines, prednisolone if severe; ciclosporin if refractory; avoid dapsone |
| Differential | PUPPP (no blistering, no DIF, no autoantibodies) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| PUPPP | No bullae, no DIF+, no autoantibodies, no foetal risk |

## Viva Questions

1. **Q:** Define Pemphigoid gestationis and outline its classification.
   **A:** Pemphigoid gestationis (formerly herpes gestationis) is a rare autoimmune subepidermal blistering disease of pregnancy (typically 2nd to 3rd trimester, sometimes postpartum). Autoantibodies against BP

2. **Q:** What are the key clinical features of Pemphigoid gestationis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Pemphigoid gestationis.
...
1. **PG vs PUPPP** = PG = bullae + DIF+ + BP180 Ab; PUPPP = pruritic papules only
...
|-----------|---------------|
| **Pregnancy** | Avoid dapsone (neonatal haemolysis); topical/systemic steroids safe |

## One-Page Revision Card

| **Topic** | **Pemphigoid gestationis** |
|-----------|-----------|
| **Definition** | Pemphigoid gestationis (formerly herpes gestationis) is a rare autoimmune subepidermal blistering di |
| **Key Features** | 2nd to 3rd trimester (most common); may flare postpartum |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Pemphigoid gestationis?
   A. 2nd to 3rd trimester (most common); may flare postpartum
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Timing: 2nd to 3rd trimester (most common); may flare postpartum*
2. **Q:** What is the first-line treatment for Pemphigoid gestationis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Pemphigoid gestationis?
...
4. **Q:** What is the most important complication of Pemphigoid gestationis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Pemphigoid gestationis?
   A. PUPPP (no blistering, no DIF, no autoantibodies)
...
## SBA Questions (5)
1. **Scenario:** Patient with Pemphigoid gestationis; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Pemphigoid gestationis failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Pemphigoid gestationis?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Pemphigoid gestationis?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Pemphigoid gestationis?
   A. PUPPP (no blistering, no DIF, no autoantibodies)
...
- **Q:** Key fact about Pemphigoid gestationis?
  **A:** 2nd to 3rd trimester (most common); may flare postpartum
- **Q:** Another key point?
  **A:** BP180 NC16A domain; cross-reacts with placenta
- **Q:** Most important complication?
  **A:** Linear C3 (±IgG) at BMZ
- **Q:** First-line treatment?
  **A:** BP180 NC16A positive
- **Q:** Key histological/serological feature?
  **A:** Periumbilical early, then trunk, limbs; spares face, mucosa, palms/soles

## Answer Key with Explanations

### MCQs
1. **A** — Timing: 2nd to 3rd trimester (most common); may flare postpartum
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: PUPPP (no blistering, no DIF, no autoantibodies)
...
5. **A** — PUPPP (no blistering, no DIF, no autoantibodies)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Pemphigoid gestationis full*

**Q1.** What is the most appropriate first-line therapy for Pemphigoid gestationis full?
