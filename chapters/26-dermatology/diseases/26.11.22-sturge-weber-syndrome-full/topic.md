...
Sturge-Weber syndrome (SWS, encephalotrigeminal angiomatosis) is a sporadic neurocutaneous disorder with facial port-wine stain (capillary malformation) in V1 distribution (forehead, upper eyelid), leptomeningeal angioma (ipsilateral to skin lesion, seizures, hemiparesis, intellectual disability), and ocular (glaucoma, choroidal haemangioma). Caused by somatic mosaic mutation in GNAQ. Risk of seizures (75%, often in first year), stroke-like episodes, developmental delay. Treatment: laser (pulsed dye) for port-wine stain; anticonvulsants; glaucoma management; aspirin (controversial for stroke prevention).

## Clinical Features and Presentation

Sturge-Weber syndrome presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Somatic mosaic GNAQ mutation |
| Skin | Port-wine stain (capillary malformation), V1 (forehead, upper eyelid) — but ANY facial PWS can have SWS |
| CNS | Leptomeningeal angioma; seizures (75%); hemiparesis; stroke-like episodes; intellectual disability |
| Eye | Glaucoma (30-70%), choroidal haemangioma, buphtalmos |
| Diagnosis | Clinical + MRI brain with contrast (leptomeningeal enhancement) + ophthalmology |
| Staining | Stains in V1 distribution (forehead, upper eyelid) |
| Treatment | Pulsed dye laser for PWS; anticonvulsants; glaucoma treatment; aspirin controversial |
| Sturge-Weber | Bilateral PWS (rare), more severe |
| Phakomatosis | Pigmentovascularis: PWS + dermal melanocytosis |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Salmon patch | Viral, transient, midline |

## Viva Questions

1. **Q:** Define Sturge-Weber syndrome and outline its classification.
   **A:** Sturge-Weber syndrome (SWS, encephalotrigeminal angiomatosis) is a sporadic neurocutaneous disorder with facial port-wine stain (capillary malformation) in V1 distribution (forehead, upper eyelid), le

2. **Q:** What are the key clinical features of Sturge-Weber syndrome?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Sturge-Weber syndrome.
...
| **Topic** | **Sturge-Weber syndrome** |
|-----------|-----------|
| **Definition** | Sturge-Weber syndrome (SWS, encephalotrigeminal angiomatosis) is a sporadic neurocutaneous disorder  |
| **Key Features** | Somatic mosaic GNAQ mutation |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Sturge-Weber syndrome?
   A. Somatic mosaic GNAQ mutation
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Sturge-Weber syndrome?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Sturge-Weber syndrome?
...
5. **Q:** What is the key histological/serological feature?
   A. Pigmentovascularis: PWS + dermal melanocytosis
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Sturge-Weber syndrome; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Sturge-Weber syndrome?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Sturge-Weber syndrome?
   A. Pigmentovascularis: PWS + dermal melanocytosis
...
- **Q:** Key fact about Sturge-Weber syndrome?
  **A:** Somatic mosaic GNAQ mutation
- **Q:** Another key point?
  **A:** Port-wine stain (capillary malformation), V1 (forehead, upper eyelid) — but ANY facial PWS can have SWS
- **Q:** Most important complication?
  **A:** Leptomeningeal angioma; seizures (75%); hemiparesis; stroke-like episodes; intellectual disability
- **Q:** First-line treatment?
  **A:** Glaucoma (30-70%), choroidal haemangioma, buphtalmos
- **Q:** Key histological/serological feature?
  **A:** Clinical + MRI brain with contrast (leptomeningeal enhancement) + ophthalmology

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Somatic mosaic GNAQ mutation
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Phakomatosis: Pigmentovascularis: PWS + dermal melanocytosis
...
5. **A** — Pigmentovascularis: PWS + dermal melanocytosis
