...
Ecthyma is a deeper form of impetigo (extends into dermis) caused by Streptococcus pyogenes (often with S. aureus). Presents as 'punched-out' ulcers with thick adherent crusts, often on legs. Heals with scarring. Common in children, elderly, immunocompromised, in warm climates.

## Clinical Features and Presentation

Ecthyma presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Strep pyogenes (often with Staph aureus) |
| Depth | Deeper than impetigo (into dermis) |
| Lesion | Punched-out ulcer with thick crust |
| Sites | Legs, buttocks (most common) |
| Healing | Scarring (always) |
| Risk factors | Children, elderly, immunocompromised, poor hygiene, warm climate |
| Diagnosis | Clinical; bacterial culture |
| Treatment | Oral antibiotics (flucloxacillin); topical after-crust-removal wound care |
| Complications | Cellulitis, ecthyma gangrenosum (Pseudomonas in neutropenic) |
| Differential | Impetigo (superficial), ecthyma gangrenosum, cutaneous anthrax, vasculitic ulcer |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Impetigo | Superficial, no ulcer, no scar |

## Viva Questions

1. **Q:** Define Ecthyma and outline its classification.
   **A:** Ecthyma is a deeper form of impetigo (extends into dermis) caused by Streptococcus pyogenes (often with S. aureus). Presents as 'punched-out' ulcers with thick adherent crusts, often on legs. Heals wi

2. **Q:** What are the key clinical features of Ecthyma?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Ecthyma.
...
1. **Ecthyma** = Deeper than impetigo, punched-out ulcer, scar
...
| **Topic** | **Ecthyma** |
|-----------|-----------|
| **Definition** | Ecthyma is a deeper form of impetigo (extends into dermis) caused by Streptococcus pyogenes (often w |
| **Key Features** | Strep pyogenes (often with Staph aureus) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Ecthyma?
   A. Strep pyogenes (often with Staph aureus)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Strep pyogenes (often with Staph aureus)*
2. **Q:** What is the first-line treatment for Ecthyma?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Ecthyma?
...
4. **Q:** What is the most important complication of Ecthyma?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Ecthyma?
   A. Impetigo (superficial), ecthyma gangrenosum, cutaneous anthrax, vasculitic ulcer
...
- **Q:** Key fact about Ecthyma?
  **A:** Strep pyogenes (often with Staph aureus)
- **Q:** Another key point?
  **A:** Deeper than impetigo (into dermis)
- **Q:** Most important complication?
  **A:** Punched-out ulcer with thick crust
- **Q:** First-line treatment?
  **A:** Legs, buttocks (most common)
...
### MCQs
1. **A** — Cause: Strep pyogenes (often with Staph aureus)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Impetigo (superficial), ecthyma gangrenosum, cutaneous anthrax, vasculitic ulcer
...
5. **A** — Impetigo (superficial), ecthyma gangrenosum, cutaneous anthrax, vasculitic ulcer
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Ecthyma full*

**Q1.** What is the most appropriate first-line therapy for Ecthyma full?
