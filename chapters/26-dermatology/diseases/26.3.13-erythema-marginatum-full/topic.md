...
| Category | Key Points |
|----------|------------|
| Association | Acute rheumatic fever (ARF) — 10-15% of cases |
| Morphology | Pink-red macular with central clearing, transient |
| Distribution | Trunk, proximal limbs, axillae |
| Symptoms | Non-pruritic, asymptomatic |
| Duration | Hours (transient, migratory) |
| Jones criteria | Major criterion for ARF diagnosis |
| ASOT | Often elevated (recent strep infection) |
| Differential | Urticaria, erythema migrans, drug eruption, viral exanthem |
| Treatment | Treat underlying ARF; lesions self-resolving |
| Prognosis | Resolves with ARF treatment |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Urticaria | Pruritic, individual wheals |
| Erythema migrans | Tick bite, single lesion |

## Viva Questions

1. **Q:** Define Erythema marginatum and outline its classification.
   **A:** Erythema marginatum is a figurate erythema strongly associated with acute rheumatic fever (ARF). Pink-red macular/papular lesions with central clearing, transient, non-pruritic, predominantly on trunk

2. **Q:** What are the key clinical features of Erythema marginatum?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Erythema marginatum.
...
1. **Marginatum = ARF** = Associated with acute rheumatic fever
...
| **Topic** | **Erythema marginatum** |
|-----------|-----------|
| **Definition** | Erythema marginatum is a figurate erythema strongly associated with acute rheumatic fever (ARF). Pin |
| **Key Features** | Acute rheumatic fever (ARF) — 10-15% of cases |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Erythema marginatum?
   A. Acute rheumatic fever (ARF) — 10-15% of cases
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Association: Acute rheumatic fever (ARF) — 10-15% of cases*
2. **Q:** What is the first-line treatment for Erythema marginatum?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Erythema marginatum?
...
4. **Q:** What is the most important complication of Erythema marginatum?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Erythema marginatum?
   A. Resolves with ARF treatment
...
## SBA Questions (5)
1. **Scenario:** Patient with Erythema marginatum; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Erythema marginatum failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Erythema marginatum?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Erythema marginatum?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Erythema marginatum?
   A. Resolves with ARF treatment
...
- **Q:** Key fact about Erythema marginatum?
  **A:** Acute rheumatic fever (ARF) — 10-15% of cases
- **Q:** Another key point?
  **A:** Pink-red macular with central clearing, transient
- **Q:** Most important complication?
  **A:** Trunk, proximal limbs, axillae
- **Q:** First-line treatment?
  **A:** Non-pruritic, asymptomatic
- **Q:** Key histological/serological feature?
  **A:** Hours (transient, migratory)

## Answer Key with Explanations

### MCQs
1. **A** — Association: Acute rheumatic fever (ARF) — 10-15% of cases
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prognosis: Resolves with ARF treatment
...
5. **A** — Resolves with ARF treatment
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Erythema marginatum full*

**Q1.** What is the most appropriate first-line therapy for Erythema marginatum full?
