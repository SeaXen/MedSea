...
topic: Drug eruptions in polypharmacy
...
Drug eruptions in elderly are common due to polypharmacy, altered pharmacokinetics, and multiple comorbidities. Common culprit drugs: antibiotics (beta-lactams, sulfonamides, TMP-SMX), NSAIDs, diuretics, allopurinol, anticoagulants, anticonvulsants, antiarrhythmics, antipsychotics, oral hypoglycaemics. Common patterns: morbilliform (most common), urticaria, fixed drug eruption, photosensitivity, SJS/TEN, DRESS, lichenoid, acneiform, bullous (BP-like). Approach: high index of suspicion, detailed drug history (including OTC, supplements, topical), temporal relationship, dechallenge, rechallenge (rare), skin biopsy. Treatment: stop culprit, supportive, antihistamines, topical/systemic steroids.
...
| Category | Key Points |
|----------|------------|
| Risk | Polypharmacy, multiple comorbidities, altered PK |
| Common | Morbilliform, urticaria, FDE, photosensitivity |
| Severe | SJS/TEN, DRESS (older age worse prognosis) |
| Common drugs | Beta-lactams, sulfonamides, NSAIDs, diuretics, allopurinol, anticonvulsants, anticoagulants |
| Approach | Drug history (Rx, OTC, supplements, topical), temporal, dechallenge, biopsy |
| SJS/TEN | Higher mortality in elderly; SCORTEN |
| DRESS | Higher organ involvement; mortality 5-10% |
| Multiple drugs | Multiple possible culprits; often antibiotic + NSAID + cardiovascular |
| Treatment | STOP culprit; supportive; specific by syndrome |
...
1. **Q:** Define Drug eruptions in polypharmacy and outline its classification.
   **A:** Drug eruptions in elderly are common due to polypharmacy, altered pharmacokinetics, and multiple comorbidities. Common culprit drugs: antibiotics (beta-lactams, sulfonamides, TMP-SMX), NSAIDs, diureti

2. **Q:** What are the key clinical features of Drug eruptions in polypharmacy?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Drug eruptions in polypharmacy.
...
|-----------|---------------|
| **Elderly** | Common, multiple drugs |
## One-Page Revision Card

| **Topic** | **Drug eruptions in polypharmacy** |
|-----------|-----------|
| **Definition** | Drug eruptions in elderly are common due to polypharmacy, altered pharmacokinetics, and multiple com |
| **Key Features** | Polypharmacy, multiple comorbidities, altered PK |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Drug eruptions in polypharmacy?
   A. Polypharmacy, multiple comorbidities, altered PK
...
5. **Q:** Key histological/serological feature?
   A. STOP culprit; supportive; specific by syndrome
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Drug eruptions in polypharmacy?
  **A:** Polypharmacy, multiple comorbidities, altered PK
- **Q:** Another key point?
  **A:** Morbilliform, urticaria, FDE, photosensitivity
- **Q:** Most important complication?
  **A:** SJS/TEN, DRESS (older age worse prognosis)
- **Q:** First-line treatment?
  **A:** Beta-lactams, sulfonamides, NSAIDs, diuretics, allopurinol, anticonvulsants, anticoagulants
- **Q:** Key histological/serological feature?
  **A:** Drug history (Rx, OTC, supplements, topical), temporal, dechallenge, biopsy

## Answer Key with Explanations

### MCQs
1. **A** — Risk: Polypharmacy, multiple comorbidities, altered PK
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: STOP culprit; supportive; specific by syndrome
...
5. **A** — STOP culprit; supportive; specific by syndrome
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Drug eruptions in polypharmacy full*

**Q1.** What is the most appropriate first-line therapy for Drug eruptions in polypharmacy full?
