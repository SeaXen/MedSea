...
Hypertrichosis is excessive hair growth in a non-androgen dependent distribution (generalised or localised). Distinct from hirsutism (androgen-dependent, in women). Causes: congenital (lanugo, terminal, localised, naevoid), acquired (drugs — minoxidil, ciclosporin, phenytoin; malignancy, porphyria, anorexia, hypothyroidism, CNS lesions). Treatment: address cause; cosmetic removal (shaving, laser, electrolysis, eflornithine).

## Clinical Features and Presentation

Hypertrichosis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Definition | Excess hair non-androgen dependent |
| Vs hirsutism | Hirsutism = androgen dependent in women; hypertrichosis = any pattern, any cause |
| Congenital | Lanugo (foetal, terminal in hypertrichosis lanuginosa), naevoid (Becker's, hairy naevus) |
| Acquired drugs | Minoxidil, ciclosporin, phenytoin, glucocorticoids, psoralen, diazoxide |
| Acquired disease | Porphyria (PCT, EPP), anorexia nervosa, hypothyroidism, CNS lesions (hypertrichosis of face in children) |
| Treatment | Address cause, cosmetic removal (laser, electrolysis) |
| Differential | Hirsutism (androgen-dependent in women) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Hirsutism | Androgen dependent in women |

## Viva Questions

1. **Q:** Define Hypertrichosis and outline its classification.
   **A:** Hypertrichosis is excessive hair growth in a non-androgen dependent distribution (generalised or localised). Distinct from hirsutism (androgen-dependent, in women). Causes: congenital (lanugo, termina

2. **Q:** What are the key clinical features of Hypertrichosis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Hypertrichosis.
...
1. Hypertrichosis = non-androgen; minoxidil/ciclosporin/phenytoin
...
| **Topic** | **Hypertrichosis** |
|-----------|-----------|
| **Definition** | Hypertrichosis is excessive hair growth in a non-androgen dependent distribution (generalised or loc |
| **Key Features** | Excess hair non-androgen dependent |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Hypertrichosis?
   A. Excess hair non-androgen dependent
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Definition: Excess hair non-androgen dependent*
2. **Q:** What is the first-line treatment for Hypertrichosis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Hypertrichosis?
...
4. **Q:** What is the most important complication of Hypertrichosis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Hypertrichosis?
   A. Hirsutism (androgen-dependent in women)
...
## SBA Questions (5)
1. **Scenario:** Patient with Hypertrichosis; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Hypertrichosis failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Hypertrichosis?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Hypertrichosis?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Hypertrichosis?
   A. Hirsutism (androgen-dependent in women)
...
- **Q:** Key fact about Hypertrichosis?
  **A:** Excess hair non-androgen dependent
- **Q:** Another key point?
  **A:** Hirsutism = androgen dependent in women; hypertrichosis = any pattern, any cause
- **Q:** Most important complication?
  **A:** Lanugo (foetal, terminal in hypertrichosis lanuginosa), naevoid (Becker's, hairy naevus)
- **Q:** First-line treatment?
  **A:** Minoxidil, ciclosporin, phenytoin, glucocorticoids, psoralen, diazoxide
- **Q:** Key histological/serological feature?
  **A:** Porphyria (PCT, EPP), anorexia nervosa, hypothyroidism, CNS lesions (hypertrichosis of face in children)

## Answer Key with Explanations

### MCQs
1. **A** — Definition: Excess hair non-androgen dependent
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Hirsutism (androgen-dependent in women)
...
5. **A** — Hirsutism (androgen-dependent in women)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Hypertrichosis full*

**Q1.** What is the most appropriate first-line therapy for Hypertrichosis full?
