...
Diaper dermatitis (nappy rash) is an irritant contact dermatitis in the diaper area from prolonged exposure to urine, faeces, friction, occlusion. Erythema, papules in convex surfaces (sparing flexures — distinguishes from candida). Treatment: frequent changes, breathable diapers, barrier creams (zinc oxide), emollients, mild topical steroids if severe. Candida superinfection: beefy red with satellite papules/pustules; treat with topical antifungal (miconazole, nystatin).

## Clinical Features and Presentation

Diaper dermatitis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Irritant (urine, faeces, friction, occlusion) |
| Distribution | Convex surfaces (sparing flexures) |
| Treatment | Frequent changes, breathable diapers, barrier cream |
| Barrier | Zinc oxide, petrolatum |
| Topical steroid | Mild potency (hydrocortisone 1%) if severe |
| Candida | Beefy red + satellite pustules; topical antifungal |
| Bacterial | Secondary impetiginisation; topical/oral antibiotics |
| Granuloma gluteale | Persistent papules/nodules after irritant dermatitis + steroid; resolve spontaneously |
| Jacquet erosive | Severe erosive, punched-out ulcers |
| Differential | Candida (spares flexures? No, favours flexures); seborrhoeic (early, other sites); inverse psoriasis |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Candida | Satellite pustules |

## Viva Questions

1. **Q:** Define Diaper dermatitis and outline its classification.
   **A:** Diaper dermatitis (nappy rash) is an irritant contact dermatitis in the diaper area from prolonged exposure to urine, faeces, friction, occlusion. Erythema, papules in convex surfaces (sparing flexure

2. **Q:** What are the key clinical features of Diaper dermatitis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Diaper dermatitis.
...
1. **Diaper dermatitis** = Convex surfaces, irritant, barrier cream


| Situation | Consideration |
|-----------|---------------|
| **Paediatric** | Common; barrier cream, frequent changes |
## One-Page Revision Card

| **Topic** | **Diaper dermatitis** |
|-----------|-----------|
| **Definition** | Diaper dermatitis (nappy rash) is an irritant contact dermatitis in the diaper area from prolonged e |
| **Key Features** | Irritant (urine, faeces, friction, occlusion) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Diaper dermatitis?
   A. Irritant (urine, faeces, friction, occlusion)
...
5. **Q:** Key histological/serological feature?
   A. Candida (spares flexures? No, favours flexures); seborrhoeic (early, other sites); inverse psoriasis
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Diaper dermatitis?
  **A:** Irritant (urine, faeces, friction, occlusion)
- **Q:** Another key point?
  **A:** Convex surfaces (sparing flexures)
- **Q:** Most important complication?
  **A:** Frequent changes, breathable diapers, barrier cream
- **Q:** First-line treatment?
  **A:** Zinc oxide, petrolatum
- **Q:** Key histological/serological feature?
  **A:** Mild potency (hydrocortisone 1%) if severe

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Irritant (urine, faeces, friction, occlusion)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Candida (spares flexures? No, favours flexures); seborrhoeic (early, other sites); inverse psoriasis
...
5. **A** — Candida (spares flexures? No, favours flexures); seborrhoeic (early, other sites); inverse psoriasis
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Diaper dermatitis full*

**Q1.** What is the most appropriate first-line therapy for Diaper dermatitis full?
