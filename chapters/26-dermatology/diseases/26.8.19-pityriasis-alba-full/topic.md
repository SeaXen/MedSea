...
Pityriasis alba is a common, benign hypopigmentation in children and adolescents, often with atopic dermatitis. Ill-defined, scaly, hypopigmented patches (face, especially cheeks; sometimes upper arms, trunk). Often more visible in dark skin. Related to mild eczema (subclinical) and UV exposure. Treatment: emollients, mild topical steroids or calcineurin inhibitors for inflammation, sun protection; usually resolves over months-years.

## Clinical Features and Presentation

Pityriasis alba presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Distribution | Face (cheeks), upper arms, trunk |
| Appearance | Ill-defined, scaly, hypopigmented patches |
| Atopy | Strong association with atopic dermatitis |
| UV | More visible in summer (contrast with tanned normal skin) |
| Histology | Mild spongiosis, reduced melanin |
| Differential | Vitiligo, tinea versicolor, pityriasis rosea, hypopigmented MF |
| Treatment | Emollients, mild topical steroids, calcineurin inhibitors, sun protection |
| Prognosis | Resolves with age, months to years |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Vitiligo | Sharp border, complete depigmentation |

## Viva Questions

1. **Q:** Define Pityriasis alba and outline its classification.
   **A:** Pityriasis alba is a common, benign hypopigmentation in children and adolescents, often with atopic dermatitis. Ill-defined, scaly, hypopigmented patches (face, especially cheeks; sometimes upper arms

2. **Q:** What are the key clinical features of Pityriasis alba?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Pityriasis alba.
...
1. **Pityriasis alba** = Children + atopic + face + ill-defined
...
| **Topic** | **Pityriasis alba** |
|-----------|-----------|
| **Definition** | Pityriasis alba is a common, benign hypopigmentation in children and adolescents, often with atopic  |
| **Key Features** | Children, adolescents |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Pityriasis alba?
   ...
   **Answer: A**  *Age: Children, adolescents*
2. **Q:** What is the first-line treatment for Pityriasis alba?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Pityriasis alba?
...
4. **Q:** What is the most important complication of Pityriasis alba?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Pityriasis alba?
   A. Resolves with age, months to years
...
## SBA Questions (5)
1. **Scenario:** Patient with Pityriasis alba; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Pityriasis alba failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Pityriasis alba?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Pityriasis alba?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Pityriasis alba?
   A. Resolves with age, months to years
...
- **Q:** Key fact about Pityriasis alba?
  **A:** Children, adolescents
- **Q:** Another key point?
  **A:** Face (cheeks), upper arms, trunk
- **Q:** Most important complication?
  **A:** Ill-defined, scaly, hypopigmented patches
- **Q:** First-line treatment?
  **A:** Strong association with atopic dermatitis
- **Q:** Key histological/serological feature?
  **A:** More visible in summer (contrast with tanned normal skin)

## Answer Key with Explanations

### MCQs
1. **A** — Age: Children, adolescents
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prognosis: Resolves with age, months to years
...
5. **A** — Resolves with age, months to years
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Pityriasis alba full*

**Q1.** What is the most appropriate first-line therapy for Pityriasis alba full?
