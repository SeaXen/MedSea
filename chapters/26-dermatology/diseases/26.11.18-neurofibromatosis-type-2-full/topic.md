...
Neurofibromatosis type 2 (NF2) is an autosomal dominant disorder due to NF2 mutation (chromosome 22, merlin/schwannomin). Hallmark: bilateral vestibular schwannomas (acoustic neuromas, hearing loss, tinnitus, balance). Skin: fewer CALMs (less than NF1), cutaneous schwannomas, plaque-like NF (intracutaneous schwannoma). Increased risk: meningiomas, ependymomas, juvenile posterior subcapsular cataracts. Diagnosis: bilateral vestibular schwannomas on MRI; or family history + unilateral vestibular schwannoma, or 2 of meningioma, schwannoma, glioma, neurofibroma, posterior subcapsular cataract. Treatment: surgery, hearing rehabilitation, bevacizumab (anti-VEGF for tumour control).

## Clinical Features and Presentation

Neurofibromatosis type 2 presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Gene | NF2 (merlin, 22q12) |
| Hallmark | Bilateral vestibular schwannomas |
| Hearing | Sensorineural loss, tinnitus, vertigo |
| Skin | Fewer CALMs, cutaneous schwannomas, plaque-like NF |
| Eye | Posterior subcapsular cataracts (juvenile) |
| CNS | Meningiomas (multiple), ependymomas, gliomas |
| Diagnosis | Bilateral vestibular schwannomas MRI; or NF2 + unilateral VS or 2 of meningioma/schwannoma/glioma/NF/cataract |
| Treatment | Surgery (hearing preservation difficult), bevacizumab (anti-VEGF) |
| Prognosis | Significant morbidity, life expectancy reduced |
| NF1 vs NF2 | NF1 = NF1 gene, 17, neurofibromas, CALMs; NF2 = NF2 gene, 22, schwannomas, meningiomas |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| NF1 | Different gene, more cutaneous |

## Viva Questions

1. **Q:** Define Neurofibromatosis type 2 and outline its classification.
   **A:** Neurofibromatosis type 2 (NF2) is an autosomal dominant disorder due to NF2 mutation (chromosome 22, merlin/schwannomin). Hallmark: bilateral vestibular schwannomas (acoustic neuromas, hearing loss, t

2. **Q:** What are the key clinical features of Neurofibromatosis type 2?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Neurofibromatosis type 2.
...
| **Topic** | **Neurofibromatosis type 2** |
|-----------|-----------|
| **Definition** | Neurofibromatosis type 2 (NF2) is an autosomal dominant disorder due to NF2 mutation (chromosome 22, |
| **Key Features** | NF2 (merlin, 22q12) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Neurofibromatosis type 2?
   A. NF2 (merlin, 22q12)
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Neurofibromatosis type 2?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Neurofibromatosis type 2?
...
5. **Q:** What is the key histological/serological feature?
   A. NF1 = NF1 gene, 17, neurofibromas, CALMs; NF2 = NF2 gene, 22, schwannomas, meningiomas
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Neurofibromatosis type 2; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Neurofibromatosis type 2?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Neurofibromatosis type 2?
   A. NF1 = NF1 gene, 17, neurofibromas, CALMs; NF2 = NF2 gene, 22, schwannomas, meningiomas
...
- **Q:** Key fact about Neurofibromatosis type 2?
  **A:** NF2 (merlin, 22q12)
- **Q:** Another key point?
  **A:** Bilateral vestibular schwannomas
- **Q:** Most important complication?
  **A:** Sensorineural loss, tinnitus, vertigo
- **Q:** First-line treatment?
  **A:** Fewer CALMs, cutaneous schwannomas, plaque-like NF
- **Q:** Key histological/serological feature?
  **A:** Posterior subcapsular cataracts (juvenile)

## Answer Key with Explanations

### MCQs
1. **A** — Gene: NF2 (merlin, 22q12)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — NF1 vs NF2: NF1 = NF1 gene, 17, neurofibromas, CALMs; NF2 = NF2 gene, 22, schwannomas, meningiomas
...
5. **A** — NF1 = NF1 gene, 17, neurofibromas, CALMs; NF2 = NF2 gene, 22, schwannomas, meningiomas
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Neurofibromatosis type 2 full*

**Q1.** What is the most appropriate first-line therapy for Neurofibromatosis type 2 full?
