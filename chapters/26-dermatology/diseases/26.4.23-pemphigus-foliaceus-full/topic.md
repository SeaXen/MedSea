...
Pemphigus foliaceus is a less severe IgG-mediated autoimmune intraepidermal blistering disease with anti-desmoglein 1 autoantibodies. Affects adults. No mucosal involvement. Mortality less than 5%.

## Clinical Features and Presentation

Pemphigus foliaceus presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Target | Anti-Dsg1 only (skin only, no mucosa) |
| Split | Subcorneal (very superficial) |
| DIF | Intercellular IgG fishnet — upper epidermis |
| Nikolsky | Positive (very superficial) |
| Mucosa | Spared (key feature distinguishing from PV) |
| Distribution | Face, scalp, trunk, upper back (seborrhoeic areas) |
| Mortality | Less than 5% |
| Treatment | Dapsone first-line mild; topical superpotent steroids; rituximab; immunosuppressants |
| Histology | Subcorneal acantholysis (very superficial) |
| Associated | Fogo selvagem endemic Brazil; drug-induced penicillamine captopril |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| PV | Mucosal involvement, anti-Dsg3, deeper split |

## Viva Questions

1. **Q:** Define Pemphigus foliaceus and outline its classification.
   **A:** Pemphigus foliaceus is a less severe IgG-mediated autoimmune intraepidermal blistering disease with anti-desmoglein 1 autoantibodies. Affects adults. No mucosal involvement. Mortality less than 5%.

2. **Q:** What are the key clinical features of Pemphigus foliaceus?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Pemphigus foliaceus.
...
1. **PF vs PV** = PF = Dsg1 only, no mucosa; PV = Dsg3 ± Dsg1, mucosa, deeper
...
| **Topic** | **Pemphigus foliaceus** |
|-----------|-----------|
| **Definition** | Pemphigus foliaceus is a less severe IgG-mediated autoimmune intraepidermal blistering disease with  |
| **Key Features** | Anti-Dsg1 only (skin only, no mucosa) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Pemphigus foliaceus?
   A. Anti-Dsg1 only (skin only, no mucosa)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Target: Anti-Dsg1 only (skin only, no mucosa)*
2. **Q:** What is the first-line treatment for Pemphigus foliaceus?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Pemphigus foliaceus?
...
4. **Q:** What is the most important complication of Pemphigus foliaceus?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Pemphigus foliaceus?
   A. Fogo selvagem endemic Brazil; drug-induced penicillamine captopril
...
## SBA Questions (5)
1. **Scenario:** Patient with Pemphigus foliaceus; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Pemphigus foliaceus failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Pemphigus foliaceus?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Pemphigus foliaceus?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Pemphigus foliaceus?
   A. Fogo selvagem endemic Brazil; drug-induced penicillamine captopril
...
- **Q:** Key fact about Pemphigus foliaceus?
  **A:** Anti-Dsg1 only (skin only, no mucosa)
- **Q:** Another key point?
  **A:** Subcorneal (very superficial)
- **Q:** Most important complication?
  **A:** Intercellular IgG fishnet — upper epidermis
- **Q:** First-line treatment?
  **A:** Positive (very superficial)
- **Q:** Key histological/serological feature?
  **A:** Spared (key feature distinguishing from PV)

## Answer Key with Explanations

### MCQs
1. **A** — Target: Anti-Dsg1 only (skin only, no mucosa)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Associated: Fogo selvagem endemic Brazil; drug-induced penicillamine captopril
...
5. **A** — Fogo selvagem endemic Brazil; drug-induced penicillamine captopril
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Pemphigus foliaceus full*

**Q1.** What is the most appropriate first-line therapy for Pemphigus foliaceus full?
