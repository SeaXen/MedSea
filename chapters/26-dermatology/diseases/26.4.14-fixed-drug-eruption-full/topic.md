...
Fixed drug eruption (FDE) is a recurrent drug reaction at the same site(s) on re-exposure, leaving post-inflammatory hyperpigmentation. Common drugs: NSAIDs (especially naproxen), paracetamol, sulfonamides, tetracyclines, phenolphthalein. Latency 30 min to 8 h. Generalised bullous FDE is severe variant mimicking SJS/TEN.

## Clinical Features and Presentation

Fixed drug eruption presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Recurrence | At same site on re-exposure (fixed) |
| Sequela | Post-inflammatory hyperpigmentation (may be persistent) |
| Common drugs | NSAIDs (naproxen), paracetamol, sulfonamides, tetracyclines |
| Latency | 30 min to 8 h |
| Sites | Lips, tongue, genitals, hands, feet (acral predilection) |
| Lesions | Well-defined erythematous macule/plaque, bulla, erosion |
| Multiple FDEs | Multiple sites if multiple exposures |
| Generalised bullous FDE | Severe variant; mimics SJS/TEN; more than 10% BSA; cross-reactivity |
| Diagnosis | Clinical; oral challenge test (re-challenge) confirms |
| Histology | Interface dermatitis with apoptotic keratinocytes, eosinophils, neutrophils |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| SJS/TEN | Acute, widespread, mucosal involvement |

## Viva Questions

1. **Q:** Define Fixed drug eruption and outline its classification.
   **A:** Fixed drug eruption (FDE) is a recurrent drug reaction at the same site(s) on re-exposure, leaving post-inflammatory hyperpigmentation. Common drugs: NSAIDs (especially naproxen), paracetamol, sulfona

2. **Q:** What are the key clinical features of Fixed drug eruption?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Fixed drug eruption.
...
1. **FDE drugs** = NSAIDs, paracetamol, sulfonamides, tetracyclines
...
| **Topic** | **Fixed drug eruption** |
|-----------|-----------|
| **Definition** | Fixed drug eruption (FDE) is a recurrent drug reaction at the same site(s) on re-exposure, leaving p |
| **Key Features** | At same site on re-exposure (fixed) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Fixed drug eruption?
   A. At same site on re-exposure (fixed)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Recurrence: At same site on re-exposure (fixed)*
2. **Q:** What is the first-line treatment for Fixed drug eruption?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Fixed drug eruption?
...
4. **Q:** What is the most important complication of Fixed drug eruption?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Fixed drug eruption?
   A. Interface dermatitis with apoptotic keratinocytes, eosinophils, neutrophils
...
## SBA Questions (5)
1. **Scenario:** Patient with Fixed drug eruption; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Fixed drug eruption failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Fixed drug eruption?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Fixed drug eruption?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Fixed drug eruption?
   A. Interface dermatitis with apoptotic keratinocytes, eosinophils, neutrophils
...
- **Q:** Key fact about Fixed drug eruption?
  **A:** At same site on re-exposure (fixed)
- **Q:** Another key point?
  **A:** Post-inflammatory hyperpigmentation (may be persistent)
- **Q:** Most important complication?
  **A:** NSAIDs (naproxen), paracetamol, sulfonamides, tetracyclines
- **Q:** First-line treatment?
  **A:** 30 min to 8 h
- **Q:** Key histological/serological feature?
  **A:** Lips, tongue, genitals, hands, feet (acral predilection)

## Answer Key with Explanations

### MCQs
1. **A** — Recurrence: At same site on re-exposure (fixed)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Histology: Interface dermatitis with apoptotic keratinocytes, eosinophils, neutrophils
...
5. **A** — Interface dermatitis with apoptotic keratinocytes, eosinophils, neutrophils
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Fixed drug eruption full*

**Q1.** What is the most appropriate first-line therapy for Fixed drug eruption full?
