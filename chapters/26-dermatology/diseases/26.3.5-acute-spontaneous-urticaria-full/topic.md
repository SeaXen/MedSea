...
topic: Acute spontaneous urticaria
...
Acute spontaneous urticaria is urticaria (wheals) lasting less than 6 weeks, often triggered by infection (viral, bacterial), drugs (NSAIDs, antibiotics), foods (nuts, shellfish, eggs), or insect stings. Affects 20% of population at some point. Often self-limiting; resolution within days to weeks.

## Clinical Features and Presentation

Acute spontaneous urticaria presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Triggers | Infection, drugs, foods, insect stings, latex |
| Prevalence | 20% lifetime |
| Lesions | Transient pruritic wheals (less than 24h each) |
| Angioedema | 40% (deeper, lasts up to 72h) |
| Investigations | Usually none; FBC, ESR if persistent; allergy tests if specific trigger |
| Treatment | Avoid trigger; H1 antihistamines (up to 4x dose); short course steroids if severe |
| Differential | Chronic urticaria, anaphylaxis, serum sickness, viral exanthem |
| Natural history | Self-limiting; chronic in 10% |
| Associations | Atopy, autoimmune (some) |
...
| Anaphylaxis | Systemic, hypotension, airway |

## Viva Questions

1. **Q:** Define Acute spontaneous urticaria and outline its classification.
   **A:** Acute spontaneous urticaria is urticaria (wheals) lasting less than 6 weeks, often triggered by infection (viral, bacterial), drugs (NSAIDs, antibiotics), foods (nuts, shellfish, eggs), or insect stin

2. **Q:** What are the key clinical features of Acute spontaneous urticaria?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Acute spontaneous urticaria.
...
1. **Acute urticaria** = Less than 6 weeks, self-limiting, trigger identifiable
...
| **Topic** | **Acute spontaneous urticaria** |
|-----------|-----------|
| **Definition** | Acute spontaneous urticaria is urticaria (wheals) lasting less than 6 weeks, often triggered by infe |
| **Key Features** | Less than 6 weeks |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Acute spontaneous urticaria?
   A. Less than 6 weeks
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Duration: Less than 6 weeks*
2. **Q:** What is the first-line treatment for Acute spontaneous urticaria?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Acute spontaneous urticaria?
...
4. **Q:** What is the most important complication of Acute spontaneous urticaria?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Acute spontaneous urticaria?
   A. Atopy, autoimmune (some)
...
## SBA Questions (5)
1. **Scenario:** Patient with Acute spontaneous urticaria; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Acute spontaneous urticaria failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Acute spontaneous urticaria?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Acute spontaneous urticaria?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Acute spontaneous urticaria?
   A. Atopy, autoimmune (some)
...
- **Q:** Key fact about Acute spontaneous urticaria?
  **A:** Less than 6 weeks
- **Q:** Another key point?
  **A:** Infection, drugs, foods, insect stings, latex
- **Q:** Most important complication?
  **A:** 20% lifetime
- **Q:** First-line treatment?
  **A:** Transient pruritic wheals (less than 24h each)
- **Q:** Key histological/serological feature?
  **A:** 40% (deeper, lasts up to 72h)

## Answer Key with Explanations

### MCQs
1. **A** — Duration: Less than 6 weeks
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Associations: Atopy, autoimmune (some)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Acute spontaneous urticaria full*

**Q1.** What is the most appropriate first-line therapy for Acute spontaneous urticaria full?
