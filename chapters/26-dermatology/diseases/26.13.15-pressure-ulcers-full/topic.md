...
Pressure ulcers (decubitus ulcers, pressure sores) are localised skin and soft tissue injuries over bony prominences from sustained pressure (and shear, friction, moisture). Common sites: sacrum, heels, trochanters, ischial tuberosities, elbows. Staging: Stage 1 (non-blanching erythema, intact skin), Stage 2 (partial thickness loss, pink/red wound bed, no slough), Stage 3 (full thickness loss, fat visible), Stage 4 (full thickness with bone, tendon, muscle visible), Unstageable (slough/eschar obscures), SDTI (suspected deep tissue injury, persistent non-blanching deep red/maroon/purple). Risk: Braden Scale. Prevention: repositioning (2-hourly), pressure-relieving mattresses, skin care, nutrition.

## Clinical Features and Presentation

Pressure ulcers presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Sites | Sacrum, heels, trochanters, ischial tuberosities, elbows |
| Stage 1 | Non-blanching erythema, intact skin |
| Stage 2 | Partial thickness loss, pink/red wound bed |
| Stage 3 | Full thickness loss, fat visible |
| Stage 4 | Full thickness, bone/tendon/muscle visible |
| Unstageable | Slough/eschar obscures |
| SDTI | Suspected deep tissue injury, persistent deep red/maroon/purple |
| Risk | Braden Scale (sensory, moisture, activity, mobility, nutrition, friction/shear) |
| Prevention | 2-hourly repositioning, pressure-relieving mattresses, skin care, nutrition |
| Treatment | Stage 1-2: conservative; Stage 3-4: debridement, dressing, surgery |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Venous/arterial ulcer | Different site/cause |

## Viva Questions

1. **Q:** Define Pressure ulcers and outline its classification.
   **A:** Pressure ulcers (decubitus ulcers, pressure sores) are localised skin and soft tissue injuries over bony prominences from sustained pressure (and shear, friction, moisture). Common sites: sacrum, heel

2. **Q:** What are the key clinical features of Pressure ulcers?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Pressure ulcers.
...
|-----------|---------------|
| **Elderly** | Common, immobile |
## One-Page Revision Card

| **Topic** | **Pressure ulcers** |
|-----------|-----------|
| **Definition** | Pressure ulcers (decubitus ulcers, pressure sores) are localised skin and soft tissue injuries over  |
| **Key Features** | Sacrum, heels, trochanters, ischial tuberosities, elbows |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Pressure ulcers?
   A. Sacrum, heels, trochanters, ischial tuberosities, elbows
...
5. **Q:** Key histological/serological feature?
   A. Stage 1-2: conservative; Stage 3-4: debridement, dressing, surgery
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Pressure ulcers?
  **A:** Sacrum, heels, trochanters, ischial tuberosities, elbows
- **Q:** Another key point?
  **A:** Non-blanching erythema, intact skin
- **Q:** Most important complication?
  **A:** Partial thickness loss, pink/red wound bed
- **Q:** First-line treatment?
  **A:** Full thickness loss, fat visible
- **Q:** Key histological/serological feature?
  **A:** Full thickness, bone/tendon/muscle visible

## Answer Key with Explanations

### MCQs
1. **A** — Sites: Sacrum, heels, trochanters, ischial tuberosities, elbows
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Stage 1-2: conservative; Stage 3-4: debridement, dressing, surgery
...
5. **A** — Stage 1-2: conservative; Stage 3-4: debridement, dressing, surgery
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Pressure ulcers full*

**Q1.** What is the most appropriate first-line therapy for Pressure ulcers full?
