...
Epidermolysis bullosa acquisita (EBA) is a chronic subepidermal autoimmune blistering disease with autoantibodies against type VII collagen (anchoring fibril at sublamina densa). Two main forms: mechanobullous (classical, trauma-induced) and inflammatory (BP-like). Salt-split skin: dermal (floor) side — distinguishes from BP (roof).

## Clinical Features and Presentation

Epidermolysis bullosa acquisita presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Target | Type VII collagen (anchoring fibrils in sublamina densa) |
| Salt-split | Dermal FLOOR side — distinguishes from BP (roof) |
| Forms | Mechanobullous (trauma-induced) and inflammatory (BP-like) |
| Mechanobullous | Acral distribution, healing with scarring and milia |
| Inflammatory | Widespread BP-like bullae, may mimic BP or MMP |
| DIF | Linear IgG/C3 at BMZ (same as BP) |
| IIF | Dermal side on salt-split skin |
| Type VII collagen | Anchoring fibril between lamina densa and dermis |
| Treatment | Difficult; colchicine, dapsone, ciclosporin, IVIG, rituximab |
| Associations | Crohn disease, SLE, other autoimmune 10-30% |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| BP | Salt-split roof side not floor |

## Viva Questions

1. **Q:** Define Epidermolysis bullosa acquisita and outline its classification.
   **A:** Epidermolysis bullosa acquisita (EBA) is a chronic subepidermal autoimmune blistering disease with autoantibodies against type VII collagen (anchoring fibril at sublamina densa). Two main forms: mecha

2. **Q:** What are the key clinical features of Epidermolysis bullosa acquisita?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Epidermolysis bullosa acquisita.
...
1. **EBA = floor** = Salt-split: BP = roof, EBA = floor
...
| **Topic** | **Epidermolysis bullosa acquisita** |
|-----------|-----------|
| **Definition** | Epidermolysis bullosa acquisita (EBA) is a chronic subepidermal autoimmune blistering disease with a |
| **Key Features** | Type VII collagen (anchoring fibrils in sublamina densa) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Epidermolysis bullosa acquisita?
   A. Type VII collagen (anchoring fibrils in sublamina densa)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Target: Type VII collagen (anchoring fibrils in sublamina densa)*
2. **Q:** What is the first-line treatment for Epidermolysis bullosa acquisita?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Epidermolysis bullosa acquisita?
...
4. **Q:** What is the most important complication of Epidermolysis bullosa acquisita?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Epidermolysis bullosa acquisita?
   A. Crohn disease, SLE, other autoimmune 10-30%
...
## SBA Questions (5)
1. **Scenario:** Patient with Epidermolysis bullosa acquisita; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Epidermolysis bullosa acquisita failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Epidermolysis bullosa acquisita?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Epidermolysis bullosa acquisita?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Epidermolysis bullosa acquisita?
   A. Crohn disease, SLE, other autoimmune 10-30%
...
- **Q:** Key fact about Epidermolysis bullosa acquisita?
  **A:** Type VII collagen (anchoring fibrils in sublamina densa)
- **Q:** Another key point?
  **A:** Dermal FLOOR side — distinguishes from BP (roof)
- **Q:** Most important complication?
  **A:** Mechanobullous (trauma-induced) and inflammatory (BP-like)
- **Q:** First-line treatment?
  **A:** Acral distribution, healing with scarring and milia
- **Q:** Key histological/serological feature?
  **A:** Widespread BP-like bullae, may mimic BP or MMP

## Answer Key with Explanations

### MCQs
1. **A** — Target: Type VII collagen (anchoring fibrils in sublamina densa)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Associations: Crohn disease, SLE, other autoimmune 10-30%
...
5. **A** — Crohn disease, SLE, other autoimmune 10-30%
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Epidermolysis bullosa acquisita full*

**Q1.** What is the most appropriate first-line therapy for Epidermolysis bullosa acquisita full?
