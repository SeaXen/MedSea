...
topic: Acquired melanocytic naevi
...
Acquired melanocytic naevi (common moles) are benign proliferations of melanocytes that develop during childhood and adolescence. Appear in early childhood, peak in 30s, involute with age. Three stages: junctional (flat, pigmented), compound (raised), intradermal (raised, skin-coloured). Symmetric, regular border, uniform colour, less than 6mm. Treatment: usually observation; excision if suspicious or symptomatic.

## Clinical Features and Presentation

Acquired melanocytic naevi presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Type | Benign melanocytic proliferation |
| Evolution | Junctional (flat, dark) → compound (raised) → intradermal (skin-coloured) |
| Size | Less than 6mm typical |
| Symmetry | Symmetric, regular border, uniform colour |
| Number | 20-40 typical; more than 100 = increased melanoma risk |
| Sun exposure | Major risk factor for development |
| Hormonal | Can change in pregnancy (darken, enlarge) |
| Atypical/dysplastic | Larger, irregular, more than 6mm; melanoma marker (FAMMM, more than 5) |
| Treatment | Observation; excision if changing, suspicious, symptomatic |
| Histology | Nested melanocytes at DEJ (junctional) or dermis (intradermal) |
| Differential | Atypical naevus, melanoma, seborrhoeic keratosis, dermatofibroma |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Melanoma | ABCDE, asymmetric, irregular |

## Viva Questions

1. **Q:** Define Acquired melanocytic naevi and outline its classification.
   **A:** Acquired melanocytic naevi (common moles) are benign proliferations of melanocytes that develop during childhood and adolescence. Appear in early childhood, peak in 30s, involute with age. Three stage

2. **Q:** What are the key clinical features of Acquired melanocytic naevi?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Acquired melanocytic naevi.
...
1. **Naevus** = Symmetric, regular, uniform; less than 6mm
...
| **Topic** | **Acquired melanocytic naevi** |
|-----------|-----------|
| **Definition** | Acquired melanocytic naevi (common moles) are benign proliferations of melanocytes that develop duri |
| **Key Features** | Benign melanocytic proliferation |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Acquired melanocytic naevi?
   A. Benign melanocytic proliferation
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Type: Benign melanocytic proliferation*
2. **Q:** What is the first-line treatment for Acquired melanocytic naevi?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Acquired melanocytic naevi?
...
4. **Q:** What is the most important complication of Acquired melanocytic naevi?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Acquired melanocytic naevi?
   A. Atypical naevus, melanoma, seborrhoeic keratosis, dermatofibroma
...
## SBA Questions (5)
1. **Scenario:** Patient with Acquired melanocytic naevi; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Acquired melanocytic naevi failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Acquired melanocytic naevi?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Acquired melanocytic naevi?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Acquired melanocytic naevi?
   A. Atypical naevus, melanoma, seborrhoeic keratosis, dermatofibroma
...
- **Q:** Key fact about Acquired melanocytic naevi?
  **A:** Benign melanocytic proliferation
- **Q:** Another key point?
  **A:** Junctional (flat, dark) → compound (raised) → intradermal (skin-coloured)
- **Q:** Most important complication?
  **A:** Less than 6mm typical
- **Q:** First-line treatment?
  **A:** Symmetric, regular border, uniform colour
- **Q:** Key histological/serological feature?
  **A:** 20-40 typical; more than 100 = increased melanoma risk

## Answer Key with Explanations

### MCQs
1. **A** — Type: Benign melanocytic proliferation
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Atypical naevus, melanoma, seborrhoeic keratosis, dermatofibroma
...
5. **A** — Atypical naevus, melanoma, seborrhoeic keratosis, dermatofibroma
