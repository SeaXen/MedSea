# Stevens-Johnson syndrome (SJS) emergency management_full
...
heading: Emergencies
topic: Stevens-Johnson syndrome (SJS) emergency management
...
# Stevens-Johnson syndrome (SJS) emergency management
...
Stevens-Johnson syndrome (SJS) is a dermatological emergency: severe cutaneous adverse reaction with skin detachment <10% BSA plus typical targetoid lesions and prominent mucosal involvement (at least 2 mucosal sites). Mortality 10%. Most commonly drug-induced (sulfonamides, anticonvulsants, allopurinol, NSAIDs, nevirapine). Onset 1-3 weeks after drug exposure. EMERGENCY: stop drug, hospital admission (often burns unit), supportive care, IVIG, ciclosporin, etanercept. SCORTEN predicts mortality. Consider Mycoplasma in children.

## Clinical Features and Presentation

Stevens-Johnson syndrome (SJS) emergency management presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| BSA | SJS <10%; SJS/TEN overlap 10-30%; TEN >30% |
| Mucosal | ≥2 sites (oral, ocular, genital) |
| Triggers | Drugs (sulfonamides, anticonvulsants, allopurinol, NSAIDs) |
| Mortality | SJS 10%, TEN 30-35% |
| SCORTEN | Score predicts mortality |
| Treatment | STOP drug; supportive (burns unit); IVIG, ciclosporin, etanercept |
| Mycoplasma | Children, more mucosal, less skin; macrolide |
| Sequelae | Ocular (SJS), skin scarring, pigmentation |
...
1. **Q:** Define Stevens-Johnson syndrome (SJS) emergency management and outline its classification.
   **A:** Stevens-Johnson syndrome (SJS) is a dermatological emergency: severe cutaneous adverse reaction with skin detachment <10% BSA plus typical targetoid lesions and prominent mucosal involvement (at least

2. **Q:** What are the key clinical features of Stevens-Johnson syndrome (SJS) emergency management?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Stevens-Johnson syndrome (SJS) emergency management.
...
| **Topic** | **Stevens-Johnson syndrome (SJS) emergency management** |
|-----------|-----------|
| **Definition** | Stevens-Johnson syndrome (SJS) is a dermatological emergency: severe cutaneous adverse reaction with |
| **Key Features** | SJS <10%; SJS/TEN overlap 10-30%; TEN >30% |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Stevens-Johnson syndrome (SJS) emergency management?
   A. SJS <10%; SJS/TEN overlap 10-30%; TEN >30%
...
5. **Q:** Key histological/serological feature?
   A. Ocular (SJS), skin scarring, pigmentation
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Stevens-Johnson syndrome (SJS) emergency management?
  **A:** SJS <10%; SJS/TEN overlap 10-30%; TEN >30%
- **Q:** Another key point?
  **A:** ≥2 sites (oral, ocular, genital)
- **Q:** Most important complication?
  **A:** Drugs (sulfonamides, anticonvulsants, allopurinol, NSAIDs)
- **Q:** First-line treatment?
  **A:** SJS 10%, TEN 30-35%
- **Q:** Key histological/serological feature?
  **A:** Score predicts mortality

## Answer Key with Explanations

### MCQs
1. **A** — BSA: SJS <10%; SJS/TEN overlap 10-30%; TEN >30%
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Sequelae: Ocular (SJS), skin scarring, pigmentation
...
5. **A** — Ocular (SJS), skin scarring, pigmentation
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Stevens-Johnson syndrome (SJS) emergency management full*

**Q1.** What is the most appropriate first-line therapy for Stevens-Johnson syndrome (SJS) emergency management full?
