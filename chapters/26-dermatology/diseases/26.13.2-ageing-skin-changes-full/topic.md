...
Ageing skin changes include intrinsic (chronological) and extrinsic (photoageing from UV). Intrinsic: thinning of epidermis and dermis, loss of subcutaneous fat, reduced sebum/sweat, dryness (xerosis), atrophy, fine wrinkles, easy bruising, senile purpura, stellate pseudoscars. Extrinsic (photoageing): coarse wrinkles, lentigines, telangiectasias, actinic keratoses, solar elastosis, actinic purpura. Common: xerosis, pruritus, seborrhoeic keratoses, skin tags, lentigines, telangiectasias, easy bruising, delayed wound healing, skin cancer.

## Clinical Features and Presentation

Ageing skin changes presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Intrinsic | Atrophy, xerosis, fine wrinkles, senile purpura |
| Extrinsic | Photoageing: coarse wrinkles, lentigines, solar elastosis, AKs |
| Xerosis | Common; emollients, urea |
| Pruritus | Xerosis, systemic disease (cholestasis, CKD, haematological) |
| Skin tags | Acrochordons, common |
| Seborrhoeic keratoses | Common benign |
| Actinic keratoses | Premalignant; cryo, 5-FU, imiquimod, PDT |
| Skin cancer | Increased; BCC, SCC, melanoma |
| Pressure ulcers | Elderly, immobile |
| Leg ulcers | Venous (most), arterial, mixed |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Xerosis vs eczema | Inflammation in eczema |

## Viva Questions

1. **Q:** Define Ageing skin changes and outline its classification.
   **A:** Ageing skin changes include intrinsic (chronological) and extrinsic (photoageing from UV). Intrinsic: thinning of epidermis and dermis, loss of subcutaneous fat, reduced sebum/sweat, dryness (xerosis)

2. **Q:** What are the key clinical features of Ageing skin changes?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Ageing skin changes.
...
|-----------|---------------|
| **Elderly** | Common; emollients, sun protection, skin exams |
## One-Page Revision Card

| **Topic** | **Ageing skin changes** |
|-----------|-----------|
| **Definition** | Ageing skin changes include intrinsic (chronological) and extrinsic (photoageing from UV). Intrinsic |
| **Key Features** | Atrophy, xerosis, fine wrinkles, senile purpura |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Ageing skin changes?
   A. Atrophy, xerosis, fine wrinkles, senile purpura
...
- **Q:** Key fact about Ageing skin changes?
  **A:** Atrophy, xerosis, fine wrinkles, senile purpura
- **Q:** Another key point?
  **A:** Photoageing: coarse wrinkles, lentigines, solar elastosis, AKs
- **Q:** Most important complication?
  **A:** Common; emollients, urea
- **Q:** First-line treatment?
  **A:** Xerosis, systemic disease (cholestasis, CKD, haematological)
- **Q:** Key histological/serological feature?
  **A:** Acrochordons, common

## Answer Key with Explanations

### MCQs
1. **A** — Intrinsic: Atrophy, xerosis, fine wrinkles, senile purpura
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Leg ulcers: Venous (most), arterial, mixed
...
5. **A** — Venous (most), arterial, mixed
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Ageing skin changes full*

**Q1.** What is the most appropriate first-line therapy for Ageing skin changes full?
