...
Xeroderma pigmentosum (XP) is a rare autosomal recessive disorder with defective nucleotide excision repair of UV-induced DNA damage, leading to extreme photosensitivity and early skin cancers (BCC, SCC, melanoma) from childhood. Severe sunburn, freckling, photophobia, neurodegeneration (DeSanctis-Cacchione syndrome in some). Strict photoprotection essential. Treatment: isotretinoin (chemoprevention), frequent skin exams, surgery for cancers.

## Clinical Features and Presentation

Xeroderma pigmentosum presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Defect in nucleotide excision repair (NER) of UV damage |
| Genes | XPA-XPG (7 complementation groups); XPV (polymerase eta) |
| Skin | Severe sunburn, freckling, poikiloderma, xerosis, lentigines from infancy |
| Eyes | Photophobia, keratitis, corneal opacities, lid cancers |
| Cancers | BCC, SCC, melanoma from childhood; 1000x normal risk |
| Neurological | DeSanctis-Cacchione (XPA) — progressive neurodegeneration |
| Prevention | Strict photoprotection: avoid sun, UV-protective clothing, window film, sunscreen |
| Treatment | Isotretinoin (chemoprevention), surgery, regular skin/eye exams |
| Prognosis | Median survival 30-40 years; often skin cancer deaths |
| Mosaicism | XP mosaics: revertant patches |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Erythropoietic protoporphyria | Painful photosensitivity, no skin cancer |

## Viva Questions

1. **Q:** Define Xeroderma pigmentosum and outline its classification.
   **A:** Xeroderma pigmentosum (XP) is a rare autosomal recessive disorder with defective nucleotide excision repair of UV-induced DNA damage, leading to extreme photosensitivity and early skin cancers (BCC, S

2. **Q:** What are the key clinical features of Xeroderma pigmentosum?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Xeroderma pigmentosum.
...
1. XP = NER defect; severe sunburn + freckling + early cancer
...
| **Topic** | **Xeroderma pigmentosum** |
|-----------|-----------|
| **Definition** | Xeroderma pigmentosum (XP) is a rare autosomal recessive disorder with defective nucleotide excision |
| **Key Features** | Defect in nucleotide excision repair (NER) of UV damage |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Xeroderma pigmentosum?
   A. Defect in nucleotide excision repair (NER) of UV damage
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Defect in nucleotide excision repair (NER) of UV damage*
2. **Q:** What is the first-line treatment for Xeroderma pigmentosum?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Xeroderma pigmentosum?
...
4. **Q:** What is the most important complication of Xeroderma pigmentosum?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Xeroderma pigmentosum?
   A. XP mosaics: revertant patches
...
## SBA Questions (5)
1. **Scenario:** Patient with Xeroderma pigmentosum; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Xeroderma pigmentosum failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Xeroderma pigmentosum?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Xeroderma pigmentosum?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Xeroderma pigmentosum?
   A. XP mosaics: revertant patches
...
- **Q:** Key fact about Xeroderma pigmentosum?
  **A:** Defect in nucleotide excision repair (NER) of UV damage
- **Q:** Another key point?
  **A:** XPA-XPG (7 complementation groups); XPV (polymerase eta)
- **Q:** Most important complication?
  **A:** Severe sunburn, freckling, poikiloderma, xerosis, lentigines from infancy
- **Q:** First-line treatment?
  **A:** Photophobia, keratitis, corneal opacities, lid cancers
- **Q:** Key histological/serological feature?
  **A:** BCC, SCC, melanoma from childhood; 1000x normal risk

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Defect in nucleotide excision repair (NER) of UV damage
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Mosaicism: XP mosaics: revertant patches
...
5. **A** — XP mosaics: revertant patches
