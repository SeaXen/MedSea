...
Bloom syndrome is a rare autosomal recessive chromosomal instability disorder due to BLM gene mutation (RECQL3 helicase). Features: severe pre- and postnatal growth retardation, photosensitivity (erythema, telangiectasias in sun-exposed), 'bird-like' facies, immunodeficiency, markedly increased cancer risk (leukaemia, lymphoma, GI, breast — early onset). High sister chromatid exchange (diagnostic). Treatment: sun protection, surveillance for malignancy, growth hormone (controversial).

## Clinical Features and Presentation

Bloom syndrome presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Gene | BLM (RECQL3 helicase) |
| Growth | Severe pre/postnatal retardation |
| Photosensitivity | Telangiectatic erythema (face, dorsum hands) |
| Face | Bird-like (narrow, prominent nose) |
| Cancer | Leukemia, lymphoma, GI, breast, early onset |
| SCE | High sister chromatid exchange (diagnostic) |
| Treatment | Sun protection, surveillance, GH controversial |
| Differential | Rothmund-Thomson (RECQL4), Werner, Cockayne |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Rothmund-Thomson | Poikiloderma, RECQL4 |

## Viva Questions

1. **Q:** Define Bloom syndrome and outline its classification.
   **A:** Bloom syndrome is a rare autosomal recessive chromosomal instability disorder due to BLM gene mutation (RECQL3 helicase). Features: severe pre- and postnatal growth retardation, photosensitivity (eryt

2. **Q:** What are the key clinical features of Bloom syndrome?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Bloom syndrome.
...
| **Topic** | **Bloom syndrome** |
|-----------|-----------|
| **Definition** | Bloom syndrome is a rare autosomal recessive chromosomal instability disorder due to BLM gene mutati |
| **Key Features** | BLM (RECQL3 helicase) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Bloom syndrome?
   A. BLM (RECQL3 helicase)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Bloom syndrome?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Bloom syndrome?
...
5. **Q:** What is the key histological/serological feature?
   A. Rothmund-Thomson (RECQL4), Werner, Cockayne
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Bloom syndrome; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Bloom syndrome?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Bloom syndrome?
   A. Rothmund-Thomson (RECQL4), Werner, Cockayne
...
- **Q:** Key fact about Bloom syndrome?
  **A:** BLM (RECQL3 helicase)
- **Q:** Another key point?
  **A:** Severe pre/postnatal retardation
- **Q:** Most important complication?
  **A:** Telangiectatic erythema (face, dorsum hands)
- **Q:** First-line treatment?
  **A:** Bird-like (narrow, prominent nose)
- **Q:** Key histological/serological feature?
  **A:** Leukemia, lymphoma, GI, breast, early onset

## Answer Key with Explanations

### MCQs
1. **A** — Gene: BLM (RECQL3 helicase)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Rothmund-Thomson (RECQL4), Werner, Cockayne
...
5. **A** — Rothmund-Thomson (RECQL4), Werner, Cockayne
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Bloom syndrome full*

**Q1.** What is the most appropriate first-line therapy for Bloom syndrome full?
