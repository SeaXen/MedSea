...
Mixed connective tissue disease (MCTD, Sharp syndrome) is an overlap syndrome with features of SLE, systemic sclerosis, and polymyositis, with high titre anti-U1 RNP antibodies. Raynaud's is a key early feature. Other: swollen sausage-like fingers/puffy hands, sclerodactyly, myositis, arthritis, oesophageal dysmotility, ILD. Skin: Raynaud's, sclerodactyly, swollen fingers, photosensitivity, malar rash, Gottron-like lesions. Treatment: calcium channel blockers for Raynaud's, immunosuppressants (azathioprine, MMF, methotrexate) for organ involvement.

## Clinical Features and Presentation

Mixed connective tissue disease presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Antibody | Anti-U1 RNP (high titre) |
| Features | SLE + SSc + PM overlap |
| Skin | Raynaud's (almost all), puffy sausage-like fingers, sclerodactyly, photosensitivity, malar rash, Gottron-like |
| Internal | Arthritis, myositis, ILD, oesophageal dysmotility, pulmonary HTN |
| Diagnosis | Kasukawa criteria: common symptoms (Raynaud's, swollen fingers, myositis) + anti-U1 RNP |
| Treatment | RP: CCB; ILD: immunosuppression (azathioprine, MMF, cyclosporine, rituximab); myositis: steroids + MTX |
| Prognosis | ILD, PAH major causes of mortality |
| Differential | SLE, SSc, PM, antisynthetase syndrome |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Overlap syndromes | MCTD = specific entity |

## Viva Questions

1. **Q:** Define Mixed connective tissue disease and outline its classification.
   **A:** Mixed connective tissue disease (MCTD, Sharp syndrome) is an overlap syndrome with features of SLE, systemic sclerosis, and polymyositis, with high titre anti-U1 RNP antibodies. Raynaud's is a key ear

2. **Q:** What are the key clinical features of Mixed connective tissue disease?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Mixed connective tissue disease.
...
| **Topic** | **Mixed connective tissue disease** |
|-----------|-----------|
| **Definition** | Mixed connective tissue disease (MCTD, Sharp syndrome) is an overlap syndrome with features of SLE,  |
| **Key Features** | Anti-U1 RNP (high titre) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Mixed connective tissue disease?
   A. Anti-U1 RNP (high titre)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Mixed connective tissue disease?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Mixed connective tissue disease?
...
5. **Q:** What is the key histological/serological feature?
   A. SLE, SSc, PM, antisynthetase syndrome
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Mixed connective tissue disease; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Mixed connective tissue disease?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Mixed connective tissue disease?
   A. SLE, SSc, PM, antisynthetase syndrome
...
- **Q:** Key fact about Mixed connective tissue disease?
  **A:** Anti-U1 RNP (high titre)
- **Q:** Another key point?
  **A:** SLE + SSc + PM overlap
- **Q:** Most important complication?
  **A:** Raynaud's (almost all), puffy sausage-like fingers, sclerodactyly, photosensitivity, malar rash, Gottron-like
- **Q:** First-line treatment?
  **A:** Arthritis, myositis, ILD, oesophageal dysmotility, pulmonary HTN
- **Q:** Key histological/serological feature?
  **A:** Kasukawa criteria: common symptoms (Raynaud's, swollen fingers, myositis) + anti-U1 RNP

## Answer Key with Explanations

### MCQs
1. **A** — Antibody: Anti-U1 RNP (high titre)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: SLE, SSc, PM, antisynthetase syndrome
...
5. **A** — SLE, SSc, PM, antisynthetase syndrome
