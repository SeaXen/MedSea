...
topic: Palpable purpura approach
...
Palpable purpura is the hallmark of small-vessel vasculitis (leukocytoclastic). Approach: history (drugs, infection, systemic), examination (distribution — legs/dependent areas), investigations (FBC, ESR, CRP, ANA, ANCA, complement, cryoglobulins, hepatitis/HIV serology), skin biopsy (H&E and DIF within 24-48 hours of new lesion).

## Clinical Features and Presentation

Palpable purpura approach presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Small vessel vasculitis (leukocytoclastic) |
| Distribution | Dependent areas (legs, ankles) |
| Triggers | Drugs (40%), infection (15-20%), autoimmune, malignancy, idiopathic |
| Investigations | FBC, ESR, CRP, ANA, ANCA, C3/C4, cryoglobulins, hepatitis B/C, HIV, urine |
| Biopsy | Within 24-48 hours of fresh lesion; H&E + DIF |
| Histology | Leukocytoclastic vasculitis (fibrinoid necrosis, neutrophils, nuclear dust) |
| ANCA | c-ANCA PR3 = GPA; p-ANCA MPO = MPA, EGPA |
| Complement | Low C3/C4 in immune complex (IgA, cryo, lupus) |
| Differential | Pigmented purpuric dermatoses (non-palpable), TTP, DIC |
| Treatment | Treat underlying cause; supportive; colchicine, dapsone, steroids for persistent |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Pigmented purpuric dermatoses | Non-palpable, no systemic |

## Viva Questions

1. **Q:** Define Palpable purpura approach and outline its classification.
   **A:** Palpable purpura is the hallmark of small-vessel vasculitis (leukocytoclastic). Approach: history (drugs, infection, systemic), examination (distribution — legs/dependent areas), investigations (FBC, 

2. **Q:** What are the key clinical features of Palpable purpura approach?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Palpable purpura approach.
...
1. **Palpable purpura = vasculitis** = Biopsy within 48h
...
| **Topic** | **Palpable purpura approach** |
|-----------|-----------|
| **Definition** | Palpable purpura is the hallmark of small-vessel vasculitis (leukocytoclastic). Approach: history (d |
| **Key Features** | Small vessel vasculitis (leukocytoclastic) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Palpable purpura approach?
   A. Small vessel vasculitis (leukocytoclastic)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Small vessel vasculitis (leukocytoclastic)*
2. **Q:** What is the first-line treatment for Palpable purpura approach?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Palpable purpura approach?
...
4. **Q:** What is the most important complication of Palpable purpura approach?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Palpable purpura approach?
   A. Treat underlying cause; supportive; colchicine, dapsone, steroids for persistent
...
## SBA Questions (5)
1. **Scenario:** Patient with Palpable purpura approach; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Palpable purpura approach failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Palpable purpura approach?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Palpable purpura approach?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Palpable purpura approach?
   A. Treat underlying cause; supportive; colchicine, dapsone, steroids for persistent
...
- **Q:** Key fact about Palpable purpura approach?
  **A:** Small vessel vasculitis (leukocytoclastic)
- **Q:** Another key point?
  **A:** Dependent areas (legs, ankles)
- **Q:** Most important complication?
  **A:** Drugs (40%), infection (15-20%), autoimmune, malignancy, idiopathic
- **Q:** First-line treatment?
  **A:** FBC, ESR, CRP, ANA, ANCA, C3/C4, cryoglobulins, hepatitis B/C, HIV, urine
- **Q:** Key histological/serological feature?
  **A:** Within 24-48 hours of fresh lesion; H&E + DIF

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Small vessel vasculitis (leukocytoclastic)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Treat underlying cause; supportive; colchicine, dapsone, steroids for persistent
...
5. **A** — Treat underlying cause; supportive; colchicine, dapsone, steroids for persistent
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Palpable purpura approach full*

**Q1.** What is the most appropriate first-line therapy for Palpable purpura approach full?
