...
SJS/TEN overlap is the intermediate form in the SJS/TEN spectrum with skin detachment 10-30% BSA. Same triggers, same management as SJS and TEN. Considered the bridge between SJS (less than 10%) and TEN (more than 30%).
...
|----------|------------|
| BSA | 10-30% |
| Triggers | Same as SJS/TEN: drugs (sulfonamides, anticonvulsants, allopurinol) |
| Mucosal | At least 2 sites |
| Mortality | 15-25% (intermediate) |
| Treatment | STOP drug; supportive (burns unit); IVIG, ciclosporin, etanercept |
| SCORTEN | Same scoring system applies |
| Prognosis | Intermediate between SJS and TEN |
| Sequelae | Ocular, skin scarring, pigmentation |
| Differentiation | Distinguishing SJS from TEN mainly by BSA |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| SJS | Less than 10% BSA |
| TEN | More than 30% BSA |

## Viva Questions

1. **Q:** Define SJS-TEN overlap and outline its classification.
   **A:** SJS/TEN overlap is the intermediate form in the SJS/TEN spectrum with skin detachment 10-30% BSA. Same triggers, same management as SJS and TEN. Considered the bridge between SJS (less than 10%) and T

2. **Q:** What are the key clinical features of SJS-TEN overlap?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of SJS-TEN overlap.
...
1. **SJS/TEN overlap** = 10-30% BSA; intermediate severity
...
| **Topic** | **SJS-TEN overlap** |
|-----------|-----------|
| **Definition** | SJS/TEN overlap is the intermediate form in the SJS/TEN spectrum with skin detachment 10-30% BSA. Sa |
| **Key Features** | 10-30% |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of SJS-TEN overlap?
   A. 10-30%
   ...
   **Answer: A**  *BSA: 10-30%*
2. **Q:** What is the first-line treatment for SJS-TEN overlap?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for SJS-TEN overlap?
...
4. **Q:** What is the most important complication of SJS-TEN overlap?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of SJS-TEN overlap?
   A. Distinguishing SJS from TEN mainly by BSA
...
## SBA Questions (5)
1. **Scenario:** Patient with SJS-TEN overlap; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** SJS-TEN overlap failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of SJS-TEN overlap?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for SJS-TEN overlap?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in SJS-TEN overlap?
   A. Distinguishing SJS from TEN mainly by BSA
...
- **Q:** Key fact about SJS-TEN overlap?
  **A:** 10-30%
- **Q:** Another key point?
  **A:** Same as SJS/TEN: drugs (sulfonamides, anticonvulsants, allopurinol)
- **Q:** Most important complication?
  **A:** At least 2 sites
- **Q:** First-line treatment?
  **A:** 15-25% (intermediate)
- **Q:** Key histological/serological feature?
  **A:** STOP drug; supportive (burns unit); IVIG, ciclosporin, etanercept
...
5. **A** — Differentiation: Distinguishing SJS from TEN mainly by BSA
...
5. **A** — Distinguishing SJS from TEN mainly by BSA
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — SJS-TEN overlap full*

**Q1.** What is the most appropriate first-line therapy for SJS-TEN overlap full?
