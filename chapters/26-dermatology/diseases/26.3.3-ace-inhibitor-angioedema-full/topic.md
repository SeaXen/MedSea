...
ACE inhibitor (ACEi) angioedema is a non-mast cell, bradykinin-mediated angioedema without urticaria, occurring in 0.1-0.7% of patients on ACE inhibitors. Most common in first weeks but can occur years after starting. Risk: black patients 4-5x higher; female; smoking. Treatment: stop ACEi, switch to ARB (low cross-reactivity).

## Clinical Features and Presentation

ACE inhibitor angioedema presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Drugs | ACE inhibitors (captopril, enalapril, lisinopril, ramipril) |
| Incidence | 0.1-0.7% |
| Mechanism | Bradykinin accumulation (ACE degrades bradykinin) |
| Time to onset | Days to years (most within first weeks) |
| Sites | Face, lips, tongue, larynx (life-threatening) |
| No urticaria | Yes |
| Itch | Absent |
| Risk | Black 4-5x, female, smoking, prior angioedema |
| Treatment | STOP ACEi; airway management; icatibant or C1-INH (emerging evidence); FFP |
| Switch | ARBs (low cross-reactivity 2-10%); caution with sacubitril/valsartan |
| Reporting | Yellow card; consider HAE investigation if recurrent off ACEi |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| HAE | Family history, low C1-INH, younger onset |

## Viva Questions

1. **Q:** Define ACE inhibitor angioedema and outline its classification.
   **A:** ACE inhibitor (ACEi) angioedema is a non-mast cell, bradykinin-mediated angioedema without urticaria, occurring in 0.1-0.7% of patients on ACE inhibitors. Most common in first weeks but can occur year

2. **Q:** What are the key clinical features of ACE inhibitor angioedema?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of ACE inhibitor angioedema.
...
1. **ACEi = bradykinin** = No urticaria, no itch, bradykinin, more common in Black
...
| **Topic** | **ACE inhibitor angioedema** |
|-----------|-----------|
| **Definition** | ACE inhibitor (ACEi) angioedema is a non-mast cell, bradykinin-mediated angioedema without urticaria |
| **Key Features** | ACE inhibitors (captopril, enalapril, lisinopril, ramipril) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of ACE inhibitor angioedema?
   A. ACE inhibitors (captopril, enalapril, lisinopril, ramipril)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Drugs: ACE inhibitors (captopril, enalapril, lisinopril, ramipril)*
2. **Q:** What is the first-line treatment for ACE inhibitor angioedema?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for ACE inhibitor angioedema?
...
4. **Q:** What is the most important complication of ACE inhibitor angioedema?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of ACE inhibitor angioedema?
   A. Yellow card; consider HAE investigation if recurrent off ACEi
...
## SBA Questions (5)
1. **Scenario:** Patient with ACE inhibitor angioedema; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** ACE inhibitor angioedema failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of ACE inhibitor angioedema?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for ACE inhibitor angioedema?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in ACE inhibitor angioedema?
   A. Yellow card; consider HAE investigation if recurrent off ACEi
...
- **Q:** Key fact about ACE inhibitor angioedema?
  **A:** ACE inhibitors (captopril, enalapril, lisinopril, ramipril)
- **Q:** Another key point?
  **A:** 0.1-0.7%
- **Q:** Most important complication?
  **A:** Bradykinin accumulation (ACE degrades bradykinin)
- **Q:** First-line treatment?
  **A:** Days to years (most within first weeks)
- **Q:** Key histological/serological feature?
  **A:** Face, lips, tongue, larynx (life-threatening)

## Answer Key with Explanations

### MCQs
1. **A** — Drugs: ACE inhibitors (captopril, enalapril, lisinopril, ramipril)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Reporting: Yellow card; consider HAE investigation if recurrent off ACEi
...
5. **A** — Yellow card; consider HAE investigation if recurrent off ACEi
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — ACE inhibitor angioedema full*

**Q1.** What is the most appropriate first-line therapy for ACE inhibitor angioedema full?
