...
Cutaneous amyloidosis comprises skin deposits of amyloid protein. Primary localised cutaneous amyloidosis (PLCA): lichen amyloidosis (papular, hyperkeratotic, shins), macular amyloidosis (hyperpigmented patches, back), nodular amyloidosis. Secondary systemic amyloidosis (AA, AL) can also affect skin (periorbital purpura, 'pinch purpura', macroglossia). Histology: Congo red (apple-green birefringence under polarised light), thioflavin T, crystal violet.

## Clinical Features and Presentation

Amyloidosis (cutaneous) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| PLCA | Lichen, macular, nodular amyloidosis |
| Lichen | Hyperkeratotic papules, shins, pruritic |
| Macular | Hyperpigmented patches, rippled, back |
| Nodular | Single or few nodules |
| Systemic | AA (chronic inflammation), AL (plasma cell dyscrasia), ATTR (hereditary) |
| Skin in systemic | Periorbital purpura ('pinch purpura' or 'raccoon eyes'), macroglossia, waxy papules |
| Histology | Congo red + apple-green birefringence under polarised light; thioflavin T fluorescence |
| AA | Serum amyloid A, chronic inflammation (RA, IBD, periodic fever) |
| AL | Light chain (kappa or lambda), plasma cell dyscrasia (myeloma, MGUS) |
| Treatment | PLCA: topical steroids, keratolytics, phototherapy; systemic: treat underlying |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Lichen simplex chronicus | No amyloid on biopsy |

## Viva Questions

1. **Q:** Define Amyloidosis (cutaneous) and outline its classification.
   **A:** Cutaneous amyloidosis comprises skin deposits of amyloid protein. Primary localised cutaneous amyloidosis (PLCA): lichen amyloidosis (papular, hyperkeratotic, shins), macular amyloidosis (hyperpigment

2. **Q:** What are the key clinical features of Amyloidosis (cutaneous)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Amyloidosis (cutaneous).
...
| **Topic** | **Amyloidosis (cutaneous)** |
|-----------|-----------|
| **Definition** | Cutaneous amyloidosis comprises skin deposits of amyloid protein. Primary localised cutaneous amyloi |
| **Key Features** | Lichen, macular, nodular amyloidosis |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Amyloidosis (cutaneous)?
   A. Lichen, macular, nodular amyloidosis
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Amyloidosis (cutaneous)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Amyloidosis (cutaneous)?
...
5. **Q:** What is the key histological/serological feature?
   A. PLCA: topical steroids, keratolytics, phototherapy; systemic: treat underlying
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Amyloidosis (cutaneous); first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Amyloidosis (cutaneous)?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Amyloidosis (cutaneous)?
   A. PLCA: topical steroids, keratolytics, phototherapy; systemic: treat underlying
...
- **Q:** Key fact about Amyloidosis (cutaneous)?
  **A:** Lichen, macular, nodular amyloidosis
- **Q:** Another key point?
  **A:** Hyperkeratotic papules, shins, pruritic
- **Q:** Most important complication?
  **A:** Hyperpigmented patches, rippled, back
- **Q:** First-line treatment?
  **A:** Single or few nodules
- **Q:** Key histological/serological feature?
  **A:** AA (chronic inflammation), AL (plasma cell dyscrasia), ATTR (hereditary)

## Answer Key with Explanations

### MCQs
1. **A** — PLCA: Lichen, macular, nodular amyloidosis
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: PLCA: topical steroids, keratolytics, phototherapy; systemic: treat underlying
...
5. **A** — PLCA: topical steroids, keratolytics, phototherapy; systemic: treat underlying
