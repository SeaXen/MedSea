...
Chronic spontaneous urticaria (CSU) is defined as daily or near-daily urticaria (wheals) and/or angioedema persisting for more than 6 weeks, with no identifiable external trigger. Affects 1% of population, predominantly adults (peak 20-40), female predominance 2:1. Pathogenesis: mast cell and basophil degranulation; 30-50% have autoantibodies against IgE or FcεRI (Type IIb autoimmunity).

## Clinical Features and Presentation

Chronic spontaneous urticaria presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Duration | More than 6 weeks, daily or near-daily |
| Prevalence | 1% |
| Sex | Female 2:1 |
| Pathogenesis | Mast cell degranulation; 30-50% have IgE/FcεRI autoantibodies |
| Associated | Autoimmune (thyroid, vitiligo, type 1 diabetes) |
| Angioedema | 40% |
| QoL | Severe impact; sleep, work, social |
| UAS7 | Daily Urticaria Activity Score 0-42; severe more than 28 |
| Treatment | H1 antihistamines 2nd gen up to 4x; omalizumab 300mg SC 4-weekly; ciclosporin if refractory |
| Differential | Chronic inducible urticaria, urticarial vasculitis, autoinflammatory |
| Duration | Average 1-5 years; 50% resolve in 1 year |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Urticarial vasculitis | Lesions last more than 24h, painful, bruise |
| Chronic inducible | Specific trigger |

## Viva Questions

1. **Q:** Define Chronic spontaneous urticaria and outline its classification.
   **A:** Chronic spontaneous urticaria (CSU) is defined as daily or near-daily urticaria (wheals) and/or angioedema persisting for more than 6 weeks, with no identifiable external trigger. Affects 1% of popula

2. **Q:** What are the key clinical features of Chronic spontaneous urticaria?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Chronic spontaneous urticaria.
...
1. **CSU stepwise** = H1 → 2x → 4x → omalizumab → ciclosporin
...
| **Topic** | **Chronic spontaneous urticaria** |
|-----------|-----------|
| **Definition** | Chronic spontaneous urticaria (CSU) is defined as daily or near-daily urticaria (wheals) and/or angi |
| **Key Features** | More than 6 weeks, daily or near-daily |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Chronic spontaneous urticaria?
   A. More than 6 weeks, daily or near-daily
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Duration: More than 6 weeks, daily or near-daily*
2. **Q:** What is the first-line treatment for Chronic spontaneous urticaria?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Chronic spontaneous urticaria?
...
4. **Q:** What is the most important complication of Chronic spontaneous urticaria?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Chronic spontaneous urticaria?
   A. Average 1-5 years; 50% resolve in 1 year
...
## SBA Questions (5)
1. **Scenario:** Patient with Chronic spontaneous urticaria; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Chronic spontaneous urticaria failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Chronic spontaneous urticaria?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Chronic spontaneous urticaria?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Chronic spontaneous urticaria?
   A. Average 1-5 years; 50% resolve in 1 year
...
- **Q:** Key fact about Chronic spontaneous urticaria?
  **A:** More than 6 weeks, daily or near-daily
- **Q:** Another key point?
  **A:** 1%
...
- **Q:** First-line treatment?
  **A:** Mast cell degranulation; 30-50% have IgE/FcεRI autoantibodies
- **Q:** Key histological/serological feature?
  **A:** Autoimmune (thyroid, vitiligo, type 1 diabetes)

## Answer Key with Explanations

### MCQs
1. **A** — Duration: More than 6 weeks, daily or near-daily
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Duration: Average 1-5 years; 50% resolve in 1 year
...
5. **A** — Average 1-5 years; 50% resolve in 1 year
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Chronic Spontaneous Urticaria full*

**Q1.** Which of the following features is most specific or characteristic of Chronic Spontaneous Urticaria full?
  ...
  > **Answer: A** — Duration
  >
  > *Source:* ythematous/white, **pruritic** papules/plaques |
| **Size** | Few mm to large confluent plaques |
| **Duration** | **<24 hours** individual wheal (key vs vasculitis) |
| **Distribution** | Any site; t

**Q2.** What is the most appropriate first-line therapy for Chronic Spontaneous Urticaria full?
  ...
  > **Answer: A** — Omalizumab
  >
  > *Source:* Step 4: **Omalizumab 300 mg SC q4 weeks** (licensed)
    │
    ▼ Inadequate control
    │
