...
Kaposi sarcoma (KS) is a low-grade vascular tumour caused by HHV-8 (KSHV). Four types: classic (elderly Mediterranean men, indolent), endemic (African, children/adults), iatrogenic (immunosuppression, transplant, HIV-negative), epidemic (AIDS-related, aggressive). Skin: purple/red/brown macules → plaques → nodules (face, oral, genitals, lower limbs); may involve mucosa, lymph nodes, viscera (lung, GI). Diagnosis: biopsy (spindle cells, slit-like vessels, extravasated RBCs, HHV-8 LANA+ IHC). Treatment: ART first (HIV-KS); local (cryotherapy, intralesional vinblastine, radiotherapy, imiquimod); systemic (liposomal doxorubicin, paclitaxel, interferon-alpha, immune checkpoint inhibitors).

## Clinical Features and Presentation

Kaposi sarcoma presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
|----------|------------|
| Cause | HHV-8 (KSHV) |
| Types | Classic, endemic, iatrogenic, epidemic (AIDS) |
| AIDS-KS | Aggressive, mucocutaneous, visceral |
| Skin | Purple/red/brown macules → plaques → nodules |
| Sites | Face, oral, genitals, lower limbs; widespread |
| Mucosa | Oral (palate), GI, respiratory |
| Histology | Spindle cells, slit-like vessels, extravasated RBCs, haemosiderin |
| IHC | HHV-8 LANA+ (LANA-1) |
| Treatment | ART first (HIV); local: cryo, intralesional vinblastine, RT, imiquimod |
| Systemic | Liposomal doxorubicin, paclitaxel, IFN-alpha, pembrolizumab |
| Prognosis | ART improves KS significantly; visceral KS poorer prognosis |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Bacillary angiomatosis | Bartonella, neutrophilic infiltrate |

## Viva Questions

1. **Q:** Define Kaposi sarcoma and outline its classification.
   **A:** Kaposi sarcoma (KS) is a low-grade vascular tumour caused by HHV-8 (KSHV). Four types: classic (elderly Mediterranean men, indolent), endemic (African, children/adults), iatrogenic (immunosuppression,

2. **Q:** What are the key clinical features of Kaposi sarcoma?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Kaposi sarcoma.
...
| **Topic** | **Kaposi sarcoma** |
|-----------|-----------|
| **Definition** | Kaposi sarcoma (KS) is a low-grade vascular tumour caused by HHV-8 (KSHV). Four types: classic (elde |
| **Key Features** | HHV-8 (KSHV) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Kaposi sarcoma?
   A. HHV-8 (KSHV)
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Kaposi sarcoma?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Kaposi sarcoma?
...
5. **Q:** What is the key histological/serological feature?
   A. ART improves KS significantly; visceral KS poorer prognosis
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Kaposi sarcoma; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Kaposi sarcoma?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Kaposi sarcoma?
   A. ART improves KS significantly; visceral KS poorer prognosis
...
- **Q:** Key fact about Kaposi sarcoma?
  **A:** HHV-8 (KSHV)
- **Q:** Another key point?
  **A:** Classic, endemic, iatrogenic, epidemic (AIDS)
- **Q:** Most important complication?
  **A:** Aggressive, mucocutaneous, visceral
- **Q:** First-line treatment?
  **A:** Purple/red/brown macules → plaques → nodules
- **Q:** Key histological/serological feature?
  **A:** Face, oral, genitals, lower limbs; widespread

## Answer Key with Explanations

### MCQs
1. **A** — Cause: HHV-8 (KSHV)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prognosis: ART improves KS significantly; visceral KS poorer prognosis
...
5. **A** — ART improves KS significantly; visceral KS poorer prognosis
