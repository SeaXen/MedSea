...
Trichotillomania (TTM) is a psychiatric disorder (DSM-5 obsessive-compulsive related) characterised by recurrent pulling out of one's own hair, resulting in hair loss. May involve scalp, eyebrows, eyelashes, pubic, axillary. More common in children (often self-limiting) and adult women. Associated with anxiety, depression, OCD. Treatment: CBT (habit reversal training), SSRIs, N-acetylcysteine.

## Clinical Features and Presentation

Trichotillomania presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Type | Psychiatric (OCD-related) |
| Behaviour | Recurrent hair pulling |
| Site | Scalp (most common), eyebrows, eyelashes, pubic |
| Patch | Irregular, asymmetric, incomplete hair loss (broken hairs of varying length) |
| Trichoscopy | Hairs broken at different lengths, V-sign, trichoptilosis (split ends), no exclamation marks |
| Psychiatric | Anxiety, depression, OCD, body dysmorphic disorder |
| Children | More common; often self-limiting; consider habit |
| Adults | Often chronic, women more; comorbidity common |
| Treatment | CBT (habit reversal training), SSRIs, N-acetylcysteine, olanzapine |
| Differential | AA (smooth bald patch, exclamation marks), tinea (KOH+, scaling) |
| Classification | Body-focused repetitive behaviour (BFRB) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| AA | Smooth bald patch, exclamation marks |

## Viva Questions

1. **Q:** Define Trichotillomania and outline its classification.
   **A:** Trichotillomania (TTM) is a psychiatric disorder (DSM-5 obsessive-compulsive related) characterised by recurrent pulling out of one's own hair, resulting in hair loss. May involve scalp, eyebrows, eye

2. **Q:** What are the key clinical features of Trichotillomania?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Trichotillomania.
...
1. Trichotillomania = broken hairs of varying length, no exclamation marks
...
| **Topic** | **Trichotillomania** |
|-----------|-----------|
| **Definition** | Trichotillomania (TTM) is a psychiatric disorder (DSM-5 obsessive-compulsive related) characterised  |
| **Key Features** | Psychiatric (OCD-related) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Trichotillomania?
   A. Psychiatric (OCD-related)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Type: Psychiatric (OCD-related)*
2. **Q:** What is the first-line treatment for Trichotillomania?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Trichotillomania?
...
4. **Q:** What is the most important complication of Trichotillomania?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Trichotillomania?
...
## SBA Questions (5)
1. **Scenario:** Patient with Trichotillomania; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Trichotillomania failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Trichotillomania?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Trichotillomania?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Trichotillomania?
   A. Body-focused repetitive behaviour (BFRB)
...
- **Q:** Key fact about Trichotillomania?
  **A:** Psychiatric (OCD-related)
- **Q:** Another key point?
  **A:** Recurrent hair pulling
- **Q:** Most important complication?
  **A:** Scalp (most common), eyebrows, eyelashes, pubic
- **Q:** First-line treatment?
  **A:** Irregular, asymmetric, incomplete hair loss (broken hairs of varying length)
- **Q:** Key histological/serological feature?
  **A:** Hairs broken at different lengths, V-sign, trichoptilosis (split ends), no exclamation marks

## Answer Key with Explanations

### MCQs
1. **A** — Type: Psychiatric (OCD-related)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Classification: Body-focused repetitive behaviour (BFRB)
...
5. **A** — Body-focused repetitive behaviour (BFRB)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Trichotillomania full*

**Q1.** What is the most appropriate first-line therapy for Trichotillomania full?
