...
Merkel cell carcinoma (MCC) is a rare, aggressive neuroendocrine carcinoma of the skin, with high rates of local recurrence and distant metastasis. Affects elderly, sun-exposed sites, often head/neck. Presents as rapidly growing, painless, red/purple nodule. Merkel cell polyomavirus (MCPyV) implicated in 80%. Treatment: wide local excision + SLNB + adjuvant radiotherapy; immunotherapy (avelumab, anti-PD-L1) for metastatic. Mortality 30-50%.

## Clinical Features and Presentation

Merkel cell carcinoma presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Merkel cell polyomavirus (MCPyV) 80%; UV 20% |
| Type | Neuroendocrine carcinoma |
| Site | Sun-exposed: head/neck (50%), extremities |
| Appearance | Rapidly growing red/purple nodule, painless |
| Age | Elderly (>65) |
| Staging | Tumour size, lymph node, metastasis (SLNB recommended) |
| Histology | Small round blue cells, neuroendocrine markers (CK20+, synaptophysin+, chromogranin+), TdT- |
| IHC | CK20 perinuclear dot-like, neurofilament+ |
| Treatment | WLE + SLNB + adjuvant RT; avelumab (anti-PD-L1) for metastatic |
| Prognosis | Poor; 5-yr survival 50% (local), 14% (metastatic) |
| Differential | BCC, SCC, amelanotic melanoma, cutaneous lymphoma, dermatofibroma |
| Recurrence | High; local 25-30%, regional 50-65% distant |
...
1. **Q:** Define Merkel cell carcinoma and outline its classification.
   **A:** Merkel cell carcinoma (MCC) is a rare, aggressive neuroendocrine carcinoma of the skin, with high rates of local recurrence and distant metastasis. Affects elderly, sun-exposed sites, often head/neck.

2. **Q:** What are the key clinical features of Merkel cell carcinoma?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Merkel cell carcinoma.
...
1. **MCC** = Aggressive neuroendocrine; CK20 dot-like; polyomavirus
...
| **Topic** | **Merkel cell carcinoma** |
|-----------|-----------|
| **Definition** | Merkel cell carcinoma (MCC) is a rare, aggressive neuroendocrine carcinoma of the skin, with high ra |
| **Key Features** | Merkel cell polyomavirus (MCPyV) 80%; UV 20% |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Merkel cell carcinoma?
   A. Merkel cell polyomavirus (MCPyV) 80%; UV 20%
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Merkel cell polyomavirus (MCPyV) 80%; UV 20%*
2. **Q:** What is the first-line treatment for Merkel cell carcinoma?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Merkel cell carcinoma?
...
4. **Q:** What is the most important complication of Merkel cell carcinoma?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Merkel cell carcinoma?
   A. High; local 25-30%, regional 50-65% distant
...
## SBA Questions (5)
1. **Scenario:** Patient with Merkel cell carcinoma; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Merkel cell carcinoma failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Merkel cell carcinoma?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Merkel cell carcinoma?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Merkel cell carcinoma?
   A. High; local 25-30%, regional 50-65% distant
...
- **Q:** Key fact about Merkel cell carcinoma?
  **A:** Merkel cell polyomavirus (MCPyV) 80%; UV 20%
- **Q:** Another key point?
  **A:** Neuroendocrine carcinoma
- **Q:** Most important complication?
  **A:** Sun-exposed: head/neck (50%), extremities
- **Q:** First-line treatment?
  **A:** Rapidly growing red/purple nodule, painless
...
### MCQs
1. **A** — Cause: Merkel cell polyomavirus (MCPyV) 80%; UV 20%
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Recurrence: High; local 25-30%, regional 50-65% distant
...
5. **A** — High; local 25-30%, regional 50-65% distant
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Merkel cell carcinoma full*

**Q1.** What is the most appropriate first-line therapy for Merkel cell carcinoma full?
