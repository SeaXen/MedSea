...
topic: Congenital ichthyosiform erythroderma
...
Congenital ichthyosiform erythroderma (CIE) is an autosomal recessive ichthyosis (ARCI) presenting as collodion baby with generalised erythroderma and fine white scale (vs lamellar plate-like). Caused by mutations in ALOX12B, ALOXE3, NIPAL4, TGM1, others. May be difficult to distinguish from lamellar at birth. Treatment similar.
...
| Erythroderma | Generalised, persistent |
| Scale | Fine white |
| Vs lamellar | Lamellar = plate-like scales; CIE = erythroderma + fine scale |
| Genes | ALOX12B, ALOXE3, NIPAL4, TGM1, others |
| Complications | Temperature, infection, dehydration |
| Treatment | Emollients, keratolytics, oral retinoids |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Lamellar | Plate-like scales |

## Viva Questions

1. **Q:** Define Congenital ichthyosiform erythroderma and outline its classification.
   **A:** Congenital ichthyosiform erythroderma (CIE) is an autosomal recessive ichthyosis (ARCI) presenting as collodion baby with generalised erythroderma and fine white scale (vs lamellar plate-like). Caused

2. **Q:** What are the key clinical features of Congenital ichthyosiform erythroderma?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Congenital ichthyosiform erythroderma.
...
| **Topic** | **Congenital ichthyosiform erythroderma** |
|-----------|-----------|
| **Definition** | Congenital ichthyosiform erythroderma (CIE) is an autosomal recessive ichthyosis (ARCI) presenting a |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Congenital ichthyosiform erythroderma?
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Congenital ichthyosiform erythroderma?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Congenital ichthyosiform erythroderma?
...
5. **Q:** What is the key histological/serological feature?
   A. Emollients, keratolytics, oral retinoids
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Congenital ichthyosiform erythroderma; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Congenital ichthyosiform erythroderma?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Congenital ichthyosiform erythroderma?
   A. Emollients, keratolytics, oral retinoids
...
- **Q:** Key fact about Congenital ichthyosiform erythroderma?
  **A:** Autosomal recessive
- **Q:** Another key point?
  **A:** Collodion baby
- **Q:** Most important complication?
  **A:** Generalised, persistent
- **Q:** First-line treatment?
  **A:** Fine white
- **Q:** Key histological/serological feature?
  **A:** Lamellar = plate-like scales; CIE = erythroderma + fine scale
...
5. **A** — Treatment: Emollients, keratolytics, oral retinoids
...
5. **A** — Emollients, keratolytics, oral retinoids
