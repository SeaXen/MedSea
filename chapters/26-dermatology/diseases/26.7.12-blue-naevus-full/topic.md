...
Blue naevus is a benign melanocytic naevus with dendritic melanocytes deep in the dermis (Tyndall effect — blue colour). Two main types: common blue naevus (small, well-defined, blue-black, 0.5-1cm) and cellular blue naevus (larger, more cellular, buttocks/sacrum, can be 1-3cm, rarely malignant transformation). Dermoscopy: homogeneous blue colour, often with white areas. Treatment: observation; excision if suspicious (cannot reliably differentiate from nodular melanoma).

## Clinical Features and Presentation

Blue naevus presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Dendritic melanocytes deep in dermis (Tyndall effect) |
| Colour | Blue, blue-black, slate-grey |
| Tyndall | Light scattering by dermal melanin gives blue appearance |
| Common | Small (0.5-1cm), well-defined, on extremities, head |
| Cellular | Larger (1-3cm), buttocks, sacrum, scalp; can be nodular |
| Dermoscopy | Homogeneous blue, white scar-like areas (cellular) |
| Malignant potential | Common: very low; cellular: rare transformation to melanoma |
| Differential | Nodular melanoma, BCC (pigmented), tattoo, venous lake |
| Treatment | Observation; excision if suspicious or changing |
| Histology | Dendritic melanocytes in mid-dermis, melanin pigment |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Nodular melanoma | Rapid growth, ABCDE |

## Viva Questions

1. **Q:** Define Blue naevus and outline its classification.
   **A:** Blue naevus is a benign melanocytic naevus with dendritic melanocytes deep in the dermis (Tyndall effect — blue colour). Two main types: common blue naevus (small, well-defined, blue-black, 0.5-1cm) a

2. **Q:** What are the key clinical features of Blue naevus?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Blue naevus.
...
1. Blue naevus = Tyndall effect = blue colour from deep melanin
...
| **Topic** | **Blue naevus** |
|-----------|-----------|
| **Definition** | Blue naevus is a benign melanocytic naevus with dendritic melanocytes deep in the dermis (Tyndall ef |
| **Key Features** | Dendritic melanocytes deep in dermis (Tyndall effect) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Blue naevus?
   A. Dendritic melanocytes deep in dermis (Tyndall effect)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Dendritic melanocytes deep in dermis (Tyndall effect)*
2. **Q:** What is the first-line treatment for Blue naevus?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Blue naevus?
...
4. **Q:** What is the most important complication of Blue naevus?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Blue naevus?
   A. Dendritic melanocytes in mid-dermis, melanin pigment
...
- **Q:** Key fact about Blue naevus?
  **A:** Dendritic melanocytes deep in dermis (Tyndall effect)
- **Q:** Another key point?
  **A:** Blue, blue-black, slate-grey
- **Q:** Most important complication?
  **A:** Light scattering by dermal melanin gives blue appearance
- **Q:** First-line treatment?
  **A:** Small (0.5-1cm), well-defined, on extremities, head
- **Q:** Key histological/serological feature?
  **A:** Larger (1-3cm), buttocks, sacrum, scalp; can be nodular

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Dendritic melanocytes deep in dermis (Tyndall effect)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Histology: Dendritic melanocytes in mid-dermis, melanin pigment
...
5. **A** — Dendritic melanocytes in mid-dermis, melanin pigment
