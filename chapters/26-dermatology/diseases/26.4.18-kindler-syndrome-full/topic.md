...
Kindler syndrome is a rare autosomal recessive genodermatosis with mutations in FERMT1 (kindlin-1). Features include: congenital skin blistering that improves with age, photosensitivity, poikiloderma, skin atrophy, periodontal disease, and increased SCC risk. Multi-level blistering (intraepidermal, lamina lucida, sub-lamina densa).

## Clinical Features and Presentation

Kindler syndrome presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Gene | FERMT1 (kindlin-1) |
| Split | MULTIPLE LEVELS (intraepidermal, lamina lucida, sub-lamina densa) |
| Photosensitivity | Yes (key feature) |
| Poikiloderma | Yes (skin atrophy + telangiectasia + pigment changes) |
| Skin atrophy | Yes (cigarette-paper-like) |
| Periodontal disease | Early-onset severe periodontitis |
| SCC risk | Increased in chronic wounds and mucosa |
| Improves with age | Blistering tends to improve after childhood |
| Other | Ectropion, oesophageal strictures, urethral strictures, nail dystrophy |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| EB simplex | Single level split, no photosensitivity |

## Viva Questions

1. **Q:** Define Kindler syndrome and outline its classification.
   **A:** Kindler syndrome is a rare autosomal recessive genodermatosis with mutations in FERMT1 (kindlin-1). Features include: congenital skin blistering that improves with age, photosensitivity, poikiloderma,

2. **Q:** What are the key clinical features of Kindler syndrome?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Kindler syndrome.
...
1. **Kindler unique** = Multi-level split + photosensitivity + poikiloderma
...
| **Topic** | **Kindler syndrome** |
|-----------|-----------|
| **Definition** | Kindler syndrome is a rare autosomal recessive genodermatosis with mutations in FERMT1 (kindlin-1).  |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Kindler syndrome?
...
2. **Q:** What is the first-line treatment for Kindler syndrome?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Kindler syndrome?
...
4. **Q:** What is the most important complication of Kindler syndrome?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Kindler syndrome?
   A. Ectropion, oesophageal strictures, urethral strictures, nail dystrophy
...
## SBA Questions (5)
1. **Scenario:** Patient with Kindler syndrome; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Kindler syndrome failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Kindler syndrome?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Kindler syndrome?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Kindler syndrome?
   A. Ectropion, oesophageal strictures, urethral strictures, nail dystrophy
...
- **Q:** Key fact about Kindler syndrome?
  **A:** Autosomal recessive
- **Q:** Another key point?
  **A:** FERMT1 (kindlin-1)
- **Q:** Most important complication?
  **A:** MULTIPLE LEVELS (intraepidermal, lamina lucida, sub-lamina densa)
- **Q:** First-line treatment?
  **A:** Yes (key feature)
- **Q:** Key histological/serological feature?
  **A:** Yes (skin atrophy + telangiectasia + pigment changes)
...
5. **A** — Other: Ectropion, oesophageal strictures, urethral strictures, nail dystrophy
...
5. **A** — Ectropion, oesophageal strictures, urethral strictures, nail dystrophy
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Kindler syndrome full*

**Q1.** What is the most appropriate first-line therapy for Kindler syndrome full?
