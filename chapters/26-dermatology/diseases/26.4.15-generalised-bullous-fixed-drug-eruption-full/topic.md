...
topic: Generalised bullous fixed drug eruption
...
Generalised bullous fixed drug eruption (GBFDE) is a severe variant of FDE with widespread bullae (more than 10% BSA) that may mimic SJS/TEN but has a better prognosis. Distinguished from SJS/TEN by: shorter latency (often less than 24 h), round/oval discrete bullae (not targetoid), less mucosal involvement (or limited to one site), and prior history of FDE at the same site.

## Clinical Features and Presentation

Generalised bullous fixed drug eruption presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Differentiation | Mimics SJS/TEN but better prognosis |
| Latency | Shorter than SJS/TEN (often less than 24 h) |
| Lesions | Round/oval bullae (vs targetoid in SJS/TEN) |
| Mucosa | Less involved (1 site or none) |
| History | Prior FDE at same site |
| Outcome | Better than SJS/TEN; mortality less than 5% |
| Common drugs | NSAIDs (naproxen, diclofenac), paracetamol, sulfonamides, tetracyclines |
| Mechanism | CD8+ T cell reactivation against drug antigen in skin |
| Treatment | STOP drug; supportive; topical/systemic steroids |
| Cross-reactivity | Within drug class (e.g., all NSAIDs) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| SJS/TEN | Acute, targetoid, mucosal, more severe |

## Viva Questions

1. **Q:** Define Generalised bullous fixed drug eruption and outline its classification.
   **A:** Generalised bullous fixed drug eruption (GBFDE) is a severe variant of FDE with widespread bullae (more than 10% BSA) that may mimic SJS/TEN but has a better prognosis. Distinguished from SJS/TEN by: 

2. **Q:** What are the key clinical features of Generalised bullous fixed drug eruption?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Generalised bullous fixed drug eruption.
...
1. **GBFDE vs SJS** = GBFDE = round bullae, less mucosa, prior FDE history
...
| **Topic** | **Generalised bullous fixed drug eruption** |
|-----------|-----------|
| **Definition** | Generalised bullous fixed drug eruption (GBFDE) is a severe variant of FDE with widespread bullae (m |
| **Key Features** | Mimics SJS/TEN but better prognosis |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Generalised bullous fixed drug eruption?
   A. Mimics SJS/TEN but better prognosis
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Differentiation: Mimics SJS/TEN but better prognosis*
2. **Q:** What is the first-line treatment for Generalised bullous fixed drug eruption?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Generalised bullous fixed drug eruption?
...
4. **Q:** What is the most important complication of Generalised bullous fixed drug eruption?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Generalised bullous fixed drug eruption?
   A. Within drug class (e.g., all NSAIDs)
...
## SBA Questions (5)
1. **Scenario:** Patient with Generalised bullous fixed drug eruption; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Generalised bullous fixed drug eruption failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Generalised bullous fixed drug eruption?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Generalised bullous fixed drug eruption?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Generalised bullous fixed drug eruption?
   A. Within drug class (e.g., all NSAIDs)
...
- **Q:** Key fact about Generalised bullous fixed drug eruption?
  **A:** Mimics SJS/TEN but better prognosis
- **Q:** Another key point?
  **A:** Shorter than SJS/TEN (often less than 24 h)
- **Q:** Most important complication?
  **A:** Round/oval bullae (vs targetoid in SJS/TEN)
- **Q:** First-line treatment?
  **A:** Less involved (1 site or none)
- **Q:** Key histological/serological feature?
  **A:** Prior FDE at same site

## Answer Key with Explanations

### MCQs
1. **A** — Differentiation: Mimics SJS/TEN but better prognosis
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Cross-reactivity: Within drug class (e.g., all NSAIDs)
...
5. **A** — Within drug class (e.g., all NSAIDs)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Generalised bullous fixed drug eruption full*

**Q1.** What is the most appropriate first-line therapy for Generalised bullous fixed drug eruption full?
