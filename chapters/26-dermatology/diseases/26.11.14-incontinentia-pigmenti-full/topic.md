...
Incontinentia pigmenti (IP, Bloch-Sulzberger) is an X-linked dominant disorder, usually lethal in males, due to NEMO/IKBKG mutation. Female neonates: 4 stages (vesiculobullous, verrucous/papular, hyperpigmented, hypopigmented/atrophic). Stage 1: vesicles in Blaschkoid pattern at birth; Stage 2: verrucous papules (weeks-months); Stage 3: hyperpigmented whorled patches (months-years); Stage 4: hypopigmented atrophic patches (adulthood). Other: dental (hypodontia, delayed eruption), alopecia, nail dystrophy, eye (retinal detachment, strabismus), CNS (seizures, intellectual disability). Histology: eosinophilic spongiosis (Stage 1); verrucous (Stage 2); pigment incontinence (Stage 3).
...
| Category | Key Points |
|----------|------------|
| Gene | NEMO/IKBKG (Xq28) |
| Inheritance | X-linked dominant (lethal in males) |
| Stages | 1 vesicles, 2 verrucous, 3 hyperpigmented whorls, 4 hypopigmented atrophic |
| Distribution | Blaschkoid lines |
| Other | Dental (hypodontia), alopecia, nail dystrophy, retinal detachment, seizures, MR |
| Histology | Eosinophilic spongiosis (Stage 1), pigment incontinence (Stage 3) |
| Eye | Retinal detachment, strabismus, cataracts |
| CNS | Seizures (10-30%), intellectual disability |
| Treatment | Supportive, ophthalmology, neuro, dental; laser for verrucous/neovascular |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Hypomelanosis Ito | Blaschkoid hypopigmentation |

## Viva Questions

1. **Q:** Define Incontinentia pigmenti and outline its classification.
   **A:** Incontinentia pigmenti (IP, Bloch-Sulzberger) is an X-linked dominant disorder, usually lethal in males, due to NEMO/IKBKG mutation. Female neonates: 4 stages (vesiculobullous, verrucous/papular, hype

2. **Q:** What are the key clinical features of Incontinentia pigmenti?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Incontinentia pigmenti.
...
| **Topic** | **Incontinentia pigmenti** |
|-----------|-----------|
| **Definition** | Incontinentia pigmenti (IP, Bloch-Sulzberger) is an X-linked dominant disorder, usually lethal in ma |
| **Key Features** | NEMO/IKBKG (Xq28) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Incontinentia pigmenti?
   A. NEMO/IKBKG (Xq28)
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Incontinentia pigmenti?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Incontinentia pigmenti?
...
5. **Q:** What is the key histological/serological feature?
   A. Supportive, ophthalmology, neuro, dental; laser for verrucous/neovascular
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Incontinentia pigmenti; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Incontinentia pigmenti?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Incontinentia pigmenti?
   A. Supportive, ophthalmology, neuro, dental; laser for verrucous/neovascular
...
- **Q:** Key fact about Incontinentia pigmenti?
  **A:** NEMO/IKBKG (Xq28)
- **Q:** Another key point?
  **A:** X-linked dominant (lethal in males)
- **Q:** Most important complication?
  **A:** 1 vesicles, 2 verrucous, 3 hyperpigmented whorls, 4 hypopigmented atrophic
- **Q:** First-line treatment?
  **A:** Blaschkoid lines
- **Q:** Key histological/serological feature?
  **A:** Dental (hypodontia), alopecia, nail dystrophy, retinal detachment, seizures, MR

## Answer Key with Explanations

### MCQs
1. **A** — Gene: NEMO/IKBKG (Xq28)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Supportive, ophthalmology, neuro, dental; laser for verrucous/neovascular
...
5. **A** — Supportive, ophthalmology, neuro, dental; laser for verrucous/neovascular
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Incontinentia pigmenti full*

**Q1.** What is the most appropriate first-line therapy for Incontinentia pigmenti full?
