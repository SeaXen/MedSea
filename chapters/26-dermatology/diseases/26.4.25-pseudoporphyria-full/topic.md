...
| Category | Key Points |
|----------|------------|
| Features | Identical to PCT clinically and histologically |
| Porphyrins | Normal (key distinguishing from PCT) |
| PCT features | Photosensitivity, skin fragility, vesicles/bullae on dorsum hands, milia, hypertrichosis, hyperpigmentation |
| Causes | Drugs (NSAIDs especially naproxen, tetracyclines, furosemide), CKD, haemodialysis, UV, tanning |
| Histology | Subepidermal bullae with festooning, caterpillar bodies, thickening of dermal vessels |
| DIF | Granular IgG/C3 at BMZ and around dermal vessels |
| Treatment | Stop offending drug; sun protection; N-acetylcysteine |
| Differential | PCT (elevated porphyrins), EBA, BP |
| Renal failure | Decreased porphyrin clearance may contribute |
| NSAIDs | Most common drug cause (naproxen, ibuprofen, ketoprofen) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| PCT | Elevated porphyrins (uroporphyrins) |

## Viva Questions

1. **Q:** Define Pseudoporphyria and outline its classification.
   **A:** Pseudoporphyria is a photodistributed bullous disorder with clinical and histological features of porphyria cutanea tarda (PCT) but normal porphyrin metabolism. Causes: drugs (NSAIDs especially naprox

2. **Q:** What are the key clinical features of Pseudoporphyria?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Pseudoporphyria.
...
1. **Pseudoporphyria clue** = PCT features + normal porphyrins = drug or renal failure
...
| **Topic** | **Pseudoporphyria** |
|-----------|-----------|
| **Definition** | Pseudoporphyria is a photodistributed bullous disorder with clinical and histological features of po |
| **Key Features** | Identical to PCT clinically and histologically |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Pseudoporphyria?
   A. Identical to PCT clinically and histologically
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Features: Identical to PCT clinically and histologically*
2. **Q:** What is the first-line treatment for Pseudoporphyria?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Pseudoporphyria?
...
4. **Q:** What is the most important complication of Pseudoporphyria?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Pseudoporphyria?
   A. Most common drug cause (naproxen, ibuprofen, ketoprofen)
...
## SBA Questions (5)
1. **Scenario:** Patient with Pseudoporphyria; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Pseudoporphyria failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Pseudoporphyria?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Pseudoporphyria?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Pseudoporphyria?
   A. Most common drug cause (naproxen, ibuprofen, ketoprofen)
...
- **Q:** Key fact about Pseudoporphyria?
  **A:** Identical to PCT clinically and histologically
- **Q:** Another key point?
  **A:** Normal (key distinguishing from PCT)
- **Q:** Most important complication?
  **A:** Photosensitivity, skin fragility, vesicles/bullae on dorsum hands, milia, hypertrichosis, hyperpigmentation
- **Q:** First-line treatment?
  **A:** Drugs (NSAIDs especially naproxen, tetracyclines, furosemide), CKD, haemodialysis, UV, tanning
- **Q:** Key histological/serological feature?
  **A:** Subepidermal bullae with festooning, caterpillar bodies, thickening of dermal vessels

## Answer Key with Explanations

### MCQs
1. **A** — Features: Identical to PCT clinically and histologically
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — NSAIDs: Most common drug cause (naproxen, ibuprofen, ketoprofen)
...
5. **A** — Most common drug cause (naproxen, ibuprofen, ketoprofen)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Pseudoporphyria full*

**Q1.** What is the most appropriate first-line therapy for Pseudoporphyria full?
