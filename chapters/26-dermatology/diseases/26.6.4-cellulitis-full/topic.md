...
Cellulitis is a deeper (subcutaneous) bacterial skin infection with diffuse erythema, swelling, warmth, and tenderness. Most commonly Strep pyogenes or Staph aureus. Affects any site, often unilateral leg. Risk factors: lymphoedema, chronic venous insufficiency, leg ulcer, tinea pedis, obesity, diabetes, immunosuppression, IV drug use.

## Clinical Features and Presentation

Cellulitis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Strep pyogenes, Staph aureus (less common) |
| Layer | Subcutaneous (deeper than erysipelas) |
| Border | Ill-defined, not raised (vs erysipelas) |
| Sites | Lower legs (most common), any site |
| Risk factors | Lymphoedema, venous insufficiency, tinea pedis, leg ulcer, IVDU |
| Diagnosis | Clinical; blood culture if severe; aspirate if atypical; consider D-dimer if DVT suspected |
| Treatment | IV flucloxacillin (severe) or oral; rest, elevate; treat underlying tinea pedis |
| Complications | Sepsis, abscess, necrotising fasciitis (if severe pain, systemic toxicity) |
| Differential | Erysipelas (superficial, raised), DVT (no systemic, no portal), lipodermatosclerosis (chronic, no systemic) |
| MRSA | Consider if risk factors (IVDU, recent hospital, colonisation); treat with vancomycin, linezolid, doxycycline |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Erysipelas | Superficial, raised, sharply demarcated |

## Viva Questions

1. **Q:** Define Cellulitis and outline its classification.
   **A:** Cellulitis is a deeper (subcutaneous) bacterial skin infection with diffuse erythema, swelling, warmth, and tenderness. Most commonly Strep pyogenes or Staph aureus. Affects any site, often unilateral

2. **Q:** What are the key clinical features of Cellulitis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Cellulitis.
...
1. Cellulitis = deeper than erysipelas; ill-defined border
...
| **Topic** | **Cellulitis** |
|-----------|-----------|
| **Definition** | Cellulitis is a deeper (subcutaneous) bacterial skin infection with diffuse erythema, swelling, warm |
| **Key Features** | Strep pyogenes, Staph aureus (less common) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Cellulitis?
   A. Strep pyogenes, Staph aureus (less common)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Strep pyogenes, Staph aureus (less common)*
2. **Q:** What is the first-line treatment for Cellulitis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Cellulitis?
...
4. **Q:** What is the most important complication of Cellulitis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Cellulitis?
   A. Consider if risk factors (IVDU, recent hospital, colonisation); treat with vancomycin, linezolid, doxycycline
...
- **Q:** Key fact about Cellulitis?
  **A:** Strep pyogenes, Staph aureus (less common)
- **Q:** Another key point?
  **A:** Subcutaneous (deeper than erysipelas)
- **Q:** Most important complication?
  **A:** Ill-defined, not raised (vs erysipelas)
- **Q:** First-line treatment?
  **A:** Lower legs (most common), any site
- **Q:** Key histological/serological feature?
  **A:** Lymphoedema, venous insufficiency, tinea pedis, leg ulcer, IVDU

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Strep pyogenes, Staph aureus (less common)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — MRSA: Consider if risk factors (IVDU, recent hospital, colonisation); treat with vancomycin, linezolid, doxycycline
...
5. **A** — Consider if risk factors (IVDU, recent hospital, colonisation); treat with vancomycin, linezolid, doxycycline
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Cellulitis full*

**Q1.** What is the most appropriate first-line therapy for Cellulitis full?
