...
Paraneoplastic pemphigus is a rare severe autoimmune blistering disease associated with underlying neoplasm. Autoantibodies against plakin proteins and desmogleins. Severe mucosal involvement, polymorphous cutaneous eruption, and bronchiolitis obliterans. Mortality 75 to 90%.

## Clinical Features and Presentation

Paraneoplastic pemphigus presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Associated | B-cell lymphoma most common, Castleman, thymoma, CLL |
| Target | Plakins (envoplakin, periplakin, BP230) and Dsg |
| Mucosa | Severe, intractable (oral, ocular, genital) |
| Skin | Polymorphous: LP-like, bullous, EM-like, SJS-like |
| Lungs | Bronchiolitis obliterans (often fatal) |
| Mortality | 75 to 90% |
| Diagnosis | DIF intercellular and BMZ, IIF rat bladder plakin specific |
| Treatment | Treat underlying neoplasm; rituximab; IVIG; immunosuppression |
| DIF | Both intercellular AND basement membrane — characteristic |
| B-cells | Often CD20+ lymphoproliferative disorder |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| PV | No underlying neoplasm, no bronchiolitis |

## Viva Questions

1. **Q:** Define Paraneoplastic pemphigus and outline its classification.
   **A:** Paraneoplastic pemphigus is a rare severe autoimmune blistering disease associated with underlying neoplasm. Autoantibodies against plakin proteins and desmogleins. Severe mucosal involvement, polymor

2. **Q:** What are the key clinical features of Paraneoplastic pemphigus?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Paraneoplastic pemphigus.
...
1. **PNP clue** = Both intercellular and BMZ DIF pattern
...
| **Topic** | **Paraneoplastic pemphigus** |
|-----------|-----------|
| **Definition** | Paraneoplastic pemphigus is a rare severe autoimmune blistering disease associated with underlying n |
| **Key Features** | B-cell lymphoma most common, Castleman, thymoma, CLL |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Paraneoplastic pemphigus?
   A. B-cell lymphoma most common, Castleman, thymoma, CLL
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Associated: B-cell lymphoma most common, Castleman, thymoma, CLL*
2. **Q:** What is the first-line treatment for Paraneoplastic pemphigus?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Paraneoplastic pemphigus?
...
4. **Q:** What is the most important complication of Paraneoplastic pemphigus?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Paraneoplastic pemphigus?
   A. Often CD20+ lymphoproliferative disorder
...
## SBA Questions (5)
1. **Scenario:** Patient with Paraneoplastic pemphigus; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Paraneoplastic pemphigus failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Paraneoplastic pemphigus?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Paraneoplastic pemphigus?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Paraneoplastic pemphigus?
   A. Often CD20+ lymphoproliferative disorder
...
- **Q:** Key fact about Paraneoplastic pemphigus?
  **A:** B-cell lymphoma most common, Castleman, thymoma, CLL
- **Q:** Another key point?
  **A:** Plakins (envoplakin, periplakin, BP230) and Dsg
- **Q:** Most important complication?
  **A:** Severe, intractable (oral, ocular, genital)
- **Q:** First-line treatment?
  **A:** Polymorphous: LP-like, bullous, EM-like, SJS-like
- **Q:** Key histological/serological feature?
  **A:** Bronchiolitis obliterans (often fatal)

## Answer Key with Explanations

### MCQs
1. **A** — Associated: B-cell lymphoma most common, Castleman, thymoma, CLL
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — B-cells: Often CD20+ lymphoproliferative disorder
...
5. **A** — Often CD20+ lymphoproliferative disorder
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Paraneoplastic pemphigus full*

**Q1.** What is the most appropriate first-line therapy for Paraneoplastic pemphigus full?
