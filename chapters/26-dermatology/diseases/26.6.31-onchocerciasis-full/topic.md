...
Onchocerciasis ('river blindness') is a filarial infection by Onchocerca volvulus transmitted by blackfly (Simulium) bite, endemic in sub-Saharan Africa, Yemen, Latin America. Adult worms in skin produce microfilariae causing severe pruritus, skin atrophy, 'leopard skin', 'hanging groin', and ocular involvement leading to blindness (irreversible keratitis, iridocyclitis). Treatment: ivermectin (kills microfilariae, not adults); doxycycline (targets Wolbachia endosymbiont).

## Clinical Features and Presentation

Onchocerciasis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Onchocerca volvulus (filarial nematode) |
| Vector | Blackfly (Simulium) — breeds in fast-flowing rivers |
| Endemic | Sub-Saharan Africa, Yemen, Latin America (especially West Africa) |
| Skin | Severe pruritus, lichenified onchodermatitis, 'leopard skin' (depigmented), 'hanging groin' (lymphadenopathy) |
| Eye | Microfilariae in cornea/anterior chamber → keratitis, iridocyclitis, optic atrophy → blindness |
| Diagnosis | Skin snips (microfilariae); serology; PCR; slit lamp for eye |
| Treatment | Ivermectin 150µg/kg every 6-12 months (kills microfilariae); doxycycline 200mg OD 6w (targets Wolbachia) |
| Prevention | Insecticide, vector control, mass drug administration (ivermectin) |
| Mazzotti reaction | Severe reaction to ivermectin (fever, pruritus, rash, hypotension) in heavily infected |
| Diethylcarbamazine | Avoid (severe Mazzotti reaction); use ivermectin |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Scabies | No microfilariae |

## Viva Questions

1. **Q:** Define Onchocerciasis and outline its classification.
   **A:** Onchocerciasis ('river blindness') is a filarial infection by Onchocerca volvulus transmitted by blackfly (Simulium) bite, endemic in sub-Saharan Africa, Yemen, Latin America. Adult worms in skin prod

2. **Q:** What are the key clinical features of Onchocerciasis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Onchocerciasis.
...
1. Onchocerciasis = river blindness; blackfly; microfilariae
...
| **Topic** | **Onchocerciasis** |
|-----------|-----------|
| **Definition** | Onchocerciasis ('river blindness') is a filarial infection by Onchocerca volvulus transmitted by bla |
| **Key Features** | Onchocerca volvulus (filarial nematode) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Onchocerciasis?
   A. Onchocerca volvulus (filarial nematode)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Onchocerca volvulus (filarial nematode)*
2. **Q:** What is the first-line treatment for Onchocerciasis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Onchocerciasis?
...
4. **Q:** What is the most important complication of Onchocerciasis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Onchocerciasis?
   A. Avoid (severe Mazzotti reaction); use ivermectin
...
## SBA Questions (5)
1. **Scenario:** Patient with Onchocerciasis; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Onchocerciasis failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Onchocerciasis?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Onchocerciasis?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Onchocerciasis?
   A. Avoid (severe Mazzotti reaction); use ivermectin
...
- **Q:** Key fact about Onchocerciasis?
  **A:** Onchocerca volvulus (filarial nematode)
- **Q:** Another key point?
  **A:** Blackfly (Simulium) — breeds in fast-flowing rivers
- **Q:** Most important complication?
  **A:** Sub-Saharan Africa, Yemen, Latin America (especially West Africa)
- **Q:** First-line treatment?
  **A:** Severe pruritus, lichenified onchodermatitis, 'leopard skin' (depigmented), 'hanging groin' (lymphadenopathy)
- **Q:** Key histological/serological feature?
  **A:** Microfilariae in cornea/anterior chamber → keratitis, iridocyclitis, optic atrophy → blindness

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Onchocerca volvulus (filarial nematode)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Diethylcarbamazine: Avoid (severe Mazzotti reaction); use ivermectin
...
5. **A** — Avoid (severe Mazzotti reaction); use ivermectin
