...
Junctional epidermolysis bullosa (JEB) is a severe form of EB with blistering at the lamina lucida (within BMZ). Caused by mutations in LAMA3, LAMB3, LAMC2 (laminin-332/laminin-5) or COL17A1 (BP180). Severe (Herlitz) form often fatal in infancy; intermediate form is non-lethal.
...
| Genes | LAMA3, LAMB3, LAMC2 (laminin-332); COL17A1 (BP180) |
| Split | Lamina lucida |
| Severe (Herlitz) | Often fatal in infancy; widespread blistering, granulation tissue, nail dystrophy, enamel hypoplasia |
| Intermediate | Non-lethal; localised or generalised blistering, improves with age |
| EM | Split in lamina lucida; reduced hemidesmosomes |
| Associated | Enamel hypoplasia (tooth abnormalities), pyloric atresia (in JEB-PA with α6β4 integrin mutation) |
| Management | Wound care, infection prevention, nutritional support, genetic counselling |
| Laryngo-onycho-cutaneous syndrome | JEB variant with laryngeal and ocular granulation |
| Mortality | Severe (Herlitz) form 40-50% in first year |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| EB simplex | Intra-basal split, keratin mutations, milder |

## Viva Questions

1. **Q:** Define Junctional epidermolysis bullosa and outline its classification.
   **A:** Junctional epidermolysis bullosa (JEB) is a severe form of EB with blistering at the lamina lucida (within BMZ). Caused by mutations in LAMA3, LAMB3, LAMC2 (laminin-332/laminin-5) or COL17A1 (BP180). 

2. **Q:** What are the key clinical features of Junctional epidermolysis bullosa?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Junctional epidermolysis bullosa.
...
1. **JEB Herlitz** = Laminin-332 null, often fatal in infancy
...
|-----------|---------------|
| **Paediatric** | Most severe EB form; presents at birth |

## One-Page Revision Card

| **Topic** | **Junctional epidermolysis bullosa** |
|-----------|-----------|
| **Definition** | Junctional epidermolysis bullosa (JEB) is a severe form of EB with blistering at the lamina lucida ( |
| **Key Features** | Autosomal recessive |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Junctional epidermolysis bullosa?
   ...
   **Answer: A**  *Inheritance: Autosomal recessive*
2. **Q:** What is the first-line treatment for Junctional epidermolysis bullosa?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Junctional epidermolysis bullosa?
...
4. **Q:** What is the most important complication of Junctional epidermolysis bullosa?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Junctional epidermolysis bullosa?
   A. Severe (Herlitz) form 40-50% in first year
...
## SBA Questions (5)
1. **Scenario:** Patient with Junctional epidermolysis bullosa; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Junctional epidermolysis bullosa failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Junctional epidermolysis bullosa?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Junctional epidermolysis bullosa?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Junctional epidermolysis bullosa?
   A. Severe (Herlitz) form 40-50% in first year
...
- **Q:** Key fact about Junctional epidermolysis bullosa?
  **A:** Autosomal recessive
- **Q:** Another key point?
  **A:** LAMA3, LAMB3, LAMC2 (laminin-332); COL17A1 (BP180)
- **Q:** Most important complication?
  **A:** Lamina lucida
- **Q:** First-line treatment?
  **A:** Often fatal in infancy; widespread blistering, granulation tissue, nail dystrophy, enamel hypoplasia
- **Q:** Key histological/serological feature?
  **A:** Non-lethal; localised or generalised blistering, improves with age

## Answer Key with Explanations

### MCQs
1. **A** — Inheritance: Autosomal recessive
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Mortality: Severe (Herlitz) form 40-50% in first year
...
5. **A** — Severe (Herlitz) form 40-50% in first year
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Junctional epidermolysis bullosa full*

**Q1.** What is the most appropriate first-line therapy for Junctional epidermolysis bullosa full?
