...
Dystrophic epidermolysis bullosa (DEB) is an EB form with sub-lamina densa blistering due to type VII collagen (COL7A1) mutations. Two forms: dominant (DDEB, generally milder) and recessive (RDEB, severe generalised Hallopeau-Siemens). Causes scarring, milia, contractures, pseudosyndactyly (mitten deformities). Increased SCC risk in chronic wounds.
...
| Category | Key Points |
|----------|------------|
| Inheritance | Dominant (DDEB) or recessive (RDEB) |
| Gene | COL7A1 (type VII collagen) |
| Split | Sub-lamina densa (beneath lamina densa) |
| Milia | Yes (key feature — small keratin cysts) |
| Scarring | Yes (atrophic scarring) |
| RDEB severe | Hallopeau-Siemens: generalised blistering, mitten deformities, scoliosis, anaemia, growth retardation |
| SCC risk | High in chronic RDEB wounds (up to 50% by age 30) |
| Nail dystrophy | Common; anonychia in severe forms |
| EM | Split below lamina densa; absent or abnormal anchoring fibrils |
| Management | Wound care, infection prevention, hand surgery for contractures, SCC surveillance, genetic counselling |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| EB simplex | Intra-basal, no scarring |

## Viva Questions

1. **Q:** Define Dystrophic epidermolysis bullosa and outline its classification.
   **A:** Dystrophic epidermolysis bullosa (DEB) is an EB form with sub-lamina densa blistering due to type VII collagen (COL7A1) mutations. Two forms: dominant (DDEB, generally milder) and recessive (RDEB, sev

2. **Q:** What are the key clinical features of Dystrophic epidermolysis bullosa?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Dystrophic epidermolysis bullosa.
...
1. **DEB types** = DDEB acral mild vs RDEB severe Hallopeau-Siemens
...
| **Topic** | **Dystrophic epidermolysis bullosa** |
|-----------|-----------|
| **Definition** | Dystrophic epidermolysis bullosa (DEB) is an EB form with sub-lamina densa blistering due to type VI |
| **Key Features** | Dominant (DDEB) or recessive (RDEB) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Dystrophic epidermolysis bullosa?
   A. Dominant (DDEB) or recessive (RDEB)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Inheritance: Dominant (DDEB) or recessive (RDEB)*
2. **Q:** What is the first-line treatment for Dystrophic epidermolysis bullosa?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Dystrophic epidermolysis bullosa?
...
4. **Q:** What is the most important complication of Dystrophic epidermolysis bullosa?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Dystrophic epidermolysis bullosa?
   A. Wound care, infection prevention, hand surgery for contractures, SCC surveillance, genetic counselling
...
## SBA Questions (5)
1. **Scenario:** Patient with Dystrophic epidermolysis bullosa; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Dystrophic epidermolysis bullosa failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Dystrophic epidermolysis bullosa?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Dystrophic epidermolysis bullosa?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Dystrophic epidermolysis bullosa?
   A. Wound care, infection prevention, hand surgery for contractures, SCC surveillance, genetic counselling
...
- **Q:** Key fact about Dystrophic epidermolysis bullosa?
  **A:** Dominant (DDEB) or recessive (RDEB)
- **Q:** Another key point?
  **A:** COL7A1 (type VII collagen)
- **Q:** Most important complication?
  **A:** Sub-lamina densa (beneath lamina densa)
- **Q:** First-line treatment?
  **A:** Yes (key feature — small keratin cysts)
- **Q:** Key histological/serological feature?
  **A:** Yes (atrophic scarring)

## Answer Key with Explanations

### MCQs
1. **A** — Inheritance: Dominant (DDEB) or recessive (RDEB)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Management: Wound care, infection prevention, hand surgery for contractures, SCC surveillance, genetic counselling
...
5. **A** — Wound care, infection prevention, hand surgery for contractures, SCC surveillance, genetic counselling
