...
Myiasis is infestation of living tissue by fly larvae (maggots). Cutaneous myiasis includes: furuncular (Dermatobia hominis, Cordylobia anthropophaga, tumbu fly), wound myiasis (Lucilia sericata, greenbottle), and creeping myiasis (Gasterophilus). Most common in tropical regions. Furuncular myiasis presents as a boil-like lesion with central punctum, often with sensation of movement. Treatment: occlusion (petroleum jelly, pork fat) then extraction; wound myiasis: larval removal + wound debridement.

## Clinical Features and Presentation

Myiasis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Fly larvae (maggots) |
| Furuncular | Dermatobia hominis (Americas); Cordylobia anthropophaga (Africa, 'tumbu fly') |
| Wound | Lucilia sericata (greenbottle, sheep blowfly); in chronic wounds |
| Creeping | Gasterophilus (horse bot fly); migrating larvae |
| Travel | Central/South America, Africa, tropical |
| Lesion | Furuncular: boil-like, central punctum, movement, serous/serosanguinous discharge |
| Diagnosis | Clinical; visualisation of larva; ultrasound |
| Treatment | Furuncular: occlusion (petroleum jelly, pork fat) 24-48h then extraction; wound: debridement, larvae removal |
| Ivermectin | Oral ivermectin can kill larvae; used adjunctively |
| Prevention | Insect repellent, protective clothing, sleeping under nets, ironing clothes (kills eggs) |
| Complications | Secondary infection, tetanus, sepsis (rare) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Furuncle | Bacterial, no movement, no central punctum with visible larva |

## Viva Questions

1. **Q:** Define Myiasis and outline its classification.
   **A:** Myiasis is infestation of living tissue by fly larvae (maggots). Cutaneous myiasis includes: furuncular (Dermatobia hominis, Cordylobia anthropophaga, tumbu fly), wound myiasis (Lucilia sericata, gree

2. **Q:** What are the key clinical features of Myiasis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Myiasis.
...
1. Myiasis = fly larvae; occlusion then extraction
...
| **Topic** | **Myiasis** |
|-----------|-----------|
| **Definition** | Myiasis is infestation of living tissue by fly larvae (maggots). Cutaneous myiasis includes: furuncu |
| **Key Features** | Fly larvae (maggots) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Myiasis?
   A. Fly larvae (maggots)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Fly larvae (maggots)*
2. **Q:** What is the first-line treatment for Myiasis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Myiasis?
...
4. **Q:** What is the most important complication of Myiasis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Myiasis?
   A. Secondary infection, tetanus, sepsis (rare)
...
- **Q:** Key fact about Myiasis?
  **A:** Fly larvae (maggots)
- **Q:** Another key point?
  **A:** Dermatobia hominis (Americas); Cordylobia anthropophaga (Africa, 'tumbu fly')
- **Q:** Most important complication?
  **A:** Lucilia sericata (greenbottle, sheep blowfly); in chronic wounds
- **Q:** First-line treatment?
  **A:** Gasterophilus (horse bot fly); migrating larvae
- **Q:** Key histological/serological feature?
  **A:** Central/South America, Africa, tropical

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Fly larvae (maggots)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Complications: Secondary infection, tetanus, sepsis (rare)
...
5. **A** — Secondary infection, tetanus, sepsis (rare)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Myiasis full*

**Q1.** What is the most appropriate first-line therapy for Myiasis full?
