...
topic: Drug-induced linear IgA disease
...
Drug-induced linear IgA disease is LAD triggered by drugs, most commonly vancomycin (often within 1-2 weeks of starting). Other drugs: penicillins, cephalosporins, NSAIDs, captopril, phenytoin. Resolves within weeks of drug withdrawal. May be severe with widespread bullae mimicking TEN.

## Clinical Features and Presentation

Drug-induced linear IgA disease presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Most common drug | Vancomycin (within 1-2 weeks of starting) |
| Other drugs | Penicillins, cephalosporins, NSAIDs, captopril, phenytoin |
| Latency | Days to weeks (often 1-2 weeks for vancomycin) |
| Resolution | Weeks after drug withdrawal |
| Severity | Can be severe, widespread, mimic TEN |
| DIF | Linear IgA at BMZ |
| Treatment | STOP drug; supportive care; dapsone may help |
| Differential | Classic LAD (idiopathic), TEN |
| Mechanism | Drug hapten or immune complex deposition |
| Prognosis | Good with drug withdrawal; usually resolves completely |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Classic LAD | Idiopathic, no drug trigger |

## Viva Questions

1. **Q:** Define Drug-induced linear IgA disease and outline its classification.
   **A:** Drug-induced linear IgA disease is LAD triggered by drugs, most commonly vancomycin (often within 1-2 weeks of starting). Other drugs: penicillins, cephalosporins, NSAIDs, captopril, phenytoin. Resolv

2. **Q:** What are the key clinical features of Drug-induced linear IgA disease?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Drug-induced linear IgA disease.
...
1. **Drug LAD** = Vancomycin = most common cause
...
| **Topic** | **Drug-induced linear IgA disease** |
|-----------|-----------|
| **Definition** | Drug-induced linear IgA disease is LAD triggered by drugs, most commonly vancomycin (often within 1- |
| **Key Features** | Vancomycin (within 1-2 weeks of starting) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Drug-induced linear IgA disease?
   A. Vancomycin (within 1-2 weeks of starting)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Most common drug: Vancomycin (within 1-2 weeks of starting)*
2. **Q:** What is the first-line treatment for Drug-induced linear IgA disease?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Drug-induced linear IgA disease?
...
4. **Q:** What is the most important complication of Drug-induced linear IgA disease?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Drug-induced linear IgA disease?
   A. Good with drug withdrawal; usually resolves completely
...
## SBA Questions (5)
1. **Scenario:** Patient with Drug-induced linear IgA disease; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Drug-induced linear IgA disease failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Drug-induced linear IgA disease?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Drug-induced linear IgA disease?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Drug-induced linear IgA disease?
   A. Good with drug withdrawal; usually resolves completely
...
- **Q:** Key fact about Drug-induced linear IgA disease?
  **A:** Vancomycin (within 1-2 weeks of starting)
- **Q:** Another key point?
  **A:** Penicillins, cephalosporins, NSAIDs, captopril, phenytoin
- **Q:** Most important complication?
  **A:** Days to weeks (often 1-2 weeks for vancomycin)
- **Q:** First-line treatment?
  **A:** Weeks after drug withdrawal
- **Q:** Key histological/serological feature?
  **A:** Can be severe, widespread, mimic TEN

## Answer Key with Explanations

### MCQs
1. **A** — Most common drug: Vancomycin (within 1-2 weeks of starting)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Prognosis: Good with drug withdrawal; usually resolves completely
...
5. **A** — Good with drug withdrawal; usually resolves completely
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Drug-induced linear IgA disease full*

**Q1.** What is the most appropriate first-line therapy for Drug-induced linear IgA disease full?
