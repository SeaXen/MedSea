...
Dermatofibrosarcoma protuberans (DFSP) is a low-grade, locally aggressive cutaneous sarcoma of fibroblastic origin with characteristic storiform spindle cell pattern and CD34 positivity. Often presents as slowly growing, indurated plaque or nodule (skin-coloured to red-brown), most commonly on trunk. High local recurrence if incompletely excised (perineural/perivascular infiltration extends beyond clinical margins). Rarely metastasises. Treatment: Mohs micrographic surgery (MMS) is preferred for tissue-sparing complete removal.

## Clinical Features and Presentation

Dermatofibrosarcoma protuberans (DFSP) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | t(17;22) translocation; PDGFB-COL1A1 fusion |
| Stain | CD34 positive; Factor XIIIa negative (vs dermatofibroma) |
| Distribution | Trunk (most common), proximal limbs |
| Appearance | Slowly growing, indurated plaque/nodule, skin-coloured to red-brown |
| Dimple sign | Negative (vs dermatofibroma positive) |
| Recurrence | High if incomplete excision (perineural/perivascular spread) |
| Metastasis | Rare (less than 1%) |
| Treatment | Mohs (preferred for tissue-sparing); WLE with 2-3cm margins; imatinib (PDGFR inhibitor) for advanced |
| Histology | Storiform spindle cell pattern, infiltrative margins, CD34+ |
| Biopsy | Punch or incisional; full depth |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Dermatofibroma | Smaller, dimple sign+, Factor XIIIa+, CD34- |

## Viva Questions

1. **Q:** Define Dermatofibrosarcoma protuberans (DFSP) and outline its classification.
   **A:** Dermatofibrosarcoma protuberans (DFSP) is a low-grade, locally aggressive cutaneous sarcoma of fibroblastic origin with characteristic storiform spindle cell pattern and CD34 positivity. Often present

2. **Q:** What are the key clinical features of Dermatofibrosarcoma protuberans (DFSP)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Dermatofibrosarcoma protuberans (DFSP).
...
1. **DFSP** = CD34+, storiform, infiltrative, Mohs preferred
...
| **Topic** | **Dermatofibrosarcoma protuberans (DFSP)** |
|-----------|-----------|
| **Definition** | Dermatofibrosarcoma protuberans (DFSP) is a low-grade, locally aggressive cutaneous sarcoma of fibro |
| **Key Features** | t(17;22) translocation; PDGFB-COL1A1 fusion |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Dermatofibrosarcoma protuberans (DFSP)?
   A. t(17;22) translocation; PDGFB-COL1A1 fusion
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: t(17;22) translocation; PDGFB-COL1A1 fusion*
2. **Q:** What is the first-line treatment for Dermatofibrosarcoma protuberans (DFSP)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Dermatofibrosarcoma protuberans (DFSP)?
...
4. **Q:** What is the most important complication of Dermatofibrosarcoma protuberans (DFSP)?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Dermatofibrosarcoma protuberans (DFSP)?
   A. Punch or incisional; full depth
...
## SBA Questions (5)
1. **Scenario:** Patient with Dermatofibrosarcoma protuberans (DFSP); first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Dermatofibrosarcoma protuberans (DFSP) failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Dermatofibrosarcoma protuberans (DFSP)?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Dermatofibrosarcoma protuberans (DFSP)?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Dermatofibrosarcoma protuberans (DFSP)?
   A. Punch or incisional; full depth
...
- **Q:** Key fact about Dermatofibrosarcoma protuberans (DFSP)?
  **A:** t(17;22) translocation; PDGFB-COL1A1 fusion
- **Q:** Another key point?
  **A:** CD34 positive; Factor XIIIa negative (vs dermatofibroma)
- **Q:** Most important complication?
  **A:** Trunk (most common), proximal limbs
- **Q:** First-line treatment?
  **A:** Slowly growing, indurated plaque/nodule, skin-coloured to red-brown
- **Q:** Key histological/serological feature?
  **A:** Negative (vs dermatofibroma positive)

## Answer Key with Explanations

### MCQs
1. **A** — Cause: t(17;22) translocation; PDGFB-COL1A1 fusion
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Biopsy: Punch or incisional; full depth
...
5. **A** — Punch or incisional; full depth
