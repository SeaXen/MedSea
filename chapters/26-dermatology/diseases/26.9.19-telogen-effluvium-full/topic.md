...
Telogen effluvium (TE) is a diffuse, non-scarring hair shedding that occurs 2-3 months after a triggering event (stress, childbirth, surgery, illness, drugs, nutritional deficiency). Increased proportion of anagen (growing) hairs transition prematurely to telogen (resting), then shed. Self-limiting, recovery in 6-12 months. Treatment: identify and address trigger; reassurance; topical minoxidil may help.

## Clinical Features and Presentation

Telogen effluvium presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Type | Diffuse, non-scarring |
| Mechanism | Premature transition anagen → telogen |
| Latency | 2-3 months post-trigger |
| Triggers | Stress, childbirth, surgery, illness, drugs, nutritional (Fe, Zn, ferritin, vitamin D), thyroid, crash diet |
| Recovery | 6-12 months |
| Hair pull | Positive (more than 6 hairs/gentle pull) |
| Histology | Increased telogen hairs (more than 20%) |
| Differential | AGA (miniaturisation), AA (patchy), drug-induced, nutritional |
| Treatment | Address trigger; reassurance; minoxidil; nutritional supplementation |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| AGA | Patterned, miniaturisation |

## Viva Questions

1. **Q:** Define Telogen effluvium and outline its classification.
   **A:** Telogen effluvium (TE) is a diffuse, non-scarring hair shedding that occurs 2-3 months after a triggering event (stress, childbirth, surgery, illness, drugs, nutritional deficiency). Increased proport

2. **Q:** What are the key clinical features of Telogen effluvium?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Telogen effluvium.
...
1. TE = 2-3 months post-trigger; diffuse; self-limiting
...
| **Topic** | **Telogen effluvium** |
|-----------|-----------|
| **Definition** | Telogen effluvium (TE) is a diffuse, non-scarring hair shedding that occurs 2-3 months after a trigg |
| **Key Features** | Diffuse, non-scarring |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Telogen effluvium?
   A. Diffuse, non-scarring
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Type: Diffuse, non-scarring*
2. **Q:** What is the first-line treatment for Telogen effluvium?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Telogen effluvium?
...
4. **Q:** What is the most important complication of Telogen effluvium?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Telogen effluvium?
   A. Address trigger; reassurance; minoxidil; nutritional supplementation
...
## SBA Questions (5)
1. **Scenario:** Patient with Telogen effluvium; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Telogen effluvium failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Telogen effluvium?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Telogen effluvium?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Telogen effluvium?
   A. Address trigger; reassurance; minoxidil; nutritional supplementation
...
- **Q:** Key fact about Telogen effluvium?
  **A:** Diffuse, non-scarring
- **Q:** Another key point?
  **A:** Premature transition anagen → telogen
- **Q:** Most important complication?
  **A:** 2-3 months post-trigger
- **Q:** First-line treatment?
  **A:** Stress, childbirth, surgery, illness, drugs, nutritional (Fe, Zn, ferritin, vitamin D), thyroid, crash diet
...
### MCQs
1. **A** — Type: Diffuse, non-scarring
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Address trigger; reassurance; minoxidil; nutritional supplementation
...
5. **A** — Address trigger; reassurance; minoxidil; nutritional supplementation
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Telogen effluvium full*

**Q1.** What is the most appropriate first-line therapy for Telogen effluvium full?
