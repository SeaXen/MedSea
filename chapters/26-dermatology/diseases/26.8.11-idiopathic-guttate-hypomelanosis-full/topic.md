...
topic: Idiopathic guttate hypomelanosis
...
Idiopathic guttate hypomelanosis (IGH, leukopathia symmetrica progressiva) is a common, benign acquired hypopigmentation in middle-aged and elderly, especially women. Multiple small (2-5mm), well-defined, depigmented macules, predominantly on sun-exposed extensor surfaces (shins, forearms). Chronic, stable. Treatment: reassurance, sun protection, topical retinoids (modest), cryotherapy, excimer laser (mild).

## Clinical Features and Presentation

Idiopathic guttate hypomelanosis presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Unknown (UV, age) |
| Age | Middle-aged, elderly |
| Distribution | Sun-exposed extensor: shins, forearms |
| Size | 2-5mm, multiple, well-defined |
| Histology | Decreased melanin, normal melanocyte count |
| Differential | Vitiligo, tinea versicolor, guttate hypopigmentation, post-inflammatory |
| Treatment | Reassurance, sun protection; topical retinoids, cryotherapy, excimer laser (limited) |
| Progression | Slow, accumulates with age |
| No associations | Not associated with systemic disease |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Vitiligo | Larger patches, complete depigmentation |

## Viva Questions

1. **Q:** Define Idiopathic guttate hypomelanosis and outline its classification.
   **A:** Idiopathic guttate hypomelanosis (IGH, leukopathia symmetrica progressiva) is a common, benign acquired hypopigmentation in middle-aged and elderly, especially women. Multiple small (2-5mm), well-defi

2. **Q:** What are the key clinical features of Idiopathic guttate hypomelanosis?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Idiopathic guttate hypomelanosis.
...
1. **IGH** = Sun-exposed shins; small white spots; elderly
...
| **Topic** | **Idiopathic guttate hypomelanosis** |
|-----------|-----------|
| **Definition** | Idiopathic guttate hypomelanosis (IGH, leukopathia symmetrica progressiva) is a common, benign acqui |
| **Key Features** | Unknown (UV, age) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Idiopathic guttate hypomelanosis?
   A. Unknown (UV, age)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Unknown (UV, age)*
2. **Q:** What is the first-line treatment for Idiopathic guttate hypomelanosis?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Idiopathic guttate hypomelanosis?
...
4. **Q:** What is the most important complication of Idiopathic guttate hypomelanosis?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Idiopathic guttate hypomelanosis?
   A. Not associated with systemic disease
...
## SBA Questions (5)
1. **Scenario:** Patient with Idiopathic guttate hypomelanosis; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Idiopathic guttate hypomelanosis failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Idiopathic guttate hypomelanosis?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Idiopathic guttate hypomelanosis?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Idiopathic guttate hypomelanosis?
   A. Not associated with systemic disease
...
- **Q:** Key fact about Idiopathic guttate hypomelanosis?
  **A:** Unknown (UV, age)
- **Q:** Another key point?
  **A:** Middle-aged, elderly
- **Q:** Most important complication?
  **A:** Sun-exposed extensor: shins, forearms
- **Q:** First-line treatment?
  **A:** 2-5mm, multiple, well-defined
- **Q:** Key histological/serological feature?
  **A:** Decreased melanin, normal melanocyte count

## Answer Key with Explanations

### MCQs
1. **A** — Cause: Unknown (UV, age)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — No associations: Not associated with systemic disease
...
5. **A** — Not associated with systemic disease
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Idiopathic guttate hypomelanosis full*

**Q1.** What is the most appropriate first-line therapy for Idiopathic guttate hypomelanosis full?
