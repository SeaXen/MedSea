...
Infantile haemangioma (strawberry naevus) is the most common tumour of infancy (5-10% of infants), with characteristic evolution: absent or precursor lesion at birth → rapid proliferation (0-12 months, especially 6-9w) → plateau → slow involution (years, complete by 5-10y in most). Superficial (red, strawberry), deep (blue/purple, subcutaneous), or mixed. Complications: ulceration (most common), bleeding, visual/airway obstruction, PHACE syndrome, high-output cardiac failure (large hepatic).

## Clinical Features and Presentation

Infantile haemangioma presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Prevalence | 5-10% of infants; F>M (3:1); premature |
| Course | Proliferate 0-12 months, involute years |
| Types | Superficial (red), deep (blue), mixed |
| Complications | Ulceration (most common), bleeding, visual obstruction, airway, PHACE, LUMBAR |
| PHACE | Posterior fossa malformation, Haemangioma, Arterial anomalies, Cardiac defects, Eye abnormalities |
| LUMBAR | Lower body haemangioma + Urogenital anomalies, Myelopathy, Bony deformities, Anorectal malformations, Renal anomalies |
| High-risk | Face (periorbital, perioral, nasal, lip), airway, anogenital, segmental, large |
| Propranolol | First-line; oral 2-3mg/kg/day; standard of care |
| Topical timolol | Small superficial haemangiomas |
| Treatment indications | Functional impairment, ulceration, PHACE, cosmetic risk |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Vascular malformation | Present at birth, grow proportionally |

## Viva Questions

1. **Q:** Define Infantile haemangioma and outline its classification.
   **A:** Infantile haemangioma (strawberry naevus) is the most common tumour of infancy (5-10% of infants), with characteristic evolution: absent or precursor lesion at birth → rapid proliferation (0-12 months

2. **Q:** What are the key clinical features of Infantile haemangioma?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Infantile haemangioma.
...
|-----------|---------------|
| **Paediatric** | Common; propranolol first-line |
## One-Page Revision Card

| **Topic** | **Infantile haemangioma** |
|-----------|-----------|
| **Definition** | Infantile haemangioma (strawberry naevus) is the most common tumour of infancy (5-10% of infants), w |
| **Key Features** | 5-10% of infants; F>M (3:1); premature |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Infantile haemangioma?
   A. 5-10% of infants; F>M (3:1); premature
...
5. **Q:** Key histological/serological feature?
   A. Functional impairment, ulceration, PHACE, cosmetic risk
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Infantile haemangioma?
  **A:** 5-10% of infants; F>M (3:1); premature
- **Q:** Another key point?
  **A:** Proliferate 0-12 months, involute years
- **Q:** Most important complication?
  **A:** Superficial (red), deep (blue), mixed
- **Q:** First-line treatment?
  **A:** Ulceration (most common), bleeding, visual obstruction, airway, PHACE, LUMBAR
- **Q:** Key histological/serological feature?
  **A:** Posterior fossa malformation, Haemangioma, Arterial anomalies, Cardiac defects, Eye abnormalities

## Answer Key with Explanations

### MCQs
1. **A** — Prevalence: 5-10% of infants; F>M (3:1); premature
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment indications: Functional impairment, ulceration, PHACE, cosmetic risk
...
5. **A** — Functional impairment, ulceration, PHACE, cosmetic risk
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Infantile haemangioma full*

**Q1.** What is the most appropriate first-line therapy for Infantile haemangioma full?
