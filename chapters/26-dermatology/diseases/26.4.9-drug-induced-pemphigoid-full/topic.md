...
Drug-induced bullous pemphigoid is BP triggered by systemic drugs. Most common: diuretics (loop and thiazide), penicillins, NSAIDs, DPP-4 inhibitors (gliptins), checkpoint inhibitors, penicillamine, gold. Latency weeks to months. Resolves with drug withdrawal; may need topical steroids.

## Clinical Features and Presentation

Drug-induced pemphigoid presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Common drugs | Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare) |
| Latency | Weeks to months |
| Mechanism | Drug induces autoantibodies against BP180/BP230 |
| Resolution | Usually with drug withdrawal (weeks-months) |
| Treatment | STOP drug; topical clobetasol; oral steroids if severe |
| DIF | Linear IgG/C3 at BMZ (same as classic BP) |
| DPP-4 inhibitors | Strongest association (linagliptin, sitagliptin) — 2-4x risk |
| Age | Often younger than classic BP (drug effect bypasses age predisposition) |
| Vaccines | Rare reports (COVID-19, influenza) |
| Mechanism | Drug hapten or molecular mimicry triggers autoimmunity |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Classic BP | Idiopathic, elderly, no drug trigger |

## Viva Questions

1. **Q:** Define Drug-induced pemphigoid and outline its classification.
   **A:** Drug-induced bullous pemphigoid is BP triggered by systemic drugs. Most common: diuretics (loop and thiazide), penicillins, NSAIDs, DPP-4 inhibitors (gliptins), checkpoint inhibitors, penicillamine, g

2. **Q:** What are the key clinical features of Drug-induced pemphigoid?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Drug-induced pemphigoid.
...
1. **BP triggers** = Diuretics, penicillins, DPP-4 inhibitors, vaccines
...
| **Topic** | **Drug-induced pemphigoid** |
|-----------|-----------|
| **Definition** | Drug-induced bullous pemphigoid is BP triggered by systemic drugs. Most common: diuretics (loop and  |
| **Key Features** | Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Drug-induced pemphigoid?
   A. Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Common drugs: Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare)*
2. **Q:** What is the first-line treatment for Drug-induced pemphigoid?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Drug-induced pemphigoid?
...
4. **Q:** What is the most important complication of Drug-induced pemphigoid?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Drug-induced pemphigoid?
   A. Drug hapten or molecular mimicry triggers autoimmunity
...
## SBA Questions (5)
1. **Scenario:** Patient with Drug-induced pemphigoid; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Drug-induced pemphigoid failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Drug-induced pemphigoid?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Drug-induced pemphigoid?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Drug-induced pemphigoid?
   A. Drug hapten or molecular mimicry triggers autoimmunity
...
- **Q:** Key fact about Drug-induced pemphigoid?
  **A:** Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare)
- **Q:** Another key point?
  **A:** Weeks to months
- **Q:** Most important complication?
  **A:** Drug induces autoantibodies against BP180/BP230
- **Q:** First-line treatment?
  **A:** Usually with drug withdrawal (weeks-months)
- **Q:** Key histological/serological feature?
  **A:** STOP drug; topical clobetasol; oral steroids if severe

## Answer Key with Explanations

### MCQs
1. **A** — Common drugs: Diuretics (loop, thiazide), penicillins, DPP-4 inhibitors, NSAIDs, vaccines (rare)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Mechanism: Drug hapten or molecular mimicry triggers autoimmunity
...
5. **A** — Drug hapten or molecular mimicry triggers autoimmunity
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Drug-induced pemphigoid full*

**Q1.** What is the most appropriate first-line therapy for Drug-induced pemphigoid full?
