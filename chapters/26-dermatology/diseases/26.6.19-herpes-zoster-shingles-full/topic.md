...
Herpes zoster (shingles) is reactivation of latent varicella-zoster virus (VZV) in sensory ganglia, causing a painful dermatomal vesicular eruption. Risk increases with age (>50 years), immunosuppression, stress. Complications: post-herpetic neuralgia (PHN, 10-20% >50 years), ophthalmic zoster, Ramsay Hunt syndrome, dissemination. Treatment: aciclovir/valaciclovir/famciclovir within 72 hours; PHN: gabapentin/amitriptyline. Vaccine: Shingrix >50 years.

## Clinical Features and Presentation

Herpes zoster (shingles) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | VZV reactivation in sensory ganglia |
| Distribution | Dermatomal, unilateral, does not cross midline |
| Thoracic | Most common site (50%) |
| Trigeminal | Ophthalmic V1: keratitis, blindness |
| Pain | Precedes rash by 2-3 days (prodromal) |
| Rash | Vesicles on erythematous base → pustules → crust over 7-10 days |
| Complications | PHN 10-20% over 50 years, dissemination (immunocompromised), secondary bacterial infection |
| Ophthalmic zoster | Hutchinson's sign (nasal tip vesicles); urgent ophthalmology |
| Ramsay Hunt | Facial palsy, ear pain, vesicles in external auditory meatus; CN VII + VIII |
| Treatment | Aciclovir/valaciclovir/famciclovir within 72h |
| PHN treatment | Gabapentin, pregabalin, amitriptyline, capsaicin, lidocaine patches |
| Vaccine | Shingrix (recombinant) >50 years; 90% efficacy |
...
1. **Q:** Define Herpes zoster (shingles) and outline its classification.
   **A:** Herpes zoster (shingles) is reactivation of latent varicella-zoster virus (VZV) in sensory ganglia, causing a painful dermatomal vesicular eruption. Risk increases with age (>50 years), immunosuppress

2. **Q:** What are the key clinical features of Herpes zoster (shingles)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Herpes zoster (shingles).
...
1. **Zoster** = Dermatomal unilateral, pain before rash, PHN
...
| **Topic** | **Herpes zoster (shingles)** |
|-----------|-----------|
| **Definition** | Herpes zoster (shingles) is reactivation of latent varicella-zoster virus (VZV) in sensory ganglia,  |
| **Key Features** | VZV reactivation in sensory ganglia |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Herpes zoster (shingles)?
   A. VZV reactivation in sensory ganglia
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: VZV reactivation in sensory ganglia*
2. **Q:** What is the first-line treatment for Herpes zoster (shingles)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Herpes zoster (shingles)?
...
4. **Q:** What is the most important complication of Herpes zoster (shingles)?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Herpes zoster (shingles)?
   A. Shingrix (recombinant) >50 years; 90% efficacy
...
## SBA Questions (5)
1. **Scenario:** Patient with Herpes zoster (shingles); first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Herpes zoster (shingles) failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Herpes zoster (shingles)?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Herpes zoster (shingles)?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Herpes zoster (shingles)?
   A. Shingrix (recombinant) >50 years; 90% efficacy
...
- **Q:** Key fact about Herpes zoster (shingles)?
  **A:** VZV reactivation in sensory ganglia
- **Q:** Another key point?
  **A:** Dermatomal, unilateral, does not cross midline
- **Q:** Most important complication?
  **A:** Most common site (50%)
- **Q:** First-line treatment?
  **A:** Ophthalmic V1: keratitis, blindness
- **Q:** Key histological/serological feature?
  **A:** Precedes rash by 2-3 days (prodromal)

## Answer Key with Explanations

### MCQs
1. **A** — Cause: VZV reactivation in sensory ganglia
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Vaccine: Shingrix (recombinant) >50 years; 90% efficacy
...
5. **A** — Shingrix (recombinant) >50 years; 90% efficacy
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Herpes zoster (shingles) full*

**Q1.** What is the most appropriate first-line therapy for Herpes zoster (shingles) full?
