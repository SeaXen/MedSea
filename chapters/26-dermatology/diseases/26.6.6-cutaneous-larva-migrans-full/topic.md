...
Cutaneous larva migrans (CLM, 'creeping eruption') is a skin infestation by animal hookworm larvae (Ancylostoma braziliense, A. caninum) typically contracted from walking barefoot on contaminated sand/soil (beaches, sandboxes). Larvae penetrate skin and migrate in epidermis creating serpiginous, intensely pruritic tracks. Self-limiting in weeks-months (humans are dead-end hosts). Treatment: ivermectin (single dose), albendazole, topical thiabendazole.

## Clinical Features and Presentation

Cutaneous larva migrans presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | Animal hookworm larvae (Ancylostoma braziliense, A. caninum) |
| Acquired | Walking barefoot on contaminated sand/soil (beaches, sandboxes) |
| Distribution | Feet, buttocks, hands (contact areas) |
| Lesion | Serpiginous, erythematous, intensely pruritic track (mm to cm per day) |
| Migration | 1-2 cm per day |
| Self-limiting | Weeks-months (humans are dead-end hosts) |
| Treatment | Ivermectin 200µg/kg single dose; albendazole 400mg OD 3-7 days; topical thiabendazole |
| Prevention | Shoes on beaches, sandboxes, contaminated soil |
| Differential | Schistosomiasis (freshwater, different), Strongyloides (faster, buttock), cutaneous panniculitis |
| Biopsy | Rarely needed; larva in epidermis on histology |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Schistosomiasis | Freshwater exposure, different morphology |

## Viva Questions

1. **Q:** Define Cutaneous larva migrans and outline its classification.
   **A:** Cutaneous larva migrans (CLM, 'creeping eruption') is a skin infestation by animal hookworm larvae (Ancylostoma braziliense, A. caninum) typically contracted from walking barefoot on contaminated sand

2. **Q:** What are the key clinical features of Cutaneous larva migrans?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Cutaneous larva migrans.
...
1. CLM = creeping eruption; beach holiday; serpiginous track
...
| **Topic** | **Cutaneous larva migrans** |
|-----------|-----------|
| **Definition** | Cutaneous larva migrans (CLM, 'creeping eruption') is a skin infestation by animal hookworm larvae ( |
| **Key Features** | Animal hookworm larvae (Ancylostoma braziliense, A. caninum) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Cutaneous larva migrans?
   A. Animal hookworm larvae (Ancylostoma braziliense, A. caninum)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: Animal hookworm larvae (Ancylostoma braziliense, A. caninum)*
2. **Q:** What is the first-line treatment for Cutaneous larva migrans?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Cutaneous larva migrans?
...
4. **Q:** What is the most important complication of Cutaneous larva migrans?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Cutaneous larva migrans?
   A. Rarely needed; larva in epidermis on histology
...
## SBA Questions (5)
1. **Scenario:** Patient with Cutaneous larva migrans; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Cutaneous larva migrans failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Cutaneous larva migrans?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Cutaneous larva migrans?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Cutaneous larva migrans?
   A. Rarely needed; larva in epidermis on histology
...
- **Q:** Key fact about Cutaneous larva migrans?
  **A:** Animal hookworm larvae (Ancylostoma braziliense, A. caninum)
- **Q:** Another key point?
  **A:** Walking barefoot on contaminated sand/soil (beaches, sandboxes)
- **Q:** Most important complication?
  **A:** Feet, buttocks, hands (contact areas)
- **Q:** First-line treatment?
  **A:** Serpiginous, erythematous, intensely pruritic track (mm to cm per day)
...
### MCQs
1. **A** — Cause: Animal hookworm larvae (Ancylostoma braziliense, A. caninum)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Biopsy: Rarely needed; larva in epidermis on histology
...
5. **A** — Rarely needed; larva in epidermis on histology
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Cutaneous larva migrans full*

**Q1.** What is the most appropriate first-line therapy for Cutaneous larva migrans full?
