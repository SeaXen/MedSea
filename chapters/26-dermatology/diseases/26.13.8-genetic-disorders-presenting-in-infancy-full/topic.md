...
topic: Genetic disorders presenting in infancy
...
Genetic disorders presenting in infancy with skin signs: epidermolysis bullosa (EB) simplex/junctional/dystrophic (blistering from birth, severity varies); ichthyosis (collodion baby, lamellar, EHK, Harlequin); epidermolytic hyperkeratosis; incontinentia pigmenti (female, Blaschkoid, 4 stages); neurofibromatosis type 1 (CALMs, axillary freckling, neurofibromas later); tuberous sclerosis (ash-leaf, angiofibromas later); xeroderma pigmentosum (photosensitivity, freckling); bullous congenital ichthyosiform erythroderma; Sjögren-Larsson syndrome; Netherton syndrome (ichthyosis, hair shaft, atopy); piebaldism; albinism. Skin biopsy (EM, genetic) essential for diagnosis.

## Clinical Features and Presentation

Genetic disorders presenting in infancy presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| EB | Blistering from birth; EB simplex, JEB, DEB |
| Ichthyosis | Collodion, lamellar, EHK, Harlequin |
| IP | Female, Blaschkoid, 4 stages |
| NF1 | CALMs, axillary freckling |
| TSC | Ash-leaf, angiofibromas later |
| XP | Photosensitivity, freckling, cancer |
| Netherton | Ichthyosis, hair (bamboo), atopy, SPINK5 |
| Investigation | Skin biopsy (EM, IFM), genetic testing |
| Treatment | Supportive; specific (e.g., retinoids for ichthyosis); multidisciplinary |
...
1. **Q:** Define Genetic disorders presenting in infancy and outline its classification.
   **A:** Genetic disorders presenting in infancy with skin signs: epidermolysis bullosa (EB) simplex/junctional/dystrophic (blistering from birth, severity varies); ichthyosis (collodion baby, lamellar, EHK, H

2. **Q:** What are the key clinical features of Genetic disorders presenting in infancy?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Genetic disorders presenting in infancy.
...
|-----------|---------------|
| **Paediatric** | Often present at birth |
## One-Page Revision Card

| **Topic** | **Genetic disorders presenting in infancy** |
|-----------|-----------|
| **Definition** | Genetic disorders presenting in infancy with skin signs: epidermolysis bullosa (EB) simplex/junction |
| **Key Features** | Blistering from birth; EB simplex, JEB, DEB |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Genetic disorders presenting in infancy?
   A. Blistering from birth; EB simplex, JEB, DEB
...
5. **Q:** Key histological/serological feature?
   A. Supportive; specific (e.g., retinoids for ichthyosis); multidisciplinary
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Genetic disorders presenting in infancy?
  **A:** Blistering from birth; EB simplex, JEB, DEB
- **Q:** Another key point?
  **A:** Collodion, lamellar, EHK, Harlequin
- **Q:** Most important complication?
  **A:** Female, Blaschkoid, 4 stages
- **Q:** First-line treatment?
  **A:** CALMs, axillary freckling
- **Q:** Key histological/serological feature?
  **A:** Ash-leaf, angiofibromas later

## Answer Key with Explanations

### MCQs
1. **A** — EB: Blistering from birth; EB simplex, JEB, DEB
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Supportive; specific (e.g., retinoids for ichthyosis); multidisciplinary
...
5. **A** — Supportive; specific (e.g., retinoids for ichthyosis); multidisciplinary
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 26: Dermatology — Genetic disorders presenting in infancy full*

**Q1.** What is the most appropriate first-line therapy for Genetic disorders presenting in infancy full?
