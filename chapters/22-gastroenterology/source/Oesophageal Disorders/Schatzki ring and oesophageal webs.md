...
topic_group: Structural oesophageal disorders
...
```mermaid
flowchart TD
A[Intermittent solid dysphagia] --> B[Consider ring/web]
B --> C[Endoscopy or contrast swallow]
C --> D[Symptomatic lesion confirmed]
D --> E[Dilation/disruption + treat associations]
```
