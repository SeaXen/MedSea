...
topic_group: Dyspepsia spectrum
...
```mermaid
flowchart TD
A[Dyspepsia] --> B{Alarm features?}
B -- Yes --> C[Upper GI endoscopy / urgent evaluation]
B -- No --> D[Review drugs + consider H. pylori strategy]
D --> E[Empirical therapy]
E --> F{Structural cause found?}
F -- No --> G[Functional dyspepsia management]
F -- Yes --> H[Treat specific cause]
```
