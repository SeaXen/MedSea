...
```mermaid
flowchart TD
A[Epigastric pain/nausea after irritant exposure] --> B{Bleeding or alarm features?}
B -- Yes --> C[Resuscitation/endoscopy pathway]
B -- No --> D[Stop trigger + acid suppression]
```
