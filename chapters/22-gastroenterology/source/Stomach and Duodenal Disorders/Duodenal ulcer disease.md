...
```mermaid
flowchart TD
A[Epigastric pain / ulcer suspicion] --> B{Complication signs?}
B -- Yes --> C[Resuscitate / urgent endoscopy or surgery]
B -- No --> D[Assess H. pylori and NSAID exposure]
D --> E[PPI-based treatment]
E --> F[Eradicate H. pylori if present]
```
