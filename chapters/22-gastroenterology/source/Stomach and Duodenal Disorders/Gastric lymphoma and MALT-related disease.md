...
topic_group: Gastric malignancy
...
```mermaid
flowchart TD
A[Persistent gastric symptoms / abnormal lesion] --> B[Endoscopy + biopsy]
B --> C[Classify lymphoma subtype]
C --> D[Assess H pylori + stage]
D --> E[Eradication pathway or oncologic therapy]
```
