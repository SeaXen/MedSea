...
## Differential from Free Perforation
...
```mermaid
flowchart TD
A[Ulcer symptoms persist or become atypical] --> B[Consider penetration/fistulation]
B --> C[Endoscopy + cross-sectional imaging]
C --> D[Specialist complication management]
```
