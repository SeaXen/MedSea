...
topic_group: Functional bowel disorders
...
```mermaid
flowchart TD
  A[Chronic Symptoms] --> B{Red Flags?}
  B -- Yes --> C[Investigate Organic]
  B -- No --> D[Rome IV Criteria Met?]
  D -- Yes --> E[Functional Diagnosis]
  D -- No --> F[Reassess]
  E --> G[Stepwise Management]
  G --> H1[Diet/Fibre/Lifestyle]
  G --> H2[Neuromodulators]
  G --> H3[Gut-Brain Therapy]
  H1 --> I{Response?}
  I -- No --> J[Escalate/Combine]
  I -- Yes --> K[Maintain]
```
