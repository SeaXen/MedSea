...
```mermaid
flowchart TD
A[Need small-bowel assessment] --> B{Need broad mucosal visualization?}
B -- Yes --> C[Capsule endoscopy]
B -- No --> D{Need biopsy or therapy?}
D -- Yes --> E[Enteroscopy]
D -- No --> F[Choose with imaging/context]
```
