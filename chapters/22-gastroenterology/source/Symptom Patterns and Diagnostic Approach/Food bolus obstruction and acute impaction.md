...
```mermaid
flowchart TD
A[Sudden dysphagia after swallowing] --> B{Can swallow saliva?}
B -- No --> C[Complete obstruction / urgent endoscopy]
B -- Yes --> D[Partial obstruction / urgent assessment]
C --> E[Assess airway, aspiration, perforation]
D --> E
E --> F[Endoscopic relief]
F --> G[Evaluate underlying cause]
```
