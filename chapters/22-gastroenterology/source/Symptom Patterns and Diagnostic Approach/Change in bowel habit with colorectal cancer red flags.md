...
```mermaid
flowchart TD
A[New change in bowel habit] --> B{Red flags?}
B -- Yes --> C[Urgent lower-GI evaluation]
B -- No --> D[Review benign/functional causes]
D --> E{Persistent or progressive?}
E -- Yes --> C
E -- No --> F[Follow-up and reassess]
```
