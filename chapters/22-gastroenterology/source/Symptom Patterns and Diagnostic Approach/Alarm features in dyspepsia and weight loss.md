...
## Differential Diagnosis Behind the Red Flags
- Gastric cancer
- Oesophageal cancer
...
```mermaid
flowchart TD
A[Dyspeptic symptoms] --> B{Alarm features present?}
B -- Yes --> C[Urgent/early upper GI endoscopy]
B -- No --> D[Standard low-risk dyspepsia pathway]
C --> E[Identify ulcer, cancer, obstruction, or other pathology]
```
