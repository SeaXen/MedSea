...
topic_group: Diarrhoea, constipation, and abdominal pain
...
```mermaid
flowchart TD
A[Constipation / altered bowel habit] --> B{Red flags or new progressive change?}
B -- Yes --> C[Investigate lower GI / obstruction pathway]
B -- No --> D[Functional / secondary-cause review]
D --> E[Conservative + rational laxative management]
```
