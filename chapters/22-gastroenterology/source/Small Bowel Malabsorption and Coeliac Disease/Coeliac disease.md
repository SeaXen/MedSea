...
topic_group: Coeliac disease spectrum
...
```mermaid
flowchart TD
A[Chronic diarrhoea / malabsorption / iron deficiency] --> B[Consider coeliac disease]
B --> C[Serology while eating gluten]
C --> D{Supports coeliac disease?}
D -- Yes --> E[Duodenal biopsy in adult pathway]
E --> F[Gluten-free diet + nutritional correction]
D -- No --> G[Consider other malabsorption causes]
```
