...
## 7. Endoscopic / Structural Features
...
```mermaid
flowchart TD
A[Recurrent solid-food dysphagia / impaction] --> B[Consider EoE]
B --> C[Endoscopy + oesophageal biopsies]
C --> D[Confirm eosinophilic inflammation]
D --> E[Treat inflammation and prevent fibrostenosis]
```
