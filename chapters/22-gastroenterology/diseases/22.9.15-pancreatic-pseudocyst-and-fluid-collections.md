...
```mermaid
mindmap
  root((Pancreatic Pseudocyst / Fluid Collections))
    Definition
      Mature encapsulated fluid collection post-pancreatitis
    Key Features
      Asymptomatic or compression symptoms; mature wall, minimal necrosis
    Diagnosis
      CT/MRI for characterization, timing, wall maturity
    Management
      Observe asymptomatic; drain symptomatic/infected/complicated
    Complications
      Infection, bleeding, GI/biliary obstruction, rupture
```
