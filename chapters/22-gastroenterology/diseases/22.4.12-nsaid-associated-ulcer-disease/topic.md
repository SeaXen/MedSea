...
```mermaid
flowchart TD
A[NSAID user with dyspepsia or bleed] --> B[Assess severity and complications]
B --> C[Stop NSAID if possible + acid suppression]
C --> D[Manage bleed/perforation urgently if present]
```
