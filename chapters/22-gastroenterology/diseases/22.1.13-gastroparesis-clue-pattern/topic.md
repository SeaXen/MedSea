...
```mermaid
flowchart TD
A[Postprandial fullness + nausea/vomiting] --> B{Old food / diabetic clue?}
B -- Yes --> C[Suspect gastroparesis]
C --> D[Exclude mechanical obstruction]
D --> E[Confirm delayed gastric emptying if feasible]
E --> F[Dietary + cause-directed + prokinetic management]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 22: Gastroenterology — Gastroparesis clue pattern*

**Q1.** What is the most appropriate first-line therapy for Gastroparesis clue pattern?

  - **A.** Use prokinetic strategy where appropriate
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Use prokinetic strategy where appropriate
  >
  > *Source:* Use prokinetic strategy where appropriate
