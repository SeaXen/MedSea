---
tags: [medicine, ophthalmology, davidson, subconjunctival, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Conjunctiva
topic_group: Subconjunctival Haemorrhage
...
```mermaid
mindmap
  root((Subconjunctival Haemorrhage))
    Definition
      Blood under bulbar conjunctiva
      Painless
      Sharply demarcated
      Bright red
    Causes
    ...
    Clinical
      ...
      Self-limiting
        1-3 weeks
        Red to yellow to resolve
    Examination
      Visual acuity normal
      BP check
      FBC if recurrent
      Coagulation if recurrent
    Management
      Reassurance
      Artificial tears
