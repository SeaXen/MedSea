# Chapter 28: Medical Ophthalmology — Topic Hierarchy (Davidson-aligned)

<callout icon="📚" color="blue_bg">
**Document Type:** Topic Hierarchy (Davidson-aligned) (Chapter-Level Overview)
**Davidson Alignment:** Chapter 28: Medical Ophthalmology
**Chapter Number:** 28
...
This is the **Topic Hierarchy** for Chapter 28: Medical Ophthalmology. It maps every atomic topic to its parent hub and Davidson section. Use this as your navigation index — every link points to the corresponding `topic.md` file in the MedSea repository.
</callout>
...
The following hierarchy was preserved from `Davidson Chapter 27 - Medical Ophthalmology Hierarchy.md` — the Davidson-aligned topic tree.
...
### 28.1 01_Anatomy_Physiology_Examination (0 topics)

*(No atomic topics yet — see hub page)*

### 28.2 02_Refractive_Errors (0 topics)

*(No atomic topics yet — see hub page)*

### 28.3 03_Lids_and_Lacrimal (0 topics)

*(No atomic topics yet — see hub page)*

### 28.4 04_Conjunctiva (0 topics)

*(No atomic topics yet — see hub page)*

### 28.5 05_Cornea (0 topics)

*(No atomic topics yet — see hub page)*

### 28.6 06_Lens_and_Cataract (0 topics)

*(No atomic topics yet — see hub page)*

### 28.7 07_Uveal_Tract (0 topics)

*(No atomic topics yet — see hub page)*

### 28.8 08_Retina_and_Vitreous (0 topics)

*(No atomic topics yet — see hub page)*

### 28.9 09_Glaucoma (0 topics)

*(No atomic topics yet — see hub page)*

### 28.10 10_Optic_Nerve (0 topics)

*(No atomic topics yet — see hub page)*

### 28.11 11_Orbit_and_Trauma (0 topics)

*(No atomic topics yet — see hub page)*

### 28.12 12_Systemic_Disease_Manifestations (0 topics)

*(No atomic topics yet — see hub page)*

### 28.13 13_Visual_Symptoms_Approach (0 topics)
...
```yaml
chapter: 28
chapter_name: Medical Ophthalmology
davidson_alignment: 25th Edition
total_atomic_topics: 97
total_hubs: 13
...
*Sea Knowledge · Medical Ophthalmology · Chapter Overview · v2.0 · For FCPS / MRCP exam prep*
