---
tags: [medicine, ophthalmology, davidson, preseptal, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Orbit & Ocular Trauma
topic_group: Preseptal Cellulitis
...
mindmap
  root((Preseptal Cellulitis))
    ...
    Investigations
      Clinical diagnosis
      Bloods if unwell
      CT if orbital suspected
    Management
      Oral co-amoxiclav
      Review 24-48h
      Admit if orbital or systemic
    Red Flags
      Proptosis
      ↓VA / RAPD
      Painful EOM
