---
tags: [medicine, ophthalmology, davidson, uvea, retina, vasculitis, Behcet, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Ocular Manifestations of Systemic Disease
topic_group: Behçet's Disease
topic: Behçet's Disease (Ocular)
...
```mermaid
mindmap
  root((Behcet's Ocular))
    Definition
      Systemic neutrophilic vasculitis
      Recurrent
      Oral genital ocular triad
    ...
    Skin Features
      Erythema nodosum
      Papulopustular
      Pathergy positive 50 percent
    Systemic
      Arthritis non erosive
      DVT arterial aneurysms
      Neuro Behcet
      GI ulcers
    Investigations
      ISG criteria
    ...
    Prognosis
      Recurrent
      25-50 percent vision loss 5-10 years
      Mortality vascular neuro
      Worse young male posterior
```
