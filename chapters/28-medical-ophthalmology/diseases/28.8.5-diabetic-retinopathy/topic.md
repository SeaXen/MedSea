---
tags: [medicine, ophthalmology, davidson, retina, DR, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Retina & Vitreous
topic_group: Diabetic Retinopathy
...
mindmap
  root((Diabetic Retinopathy))
    Definition
      ...
      Leading cause blindness working age
    Risk Factors
    ...
    Classification
      NPDR
        Mild - microaneurysms
        Moderate - haemorrhages, exudates
        Severe - 4-2-1 rule
        Very severe - 2+ of 4-2-1
      PDR
        NVD, NVE
