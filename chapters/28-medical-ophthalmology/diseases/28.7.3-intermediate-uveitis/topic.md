---
tags: [medicine, ophthalmology, davidson, uveitis, intermediate, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Uveal Tract — Uveitis
topic_group: Intermediate Uveitis
...
mindmap
  root((Intermediate Uveitis))
    ...
    Causes
      ...
      MS periphlebitis
      Sarcoidosis
      IBD, Lyme, TB, Syphilis
    Clinical Features
      Floaters
      Painless blurred vision
      Vitritis
      Snowballs inferior vitreous
      Snowbank pars plana
      Periphlebitis
      CMO
    Investigations
      ...
      OCT CMO
      Brain MRI MS
      ACE syphilis TB serology
    Management
      Observation if mild
      Steroid topical periocular intravitreal
      Systemic steroid
      Immunosuppression MTX MMF biologic
      Cryotherapy to snowbank
      Vitrectomy
    Complications
      CMO main cause of vision loss
      Cataract
      Glaucoma
      Retinal detachment
```
