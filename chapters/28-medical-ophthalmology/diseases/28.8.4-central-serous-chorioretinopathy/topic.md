---
tags: [medicine, ophthalmology, davidson, retina, macula, CSCR, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Retina & Vitreous
topic_group: Central Serous Chorioretinopathy
...
mindmap
  root((CSCR))
    Definition
      Serous detachment neurosensory retina
      Macular
      RPE defect leak
    ...
    Signs
      Mild vision loss
      Subtle macular elevation
      Loss foveal reflex
      Dome shaped serous detachment
    Investigations
      OCT
        Subretinal fluid
        Pachychoroid
      FFA
        Inkblot leak 90 percent
        Smokestack leak 10 percent
      ICGA
        Choroidal hyperpermeability
      Autofluorescence
        Hyperautofluorescent SRF
      OCTA
        Exclude CNV
    ...
    Prognosis
      80-90 percent resolve
      Recurrence 30-50 percent
      Chronic 10-15 percent
```
