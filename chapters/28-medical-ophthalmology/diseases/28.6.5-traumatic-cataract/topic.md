---
tags: [medicine, ophthalmology, davidson, traumatic, cataract, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Lens & Cataract
topic_group: Traumatic Cataract
...
```mermaid
mindmap
  root((Traumatic Cataract))
    Mechanisms
      Blunt trauma
        Rosette stellate PSC
      ...
      Penetrating trauma
        ...
        Extruded lens matter
      IOFB
        Siderosis iron
        Chalcosis copper
      Other
        Electrical multilamellar
    ...
    Clinical
      ...
      Decreased vision
      Pain
      Lens opacity rosette focal diffuse
      Associated signs hyphema RD
    Investigations
      Slit lamp
      B scan
      CT orbit IOFB
      Avoid MRI metallic FB
      ERG VEP if posterior not visible
    Management
      Emergency ABC
      Shield eye no patch
      IV antibiotics open globe
      Tetanus prophylaxis
      Surgery lensectomy IOL
        Timing 1 to 4 weeks
        Combined with PPV if needed
    Complications
      Phacomorphic glaucoma
      Phacolytic uveitis
      Phacoanaphylactic uveitis
      Endophthalmitis Bacillus
      Retinal detachment
