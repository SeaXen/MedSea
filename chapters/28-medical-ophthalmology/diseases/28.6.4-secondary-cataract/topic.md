---
tags: [medicine, ophthalmology, davidson, secondary, cataract, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Lens & Cataract
topic_group: Secondary Cataract
...
```mermaid
mindmap
  root((Secondary Cataract))
    Systemic
      Diabetes mellitus
        Snowflake young T1DM
        Earlier onset
        Polyol pathway
      Galactosaemia
        Oil droplet reversible
        Lactose free diet
      Hypocalcaemia
        Lamellar zonular
      Myotonic dystrophy
    ...
    Ocular
      ...
      Retinitis pigmentosa
        PSC
      Post vitrectomy
        Nuclear sclerosis accelerated
      Acute angle closure
        Glaukomflecken
    Management
      Treat underlying cause
        DM control
        Stop reduce steroids
        Control uveitis
