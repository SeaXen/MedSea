...
## 2. Medulloblastoma (MB) — Most Common Paediatric Malignant CNS Tumour

### Molecular Subgroups (WHO CNS5 / Consensus)
...
### Chang Staging (Clinical) + Molecular Risk
...
## 4. Diffuse Midline Glioma / DIPG (H3K27M-Mutant)
...
## 5. Paediatric Low-Grade Glioma (PLGG) — Pilocytic Astrocytoma
...
## 6. Paediatric High-Grade Glioma (HGG) — Non-DIPG
...
## 8. Intracranial Germ Cell Tumours (GCT)
...
## 9. Hydrocephalus Management (Common Across Paediatric CNS Tumours)
