...
## 3. Histological Classification (WHO)
...
## 5. Prognostic Scores — **IPS (Advanced HL) / GHSG (Early)**

### International Prognostic Score (IPS) — **Advanced HL (Stage III-IV)**
| Factor | Points |
|--------|--------|
| **Albumin <4 g/dL** | 1 |
| **Hb <10.5 g/dL** | 1 |
...
### GHSG Risk (Early Stage I-II) — **HD18 / HD19**
| Risk Group | Criteria |
|------------|----------|
...
## 6. Treatment — **ABVD / BEACOPP / PET-Adapted**

### Early Stage (I-II) — **GHSG HD18/HD19**
...
### Advanced Stage (III-IV) — **ABVD vs BEACOPPesc**
...
## 7. Brentuximab Vedotin (BV) — **Anti-CD30 ADC**
...
## 8. Relapsed/Refractory HL — **Salvage → Auto-HSCT → Novel**
