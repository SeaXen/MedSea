...
## 3. Classification — **WHO 2022 / ICC 2022**

### Defining Genetic Subtypes (Presence = AML regardless of blast %)
...
### AML Not Otherwise Specified (NOS) — Morphology
...
## 4. ELN 2022 Risk Stratification — **EXAM CRITICAL**
...
## 6. Management — **Induction → Consolidation → Maintenance**
...
## 7. Induction Regimens — **Dosing Details**
...
## 8. APL (Acute Promyelocytic Leukaemia) — **EMERGENCY**
...
## 9. Complications & Supportive Care
...
| **ELN 2022** | **Favourable**: t(8;21), inv(16), NPM1mut (no FLT3-ITD/low AR), CEBPA bZIP<br>**Adverse**: TP53mut, Complex karyotype, FLT3-ITD high AR, KMT2A-r |
...
**2.** Regarding Acute Myeloid Leukaemia (AML) (ELN 2022), which statement is correct?
   ...
   C. Empirical management only
   D. Watch and wait
   - **Answer: A** — **Favourable**: t(8;21), inv(16), NPM1mut (no FLT3-ITD/low AR), CEBPA bZIP<br>**Adverse**: TP53mut, Complex karyotype, F...
...
**2.** On staging workup, the patient is found to be [Stage X]. Best management is:
   ...
   - C. Empirical broad approach
   - D. No intervention required
   - **Answer: A** — stage-specific: **Favourable**: t(8;21), inv(16), NPM1mut (no FLT3-ITD/low AR), CEBPA bZIP<br>**Adverse**: TP53mut, Complex karyotype, F...
