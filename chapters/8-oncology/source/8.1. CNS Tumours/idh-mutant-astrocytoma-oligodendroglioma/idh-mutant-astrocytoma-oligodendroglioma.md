...
## 2. Definition & Classification (WHO CNS5 2021)
...
flowchart LR
    ...
    B -->|**Codeleted**| C[**Oligodendroglioma**<br/>**TERT Promoter Mut (80%)**<br/>**CIC Mut (60%)**<br/>**FUBP1 Mut (25%)**<br/>**NOTCH1 Mut**<br/>**ATRX Retained**<br/>**TP53 Wildtype**]
    B -->|**Non-Codeleted**| D[**Astrocytoma**<br/>**ATRX Loss (80%)**<br/>**TP53 Mut (90%)**<br/>**CDKN2A/B Del (Grade 3-4)**<br/>**RB1 Loss (Grade 4)**<br/>**TERTp Usually WT**]
```
...
### Grade 4 Astrocytoma, IDH-mutant = **Secondary Glioblastoma**
...
## 6. Management by Grade & Type

### Grade 2 (Low-Grade) — IDH-Mutant Astrocytoma / Oligodendroglioma

```mermaid
flowchart TD
    A[Grade 2 IDH-Mutant Glioma] --> B{Extent of Resection / Risk}
    B -->|**GTR, Low Risk (Age<40, KPS=100, Size<5cm, Non-Eloquent)**| C[**Observation + Serial MRI**<br/>**q3mo ×1yr, q6mo ×2yr, then Annually**]
    B -->|**STR / Biopsy / High Risk (Age>40, Eloquent, Size>5cm, Crosses Midline)**| D[**Adjuvant Therapy**]
    D --> D1[**RT: 50.4-54Gy/28-30fx** (Standard for Oligo/Astro)> <br/>**OR TMZ (RTOG 9802 Subset)**]
    D --> D2[**Oligodendroglioma**: Consider RT + PCV (CODEL) if High Risk]
```

### Grade 3 (Anaplastic) — RT + Chemo Standard
...
### Grade 4 (IDH-mutant Astrocytoma = Secondary GBM)
...
## 7. CODEL & CATNON Trials (Practice-Changing)

### CODEL Trial (Anaplastic Oligodendroglioma, 1p/19q Codel)
...
### CATNON Trial (Anaplastic Astrocytoma, IDH-mut, Non-Codel)
...
## 8. 1p/19q Codeletion — Clinical Significance
