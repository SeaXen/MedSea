...
- Q: What is the definition of Cancer of the Lung?
  A: SCLC = 13-15% of lung cancer; Neuroendocrine, high-grade; Central, rapid doubling time; Almost exclusively smokers; Staging: Limited Stage (LS-SCLC) = confined to one hemithorax + regional nodes (T1-4, N0-3, M0) vs Extensive Stage (ES-SCLC) = disease beyond (M1).
- Q: What is Central Mass of Cancer of the Lung?
  A: Hilar/perihilar, bulky mediastinal nodes; SVC obstruction common
- Q: What is Rapid Onset of Cancer of the Lung?
  A: Weeks; Doubling time ~30 days
- Q: What is Respiratory of Cancer of the Lung?
  A: Cough, dyspnoea, haemoptysis, stridor (airway compression)
- Q: What is Paraneoplastic of Cancer of the Lung?
  A: SIADH (hyponatraemia) — Most common (15%); Lambert-Eaton (proximal weakness, ↓reflexes, ↓CMAP facilitation) — VGCC Ab; Anti-Hu (encephalomyelitis, sensory neuropathy) — ANNA-1; Cushing's (ACTH); Peripheral neuropathy
- Q: What is Metastatic of Cancer of the Lung?
  A: Brain (LS 10-15%, ES 20-25% at dx), Liver, Bone, Adrenal, Marrow
- Q: What is Central Mass of Cancer of the Lung?
  A: Hilar/perihilar, bulky mediastinal nodes; SVC obstruction common
- Q: What is Rapid Onset of Cancer of the Lung?
  A: Weeks; Doubling time ~30 days
...
- Q: What is Metastatic of Cancer of the Lung?
  A: Brain (LS 10-15%, ES 20-25% at dx), Liver, Bone, Adrenal, Marrow
- Q: What is SCLC of Cancer of the Lung?
  A: 13-15%; Neuroendocrine; Central, rapid; Smoking 100%; Ki-67 >50%
- Q: What is Staging of Cancer of the Lung?
  A: VALG 2-stage: LS (one hemithorax, radiation portal) vs ES (beyond)
- Q: What is LS-SCLC of Cancer of the Lung?
  A: Concurrent Cis+Etoposide ×4 + RT 45Gy/30fx (BID) or 60-66Gy/30-33fx → PCI 25Gy/10fx (all responders)
- Q: What is ES-SCLC 1L of Cancer of the Lung?
  A: Platinum/Etoposide ×4 + IO (Atezo IMpower133 / Pembro KEYNOTE-604 / Durva CASPIAN) → Maintenance IO
- Q: What is PCI of Cancer of the Lung?
  A: 25Gy/10fx; Mandatory LS responders; Optional ES CR/PR
- Q: What is Paraneoplastic of Cancer of the Lung?
  A: SIADH (↑ADH) — Most common; Lambert-Eaton (VGCC Ab, proximal weakness, facilitation); Anti-Hu (encephalitis); ACTH (Cushing's)
- Q: What is Relapse of Cancer of the Lung?
  A: Chemosensitive (≥6mo): Re-challenge Plat/Etop or IO recharge; Chemoresistant (<6mo): Topotecan (standard), Amrubicin, Lurbinectedin
- Q: What is Topotecan of Cancer of the Lung?
  A: Topo I inhibitor; IV/oral; Myelosuppression (G-CSF support); CNS penetration
- Q: What is Lurbinectedin of Cancer of the Lung?
  A: Trabectedin analogue; Selective inhibitor of RNA Pol II; ATLANTIS: ORR 35%, mPFS 3.5mo
- Q: What is DLL3-targeted of Cancer of the Lung?
  A: Tarlatamab (BITE) — SCLC-A (ASCL1+) expresses DLL3; DeLLphi-301: ORR ~40%

## MCQs (1 generated)

1. **Which of the following best describes Cancer of the Lung?**
   A. **SCLC = 13-15% of lung cancer; Neuroendocrine, high-grade; Central, rapid doubling time; Almost exclusively smokers; Staging: Limited Stage (LS-SCLC) = confined to one hemithorax + regional nodes (T1-4**
...
1. A patient with suspected Cancer of the Lung presents with: Incidence — 13-15% of lung cancer; ~6,500/year UK; Declining with smoking reduction; Prevalence — Very aggressive: Median OS LS 18-24mo, ES 8-12mo (improving with IO); 5-year OS LS ~25-30%, ES ~3-5%; Peak Age — 60-70 years. What is the most likely diagnosis?
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Small Cell Lung Cancer (SCLC)*

**Q1.** Which of the following features is most specific or characteristic of Small Cell Lung Cancer (SCLC)?
  ...
  > *Source:* LC regimen) |
| **NSCLC with NE differentiation** | Adeno/Squamous with NE markers; Not pure NE |
| **Carcinoid (Typical/Atypical)** | **Well-differentiated**, **Ki-67 <20% (Typical) / 20-50% (Atypica

**Q2.** What is the most appropriate first-line therapy for Small Cell Lung Cancer (SCLC)?

  - **A.** RT: + Start RT with Cycle + CONVERT trial
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — RT: + Start RT with Cycle + CONVERT trial
  >
  > *Source:* B --> B2[**RT: 45Gy/30fx (1.5Gy BID) or 60-66Gy/30-33fx (2Gy daily)**<br/>**Start RT with Cycle 1 or 2** (Concurrent superior) — **CONVERT trial**]
