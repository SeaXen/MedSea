...
| **Risk Factors** | **Adenocarcinoma**: Barrett's oesophagus (↑40-125x), GERD, obesity, smoking, male sex
**Squamous**: Smoking, alcohol (synergistic), achalasia, tylosis, caustic injury, hot beverages, HPV (some regions), nutritional deficiencies |
...
| **Stage Grouping** | **Adenocarcinoma**: IA (T1N0), IB (T2N0/T1N1), IIA (T3N0), IIB (T1-2N1/T3N1), III (T4aN0-1/T1-3N2), IV (T4b/Any N/M1)
**Squamous**: Similar but N-stage cutoff differs; Location (upper/mid/lower) matters for stage grouping |

### 1. Siewert Classification (GEJ Tumours)
...
flowchart TD
    ...
    B -->|Locally Advanced
T1b-T4a N0-2 M0| D{Histology}
    D -->|Adenocarcinoma / GEJ| E[Perioperative Chemo
FLOT x4 cycles pre + post
OR
Neoadjuvant CRT
CROSS: Carboplatin/Paclitaxel + 41.4 Gy]
    D -->|Squamous Cell| F[Definitive Chemoradiation
50-50.4 Gy + Concurrent Chemo
Cisplatin/5-FU or Carboplatin/Paclitaxel
Surgery only if residual]
    B -->|Metastatic / Unresectable| G[Palliative Systemic Therapy]
    G --> H1[1st Line: FOLFOX/CAPOX + Nivolumab
(CheckMate 648/649) if PD-L1 CPS ≥5]
    G --> H2[HER2+: Add Trastuzumab
(ToGA trial)]
    G --> H3[2nd Line: Paclitaxel ± Ramucirumab
(RAINBOW); Docetaxel; Irinotecan]
    E --> I[Surgery: Ivor Lewis / McKeown / Transhiatal]
    F --> J[Response Assessment: PET-CT + Endoscopy at 3-6 mo]
    I --> K[Adjuvant: Nivolumab if residual
(CheckMate 577)]
    K --> L[Surveillance]
    J --> L
    L --> M[Endoscopy q3-6mo x2yr, then annually
CT Chest/Abd/Pelvis annually x5yr]
```
...
| **T2-3 / N+ (Resectable)** | **FLOT x4 pre + post** (FLOT4-AIO) **OR**
**CROSS: NeoCRT (Carbo/Taxol + 41.4Gy) → Surgery** | **Definitive CRT** (50.4 Gy + Cisplatin/5-FU)
Surgery only for residual disease |
...
| **Metastatic (M1)** | **1L: FOLFOX/CAPOX + Nivolumab** (CPS ≥5, CheckMate 649)
HER2+: + Trastuzumab (ToGA)
**2L: Paclitaxel ± Ramucirumab** (RAINBOW)
**3L: Docetaxel / Irinotecan / Trifluridine-tipiracil** | **1L: Cisplatin/5-FU + Nivolumab** (CheckMate 648)
**2L: Paclitaxel / Docetaxel / Irinotecan** |
...
- Q: What is the definition of Upper GI Cancers?
  A: Malignant tumour of oesophageal mucosa; two main histological types: adenocarcinoma (distal oesophagus/GEJ) and squamous cell carcinoma (proximal/mid oesophagus)
- Q: What is the epidemiology of Upper GI Cancers?
  A: UK: ~9,300 new cases/year; M:F = 3:2; Adenocarcinoma now > Squamous in Western countries
- Q: What is Peak Age of Upper GI Cancers?
  A: 60-80 years (median 70); rare <40
- Q: What is Sex Ratio of Upper GI Cancers?
  A: Male predominance (3:1 for adenocarcinoma, 2:1 for squamous)
- Q: What are the clinical features of Upper GI Cancers?
  A: Progressive dysphagia (solids → liquids) = hallmark; Odynophagia
- Q: What is Weight Loss of Upper GI Cancers?
  A: >10% body weight = poor prognostic sign
- Q: What is Reflux/Heartburn of Upper GI Cancers?
  A: Pre-existing GERD (adenocarcinoma)
- Q: What is Hoarseness of Upper GI Cancers?
  A: Recurrent laryngeal nerve palsy (mediastinal invasion) → unresectable
- Q: What is Cough/Regurgitation of Upper GI Cancers?
  A: Tracheo-oesophageal fistula, aspiration
- Q: What is SVCO of Upper GI Cancers?
  A: Mediastinal nodal compression of SVC (emergency)
- Q: What is Paraneoplastic of Upper GI Cancers?
  A: Hypercalcaemia (PTHrP), Dermatomyositis, Acanthosis nigricans (Tripe palms)
- Q: What are the clinical features of Upper GI Cancers?
  A: Progressive dysphagia (solids → liquids) = hallmark; Odynophagia
- Q: What is Weight Loss of Upper GI Cancers?
  A: >10% body weight = poor prognostic sign
...
- Q: What is Paraneoplastic of Upper GI Cancers?
  A: Hypercalcaemia (PTHrP), Dermatomyositis, Acanthosis nigricans (Tripe palms)
- Q: What is Two Diseases of Upper GI Cancers?
  A: Adeno (distal, Barrett's, obesity) vs Squamous (proximal/mid, smoking/alcohol)
- Q: What is Red Flag of Upper GI Cancers?
  A: Progressive dysphagia + weight loss in >55yr = urgent endoscopy (2-week wait)
- Q: What is Staging of Upper GI Cancers?
  A: EUS for T/N, PET-CT for M, Laparoscopy for occult mets (GEJ)
- Q: What is the investigation of choice for Upper GI Cancers?
  A: Mandatory in metastatic adenocarcinoma (ToGA: trastuzumab + chemo ↑OS)
- Q: What is CROSS Trial of Upper GI Cancers?
  A: NeoCRT (Carbo/Taxol + 41.4Gy) → Surgery improved OS vs Surgery alone (HR 0.65) — Adeno benefit > Squamous
- Q: What is FLOT Trial of Upper GI Cancers?
  A: Perioperative FLOT (docetaxel/oxaliplatin/5-FU/leucovorin) ↑OS vs ECF/ECX — Standard for resectable adeno/GEJ
- Q: What is CheckMate 577 of Upper GI Cancers?
  A: Adjuvant Nivolumab post neoCRT+Surgery with residual disease → ↑DFS (HR 0.69)
- Q: What is CheckMate 648/649 of Upper GI Cancers?
  A: 1L Metastatic: Nivolumab + Chemo (CPS ≥5) → ↑OS
- Q: What is Definitive CRT of Upper GI Cancers?
  A: Standard for Squamous (organ preservation); 50.4 Gy + Cisplatin/5-FU
- Q: What is SVCO/MSCC of Upper GI Cancers?
  A: Oncologic emergencies — dexamethasone + urgent RT ± stenting/surgery
- Q: What is Nutrition of Upper GI Cancers?
  A: Pre-op nutritional optimisation critical; jejunostomy at surgery

## MCQs (1 generated)

1. **Which of the following best describes Upper GI Cancers?**
   A. **Oesophageal cancer = 2 distinct diseases (Adenocarcinoma vs Squamous) with different epidemiology, risk factors, staging, and treatment.**
...
1. A patient with suspected Upper GI Cancers presents with: Incidence — UK: ~9,300 new cases/year; M:F = 3:2; Adenocarcinoma now > Squamous in Western countries; Prevalence — 6th most common cause of cancer death globally; 5-year OS ~15-25% overall; Peak Age — 60-80 years (median 70); rare <40. What is the most likely diagnosis?
   A. **Upper GI Cancers**
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Oesophageal Cancer*

**Q1.** Which of the following features is most specific or characteristic of Oesophageal Cancer?
  ...
  > **Answer: A** — Presenting Symptom
  >
  > *Source:* Feature | Description |
|---------|-------------|
| **Presenting Symptom** | **Progressive dysphagia** (solids → liquids) = hallmark; Odynophagia |
| **Weight Loss** | >10% body weight = poor prognost

**Q2.** What is the most appropriate first-line therapy for Oesophageal Cancer?

  - **A.** T2-3 / N + FLOT x4 pre + post + CROSS: NeoCRT
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — T2-3 / N + FLOT x4 pre + post + CROSS: NeoCRT
  >
  > *Source:* **T2-3 / N+ (Resectable)**   **FLOT x4 pre + post** (FLOT4-AIO) **OR**<br/>**CROSS: NeoCRT (Carbo/Taxol + 41.4Gy) → Surgery**   **Definitive CRT** (50.4 Gy + Cisplatin/5-FU)<br/>Surgery only for resid
