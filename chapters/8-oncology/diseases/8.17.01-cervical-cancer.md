...
## 5. 5. Staging (FIGO 2018 — Imaging-Based)
...
flowchart TD
    ...
    B -->|**CIN1 (LSIL)**| C[**Observation** (60-70% regress)
**HPV test at 12mo**
If persistent → Treat]
    B -->|**CIN2 (HSIL)**| D[**LLETZ (Large Loop Excision)**
**OR Observation** (if <25yo, 50% regress)
**Fertility-sparing**]
    B -->|**CIN3 (HSIL)**| E[**LLETZ / Cold Knife Cone**
**Margins must be clear**
**If margins +ve → Repeat excision / Hysterectomy**]
    D --> F[**Follow-up: HPV + Cytology at 6mo, then 12mo, then 3yr**]
    E --> F
```

### 2. Early Stage (IA1-IB1)

```mermaid
flowchart TD
    A[Early Stage Cervical Cancer] --> B{Stage}
    B -->|**IA1 (No LVI)**| C[**Fertility-Sparing: Cone Biopsy / Trachelectomy**
**If margins clear, no LVI → No further Rx**
**If childbearing complete → Simple Hysterectomy**]
    B -->|**IA2 (LVI-)**| D[**Radical Trachelectomy + PLND** (Fertility)
**OR Radical Hysterectomy + PLND**]
    B -->|**IB1 (<2cm)**| E[**Radical Hysterectomy + PLND**
**Type III (Wertheim-Meigs) preferred**
**OR CCRT (Weekly Cisplatin + EBRT + Brachy) — Equivalent OS**]
    C --> F[**PLND: Sentinel Node Mapping (ICG) preferred**
**If SLN+ → Complete PLND / RT to pelvis**]
    D --> F
    E --> F
```

### 3. Locally Advanced (IB2-IVA)
...
flowchart TD
    ...
    B --> B3[**Brachytherapy: HDR/PDR**
**Image-guided (MRI/CT)**
**Point A Dose: ~85Gy EQD2**
**Total EQD2 (EBRT+BT): ~85-90Gy**]
...
flowchart TD
    ...
    B -->|**CPS ≥1**| C[**Carboplatin AUC5 + Paclitaxel 175mg/m² q3w ×6**
**+ Bevacizumab 15mg/kg** (GOG-240) — **If eligible**
**+ Pembrolizumab 200mg q3w** (KEYNOTE-826) — **OS HR 0.64, PFS HR 0.62**
**→ Maintenance: Pembro + Bev**]
    B -->|**CPS <1**| D[**Carbo/Pac ± Bevacizumab** (GOG-240)
**No Pembrolizumab** (OS not sig benefit)
**2L: PLD, Topotecan, Gemcitabine, Bev ± Chemo**]
    D --> E[**Clinical Trial / Re-challenge**]
```

### 5. KEYNOTE-826 Regimen
...
mindmap
  root((Cervical Cancer))
    ...
    Staging FIGO 2018
      ...
      IA2 (3-5mm)
      IB1-3 (size)
      II (Parametrium/Vagina)
      III (Wall/Vagina/Hydro/Nodes)
      IIIC1/2 (Nodes)
      IV (Bladder/Rectal/Distant)
    Early
      IA1: Cone/Trachelectomy
      IB1: Rad Hyst III + PLND OR CCRT
    Locally Advanced
      CCRT: Cis 40mg/wk + EBRT → Brachy
      Brachy: HR-CTV D90 85-90Gy EQD2
    Metastatic
      CPS≥1: Carbo/Pac/Bev + Pembro (K-826)
      CPS<1: Carbo/Pac ± Bev
    Prevention
...
- Q: What is the definition of Gynaecological Cancers?
  A: Malignant tumour of cervical epithelium; SCC 70-80%, Adenocarcinoma 20-25%; HPV-driven (>99%)
- Q: What is the epidemiology of Gynaecological Cancers?
  A: UK: ~3,200/year; Global: 4th most common female cancer (600k new, 340k deaths)
- Q: What is Peak Age of Gynaecological Cancers?
  A: Bimodal: 35-45 (HPV-related), 60-70 (screening failures)
- Q: What causes Gynaecological Cancers?
  A: HPV 16/18 (70%), Multiple partners, Early coitarche, Smoking (↑2-3x), Immunosuppression (HIV), Long-term OCP, High parity, DES exposure
- Q: What is Protective of Gynaecological Cancers?
  A: HPV Vaccination, Condoms, Circumcision (male partner), Screening
- Q: What is HPV of Gynaecological Cancers?
  A: HPV16/18 (70%), E6→p53 deg, E7→pRb deg; Screening prevents 70%
- Q: What is FIGO 2018 of Gynaecological Cancers?
  A: Imaging-based (MRI, PET-CT); LN+ = IIIC1 (pelvic), IIIC2 (para-aortic); IA1 <3mm no LVI
- Q: What is Screening of Gynaecological Cancers?
  A: Primary HPV → Cytology triage → Colposcopy
- Q: What is CIN of Gynaecological Cancers?
  A: CIN1: Obs; CIN2: LLETZ/Obs (<25yo); CIN3: LLETZ/Cone
- Q: What is IA1 (No LVI) of Gynaecological Cancers?
  A: Cone/Trachelectomy (fertility) OR Simple Hysterectomy
- Q: What is IB1 (<2cm) of Gynaecological Cancers?
  A: Radical Hysterectomy Type III + PLND OR CCRT (equivalent OS)
- Q: What is Locally Advanced of Gynaecological Cancers?
  A: CCRT: Weekly Cisplatin 40mg/m² + EBRT 45-50.4Gy → Brachy
- Q: How is Gynaecological Cancers managed?
  A: Image-guided (MRI/CT), Point A ~85Gy EQD2, Total ~85-90Gy EQD2
- Q: What is Metastatic of Gynaecological Cancers?
  A: Carbo/Pac + Bev + Pembro (KEYNOTE-826) if CPS≥1 → OS HR 0.64
- Q: What is HPV Vaccine of Gynaecological Cancers?
  A: 9-valent (6,11,16,18,31,33,45,52,58) — 2-dose <15yr, 3-dose ≥15yr

## MCQs (1 generated)

1. **Which of the following best describes Gynaecological Cancers?**
   A. **Cervical Cancer = 4th most common female cancer globally; HPV-driven (HPV16/18 70%, HPV45/31/33/52/58); FIGO 2018 Staging; Screening: Primary HPV testing + Cytology triage; Pre-cancer (CIN1-3): CIN1 o**
...
1. A patient with suspected Gynaecological Cancers presents with: Definition — Malignant tumour of cervical epithelium; SCC 70-80%, Adenocarcinoma 20-25%; HPV-driven (>99%); Incidence — UK: ~3,200/year; Global: 4th most common female cancer (600k new, 340k deaths); Prevalence — 5-year OS: Stage I ~90%, Stage II ~60%, Stage III ~40%, Stage IV ~15%. What is the most likely diagnosis?
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Cervical Cancer*

**Q1.** Which of the following features is most specific or characteristic of Cervical Cancer?

  - **A.** GOG-240 vs KEYNOTE-826
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — GOG-240 vs KEYNOTE-826
  >
  > *Source:* HR-CTV (High-Risk Clinical Target Volume) D90 ≥85-90Gy EQD2**; **Point A historical surrogate** |
| **GOG-240 vs KEYNOTE-826** | **GOG-240**: Carbo/Pac ± Bev (Bev added PFS/OS); **KEYNOTE-826**: Adds 

**Q2.** What is the most appropriate first-line therapy for Cervical Cancer?

  - **A.** CIN1 + Observation + HPV test at
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — CIN1 + Observation + HPV test at
  >
  > *Source:* B --> **CIN1 (LSIL)**  C[**Observation** (60-70% regress)<br/>**HPV test at 12mo**<br/>If persistent → Treat]
