...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Renal Cell Carcinoma (RCC)*

**Q1.** Which of the following features is most specific or characteristic of Renal Cell Carcinoma (RCC)?
  ...
  > *Source:* ic site |
| **Bone Scan / PET-CT** | Symptomatic bone; PET for occult mets | PET-CT not routine |
| **Biopsy** | **Before systemic therapy** for metastatic (confirm histology, subtype); **Not routine 

**Q2.** What is the most appropriate first-line therapy for Renal Cell Carcinoma (RCC)?

  - **A.** CARMENA + IMDC Intermediate/Poor + Sunitinib alone
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — CARMENA + IMDC Intermediate/Poor + Sunitinib alone
  >
  > *Source:* **CARMENA**   **IMDC Intermediate/Poor**, asymptomatic primary   **Sunitinib alone** vs **CN + Sunitinib**   **Non-inferior OS** (no benefit for CN)
