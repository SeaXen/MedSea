...
## 3. 3. ctDNA Clinical Applications
...
## 4. 4. Resistance Mutation Monitoring
...
## 5. 5. Tumour Fraction & Clinical Utility
...
## 7. 7. Multi-Cancer Early Detection (MCED)
...
mindmap
  root((Liquid Biopsy))
    ctDNA
      MRD (Post-Surg/Adjuvant)
      Resistance (EGFR T790M, ESR1, KRAS)
      Tumour Fraction (% ctDNA)
      TMB/MSI from ctDNA
      CHIP Confounder (DNMT3A, TET2, ASXL1)
    CTCs
      Prognosis
      Heterogeneity
    ...
    CHIP
      DNMT3A, TET2, ASXL1
      False Positive ctDNA
      WBC Sequencing Removes
    MCED
      Galleri (GRAIL)
      CancerSEEK, PanSeer
      Not Routine Screening
    ctDNA vs CTCs
      ctDNA: MRD, Resistance
      CTCs: Prognosis, Single-Cell
```
...
- Q: What is the definition of Cancer Screening & Prevention?
  A: Liquid Biopsy = Non-Invasive Tumour Analysis via Blood; ctDNA (Circulating Tumour DNA) for MRD, Resistance Monitoring, Early Detection; CTCs (Circulating Tumour Cells) for Prognosis; Clinical Utility: MRD (Post-Surgery/Adjuvant), Resistance Tracking (EGFR T790M, ESR1, KRAS), Tumour Fraction, TMB, MSI; CHIP Confounder; Multi-Cancer Early Detection (MCED) emerging.
- Q: What is CHIP (Clonal Haematopoiesis of Indeterminate Potential) of Cancer Screening & Prevention?
  A: Age-related somatic mutations in blood cells (DNMT3A, TET2, ASXL1, TET2, JAK2, TP53)
- Q: What is Frequency of Cancer Screening & Prevention?
  A: ~10% at 70yr, ~20% at 80yr
- Q: What is Confounding Effect of Cancer Screening & Prevention?
  A: CHIP mutations appear in cfDNA → False Positive Tumour Mutations
- Q: What is Key Genes of Cancer Screening & Prevention?
  A: DNMT3A, TET2, ASXL1, JAK2, TP53, PPM1D, SF3B1, SRSF2
- Q: What is Mitigation of Cancer Screening & Prevention?
  A: White Blood Cell Sequencing (Paired WBC-cfDNA), CHIP Panel Filtering
- Q: What is Clinical Impact of Cancer Screening & Prevention?
  A: False Positive "Tumour" Mutations → Incorrect Treatment Decisions
- Q: What is Concept of Cancer Screening & Prevention?
  A: Single Blood Test → Multiple Cancer Types
- Q: What is Key Technologies of Cancer Screening & Prevention?
  A: Methylation-Based (GRAIL Galleri), Fragmentomics, Combined ctDNA/Protein
- Q: What is Galleri (GRAIL) of Cancer Screening & Prevention?
  A: >50 Cancer Types, Sensitivity 50-70% (Stage I-III), Specificity 99.5%
- Q: What is Other Platforms of Cancer Screening & Prevention?
  A: CancerSEEK, PanSeer, Delfi, Singlera
- Q: What is Current Status of Cancer Screening & Prevention?
  A: Not Yet Routine Screening (NHS-Galleri Trial Ongoing)
- Q: What is Challenges of Cancer Screening & Prevention?
  A: Low Sensitivity Stage I, False Positives, Cost, Equity, Overtreatment
- Q: What is CHIP (Clonal Haematopoiesis of Indeterminate Potential) of Cancer Screening & Prevention?
  A: Age-related somatic mutations in blood cells (DNMT3A, TET2, ASXL1, TET2, JAK2, TP53)
- Q: What is Frequency of Cancer Screening & Prevention?
  A: ~10% at 70yr, ~20% at 80yr
...
- Q: What is Challenges of Cancer Screening & Prevention?
  A: Low Sensitivity Stage I, False Positives, Cost, Equity, Overtreatment
- Q: What is ctDNA vs CTCs of Cancer Screening & Prevention?
  A: ctDNA: DNA Fragments, High Sensitivity, MRD/Resistance; CTCs: Intact Cells, Prognosis
- Q: What is MRD (ctDNA) of Cancer Screening & Prevention?
  A: Post-Surgery/Adjuvant: MRD+ → High Relapse Risk, Guides Adjuvant/Intensification
- Q: What is Resistance Tracking of Cancer Screening & Prevention?
  A: EGFR T790M, ESR1, KRAS, ALK via ctDNA → Early Switch Therapy
- Q: What is Tumour Fraction of Cancer Screening & Prevention?
  A: % ctDNA in cfDNA → Prognostic, MRD, Response Assessment
- Q: What is CHIP of Cancer Screening & Prevention?
  A: Clonal Haematopoiesis (DNMT3A, TET2, ASXL1) → False Positive ctDNA Mutations
- Q: What is MCED of Cancer Screening & Prevention?
  A: Galleri (GRAIL), CancerSEEK, PanSeer — Not Yet Routine Screening

## MCQs (1 generated)

1. **Which of the following best describes Cancer Screening & Prevention?**
   A. **Liquid Biopsy = Non-Invasive Tumour Analysis via Blood; ctDNA (Circulating Tumour DNA) for MRD, Resistance Monitoring, Early Detection; CTCs (Circulating Tumour Cells) for Prognosis; Clinical Utility:**
...
1. A patient with suspected Cancer Screening & Prevention presents with: Setting — ctDNA Utility; Post-Surgery (Adjuvant) — MRD+ → High Relapse Risk → Intensify/Adjuvant Therapy; Post-Adjuvant Therapy — MRD+ → High Relapse Risk → Consider Intensification. What is the most likely diagnosis?
   A. **Cancer Screening & Prevention**
   B. A condition that mimics Cancer Screening & Prevention but is not the same entity
   C. A complication of Cancer Screening & Prevention rather than the primary diagnosis
   D. An unrelated condition in the same clinical category as Cancer Screening & Prevention

## PasTest Scenario SBAs (Clinical Vignettes)

> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Liquid Biopsy*

**Q1.** Which of the following features is most specific or characteristic of Liquid Biopsy?

  - **A.** MCED vs Standard Screening
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — MCED vs Standard Screening
  >
  > *Source:* Stage** | **Stage I: 40-50%**, **Stage II: 60-70%**, **Stage III: 70-80%**, **Stage IV: >90%** |
| **MCED vs Standard Screening** | **MCED: Multi-Cancer, Single Blood Test**; **Standard: Organ-Specifi
