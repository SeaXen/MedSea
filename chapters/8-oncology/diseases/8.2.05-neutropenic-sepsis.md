...
## 2. 2. Definition & Diagnostic Criteria
...
## 3. 3. MASCC Risk Index (Multinational Association for Supportive Care in Cancer)
...
## 4. 4. Empiric Antibiotic Therapy

### 1. High Risk (MASCC <21) — IV Inpatient
...
### 2. Add-On Vancomycin (15-20mg/kg IV q12h) — If ANY:
...
### 3. Low Risk (MASCC ≥21) — Oral Outpatient
...
## 5. 5. Antifungal Therapy

### 1. Prophylaxis (Primary)
...
### 2. Empiric Therapy (Persistent Fever >4-7 Days)
...
### 3. Targeted Therapy (Documented Infection)
...
## 6. 6. G-CSF Prophylaxis (Granulocyte Colony-Stimulating Factor)
...
## 7. 7. Supportive Care & Monitoring
...
## 8. 8. Source Control & Line Management
...
```mermaid
mindmap
  root((Neutropenic Sepsis))
    Definition
      Fever ≥38.3°C / ANC <0.5
      Time = Critical (Abx <1h)
    MASCC Score
      ≥21 Low Risk → Oral Cipro + Augmentin
      <21 High Risk → IV Pip-Tazo/Meropenem
    Empiric Abx
      High Risk: Pip-Tazo 4.5g q6h / Mero 1g q8h
      Vancomycin Add: Hypotension, Catheter, Skin, MRSA
      Low Risk: Cipro + Augmentin Oral
    Antifungal
      Prophylaxis: Fluconazole / Posaconazole (High Risk)
      Empiric >4-7d: Caspofungin / Voriconazole
    G-CSF
      Primary: Risk >20% (Dose-Dense, Age>65, Prior FN)
      Secondary: Prior FN
      Pegfilgrastim 6mg Day 2
    Source Control
      Line Removal >48-72h Fever
      Drain Abscess
      Remove Cannula
    Supportive
      ...
      Low Microbial Diet
    Septic Shock
      Fluids 30mL/kg → Norad → Abx + Line Removal
      Lactate, ScvO2, Hydrocortisone
```
...
- Q: What is Fever of Oncologic Emergencies?
  A: ≥38.3°C (Single Reading) OR ≥38.0°C Sustained >1 Hour
- Q: What is Neutropenia of Oncologic Emergencies?
  A: ANC <0.5 ×10⁹/L OR <1.0 ×10⁹/L Predicted to Fall to <0.5
- Q: What is ANC Calculation of Oncologic Emergencies?
  A: WBC × (% Neutrophils + % Bands) / 100
- Q: What is Primary Prophylaxis of Oncologic Emergencies?
  A: FN Risk >20% (e.g., Dose-Dense Chemo, Age >65, Comorbidities, Prior FN, Extensive Disease)
- Q: What is Secondary Prophylaxis of Oncologic Emergencies?
  A: Prior Episode of FN (Any Cycle)
- Q: What is Agent of Oncologic Emergencies?
  A: Filgrastim 5mcg/kg SC Daily (Until ANC >10 ×10⁹/L Post-Nadir) OR Pegfilgrastim 6mg SC Single Dose (Day 2 Post-Chemo)
- Q: What is Oncologic Emergencies indicated for?
  A: Concurrent Chemo/Radiotherapy (Theoretical Tumour Stimulation) — Start 24-72h Post-Chemo
- Q: What is Temperature of Oncologic Emergencies?
  A: q4-6h (Continuous if Septic)
- Q: What is Haemodynamics of Oncologic Emergencies?
  A: BP, HR q1-2h (Unstable: Continuous)
- Q: What is Bloods of Oncologic Emergencies?
  A: CBC (Daily), CRP, U&E, LFTs, Coagulation, Lactate (q6-12h if Unstable)
- Q: What is Microbiology of Oncologic Emergencies?
  A: Blood Cultures ×2 Sets (Peripheral + Line) PRE-Antibiotics, Urine, Sputum, Wound Swabs, Stool
- Q: What is Chest X-ray of Oncologic Emergencies?
  A: Daily if Pneumonia Suspected
- Q: What is Line Sites of Oncologic Emergencies?
  A: Daily Inspection (Phlebitis, Purulence)
- Q: What is Primary Prophylaxis of Oncologic Emergencies?
  A: FN Risk >20% (e.g., Dose-Dense Chemo, Age >65, Comorbidities, Prior FN, Extensive Disease)
- Q: What is Secondary Prophylaxis of Oncologic Emergencies?
  A: Prior Episode of FN (Any Cycle)
...
- Q: What is the definition of Oncologic Emergencies?
  A: Fever ≥38.3°C (Single) / ≥38.0°C >1h + ANC <0.5 (or <1.0 Predicted)
- Q: What is MASCC Score of Oncologic Emergencies?
  A: ≥21 = Low Risk (Oral Outpatient); <21 = High Risk (IV Inpatient)
- Q: What is Empiric IV of Oncologic Emergencies?
  A: Piperacillin-Tazobactam 4.5g q6h OR Meropenem 1g q8h (Monotherapy)
- Q: What is Vancomycin Add of Oncologic Emergencies?
  A: Hypotension, Catheter, Skin/Soft Tissue, MRSA, Severe Mucositis
- Q: What is G-CSF Prophylaxis of Oncologic Emergencies?
  A: Risk >20% (Dose-Dense, Age>65, Prior FN) → Pegfilgrastim 6mg Day 2
- Q: What is Antifungal of Oncologic Emergencies?
  A: >4-7d Fever → Caspofungin 70/50mg; Moulds → Voriconazole/Liposomal AmB
- Q: What is Line Removal of Oncologic Emergencies?
  A: Persistent Fever >48-72h → Remove & Culture Tip
- Q: What is Isolation of Oncologic Emergencies?
  A: Protective (Positive Pressure), Hand Hygiene, Low Microbial Diet
- Q: What is Septic Shock of Oncologic Emergencies?
  A: Fluids 30mL/kg → Norepinephrine → Broad Abx + Line Removal within 1h

## MCQs (1 generated)

1. **Which of the following best describes Oncologic Emergencies?**
   A. **> Neutropenic Sepsis = Oncologic Emergency; Definition: Fever ≥38.3°C (Single) or ≥38.0°C Sustained >1h AND ANC <0.5×10⁹/L (or <1.0 Predicted to Fall); MASCC Score ≥21 = Low Risk (Oral Outpatient), <2**
...
1. A patient with suspected Oncologic Emergencies presents with: Fever — ≥38.3°C (Single Reading) OR ≥38.0°C Sustained >1 Hour; Neutropenia — ANC <0.5 ×10⁹/L OR <1.0 ×10⁹/L Predicted to Fall to <0.5; ANC Calculation — WBC × (% Neutrophils + % Bands) / 100. What is the most likely diagnosis?
