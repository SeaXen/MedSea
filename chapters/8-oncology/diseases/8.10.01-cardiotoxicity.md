...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Cardiotoxicity*

**Q1.** What is the most appropriate first-line therapy for Cardiotoxicity?

  - **A.** Recovers to Normal + Consider Restarting Cancer Therapy
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Recovers to Normal + Consider Restarting Cancer Therapy
  >
  > *Source:* E --> **Recovers to Normal**  F[**Consider Restarting Cancer Therapy** (With Cardio-Oncology Input)]
