...
### 2. Lymphoma: International Prognostic Index (IPI) / FLIPI
...
### 1. DIPSS / DIPSS-plus (Primary Myelofibrosis)
...
## 5. 5. Germ Cell Tumours

### 1. IGCCCG Risk Groups (Metastatic)
...
## 9. 9. Key Molecular Biomarkers

### 1. ESCAT Classification (Actionability)
...
```mermaid
mindmap
  root((Prognostic Indices & Biomarkers))
    Prognostic Indices
      Breast: NPI (Size + Grade + Nodes)
      Lymphoma: IPI / FLIPI
      Myeloma: R-ISS (ISS + Cytogenetics + LDH)
      MPN: DIPSS / DIPSS-plus
      RCC: IMDC
      GCT: IGCCCG
      HCC: BCLC / Child-Pugh
    Biomarker Types
      Predictive (Tx Selection)
      Prognostic (Outcome)
      Monitoring (Response)
    ESCAT
      I: Routine (EGFR, ALK, BRAF, HER2, BRCA, NTRK, MSI-H)
      II: Trial (KRAS G12C, RET, METex14, FGFR)
      III: Preclinical
      IV: Benign
    Key Biomarkers
      ER/PR/HER2, EGFR, ALK, ROS1, BRAF, KRAS, NTRK
      BRCA1/2, MSI-H/dMMR, PD-L1, TMB
      ESR1, PIK3CA, FGFR, RET, MET
    Liquid Biopsy
      ctDNA: MRD, Resistance, TMB, MSI
      CTCs: Prognosis, Heterogeneity
      CHIP Confounder
    Applications
      Treatment Selection
      Prognostication
...
- Q: What is the definition of Principles of Cancer Management?
  A: Prognostic Indices: Standardised tools combining clinical, pathological, and molecular features; Key Indices: NPI (Breast), IPI/FLIPI (Lymphoma), DIPSS/DIPSS-plus (MPN), IMDC (RCC), IGCCCG (GCT), ISS/R-ISS (Myeloma), Child-Pugh/BCLC (HCC); Biomarkers: Predictive (Treatment Selection), Prognostic (Outcome), Monitoring (Response); Clinical Utility: Treatment Selection, Trial Eligibility, Surveillanc

## MCQs (1 generated)

1. **Which of the following best describes Principles of Cancer Management?**
   A. **Prognostic Indices: Standardised tools combining clinical, pathological, and molecular features; Key Indices: NPI (Breast), IPI/FLIPI (Lymphoma), DIPSS/DIPSS-plus (MPN), IMDC (RCC), IGCCCG (GCT), ISS/**
...
1. A patient with suspected Principles of Cancer Management presents with: Application — Biomarkers Used; Treatment Selection — ER/PR/HER2, EGFR, ALK, ROS1, BRAF, KRAS, BRCA, MSI, PD-L1, TMB; Prognostication — Stage, Grade, NPI, IPI, R-ISS, IMDC, Cytogenetics, Gene Signatures (Oncotype DX, MammaPrint). What is the most likely diagnosis?
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Prognostic Indices & Biomarkers*

**Q1.** Which of the following features is most specific or characteristic of Prognostic Indices & Biomarkers?

  - **A.** Predictive vs Prognostic
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — Predictive vs Prognostic
  >
  > *Source:* ors** | Genomic Scarring Score |

---
| Confusion | Clarification |
|-----------|---------------|
| **Predictive vs Prognostic** | **Predictive**: Predicts **response to specific therapy**; **Prognost
