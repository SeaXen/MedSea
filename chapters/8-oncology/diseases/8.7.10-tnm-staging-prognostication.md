...
- Q: What is the definition of Principles of Cancer Management?
  A: TNM 8th Edition (AJCC/UICC): T = Primary Tumour (Size, Extension), N = Regional Lymph Nodes, M = Distant Metastasis; Stage Grouping: 0, I, II, III, IV (A/B/C Substages); Prognostic Factors: Grade (Differentiation), LVI, PNI, Margins, Biomarkers, Molecular Subtypes; Site-Specific Staging for Breast, Lung, Colorectal, Gastric, Gynae, H&N, GU, Sarcoma, CNS; Prognostic Models: NPI (Breast), IPI (Lymph
- Q: What is TNM 8th of Principles of Cancer Management?
  A: T (Tumour), N (Nodes), M (Mets); Stage 0-IV; Substages A/B/C
- Q: What is Prognostic Factors of Principles of Cancer Management?
  A: Grade, LVI, PNI, Margins (R0/R1/R2), Biomarkers, Molecular Subtypes, PS
- Q: What is Breast NPI of Principles of Cancer Management?
  A: Size + Grade + Nodes → 4 Risk Groups
- Q: What is Lymphoma IPI of Principles of Cancer Management?
  A: Age>60, Stage III/IV, LDH↑, PS≥2, Extranodal>1 → 4 Groups
- Q: What is Myeloma R-ISS of Principles of Cancer Management?
  A: ISS + Cytogenetics (del17p, t4;14, t14;16) + LDH
- Q: What is PMF DIPSS of Principles of Cancer Management?
  A: Age>65, Hb<10, WBC>25, Blasts≥1%, Symptoms → DIPSS-plus adds Plt, Transfusion, Karyotype
- Q: What is RCC IMDC of Principles of Cancer Management?
  A: KPS<80, <1yr Dx-Tx, Hb↓, Ca↑, NLR>3, Plt↑ → Fav/Int/Poor
- Q: What is GCT IGCCCG of Principles of Cancer Management?
  A: Seminoma: Good/Int only; NSGCT: Good/Int/Poor (Mediastinal = Poor)
- Q: What is Breast of Principles of Cancer Management?
  A: ER/PR/HER2, Grade, Nodes, Size, LVI, Oncotype
- Q: What is CRC of Principles of Cancer Management?
  A: MSI/MMR, KRAS/NRAS/BRAF, LVI, PNI, CEA
- Q: What is HCC of Principles of Cancer Management?
  A: BCLC, Child-Pugh, AFP, Vascular Invasion

## MCQs (1 generated)

1. **Which of the following best describes Principles of Cancer Management?**
   A. **TNM 8th Edition (AJCC/UICC): T = Primary Tumour (Size, Extension), N = Regional Lymph Nodes, M = Distant Metastasis; Stage Grouping: 0, I, II, III, IV (A/B/C Substages); Prognostic Factors: Grade (Dif**
...
1. A patient with suspected Principles of Cancer Management presents with: T Category — General Definition; Tx — Primary tumour cannot be assessed; T0 — No evidence of primary tumour. What is the most likely diagnosis?
