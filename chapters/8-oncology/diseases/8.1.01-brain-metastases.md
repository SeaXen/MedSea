...
## 5. 5. Prognostic Indices

### 1. RPA (Recursive Partitioning Analysis) — Gastrin 1997
...
### 2. GPA (Graded Prognostic Assessment) — Sperduto 2008
...
### 3. Disease-Specific GPA (DS-GPA) — Sperduto 2017
...
### 1. Local Therapy Decision Algorithm

```mermaid
flowchart TD
    A[Brain Metastases] --> B{Number / Size / Location / KPS}
    B -->|**1-3 Mets, ≤3cm, KPS ≥70**| C[**SRS (Stereotactic Radiosurgery)** — **Standard**
**JROSG/NCCTG: SRS Alone Non-Inferior to SRS+WBRT**
**Less Neurocognitive Decline**]
    B -->|**>3 Mets OR >3cm OR Critical Location**| D[**WBRT (Whole Brain RT)**
**30Gy/10fx OR 20Gy/5fx**
**Hippocampal Avoidance (HA-WBRT) + Memantine**]
    B -->|**Solitary, >3cm, Symptomatic, Accessible, Diagnostic Uncertainty**| E[**Surgery + SRS to Cavity**
**Patchell: Surgery+WBRT > WBRT Alone**
**Modern: Surgery + Cavity SRS (No WBRT)**]
    C --> F[**Surveillance MRI q3mo ×1yr, q6mo ×2yr**]
    D --> F
    E --> F
```

### 2. SRS vs WBRT — Key Trials
...
### 3. Hippocampal-Avoidance WBRT + Memantine
...
## 8. 8. Molecular-Driven Systemic Therapy (Blood-Brain Barrier Penetration)

### 1. NSCLC with Brain Mets
...
## 10. 10. Radionecrosis vs Progression
...
- Q: What is the definition of CNS Tumours?
  A: Brain Metastases = Most Common CNS Malignancy (10x Primary); Sources: Lung (50%), Breast (15-20%), Melanoma (10%), RCC, GI; 1-3 Mets: SRS Standard (JROSG, NCCTG); >3 Mets: WBRT OR SRS (JROSG-99); Surgery for Solitary/Symptomatic/Accessible; Molecular-Driven Systemic Therapy: Lung EGFR/ALK (Osimertinib, Lorlatinib); Breast HER2+ (T-DXd, Tucatinib+Capecitabine+Trastuzumab); Melanoma (Ipi+Nivo, Pembr
- Q: What is Headache of CNS Tumours?
  A: Most Common (50%); Morning, Valsalva-Aggravated (Raised ICP)
- Q: What is Seizures of CNS Tumours?
  A: 15-25% (Focal > Generalised)
- Q: What is Focal Neurological Deficits of CNS Tumours?
  A: Hemiparesis, Aphasia, Visual Field, Ataxia, Cranial Nerve Palsies
- Q: What is Cognitive/Behavioural of CNS Tumours?
  A: Personality Change, Memory, Executive Dysfunction
- Q: What are the clinical features of CNS Tumours?
  A: Incidental on Staging Imaging (10-20%)
- Q: What is Ipilimumab + Nivolumab of CNS Tumours?
  A: CheckMate 204: Intracranial ORR 46-57%, Durable
- Q: What is Pembrolizumab of CNS Tumours?
  A: KEYNOTE-022: Intracranial ORR 22%
- Q: What is Dabrafenib + Trametinib (BRAF V600E) of CNS Tumours?
  A: COMBI-MB: Intracranial ORR 58%
- Q: What is Ipilimumab + Nivolumab of CNS Tumours?
  A: CheckMate 204: Intracranial ORR 46-57%, Durable
- Q: What is Pembrolizumab of CNS Tumours?
  A: KEYNOTE-022: Intracranial ORR 22%
...
- Q: What is the epidemiology of CNS Tumours?
  A: Most Common CNS Malignancy; Lung 50%, Breast 15-20%, Melanoma 10%, RCC, GI
- Q: What is SRS vs WBRT of CNS Tumours?
  A: 1-3 Mets: SRS Standard (Equiv OS, Less Cognitive Decline); >3 Mets: WBRT or SRS (JROSG-99)
- Q: What is Surgery of CNS Tumours?
  A: Solitary, Symptomatic, Accessible, >3cm, Diagnostic Uncertainty → Cavity SRS Post-Op
- Q: What is WBRT of CNS Tumours?
  A: 30Gy/10fx or 20Gy/5fx; HA-WBRT + Memantine Preserves Memory
- Q: What is Lung EGFR/ALK of CNS Tumours?
  A: Osimertinib, Lorlatinib, Alectinib, Brigatinib — High CNS Penetration
- Q: What is Breast HER2+ of CNS Tumours?
  A: Tucatinib + Cape + Tras (HER2CLIMB), T-DXd
- Q: What is Melanoma of CNS Tumours?
  A: Ipi+Nivo (CheckMate 204), Pembro, Dab/Tram (BRAF)
- Q: What is Dexamethasone of CNS Tumours?
  A: Vasogenic Oedema; Taper Over 1-2wk
- Q: What is VTE Prophylaxis of CNS Tumours?
  A: LMWH (High Risk)
- Q: What is the prognosis of CNS Tumours?
  A: RPA/GPA/DS-GPA; Lung EGFR/ALK Best; Melanoma ICI Best

## MCQs (1 generated)

1. **Which of the following best describes CNS Tumours?**
   A. **Brain Metastases = Most Common CNS Malignancy (10x Primary); Sources: Lung (50%), Breast (15-20%), Melanoma (10%), RCC, GI; 1-3 Mets: SRS Standard (JROSG, NCCTG); >3 Mets: WBRT OR SRS (JROSG-99); Surg**
...
1. A patient with suspected CNS Tumours presents with: Definition — Secondary malignant deposits in brain parenchyma; Haematogenous Spread (Grey-White Junction); Incidence — 10x Primary Brain Tumours; ~100,000-170,000/year US; 20-40% of Cancer Patients; Sources — Lung (50%), Breast (15-20%), Melanoma (10%), RCC (5%), GI (5%), Unknown Primary (5%). What is the most likely diagnosis?
   A. **CNS Tumours**
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Brain Metastases*

**Q1.** What is the most appropriate first-line therapy for Brain Metastases?

  - **A.** QUARTZ + WBRT + Dex vs Dex Alone + No OS/QOL Benefit for WBRT
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — QUARTZ + WBRT + Dex vs Dex Alone + No OS/QOL Benefit for WBRT
  >
  > *Source:* **QUARTZ (NSCLC, Unfit)**   **WBRT + Dex vs Dex Alone**   **No OS/QOL Benefit for WBRT**  
