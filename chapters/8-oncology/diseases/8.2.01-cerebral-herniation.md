...
## 2. 2. Types of Cerebral Herniation
...
## 3. 3. Pathophysiology & Progression

```mermaid
flowchart LR
    A[Raised ICP] --> B[Compensatory Mechanisms]
    B --> B1[CSF Displacement]
    B --> B2[Venous Compression]
    B --> B3[Tissue Compression]
    B1 --> C[Decompensation]
    B2 --> C
    B3 --> C
    C --> D[**Herniation**]
    D --> D1[Subfalcine]
    D1 --> D2[Uncal/Transtentorial]
    D2 --> D3[Central]
    D3 --> D4[Tonsillar]
    D4 --> D5[Brainstem Compression → Death]
```
...
## 4. 4. Clinical Features by Herniation Type
...
### 2. Central (Trans-tentorial) Herniation
| Sign | Pathophysiology |
|------|----------------|
...
### 3. Tonsillar (Cerebellar) Herniation
| Sign | Pathophysiology |
|------|----------------|
...
## 5. 5. Cushing's Triad — The Herald of Herniation
...
## 6. 6. Emergency Management Algorithm
...
## 7. 7. Immediate Management (First 5 Minutes)
...
## 8. 8. Definitive Neurosurgical Interventions
...
```mermaid
mindmap
  root((Cerebral Herniation))
    Types
      Subfalcine (Cingulate)
      Uncal/Transtentorial (Common)
      Central (Trans-tentorial)
      Tonsillar (Cerebellar)
      Upward (Trans-foraminal)
    Uncal
      Ipsilateral CN III Palsy (Fixed Dilated Pupil)
...
- Q: What is the definition of Oncologic Emergencies?
  A: Cerebral Herniation = Life-Threatening Complication of Raised ICP; Types: Subfalcine (Cingulate), Uncal/Transtentorial, Central (Trans-tentorial), Tonsillar (Cerebellar), Upward (Trans-foraminal); Cushing's Triad (Hypertension, Bradycardia, Irregular Breathing) = Impending Herniation; Management: Hyperventilation, Mannitol/Hypertonic Saline, Dexamethasone, Emergent Neurosurgery (Decompressive Cran
- Q: What is Bilateral Fixed Dilated Pupils of Oncologic Emergencies?
  A: Bilateral CN III Compression
- Q: What is Coma (GCS <8) of Oncologic Emergencies?
  A: Bilateral Cerebral Hemisphere Compression
- Q: What is Decerebrate Posturing of Oncologic Emergencies?
  A: Midbrain/Upper Pons Compression
- Q: What is Apnoea / Respiratory Arrest of Oncologic Emergencies?
  A: Medullary Compression (Respiratory Centres)
- Q: What is Bradycardia + Hypertension of Oncologic Emergencies?
  A: Cushing's Reflex (Medullary Compression)
- Q: What is Flaccid Quadriparesis of Oncologic Emergencies?
  A: Corticospinal Tract Compression at Medulla
- Q: What is Ipsilateral Fixed Dilated Pupil of Oncologic Emergencies?
  A: CN III Compression (Parasympathetic Fibres Peripheral)
- Q: What is Contralateral Hemiparesis of Oncologic Emergencies?
  A: Crus Cerebri Compression (Corticospinal Tract)
- Q: What is Contralateral Hemianopia of Oncologic Emergencies?
  A: PCA Compression (Posterior Cerebral Artery)
- Q: What is Bilateral Fixed Dilated Pupils of Oncologic Emergencies?
  A: Bilateral CN III Compression
- Q: What is Coma (GCS <8) of Oncologic Emergencies?
  A: Bilateral Cerebral Hemisphere Compression
...
- Q: What is Flaccid Quadriparesis of Oncologic Emergencies?
  A: Corticospinal Tract Compression at Medulla
- Q: How is Oncologic Emergencies classified?
  A: Subfalcine, Uncal (Most Common), Central, Tonsillar, Upward
- Q: What is Uncal Herniation of Oncologic Emergencies?
  A: Ipsilateral Fixed Dilated Pupil, Contralateral Hemiparesis, Contralateral CN III Palsy
- Q: What is Central Herniation of Oncologic Emergencies?
  A: Bilateral Fixed Dilated Pupils, Coma, Decerebrate Posturing
- Q: What is Tonsillar Herniation of Oncologic Emergencies?
  A: Respiratory Arrest, Bradycardia, Hypertension, Cushing's Triad
- Q: What is Cushing's Triad of Oncologic Emergencies?
  A: Hypertension + Bradycardia + Irregular Breathing = Impending Herniation
- Q: How is Oncologic Emergencies managed?
  A: Hyperventilation (PaCO2 30-35) → Mannitol 0.5-1g/kg → Dexamethasone 16mg IV → Neurosurgery
- Q: What is Time-Critical of Oncologic Emergencies?
  A: Minutes Matter — Herniation → Death in Minutes if Untreated
- Q: What is Neurosurgical Options of Oncologic Emergencies?
  A: EVD (Hydrocephalus), Decompressive Craniectomy (Malignant Oedema), Resection (Tumour)

## MCQs (1 generated)

1. **Which of the following best describes Oncologic Emergencies?**
   A. **Cerebral Herniation = Life-Threatening Complication of Raised ICP; Types: Subfalcine (Cingulate), Uncal/Transtentorial, Central (Trans-tentorial), Tonsillar (Cerebellar), Upward (Trans-foraminal); Cus**
...
1. A patient with suspected Oncologic Emergencies presents with: Ipsilateral Fixed Dilated Pupil — CN III Compression (Parasympathetic Fibres Peripheral); Contralateral Hemiparesis — Crus Cerebri Compression (Corticospinal Tract); Contralateral Hemianopia — PCA Compression (Posterior Cerebral Artery). What is the most likely diagnosis?
