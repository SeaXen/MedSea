...
### 1. Key Mutations & Prognostic Impact
...
## 5. 5. Classification (WHO 2022 / ICC 2022)
...
| **MDS, morphologically defined** | **MDS with low blasts (MDS-LB)**: <5% BM blasts, <2% PB blasts
**MDS, hypoplastic (MDS-h)**: Hypocellular BM (<25% cellularity)
**MDS with increased blasts (MDS-IB)**: **MDS-IB1** (5-9% BM or 2-4% PB); **MDS-IB2** (10-19% BM or 5-19% PB) |
...
### 2. ICC 2022 (Similar but nuanced)
...
### 1. IPSS-R (Revised International Prognostic Scoring System)

| Variable | Categories & Points |
|----------|---------------------|
| **Cytogenetics** | Very Good (0): -Y, del(11q)
Good (1): Normal, del(5q), del(12p), del(20q), double incl. del(5q)
Intermediate (2): del(7q), +8, +19, i(17q), other
Poor (3): -7, inv(3)/t(3q)/del(3q), double incl. -7/del(7q), complex (3 abn)
Very Poor (4): Complex (>3 abn) |
...
### 2. IPSS-M (Molecular IPSS) — **Adds Mutations**
...
### 1. Lower-Risk MDS (IPSS-R Very Low/Low/Intermediate)

```mermaid
flowchart TD
    A[Lower-Risk MDS] --> B{Transfusion Dependent?}
    B -->|**Anaemia, Non-transfusion dep**| C[**ESA (Epoetin alfa/beta, Darbepoetin)**
**Predictors of Response**: Serum EPO <200-500 mU/mL, No/low transfusion burden, Non-del(5q)
**Dose**: Epoetin 40-60k IU SC q1-2wk; Darbepoetin 500mcg q3-4wk
**Response**: Hb ↑≥1.5g/dL or ↓transfusion by ≥4 units/8wk]
    B -->|**Transfusion Dependent Anaemia**| D{SF3B1 mut / Ring Sideroblasts?}
    D -->|**Yes (MDS-RS)**| E[**Luspatercept** (MEDALIST)
Activin Receptor Ligand Trap → ↓SMAD2/3 → ↑Erythropoiesis
**1.0-1.75mg/kg SC q3wk**
**TI response (≥8wk transfusion independence) ~38-45%**
**Preferred over ESA if RS+ & ESA-refractory**]
    D -->|**No (or ESA failure)**| F[**Imetelstat** (IMerge) — **Telomerase Inhibitor**
**MDS-RS, Transfusion-dependent, ESA-refractory**
9.4mg/kg IV q4wk
**TI response ~40%**]
    B -->|**Isolated del(5q)**| G[**Lenalidomide**
**10mg/day (21/28 days)**
**Transfusion Independence ~67%**
**Contraindicated if TP53 mut**]
    B -->|**Thrombocytopenia**| H[**Romiplostim / Eltrombopag** (TPO-RA)
If severe/refractory; Monitor BM blasts]
```

### 2. Higher-Risk MDS (IPSS-R High/Very High / IPSS-M High/Very High)

```mermaid
flowchart TD
    A[Higher-Risk MDS] --> B{Transplant Candidate?
(Age <70-75, HCT-CI ≤3, Donor)}
    B -->|**Yes**| C[**HMA Bridging → Allo-HSCT**
**Azacitidine 75mg/m² SC/IV d1-7 q4wk** (or Decitabine 20mg/m² IV d1-5)
**4-6 cycles** before HSCT
**TP53 mut: Aza + Venetoclax** (Phase 2/3) preferred bridge]
    B -->|**No / Unfit**| D[**HMA Monotherapy**
**Azacitidine** (AZA-001: OS benefit vs BSC)
**Decitabine** (alternative, IV only)
**Response**: CR/PR/mCR/HI (IWG criteria)
**Median cycles to response: 4-6**]
    D --> D1[**TP53 mut MDS**
**Azacitidine + Venetoclax**
**CR rate ~50-60%** (vs ~20% Aza alone)
**Pending regulatory approval**]
    D --> D2[**Maintenance**: Continue HMA until progression/toxicity
**Dose reduction**: 50mg/d1-5 if cytopenias]
```
...
flowchart TD
    ...
    B -->|**Low Risk**
CPSS Low/Int-1| C[**Watch & Wait** / Supportive Care
Transfusions, Growth factors, Hydroxyurea if WBC>20-50×10⁹/L]
    B -->|**High Risk**
CPSS Int-2/High| D[**Higher-Risk MDS Approach**]
    D --> D1[**Azacitidine** (preferred over Decitabine)
**Efficacy similar to MDS**]
    D1 --> D2[**Transplant Candidate?**]
    D2 -->|Yes| E[**Allo-HSCT** (Curative)
**Reduced Intensity Conditioning (RIC)**
FLU/MEL or FLU/BU2]
    D2 -->|No| F[**Continue HMA**
Clinical Trials (JAK2, BET, etc.)]
```

### 4. Allo-HSCT in MDS/CMML
...
- Q: What is the definition of Haematological Malignancies?
  A: Clonal haematopoietic stem cell disorder; Ineffective haematopoiesis → Cytopenias + Morphological dysplasia (≥10% in ≥1 lineage) + AML transformation risk
- Q: What is the epidemiology of Haematological Malignancies?
  A: UK: ~2,500/year; Median age 70-75; M:F = 1.5:1
- Q: What causes Haematological Malignancies?
  A: Age, Prior chemo/RT (t-MDS), Benzene, Smoking, Genetic predisposition (GATA2, RUNX1, CEBPA, DDX41, ETV6, ANKRD26, SAMD9/9L)
- Q: What is Higher-Risk MDS (IPSS-R Int/High/Very High) of Haematological Malignancies?
  A: Curative; Best if CR/PR pre-HSCT
- Q: What are the side effects of Haematological Malignancies?
  A: TP53 mut, Complex karyotype, Transfusion dependence refractory to therapy
- Q: What is CMML of Haematological Malignancies?
  A: CPSS Int-2/High; CPSS-Mol High (ASXL1/SRSF2 mut)
- Q: What is Donor of Haematological Malignancies?
  A: Matched Sibling > MUD > Haploidentical > Cord
- Q: What is Conditioning of Haematological Malignancies?
  A: RIC (FLU/MEL, FLU/BU2) preferred for age >55-60 / HCT-CI >3; MAC for young, fit, high-risk
- Q: What is TP53 mut of Haematological Malignancies?
  A: Allo-HSCT only potentially curative; High relapse risk post-HSCT; Consider Post-HSCT maintenance (Aza/Venetoclax)
- Q: What is Higher-Risk MDS (IPSS-R Int/High/Very High) of Haematological Malignancies?
  A: Curative; Best if CR/PR pre-HSCT
- Q: What are the side effects of Haematological Malignancies?
  A: TP53 mut, Complex karyotype, Transfusion dependence refractory to therapy
...
- Q: What is Conditioning of Haematological Malignancies?
  A: RIC (FLU/MEL, FLU/BU2) preferred for age >55-60 / HCT-CI >3; MAC for young, fit, high-risk
- Q: What is the definition of Haematological Malignancies?
  A: Dysplasia ≥10% in ≥1 lineage + Cytopenia(s) + Clonal (cytogenetics/mutation) + Exclude other causes
- Q: What is WHO 2022 Key Categories of Haematological Malignancies?
  A: MDS with defining genetic abn: del(5q), SF3B1, TP53; MDS-LB (<5% blasts); MDS-IB1/IB2 (5-19% blasts); MDS-h
- Q: What is MDS-RS of Haematological Malignancies?
  A: SF3B1 mut + RS ≥15% (or ≥5% if SF3B1 mut); Favourable if isolated
- Q: What is del(5q) MDS of Haematological Malignancies?
  A: Isolated del(5q) → Lenalidomide 10mg (TI ~67%); Contraindicated if TP53 mut
- Q: What is TP53 MDS of Haematological Malignancies?
  A: Very Poor; Complex karyotype; Aza + Venetoclax preferred; Allo-HSCT only cure
- Q: What is IPSS-R vs IPSS-M of Haematological Malignancies?
  A: IPSS-M adds mutations (TP53, SF3B1, ASXL1, RUNX1, VAF) → Better risk discrimination
- Q: What is Lower-Risk Rx of Haematological Malignancies?
  A: ESA (sEPO<200-500) → Luspatercept (RS+, ESA-refractory) → Lenalidomide (del(5q)) → Imetelstat (RS+, TD)
- Q: What is Higher-Risk Rx of Haematological Malignancies?
  A: HMA (Aza/Decitabine) → Allo-HSCT (curative); TP53: Aza + Ven
- Q: What is CMML of Haematological Malignancies?
  A: Monocytosis ≥1×10⁹/L persistent; No BCR-ABL1/PDGFR/JAK2; ASXL1, TET2, SRSF2, RUNX1; CPSS-Mol for risk
- Q: What is Luspatercept of Haematological Malignancies?
  A: Activin receptor trap → ↓SMAD2/3 → ↑Erythropoiesis; MEDALIST: MDS-RS, TD, ESA-refractory
- Q: What is Imetelstat of Haematological Malignancies?
  A: Telomerase inhibitor; IMERGE: MDS-RS, TD, ESA-refractory
- Q: What is Allo-HSCT of Haematological Malignancies?
  A: Curative for Higher-Risk; RIC preferred; TP53 = high relapse post-HSCT

## MCQs (1 generated)

1. **Which of the following best describes Haematological Malignancies?**
   A. **MDS = Clonal haematopoietic stem cell disorder; Dysplasia + Cytopenias + Risk of AML transformation.**
...
1. A patient with suspected Haematological Malignancies presents with: MDS Definition — Clonal haematopoietic stem cell disorder; Ineffective haematopoiesis → Cytopenias + Morphological dysplasia (≥10% in ≥1 lineage) + AML transformation risk; MDS Incidence — UK: ~2,500/year; Median age 70-75; M:F = 1.5:1; CMML Definition — MDS/MPN Overlap; Persistent Monocytosis ≥1×10⁹/L + Dysplasia + No BCR-ABL1/PCM1-JAK2/PDGFRA/B/FGFR1 rearrangement. What is the most likely diagnosis?
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 8: Oncology — Myelodysplastic Syndromes (MDS) & CMML*

**Q1.** What is the most appropriate first-line therapy for Myelodysplastic Syndromes (MDS) & CMML?
  ...
  > **Answer: A** — Continue HMA
  >
  > *Source:* D2 --> No  F[**Continue HMA**<br/>Clinical Trials (JAK2, BET, etc.)]
```
