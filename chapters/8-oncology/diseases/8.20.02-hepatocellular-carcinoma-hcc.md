...
### 1. BCLC Staging & Treatment Algorithm
...
flowchart TD
    ...
    C --> C1[**Resection**
Child-Pugh A, preserved portal flow,
future liver remnant >40% (30% if healthy)]
    C --> C2[**Ablation: RFA/MWA**
≤3cm, ≤3 nodules,
peripheral, no major vessels]
    C --> C3[**Liver Transplant**
Milan criteria, Child-Pugh B/C,
not resectable]
    B -->|B (Intermediate)| D[**Locoregional**]
    D --> D1[**TACE (cTACE/DEB-TACE)**
Child-Pugh A/B7, bilobar, preserved portal vein]
    D --> D2[**TARE (Y-90)**
PVT (segmental), TACE-refractory,
bridging to transplant]
    D --> D3[**RFA + TACE**
>3cm or difficult location]
    B -->|C (Advanced)| E[**Systemic Therapy**]
    E --> E1[**1L: Atezolizumab + Bevacizumab**
(IMbrave150) — **Standard**
Child-Pugh A, no high-risk varices]
    E --> E2[**1L: Sorafenib** (SHARP) / **Lenvatinib** (REFLECT)
If ICI contraindicated]
    E --> E3[**2L: Regorafenib** (RESORCE) — post-Sorafenib
**Cabozantinib** (CELESTIAL)
**Ramucirumab** (REACH-2) if AFP≥400]
    E --> E4[**3L+: Clinical Trial / Best Supportive**]
    B -->|D (Terminal)| F[**Best Supportive Care**
Paracentesis, lactulose,
analgesia, hospice]
    C1 --> G[Surveillance: US/AFP q3-6mo
CT/MRI q6-12mo]
    C2 --> G
    C3 --> G
    D1 --> G
...
### 1. Locoregional Therapy Details
...
- Q: What is the definition of Hepatobiliary & Pancreatic?
  A: Primary malignant tumour of hepatocytes; >90% arise in cirrhosis
- Q: What is the epidemiology of Hepatobiliary & Pancreatic?
  A: 6th most common cancer globally; 3rd leading cause of cancer death; UK: ~6,200/year; M:F = 2-3:1
- Q: What is Peak Age of Hepatobiliary & Pancreatic?
  A: 60-70 years; HBV: younger (30-50)
- Q: What is Sex Ratio of Hepatobiliary & Pancreatic?
  A: Male 2-3:1 (androgen effect, behavioural)
- Q: What causes Hepatobiliary & Pancreatic?
  A: Cirrhosis (any aetiology): HBV (integrates DNA, ↓ need cirrhosis), HCV, Alcohol, NAFLD/NASH (fastest rising), Hemochromatosis, A1AT deficiency, PBC, Autoimmune hepatitis, Aflatoxin (synergy with HBV), Diabetes, Obesity, Smoking
- Q: What is Surveillance-Detected of Hepatobiliary & Pancreatic?
  A: Asymptomatic; US lesion <2cm; AFP elevated
- Q: What are the clinical features of Hepatobiliary & Pancreatic?
  A: RUQ pain, weight loss, early satiety, palpable mass
- Q: What is Decompensation of Hepatobiliary & Pancreatic?
  A: Ascites, variceal bleed, encephalopathy, jaundice (tumour-induced)
- Q: What is Paraneoplastic of Hepatobiliary & Pancreatic?
  A: Hypoglycaemia (IGF-II), Erythrocytosis (EPO), Hypercholesterolaemia, Hypercalcaemia (PTHrP), Porphyria cutanea tarda, Carcinoid syndrome (rare)
- Q: What is Rupture of Hepatobiliary & Pancreatic?
  A: Acute abdomen, haemoperitoneum, shock — emergency (TACE/embolisation)
- Q: What is Extrahepatic Spread of Hepatobiliary & Pancreatic?
  A: Lung (most common), lymph nodes, bone, adrenal, brain
- Q: What is Surveillance-Detected of Hepatobiliary & Pancreatic?
  A: Asymptomatic; US lesion <2cm; AFP elevated
- Q: What are the clinical features of Hepatobiliary & Pancreatic?
  A: RUQ pain, weight loss, early satiety, palpable mass
...
- Q: What is Extrahepatic Spread of Hepatobiliary & Pancreatic?
  A: Lung (most common), lymph nodes, bone, adrenal, brain
- Q: What causes Hepatobiliary & Pancreatic?
  A: Cirrhosis (HBV, HCV, Alcohol, NAFLD/NASH rising); HBV → HCC without cirrhosis
- Q: What is Surveillance of Hepatobiliary & Pancreatic?
  A: US ± AFP q6mo in cirrhosis (Child A/B); Cost-effective
- Q: What is the investigation of choice for Hepatobiliary & Pancreatic?
  A: LI-RADS LR-5 = Non-invasive diagnosis (arterial hyperenhancement + washout + capsule); Biopsy if LR-3/4/M
- Q: What is BCLC of Hepatobiliary & Pancreatic?
  A: Treatment algorithm based on stage + liver function + PS — only staging that links to treatment
- Q: What is Milan Criteria of Hepatobiliary & Pancreatic?
  A: Single ≤5cm OR ≤3 nodules ≤3cm, no vascular invasion → Transplant (5-yr recurrence <10%)
- Q: What is Curative of Hepatobiliary & Pancreatic?
  A: Resection (Child A, good remnant), RFA/MWA (≤3cm), Transplant (Milan, Child B/C)
- Q: What is TACE of Hepatobiliary & Pancreatic?
  A: Standard for BCLC B (multinodular); cTACE vs DEB-TACE; Contraindicated: Main PVT, Child C
- Q: What is TARE (Y-90) of Hepatobiliary & Pancreatic?
  A: Segmental PVT, TACE-refractory, Bridging to transplant
- Q: What is 1L Systemic of Hepatobiliary & Pancreatic?
  A: Atezolizumab + Bevacizumab (IMbrave150) — New Standard; Requires variceal screening/banding
- Q: What is 2L Systemic of Hepatobiliary & Pancreatic?
  A: Regorafenib (post-Sorafenib tolerant), Cabozantinib, Ramucirumab (AFP≥400)
- Q: What is Child-Pugh of Hepatobiliary & Pancreatic?
  A: A: All options; B: Selected (TACE, Sorafenib); C: BSC only
- Q: What are the complications of Hepatobiliary & Pancreatic?
  A: Variceal bleed (prophylactic banding), HE, HRS, Tumour rupture (emergency TACE)

## MCQs (1 generated)

1. **Which of the following best describes Hepatobiliary & Pancreatic?**
   A. **HCC = primary liver cancer in cirrhosis (80-90%).**
...
1. A patient with suspected Hepatobiliary & Pancreatic presents with: Definition — Primary malignant tumour of hepatocytes; >90% arise in cirrhosis; Incidence — 6th most common cancer globally; 3rd leading cause of cancer death; UK: ~6,200/year; M:F = 2-3:1; Prevalence — High in East Asia, Sub-Saharan Africa (HBV endemic); Rising in West (NASH/Alcohol). What is the most likely diagnosis?
