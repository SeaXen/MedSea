...
- Q: What is the definition of Principles of Cancer Management?
  A: Liquid Biopsy = Non-Invasive Tumour Profiling via Blood; ctDNA = Tumour-Derived DNA Fragments in Plasma; Applications: MRD (Post-Surgery/Adjuvant), Resistance Monitoring (EGFR T790M, ESR1, KRAS), Tumour Fraction, Early Detection (Screening); Limitations: Sensitivity (Stage-Dependent), CHIP (Clonal Haematopoiesis), False Positives; NGS vs ddPCR; MRD-Guided Adjuvant Therapy (GALAXY, IMvigor010, DYNA
- Q: What is Origin of Principles of Cancer Management?
  A: Tumour cell apoptosis/necrosis → DNA fragments released into bloodstream
- Q: What is Fragment Size of Principles of Cancer Management?
  A: ~166bp (mononucleosomal), Peak at ~166bp, Sub-nucleosomal <100bp
- Q: What is Half-Life of Principles of Cancer Management?
  A: ~15-30 minutes (Rapid clearance by liver/spleen)
- Q: What is Concentration of Principles of Cancer Management?
  A: 0.01-10% of total cfDNA (VAF 0.01-10%)
- Q: What is Fragmentomics of Principles of Cancer Management?
  A: Size profiles, End motifs, Nucleosome positioning → Tissue of origin
- Q: What is ctDNA Origin of Principles of Cancer Management?
  A: Tumour Apoptosis/Necrosis → 166bp Fragments, Half-Life 15-30min
- Q: What is MRD of Principles of Cancer Management?
  A: Post-Surgery ctDNA+ = High Recurrence Risk; Guides Adjuvant (DYNAMIC, IMvigor010)
- Q: How is Principles of Cancer Management monitored?
  A: EGFR T790M → Osimertinib; ESR1 → Elacestrant/Fulvestrant; KRAS → Stop Anti-EGFR
- Q: What is Tumour Fraction of Principles of Cancer Management?
  A: % ctDNA in cfDNA; Prognostic, Response Monitoring
- Q: What is CHIP of Principles of Cancer Management?
  A: DNMT3A, TET2, ASXL1, TP53, JAK2; Screen WBC to Subtract
- Q: What is Limitations of Principles of Cancer Management?
  A: Stage-Dependent Sensitivity, CHIP, Low Shedding (Brain), Low VAF
- Q: What is MCED of Principles of Cancer Management?
  A: Galleri (Methylation), CancerSEEK; Sensitivity Stage I ~16%, Stage IV ~90%
- Q: What is MRD-Guided Adjuvant of Principles of Cancer Management?
  A: DYNAMIC (CRC): Reduced Chemo; IMvigor010 (Bladder): Atezo if MRD+

## MCQs (1 generated)

1. **Which of the following best describes Principles of Cancer Management?**
   A. **Liquid Biopsy = Non-Invasive Tumour Profiling via Blood; ctDNA = Tumour-Derived DNA Fragments in Plasma; Applications: MRD (Post-Surgery/Adjuvant), Resistance Monitoring (EGFR T790M, ESR1, KRAS), Tumo**
...
1. A patient with suspected Principles of Cancer Management presents with: Setting — Clinical Utility; Post-Surgery (CRC, Lung, Breast, Bladder) — MRD+ → High Recurrence Risk (HR 10-50x); Guides Adjuvant Therapy; During Adjuvant Therapy — Early MRD Clearance → Better Outcome; Persistent MRD+ → Escalation. What is the most likely diagnosis?
