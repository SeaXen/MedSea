...
```mermaid
mindmap
  root((Other Bacterial STIs))
    Chancroid
      H. ducreyi
      Painful Ulcer + Suppurative Buboes
      Azi 1g Stat / Ceftriaxone 250mg IM
      HIV Co-infection
      Needle Aspiration Buboes
    M. genitalium
      NGU, Cervicitis, PID
      NAAT Only Diagnosis
      Macrolide Resistance >50%
      Azi 5d (Susceptible)
      Moxi 7-14d (Macrolide-R)
      Pristinamycin (Dual R)
      TOC 4 Weeks
    Ureaplasma / M. hominis
      Controversial Pathogenicity
      Treat if Symptomatic Only
      Doxycycline 100mg BD x7d
    GBS
      Universal Screen 36-37w
      IAP Penicillin G IV
      Early/Late Neonatal Disease
    Other
      Donovanosis (Azi/Doxy)
      Yaws/Bejel (Non-Venereal Treponemes)
```
