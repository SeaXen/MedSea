...
mindmap
  root((Chlamydia trachomatis))
    Epidemiology
      129M New Cases/Year
      Peak 15-24y
      70-80% Women Asymptomatic
    Clinical
      Male: Urethritis, Epididymitis
      Female: Cervicitis, PID, Infertility
      Rectal/Pharyngeal (MSM)
      LGV: Serovars L1/L2/L3
    Diagnosis
      NAAT 1st Line (Urine/Swab)
      Culture (AST)
      Specimens: Urine, Swabs
    Treatment
      Doxy 100mg BD x7d (1st Line)
      Azi 1g Stat (Pregnancy)
      LGV: Doxy 21d
      Pregnancy: Azi 1g Stat
    Complications
