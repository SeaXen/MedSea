...
```mermaid
mindmap
  root((SSRI/SNRI Poisoning & Serotonin Syndrome))
    Agents
      SSRIs (Fluoxetine, Sertraline, Citalopram)
      SNRIs (Venlafaxine, Duloxetine)
      MAOIs, Tramadol, Linezolid, Fentanyl
    Serotonin Syndrome
      Hunter Criteria (Clonus-based)
      Triad: Neuromuscular + Autonomic + Mental
      Onset: Hours
    DDx
      NMS (Days, Rigidity, No Clonus)
      Sympathomimetic (No Clonus)
      Anticholinergic (Dry)
    Management
      Stop Serotonergics
      Benzos (1st Line)
      ...
      Cooling >41°C
      Paralysis if Refractory
    High Risk Combinations
      SSRI + MAOI (14d washout)
      SSRI + Tramadol/Linezolid/Fentanyl
```

## 15. Flowchart
```mermaid
flowchart TD
  A[On Serotonergic + Clonus/Hyperreflexia/\nAgitation/Hyperthermia] --> B[Serotonin Syndrome\nHunter Criteria]
  B --> C[STOP All Serotonergic Drugs\nABCDE]
  C --> D[Benzodiazepines\nLorazepam 2-4mg IV q5-10min]
  D --> E{Temp > 41°C?}
  E -->|Yes| F[Aggressive Cooling\nEvaporative, Ice, Cold Fluids\nParalyze + Ventilate if Refractory]
  E -->|No| G
  D --> G[Cyproheptadine 12mg PO/NG\n2mg q1h x6, then 8mg q6h]
  F --> G
  G --> H[Monitor: Clonus Resolution\nTemp, HR, BP, CK, Renal]
  H --> I{Improving?}
  I -->|Yes| J[Continue Supportive\nObserve 24h Post-Resolution]
  I -->|No| K[Paralyze + Ventilate\nICU]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 11: Poisoning — SSRI-SNRI Poisoning and Serotonin Syndrome*

**Q1.** Which of the following features is most specific or characteristic of SSRI-SNRI Poisoning and Serotonin Syndrome?
...
| **Onset** | **Hours** (rapid) | **Days** (gradual) | Minutes-hours | Minutes-hours |
| **Clonus** | **YES (Hallmark)** | No | No | No |
| **Hyperreflexia** | **YES** | Normal/↑ | Yes | No

**Q2.** What is the most appropriate first-line therapy for SSRI-SNRI Poisoning and Serotonin Syndrome?
  ...
  >
  > *Source:* **Cardiovascular**: treat tachycardia/HTN with short-acting agents (esmolol, nicardipine)
