...
```mermaid
mindmap
  root((Sedative-Hypnotic Toxidrome))
    Mechanism
      GABA-A Potentiation
      Benzo: Freq ↑ (Ceiling)
      Barbiturate: Duration ↑ (NO Ceiling)
      Z-drugs: BZ1 Selective
      GHB: GHB Receptor + GABA-B
      Ethanol: Multi-target
    Clinical
      Sedation → Coma
      Respiratory Depression
      Hypotension
      Hypothermia
      Miosis/Normal Pupils
    Agents
      Benzo (Flumazenil Restricted)
      Barbiturate (MDAC, Alkalinization, Dialysis)
      Z-drugs (Shorter, Sleep Behaviors)
      GHB/GBL (Rapid Arousal)
      Ethanol (Withdrawal, Hypoglycemia)
    DDx
      Opioid (Miosis, Naloxone)
      Metabolic/Structural/Infection
    Management
      Supportive (ABCDE, Intubate)
      Flumazenil (Procedural/Diagnostic ONLY)
      Naloxone (if Opioid Possible)
      Thiamine → Glucose
    Withdrawal
      Benzo: Diazepam Taper
      Alcohol: CIWA-Ar, Benzo, Thiamine
      GHB: High-dose Benzo/Phenobarbital
```
