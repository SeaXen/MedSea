...
```mermaid
mindmap
  root((Hydrogen Sulfide Poisoning))
    Mechanism
      Cytochrome Oxidase Inhibition (Fe3+)
      Histotoxic Hypoxia (Like Cyanide)
    Source
      Confined Spaces (Sewers, Manure, Oil Wells)
      Heavier Than Air
    Olfactory Fatigue
      Low Conc: Rotten Egg Smell
      High Conc: No Smell = DANGER
    Clinical
