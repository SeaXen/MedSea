...
mindmap
  root((Benzodiazepine Poisoning))
    Mechanism
      ...
      Active Metabolites
    Clinical
      Pure: Sedation, Ataxia, Nystagmus, Mild Resp Dep
      Mixed: Fatal Resp Dep (Opioid/Alcohol/TCA)
    DDx
      Opioid (Miosis, Naloxone)
      Barbiturate (Deeper, No Ceiling)
      Alcohol (Odor, Ketoacidosis)
      GHB (Rapid Arousal)
    Management
      Supportive (Mainstay)
      Flumazenil (RESTRICTED)
      Naloxone Trial (if Opioid)
      Charcoal (Longer Window)
    Flumazenil
      Indications: Procedural, Diagnostic
      Contraindications: TCA, Seizure, Chronic, Head Injury
      Dose: 0.2mg IV, Re-sedation Common
    Withdrawal
      Diazepam Taper
      Short-acting: 6-12h
      Long-acting: 24-48h
