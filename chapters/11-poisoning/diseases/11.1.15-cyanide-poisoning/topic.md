...
mindmap
  root((Cyanide Poisoning))
    ...
    Labs
      ...
      High Venous O2 (Bright Red)
      Lactate > 10
      Normal COHb (unless Fire)
    Antidotes
      Hydroxocobalamin 5g IV (Preferred)
      Nitrite + Thiosulfate (If No Hydroxocobalamin)
      NO Nitrites in Fire/CO
    Fire Victim
      CO + CN Co-exposure
      100% O2 + Hydroxocobalamin
      NO Nitrites
    Special
      Nitroprusside → Thiocyanate
      Bitter Almond Smell (40%)
      Hydroxocobalamin Red Urine
```
