...
```mermaid
mindmap
  root((Ethylene Glycol Poisoning))
    Metabolism
      ADH → Glycoaldehyde → Glycolic Acid (Acidosis)
      → Glyoxylic Acid → Oxalic Acid (Crystals, Renal)
      Alternative: Thiamine → α-Hydroxy-β-ketoadipate
      Alternative: Pyridoxine → Glycine
    Clinical Stages
      1: 0-12h CNS (Drunk, Osmolar Gap)
      2: 12-24h Acidosis, Pulmonary, Crystalluria, HypoCa
      3: 24-72h Renal Failure
    Diagnosis
      Osmolar Gap Early
      Anion Gap Acidosis Late
      Calcium Oxalate Crystals (Hallmark)
      Hypocalcemia
    Treatment
      Fomepizole (15 load, 10 q12h)
      Thiamine 100mg q6h + Pyridoxine 50mg q6h
      Bicarbonate pH<7.3
      Calcium if Symptomatic HypoCa
...
```mermaid
flowchart TD
  A[Suspected EG] --> B[ABCDE + Osmolality + ABG + Urinalysis\n+ EG Level + Calcium + Renal]
  B --> C{Fomepizole Available?}
  C -->|Yes| D[Fomepizole 15mg/kg Load\n10mg/kg q12h\nThiamine 100mg q6h\nPyridoxine 50mg q6h]
  C -->|No| E[Ethanol 10% Central\nTarget 100-150 mg/dL\nThiamine + Pyridoxine]
  D --> F[Bicarbonate if pH < 7.3\nCalcium if Symptomatic HypoCa]
  E --> F
  F --> G{Dialysis Indicated?\npH<7.3, Renal Failure,\nLevel>50 mmol/L}
  G -->|Yes| H[Hemodialysis\nFomepizole 1mg/kg/hr during]
  G -->|No| I[Monitor q4-6h\nUntil EG<20, pH Normal,\nRenal Recovering]
  H --> I
```
