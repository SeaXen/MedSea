...
```mermaid
flowchart TD
  A[Agitated, Hypertensive, Tachycardic, Diaphoretic, Hyperthermic] --> B[Sympathomimetic Toxidrome]
  B --> C[ABCDE + Benzodiazepines<br/>Lorazepam 2-4mg IV q5-10min\nTarget: Sedation RASS -1 to 0]
  C --> D{HTN Persists\nAfter Adequate Benzo?}
  D -->|Yes| E[Vasodilators:\nNicardipine / Phentolamine /\nNitroprusside / Nitroglycerin\nNO BETA-BLOCKERS]
  D -->|No| F[Monitor]
  C --> G{Temp > 39°C?}
  G -->|Yes| H[Aggressive Cooling\nEvaporative, Ice, Cold Fluids\nParalyze if Refractory]
  G -->|No| F
  C --> I{Seizures?}
  I -->|Yes| J[Benzo → Phenobarbital/Propofol\nNO Phenytoin]
  I -->|No| F
  C --> K{Rhabdo?\nCK > 5000}
  K -->|Yes| L[Fluids 1-2L/hr\nAlkalinize Urine\nTarget UOP 2-3 mL/kg/hr]
  K -->|No| F
  F --> M[Disposition:\nICU if Severe/Intubated\nObs 6-12h if Mild\nPsych Assessment]
```
