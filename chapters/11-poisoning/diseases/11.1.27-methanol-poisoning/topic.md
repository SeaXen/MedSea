...
```mermaid
mindmap
  root((Methanol Poisoning))
    Metabolism
      ADH → Formaldehyde
      ALDH → Formic Acid (TOXIC)
      Formic Acid: Cytochrome C Oxidase Inhibit + Optic Nerve
    Timeline
      Early: Osmolar Gap, Inebriation
      Late: Anion Gap Acidosis, Visual Loss, Basal Ganglia
    Diagnosis
      Methanol Level
      Osmolar Gap > 10
      Anion Gap Acidosis
...
```mermaid
flowchart TD
  A[Suspected Methanol] --> B[ABCDE + Osmolality + ABG + Methanol Level\nOphthalmology Review]
  B --> C{Fomepizole Available?}
  C -->|Yes| D[Fomepizole 15mg/kg IV Load\nThen 10mg/kg q12h\nFolinic Acid 50mg IV q6h]
  C -->|No| E[Ethanol 10% Central Line\nTarget 100-150 mg/dL\nFolinic Acid 50mg IV q6h]
  D --> F[Bicarbonate if pH < 7.3]
  E --> F
  F --> G{Dialysis Indicated?\npH<7.3, Renal, Visual,\nLevel>50 mmol/L}
  G -->|Yes| H[Hemodialysis\nFomepizole 1mg/kg/hr during]
  G -->|No| I[Monitor q4-6h: pH, Level, Visual\nUntil Level<20, Asymptomatic, pH Normal]
  H --> I
```
