...
```mermaid
mindmap
  root((Antihypertensive Poisoning))
    Central Alpha-2
      Clonidine: Coma, Miosis, Brady, Hypotension, Transient HTN
      Naloxone Partial Reversal
    ACEi/ARB
      Hypotension + HyperK + AKI
      ACEi: Cough, Angioedema
    Diuretics
      Loop: K↓, Na↓, Alk, Ototoxicity
      Thiazide: Na↓, K↓, Alk, Ca↑, Hyperuricemia
      K-Sparing: K↑, Acidosis (Type 4 RTA)
    Vasodilators
      Nitroprusside: Cyanide/Thiocyanate -> Hydroxocobalamin
      Nitrates: MetHb -> Methylene Blue
      Hydralazine: Lupus, Reflex Tachy
