...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Health Policy, Planning & Evaluation*

**Q1.** Which of the following features is most specific or characteristic of Health Policy, Planning & Evaluation?
  ...
  > **Answer: A** — Policy vs Plan
  >
  > *Source:* ustained at individual, setting)

---
| Confusion | Clarification |
|-----------|---------------|
| **Policy vs Plan** | Policy = general direction, principles. Plan = specific actions, timelines, res

**Q2.** What is the most appropriate first-line therapy for Health Policy, Planning & Evaluation?
  ...
  > **Answer: A** — Lobby
  >
  > *Source:* **Lobby**   Direct contact with policymakers, briefings, parliamentary questions
