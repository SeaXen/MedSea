...
## 4. 4. Classification / Evidence Hierarchy (Therapy/Harm)
...
## 5. 5. Diagnosis & Investigations (PICO & Appraisal)
...
## 6. 6. Differential Diagnosis (EBM Confusions)
...
## 7. 7. Management (Guideline Development & Implementation)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Evidence-Based Medicine & Clinical Guidelines*

**Q1.** Which of the following features is most specific or characteristic of Evidence-Based Medicine & Clinical Guidelines?
