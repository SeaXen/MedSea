...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Disease Surveillance & Outbreak Investigation*

**Q1.** Which of the following features is most specific or characteristic of Disease Surveillance & Outbreak Investigation?

  - **A.** Case Definition Levels
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — Case Definition Levels
  >
  > *Source:* |
| **Case Definition Levels** | Suspect (clinical), Probable (clinical + epi link), Confirmed (lab). Balance sensitivity (suspect) vs specificity (confirmed)

**Q2.** What is the most appropriate first-line therapy for Disease Surveillance & Outbreak Investigation?

  - **A.** Contact Tracing: + Contact + High-risk
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Contact Tracing: + Contact + High-risk
  >
  > *Source:* **Contact Tracing:**
- **Contact**: Person with exposure to confirmed case during infectious period
- **High-risk**: Household, healthcare, close proximity >15 min
- **Actions**: Quarantine, monitorin
