...
## 4. 4. Classification / Disaster Cycle & Triage
...
## 5. 5. Diagnosis & Investigations (SPHERE & Public Health)
...
## 6. 6. Differential Diagnosis (Disaster Confusions)
...
## 7. 7. Management (Humanitarian Action & Principles)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Disaster & Humanitarian Health*

**Q1.** What is the most appropriate first-line therapy for Disaster & Humanitarian Health?
  ...
  > **Answer: A** — Neutrality
  >
  > *Source:* **Neutrality**: Do not take sides in hostilities
3.
