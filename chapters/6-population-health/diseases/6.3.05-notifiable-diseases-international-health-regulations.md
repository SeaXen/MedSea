...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Notifiable Diseases & International Health Regulations*

**Q1.** Which of the following features is most specific or characteristic of Notifiable Diseases & International Health Regulations?

  - **A.** IHR vs WHO Constitution
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — IHR vs WHO Constitution
  >
  > *Source:* |
| **IHR vs WHO Constitution** | IHR = specific binding instrument for health emergencies

**Q2.** What is the most appropriate first-line therapy for Notifiable Diseases & International Health Regulations?
  ...
  >
  > *Source:* **Restriction**   Restrict movements, activities (e.g., food handler with Salmonella)
