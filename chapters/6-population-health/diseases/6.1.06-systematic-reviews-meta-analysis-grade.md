...
## 4. 4. Classification / Meta-Analysis Models
...
## 5. 5. Diagnosis & Investigations (Forest Plot & GRADE)
...
## 6. 6. Differential Diagnosis (SR/MA Confusions)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Systematic Reviews, Meta-analysis, GRADE*

**Q1.** What is the most appropriate first-line therapy for Systematic Reviews, Meta-analysis, GRADE?
  ...
  > **Answer: A** — PRISMA
  >
  > *Source:* **PRISMA**   Reporting guideline (27 items) for SR/MA
