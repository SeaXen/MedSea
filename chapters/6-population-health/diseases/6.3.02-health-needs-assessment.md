...
## 4. 4. Classification / HNA Approaches
...
## 5. 5. Diagnosis & Investigations (Data Sources & Methods)
...
```mermaid
flowchart TD
    A[JSNA: Joint Strategic Needs Assessment] --> B[Identify Needs\nEpi + Comparative + Corporate]
    B --> C[Prioritise\nMagnitude, Inequity, Effectiveness]
    C --> D[JHWS: Joint Health & Wellbeing Strategy]
    D --> E[Commissioning Plans\nICB / LA / NHS England]
    E --> F[Service Specification\nContracts / Grants]
    F --> G[Delivery & Monitoring\nKPIs, Outcomes, Equity]
    G --> H[Evaluation & Feedback]
    H --> A
...
## 6. 6. Differential Diagnosis (HNA vs Related Concepts)
...
## 7. 7. Management (Application in UK System)
...
```mermaid
mindmap
  root((Health Needs Assessment))
    Definition
      Need = Capacity to Benefit
      Want = Perceived
      Demand = Expressed Action
    Bradshaw's Types
      Normative
      Felt
      Expressed
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Health Needs Assessment*

**Q1.** Which of the following features is most specific or characteristic of Health Needs Assessment?
...
| **Public Health** | Screening uptake, immunisation, sexual health, substance misuse |
| **Mortality (ONS)** | Cause-specific, avoidable, LE, healthy LE, SMR |
| **Surveys** | Health Survey

**Q2.** What is the most appropriate first-line therapy for Health Needs Assessment?

  - **A.** Proportional Universalism
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Proportional Universalism
  >
  > *Source:* **Proportional Universalism (Marmot):**
- Universal services for all
- Scale and intensity proportionate to need/disadvantage
- Reduces gradient, not just gap
