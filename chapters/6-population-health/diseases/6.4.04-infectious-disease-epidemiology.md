...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Infectious Disease Epidemiology*

**Q1.** What is the most appropriate first-line therapy for Infectious Disease Epidemiology?
  ...
  >
  > *Source:* **One Health Approach:** Human + Animal + Environmental health integration for zoonoses and AMR.
