...
## 4. 4. Classification / WHO Building Blocks & UHC
...
## 5. 5. Diagnosis & Investigations (Financing & Economics)
...
## 6. 6. Differential Diagnosis (Systems Confusions)
...
## 7. 7. Management (NHS Structure & Reforms)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 6: Population Health — Health Systems, UHC & Health Economics*

**Q1.** Which of the following features is most specific or characteristic of Health Systems, UHC & Health Economics?
  ...
  > **Answer: A** — Threshold Variation
  >
  > *Source:* |
| **Threshold Variation** | NICE £20-30K/QALY. WHO 1-3x GDP/DALY. Country-specific
