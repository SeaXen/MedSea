<!-- Source: /mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Pathophysiology_(demand_vs_supply_ischemia).md | section: 16.3 | hub: chronic-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Pathophysiology?
...
**Q2.** First-line investigation for Pathophysiology:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Pathophysiology:
...
**Q4.** Which is a contraindication to therapy in Pathophysiology?
A. Renal dysfunction
...
**Q5.** The most common complication of Pathophysiology is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Pathophysiology. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Pathophysiology on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Pathophysiology
2. Discuss the pathophysiology of Pathophysiology
3. What are the diagnostic criteria for Pathophysiology?
4. Outline the management approach to Pathophysiology
5. What are the complications and prognosis of Pathophysiology?
6. What are the latest guidelines for Pathophysiology?
7. How is Pathophysiology managed in special populations?
8. Compare Pathophysiology with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / Pathophysiology (demand vs supply ischemia)**

**Q1.** A patient presents with features consistent with Pathophysiology (demand vs supply ischemia). The clinical picture is most consistent with: Clinical presentation of Pathophysiology varies by acuity (acute vs chronic), severity, and patient factors. **Cardinal  What is the most likely diagnosis?

  - **A.** Pathophysiology (demand vs supply ischemia)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of Pathophysiology (demand vs supply ischemia)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — Pathophysiology (demand vs supply ischemia)

**Q2.** A patient is being evaluated for Pathophysiology (demand vs supply ischemia). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of Pathophysiology (demand vs supply ischemia), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with Pathophysiology (demand vs supply ischemia). What is the most appropriate first-line management approach?
