<!-- Source: /mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Diagnostic_testing_(exercise_ECG,_stress_echo,_nuclear,_CTCA,_invasive_angiography).md | section: 16.3 | hub: chronic-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Diagnostic testing?
...
**Q2.** First-line investigation for Diagnostic testing:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Diagnostic testing:
...
**Q4.** Which is a contraindication to therapy in Diagnostic testing?
A. Renal dysfunction
...
**Q5.** The most common complication of Diagnostic testing is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Diagnostic testing. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Diagnostic testing on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Diagnostic testing
2. Discuss the pathophysiology of Diagnostic testing
3. What are the diagnostic criteria for Diagnostic testing?
4. Outline the management approach to Diagnostic testing
5. What are the complications and prognosis of Diagnostic testing?
6. What are the latest guidelines for Diagnostic testing?
7. How is Diagnostic testing managed in special populations?
8. Compare Diagnostic testing with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Diagnostic testing (exercise ECG*

**Q1.** Which of the following features is most specific or characteristic of Diagnostic testing (exercise ECG?
