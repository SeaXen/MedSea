<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Treatment_thresholds_and_targets_ACC_AHA_vs_ESC.md | section: 16.14 | hub: hypertension-cv-risk -->

# Treatment thresholds and targets ACC AHA vs ESC
...
**Q1.** What is the most common aetiology of Treatment thresholds and targets ACC AHA vs ESC?
...
**Q2.** First-line investigation for Treatment thresholds and targets ACC AHA vs ESC:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Treatment thresholds and targets ACC AHA vs ESC:
...
**Q4.** Which is a contraindication to therapy in Treatment thresholds and targets ACC AHA vs ESC?
A. Renal dysfunction
...
**Q5.** The most common complication of Treatment thresholds and targets ACC AHA vs ESC is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Treatment thresholds and targets ACC AHA vs ESC. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Treatment thresholds and targets ACC AHA vs ESC on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Treatment thresholds and targets ACC AHA vs ESC
2. Discuss the pathophysiology of Treatment thresholds and targets ACC AHA vs ESC
3. What are the diagnostic criteria for Treatment thresholds and targets ACC AHA vs ESC?
4. Outline the management approach to Treatment thresholds and targets ACC AHA vs ESC
5. What are the complications and prognosis of Treatment thresholds and targets ACC AHA vs ESC?
6. What are the latest guidelines for Treatment thresholds and targets ACC AHA vs ESC?
7. How is Treatment thresholds and targets ACC AHA vs ESC managed in special populations?
8. Compare Treatment thresholds and targets ACC AHA vs ESC with related conditions
...
**File:** Treatment_thresholds_and_targets_ACC_AHA_vs_ESC.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Treatment thresholds and targets ACC AHA vs ESC*

**Q1.** Which of the following features is most specific or characteristic of Treatment thresholds and targets ACC AHA vs ESC?
