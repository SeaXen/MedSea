<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/Revascularization_(PCI_vs_CABG).md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Revascularization?
...
**Q2.** First-line investigation for Revascularization:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Revascularization:
...
**Q4.** Which is a contraindication to therapy in Revascularization?
A. Renal dysfunction
...
**Q5.** The most common complication of Revascularization is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Revascularization. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Revascularization on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Revascularization
2. Discuss the pathophysiology of Revascularization
3. What are the diagnostic criteria for Revascularization?
4. Outline the management approach to Revascularization
5. What are the complications and prognosis of Revascularization?
6. What are the latest guidelines for Revascularization?
7. How is Revascularization managed in special populations?
8. Compare Revascularization with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / Revascularization (PCI vs CABG)**

**Q1.** A patient presents with features consistent with Revascularization (PCI vs CABG). The clinical picture is most consistent with: Clinical presentation of Revascularization varies by acuity (acute vs chronic), severity, and patient factors. **Cardina What is the most likely diagnosis?

  - **A.** Revascularization (PCI vs CABG)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of Revascularization (PCI vs CABG)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — Revascularization (PCI vs CABG)

**Q2.** A patient is being evaluated for Revascularization (PCI vs CABG). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of Revascularization (PCI vs CABG), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with Revascularization (PCI vs CABG). What is the most appropriate first-line management approach?
