<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/VT_ablation_(ischemic,_non-ischemic).md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of VT ablation?
...
**Q2.** First-line investigation for VT ablation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for VT ablation:
...
**Q4.** Which is a contraindication to therapy in VT ablation?
A. Renal dysfunction
...
**Q5.** The most common complication of VT ablation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of VT ablation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with VT ablation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify VT ablation
2. Discuss the pathophysiology of VT ablation
3. What are the diagnostic criteria for VT ablation?
4. Outline the management approach to VT ablation
5. What are the complications and prognosis of VT ablation?
6. What are the latest guidelines for VT ablation?
7. How is VT ablation managed in special populations?
8. Compare VT ablation with related conditions
