<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Cardiac_CT_coronary_calcium_scoring_CT_coronary_angiography.md | section: 16.1 | hub: cardiac-investigations -->

# Cardiac CT coronary calcium scoring CT coronary angiography
...
**Q1.** What is the most common aetiology of Cardiac CT coronary calcium scoring CT coronary angiography?
...
**Q2.** First-line investigation for Cardiac CT coronary calcium scoring CT coronary angiography:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Cardiac CT coronary calcium scoring CT coronary angiography:
...
**Q4.** Which is a contraindication to therapy in Cardiac CT coronary calcium scoring CT coronary angiography?
A. Renal dysfunction
...
**Q5.** The most common complication of Cardiac CT coronary calcium scoring CT coronary angiography is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Cardiac CT coronary calcium scoring CT coronary angiography. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Cardiac CT coronary calcium scoring CT coronary angiography on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Cardiac CT coronary calcium scoring CT coronary angiography
2. Discuss the pathophysiology of Cardiac CT coronary calcium scoring CT coronary angiography
3. What are the diagnostic criteria for Cardiac CT coronary calcium scoring CT coronary angiography?
4. Outline the management approach to Cardiac CT coronary calcium scoring CT coronary angiography
5. What are the complications and prognosis of Cardiac CT coronary calcium scoring CT coronary angiography?
6. What are the latest guidelines for Cardiac CT coronary calcium scoring CT coronary angiography?
7. How is Cardiac CT coronary calcium scoring CT coronary angiography managed in special populations?
8. Compare Cardiac CT coronary calcium scoring CT coronary angiography with related conditions
...
**File:** Cardiac_CT_coronary_calcium_scoring_CT_coronary_angiography.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Cardiac CT coronary calcium scoring CT coronary angiography*

**Q1.** Which of the following features is most specific or characteristic of Cardiac CT coronary calcium scoring CT coronary angiography?
...
**Q2.** What is the most appropriate first-line therapy for Cardiac CT coronary calcium scoring CT coronary angiography?
