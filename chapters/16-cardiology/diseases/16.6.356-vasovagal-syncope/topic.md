...
```mermaid
mindmap
  root((Vasovagal Syncope))
    Pathophysiology
      Bezold-Jarisch reflex
      Vagal surge + sympathetic withdrawal
    Classic Features
      Trigger (standing, emotion, pain)
      Prodrome (nausea, warmth, sweat)
      Standing position
      Rapid recovery
    Tilt Test Types
      Type 1: Cardioinhibitory (asystole)
      Type 2: Vasodepressor (BP drop)
      Type 3: Mixed
    Management
      Reassurance + Education
      Fluids 2-3L + Salt 6-10g
