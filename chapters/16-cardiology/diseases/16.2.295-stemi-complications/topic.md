<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/STEMI_complications_(mechanical,_arrhythmic,_HF,_pericarditis).md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of STEMI complications?
...
**Q2.** First-line investigation for STEMI complications:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for STEMI complications:
...
**Q4.** Which is a contraindication to therapy in STEMI complications?
A. Renal dysfunction
...
**Q5.** The most common complication of STEMI complications is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of STEMI complications. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with STEMI complications on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify STEMI complications
2. Discuss the pathophysiology of STEMI complications
3. What are the diagnostic criteria for STEMI complications?
4. Outline the management approach to STEMI complications
5. What are the complications and prognosis of STEMI complications?
6. What are the latest guidelines for STEMI complications?
7. How is STEMI complications managed in special populations?
8. Compare STEMI complications with related conditions
