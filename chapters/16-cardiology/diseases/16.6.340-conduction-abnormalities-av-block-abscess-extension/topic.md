<!-- Source: /mnt/tb/Medicine/Cardiology/06_Infective_Endocarditis/Conduction_abnormalities_AV_block_abscess_extension.md | section: 16.6 | hub: infective-endocarditis -->

# Conduction abnormalities AV block abscess extension
...
**Conduction abnormalities AV block abscess extension**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Conduction abnormalities AV block abscess extension?
...
**Q2.** First-line investigation for Conduction abnormalities AV block abscess extension:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Conduction abnormalities AV block abscess extension:
...
**Q4.** Which is a contraindication to therapy in Conduction abnormalities AV block abscess extension?
A. Renal dysfunction
...
**Q5.** The most common complication of Conduction abnormalities AV block abscess extension is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Conduction abnormalities AV block abscess extension. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Conduction abnormalities AV block abscess extension on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Conduction abnormalities AV block abscess extension
2. Discuss the pathophysiology of Conduction abnormalities AV block abscess extension
3. What are the diagnostic criteria for Conduction abnormalities AV block abscess extension?
4. Outline the management approach to Conduction abnormalities AV block abscess extension
5. What are the complications and prognosis of Conduction abnormalities AV block abscess extension?
6. What are the latest guidelines for Conduction abnormalities AV block abscess extension?
7. How is Conduction abnormalities AV block abscess extension managed in special populations?
8. Compare Conduction abnormalities AV block abscess extension with related conditions
...
**File:** Conduction_abnormalities_AV_block_abscess_extension.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Conduction abnormalities AV block abscess extension*

**Q1.** What is the most appropriate first-line therapy for Conduction abnormalities AV block abscess extension?
