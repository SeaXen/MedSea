...
source: "/mnt/tb/Medicine/Cardiology/Adult Congenital Heart Disease and Cardiac Shunts/Bicuspid aortic valve.md"
...
```mermaid
mindmap
  root((Bicuspid Aortic Valve))
    Embryology
      RL cusp fusion (70-80%)
      Sievers: 0/1/2 raphe
    Aortopathy
    ...
    Complications
      AS / AR (earlier)
      IE / Dissection / Aneurysm
    Surveillance
      TTE: valve + aorta (annulus to descending)
      CTA/MRI: full aorta
    Surgery
      Aorta ≥55mm asymptomatic
      ≥50mm risk factors
      ≥45mm with valve surgery
      Growth >3mm/yr
    Family
      Screen 1st degree (echo)
    Pregnancy
      >45mm = C-section
```
