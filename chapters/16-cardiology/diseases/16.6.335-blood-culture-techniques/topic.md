<!-- Source: /mnt/tb/Medicine/Cardiology/06_Infective_Endocarditis/Blood_culture_techniques_(timing,_volume,_bottles).md | section: 16.6 | hub: infective-endocarditis -->
...
**Q1.** What is the most common aetiology of Blood culture techniques?
...
**Q2.** First-line investigation for Blood culture techniques:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Blood culture techniques:
...
**Q4.** Which is a contraindication to therapy in Blood culture techniques?
A. Renal dysfunction
...
**Q5.** The most common complication of Blood culture techniques is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Blood culture techniques. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Blood culture techniques on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Blood culture techniques
2. Discuss the pathophysiology of Blood culture techniques
3. What are the diagnostic criteria for Blood culture techniques?
4. Outline the management approach to Blood culture techniques
5. What are the complications and prognosis of Blood culture techniques?
6. What are the latest guidelines for Blood culture techniques?
7. How is Blood culture techniques managed in special populations?
8. Compare Blood culture techniques with related conditions
...
**File:** Blood_culture_techniques.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Blood culture techniques (timing, volume, bottles)*

**Q1.** Which of the following features is most specific or characteristic of Blood culture techniques (timing, volume, bottles)?
