<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/Permanent_pacemaker_indications_sinus_node_dysfunction_AV_block_bifascicular_block_+_symptoms.md | section: 16.8 | hub: arrhythmias -->

# Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms
...
**Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms?
...
**Q2.** First-line investigation for Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms:
...
**Q4.** Which is a contraindication to therapy in Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms?
A. Renal dysfunction
...
**Q5.** The most common complication of Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms
2. Discuss the pathophysiology of Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms
3. What are the diagnostic criteria for Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms?
4. Outline the management approach to Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms
5. What are the complications and prognosis of Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms?
6. What are the latest guidelines for Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms?
7. How is Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms managed in special populations?
8. Compare Permanent pacemaker indications sinus node dysfunction AV block bifascicular block + symptoms with related conditions
...
**File:** Permanent_pacemaker_indications_sinus_node_dysfunction_AV_block_bifascicular_block_+_symptoms.md
