<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/Management_(diuretics,_SGLT2i,_BP_control,_treat_comorbidities).md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of Management?
...
**Q2.** First-line investigation for Management:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Management:
...
**Q4.** Which is a contraindication to therapy in Management?
A. Renal dysfunction
...
**Q5.** The most common complication of Management is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Management. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Management on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Management
2. Discuss the pathophysiology of Management
3. What are the diagnostic criteria for Management?
4. Outline the management approach to Management
5. What are the complications and prognosis of Management?
6. What are the latest guidelines for Management?
7. How is Management managed in special populations?
8. Compare Management with related conditions
