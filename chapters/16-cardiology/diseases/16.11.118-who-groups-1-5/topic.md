<!-- Source: /mnt/tb/Medicine/Cardiology/11_Pulmonary_Hypertension/WHO_Groups_1-5_(PAH,_PH-LHD,_PH-Lung,_CTEPH,_Multifactorial).md | section: 16.11 | hub: pulmonary-hypertension -->
...
**Q1.** What is the most common aetiology of WHO Groups 1-5?
...
**Q2.** First-line investigation for WHO Groups 1-5:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for WHO Groups 1-5:
...
**Q4.** Which is a contraindication to therapy in WHO Groups 1-5?
A. Renal dysfunction
...
**Q5.** The most common complication of WHO Groups 1-5 is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of WHO Groups 1-5. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with WHO Groups 1-5 on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify WHO Groups 1-5
2. Discuss the pathophysiology of WHO Groups 1-5
3. What are the diagnostic criteria for WHO Groups 1-5?
4. Outline the management approach to WHO Groups 1-5
5. What are the complications and prognosis of WHO Groups 1-5?
6. What are the latest guidelines for WHO Groups 1-5?
7. How is WHO Groups 1-5 managed in special populations?
8. Compare WHO Groups 1-5 with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — WHO Groups 1-5 (PAH, PH-LHD, PH-Lung, CTEPH, Multifactorial)*

**Q1.** Which of the following features is most specific or characteristic of WHO Groups 1-5 (PAH, PH-LHD, PH-Lung, CTEPH, Multifactorial)?
