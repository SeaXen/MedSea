...
davidson_topic_id: "16.17.121"
topic: "TR_(primary,_secondary_functional)"
...
source: "/mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/TR_(primary,_secondary_functional).md"
...
**Q1.** What is the most common aetiology of TR?
...
**Q2.** First-line investigation for TR:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for TR:
...
**Q4.** Which is a contraindication to therapy in TR?
A. Renal dysfunction
...
**Q5.** The most common complication of TR is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of TR. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with TR on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify TR
2. Discuss the pathophysiology of TR
3. What are the diagnostic criteria for TR?
4. Outline the management approach to TR
5. What are the complications and prognosis of TR?
6. What are the latest guidelines for TR?
7. How is TR managed in special populations?
8. Compare TR with related conditions
