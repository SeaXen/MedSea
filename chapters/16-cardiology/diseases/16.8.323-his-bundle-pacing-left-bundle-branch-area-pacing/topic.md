<!-- Source: /mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/His-bundle_pacing,_Left_bundle_branch_area_pacing_(LBBAP).md | section: 16.8 | hub: cardiac-devices-ep -->
...
**His-bundle pacing, Left bundle branch area pacing**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of His-bundle pacing, Left bundle branch area pacing?
...
**Q2.** First-line investigation for His-bundle pacing, Left bundle branch area pacing:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for His-bundle pacing, Left bundle branch area pacing:
...
**Q4.** Which is a contraindication to therapy in His-bundle pacing, Left bundle branch area pacing?
A. Renal dysfunction
...
**Q5.** The most common complication of His-bundle pacing, Left bundle branch area pacing is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of His-bundle pacing, Left bundle branch area pacing. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with His-bundle pacing, Left bundle branch area pacing on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify His-bundle pacing, Left bundle branch area pacing
2. Discuss the pathophysiology of His-bundle pacing, Left bundle branch area pacing
3. What are the diagnostic criteria for His-bundle pacing, Left bundle branch area pacing?
4. Outline the management approach to His-bundle pacing, Left bundle branch area pacing
5. What are the complications and prognosis of His-bundle pacing, Left bundle branch area pacing?
6. What are the latest guidelines for His-bundle pacing, Left bundle branch area pacing?
7. How is His-bundle pacing, Left bundle branch area pacing managed in special populations?
8. Compare His-bundle pacing, Left bundle branch area pacing with related conditions
...
**File:** His-bundle_pacing,_Left_bundle_branch_area_pacing.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — His-bundle pacing, Left bundle branch area pacing (LBBAP)*

**Q1.** What is the most appropriate first-line therapy for His-bundle pacing, Left bundle branch area pacing (LBBAP)?
