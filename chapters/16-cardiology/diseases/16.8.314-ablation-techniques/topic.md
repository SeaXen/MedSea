<!-- Source: /mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/Ablation_techniques_(RF,_cryo,_pulsed_field).md | section: 16.8 | hub: cardiac-devices-ep -->
...
**Q1.** What is the most common aetiology of Ablation techniques?
...
**Q2.** First-line investigation for Ablation techniques:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Ablation techniques:
...
**Q4.** Which is a contraindication to therapy in Ablation techniques?
A. Renal dysfunction
...
**Q5.** The most common complication of Ablation techniques is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Ablation techniques. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Ablation techniques on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Ablation techniques
2. Discuss the pathophysiology of Ablation techniques
3. What are the diagnostic criteria for Ablation techniques?
4. Outline the management approach to Ablation techniques
5. What are the complications and prognosis of Ablation techniques?
6. What are the latest guidelines for Ablation techniques?
7. How is Ablation techniques managed in special populations?
8. Compare Ablation techniques with related conditions
