<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/Next____Create_MOC,_Template,_directories,_hubs,_and_scaffolds.md | section: 16.16 | hub: cardiac-emergencies -->
...
**Q1.** What is the most common aetiology of Next    Create MOC, Template, directories, hubs, and scaffolds?
...
**Q2.** First-line investigation for Next    Create MOC, Template, directories, hubs, and scaffolds:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Next    Create MOC, Template, directories, hubs, and scaffolds:
...
**Q4.** Which is a contraindication to therapy in Next    Create MOC, Template, directories, hubs, and scaffolds?
A. Renal dysfunction
...
**Q5.** The most common complication of Next    Create MOC, Template, directories, hubs, and scaffolds is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Next    Create MOC, Template, directories, hubs, and scaffolds. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Next    Create MOC, Template, directories, hubs, and scaffolds on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Next    Create MOC, Template, directories, hubs, and scaffolds
2. Discuss the pathophysiology of Next    Create MOC, Template, directories, hubs, and scaffolds
3. What are the diagnostic criteria for Next    Create MOC, Template, directories, hubs, and scaffolds?
4. Outline the management approach to Next    Create MOC, Template, directories, hubs, and scaffolds
5. What are the complications and prognosis of Next    Create MOC, Template, directories, hubs, and scaffolds?
6. What are the latest guidelines for Next    Create MOC, Template, directories, hubs, and scaffolds?
7. How is Next    Create MOC, Template, directories, hubs, and scaffolds managed in special populations?
8. Compare Next    Create MOC, Template, directories, hubs, and scaffolds with related conditions
...
**File:** Next_Create_MOC,_Template,_directories,_hubs,_and_scaffolds.md
