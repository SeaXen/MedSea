<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Nuclear_imaging_(myocardial_perfusion,_MUGA,_PET).md | section: 16.1 | hub: cardiac-investigations -->
...
**Q1.** What is the most common aetiology of Nuclear imaging?
...
**Q2.** First-line investigation for Nuclear imaging:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Nuclear imaging:
...
**Q4.** Which is a contraindication to therapy in Nuclear imaging?
A. Renal dysfunction
...
**Q5.** The most common complication of Nuclear imaging is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Nuclear imaging. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Nuclear imaging on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Nuclear imaging
2. Discuss the pathophysiology of Nuclear imaging
3. What are the diagnostic criteria for Nuclear imaging?
4. Outline the management approach to Nuclear imaging
5. What are the complications and prognosis of Nuclear imaging?
6. What are the latest guidelines for Nuclear imaging?
7. How is Nuclear imaging managed in special populations?
8. Compare Nuclear imaging with related conditions
