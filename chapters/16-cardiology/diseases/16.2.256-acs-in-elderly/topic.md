<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/ACS_in_elderly.md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of ACS in elderly?
...
**Q2.** First-line investigation for ACS in elderly:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for ACS in elderly:
...
**Q4.** Which is a contraindication to therapy in ACS in elderly?
A. Renal dysfunction
...
**Q5.** The most common complication of ACS in elderly is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of ACS in elderly. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with ACS in elderly on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify ACS in elderly
2. Discuss the pathophysiology of ACS in elderly
3. What are the diagnostic criteria for ACS in elderly?
4. Outline the management approach to ACS in elderly
5. What are the complications and prognosis of ACS in elderly?
6. What are the latest guidelines for ACS in elderly?
7. How is ACS in elderly managed in special populations?
8. Compare ACS in elderly with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — ACS in elderly*

**Q1.** Which of the following features is most specific or characteristic of ACS in elderly?
