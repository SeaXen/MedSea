<!-- Source: /mnt/tb/Medicine/Cardiology/09_Cardiomyopathies/Risk_stratification_(HCM_Risk-SCD_score).md | section: 16.9 | hub: cardiomyopathies -->
...
**Q1.** What is the most common aetiology of Risk stratification?
...
**Q2.** First-line investigation for Risk stratification:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Risk stratification:
...
**Q4.** Which is a contraindication to therapy in Risk stratification?
A. Renal dysfunction
...
**Q5.** The most common complication of Risk stratification is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Risk stratification. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Risk stratification on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Risk stratification
2. Discuss the pathophysiology of Risk stratification
3. What are the diagnostic criteria for Risk stratification?
4. Outline the management approach to Risk stratification
5. What are the complications and prognosis of Risk stratification?
6. What are the latest guidelines for Risk stratification?
7. How is Risk stratification managed in special populations?
8. Compare Risk stratification with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Risk stratification (HCM Risk-SCD score)*

**Q1.** Which of the following features is most specific or characteristic of Risk stratification (HCM Risk-SCD score)?
