<!-- Source: /mnt/tb/Medicine/Cardiology/09_Cardiomyopathies/Non-compaction_cardiomyopathy.md | section: 16.9 | hub: cardiomyopathies -->
...
**Q1.** What is the most common aetiology of Non-compaction cardiomyopathy?
...
**Q2.** First-line investigation for Non-compaction cardiomyopathy:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Non-compaction cardiomyopathy:
...
**Q4.** Which is a contraindication to therapy in Non-compaction cardiomyopathy?
A. Renal dysfunction
...
**Q5.** The most common complication of Non-compaction cardiomyopathy is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Non-compaction cardiomyopathy. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Non-compaction cardiomyopathy on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Non-compaction cardiomyopathy
2. Discuss the pathophysiology of Non-compaction cardiomyopathy
3. What are the diagnostic criteria for Non-compaction cardiomyopathy?
4. Outline the management approach to Non-compaction cardiomyopathy
5. What are the complications and prognosis of Non-compaction cardiomyopathy?
6. What are the latest guidelines for Non-compaction cardiomyopathy?
7. How is Non-compaction cardiomyopathy managed in special populations?
8. Compare Non-compaction cardiomyopathy with related conditions
...
**File:** Non-compaction_cardiomyopathy.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Non-compaction cardiomyopathy*

**Q1.** Which of the following features is most specific or characteristic of Non-compaction cardiomyopathy?
