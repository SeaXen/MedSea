<!-- Source: /mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Variant_(Prinzmetal)_angina.md | section: 16.3 | hub: chronic-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Variant  angina?
...
**Q2.** First-line investigation for Variant  angina:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Variant  angina:
...
**Q4.** Which is a contraindication to therapy in Variant  angina?
A. Renal dysfunction
...
**Q5.** The most common complication of Variant  angina is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Variant  angina. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Variant  angina on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Variant  angina
2. Discuss the pathophysiology of Variant  angina
3. What are the diagnostic criteria for Variant  angina?
4. Outline the management approach to Variant  angina
5. What are the complications and prognosis of Variant  angina?
6. What are the latest guidelines for Variant  angina?
7. How is Variant  angina managed in special populations?
8. Compare Variant  angina with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Variant (Prinzmetal) angina*

**Q1.** Which of the following features is most specific or characteristic of Variant (Prinzmetal) angina?
