<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Transesophageal_echo_(TOE)_indications.md | section: 16.1 | hub: cardiac-investigations -->

# Transesophageal echo  indications
...
**Q1.** What is the most common aetiology of Transesophageal echo  indications?
...
**Q2.** First-line investigation for Transesophageal echo  indications:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Transesophageal echo  indications:
...
**Q4.** Which is a contraindication to therapy in Transesophageal echo  indications?
A. Renal dysfunction
...
**Q5.** The most common complication of Transesophageal echo  indications is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Transesophageal echo  indications. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Transesophageal echo  indications on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Transesophageal echo  indications
2. Discuss the pathophysiology of Transesophageal echo  indications
3. What are the diagnostic criteria for Transesophageal echo  indications?
4. Outline the management approach to Transesophageal echo  indications
5. What are the complications and prognosis of Transesophageal echo  indications?
6. What are the latest guidelines for Transesophageal echo  indications?
7. How is Transesophageal echo  indications managed in special populations?
8. Compare Transesophageal echo  indications with related conditions
...
**File:** Transesophageal_echo_indications.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Transesophageal echo (TOE) indications*

**Q1.** Which of the following features is most specific or characteristic of Transesophageal echo (TOE) indications?
...
**Q2.** What is the most appropriate first-line therapy for Transesophageal echo (TOE) indications?
