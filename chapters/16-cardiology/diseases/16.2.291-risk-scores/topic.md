<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/Risk_scores_(GRACE,_TIMI,_HEART).md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Risk scores?
...
**Q2.** First-line investigation for Risk scores:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Risk scores:
...
**Q4.** Which is a contraindication to therapy in Risk scores?
A. Renal dysfunction
...
**Q5.** The most common complication of Risk scores is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Risk scores. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Risk scores on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Risk scores
2. Discuss the pathophysiology of Risk scores
3. What are the diagnostic criteria for Risk scores?
4. Outline the management approach to Risk scores
5. What are the complications and prognosis of Risk scores?
6. What are the latest guidelines for Risk scores?
7. How is Risk scores managed in special populations?
8. Compare Risk scores with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Risk scores (GRACE, TIMI, HEART)*

**Q1.** Which of the following features is most specific or characteristic of Risk scores (GRACE, TIMI, HEART)?
