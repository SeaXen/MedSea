<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/AVNRT_AVRT_ablation.md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of AVNRT AVRT ablation?
...
**Q2.** First-line investigation for AVNRT AVRT ablation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for AVNRT AVRT ablation:
...
**Q4.** Which is a contraindication to therapy in AVNRT AVRT ablation?
A. Renal dysfunction
...
**Q5.** The most common complication of AVNRT AVRT ablation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of AVNRT AVRT ablation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with AVNRT AVRT ablation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify AVNRT AVRT ablation
2. Discuss the pathophysiology of AVNRT AVRT ablation
3. What are the diagnostic criteria for AVNRT AVRT ablation?
4. Outline the management approach to AVNRT AVRT ablation
5. What are the complications and prognosis of AVNRT AVRT ablation?
6. What are the latest guidelines for AVNRT AVRT ablation?
7. How is AVNRT AVRT ablation managed in special populations?
8. Compare AVNRT AVRT ablation with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — AVNRT AVRT ablation*

**Q1.** Which of the following features is most specific or characteristic of AVNRT AVRT ablation?
