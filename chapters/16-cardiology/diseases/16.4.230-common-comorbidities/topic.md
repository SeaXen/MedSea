<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/Common_comorbidities_(AF,_obesity,_CKD,_anemia,_iron_deficiency).md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of Common comorbidities?
...
**Q2.** First-line investigation for Common comorbidities:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Common comorbidities:
...
**Q4.** Which is a contraindication to therapy in Common comorbidities?
A. Renal dysfunction
...
**Q5.** The most common complication of Common comorbidities is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Common comorbidities. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Common comorbidities on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Common comorbidities
2. Discuss the pathophysiology of Common comorbidities
3. What are the diagnostic criteria for Common comorbidities?
4. Outline the management approach to Common comorbidities
5. What are the complications and prognosis of Common comorbidities?
6. What are the latest guidelines for Common comorbidities?
7. How is Common comorbidities managed in special populations?
8. Compare Common comorbidities with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Common comorbidities (AF*

**Q1.** Which of the following features is most specific or characteristic of Common comorbidities (AF?
