<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/Iron_deficiency_in_HF.md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of Iron deficiency in HF?
...
**Q2.** First-line investigation for Iron deficiency in HF:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Iron deficiency in HF:
...
**Q4.** Which is a contraindication to therapy in Iron deficiency in HF?
A. Renal dysfunction
...
**Q5.** The most common complication of Iron deficiency in HF is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Iron deficiency in HF. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Iron deficiency in HF on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Iron deficiency in HF
2. Discuss the pathophysiology of Iron deficiency in HF
3. What are the diagnostic criteria for Iron deficiency in HF?
4. Outline the management approach to Iron deficiency in HF
5. What are the complications and prognosis of Iron deficiency in HF?
6. What are the latest guidelines for Iron deficiency in HF?
7. How is Iron deficiency in HF managed in special populations?
8. Compare Iron deficiency in HF with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Iron deficiency in HF*

**Q1.** In the management of Iron deficiency in HF, which of the following should be avoided or is contraindicated?
...
**Q2.** What is the most appropriate first-line therapy for Iron deficiency in HF?
