<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/CRT_indications_(QRS_duration,_morphology,_LVEF).md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of CRT indications?
...
**Q2.** First-line investigation for CRT indications:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for CRT indications:
...
**Q4.** Which is a contraindication to therapy in CRT indications?
A. Renal dysfunction
...
**Q5.** The most common complication of CRT indications is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of CRT indications. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with CRT indications on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify CRT indications
2. Discuss the pathophysiology of CRT indications
3. What are the diagnostic criteria for CRT indications?
4. Outline the management approach to CRT indications
5. What are the complications and prognosis of CRT indications?
6. What are the latest guidelines for CRT indications?
7. How is CRT indications managed in special populations?
8. Compare CRT indications with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — CRT indications (QRS duration, morphology, LVEF)*

**Q1.** In the management of CRT indications (QRS duration, morphology, LVEF), which of the following should be avoided or is contraindicated?
...
**Q2.** What is the most appropriate first-line therapy for CRT indications (QRS duration, morphology, LVEF)?
