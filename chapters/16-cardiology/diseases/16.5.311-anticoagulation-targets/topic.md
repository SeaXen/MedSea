<!-- Source: /mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/Anticoagulation_targets_(INR,_DOACs_contraindicated_in_mechanical).md | section: 16.5 | hub: valvular-heart-disease -->
...
**Q1.** What is the most common aetiology of Anticoagulation targets?
...
**Q2.** First-line investigation for Anticoagulation targets:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Anticoagulation targets:
...
**Q4.** Which is a contraindication to therapy in Anticoagulation targets?
A. Renal dysfunction
...
**Q5.** The most common complication of Anticoagulation targets is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Anticoagulation targets. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Anticoagulation targets on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Anticoagulation targets
2. Discuss the pathophysiology of Anticoagulation targets
3. What are the diagnostic criteria for Anticoagulation targets?
4. Outline the management approach to Anticoagulation targets
5. What are the complications and prognosis of Anticoagulation targets?
6. What are the latest guidelines for Anticoagulation targets?
7. How is Anticoagulation targets managed in special populations?
8. Compare Anticoagulation targets with related conditions
...
**File:** Anticoagulation_targets.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Anticoagulation targets (INR*

**Q1.** Which of the following features is most specific or characteristic of Anticoagulation targets (INR?
