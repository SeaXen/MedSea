...
davidson_topic_id: "16.1.51"
topic: "ACS_in_CKD_dialysis"
...
source: "/mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/ACS_in_CKD_dialysis.md"
...
**Q1.** What is the most common aetiology of ACS in CKD dialysis?
...
**Q2.** First-line investigation for ACS in CKD dialysis:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for ACS in CKD dialysis:
...
**Q4.** Which is a contraindication to therapy in ACS in CKD dialysis?
A. Renal dysfunction
...
**Q5.** The most common complication of ACS in CKD dialysis is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of ACS in CKD dialysis. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with ACS in CKD dialysis on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify ACS in CKD dialysis
2. Discuss the pathophysiology of ACS in CKD dialysis
3. What are the diagnostic criteria for ACS in CKD dialysis?
4. Outline the management approach to ACS in CKD dialysis
5. What are the complications and prognosis of ACS in CKD dialysis?
6. What are the latest guidelines for ACS in CKD dialysis?
7. How is ACS in CKD dialysis managed in special populations?
8. Compare ACS in CKD dialysis with related conditions
