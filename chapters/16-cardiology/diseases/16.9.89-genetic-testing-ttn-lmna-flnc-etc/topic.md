<!-- Source: /mnt/tb/Medicine/Cardiology/09_Cardiomyopathies/Genetic_testing_TTN_LMNA_FLNC_etc.md | section: 16.9 | hub: cardiomyopathies -->

# Genetic testing TTN LMNA FLNC etc
...
**Q1.** What is the most common aetiology of Genetic testing TTN LMNA FLNC etc?
...
**Q2.** First-line investigation for Genetic testing TTN LMNA FLNC etc:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Genetic testing TTN LMNA FLNC etc:
...
**Q4.** Which is a contraindication to therapy in Genetic testing TTN LMNA FLNC etc?
A. Renal dysfunction
...
**Q5.** The most common complication of Genetic testing TTN LMNA FLNC etc is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Genetic testing TTN LMNA FLNC etc. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Genetic testing TTN LMNA FLNC etc on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Genetic testing TTN LMNA FLNC etc
2. Discuss the pathophysiology of Genetic testing TTN LMNA FLNC etc
3. What are the diagnostic criteria for Genetic testing TTN LMNA FLNC etc?
4. Outline the management approach to Genetic testing TTN LMNA FLNC etc
5. What are the complications and prognosis of Genetic testing TTN LMNA FLNC etc?
6. What are the latest guidelines for Genetic testing TTN LMNA FLNC etc?
7. How is Genetic testing TTN LMNA FLNC etc managed in special populations?
8. Compare Genetic testing TTN LMNA FLNC etc with related conditions
...
**File:** Genetic_testing_TTN_LMNA_FLNC_etc.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Genetic testing TTN LMNA FLNC etc*

**Q1.** Which of the following features is most specific or characteristic of Genetic testing TTN LMNA FLNC etc?
