<!-- Source: /mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Revascularization_criteria_(PCI_vs_CABG,_SYNTAX_score).md | section: 16.3 | hub: chronic-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Revascularization criteria?
...
**Q2.** First-line investigation for Revascularization criteria:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Revascularization criteria:
...
**Q4.** Which is a contraindication to therapy in Revascularization criteria?
A. Renal dysfunction
...
**Q5.** The most common complication of Revascularization criteria is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Revascularization criteria. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Revascularization criteria on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Revascularization criteria
2. Discuss the pathophysiology of Revascularization criteria
3. What are the diagnostic criteria for Revascularization criteria?
4. Outline the management approach to Revascularization criteria
5. What are the complications and prognosis of Revascularization criteria?
6. What are the latest guidelines for Revascularization criteria?
7. How is Revascularization criteria managed in special populations?
8. Compare Revascularization criteria with related conditions
...
**File:** Revascularization_criteria.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Revascularization criteria (PCI vs CABG, SYNTAX score)*

**Q1.** Which of the following features is most specific or characteristic of Revascularization criteria (PCI vs CABG, SYNTAX score)?
