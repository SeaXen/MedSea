...
davidson_topic_id: "16.4.213"
topic: "3D_mapping_systems"
...
source: "/mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/3D_mapping_systems.md"
...
**Q1.** What is the most common aetiology of 3D mapping systems?
...
**Q2.** First-line investigation for 3D mapping systems:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for 3D mapping systems:
...
**Q4.** Which is a contraindication to therapy in 3D mapping systems?
A. Renal dysfunction
...
**Q5.** The most common complication of 3D mapping systems is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of 3D mapping systems. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with 3D mapping systems on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify 3D mapping systems
2. Discuss the pathophysiology of 3D mapping systems
3. What are the diagnostic criteria for 3D mapping systems?
4. Outline the management approach to 3D mapping systems
5. What are the complications and prognosis of 3D mapping systems?
6. What are the latest guidelines for 3D mapping systems?
7. How is 3D mapping systems managed in special populations?
8. Compare 3D mapping systems with related conditions
