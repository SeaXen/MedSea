<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Drug_classes_(ACEi_ARB,_CCB,_thiazide,_beta-blocker,_MRA).md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of Drug classes?
...
**Q2.** First-line investigation for Drug classes:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Drug classes:
...
**Q4.** Which is a contraindication to therapy in Drug classes?
A. Renal dysfunction
...
**Q5.** The most common complication of Drug classes is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Drug classes. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Drug classes on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Drug classes
2. Discuss the pathophysiology of Drug classes
3. What are the diagnostic criteria for Drug classes?
4. Outline the management approach to Drug classes
5. What are the complications and prognosis of Drug classes?
6. What are the latest guidelines for Drug classes?
7. How is Drug classes managed in special populations?
8. Compare Drug classes with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Drug classes (ACEi ARB, CCB, thiazide, beta-blocker, MRA)*

**Q1.** Which of the following features is most specific or characteristic of Drug classes (ACEi ARB, CCB, thiazide, beta-blocker, MRA)?
