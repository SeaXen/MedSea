<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Classification_ACC_AHA_vs_ESC_ESH.md | section: 16.14 | hub: hypertension-cv-risk -->

# Classification ACC AHA vs ESC ESH
...
**Q1.** What is the most common aetiology of Classification ACC AHA vs ESC ESH?
...
**Q2.** First-line investigation for Classification ACC AHA vs ESC ESH:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Classification ACC AHA vs ESC ESH:
...
**Q4.** Which is a contraindication to therapy in Classification ACC AHA vs ESC ESH?
A. Renal dysfunction
...
**Q5.** The most common complication of Classification ACC AHA vs ESC ESH is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Classification ACC AHA vs ESC ESH. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Classification ACC AHA vs ESC ESH on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Classification ACC AHA vs ESC ESH
2. Discuss the pathophysiology of Classification ACC AHA vs ESC ESH
3. What are the diagnostic criteria for Classification ACC AHA vs ESC ESH?
4. Outline the management approach to Classification ACC AHA vs ESC ESH
5. What are the complications and prognosis of Classification ACC AHA vs ESC ESH?
6. What are the latest guidelines for Classification ACC AHA vs ESC ESH?
7. How is Classification ACC AHA vs ESC ESH managed in special populations?
8. Compare Classification ACC AHA vs ESC ESH with related conditions
...
**File:** Classification_ACC_AHA_vs_ESC_ESH.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Classification ACC AHA vs ESC ESH*

**Q1.** Which of the following features is most specific or characteristic of Classification ACC AHA vs ESC ESH?
