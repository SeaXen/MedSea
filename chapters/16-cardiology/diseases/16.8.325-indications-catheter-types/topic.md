<!-- Source: /mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/Indications,_catheter_types.md | section: 16.8 | hub: cardiac-devices-ep -->

# Indications, catheter types
...
**Q1.** What is the most common aetiology of Indications, catheter types?
...
**Q2.** First-line investigation for Indications, catheter types:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Indications, catheter types:
...
**Q4.** Which is a contraindication to therapy in Indications, catheter types?
A. Renal dysfunction
...
**Q5.** The most common complication of Indications, catheter types is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Indications, catheter types. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Indications, catheter types on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Indications, catheter types
2. Discuss the pathophysiology of Indications, catheter types
3. What are the diagnostic criteria for Indications, catheter types?
4. Outline the management approach to Indications, catheter types
5. What are the complications and prognosis of Indications, catheter types?
6. What are the latest guidelines for Indications, catheter types?
7. How is Indications, catheter types managed in special populations?
8. Compare Indications, catheter types with related conditions
...
**File:** Indications,_catheter_types.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Indications, catheter types*

**Q1.** Which of the following features is most specific or characteristic of Indications, catheter types?
