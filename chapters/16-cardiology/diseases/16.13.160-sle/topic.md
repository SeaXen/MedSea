<!-- Source: /mnt/tb/Medicine/Cardiology/13_Systemic_Cardiac/SLE_(pericarditis,_Libman-Sacks_endocarditis,_accelerated_CAD).md | section: 16.13 | hub: systemic-cardiac -->
...
**Q1.** What is the most common aetiology of SLE?
...
**Q2.** First-line investigation for SLE:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for SLE:
...
**Q4.** Which is a contraindication to therapy in SLE?
A. Renal dysfunction
...
**Q5.** The most common complication of SLE is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of SLE. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with SLE on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify SLE
2. Discuss the pathophysiology of SLE
3. What are the diagnostic criteria for SLE?
4. Outline the management approach to SLE
5. What are the complications and prognosis of SLE?
6. What are the latest guidelines for SLE?
7. How is SLE managed in special populations?
8. Compare SLE with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD)**

**Q1.** A patient presents with features consistent with SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD). The clinical picture is most consistent with: Clinical presentation of SLE varies by acuity (acute vs chronic), severity, and patient factors. **Cardinal symptoms**:  What is the most likely diagnosis?

  - **A.** SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD)

**Q2.** A patient is being evaluated for SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with SLE (pericarditis, Libman-Sacks endocarditis, accelerated CAD). What is the most appropriate first-line management approach?
