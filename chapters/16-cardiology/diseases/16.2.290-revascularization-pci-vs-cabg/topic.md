<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/Revascularization_PCI_vs_CABG.md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Revascularization PCI vs CABG?
...
**Q2.** First-line investigation for Revascularization PCI vs CABG:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Revascularization PCI vs CABG:
...
**Q4.** Which is a contraindication to therapy in Revascularization PCI vs CABG?
A. Renal dysfunction
...
**Q5.** The most common complication of Revascularization PCI vs CABG is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Revascularization PCI vs CABG. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Revascularization PCI vs CABG on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Revascularization PCI vs CABG
2. Discuss the pathophysiology of Revascularization PCI vs CABG
3. What are the diagnostic criteria for Revascularization PCI vs CABG?
4. Outline the management approach to Revascularization PCI vs CABG
5. What are the complications and prognosis of Revascularization PCI vs CABG?
6. What are the latest guidelines for Revascularization PCI vs CABG?
7. How is Revascularization PCI vs CABG managed in special populations?
8. Compare Revascularization PCI vs CABG with related conditions
...
**File:** Revascularization_PCI_vs_CABG.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Revascularization PCI vs CABG*

**Q1.** Which of the following features is most specific or characteristic of Revascularization PCI vs CABG?
...
**Q2.** What is the most appropriate first-line therapy for Revascularization PCI vs CABG?
