...
```mermaid
mindmap
  root((Ebstein Anomaly))
    Anatomy
      Apical displacement septal/posterior TV leaflets
      Anterior leaflet sail-like
      Atrialized RV (proximal)
    Echo
    ...
    Arrhythmias
      ...
      VT rare
    Management
      Cone repair (preferred)
      Ablation for WPW/AF
      NO digoxin/verapamil/BB in WPW+AF
