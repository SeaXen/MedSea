<!-- Source: /mnt/tb/Medicine/Cardiology/11_Pulmonary_Hypertension/Diagnostic_algorithm_(Echo,_RHC,_Vasoreactivity_testing).md | section: 16.11 | hub: pulmonary-hypertension -->
...
**Q1.** What is the most common aetiology of Diagnostic algorithm?
...
**Q2.** First-line investigation for Diagnostic algorithm:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Diagnostic algorithm:
...
**Q4.** Which is a contraindication to therapy in Diagnostic algorithm?
A. Renal dysfunction
...
**Q5.** The most common complication of Diagnostic algorithm is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Diagnostic algorithm. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Diagnostic algorithm on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Diagnostic algorithm
2. Discuss the pathophysiology of Diagnostic algorithm
3. What are the diagnostic criteria for Diagnostic algorithm?
4. Outline the management approach to Diagnostic algorithm
5. What are the complications and prognosis of Diagnostic algorithm?
6. What are the latest guidelines for Diagnostic algorithm?
7. How is Diagnostic algorithm managed in special populations?
8. Compare Diagnostic algorithm with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Diagnostic algorithm (Echo, RHC, Vasoreactivity testing)*

**Q1.** Which of the following features is most specific or characteristic of Diagnostic algorithm (Echo, RHC, Vasoreactivity testing)?
