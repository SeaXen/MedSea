<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/VF_pulseless_VT_ACLS_algorithm.md | section: 16.16 | hub: cardiac-emergencies -->

# VF pulseless VT ACLS algorithm
...
**Q1.** What is the most common aetiology of VF pulseless VT ACLS algorithm?
...
**Q2.** First-line investigation for VF pulseless VT ACLS algorithm:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for VF pulseless VT ACLS algorithm:
...
**Q4.** Which is a contraindication to therapy in VF pulseless VT ACLS algorithm?
A. Renal dysfunction
...
**Q5.** The most common complication of VF pulseless VT ACLS algorithm is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of VF pulseless VT ACLS algorithm. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with VF pulseless VT ACLS algorithm on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify VF pulseless VT ACLS algorithm
2. Discuss the pathophysiology of VF pulseless VT ACLS algorithm
3. What are the diagnostic criteria for VF pulseless VT ACLS algorithm?
4. Outline the management approach to VF pulseless VT ACLS algorithm
5. What are the complications and prognosis of VF pulseless VT ACLS algorithm?
6. What are the latest guidelines for VF pulseless VT ACLS algorithm?
7. How is VF pulseless VT ACLS algorithm managed in special populations?
8. Compare VF pulseless VT ACLS algorithm with related conditions
...
**File:** VF_pulseless_VT_ACLS_algorithm.md
