<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/AF_ablation_(pulmonary_vein_isolation,_beyond_PVI).md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of AF ablation?
...
**Q2.** First-line investigation for AF ablation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for AF ablation:
...
**Q4.** Which is a contraindication to therapy in AF ablation?
A. Renal dysfunction
...
**Q5.** The most common complication of AF ablation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of AF ablation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with AF ablation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify AF ablation
2. Discuss the pathophysiology of AF ablation
3. What are the diagnostic criteria for AF ablation?
4. Outline the management approach to AF ablation
5. What are the complications and prognosis of AF ablation?
6. What are the latest guidelines for AF ablation?
7. How is AF ablation managed in special populations?
8. Compare AF ablation with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — AF ablation (pulmonary vein isolation, beyond PVI)*

**Q1.** What is the most appropriate first-line therapy for AF ablation (pulmonary vein isolation, beyond PVI)?
