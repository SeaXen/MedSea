<!-- Source: /mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/Ablation_techniques_RF_cryo_pulsed_field.md | section: 16.8 | hub: cardiac-devices-ep -->

# Ablation techniques RF cryo pulsed field
...
**Q1.** What is the most common aetiology of Ablation techniques RF cryo pulsed field?
...
**Q2.** First-line investigation for Ablation techniques RF cryo pulsed field:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Ablation techniques RF cryo pulsed field:
...
**Q4.** Which is a contraindication to therapy in Ablation techniques RF cryo pulsed field?
A. Renal dysfunction
...
**Q5.** The most common complication of Ablation techniques RF cryo pulsed field is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Ablation techniques RF cryo pulsed field. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Ablation techniques RF cryo pulsed field on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Ablation techniques RF cryo pulsed field
2. Discuss the pathophysiology of Ablation techniques RF cryo pulsed field
3. What are the diagnostic criteria for Ablation techniques RF cryo pulsed field?
4. Outline the management approach to Ablation techniques RF cryo pulsed field
5. What are the complications and prognosis of Ablation techniques RF cryo pulsed field?
6. What are the latest guidelines for Ablation techniques RF cryo pulsed field?
7. How is Ablation techniques RF cryo pulsed field managed in special populations?
8. Compare Ablation techniques RF cryo pulsed field with related conditions
...
**File:** Ablation_techniques_RF_cryo_pulsed_field.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Ablation techniques RF cryo pulsed field*

**Q1.** Which of the following features is most specific or characteristic of Ablation techniques RF cryo pulsed field?
