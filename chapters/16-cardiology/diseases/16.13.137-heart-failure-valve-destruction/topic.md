...
davidson_topic_id: "16.13.137"
topic: "Heart_failure_(valve_destruction)"
...
source: "/mnt/tb/Medicine/Cardiology/06_Infective_Endocarditis/Heart_failure_(valve_destruction).md"
...
**Q1.** What is the most common aetiology of Heart failure?
...
**Q2.** First-line investigation for Heart failure:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Heart failure:
...
**Q4.** Which is a contraindication to therapy in Heart failure?
A. Renal dysfunction
...
**Q5.** The most common complication of Heart failure is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Heart failure. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Heart failure on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Heart failure
2. Discuss the pathophysiology of Heart failure
3. What are the diagnostic criteria for Heart failure?
4. Outline the management approach to Heart failure
5. What are the complications and prognosis of Heart failure?
6. What are the latest guidelines for Heart failure?
7. How is Heart failure managed in special populations?
8. Compare Heart failure with related conditions
