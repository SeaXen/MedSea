<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/Primary_PCI_protocol_(door-to-balloon,_stent_choice,_anticoagulation).md | section: 16.2 | hub: acute-coronary-syndromes -->
...
**Q1.** What is the most common aetiology of Primary PCI protocol?
...
**Q2.** First-line investigation for Primary PCI protocol:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Primary PCI protocol:
...
**Q4.** Which is a contraindication to therapy in Primary PCI protocol?
A. Renal dysfunction
...
**Q5.** The most common complication of Primary PCI protocol is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Primary PCI protocol. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Primary PCI protocol on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Primary PCI protocol
2. Discuss the pathophysiology of Primary PCI protocol
3. What are the diagnostic criteria for Primary PCI protocol?
4. Outline the management approach to Primary PCI protocol
5. What are the complications and prognosis of Primary PCI protocol?
6. What are the latest guidelines for Primary PCI protocol?
7. How is Primary PCI protocol managed in special populations?
8. Compare Primary PCI protocol with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Primary PCI protocol (door-to-balloon*

**Q1.** Which of the following features is most specific or characteristic of Primary PCI protocol (door-to-balloon?
