<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/MOC_file__`Cardiology_MOC.md`_(root_of__mnt_tb_Medicine_Cardiology_).md | section: 16.16 | hub: cardiac-emergencies -->

# MOC file  `Cardiology MOC`
...
**Q1.** What is the most common aetiology of MOC file  `Cardiology MOC`?
...
**Q2.** First-line investigation for MOC file  `Cardiology MOC`:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for MOC file  `Cardiology MOC`:
...
**Q4.** Which is a contraindication to therapy in MOC file  `Cardiology MOC`?
A. Renal dysfunction
...
**Q5.** The most common complication of MOC file  `Cardiology MOC` is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of MOC file  `Cardiology MOC`. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with MOC file  `Cardiology MOC` on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify MOC file  `Cardiology MOC`
2. Discuss the pathophysiology of MOC file  `Cardiology MOC`
3. What are the diagnostic criteria for MOC file  `Cardiology MOC`?
4. Outline the management approach to MOC file  `Cardiology MOC`
5. What are the complications and prognosis of MOC file  `Cardiology MOC`?
6. What are the latest guidelines for MOC file  `Cardiology MOC`?
7. How is MOC file  `Cardiology MOC` managed in special populations?
8. Compare MOC file  `Cardiology MOC` with related conditions
...
**File:** MOC_file_`Cardiology_MOC`.md
