<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Treatment_thresholds_and_targets_(ACC_AHA_vs_ESC).md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of Treatment thresholds and targets?
...
**Q2.** First-line investigation for Treatment thresholds and targets:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Treatment thresholds and targets:
...
**Q4.** Which is a contraindication to therapy in Treatment thresholds and targets?
A. Renal dysfunction
...
**Q5.** The most common complication of Treatment thresholds and targets is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Treatment thresholds and targets. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Treatment thresholds and targets on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Treatment thresholds and targets
2. Discuss the pathophysiology of Treatment thresholds and targets
3. What are the diagnostic criteria for Treatment thresholds and targets?
4. Outline the management approach to Treatment thresholds and targets
5. What are the complications and prognosis of Treatment thresholds and targets?
6. What are the latest guidelines for Treatment thresholds and targets?
7. How is Treatment thresholds and targets managed in special populations?
8. Compare Treatment thresholds and targets with related conditions
...
**File:** Treatment_thresholds_and_targets.md
