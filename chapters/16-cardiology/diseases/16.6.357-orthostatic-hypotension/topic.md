...
| **Neurogenic** | Autonomic failure (central/peripheral) | **Primary**: MSA, PD, PAF, DLB, dementia<br>**Secondary**: Diabetes, amyloidosis, Sjogren's, paraneoplastic, autoimmune |
...
```mermaid
flowchart TD
A[Confirmed OH] --> B{Non-neurogenic?}
B -->|Volume depletion| C[IV/PO fluids, treat cause]
B -->|Drug-induced| D[Stop/reduce offending drugs]
B -->|Cardiac failure| E[Optimise HF therapy]
B -->|Neurogenic| F[Stepwise non-drug → drug]
F --> F1[Non-pharmacological]
F1 --> F2[Still symptomatic?]
F2 -->|Yes| F3[Fludrocortisone 0.1–0.3 mg OD]
F3 --> F4[Still symptomatic?]
F4 -->|Yes| F5[Midodrine 2.5–10 mg TDS]
F5 --> F6[Still symptomatic?]
F6 -->|Yes| F7[Droxidopa 100–600 mg TDS]
F7 --> F8[Refractory: Pyridostigmine, octreotide, erythropoietin]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Orthostatic hypotension*

**Q1.** What is the most appropriate first-line therapy for Orthostatic hypotension?

  - **A.** Fluid bolus + 500 mL water rapidly
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Fluid bolus + 500 mL water rapidly
  >
  > *Source:* **Fluid bolus**   **500 mL water rapidly** → ↑ BP 10–20 mmHg for 30–60 min
