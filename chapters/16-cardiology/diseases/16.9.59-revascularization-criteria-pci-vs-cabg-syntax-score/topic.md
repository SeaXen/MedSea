...
davidson_topic_id: "16.9.59"
topic: "Revascularization_criteria_PCI_vs_CABG_SYNTAX_score"
...
source: "/mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Revascularization_criteria_PCI_vs_CABG_SYNTAX_score.md"
tags: [medicine, cardiology, davidson, fcps, mrcp]
---

# Revascularization criteria PCI vs CABG SYNTAX score
...
**Q1.** What is the most common aetiology of Revascularization criteria PCI vs CABG SYNTAX score?
...
**Q2.** First-line investigation for Revascularization criteria PCI vs CABG SYNTAX score:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Revascularization criteria PCI vs CABG SYNTAX score:
...
**Q4.** Which is a contraindication to therapy in Revascularization criteria PCI vs CABG SYNTAX score?
A. Renal dysfunction
...
**Q5.** The most common complication of Revascularization criteria PCI vs CABG SYNTAX score is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Revascularization criteria PCI vs CABG SYNTAX score. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Revascularization criteria PCI vs CABG SYNTAX score on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Revascularization criteria PCI vs CABG SYNTAX score
2. Discuss the pathophysiology of Revascularization criteria PCI vs CABG SYNTAX score
3. What are the diagnostic criteria for Revascularization criteria PCI vs CABG SYNTAX score?
4. Outline the management approach to Revascularization criteria PCI vs CABG SYNTAX score
5. What are the complications and prognosis of Revascularization criteria PCI vs CABG SYNTAX score?
6. What are the latest guidelines for Revascularization criteria PCI vs CABG SYNTAX score?
7. How is Revascularization criteria PCI vs CABG SYNTAX score managed in special populations?
8. Compare Revascularization criteria PCI vs CABG SYNTAX score with related conditions
...
**File:** Revascularization_criteria_PCI_vs_CABG_SYNTAX_score.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
