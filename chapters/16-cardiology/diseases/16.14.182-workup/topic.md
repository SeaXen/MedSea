<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Workup_(secondary_causes,_target_organ_damage).md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of Workup?
...
**Q2.** First-line investigation for Workup:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Workup:
...
**Q4.** Which is a contraindication to therapy in Workup?
A. Renal dysfunction
...
**Q5.** The most common complication of Workup is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Workup. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Workup on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Workup
2. Discuss the pathophysiology of Workup
3. What are the diagnostic criteria for Workup?
4. Outline the management approach to Workup
5. What are the complications and prognosis of Workup?
6. What are the latest guidelines for Workup?
7. How is Workup managed in special populations?
8. Compare Workup with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / Workup (secondary causes, target organ damage)**

**Q1.** A patient presents with features consistent with Workup (secondary causes, target organ damage). The clinical picture is most consistent with: Clinical presentation of Workup varies by acuity (acute vs chronic), severity, and patient factors. **Cardinal symptoms* What is the most likely diagnosis?

  - **A.** Workup (secondary causes, target organ damage)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of Workup (secondary causes, target organ damage)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — Workup (secondary causes, target organ damage)

**Q2.** A patient is being evaluated for Workup (secondary causes, target organ damage). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of Workup (secondary causes, target organ damage), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with Workup (secondary causes, target organ damage). What is the most appropriate first-line management approach?
