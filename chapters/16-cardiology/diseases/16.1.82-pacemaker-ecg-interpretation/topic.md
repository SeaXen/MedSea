<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Pacemaker_ECG_interpretation.md | section: 16.1 | hub: cardiac-investigations -->
...
**Pacemaker ECG interpretation**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Pacemaker ECG interpretation?
...
**Q2.** First-line investigation for Pacemaker ECG interpretation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Pacemaker ECG interpretation:
...
**Q4.** Which is a contraindication to therapy in Pacemaker ECG interpretation?
A. Renal dysfunction
...
**Q5.** The most common complication of Pacemaker ECG interpretation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Pacemaker ECG interpretation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Pacemaker ECG interpretation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Pacemaker ECG interpretation
2. Discuss the pathophysiology of Pacemaker ECG interpretation
3. What are the diagnostic criteria for Pacemaker ECG interpretation?
4. Outline the management approach to Pacemaker ECG interpretation
5. What are the complications and prognosis of Pacemaker ECG interpretation?
6. What are the latest guidelines for Pacemaker ECG interpretation?
7. How is Pacemaker ECG interpretation managed in special populations?
8. Compare Pacemaker ECG interpretation with related conditions
...
**File:** Pacemaker_ECG_interpretation.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Pacemaker ECG interpretation*

**Q1.** What is the most appropriate first-line therapy for Pacemaker ECG interpretation?
