<!-- Source: /mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/Surgical_options_(commissurotomy,_replacement).md | section: 16.5 | hub: valvular-heart-disease -->
...
**Q1.** What is the most common aetiology of Surgical options?
...
**Q2.** First-line investigation for Surgical options:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Surgical options:
...
**Q4.** Which is a contraindication to therapy in Surgical options?
A. Renal dysfunction
...
**Q5.** The most common complication of Surgical options is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Surgical options. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Surgical options on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Surgical options
2. Discuss the pathophysiology of Surgical options
3. What are the diagnostic criteria for Surgical options?
4. Outline the management approach to Surgical options
5. What are the complications and prognosis of Surgical options?
6. What are the latest guidelines for Surgical options?
7. How is Surgical options managed in special populations?
8. Compare Surgical options with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Surgical options (commissurotomy, replacement)*

**Q1.** Which of the following features is most specific or characteristic of Surgical options (commissurotomy, replacement)?
