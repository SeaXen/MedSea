<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Lipid_management_(statin_intensity,_ezetimibe,_PCSK9i).md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of Lipid management?
...
**Q2.** First-line investigation for Lipid management:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Lipid management:
...
**Q4.** Which is a contraindication to therapy in Lipid management?
A. Renal dysfunction
...
**Q5.** The most common complication of Lipid management is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Lipid management. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Lipid management on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Lipid management
2. Discuss the pathophysiology of Lipid management
3. What are the diagnostic criteria for Lipid management?
4. Outline the management approach to Lipid management
5. What are the complications and prognosis of Lipid management?
6. What are the latest guidelines for Lipid management?
7. How is Lipid management managed in special populations?
8. Compare Lipid management with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Lipid management (statin intensity, ezetimibe, PCSK9i)*

**Q1.** Which of the following features is most specific or characteristic of Lipid management (statin intensity, ezetimibe, PCSK9i)?
