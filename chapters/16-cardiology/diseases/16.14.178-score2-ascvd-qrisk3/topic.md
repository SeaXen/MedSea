<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/SCORE2,_ASCVD,_QRISK3.md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of SCORE2, ASCVD, QRISK3?
...
**Q2.** First-line investigation for SCORE2, ASCVD, QRISK3:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for SCORE2, ASCVD, QRISK3:
...
**Q4.** Which is a contraindication to therapy in SCORE2, ASCVD, QRISK3?
A. Renal dysfunction
...
**Q5.** The most common complication of SCORE2, ASCVD, QRISK3 is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of SCORE2, ASCVD, QRISK3. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with SCORE2, ASCVD, QRISK3 on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify SCORE2, ASCVD, QRISK3
2. Discuss the pathophysiology of SCORE2, ASCVD, QRISK3
3. What are the diagnostic criteria for SCORE2, ASCVD, QRISK3?
4. Outline the management approach to SCORE2, ASCVD, QRISK3
5. What are the complications and prognosis of SCORE2, ASCVD, QRISK3?
6. What are the latest guidelines for SCORE2, ASCVD, QRISK3?
7. How is SCORE2, ASCVD, QRISK3 managed in special populations?
8. Compare SCORE2, ASCVD, QRISK3 with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — SCORE2, ASCVD, QRISK3*

**Q1.** Which of the following features is most specific or characteristic of SCORE2, ASCVD, QRISK3?
