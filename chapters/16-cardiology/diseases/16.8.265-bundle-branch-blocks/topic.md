<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/Bundle_branch_blocks_(LBBB,_RBBB,_bifascicular,_trifascicular).md | section: 16.8 | hub: arrhythmias -->
...
**Bundle branch blocks**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Bundle branch blocks?
...
**Q2.** First-line investigation for Bundle branch blocks:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Bundle branch blocks:
...
**Q4.** Which is a contraindication to therapy in Bundle branch blocks?
A. Renal dysfunction
...
**Q5.** The most common complication of Bundle branch blocks is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Bundle branch blocks. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Bundle branch blocks on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Bundle branch blocks
2. Discuss the pathophysiology of Bundle branch blocks
3. What are the diagnostic criteria for Bundle branch blocks?
4. Outline the management approach to Bundle branch blocks
5. What are the complications and prognosis of Bundle branch blocks?
6. What are the latest guidelines for Bundle branch blocks?
7. How is Bundle branch blocks managed in special populations?
8. Compare Bundle branch blocks with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Bundle branch blocks (LBBB*

**Q1.** What is the most appropriate first-line therapy for Bundle branch blocks (LBBB?
