...
davidson_topic_id: "16.11.97"
topic: "CRT_indications_QRS_duration_morphology_LVEF"
...
source: "/mnt/tb/Medicine/Cardiology/04_Heart_Failure/CRT_indications_QRS_duration_morphology_LVEF.md"
tags: [medicine, cardiology, davidson, fcps, mrcp]
---

# CRT indications QRS duration morphology LVEF
...
**Q1.** What is the most common aetiology of CRT indications QRS duration morphology LVEF?
...
**Q2.** First-line investigation for CRT indications QRS duration morphology LVEF:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for CRT indications QRS duration morphology LVEF:
...
**Q4.** Which is a contraindication to therapy in CRT indications QRS duration morphology LVEF?
A. Renal dysfunction
...
**Q5.** The most common complication of CRT indications QRS duration morphology LVEF is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of CRT indications QRS duration morphology LVEF. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with CRT indications QRS duration morphology LVEF on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify CRT indications QRS duration morphology LVEF
2. Discuss the pathophysiology of CRT indications QRS duration morphology LVEF
3. What are the diagnostic criteria for CRT indications QRS duration morphology LVEF?
4. Outline the management approach to CRT indications QRS duration morphology LVEF
5. What are the complications and prognosis of CRT indications QRS duration morphology LVEF?
6. What are the latest guidelines for CRT indications QRS duration morphology LVEF?
7. How is CRT indications QRS duration morphology LVEF managed in special populations?
8. Compare CRT indications QRS duration morphology LVEF with related conditions
...
**File:** CRT_indications_QRS_duration_morphology_LVEF.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
