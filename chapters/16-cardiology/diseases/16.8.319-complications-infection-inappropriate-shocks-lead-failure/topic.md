<!-- Source: /mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/Complications_infection_inappropriate_shocks_lead_failure.md | section: 16.8 | hub: cardiac-devices-ep -->

# Complications infection inappropriate shocks lead failure
...
**Q1.** What is the most common aetiology of Complications infection inappropriate shocks lead failure?
...
**Q2.** First-line investigation for Complications infection inappropriate shocks lead failure:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Complications infection inappropriate shocks lead failure:
...
**Q4.** Which is a contraindication to therapy in Complications infection inappropriate shocks lead failure?
A. Renal dysfunction
...
**Q5.** The most common complication of Complications infection inappropriate shocks lead failure is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Complications infection inappropriate shocks lead failure. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Complications infection inappropriate shocks lead failure on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Complications infection inappropriate shocks lead failure
2. Discuss the pathophysiology of Complications infection inappropriate shocks lead failure
3. What are the diagnostic criteria for Complications infection inappropriate shocks lead failure?
4. Outline the management approach to Complications infection inappropriate shocks lead failure
5. What are the complications and prognosis of Complications infection inappropriate shocks lead failure?
6. What are the latest guidelines for Complications infection inappropriate shocks lead failure?
7. How is Complications infection inappropriate shocks lead failure managed in special populations?
8. Compare Complications infection inappropriate shocks lead failure with related conditions
...
**File:** Complications_infection_inappropriate_shocks_lead_failure.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Complications infection inappropriate shocks lead failure*

**Q1.** Which of the following features is most specific or characteristic of Complications infection inappropriate shocks lead failure?
