<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/Coronary_angiography_post_ROSC.md | section: 16.16 | hub: cardiac-emergencies -->
...
**Q1.** What is the most common aetiology of Coronary angiography post ROSC?
...
**Q2.** First-line investigation for Coronary angiography post ROSC:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Coronary angiography post ROSC:
...
**Q4.** Which is a contraindication to therapy in Coronary angiography post ROSC?
A. Renal dysfunction
...
**Q5.** The most common complication of Coronary angiography post ROSC is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Coronary angiography post ROSC. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Coronary angiography post ROSC on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Coronary angiography post ROSC
2. Discuss the pathophysiology of Coronary angiography post ROSC
3. What are the diagnostic criteria for Coronary angiography post ROSC?
4. Outline the management approach to Coronary angiography post ROSC
5. What are the complications and prognosis of Coronary angiography post ROSC?
6. What are the latest guidelines for Coronary angiography post ROSC?
7. How is Coronary angiography post ROSC managed in special populations?
8. Compare Coronary angiography post ROSC with related conditions
...
**File:** Coronary_angiography_post_ROSC.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Coronary angiography post-ROSC*

**Q1.** Which of the following features is most specific or characteristic of Coronary angiography post-ROSC?
