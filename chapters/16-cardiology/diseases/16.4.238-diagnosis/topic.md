<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/Diagnosis_(HFA-PEFF,_H2FPEF_scores).md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of Diagnosis?
...
**Q2.** First-line investigation for Diagnosis:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Diagnosis:
...
**Q4.** Which is a contraindication to therapy in Diagnosis?
A. Renal dysfunction
...
**Q5.** The most common complication of Diagnosis is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Diagnosis. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Diagnosis on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Diagnosis
2. Discuss the pathophysiology of Diagnosis
3. What are the diagnostic criteria for Diagnosis?
4. Outline the management approach to Diagnosis
5. What are the complications and prognosis of Diagnosis?
6. What are the latest guidelines for Diagnosis?
7. How is Diagnosis managed in special populations?
8. Compare Diagnosis with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / Diagnosis (HFA-PEFF, H2FPEF scores)**

**Q1.** A patient presents with features consistent with Diagnosis (HFA-PEFF, H2FPEF scores). The clinical picture is most consistent with: Clinical presentation of Diagnosis varies by acuity (acute vs chronic), severity, and patient factors. **Cardinal sympto What is the most likely diagnosis?

  - **A.** Diagnosis (HFA-PEFF, H2FPEF scores)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of Diagnosis (HFA-PEFF, H2FPEF scores)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — Diagnosis (HFA-PEFF, H2FPEF scores)

**Q2.** A patient is being evaluated for Diagnosis (HFA-PEFF, H2FPEF scores). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of Diagnosis (HFA-PEFF, H2FPEF scores), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with Diagnosis (HFA-PEFF, H2FPEF scores). What is the most appropriate first-line management approach?
