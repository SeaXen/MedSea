<!-- Source: /mnt/tb/Medicine/Cardiology/14_Hypertension_CV_Risk/Classification_(ACC_AHA_vs_ESC_ESH).md | section: 16.14 | hub: hypertension-cv-risk -->
...
**Q1.** What is the most common aetiology of Classification?
...
**Q2.** First-line investigation for Classification:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Classification:
...
**Q4.** Which is a contraindication to therapy in Classification?
A. Renal dysfunction
...
**Q5.** The most common complication of Classification is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Classification. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Classification on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Classification
2. Discuss the pathophysiology of Classification
3. What are the diagnostic criteria for Classification?
4. Outline the management approach to Classification
5. What are the complications and prognosis of Classification?
6. What are the latest guidelines for Classification?
7. How is Classification managed in special populations?
8. Compare Classification with related conditions
