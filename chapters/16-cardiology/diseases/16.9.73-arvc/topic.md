<!-- Source: /mnt/tb/Medicine/Cardiology/09_Cardiomyopathies/ARVC_(Task_Force_Criteria,_PKP2_mutations).md | section: 16.9 | hub: cardiomyopathies -->
...
**Q1.** What is the most common aetiology of ARVC?
...
**Q2.** First-line investigation for ARVC:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for ARVC:
...
**Q4.** Which is a contraindication to therapy in ARVC?
A. Renal dysfunction
...
**Q5.** The most common complication of ARVC is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of ARVC. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with ARVC on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify ARVC
2. Discuss the pathophysiology of ARVC
3. What are the diagnostic criteria for ARVC?
4. Outline the management approach to ARVC
5. What are the complications and prognosis of ARVC?
6. What are the latest guidelines for ARVC?
7. How is ARVC managed in special populations?
8. Compare ARVC with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / ARVC (Task Force Criteria, PKP2 mutations)**

**Q1.** A patient presents with features consistent with ARVC (Task Force Criteria, PKP2 mutations). The clinical picture is most consistent with: **Asymptomatic** (most). **Symptoms**: dyspnoea (diastolic dysfunction, MR, LVOT), chest pain (ischaemia, microvascular) What is the most likely diagnosis?

  - **A.** ARVC (Task Force Criteria, PKP2 mutations)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of ARVC (Task Force Criteria, PKP2 mutations)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — ARVC (Task Force Criteria, PKP2 mutations)

**Q2.** A patient is being evaluated for ARVC (Task Force Criteria, PKP2 mutations). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of ARVC (Task Force Criteria, PKP2 mutations), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with ARVC (Task Force Criteria, PKP2 mutations). What is the most appropriate first-line management approach?
