<!-- Source: /mnt/tb/Medicine/Cardiology/10_Adult_Congenital_Heart_Disease/Atrial_Septal_Defect_(ASD)_-_types,_closure_criteria,_transcatheter_vs_surgical.md | section: 16.10 | hub: adult-congenital-heart-disease -->

# Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical
...
**Q1.** What is the most common aetiology of Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical?
...
**Q2.** First-line investigation for Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical:
...
**Q4.** Which is a contraindication to therapy in Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical?
A. Renal dysfunction
...
**Q5.** The most common complication of Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical
2. Discuss the pathophysiology of Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical
3. What are the diagnostic criteria for Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical?
4. Outline the management approach to Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical
5. What are the complications and prognosis of Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical?
6. What are the latest guidelines for Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical?
7. How is Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical managed in special populations?
8. Compare Atrial Septal Defect  - types, closure criteria, transcatheter vs surgical with related conditions
...
**File:** Atrial_Septal_Defect_-_types,_closure_criteria,_transcatheter_vs_surgical.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Atrial Septal Defect (ASD)*

**Q1.** Which of the following features is most specific or characteristic of Atrial Septal Defect (ASD)?
