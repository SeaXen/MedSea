<!-- Source: /mnt/tb/Medicine/Cardiology/06_Infective_Endocarditis/Abscess_formation_(aortic_root,_mitral-aortic_intervalvular_fibrosa).md | section: 16.6 | hub: infective-endocarditis -->
...
**Q1.** What is the most common aetiology of Abscess formation?
...
**Q2.** First-line investigation for Abscess formation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Abscess formation:
...
**Q4.** Which is a contraindication to therapy in Abscess formation?
A. Renal dysfunction
...
**Q5.** The most common complication of Abscess formation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Abscess formation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Abscess formation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Abscess formation
2. Discuss the pathophysiology of Abscess formation
3. What are the diagnostic criteria for Abscess formation?
4. Outline the management approach to Abscess formation
5. What are the complications and prognosis of Abscess formation?
6. What are the latest guidelines for Abscess formation?
7. How is Abscess formation managed in special populations?
8. Compare Abscess formation with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Abscess formation (aortic root*

**Q1.** Which of the following features is most specific or characteristic of Abscess formation (aortic root?
