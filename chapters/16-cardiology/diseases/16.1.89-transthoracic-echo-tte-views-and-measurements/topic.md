<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Transthoracic_echo_TTE_views_and_measurements.md | section: 16.1 | hub: cardiac-investigations -->

# Transthoracic echo TTE views and measurements
...
**Q1.** What is the most common aetiology of Transthoracic echo TTE views and measurements?
...
**Q2.** First-line investigation for Transthoracic echo TTE views and measurements:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Transthoracic echo TTE views and measurements:
...
**Q4.** Which is a contraindication to therapy in Transthoracic echo TTE views and measurements?
A. Renal dysfunction
...
**Q5.** The most common complication of Transthoracic echo TTE views and measurements is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Transthoracic echo TTE views and measurements. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Transthoracic echo TTE views and measurements on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Transthoracic echo TTE views and measurements
2. Discuss the pathophysiology of Transthoracic echo TTE views and measurements
3. What are the diagnostic criteria for Transthoracic echo TTE views and measurements?
4. Outline the management approach to Transthoracic echo TTE views and measurements
5. What are the complications and prognosis of Transthoracic echo TTE views and measurements?
6. What are the latest guidelines for Transthoracic echo TTE views and measurements?
7. How is Transthoracic echo TTE views and measurements managed in special populations?
8. Compare Transthoracic echo TTE views and measurements with related conditions
...
**File:** Transthoracic_echo_TTE_views_and_measurements.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Transthoracic echo TTE views and measurements*

**Q1.** Which of the following features is most specific or characteristic of Transthoracic echo TTE views and measurements?
...
**Q2.** What is the most appropriate first-line therapy for Transthoracic echo TTE views and measurements?
