<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/PVC_ablation.md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of PVC ablation?
...
**Q2.** First-line investigation for PVC ablation:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for PVC ablation:
...
**Q4.** Which is a contraindication to therapy in PVC ablation?
A. Renal dysfunction
...
**Q5.** The most common complication of PVC ablation is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of PVC ablation. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with PVC ablation on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify PVC ablation
2. Discuss the pathophysiology of PVC ablation
3. What are the diagnostic criteria for PVC ablation?
4. Outline the management approach to PVC ablation
5. What are the complications and prognosis of PVC ablation?
6. What are the latest guidelines for PVC ablation?
7. How is PVC ablation managed in special populations?
8. Compare PVC ablation with related conditions
