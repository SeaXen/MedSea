<!-- Source: /mnt/tb/Medicine/Cardiology/10_Adult_Congenital_Heart_Disease/Ventricular_Septal_Defect_(VSD)_-_types,_closure.md | section: 16.10 | hub: adult-congenital-heart-disease -->

# Ventricular Septal Defect  - types, closure
...
**Q1.** What is the most common aetiology of Ventricular Septal Defect  - types, closure?
...
**Q2.** First-line investigation for Ventricular Septal Defect  - types, closure:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Ventricular Septal Defect  - types, closure:
...
**Q4.** Which is a contraindication to therapy in Ventricular Septal Defect  - types, closure?
A. Renal dysfunction
...
**Q5.** The most common complication of Ventricular Septal Defect  - types, closure is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Ventricular Septal Defect  - types, closure. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Ventricular Septal Defect  - types, closure on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Ventricular Septal Defect  - types, closure
2. Discuss the pathophysiology of Ventricular Septal Defect  - types, closure
3. What are the diagnostic criteria for Ventricular Septal Defect  - types, closure?
4. Outline the management approach to Ventricular Septal Defect  - types, closure
5. What are the complications and prognosis of Ventricular Septal Defect  - types, closure?
6. What are the latest guidelines for Ventricular Septal Defect  - types, closure?
7. How is Ventricular Septal Defect  - types, closure managed in special populations?
8. Compare Ventricular Septal Defect  - types, closure with related conditions
...
**File:** Ventricular_Septal_Defect_-_types,_closure.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Ventricular Septal Defect (VSD) - types, closure*

**Q1.** Which of the following features is most specific or characteristic of Ventricular Septal Defect (VSD) - types, closure?
