<!-- Source: /mnt/tb/Medicine/Cardiology/11_Pulmonary_Hypertension/Risk_stratification_REVEAL_20_ESC_ERS_risk_table.md | section: 16.11 | hub: pulmonary-hypertension -->

# Risk stratification REVEAL 20 ESC ERS risk table
...
**Q1.** What is the most common aetiology of Risk stratification REVEAL 20 ESC ERS risk table?
...
**Q2.** First-line investigation for Risk stratification REVEAL 20 ESC ERS risk table:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Risk stratification REVEAL 20 ESC ERS risk table:
...
**Q4.** Which is a contraindication to therapy in Risk stratification REVEAL 20 ESC ERS risk table?
A. Renal dysfunction
...
**Q5.** The most common complication of Risk stratification REVEAL 20 ESC ERS risk table is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Risk stratification REVEAL 20 ESC ERS risk table. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Risk stratification REVEAL 20 ESC ERS risk table on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Risk stratification REVEAL 20 ESC ERS risk table
2. Discuss the pathophysiology of Risk stratification REVEAL 20 ESC ERS risk table
3. What are the diagnostic criteria for Risk stratification REVEAL 20 ESC ERS risk table?
4. Outline the management approach to Risk stratification REVEAL 20 ESC ERS risk table
5. What are the complications and prognosis of Risk stratification REVEAL 20 ESC ERS risk table?
6. What are the latest guidelines for Risk stratification REVEAL 20 ESC ERS risk table?
7. How is Risk stratification REVEAL 20 ESC ERS risk table managed in special populations?
8. Compare Risk stratification REVEAL 20 ESC ERS risk table with related conditions
...
**File:** Risk_stratification_REVEAL_20_ESC_ERS_risk_table.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Risk stratification REVEAL 20 ESC ERS risk table*

**Q1.** Which of the following features is most specific or characteristic of Risk stratification REVEAL 20 ESC ERS risk table?
