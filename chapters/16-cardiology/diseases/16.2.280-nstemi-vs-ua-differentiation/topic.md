<!-- Source: /mnt/tb/Medicine/Cardiology/02_Acute_Coronary_Syndromes/NSTEMI_vs_UA_differentiation.md | section: 16.2 | hub: acute-coronary-syndromes -->
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — NSTEMI vs UA differentiation*

**Q1.** Which of the following features is most specific or characteristic of NSTEMI vs UA differentiation?
...
**Q2.** What is the most appropriate first-line therapy for NSTEMI vs UA differentiation?
