<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/Definition_(LVEF_≤40%),_epidemiology,_pathophysiology.md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of Definition , epidemiology, pathophysiology?
...
**Q2.** First-line investigation for Definition , epidemiology, pathophysiology:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Definition , epidemiology, pathophysiology:
...
**Q4.** Which is a contraindication to therapy in Definition , epidemiology, pathophysiology?
A. Renal dysfunction
...
**Q5.** The most common complication of Definition , epidemiology, pathophysiology is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Definition , epidemiology, pathophysiology. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Definition , epidemiology, pathophysiology on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Definition , epidemiology, pathophysiology
2. Discuss the pathophysiology of Definition , epidemiology, pathophysiology
3. What are the diagnostic criteria for Definition , epidemiology, pathophysiology?
4. Outline the management approach to Definition , epidemiology, pathophysiology
5. What are the complications and prognosis of Definition , epidemiology, pathophysiology?
6. What are the latest guidelines for Definition , epidemiology, pathophysiology?
7. How is Definition , epidemiology, pathophysiology managed in special populations?
8. Compare Definition , epidemiology, pathophysiology with related conditions
...
**File:** Definition_,_epidemiology,_pathophysiology.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Definition (LVEF ≤40%), epidemiology, pathophysiology*

**Q1.** Which of the following features is most specific or characteristic of Definition (LVEF ≤40%), epidemiology, pathophysiology?
