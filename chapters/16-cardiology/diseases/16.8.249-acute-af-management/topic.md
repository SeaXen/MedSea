<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/Acute_AF_management_(rate_vs_rhythm,_cardioversion).md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of Acute AF management?
...
**Q2.** First-line investigation for Acute AF management:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Acute AF management:
...
**Q4.** Which is a contraindication to therapy in Acute AF management?
A. Renal dysfunction
...
**Q5.** The most common complication of Acute AF management is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Acute AF management. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Acute AF management on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Acute AF management
2. Discuss the pathophysiology of Acute AF management
3. What are the diagnostic criteria for Acute AF management?
4. Outline the management approach to Acute AF management
5. What are the complications and prognosis of Acute AF management?
6. What are the latest guidelines for Acute AF management?
7. How is Acute AF management managed in special populations?
8. Compare Acute AF management with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Acute AF management (rate vs rhythm, cardioversion)*

**Q1.** What is the most appropriate first-line therapy for Acute AF management (rate vs rhythm, cardioversion)?
