<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Chamber_enlargement_LAE_RAE_LVH_RVH.md | section: 16.1 | hub: cardiac-investigations -->
...
**Q1.** What is the most common aetiology of Chamber enlargement LAE RAE LVH RVH?
...
**Q2.** First-line investigation for Chamber enlargement LAE RAE LVH RVH:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Chamber enlargement LAE RAE LVH RVH:
...
**Q4.** Which is a contraindication to therapy in Chamber enlargement LAE RAE LVH RVH?
A. Renal dysfunction
...
**Q5.** The most common complication of Chamber enlargement LAE RAE LVH RVH is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Chamber enlargement LAE RAE LVH RVH. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Chamber enlargement LAE RAE LVH RVH on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Chamber enlargement LAE RAE LVH RVH
2. Discuss the pathophysiology of Chamber enlargement LAE RAE LVH RVH
3. What are the diagnostic criteria for Chamber enlargement LAE RAE LVH RVH?
4. Outline the management approach to Chamber enlargement LAE RAE LVH RVH
5. What are the complications and prognosis of Chamber enlargement LAE RAE LVH RVH?
6. What are the latest guidelines for Chamber enlargement LAE RAE LVH RVH?
7. How is Chamber enlargement LAE RAE LVH RVH managed in special populations?
8. Compare Chamber enlargement LAE RAE LVH RVH with related conditions
...
**File:** Chamber_enlargement_LAE_RAE_LVH_RVH.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Chamber enlargement LAE RAE LVH RVH*

**Q1.** Which of the following features is most specific or characteristic of Chamber enlargement LAE RAE LVH RVH?
...
**Q2.** What is the most appropriate first-line therapy for Chamber enlargement LAE RAE LVH RVH?
