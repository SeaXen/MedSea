<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/STEMI_primary_PCI_lt90_min_fibrinolysis_if_PCI_gt120_min.md | section: 16.16 | hub: cardiac-emergencies -->

# STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min
...
**Q1.** What is the most common aetiology of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
...
**Q2.** First-line investigation for STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min:
...
**Q4.** Which is a contraindication to therapy in STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
A. Renal dysfunction
...
**Q5.** The most common complication of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min
2. Discuss the pathophysiology of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min
3. What are the diagnostic criteria for STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
4. Outline the management approach to STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min
5. What are the complications and prognosis of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
6. What are the latest guidelines for STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
7. How is STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min managed in special populations?
8. Compare STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min with related conditions
...
**File:** STEMI_primary_PCI_lt90_min_fibrinolysis_if_PCI_gt120_min.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min*

**Q1.** Which of the following features is most specific or characteristic of STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
...
**Q2.** What is the most appropriate first-line therapy for STEMI primary PCI lt90 min fibrinolysis if PCI gt120 min?
