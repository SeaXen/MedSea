...
davidson_topic_id: "16.17.127"
topic: "Combined_AS_+_MR"
...
source: "/mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/Combined_AS_+_MR.md"
...
**Q1.** What is the most common aetiology of Combined AS + MR?
...
**Q2.** First-line investigation for Combined AS + MR:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Combined AS + MR:
...
**Q4.** Which is a contraindication to therapy in Combined AS + MR?
A. Renal dysfunction
...
**Q5.** The most common complication of Combined AS + MR is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Combined AS + MR. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Combined AS + MR on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Combined AS + MR
2. Discuss the pathophysiology of Combined AS + MR
3. What are the diagnostic criteria for Combined AS + MR?
4. Outline the management approach to Combined AS + MR
5. What are the complications and prognosis of Combined AS + MR?
6. What are the latest guidelines for Combined AS + MR?
7. How is Combined AS + MR managed in special populations?
8. Compare Combined AS + MR with related conditions
