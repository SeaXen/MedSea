<!-- Source: /mnt/tb/Medicine/Cardiology/15_Special_Populations/Vascular_calcification.md | section: 16.15 | hub: special-populations -->
...
**Q1.** What is the most common aetiology of Vascular calcification?
...
**Q2.** First-line investigation for Vascular calcification:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Vascular calcification:
...
**Q4.** Which is a contraindication to therapy in Vascular calcification?
A. Renal dysfunction
...
**Q5.** The most common complication of Vascular calcification is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Vascular calcification. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Vascular calcification on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Vascular calcification
2. Discuss the pathophysiology of Vascular calcification
3. What are the diagnostic criteria for Vascular calcification?
4. Outline the management approach to Vascular calcification
5. What are the complications and prognosis of Vascular calcification?
6. What are the latest guidelines for Vascular calcification?
7. How is Vascular calcification managed in special populations?
8. Compare Vascular calcification with related conditions
...
**File:** Vascular_calcification.md
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Vascular calcification*

**Q1.** Which of the following features is most specific or characteristic of Vascular calcification?
