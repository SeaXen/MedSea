<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/AV_block_(1st,_2nd_type_I_II,_3rd_degree).md | section: 16.8 | hub: arrhythmias -->
...
**AV block**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of AV block?
...
**Q2.** First-line investigation for AV block:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for AV block:
...
**Q4.** Which is a contraindication to therapy in AV block?
A. Renal dysfunction
...
**Q5.** The most common complication of AV block is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of AV block. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with AV block on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify AV block
2. Discuss the pathophysiology of AV block
3. What are the diagnostic criteria for AV block?
4. Outline the management approach to AV block
5. What are the complications and prognosis of AV block?
6. What are the latest guidelines for AV block?
7. How is AV block managed in special populations?
8. Compare AV block with related conditions
