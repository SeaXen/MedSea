<!-- Source: /mnt/tb/Medicine/Cardiology/08_Arrhythmias/Post-op_AF_(post-cardiac_surgery).md | section: 16.8 | hub: arrhythmias -->
...
**Q1.** What is the most common aetiology of Post-op AF?
...
**Q2.** First-line investigation for Post-op AF:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Post-op AF:
...
**Q4.** Which is a contraindication to therapy in Post-op AF?
A. Renal dysfunction
...
**Q5.** The most common complication of Post-op AF is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Post-op AF. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Post-op AF on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Post-op AF
2. Discuss the pathophysiology of Post-op AF
3. What are the diagnostic criteria for Post-op AF?
4. Outline the management approach to Post-op AF
5. What are the complications and prognosis of Post-op AF?
6. What are the latest guidelines for Post-op AF?
7. How is Post-op AF managed in special populations?
8. Compare Post-op AF with related conditions
