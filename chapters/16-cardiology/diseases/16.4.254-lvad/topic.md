<!-- Source: /mnt/tb/Medicine/Cardiology/04_Heart_Failure/LVAD_(Bridge_to_transplant,_destination_therapy).md | section: 16.4 | hub: heart-failure -->
...
**Q1.** What is the most common aetiology of LVAD?
...
**Q2.** First-line investigation for LVAD:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for LVAD:
...
**Q4.** Which is a contraindication to therapy in LVAD?
A. Renal dysfunction
...
**Q5.** The most common complication of LVAD is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of LVAD. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with LVAD on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify LVAD
2. Discuss the pathophysiology of LVAD
3. What are the diagnostic criteria for LVAD?
4. Outline the management approach to LVAD
5. What are the complications and prognosis of LVAD?
6. What are the latest guidelines for LVAD?
7. How is LVAD managed in special populations?
8. Compare LVAD with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source content. Each scenario is a clinical vignette with 4 options. **Source: Ch 16: Cardiology / LVAD (Bridge to transplant, destination therapy)**

**Q1.** A patient presents with features consistent with LVAD (Bridge to transplant, destination therapy). The clinical picture is most consistent with: Dyspnoea (exertional, orthopnoea, PND, bendopnoea), fatigue, exercise intolerance, peripheral/sacral oedema, nocturia, a What is the most likely diagnosis?

  - **A.** LVAD (Bridge to transplant, destination therapy)
  - **B.** A closely related condition in the same clinical area
  - **C.** A complication of LVAD (Bridge to transplant, destination therapy)
  - **D.** An unrelated mimic with overlapping features

  > **Answer: A** — LVAD (Bridge to transplant, destination therapy)

**Q2.** A patient is being evaluated for LVAD (Bridge to transplant, destination therapy). Based on standard diagnostic approach, what is the most appropriate first-line investigation?
...
**Q3.** In the assessment of LVAD (Bridge to transplant, destination therapy), severity and risk stratification are essential. Which approach is most appropriate?
...
**Q4.** A patient is diagnosed with LVAD (Bridge to transplant, destination therapy). What is the most appropriate first-line management approach?
