<!-- Source: /mnt/tb/Medicine/Cardiology/06_Infective_Endocarditis/Common_organisms_(Staph_aureus,_Viridans_streptococci,_Enterococcus,_HACEK,_fungi).md | section: 16.6 | hub: infective-endocarditis -->
...
**Q1.** What is the most common aetiology of Common organisms?
...
**Q2.** First-line investigation for Common organisms:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Common organisms:
...
**Q4.** Which is a contraindication to therapy in Common organisms?
A. Renal dysfunction
...
**Q5.** The most common complication of Common organisms is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Common organisms. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Common organisms on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Common organisms
2. Discuss the pathophysiology of Common organisms
3. What are the diagnostic criteria for Common organisms?
4. Outline the management approach to Common organisms
5. What are the complications and prognosis of Common organisms?
6. What are the latest guidelines for Common organisms?
7. How is Common organisms managed in special populations?
8. Compare Common organisms with related conditions
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 16: Cardiology — Common organisms (Staph aureus*

**Q1.** Which of the following features is most specific or characteristic of Common organisms (Staph aureus?
