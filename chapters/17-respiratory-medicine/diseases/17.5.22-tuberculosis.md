...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Tuberculosis*

**Q1.** Which of the following features is most specific or characteristic of Tuberculosis?
  ...
  > **Answer: A** — Urine
  >
  > *Source:* n, ↓ glucose (<2.2 mmol/L or <50% serum), ↑ ADA, **NAAT (Xpert Ultra on CSF) — sensitivity ~50%**
- **Urine (GU TB)**: 3 early-morning urines for AFB; **sterile pyuria** is the hallmark
- **Bone marro

**Q2.** What is the most appropriate first-line therapy for Tuberculosis?
  ...
  > **Answer: A** — Daily DOT
  >
  > *Source:* **Daily DOT** (directly observed therapy) preferred
