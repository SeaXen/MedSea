...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Small-cell vs non-small-cell lung cancer*

**Q1.** In the management of Small-cell vs non-small-cell lung cancer, which of the following should be avoided or is contraindicated?

  - **A.** anticoagulation decisions (avoid in concurrent PE or AF exists)
  ...
  > **Answer: A** — anticoagulation decisions (avoid in concurrent PE or AF exists)
  >
  > *Source:* - Hemoptysis and airway obstruction require careful anticoagulation decisions if concurrent PE or AF exists.
### Common procedures
- bronchoscopy with biopsy
- EBUS-guided nodal sampling
- CT-guided t
