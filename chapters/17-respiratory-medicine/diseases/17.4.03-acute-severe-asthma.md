...
davidson_topic_id: "17.4.03"
topic: "Acute severe asthma"
...
source: "/mnt/tb/Medicine/Respiratory/Airway Diseases/Acute severe asthma.md"
...
```mermaid
flowchart TD
A[Suspected acute asthma exacerbation] --> B[Immediate ABC assessment]
B --> C[Check severity: RR HR speech SpO2 PEF]
C --> D[Give oxygen to target SpO2 94 to 98 percent]
D --> E[Nebulized salbutamol]
E --> F[Add nebulized ipratropium if severe]
F --> G[Give systemic corticosteroid early]
G --> H[Reassess response and repeat bronchodilator]
H --> I{Poor response or life-threatening features?}
I -- Yes --> J[Senior review ICU/anaesthesia alert ABG MgSO4 continuous nebulization]
I -- No --> K[Observe and plan further disposition]
J --> L{Exhaustion rising PaCO2 silent chest?}
L -- Yes --> M[Intubation/ventilation by experienced team]
L -- No --> N[Continue intensive medical therapy and close monitoring]
```
...
```mermaid
flowchart LR
A[Acute asthma attack] --> B{Severe criteria present?}
B -- No --> C[Moderate exacerbation pathway]
B -- Yes --> D[Acute severe asthma]
D --> E[Oxygen + salbutamol + ipratropium + steroid]
E --> F[Reassess PEF SpO2 effort ABG]
F --> G{Improving?}
G -- Yes --> H[Observe admit or discharge safely]
G -- No --> I[Magnesium + senior/ICU review]
I --> J{Exhaustion or rising CO2?}
J -- Yes --> K[Intubation/ventilation]
J -- No --> L[Continue intensive treatment and monitoring]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Acute severe asthma*

**Q1.** What is the most appropriate first-line therapy for Acute severe asthma?
  ...
  >
  > *Source:* give **IV magnesium sulfate 1.2–2 g over about 20 minutes** in severe or life-threatening attack not responding adequately
