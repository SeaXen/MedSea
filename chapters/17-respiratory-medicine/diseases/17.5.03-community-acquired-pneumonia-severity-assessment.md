...
davidson_topic_id: "17.5.03"
topic: "Community-acquired pneumonia severity assessment"
...
source: "/mnt/tb/Medicine/Respiratory/Respiratory Infections/Community-acquired pneumonia severity assessment.md"
...
```mermaid
flowchart TD
A[Suspected CAP] --> B[Confirm clinical syndrome and CXR]
B --> C[Assess ABCDE and oxygenation]
C --> D[Apply CURB-65 or CRB-65]
D --> E[Look for red flags beyond the score]
E --> F{Low risk and stable?}
F -- Yes --> G[Consider outpatient treatment]
F -- No --> H[Admit]
H --> I{Severe red flags or CURB-65 3 to 5?}
I -- Yes --> J[Urgent senior review / HDU ICU consideration]
I -- No --> K[Ward care with monitoring]
```
...
```mermaid
flowchart LR
A[CAP diagnosed] --> B[Check ABCDE SpO2 BP RR confusion]
B --> C[Calculate CURB-65]
C --> D{0 to 1 and clinically stable?}
D -- Yes --> E[Consider outpatient treatment]
D -- No --> F[Admit]
F --> G{CURB-65 3 to 5 or red flags?}
G -- Yes --> H[ICU/HDU level review]
G -- No --> I[Ward management]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Community-acquired pneumonia severity assessment*

**Q1.** What is the most appropriate first-line therapy for Community-acquired pneumonia severity assessment?

  - **A.** Use oxygen to maintain adequate saturation
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Use oxygen to maintain adequate saturation
  >
  > *Source:* Use oxygen to maintain adequate saturation.
