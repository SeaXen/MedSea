...
source: "/mnt/tb/Medicine/Respiratory/Airway Diseases/Alpha-1 antitrypsin deficiency.md"
...
```mermaid
flowchart TD
  A[Suspected A1ATD] --> B[Serum A1AT Level]
  B -->|Low <1.1 g/L| C[Phenotyping / Genotyping]
  B -->|Normal| D[Exclude Significant Deficiency]
  C --> E{ZZ Phenotype?}
  E -->|Yes| F[Diagnosis Confirmed]
  E -->|MZ/SZ| G[Intermediate Risk\nCounsel Smoking Cessation]
  E -->|Null| H[Severe Lung, No Liver\nNo Augmentation Substrate]
  F --> I[Assess Organ Involvement]
  I --> J{Lung: FEV1 30-65%\n+ Emphysema}
  J -->|Yes| K[Augmentation 60mg/kg/wk IV]
  J -->|No| L[Monitor, Smoking Cessation]
  I --> M{Liver: LFTs, US,\nFibroScan}
  M -->|Cirrhosis| N[Transplant Evaluation]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Alpha-1 antitrypsin deficiency*

**Q1.** Which of the following features is most specific or characteristic of Alpha-1 antitrypsin deficiency?
  ...
  > **Answer: A** — FCPS/MRCP tip
  >
  > *Source:* l** | 1.5-3.5 g/L (20-52 µM) | **<0.5 g/L** | 0.7-1.2 g/L |
| **Phenotype** | MM | **ZZ** | MZ |

> **FCPS/MRCP tip**: **Low A1AT level + ZZ phenotype = diagnostic**

**Q2.** What is the most appropriate first-line therapy for Alpha-1 antitrypsin deficiency?
  ...
  > **Answer: A** — No specific therapy
  >
  > *Source:* **No specific therapy** for liver disease
