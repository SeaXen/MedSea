...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Silicosis*

**Q1.** Which of the following is characterised by the clinical triad: nodules, eggshell, PMF?
  ...
  > **Answer: A** — Silicosis
  >
  > *Source:* high mortality, whole lung lavage
## 24-Hour Recall Prompts
- Silicosis forms and latencies
- HRCT classic triad (nodules, eggshell, PMF)
- Eggshell calcification significance
...
**Q2.** Which of the following features is most specific or characteristic of Silicosis?
  ...
  > **Answer: A** — Eggshell calcification
  >
  > *Source:* CXR / HRCT (Diagnostic Cornerstone)
| Finding | Description |
|---------|-------------|
| **Small rounded opacities** | **Upper zone predominant** (1–5 mm, innumerable) |
| **Eggshell calcification** 

**Q3.** What is the most appropriate first-line therapy for Silicosis?

  - **A.** Smoking cessation + Oxygen + Pulmonary rehabilitation
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Smoking cessation + Oxygen + Pulmonary rehabilitation
  >
