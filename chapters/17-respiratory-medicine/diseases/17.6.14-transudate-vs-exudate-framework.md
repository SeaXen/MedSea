...
davidson_topic_id: "17.6.14"
topic: "Transudate vs exudate framework"
...
source: "/mnt/tb/Medicine/Respiratory/Pleural Diseases/Transudate vs exudate framework.md"
...
mindmap
  root((Pleural Fluid))
    Light's Criteria
      ...
      ANY = Exudate
    Transudate
      Systemic (Starling forces)
      CHF, Cirrhosis, Nephrotic, Dialysis
      Gradient correction: Prot>3.1, Alb>1.2
    Exudate
      Local pleural disease
      Infection (PPE, Empyema, TB)
      Malignancy
      Autoimmune (RA, SLE)
      Drugs, Pancreatic, Chylous
    Sub-classification
      Neutrophilic + low pH = Empyema
      Lymphocytic + ADA>40 = TB
      Lymphocytic + Cytology+ = Malignancy
      Low glucose + RA = Rheumatoid
      Milky + TG+chylomicrons = Chylothorax
```

## Flowchart
```mermaid
flowchart TD
    A[Pleural Fluid Aspiration] --> B[Light's Criteria + Serum Paired]
    B --> C{Any Light's Positive?}
    C -- NO --> D[TRANSUDATE\nTreat Systemic Cause]
    C -- YES --> E[EXUDATE\nClinical Transudate?]
    E -- YES (CHF on diuretics) --> F[Gradients:\nProtein>3.1 or Alb>1.2?]
    F -- YES --> D
    F -- NO --> G[TRUE EXUDATE]
    E -- NO --> G
    G --> H[Sub-classify by Fluid Pattern]
    H --> I{Pattern}
    I -- Neutrophilic, pH<7.2, Glu<3.3 --> J[Complicated PPE / Empyema\nDRAIN]
    I -- Lymphocytic, ADA>40, Glu low --> K[TB\nAnti-TB]
    I -- Lymphocytic, Cytology+ --> L[Malignancy\nPleurodesis/IPC]
    I -- Lymphocytic, Glu very low, pH low, RF+ --> M[Rheumatoid]
    I -- Milky, TG>1.24, Chylomicrons+ --> N[Chylothorax\nMCT/Octreotide/Surgery]
    I -- Milky, Chol>5.18, Crystals+ --> O[Pseudochylothorax\nTreat Underlying]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Transudate vs exudate framework*

**Q1.** What is the most appropriate first-line therapy for Transudate vs exudate framework?

  - **A.** Nephrotic syndrome + ACEi/ARB
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Nephrotic syndrome + ACEi/ARB
  >
  > *Source:* **Nephrotic syndrome**: **ACEi/ARB**, diuretics, treat primary glomerular disease
