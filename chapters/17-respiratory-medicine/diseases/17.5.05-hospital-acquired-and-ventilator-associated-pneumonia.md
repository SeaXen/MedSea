...
source: "/mnt/tb/Medicine/Respiratory/Respiratory Infections/Hospital-acquired and ventilator-associated pneumonia.md"
...
mindmap
  root((HAP/VAP))
    ...
    Diagnosis
      ...
      CXR new infiltrate
    Empiric Therapy
      No MDRO risk: Ceftriaxone/Co-amoxiclav
      MDRO risk: Antipseudomonal β-lactam ± anti-MRSA
    Management
      De-escalation 48-72h
      7-8 days duration
      De-escalation = mandatory
    Prevention
      VAP Bundle: HOB 30-45°, Sedation holiday, SBT, Oral care, DVT/Stress ulcer prophylaxis
```
