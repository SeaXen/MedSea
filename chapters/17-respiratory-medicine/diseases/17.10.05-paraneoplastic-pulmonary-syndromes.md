...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Paraneoplastic pulmonary syndromes*

**Q1.** What is the most appropriate first-line therapy for Paraneoplastic pulmonary syndromes?
  ...
  > **Answer: A** — Ectopic ACTH
  >
  > *Source:* **Ectopic ACTH**   Treat cancer, ketoconazole/metyrapone
