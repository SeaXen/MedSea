...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Pleural Effusion*

**Q1.** Which of the following features is most specific or characteristic of Pleural Effusion?
  ...
  > **Answer: A** — Image-guided
  >
  > *Source:* Pleural biopsy
- **Image-guided (USS or CT) pleural biopsy**: for suspicious thickening or nodularity; diagnostic yield ~80% for malignancy

**Q2.** What is the most appropriate first-line therapy for Pleural Effusion?

  - **A.** Treat underlying malignancy
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Treat underlying malignancy
  >
  > *Source:* **Treat underlying malignancy**: chemotherapy, radiotherapy, hormonal therapy.
