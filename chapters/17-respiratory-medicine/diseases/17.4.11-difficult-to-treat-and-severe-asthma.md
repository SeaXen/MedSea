...
davidson_topic_id: "17.4.11"
topic: "Difficult-to-treat and severe asthma"
...
source: "/mnt/tb/Medicine/Respiratory/Airway Diseases/Difficult-to-treat and severe asthma.md"
...
```mermaid
mindmap
  root((Difficult/Severe Asthma))
    Difficult-to-Treat
      Uncontrolled on Med-High ICS/LABA
      Check: Adherence, Technique, Comorbidities, Triggers
    Severe Asthma
      Subset of Difficult
      High-Dose ICS/LABA + Adherence + Comorbidities Managed
      Still Uncontrolled
    Phenotypes
      Allergic (IgE)
      Eosinophilic (Eos/FeNO)
      AERD (CRSwNP)
      Obese Non-Eos
    Biologics (Step 5)
      Omalizumab (IgE)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Difficult-to-treat and severe asthma*

**Q1.** What is the most appropriate first-line therapy for Difficult-to-treat and severe asthma?

  - **A.** Anti-IL13 + First biologic choice + dominant phenotype/biomarkers
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Anti-IL13 + First biologic choice + dominant phenotype/biomarkers
  >
  > *Source:* **Anti-IL13**   (Investigational)   Lebrikizumab, tralokinumab  
