...
davidson_topic_id: "17.5.07"
topic: "Lung abscess and necrotizing pneumonia"
...
source: "/mnt/tb/Medicine/Respiratory/Respiratory Infections/Lung abscess and necrotizing pneumonia.md"
...
```mermaid
flowchart TD
    A[Suspected Lung Abscess\nPutrid sputum + CXR cavity] --> B[CT Chest + Sputum Culture\nAnaerobic + Aerobic]
    B --> C{Cavity >2cm\nAir-fluid level\nThick wall}
    C -- YES --> D[Start Antibiotics\nClindamycin 600mg IV q6h\nOR Co-amoxiclav + Metronidazole]
    C -- NO --> E[Alternative: Empyema, Cancer, TB, Cyst]
    D --> F{Post-Obstructive?\n>40y, Smoker, Wall irregular}
    F -- YES --> G[Bronchoscopy\nCT/PET-CT\nExclude Cancer]
    F -- NO --> H[Continue Medical Management]
    H --> I[Postural Drainage\nPhysiotherapy]
    I --> J[Monitor: CXR 6-8wks\nCavity resolution]
    J --> K{Persistent Cavity?}
    K -- YES --> L[Re-biopsy\nExclude Cancer/TB/Fungal]
    K -- NO --> M[Complete 4-6wk Antibiotics\nFollow-up]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Lung abscess and necrotizing pneumonia*

**Q1.** Which of the following features is most specific or characteristic of Lung abscess and necrotizing pneumonia?
  ...
  > **Answer: A** — Cough
  >
  > *Source:* ## Lung Abscess (Subacute/Chronic)
| Feature | Description |
|---------|-------------|
| **Cough** | **Productive, putrid/foul-smelling sputum** (hallmark) |
| **Fever** | Low-grade, intermittent, nig

**Q2.** What is the most appropriate first-line therapy for Lung abscess and necrotizing pneumonia?

  - **A.** Clindamycin + 4–6 weeks
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Clindamycin + 4–6 weeks
  >
  > *Source:* **Clindamycin** (1st line for anaerobes)   600mg IV q6h → 300mg PO q6h   **4–6 weeks** (then oral to complete)
