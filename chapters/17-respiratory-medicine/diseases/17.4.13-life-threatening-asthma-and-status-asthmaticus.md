...
davidson_topic_id: "17.4.13"
topic: "Life-threatening asthma and status asthmaticus"
...
source: "/mnt/tb/Medicine/Respiratory/Airway Diseases/Life-threatening asthma and status asthmaticus.md"
...
mindmap
  root((Life-threatening Asthma / Status Asthmaticus))
    ...
    ABG
      PaCO2 Low = Compensated
      PaCO2 Normal = Impending Failure
      PaCO2 High = Decompensated
    Management
      O2, Salbutamol+Ipratropium, Steroids
      MgSO4 2g IV
      Aminophylline (Senior)
      ICU Escalation
    Ventilation
      Low Vt, Low RR, Long Expiration
      Permissive Hypercapnia
      Low PEEP, Auto-PEEP Management
    Complications
      Pneumothorax, Hypotension, Auto-PEEP
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Life-threatening asthma and status asthmaticus*

**Q1.** What is the most appropriate first-line therapy for Life-threatening asthma and status asthmaticus?

  - **A.** Persistent PaCO₂ >8 kPa
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Persistent PaCO₂ >8 kPa
  >
  > *Source:* **Persistent PaCO₂ >8 kPa (60 mmHg)** or pH <7.2 despite maximal therapy
