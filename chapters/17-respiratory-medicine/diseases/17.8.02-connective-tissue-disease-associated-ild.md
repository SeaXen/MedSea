...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Connective tissue disease-associated ILD*

**Q1.** Which of the following features is most specific or characteristic of Connective tissue disease-associated ILD?
...
**Q2.** Which landmark clinical trial provided evidence relevant to the management of Connective tissue disease-associated ILD (specifically: MMF as first-line for SSc-ILD)?
  ...
  > **Answer: A** — III trial
  >
  > *Source:* **B** — SLS I/II/III trials established MMF as first-line for SSc-ILD

**Q3.** What is the most appropriate first-line therapy for Connective tissue disease-associated ILD?

  - **A.** PAH-specific therapy + ERA + PDE5i
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — PAH-specific therapy + ERA + PDE5i
  >
  > *Source:* **PAH-specific therapy**: **ERA** (ambrisentan, macitentan), **PDE5i** (sildenafil, tadalaf
