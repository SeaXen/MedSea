...
davidson_topic_id: "17.6.07"
topic: "Pleural aspiration and chest drain basics"
...
source: "/mnt/tb/Medicine/Respiratory/Pleural Diseases/Pleural aspiration and chest drain basics.md"
...
```mermaid
flowchart TD
    A[Need Pleural Procedure] --> B{Type?}
    B -- Aspiration --> C[US-guided Diagnostic/Therapeutic\nSamples: pH anaerobic, culture bottles, cytology fresh\nLimit 1.5L]
    B -- Drain --> D{Indication}
    D -- Pneumothorax/Simple fluid --> E[Seldinger Pigtail 10-14F\nSafe triangle, US-guided]
    D -- Empyema/Thick pus --> F[Surgical 24-28F\nBlunt dissection]
    E --> G[Underwater seal only\nSuction if leak>48h]
    F --> G
    G --> H[Monitor: Swing, Bubble, Output]
    H --> I{Removal Criteria?}
    I -- Leak stopped 24h, Output<150mL, Lung expanded --> J[Remove at end inspiration/expiration\nOcclusive dressing\nCXR 24h]
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 17: Respiratory Medicine — Pleural aspiration and chest drain basics*

**Q1.** What is the most appropriate first-line therapy for Pleural aspiration and chest drain basics?

  - **A.** Water seal + One-way valve
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Water seal + One-way valve
  >
  > *Source:* **Water seal**   **One-way valve** — allows air/fluid OUT, prevents air IN
