...
## 2. 2. 🧠 Core Concept: EBM Framework

```mermaid
flowchart TD
    A[Clinical Question
PICO] --> B[Search for Evidence
Systematic → Databases]
    B --> C[Critical Appraisal
...
## 3. 3. ️⃣ Hierarchy of Evidence (Oxford CEBM 2011)
...
## 4. 4. ️⃣ Study Designs — Key Features

### 1. Randomised Controlled Trial (RCT) — Gold Standard for Therapy
| Feature | Detail |
|---------|--------|
...
## 5. 5. ️⃣ Critical Appraisal by Question Type

### 1. 3.1 Therapy (RCT) — Key Appraisal Questions
...
### 4. 3.2 Diagnostic Studies — Key Appraisal
...
### 5. 3.3 Prognosis Studies — Key Appraisal
...
### 9. 3.5 Systematic Review & Meta-Analysis Appraisal
...
## 6. 6. ️⃣ Statistics for EBM — Quick Reference

### 1. Common Tests & When to Use
...
## 7. 7. ️⃣ GRADE (Grading of Recommendations Assessment, Development and Evaluation)

### 1. Quality of Evidence — 4 Levels
...
### 3. Upgrading Factors (3) — Observational only
| Factor | Upgrade By |
|--------|------------|
...
## 8. 8. ️⃣ Guideline Development & Appraisal
...
### 2. WHO Guideline Development (Handbook)
...
## 9. 9. ️⃣ Shared Decision-Making (SDM)

### 1. SDM Model (Elwyn et al.)

```mermaid
flowchart LR
    A[Choice Talk
Options exist] --> B[Option Talk
Compare options]
    B --> C[Decision Talk
Elicit preferences]
    C --> D[Decision / Defer]
...
## 10. 10. ️⃣ Practical Appraisal Checklists

### 1. RCT Quick Checklist (CONSORT-based)
...
### 2. Diagnostic Study Checklist (QUADAS-2 based)
...
### 3. SR/MA Checklist (PRISMA/AMSTAR-2)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 1: Clinical Decision-Making — Evidence-Based Medicine*

**Q1.** Which of the following features is most specific or characteristic of Evidence-Based Medicine?
  ...
  >
  > *Source:* **Case-Control** | Rare diseases, Harm (long latency) | Recall bias, Selection bias (controls) |
| **Cross-Sectional** | Prevalence, Diagnostic accuracy | Temporal ambiguity |
