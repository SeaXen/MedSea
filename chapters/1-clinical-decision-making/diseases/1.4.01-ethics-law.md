...
## 2. 2. 🧠 Core Concept: Ethics & Law in Clinical Practice

```mermaid
flowchart TD
    A[Clinical Decision] --> B{Ethical Analysis}
    B --> C[4 Principles
...
Data Protection 2018]
    E --> G[Case Law
Montgomery, Bolam,
Bolitho, Re A, Gillick]
    E --> H[Regulatory
GMC Good Medical Practice,
Fitness to Practise]
    C & D & F & G & H --> I[Resolution:
Ethically Justified &
Legally Defensible]
```
...
### 1. Four Principles (Beauchamp & Childress)
...
### 2. Four Quadrants Approach (Jonsen et al.)
...
## 4. 4. ️⃣ Key Ethical Dilemmas in Clinical Practice
...
### 2. End-of-Life Decision Framework (ReSPECT / GMC)

```mermaid
flowchart TD
    A[Patient with Deteriorating Condition] --> B{Capacity?}
    B -->|Yes| C[Discuss Goals of Care
DNAR? Treatments? Ceiling?]
    B -->|No| D[Best Interests Decision]
    C & D --> E{Agreement?}
    E -->|Yes| F[Document ReSPECT/DNAR
Share with Team/Family]
    E -->|Disagreement| G[Second Opinion / Mediation
Ethics Committee / Court]
    F & G --> H[Regular Review
Escalate if Change]
```

### 3. Resource Allocation (Distributive Justice)
...
## 5. 5. ️⃣ UK Medical Law — Key Statutes & Cases

### 1. Consent Law Evolution
...
### 2. Montgomery Test (2015) — 2-Limb Test
...
### 3. Negligence — 4 Elements (Tort Law)
...
### 4. Confidentiality — Legal Basis & Exceptions
...
### 5. Mental Capacity Act 2005 — Key Provisions
...
### 6. Human Rights Act 1998 — Relevant Articles
...
## 6. 6. ️⃣ Paediatric Consent — Gillick & Fraser
...
## 7. 7. ️⃣ Professional Regulation — GMC & Fitness to Practise
...
### 3. Duty of Candour (Statutory — Health & Social Care Act 2008 Reg 20)
...
### 4. Raising Concerns (Whistleblowing)
...
## 8. 8. ️⃣ Practical Decision Frameworks

### 1. Ethical Decision-Making (4-Quadrant Checklist)

```mermaid
flowchart TD
    A[Clinical Dilemma] --> B[1. Medical Indications
Diagnosis, Prognosis, Options, Goals]
    B --> C[2. Patient Preferences
Informed? Capacity? Consent? Values? Advance Directives?]
    C --> D[3. Quality of Life
Current/Future? Patient's View? Bias?]
    D --> E[4. Contextual Features
Family, Resources, Legal, Institutional, Cultural]
    E --> F[Identify Conflicts
Autonomy vs Beneficence? Justice?]
    F --> G{Resolve: Proportionality,
...
### 2. Consent Conversation Checklist (Montgomery-Compliant)
...
### 3. Capacity Assessment Script (MCA 2005)
```
...
mindmap
  root((Ethics & Law))
    ...
    Consent
      ...
      Bolam / Bolitho
      Capacity (MCA 2-Stage)
      Advance Decisions
    End-of-Life
      DNAR / ReSPECT
      Withhold = Withdraw (Airedale)
      Double Effect
      Euthanasia Illegal
    Confidentiality
      Exceptions (Consent, Law, Public Interest, Child)
    Paediatric
      Gillick / Fraser
    ...
    Key Cases
      ...
      Airedale / Gillick / Re A
      Montgomery / Chester v Afshar
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 1: Clinical Decision-Making — Ethics & Law*

**Q1.** Which of the following features is most specific or characteristic of Ethics & Law?
  ...
  > **Answer: A** — Advance Decisions
  >
  > *Source:* |
| **Advance Decisions (ADRT)** | Legally binding refusal if valid (MCA 2005). Must be "clear, specific, applicable"
