...
## 2. 2. 🧠 Core Concept: From Evidence to Practice

```mermaid
flowchart LR
    A[Evidence
SR/MA, RCT] --> B[Guideline Development
GRADE, AGREE II]
    B --> C[Clinical Guideline
Recommendations]
    C --> D[Clinical Pathway
Integrated Care Map]
    D --> E[Clinical Protocol
Standardised Procedure]
    E --> F[Implementation
CFIR, RE-AIM, Barriers]
    F --> G[Clinical Practice
Audit, Feedback, QI]
    G --> H[Outcomes
Patient, System, Cost]
    H --> A[New Evidence]
...
## 3. 3. ️⃣ Guideline Appraisal — AGREE II (Gold Standard)

### 1. AGREE II Instrument — 23 Items, 6 Domains
...
### 3. Critical Appraisal Questions (Rapid AGREE)
...
## 4. 4. ️⃣ Guideline Development Process

### 1. WHO Guideline Development (WHO Handbook)

```mermaid
flowchart TD
    A[1. Scope & Prioritisation] --> B[2. Group Composition
GDG, Methodologists, Stakeholders]
    B --> C[3. PICO Questions
Population, Intervention, Comparator, Outcomes]
    C --> D[4. Evidence Retrieval
Systematic Reviews, GRADE]
    D --> E[5. Evidence Appraisal
Risk of Bias, Certainty]
    E --> F[6. Evidence-to-Decision
EtD Frameworks: Benefits, Harms, Values, Resources, Equity, Acceptability, Feasibility]
    F --> G[7. Recommendation Formulation
Strong vs Conditional]
    G --> H[8. Drafting Guideline
Peer Review, Public Consultation]
    H --> I[9. Dissemination & Implementation
Tools, Training, Adaptation]
    I --> J[10. Evaluation & Update
Surveillance, Living Guidelines]
```

### 2. NICE Guideline Process (UK)
...
## 5. 5. ️⃣ Guideline vs Pathway vs Protocol vs Bundle
...
## 6. 6. ️⃣ Implementation Science — Bridging the Gap
...
### 3. CFIR — 5 Domains (Determinants of Implementation)
...
### 5. Barriers & Facilitators (BARRIERS Framework)
...
## 7. 7. ️⃣ Implementation Strategies (EPOC Taxonomy)
...
## 8. 8. ️⃣ NICE — UK Guideline Ecosystem

### 1. NICE Product Types
...
### 2. NICE Technology Appraisal Process
...
### 3. NICE Cost-Effectiveness Threshold
...
## 9. 9. ️⃣ Protocol Development & Standardisation

### 1. Protocol vs Guideline
...
### 2. Protocol Development Checklist
...
### 3. Standardisation vs Individualisation
...
## 10. 10. ️⃣ Evaluating Guideline Impact
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 1: Clinical Decision-Making — Guidelines & Pathways*

**Q1.** Which of the following features is most specific or characteristic of Guidelines & Pathways?

  - **A.** "Protocol deviation = Negligence"
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — "Protocol deviation = Negligence"
  >
  > *Source:* |
| **"Protocol deviation = Negligence"** | **NO.** Documented, justified deviation with patient-specific reasoning = Good care
