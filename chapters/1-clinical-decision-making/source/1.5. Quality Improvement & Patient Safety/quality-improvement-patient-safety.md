...
## 2. 🧠 Core Concept: Quality Improvement = System Science

```mermaid
flowchart TD
    A[Problem Identified] --> B[Understand System<br/>Process Mapping, Data]
    B --> C[Model for Improvement<br/>3 Questions + PDSA]
    C --> D[Test Changes<br/>Small Scale → Scale Up]
    D --> E[Measure Impact<br/>Run Charts, SPC]
    E --> F{Sustain & Spread}
    F -->|Standardise| G[Embed in Pathways<br/>Policy, EHR, Training]
...
## 3. ️⃣ QI Methodology — Model for Improvement (IHI)
...
### Driver Diagram — Linking Aim to Changes

```mermaid
flowchart TD
    A[Aim<br/>Reduce sepsis mortality by 20% in 12 months] --> B[Primary Drivers]
    B --> B1[Early Recognition<br/>NEWS2, Screening]
    B --> B2[Timely Treatment<br/>Sepsis 6 Bundle]
    B --> B3[Reliable Processes<br/>Pathways, Education]
...
## 4. ️⃣ Measurement for Improvement
...
### Data Visualisation — Run Charts vs Control Charts
...
### Variation — Common vs Special Cause (Deming/Shewhart)
...
## 5. ️⃣ Root Cause Analysis (RCA) — Tools & Process

### RCA Process (NHS / NPSA)

```mermaid
flowchart TD
    A[Incident Identified] --> B[Immediate Safety Actions]
    B --> C[Team Formation<br/>Multidisciplinary, Independent]
    C --> D[Data Collection<br/>Timeline, Interviews, Records]
    D --> E[Analysis<br/>Fishbone, 5 Whys, Swiss Cheese]
    E --> F[Root Causes<br/>& Contributing Factors]
    F --> G[Action Plan<br/>SMART: Strong/Intermediate/Weak]
...
### Action Hierarchy (Strength of Interventions)
...
## 6. ️⃣ Patient Safety — Core Concepts

### Never Events (NHS England — 2018 Framework)
...
### Duty of Candour (Statutory — Regulation 20, HSCA 2008)
...
## 7. ️⃣ Clinical Governance — 7 Pillars (NHS)
...
```mermaid
flowchart LR
    A[Select Topic<br/>High risk, High volume, Evidence gap] --> B[Set Standards<br/>Evidence-based, Measurable]
    B --> C[Collect Data<br/>Retrospective/Prospective]
    C --> D[Compare<br/>Actual vs Standard]
    D --> E[Implement Change<br/>PDSA if Needed]
    E --> F[Re-audit<br/>Sustain Improvement]
```

> **Audit ≠ Research.** Audit = "Are we doing what we should?" Research = "What should we do?"

### Revalidation (GMC) — 5-Year Cycle
...
## 8. ️⃣ High-Reliability Safety Interventions
...
### Central Line Bundle (CLAB Prevention)
...
### Sepsis 6 Bundle (UK Sepsis Trust)
...
### Medication Safety — High-Alert Strategies
...
## 9. ️⃣ Practical QI Project Template

```mermaid
flowchart TD
    A[1. Identify Problem<br/>Data, Stakeholder Voice] --> B[2. Form Team<br/>Multidisciplinary, Sponsor]
    B --> C[3. Aim Statement<br/>SMART: Who, What, By When, How Much]
    C --> D[4. Driver Diagram<br/>Primary/Secondary Drivers]
    D --> E[5. Measurement Plan<br/>Outcome/Process/Balancing<br/>Run Chart / SPC]
    E --> F[6. PDSA Cycles<br/>Test Small → Learn → Scale]
    F --> G[7. Sustain<br/>Embed in Policy/EHR<br/>Standard Work]
    G --> H[8. Spread<br/>Other Wards/Trusts<br/>Share Learning]
```
...
```mermaid
mindmap
  root((Quality Improvement<br>& Patient Safety))
