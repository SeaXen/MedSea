...
```mermaid
mindmap
  root((Bile Acid Diarrhoea))
    Definition
      BAD = bile acids reach colon → secretory diarrhoea...
    Key Features
      Type 1: ileal disease/resection; Type 2: idiopathi...
    Diagnosis
      SeHCAT 7-day retention <15% = diagnostic...
    Management
      Empirical cholestyramine trial = practical diagnos...
    Complications
...
```mermaid
flowchart TD
  A[Bile Acid Diarrhoea Presentation] --> B{Key Diagnostic Feature?}
