...
```mermaid
flowchart TD
A[Acute diarrhoea] --> B{Severe or red flags?}
B -- Yes --> C[Assess dehydration + urgent tests/treatment]
B -- No --> D[Supportive care]
C --> E{Watery vs bloody/inflammatory?}
D --> E
E --> F[Targeted stool testing / C. difficile logic / escalation when needed]
```
