...
```mermaid
flowchart TD
A[Acute abdominal pain] --> B{Peritonism / shock / severe red flags?}
B -- Yes --> C[Resuscitate + urgent surgical/acute escalation]
B -- No --> D[Focused evaluation]
C --> E[Urgent imaging and cause-directed management]
```
