...
```mermaid
flowchart TD
A[Bloody diarrhoea + urgency] --> B[Exclude infection]
B --> C[Calprotectin / inflammatory work-up]
C --> D[Endoscopy + biopsy]
D --> E{Continuous rectum-based colitis?}
E -- Yes --> F[Ulcerative colitis management pathway]
E -- No --> G[Consider Crohn or other colitis]
```
