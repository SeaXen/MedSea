...
## 6. Red Flags / High-Yield Contexts
- unexplained IDA
...
```mermaid
flowchart TD
A[Suspect coeliac disease] --> B[Serology]
B --> C{Positive or strong ongoing suspicion?}
C -- Yes --> D[Upper GI endoscopy + duodenal biopsy]
C -- No --> E[Reassess diagnosis clinically]
```
