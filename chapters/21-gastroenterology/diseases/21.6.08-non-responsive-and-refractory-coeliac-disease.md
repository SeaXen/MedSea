...
## 4. Common causes of persistent symptoms
...
```mermaid
flowchart TD
  A[Non-Responsive and Refractory Coeliac Disease Presentation] --> B{Key Diagnostic Feature?}
