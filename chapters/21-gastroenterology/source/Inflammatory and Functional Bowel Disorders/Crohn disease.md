...
```mermaid
flowchart TD
A[Chronic diarrhoea + abdominal pain + weight loss] --> B[Consider IBD]
B --> C[Calprotectin / baseline inflammatory work-up]
C --> D[Ileocolonoscopy + biopsy]
D --> E{Skip lesions / ileal disease / transmural complications?}
E -- Yes --> F[Crohn disease pathway]
E -- No --> G[Consider UC or other diagnosis]
```
