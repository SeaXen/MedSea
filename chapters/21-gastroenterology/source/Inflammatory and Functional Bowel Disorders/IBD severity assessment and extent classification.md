...
## Ulcerative colitis severity clues
- Stool frequency
- Blood in stool
- Pulse, temperature
- Haemoglobin
...
```mermaid
flowchart TD
  A[Clinical Indication] --> B{Assess Criteria}
  B -- Meets --> C[Initiate/Classify]
  B -- Not --> D[Alternative/Wait]
  C --> E[Monitor Response]
  E --> F{Adequate Response?}
  F -- Yes --> G[Continue/Maintain]
  F -- No --> H[Escalate/Modify]
```
