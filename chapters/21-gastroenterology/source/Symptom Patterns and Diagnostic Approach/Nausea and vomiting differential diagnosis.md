...
## Practical Classification of Causes
### GI causes
...
```mermaid
flowchart TD
A[Nausea / vomiting] --> B{Red flags?}
B -- Yes --> C[Resuscitate + urgent targeted workup]
B -- No --> D[Pattern-based history and examination]
D --> E{GI / metabolic / drug / pregnancy / neuro?}
E --> F[Targeted tests and treatment]
```
