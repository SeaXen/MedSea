...
```mermaid
flowchart TD
A[Reflux symptom pattern] --> B{Alarm features or treatment failure?}
B -- Yes --> C[Endoscopic evaluation]
B -- No --> D[Reflux-directed treatment]
C --> E[Erosions seen = erosive oesophagitis]
```
