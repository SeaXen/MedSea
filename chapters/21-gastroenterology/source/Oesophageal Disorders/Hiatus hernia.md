...
```mermaid
flowchart TD
A[Hiatus hernia identified] --> B{Sliding or para-oesophageal?}
B -- Sliding --> C[Treat reflux pattern]
B -- Para-oesophageal / complicated --> D[Assess for surgical management]
```
