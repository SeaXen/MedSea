...
topic_group: Lower GI endoscopy
...
## Red Flags for Earlier Reassessment
...
```mermaid
flowchart TD
A[Polyp removed] --> B[Review number, size, histology]
B --> C{Complete removal and good exam quality?}
C -- Yes --> D[Risk-stratified routine surveillance]
C -- No --> E[Earlier reassessment]
```
