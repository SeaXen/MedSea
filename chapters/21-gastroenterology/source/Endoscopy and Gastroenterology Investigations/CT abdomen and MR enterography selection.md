...
topic_group: Small bowel and imaging tests
...
```mermaid
flowchart TD
A[Need cross-sectional GI imaging] --> B{Acute complication question?}
B -- Yes --> C[CT abdomen]
B -- No --> D{Small-bowel inflammatory mapping needed?}
D -- Yes --> E[MR enterography]
D -- No --> F[Choose by clinical context]
```
