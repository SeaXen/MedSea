...
heading: Endoscopy and Gastroenterology Investigations
topic_group: Upper GI endoscopy
...
```mermaid
flowchart TD
A[Upper GI endoscopy finding / question] --> B{Visible lesion?}
B -- Yes --> C[Target lesion biopsy]
B -- No --> D{Disease needs protocol/systematic mucosal sampling?}
D -- Yes --> E[Site-specific mucosal biopsy]
D -- No --> F[Reconsider whether biopsy is needed]
C --> G[Correlate pathology with endoscopic picture]
E --> G
```
