...
## Classification / Clinical Associations
...
```mermaid
flowchart TD
A[Suspected H. pylori-related disease] --> B{Need endoscopy anyway?}
B -- No --> C[Use urea breath test or stool antigen]
B -- Yes --> D[Biopsy-based diagnosis at endoscopy]
C --> E{Positive?}
D --> E
E -- Yes --> F[Eradication regimen]
F --> G[Confirm eradication when indicated]
```
