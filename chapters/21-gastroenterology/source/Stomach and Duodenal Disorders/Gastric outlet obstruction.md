...
topic_group: Peptic ulcer complications
...
```mermaid
flowchart TD
A[Persistent vomiting/fullness] --> B[Suspect gastric outlet obstruction]
B --> C[Resuscitate fluids/electrolytes]
C --> D[Endoscopy/imaging]
D --> E[Benign vs malignant treatment pathway]
```
