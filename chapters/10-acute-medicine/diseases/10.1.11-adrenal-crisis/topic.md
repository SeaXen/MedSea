...
mindmap
  root((Adrenal Crisis))
    ...
    Investigations
      Random cortisol <300 in illness
      ACTH, UandE, glucose
    ...
    Special
      Stress-dose for surgery
      Relative AI in sepsis
...
```mermaid
flowchart TD
  A[Suspected Adrenal Crisis] --> B[IV access x2, bloods]
  B --> C[Hydrocortisone 100mg IV bolus]
  C --> D[1L 0.9% saline rapid]
  D --> E[Hydrocortisone 50mg IV q6h or 200mg/24h infusion]
  E --> F[Reassess: BP, UO, electrolytes]
  F --> G{Stable?}
  G -->|No| H[More fluids, vasopressors]
  G -->|Yes| I[Continue q6h, switch to oral, taper]
  I --> J[Synacthen test after 24h]
  J --> K[Long-term: Hydro + Fludro, sick-day rules]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 10: Acute Medicine — Adrenal Crisis*

**Q1.** What is the most appropriate first-line therapy for Adrenal Crisis?

  - **A.** Treat precipitating cause
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Treat precipitating cause
  >
  > *Source:* **Treat precipitating cause** (antibiotics if sepsis)
