...
mindmap
  root((Rhabdomyolysis))
    Definition
      ...
      Myoglobin release
    Causes
      Trauma: crush, immobility, compartment
      Exertion: marathon, seizures
      Heat stroke
      Drugs: statins, alcohol, cocaine, MDMA
      NMS, MH, serotonin syndrome
      Snake/spider bite
      DKA, HHS, hypothyroidism
      Genetic: McArdle, CPT II
    Features
      Triad: pain, weakness, dark urine
      Muscle swelling, tenderness
      Compartment signs
    Investigations
      CK >1000, >5000 severe
      Myoglobin, K+, Cr, urate
      Hypocalcaemia early, hypercalcaemia late
      Urine: dipstick +, no RBCs
      ECG for hyperK
    Complications
      AKI (10-50%)
      HyperK
    ...
    Management
      Aggressive IV fluids
        1-2 L/h initially
        Target UO 200-300 mL/h
        10-12 L/d
      Treat hyperK
      Urine alkalinisation (controversial)
      Mannitol (controversial)
      Loop diuretics (after euvolaemia)
      Dialysis (AEIOU)
      Treat cause
      Compartment -> fasciotomy
    Specific
      MH/NMS: dantrolene
      Statin: stop, supportive
      Snake bite: antivenom
      Heat stroke: cooling
    Prevention
      Early fluids at scene
      Avoid immobility
      Statin monitoring
    Prognosis
      Most recover
      5-25% mortality severe
      AKI 1-3 weeks
```
...
```mermaid
flowchart TD
  A[Suspected Rhabdo] --> B[CK, UandE, urate, Ca, Mg, ECG, urinalysis]
  B --> C{CK >1000?}
  C -->|No| D[Reassess]
  C -->|Yes| E[Aggressive IV 0.9% Saline 1-2 L/h]
  E --> F[Target UO 200-300 mL/h]
  F --> G[Monitor CK 6-12h, UandE, ECG]
  G --> H{Compartment syndrome?}
  H -->|Yes| I[Fasciotomy]
  H -->|No| J{HyperK?}
  J -->|Yes| K[Ca gluconate + insulin/dextrose]
  J -->|No| L[Continue fluids until CK <1000]
  L --> M{Treat cause?}
  M -->|Yes| N[Specific Rx: dantrolene for MH/NMS, antivenom, etc.]
  M -->|No| L
  K --> L
  I --> L
  N --> L
  L --> O{AKI/HyperK refractory?}
  O -->|Yes| P[Dialysis]
  O -->|No| Q[Monitor recovery]
```
