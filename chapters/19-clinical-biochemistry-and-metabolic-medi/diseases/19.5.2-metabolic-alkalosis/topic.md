---
tags: [medicine, clinical-biochemistry, metabolic-alkalosis, davidson, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 10: Clinical Biochemistry and Metabolic Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Metabolic alkalosis is common in hospitalised patients. Key viva: Chloride-responsive vs chloride-resistant differentiation using urine chloride, maintenance factors, and management of chloride-responsive vs resistant types."
see_also: ["Metabolic Acidosis", "Respiratory Acidosis", "Respiratory Alkalosis", "Mixed Acid-Base Disorders", "Hypokalaemia", "Diuretic Use", "Hyperaldosteronism"]
created: 2026-06-15
modified: 2026-06-15
---
...
```mermaid
mindmap
  root((Metabolic Alkalosis))
    Definition
      pH >7.45, HCO₃⁻ >26
    Urine Chloride (Key!)
      <20 → Chloride-Responsive (Volume Depleted)
        Causes: Vomiting, NG Suction, Diuretics, Post-Hypercapnic
        Rx: 0.9% NaCl + KCl
      >20 → Chloride-Resistant (Volume Normal/Expanded)
        Causes: Conn's, Cushing's, Bartter, Gitelman, Liquorice
        Rx: Treat Cause + Acetazolamide/K-Sparing
    Maintenance Factors
      Volume Depletion → Aldosterone
      Hypokalaemia (H+ In, K+ Out)
      Hypochloraemia (Cl/HCO3 Exchange)
    Compensation
      pCO2 = 0.7×HCO3 + 20 (Max 55-60)
    Specific Causes
      Vomiting/NG: Cl-Responsive
      Diuretics: Post-Diuretic Phase (Cl-Responsive)
      Conn's: HTN + HypoK + Alkalosis
      Bartter/Gitelman: HypoK + Alkalosis + Normal/Low BP
      Gitelman: HypoMg + Hypocalciuria
    Rx
      Cl-Responsive: NaCl + KCl
      Cl-Resistant: Treat Cause; Acetazolamide 250-500mg BD
```
