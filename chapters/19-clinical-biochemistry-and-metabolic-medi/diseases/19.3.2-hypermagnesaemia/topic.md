---
tags: [medicine, clinical-biochemistry, hypermagnesaemia, davidson, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 10: Clinical Biochemistry and Metabolic Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Hypermagnesaemia is less common but life-threatening when severe. Key viva: Renal failure as primary cause, iatrogenic causes (antacids, enemas), neuromuscular and cardiac toxicity, and management with IV fluids, furosemide, and dialysis."
see_also: ["Hypomagnesaemia", "Renal Failure", "Adrenal Insufficiency", "Rhabdomyolysis", "Tumour Lysis Syndrome"]
created: 2026-06-15
modified: 2026-06-15
---
...
```mermaid
mindmap
  root((Hypermagnesaemia))
    Definition
      Mg²⁺ >1.1 mmol/L
      Mild 1.1-2.0; Mod 2.0-3.0; Severe >3.0
    Causes
      Renal Failure (Most Common)
      Iatrogenic: Antacids, Laxatives, Enemas, IV MgSO₄
      Adrenal Insufficiency
      Rhabdo/Tumour Lysis
      Lithium
    Clinical
      Neuromuscular: Weakness, Hyporeflexia, Paralysis, Respiratory Failure
      CV: Hypotension, Bradycardia, Heart Block, Asystole
      Respiratory: Depression, Apnoea
    ECG
      Prolonged PR/QT, Widened QRS, AV Block, Sine Wave
    Management
      1. Stop Mg Source
      2. IV Fluids + Furosemide
      3. Calcium Gluconate 10mL 10% IV (Antagonist)
      4. Dialysis (Severe / Renal Failure)
    Eclampsia
      Therapeutic 2-4 mmol/L
      Toxic >4: Loss Reflexes, Resp Depression
      Antidote: Calcium Gluconate 10mL 10%
```
