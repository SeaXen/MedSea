---
tags: [medicine, clinical-biochemistry, cerebral-salt-wasting, davidson, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 10: Clinical Biochemistry and Metabolic Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Cerebral Salt Wasting (CSW) is a rare but critical cause of hypovolaemic hyponatraemia. Key viva: Differentiation from SIADH (volume status), management with saline + fludrocortisone, and association with CNS disease."
see_also: ["SIADH", "Hyponatraemia", "Hyponatraemia vs CSW", "Sodium & Water Balance"]
created: 2026-06-15
modified: 2026-06-15
---
...
```mermaid
mindmap
  root((Cerebral Salt Wasting))
    Pathophysiology
      Intracranial Disease → BNP Release / Sympathetic Overactivity
      Renal Salt Wasting → Volume Depletion → ADH Release
      Hyponatraemia + Hypovolaemia
    Settings
      SAH (10-20%)
      TBI / Neurosurgery
      CNS Tumours / Infection
    Clinical
      Hypovolaemic Hyponatraemia
      High Urine Na+ (>20)
      High Urine Osm (>100)
      Polyuria, Low JVP, Postural Drop
      High Uric Acid
    Diagnosis
      Hypovolaemic + High Urine Na+ + CNS Disease
      Differentiate from SIADH (Euvolaemic)
    Management
      Saline Resuscitation (0.9% NaCl)
      Fludrocortisone 0.05-0.2mg OD
      Salt Tablets (NaCl 1-2g TDS)
      Monitor: Na+, K+, Vol, BP, Uric Acid
    CSW vs SIADH
      Volume Status: Hypovolaemic vs Euvolaemic
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 19: Clinical Biochemistry — Cerebral Salt Wasting*

**Q1.** Which of the following features is most specific or characteristic of Cerebral Salt Wasting?
  ...
  > **Answer: A** — CSW vs SIADH
  >
  > *Source:* nal) | Low Cortisol, High ACTH |
...
**Q2.** What is the most appropriate first-line therapy for Cerebral Salt Wasting?
  ...
  > **Answer: A** — Weaning
  >
  > *Source:* **Weaning**   Gradual Over 1-2 Weeks as CNS Recovers
