---
tags: [medicine, clinical-biochemistry, hypomagnesaemia, davidson, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 10: Clinical Biochemistry and Metabolic Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Hypomagnesaemia is a commonly overlooked cause of refractory hypokalaemia and hypocalcaemia. Key viva: Causes (GI, renal, redistribution), ECG changes (QT prolongation, Torsades), and IV magnesium repletion protocols."
see_also: ["Hyperkalaemia", "Hypocalcaemia", "Hypokalaemia", "Hypermagnesaemia", "Metabolic Alkalosis", "Refeeding Syndrome"]
created: 2026-06-15
modified: 2026-06-15
---
...
```mermaid
mindmap
  root((Hypomagnesaemia))
    Definition
      Mg²⁺ <0.7 mmol/L
      Severe <0.5
    Aetiology
      GI: Diarrhoea, Malabsorption, PPIs, Alcohol
      Renal: Loop/Thiazide Diuretics, Cisplatin, Aminoglycosides, Gitelman, Bartter
      Redistribution: Hungry Bone, Refeeding, DKA Tx
    Clinical
      Refractory Hypokalaemia (Corr Mg First)
      Refractory Hypocalcaemia (Correct Mg First)
      Tetany, Seizures, Torsades
      QT Prolongation
    Diagnosis
      Mg²⁺ <0.7
      FEMg >2% = Renal Wasting
      Hypokalaemia + Hypocalcaemia Often Coexist
    Management
      Acute: IV MgSO₄ 2-4g over 20-30min
      Chronic: Oral Glycinate/Citrate 10-20mmol/d
      Correct K⁺/Ca²⁺ AFTER Mg
    Special
      PPI >1yr: Monitor Mg
      Gitelman: HypoMg + HypoK + HypoCaUri
      Refeeding: Prophylactic Mg
      Torsades: MgSO₄ 2g Bolus (Even if Normal Mg)
    Drugs
      PPIs, Loop/Thiazide, Cisplatin, Aminoglycosides, Tacrolimus
```
