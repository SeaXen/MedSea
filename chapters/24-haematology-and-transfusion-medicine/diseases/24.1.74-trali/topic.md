---
tags: [medicine, haematology, davidson, transfusion-reactions, trali, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - TRALI is the leading cause of transfusion-related mortality. Key viva: Donor anti-HLA/HNA antibodies, clinical differentiation from TACO, and prevention with male-only plasma."
see_also: ["TACO", "Transfusion Reactions", "Acute Haemolytic Transfusion Reaction", "Transfusion Medicine"]
created: 2026-06-15
modified: 2026-06-15
---
...
mindmap
  root((TRALI))
    Definition
      ALI ≤6h Post-Transfusion
      No Left Atrial Hypertension
      Bilateral Infiltrates + Hypoxaemia
    Pathophysiology
      Two-Hit Model
      Patient: Primed Neutrophils (Sepsis/Surgery)
      Transfusion: Donor Anti-HLA/HNA
      Bioactive Lipids (Stored Blood)
    Clinical
      Dyspnoea, Hypoxaemia, Fever, Hypotension
      Bilateral Infiltrates (CXR)
      No Cardiac Failure
    TRALI vs TACO
      TRALI: BNP Normal, Hypotension, No Response to Diuretics
      TACO: BNP High, Hypertension, Diuretic Response
    Management
      STOP Transfusion
      O₂, NIV/Intubation
      NO DIURETICS
      Vasopressors if Hypotensive
      Report to Blood Service / SHOT
    Prevention
      Male-Only Plasma/Platelets
      Leucodepletion
      Donor Deferral (Anti-HLA/HNA)
    Mortality
      5-10%
