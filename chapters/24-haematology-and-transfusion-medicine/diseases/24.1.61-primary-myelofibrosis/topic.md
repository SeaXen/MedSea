---
tags: [medicine, davidson, hematology, primary-myelofibrosis, pmf, mpn, myeloproliferative-neoplasm, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | JAK2/CALR/MPL, DIPSS-plus, ruxolitinib, splenomegaly, leukoerythroblastic, teardrops, HSCT"
see_also: "[[Polycythaemia Vera]], [[Essential Thrombocythaemia]], [[MPN]], [[Post-PV/ET MF]], [[Ruxolitinib]], [[Allogeneic SCT]]"
created: 2025-06-16
modified: 2025-06-16
---
...
mindmap
  root((Primary Myelofibrosis))
    ...
    Mutations
      JAK2: 50-60%
      CALR: 25-30% (Better OS)
      MPL: 5-10%
      Triple-Neg: 10-15% (Worse)
    Blood Film
      Leukoerythroblastic
      Teardrops, NRBCs, Immature Granulocytes
    Prognosis
      DIPSS-plus: Age, Hb, WBC, Blasts, Symptoms, Tx, Plts, Karotype
      MIPSS70: + HMR Mutations (ASXL1, SRSF2, U2AF1, EZH2, IDH)
    Management
      Low Risk: Observe
      Spleen/Symptoms: Ruxolitinib (Plt-based dose)
      Anaemia: Transfuse, ESA, Luspatercept
      Int-2/High: Allo-HSCT (Curative)
    Complications
      Portal HTN, Pulm HTN
      Blast Transformation (≥20%)
      Infections (Ruxo)
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 24: Haematology — Primary Myelofibrosis*

**Q1.** What is the most appropriate first-line therapy for Primary Myelofibrosis?

  - **A.** Thrombocytopenia + Avoid JAKi if Plt <50 + Standard for Symptoms/Spleen
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Thrombocytopenia + Avoid JAKi if Plt <50 + Standard for Symptoms/Spleen
  >
  > *Source:* **Thrombocytopenia**   **Avoid JAKi if Plt <50**   Platelet transfusions, TPO-RA (romiplostim/eltrombopag)  
