---
tags: [medicine, davidson, hematology, factor-xi-deficiency, rare-factor-deficiencies, bleeding-disorder, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Factor XI deficiency (common in Ashkenazi Jews), Rosenthal syndrome, FXII deficiency, FVII deficiency, FXIII deficiency, fibrinogen disorders"
see_also: "[[Haemophilia A & B]], [[Von Willebrand Disease]], [[Factor V Leiden & Thrombophilia]], [[Vitamin K Deficiency]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Rare Factor Deficiencies))
    FXI Deficiency (Rosenthal)
      Isolated APTT↑
      Ashkenazi Jews (8% carrier)
      Variable Bleeding
      TXA 1st Line
      FFP / rFVIIa (Last Resort)
    FXII Deficiency
      APTT↑↑
      NO BLEEDING
      Do Not Treat
    ...
    FXIII Deficiency
      PT/APTT Normal
      Solubility Test + (5M Urea)
      Delayed Bleeding
      FXIII Concentrate
    Fibrinogen Disorders
      Afibrinogenaemia (Absent)
      Hypofibrinogenaemia (Low)
      Dysfibrinogenaemia (Dysfunctional, Ratio<0.7)
```
