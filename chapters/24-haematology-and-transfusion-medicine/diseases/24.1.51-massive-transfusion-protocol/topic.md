---
tags: [medicine, davidson, hematology, transfusion, massive-transfusion-protocol, mtp, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Activation criteria, RBC:FFP:Platelet ratios (1:1:1), empiric vs goal-directed, tranexamic acid, calcium, hypothermia, acidosis, coagulation monitoring, TEG/ROTEM"
see_also: "[[Red Cell Transfusion]], [[Platelet Transfusion]], [[FFP/Cryoprecipitate]], [[DIC]], [[Trauma]], [[Coagulopathy of Trauma]]"
created: 2025-06-16
modified: 2025-06-16
---
...
```mermaid
mindmap
  root((Massive Transfusion Protocol))
    Activation
      ABC Score ≥2
      Penetrating, SBP≤90, HR≥120, FAST+
    Definition
      ≥4 RBC/1h or ≥10 RBC/24h
      >1 Blood Volume/24h
    Ratio
      1:1:1 RBC:FFP:Platelets
      PROMMTT/PROPPR Evidence
    Adjuncts
      TXA: 1g+1g/8h within 3h
      Calcium: iCa²⁺>1.0 → CaCl₂
      Warming: >36°C
    Monitoring
      Labs: PT/APTT/Fib/Plts/Ca/ABG
      TEG/ROTEM: Goal-Directed
      EXTEM CT→FFP, FIBTEM→Cryo, EXTEM A10→Plts
    Lethal Triad
      Hypothermia → Warm
      Acidosis → Treat Shock
      Coagulopathy → 1:1:1 + TXA + Ca
    Targets
