---
tags: [medicine, davidson, hematology, palliative-care, end-of-life, haematology, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Symptom control, transfusion in palliative care, advance care planning, bleeding, anaemia, infections, communication"
see_also: "[[Allogeneic SCT & GVHD]], [[Acute Myeloid Leukaemia (AML)]], [[Multiple Myeloma]], [[Chronic Lymphocytic Leukaemia (CLL)]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Palliative Care in Haematology))
    Principles
      Early Integration
    ...
    Symptom Control
      Anaemia: Transfusion Trial / EPO
      Bleeding: Plt/FFP/Cryo/TXA
      Infections: Palliative ABx
      Pain: WHO Ladder + Bisphosphonates
      Fatigue: Pacing + Psychosocial
    Transfusion
      Symptom Relief Goal
      1-2 Unit Trial
      Stop if No QoL Benefit
    Advance Care Planning
      DNACPR
      Treatment Ceilings (1/2/3)
      Preferred Place
      ADRT / LPA
    End-of-Life Emergencies
      Terminal Bleed: Dark Towels + Midazolam
      Hypercalcaemia: Saline + Zoledronic
      SVCO: Head Up + Dex 16mg + RT
      TLS: Hydration + Rasburicase
    Communication
      SPIKES
      Surprise Question
      Reframe Hope
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 24: Haematology — Palliative Care in Haematology*

**Q1.** What is the most appropriate first-line therapy for Palliative Care in Haematology?
  ...
  > **Answer: A** — Prophylaxis + Stop
  >
  > *Source:* **Prophylaxis**   **Stop** if no longer aligned with goals (e.g.
