---
tags: [medicine, davidson, hematology, dvt, pe, vte, cancer-associated-thrombosis, cat, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Wells/PE/Geneva scores, D-dimer, DOACs first-line, CAT: LMWH preferred (CLOT trial), duration, IVC filter, thrombolysis"
see_also: "[[Factor V Leiden & Thrombophilia]], [[Antiphospholipid Syndrome]], [[HIT]], [[DIC]], [[Thrombolysis]], [[IVC Filter]]"
created: 2025-06-16
modified: 2025-06-16
---
...
mindmap
  root((VTE: DVT/PE & CAT))
    Diagnosis
      DVT: Wells → D-dimer/US
      PE: Wells/Geneva → D-dimer/CTPA
      D-dimer: Age-adjusted (Age×10 >50)
    Acute Treatment
      DOACs: Riva/Apixa (1st line)
      Warfarin: Mech valve, Preg, AT Def, APS triple
    Duration
      Provoked: 3mo
      Unprovoked: Indefinite
      CAT: Indefinite (cancer active)
      APS: Indefinite
    Cancer-Associated Thrombosis
      Khorana Score (Prophylaxis)
      LMWH: CLOT Trial (Standard)
      DOACs: Apixaban CARAVAGGIO (Preferred)
      Avoid DOAC in GI/GU (SELECT-D)
    Massive PE
      SBP<90 → Alteplase 100mg/2h
      Submassive: RV strain → Consider
    IVC Filter
      Contraindication to AC
      Recurrent VTE on Therapeutic AC
```
