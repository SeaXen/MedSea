---
tags: [medicine, davidson, hematology, congenital-dyserythropoietic-anaemia, cdea, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | CDA types I/II/III, Binuclear erythroblasts, SEC23B, KIF23, KLF1 mutations, iron overload, splenectomy"
see_also: "[[Hereditary Spherocytosis]], [[Thalassaemia]], [[Sickle Cell Disease]], [[Iron Chelation Therapy]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
flowchart TD
    A[Genetic Mutation] --> B[Defective Erythroblast Division/Maturation]
    B --> C1[CDA I: CDAN1 → Nuclear Division Defect → Multinuclear Erythroblasts]
    B --> C2[CDA II: SEC23B → Trafficking/Glycosylation Defect → Binuclear Erythroblasts, ↓ Band 3]
    B --> C3[CDA III: KIF23 → Cytokinesis Defect → Multinuclear Erythroblasts]
    B --> C4[CDA IV: KLF1 → Transcriptional Dysregulation]
    C1 & C2 & C3 & C4 --> D[Ineffective Erythropoiesis]
    D --> E[Increased Erythroblast Apoptosis]
    E --> F[Anaemia + Haemolysis + Iron Overload]
```
