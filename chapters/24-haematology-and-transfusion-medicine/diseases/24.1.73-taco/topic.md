---
tags: [medicine, haematology, davidson, transfusion-reactions, taco, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - TACO is the most common transfusion reaction causing major morbidity. Key viva: Volume overload pathophysiology, BNP elevation, differentiation from TRALI, and risk factors (elderly, cardiac failure, rapid transfusion)."
see_also: ["TRALI", "Transfusion Reactions", "Massive Transfusion Protocol", "Heart Failure", "Transfusion Medicine"]
created: 2026-06-15
modified: 2026-06-15
---
...
mindmap
  root((TACO))
    Definition
      Pulmonary Oedema ≤6h Post-Transfusion
      Volume Overload (Hydrostatic)
    Pathophysiology
      Rapid Volume → ↑ Pulmonary Capillary Pressure
    ...
    Risk Factors
      ...
      CKD (eGFR <30)
      Rapid Transfusion (>1 Unit/2h)
      Positive Fluid Balance
    Clinical
      Dyspnoea, Orthopnoea, Pink Frothy Sputum
      Hypertension, Tachycardia, JVP↑, S3
      Bilateral Pulmonary Oedema (CXR)
    Diagnostics
      BNP/NT-proBNP ↑↑ (Key)
      Echo: LV Dysfunction
      CXR: Cardiomegaly, Batwing Oedema
      Fluid Balance Positive
    TACO vs TRALI
      TACO: BNP↑, HTN, Diuretic Response
      TRALI: BNP Normal, Hypotension, No Diuretic Response
    Management
      STOP Transfusion
      Sit Up, O₂, NIV/CPAP
    ...
    Prevention
      Slow Rate (1 Unit/2-3h)
      Pre-Transfusion Furosemide
      Single-Unit Policy
