---
tags: [medicine, davidson, hematology, sideroblastic-anaemia, anaemia, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Ring sideroblasts, reversible vs congenital, lead poisoning"
see_also: "[[Iron Deficiency Anaemia]], [[Anaemia of Chronic Disease]], [[Lead Poisoning]], [[MDS]], [[Pyridoxine Deficiency]]"
created: 2025-06-16
modified: 2025-06-16
---
...
```mermaid
mindmap
  root((Sideroblastic Anaemia))
    Definition
      Ring Sideroblasts ≥15%
      Prussian Blue Stain
    Pathophysiology
      Defective Haeme Synthesis
      Mitochondrial Iron Overload
    Classification
      Congenital: ALAS2, SLC25A38
      Acquired MDS: SF3B1 (80%)
      Acquired Reversible: EtOH, Lead, INH, B6, Cu
    Diagnosis
      Blood Film: Dimorphic, Basophilic Stippling
      Iron Studies: High Ferritin/TSAT
      BM: Prussian Blue ≥15% Ring Sideroblasts
      SF3B1 Mutation
    Management
      Reversible: Treat Cause
      Pyridoxine Trial: 100-200mg × 3-6mo
      MDS-RS: Luspatercept (SF3B1+)
