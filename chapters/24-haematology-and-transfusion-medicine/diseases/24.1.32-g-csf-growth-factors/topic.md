---
tags: [medicine, davidson, hematology, g-csf, growth-factors, epo, thrombopoietin, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | G-CSF (Filgrastim/Pegfilgrastim), Erythropoietin (EPO), Thrombopoietin Agents (Eltrombopag/Romiplostim), indications, dosing, monitoring, side effects"
see_also: "[[Aplastic Anaemia]], [[MDS]], [[Chemotherapy-Induced Neutropenia]], [[Stem Cell Transplantation]], [[ITP]]"
created: 2025-06-16
modified: 2025-06-16
---
...
mindmap
  root((Growth Factors))
    G-CSF
      Filgrastim (Daily SC)
      Pegfilgrastim (Single Post-Chemo)
      Indications: Chemo FN, HSCT Mobilisation, Congenital Neutropenia
      SE: Bone Pain, Splenic Rupture (Rare)
      Mobilisation: 10µg/kg + Plerixafor
    EPO / Darbepoetin
      Indications: CKD, Chemo, MDS
      Target Hb: 10-11 (Max 11.5)
      Iron First (Ferritin>100, TSAT>20%)
      Risks: Thrombosis, HTN, PRCA, Tumour Progression
    TPO-RA
      Eltrombopag (Oral, Empty Stomach)
      Romiplostim (SC Weekly)
      Target Plt: 50-200
      ITP, AA, HCV Thrombocytopenia
      SE: Eltrombopag = LFT/Cataract/Fibrosis
      Romiplostim = Thrombosis/Fibrosis
    Mobilisation
      G-CSF 10µg/kg × 4-5d
      Plerixafor 240µg/kg (Poor Mobiliser)
    Other
      GM-CSF (Rare)
