---
tags: [medicine, davidson, hematology, transfusion, red-cell-transfusion, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Indications, thresholds (Hb 70-80), ABO/Rh compatibility, crossmatch, special requirements (irradiated, CMV-, washed), storage, complications"
see_also: "[[Platelet Transfusion]], [[Massive Transfusion Protocol]], [[Transfusion Reactions]], [[Transfusion Compatibility]]"
created: 2025-06-16
modified: 2025-06-16
---
...
```mermaid
mindmap
  root((Red Cell Transfusion))
    Indications
      Restrictive: Hb <70 (Stable)
      Liberal: Hb <80 (Cardiac/ACS)
      Active Bleed: Hb <80-100
    Dose
      1 Unit = 300mL = Hb +10g/L (70kg)
      Paeds: 10-15mL/kg
    Compatibility
      ABO: O→All, A→A/AB, B→B/AB, AB→AB
      Rh: Neg only for Rh Neg
      Crossmatch: Electronic / IS / AHG
    Special Products
      Irradiated: TA-GVHD Prevention
      CMV Neg / Leucodepleted
      Washed: IgA Def, Allergic
      Pheno-Matched: Sickle, Thal, AIHA
    Storage Lesion
      2,3-DPG↓, K+↑, pH↓, Microaggregates
      Max 4h out of fridge
    Acute Reactions
      AHTR: ABO Mismatch → STOP
      FNHTR: Fever, Cytokines
      TRALI: Non-Cardio Pulm Oedema
      TACO: Volume Overload
      Anaphylaxis: Adrenaline
    Delayed Reactions
      DHTR: 3-10d, Anamnestic Ab
      TA-GVHD: 10-14d, FATAL → IRRADIATE
      PTP: 5-10d, Thrombocytopenia
    Infections
      NAT Window: HIV 9d, HCV 7d, HBV 20d
```
