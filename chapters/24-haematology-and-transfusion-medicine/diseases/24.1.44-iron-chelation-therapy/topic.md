---
tags: [medicine, davidson, hematology, iron-chelation, thalassaemia, sickle-cell, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Deferoxamine (DFO), Deferiprone (DFP), Deferasirox (DFX), monitoring (ferritin, LIC, T2*), indications, dose, side effects, combination therapy"
see_also: "[[Thalassaemia]], [[Sickle Cell Disease]], [[Transfusion Medicine]], [[Myelodysplastic Syndromes]]"
created: 2025-06-16
modified: 2025-06-16
---
...
mindmap
  root((Iron Chelation Therapy))
    ...
    Deferoxamine (DFO)
      ...
      Pregnancy: Safe
    Deferiprone (DFP)
      Oral TDS 75-100mg/kg
      Weekly ANC (Agranulocytosis!)
      Arthralgia
      Pregnancy: Contraindicated
    Deferasirox (DFX)
      Oral OD
      Monthly Creatinine (Renal!)
      GI Ulcers, Fanconi-like
      Pregnancy: Contraindicated
    Combination
      DFO + DFP (Best Cardiac)
      DFX + DFP
      DFX + DFO
    Monitoring
      Ferritin q3mo
