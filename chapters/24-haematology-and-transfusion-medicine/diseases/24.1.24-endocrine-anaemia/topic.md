---
tags: [medicine, davidson, hematology, endocrine-anaemia, thyroid, adrenal, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Hypothyroidism, Hyperthyroidism, Adrenal insufficiency, Cushing's, Myxoedema, Anaemia of endocrine origin"
see_also: "[[Anaemia of Chronic Disease]], [[Iron Deficiency Anaemia]], [[Vitamin B12 Deficiency Anaemia]], [[Liver Disease Coagulopathy]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Endocrine Anaemia))
    Hypothyroidism
      Normocytic / Macrocytic
      ↓ EPO, ↓ Marrow Response
      Levothyroxine → Resolves 2-3mo
      Pernicious Anaemia overlap
    Hyperthyroidism
      Mild Normocytic
      ↑ Turnover
      Carbimazole → Resolves
    Adrenal Insufficiency (Addison's)
      Normocytic
      ↓ Androgens → ↓ EPO
      Hydrocortisone → Rapid resolution
      Autoimmune Polyglandular overlap
    Cushing's Syndrome
      Polycythaemia (Common)
      Androgens → EPO ↑
      Anaemia only if Fe Def
```
