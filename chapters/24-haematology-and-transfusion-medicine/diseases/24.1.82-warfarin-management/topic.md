---
tags: [medicine, davidson, hematology, warfarin, anticoagulation, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Indications, dosing, INR targets, monitoring, reversal, interactions, bridging, peri-procedural, pregnancy"
see_also: "[[Coagulation Assays]], [[Heparin Management]], [[DOAC Management]], [[Anticoagulation Monitoring]], [[Vitamin K Deficiency]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Warfarin Management))
    Indications
      AF, VTE, Mechanical Valves, APS
    INR Targets
      Standard 2-3
      High Risk 2.5-3.5 (Mech Mitral, APS Arterial)
    Initiation
      Day 1-2: 10mg (5mg Elderly)
      INR Day 3, Adjust Day 4
    Monitoring
      Daily x7d → 2-3×/wk → Monthly
    Dose Adjustment
      <1.5: ↑20-30%
      1.5-1.9: ↑10-20%
      2-3: Maintain
    ...
    Reversal
      ...
      Major: PCC + Vit K IV
    Interactions
      ↑ INR: Macrolides, Quinolones, TMP-SMX, Amiodarone, Azoles
      ↓ INR: Rifampicin, Carbamazepine, Phenytoin
    Bridging
      High Risk Only: Mech Mitral, Recent VTE, CHA2DS2-VASc≥5
      LMWH 1mg/kg BD, INR<2 Start
    Peri-procedural
      Low Risk: Continue
      High Risk: Stop 5d, Bridge
    Pregnancy
      CONTRAINDICATED (Weeks 6-12)
      Switch to LMWH Pre-conception
```
