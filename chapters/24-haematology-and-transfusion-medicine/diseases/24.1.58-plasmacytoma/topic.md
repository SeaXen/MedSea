---
tags: [medicine, davidson, hematology, plasmacytoma, solitary-plasmacytoma, multiple-myeloma, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Solitary bone/soft tissue plasmacytoma, progression to myeloma, radiotherapy, surveillance, SMOLDERING myeloma distinction"
see_also: "[[Multiple Myeloma]], [[MGUS]], [[Amyloidosis (AL)]], [[Waldenström Macroglobulinaemia]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Solitary Plasmacytoma))
    Types
      SBP (Bone, 70%)
      EMP (Soft Tissue, 30%)
    Diagnosis
      Biopsy: Clonal Plasma Cells
      BM: <10% Plasma Cells
      PET-CT: Single Lesion
      No CRAB/SLiM
    Management
      RT: 40-50 Gy (Curative)
      SBP: RT Alone
      EMP: RT ± Surgery
      No Adjuvant Chemo
    Progression
    ...
    Surveillance
      q3-6mo × 5yr: SPEP, sFLC, CBC, Renal, Ca, PET-CT
