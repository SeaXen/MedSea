---
tags: [medicine, davidson, hematology, liver-disease-macrocytosis, alcohol-macrocytosis, macrocytic-anaemia, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Liver disease macrocytosis, alcohol macrocytosis, target cells, B12/Folate normal, differentiation from other causes"
see_also: "[[Drug-Induced Macrocytosis]], [[Vitamin B12 Deficiency Anaemia]], [[Folate Deficiency Anaemia]], [[Sideroblastic Anaemia]], [[Liver Disease Coagulopathy]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Liver/Alcohol Macrocytosis))
    Liver Disease
      Mechanism: ↑ Membrane Cholesterol
      Blood Film: Target Cells (Many)
      MCV: 100-110
      B12/Folate: Normal
      LFTs: AST/ALT/ALP/GGT ↑
      PT ↑, Platelets ↓
    Alcohol
      Mechanism: Direct Toxicity + Folate Def + Liver
      Blood Film: Target + Oval Macro
      MCV: 100-115
      GGT: ↑↑ (Sensitive)
      AST > ALT (2:1)
      Folate: Often Low
    Mechanism Differences
      Liver: Lipid Membrane Alteration
      Alcohol: Direct Toxicity + Nutritional
    Management
      Liver: Treat Underlying
      Alcohol: Abstinence + Thiamine + Folate + B-complex
    Differential
      vs B12/Folate: Target Cells vs Hypersegmented Neutrophils
      vs MDS: No Dysplasia
      vs Drug: History
```
