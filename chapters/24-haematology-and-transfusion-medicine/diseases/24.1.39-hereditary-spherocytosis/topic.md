---
tags: [medicine, davidson, hematology, hereditary-spherocytosis, haemolytic-anaemia, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Membrane defect, splenectomy, osmotic fragility, EMA binding, cholecystectomy"
see_also: "[[Haemolytic Anaemias]], [[G6PD Deficiency]], [[AIHA]], [[Elliptocytosis]], [[Cholecystectomy]]"
created: 2025-06-16
modified: 2025-06-16
---
...
```mermaid
mindmap
  root((Hereditary Spherocytosis))
    Genetics
      AD 75%: Spectrin, Ankyrin, Band 3
      AR 25%: Severe
    Pathophysiology
      Vertical Linkage Loss
    ...
    Diagnosis
      Film: Spherocytes
      DAT: NEGATIVE
      EMA Binding: DECREASED (Gold)
      OFT: INCREASED (Classic)
    Management
      Folic Acid 5mg daily
      Splenectomy ≥6yr (Curative)
      Vaccines + Penicillin Lifelong
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 24: Haematology — Hereditary Spherocytosis*

**Q1.** Which of the following features is most specific or characteristic of Hereditary Spherocytosis?
  ...
  > **Answer: A** — "EMA = Gold Standard"
  >
  > *Source:* nd 3, Protein 4.2"** | Protein defects |
| **"Spherocytes = No Central Pallor"** | Film finding |
| **"EMA = Gold Standard"** | Diagnostic test |
| **"Splenectomy ≥6yr = Penicillin Life"** | Post-sple

**Q2.** What is the most appropriate first-line therapy for Hereditary Spherocytosis?

  - **A.** Vaccinations + Pre-splenectomy + COVID, Flu
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Vaccinations + Pre-splenectomy + COVID, Flu
  >
  > *Source:* **Vaccinations**   **Pre-splenectomy**: PCV13, PPSV23, MenACWY, Hib, **COVID, Flu**  
