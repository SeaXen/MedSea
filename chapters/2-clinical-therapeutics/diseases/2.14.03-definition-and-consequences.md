...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Definition and Consequences*

**Q1.** Which of the following features is most specific or characteristic of Definition and Consequences?

  - **A.** "Prescribing cascade = any new drug after another"
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — "Prescribing cascade = any new drug after another"
  >
  > *Source:* |
| **"Prescribing cascade = any new drug after another"** | Cascade specifically = **ADR misdiagnosed as new condition**
