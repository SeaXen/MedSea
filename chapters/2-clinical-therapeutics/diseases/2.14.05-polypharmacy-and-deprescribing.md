...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Polypharmacy and Deprescribing*

**Q1.** Which of the following features is most specific or characteristic of Polypharmacy and Deprescribing?
  ...
  > **Answer: A** — ACB vs DBI
  >
  > *Source:* ), Explicit drug list; **STOPP/START** = EU/Ireland, Criteria-based, Includes START (omissions) |
| **ACB vs DBI** | **ACB** = Anticholinergic-specific (3/2/1 scoring); **DBI** = Sedative + Anticholin
