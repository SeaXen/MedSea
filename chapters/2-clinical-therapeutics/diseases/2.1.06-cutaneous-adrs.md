...
## 2. 2. 📊 Classification by Severity & Morphology
...
## 3. 3. 🔬 Severe Cutaneous Adverse Reactions (SCARs) Comparison
...
### 1. SCORTEN (SJS/TEN Severity Score) — *Calculate at admission*
| Parameter | Points |
|-----------|--------|
| Age >40 years | 1 |
...
### 2. RegiSCAR (DRESS) — *Scoring system*
| Criterion | Score |
|-----------|-------|
| Fever ≥38°C | 1 |
...
## 5. 5. ⚡ Emergency Management of SCARs

```mermaid
flowchart TD
    A[Suspect SCAR: SJS/TEN/DRESS/AGEP] --> B[**STOP ALL NON-ESSENTIAL DRUGS IMMEDIATELY**]
    B --> C{SCAR Type?}
    C -->|SJS/TEN| D[**ICU / Burns Unit Referral**
Fluid/electrolyte management
Wound care (non-adherent dressings)
Ophthalmology review (ocular mucosa)
Infection surveillance
Nutrition (NG if oral mucosa severe)]
    C -->|DRESS| E[**Systemic Steroids: Prednisolone 1mg/kg/day**
Slow taper 6–12 weeks
Monitor LFTs, renal, cardiac
IVIG controversial]
    C -->|AGEP| F[**Supportive only**
Topical steroids/emollients
Antihistamines for pruritus
Typically resolves <2 weeks post-withdrawal]
    D & E & F --> G[**Identify culprit drug** — detailed timeline
HLA testing if indicated (retrospective)
Document allergy: drug + reaction type
Cross-reactivity counselling]
```
...
### 1. Long Question (10 marks): *"Discuss the classification, diagnosis, and management of severe cutaneous adverse reactions (SCARs)."*
...
### 2. Short Question (5 marks): *"SJS vs TEN vs DRESS"*
...
### 3. Viva (2 min): *"Patient on allopurinol 10 days, fever, rash, eosinophilia 2.5×10⁹, ALT 200. Diagnosis? Management?"*
...
### 4. Ward Round (30 sec): *"Patient on carbamazepine 2 weeks, widespread targetoid lesions, oral ulcers, 5% BSA detachment. Immediate steps?"*
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Cutaneous ADRs*

**Q1.** What is the most appropriate first-line therapy for Cutaneous ADRs?
  ...
  > **Answer: A** — Supportive only
  >
  > *Source:* C --> AGEP  F[**Supportive only**<br/>Topical steroids/emollients<br/>Antihistamines for pruritus<br/>Typically resolves <2 weeks post-withdrawal]
