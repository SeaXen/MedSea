...
## 2. 2. Stratification of Clinical Significance
...
## 3. 3. Mermaid Algorithm — Interaction Risk Assessment

```mermaid
flowchart TD
    A[Two drugs co-prescribed] --> B[Check interaction database
BNF, Stockley, Lexicomp]
    B --> C{Severity?}
    C -->|Severe| D[AVOID combination
or switch drug]
    C -->|Moderate| E{Is this patient
at high risk?}
    C -->|Mild| F[Aware; continue]
    E -->|Yes| G[Switch or monitor closely
with TDM if available]
...
### 1. 4.1 Patient-Related Risk Factors
...
### 2. 4.2 Drug-Related Risk Factors
...
### 3. 4.3 Top 10 Highest-Risk Drug Combinations (Mnemonic: "**WWALICCTSM**")
...
### 5. 4.5 Food / Herbal / OTC Interactions
