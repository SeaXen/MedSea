...
### 1. [[Medication Safety/Types of medication errors|Types of Medication Errors]]
...
### 2. [[Medication Safety/Root causes|Root Causes & Contributing Factors]]
...
### 3. [[Medication Safety/Prevention strategies|Prevention Strategies]]
...
### 4. [[Medication Safety/High-risk drugs|High-Risk Drugs (PINCH/PINCHER)]]
...
### 1. PINCH / PINCHER High-Alert Drug Classes
...
### 2. Medication Reconciliation (ATD)
| Transition | Action |
|------------|--------|
...
### 3. Common LASA Pairs (Tall Man Lettering)
...
### 4. Independent Double-Check Requirements
...
```mermaid
mindmap
  root((Medication Safety))
    Error Types
      Prescribing (Drug, Dose, Freq, Route, Patient, Allergy, Interaction)
      Dispensing (Wrong Drug, Strength, Qty, Label, Patient)
      Administration (Time, Rate, Route, Technique, Patient, Omission)
      Monitoring (Labs, TDM, Clinical Response, ADR Surveillance)
    Root Causes
      Human Factors (Fatigue, Distraction, Knowledge, Communication)
      System (LASA, High-Alert, Transitions, Workload)
    High-Alert (PINCHER)
    ...
    Prevention
      Reconciliation (ATD, BPMH)
      CPOE (Dose, Allergy, Interaction, Duplicate Alerts)
      Tall Man (LASA)
      Double-Check (PINCHER)
      Education/Culture
    Transitions
      Admission (BPMH)
      Transfer (Review/Adjust)
      Discharge (Reconcile + Communicate)
```
