...
### 1. [[Special Populations/Renal impairment|Renal Impairment]]
...
### 2. [[Special Populations/Hepatic impairment|Hepatic Impairment]]
...
### 3. [[Special Populations/Elderly|Elderly Prescribing]]
...
### 4. [[Special Populations/Pregnancy and lactation|Pregnancy & Lactation]]
...
### 5. [[Special Populations/Paediatrics|Paediatric Prescribing]]
...
### 1. Renal Dosing Quick Reference (eGFR-based)
...
### 2. Common Drug Renal Adjustments (CKD Stages G3-G5)
...
### 3. Hepatic Impairment (Child-Pugh)
...
### 4. Pregnancy Categories (FDA → Phased Out; Use Narrative Labelling)
...
### 5. Teratogenic Critical Periods
...
### 6. Key Teratogens (Avoid in Pregnancy)
...
```mermaid
mindmap
  root((Prescribing in Special Populations))
    Renal
      Cockcroft-Gault
      eGFR thresholds
      Metformin <30 NO
    ...
    Hepatic
      Child-Pugh A/B/C
      High-extraction (Propranolol, Morphine)
      Low-extraction (Warfarin, Phenytoin)
      Avoid hepatotoxins in C
    Pregnancy
      FDA/UK categories
      Teratogens: Valproate, Warfarin, ACEi, Lithium, Isotretinoin
      Safe: Labetalol, LMWH, Insulin, Lamotrigine, Sertraline
      Critical periods: NT 18-28d, Heart 20-50d, Limbs 24-46d
    Elderly
      PK/PD changes
      STOPP/START v3
      Beers 2023
