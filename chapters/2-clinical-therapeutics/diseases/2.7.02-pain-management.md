...
## 2. 2. 🧠 Core Concept: WHO Analgesic Ladder (Updated 2019)

```mermaid
flowchart TD
    A[Pain Assessment
Severity: Mild/Moderate/Severe
Type: Nociceptive/Neuropathic/Mixed] --> B{Step 1: Mild Pain
NRS 1-3}
    B --> C[Paracetamol 1g QDS
± NSAID (ibuprofen 400mg TDS)
± Adjuvant if neuropathic]
    C --> D{Inadequate?}
    D -->|Yes| E[Step 2: Moderate Pain
NRS 4-6]
...
+ Adjuvant]
    G --> H{Inadequate?}
    H -->|Yes| I[Step 3: Severe Pain
NRS 7-10]
    H -->|No| J[Continue + Review]
    I --> K[Strong Opioid
Morphine PO 10-20mg Q4H
or Oxycodone PO 5-10mg Q4H
or Fentanyl TD patch
+ Paracetamol/NSAID
+ Adjuvant
+ Laxative + Antiemetic PRN]
    K --> L{Inadequate?}
    L -->|Yes| M[Optimise: Dose titration
Opioid rotation
...
## 3. 3. ️⃣ Step 1: Non-Opioid Analgesics
...
### 1. Paracetamol + NSAID Combination
...
## 4. 4. ️⃣ Step 2: Weak Opioids (Moderate Pain)
...
## 5. 5. ️⃣ Step 3: Strong Opioids (Severe Pain)

### 1. First-Line Oral Opioids
...
### 2. Modified-Release (MR) — For Background Pain
...
### 3. Transdermal — For Stable Pain / Swallowing Difficulty
...
## 6. 6. ️⃣ Opioid Conversion — Oral Morphine Equivalent (OME)

### 1. Conversion Table (Approximate — **Always Reduce 30–50% on Rotation**)
...
### 2. Methadone Conversion — **Specialist Only**
...
## 7. 7. ️⃣ Breakthrough Pain — Rescue Dosing
...
## 8. 8. ️⃣ Adjuvant Analgesics — Neuropathic Pain

### 1. First-Line (NICE CG173)
...
## 9. 9. ️⃣ Opioid Side Effects — Prevention & Management
...
## 10. 10. ️⃣ Special Populations

### 1. Renal Impairment — **Opioid Choice Critical**
...
### 4. Palliative Care — Syringe Drivers (SC Infusion)
...
## 11. 11. ️⃣ Practical Prescribing Algorithm

```mermaid
flowchart TD
    A[Assess Pain: Severity, Type, Impact] --> B{Neuropathic Component?}
    B -->|Yes| C[Add Adjuvant at ALL Steps
Gabapentin/Pregabalin/Duloxetine/Amitriptyline]
    B -->|No| D[Proceed]
    C & D --> E{Pain Severity}
    E -->|Mild (1-3)| F[Step 1: Paracetamol ± NSAID
Regular dosing]
    E -->|Moderate (4-6)| G[Step 2: Weak Opioid
Codeine/Tramadol + Step 1]
    E -->|Severe (7-10)| H[Step 3: Strong Opioid
Morphine/Oxycodone MR + IR breakthrough]
    F & G & H --> I[Co-prescribe Laxative + Antiemetic PRN]
    I --> J[Review: 24-48h (acute), 1-2w (chronic)]
    J --> K{Adequate Control?}
    K -->|No| L[Optimise: Titrate dose
Add/Adjust adjuvant
Opioid rotation
Specialist referral]
...
## 13. 13. 🎤 Viva Questions (Expected Answers)
...
## 16. 16. 📅 Spaced Repetition Tracker
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Pain Management*

**Q1.** What is the most appropriate first-line therapy for Pain Management?
  ...
  > **Answer: A** — Nausea/Vomiting
  >
  > *Source:* **Nausea/Vomiting**   Antiemetic PRN (metoclopramide/ondansetron) for 1st week   Regular antiemetic if persistent; rotate opioid
