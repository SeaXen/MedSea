...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Licensing and approval*

**Q1.** Which of the following features is most specific or characteristic of Licensing and approval?
  ...
  >
  > *Source:* n children, unsafe, ineffective)

---
| Confusion | Clarification |
|-----------|---------------|
| **Accelerated (FDA) vs Conditional (EMA)** | **FDA Accelerated** = Surrogate endpoint, confirmatory 
