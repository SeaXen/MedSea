...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Evidence-based prescribing*

**Q1.** Which landmark clinical trial provided evidence relevant to the management of Evidence-based prescribing (specifically: benefit of antihypertensives in:**
   A)?
  ...
  > **Answer: A** — HYVET trial
  >
  > *Source:* **HYVET trial demonstrated benefit of antihypertensives in:**
   A
