...
## 2. 2. 📖 Classification of PD Interactions
...
## 3. 3. ⚡ Receptor-Level Interactions
...
## 4. 4. 🔄 Physiological System Interactions (High-Yield Syndromes)

### 1. 1. Triple Whammy (Renal)
...
### 3. 3. Neuroleptic Malignant Syndrome (NMS)
...
### 5. 5. Anticholinergic Burden (Additive)
...
### 6. 6. Hypokalaemia-Induced Interactions
| Scenario | Drugs | Risk |
|----------|-------|------|
...
### 7. 7. Hyperkalaemia-Induced Interactions
| Scenario | Drugs | Risk |
|----------|-------|------|
...
### 8. 8. Bleeding Risk (Additive/Synergistic)
...
### 1. Short Question (5 marks): *"Triple Whammy AKI"*
- ACEi/ARB + Diuretic + NSAID → ↓ efferent + ↓ volume + ↓ afferent → ↓↓ GFR
- Avoid NSAID; monitor creatinine; hold ACEi/ARB if AKI

### 2. Viva (2 min): *"SSRI + Tramadol + Linezolid → confusion, clonus, fever. Diagnosis? Management?"*
...
### 3. Ward Round (30 sec): *"Patient on ramipril, furosemide, started ibuprofen for knee pain. Day 5: Cr 180 (baseline 100). Action?"*
