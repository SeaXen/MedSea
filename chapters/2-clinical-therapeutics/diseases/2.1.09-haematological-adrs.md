...
## 2. 2. 📊 Classification by Cell Line
...
## 3. 3. ⚠️ Agranulocytosis — **Medical Emergency**
...
### 1. High-Risk Drugs for Agranulocytosis
...
flowchart TD
    ...
    B --> C{ANC <0.5 × 10⁹/L?}
    C -->|YES| D[**AGRANULOCYTOSIS**
**STOP DRUG IMMEDIATELY**
**IV Broad-spectrum antibiotics** (Piperacillin-tazobactam / Meropenem)
**G-CSF** (Filgrastim 5mcg/kg/day until ANC>1.0)
**Reverse isolation**
Blood/urine cultures
No routine antifungals unless persistent fever>4-5d]
    C -->|ANC 0.5-1.0| E[**SEVERE NEUTROPENIA**
Stop drug
IV antibiotics if febrile
G-CSF consideration
Close monitoring]
    C -->|ANC 1.0-1.5| F[**MODERATE NEUTROPENIA**
Stop drug if possible
Oral antibiotics if febrile
Monitor FBC 2-3x/week]
    C -->|ANC >1.5| G[**NOT NEUTROPENIC**
Evaluate other causes of fever
Continue drug if benefit>risk]
```

---

## 4. 4. 🩸 Drug-Induced Thrombocytopenia (DITP) & HIT

### 1. DITP (Non-HIT Immune Thrombocytopenia)
| Feature | DITP |
|---------|------|
...
### 2. Heparin-Induced Thrombocytopenia (HIT) — **Critical**
| Feature | **HIT (Type II)** |
|---------|-------------------|
...
### 3. HIT Management Algorithm
```mermaid
flowchart TD
    A[Suspect HIT: Thrombocytopenia 5-14d post-heparin] --> B[Calculate 4Ts Score]
    B --> C{4Ts Score}
    C -->|**Low (≤2)**| D[**HIT UNLIKELY**
Continue heparin if needed
Monitor platelets]
    C -->|**Intermediate (3-4)**| E[**STOP ALL HEPARIN** (UFH, LMWH, flushes)
**Start non-heparin anticoagulant**:
Argatroban (IV, hepatic adj) / Bivalirudin (IV, renal adj) / Fondaparinux (SC, off-label)
Send **HIT antibody (PF4 ELISA)**
If ELISA +ve → continue anticoagulation]
    C -->|**High (≥5)**| F[**STOP ALL HEPARIN IMMEDIATELY**
**Start non-heparin anticoagulant** (Argatroban/Bivalirudin/Fondaparinux)
Send HIT antibody
**Do NOT wait for result**
**No platelet transfusion** (unless active bleed)
**No warfarin alone** (risk WISN — wait for platelet recovery >150)]
    D & E & F --> G[**Anticoagulation duration**: 3 months if thrombosis; 4–6 weeks if isolated HIT
Transition to DOAC/Warfarin after platelet recovery >150]
```

### 4. HIT vs DITP Comparison
| Feature | **HIT** | **DITP** |
|---------|---------|----------|
...
## 5. 5. 🔴 Haemolytic Anaemia

### 1. Immune Haemolytic Anaemia (Type II)
...
### 2. G6PD Deficiency (Oxidative Haemolysis)
| Drug | Risk |
|------|------|
| **Dapsone** | **High** |
...
### 3. Microangiopathic Haemolytic Anaemia (MAHA/TMA)
| Drug | Context |
|------|---------|
...
### 1. Long Question (10 marks): *"Discuss heparin-induced thrombocytopenia (HIT) — pathophysiology, diagnosis, and management."*
...
### 2. Short Question (5 marks): *"HIT 4Ts Score"*
...
### 3. Viva (2 min): *"Patient on UFH 7 days, platelets 80 (baseline 250), new DVT. 4Ts? Management?"*
...
### 4. Ward Round (30 sec): *"Patient on clozapine 3 months, temp 38.5°C. Immediate steps?"*
