...
## 2. 2. 🧬 High-Yield HLA Allele–Drug Association Table
...
## 3. 3. 📊 Screening Algorithms (Mermaid)

### 1. Carbamazepine/Oxcarbazepine — HLA-B*15:02
```mermaid
flowchart TD
...
## 4. 4. ⚖️ Number Needed to Screen (NNS) & Cost-Effectiveness
...
## 5. 5. 🧠 Pathophysiology: HLA-Restricted T-Cell Activation
...
### 1. Long Question (10 marks): *"Discuss HLA-B*57:01 screening before abacavir therapy"*
**Structure:**
...
### 2. Short Question (5 marks): *"HLA-B*15:02 and carbamazepine"*
- Allele: HLA-B*15:02
...
### 3. Viva (2 min): *"Why screen for HLA-B*58:01 before allopurinol but not HLA-B*15:02 in Europeans?"*
...
### 4. Ward Round (30 sec): *"Patient on allopurinol 300 mg, eGFR 25, develops rash + fever day 10. Plan?"*
