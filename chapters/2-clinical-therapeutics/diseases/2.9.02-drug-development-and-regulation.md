...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 2: Clinical Therapeutics — Drug Development and Regulation*

**Q1.** Which of the following features is most specific or characteristic of Drug Development and Regulation?

  - **A.** Conditional MA / CMA
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — Conditional MA / CMA
  >
  > *Source:* ial improvement |
| **Fast Track** | US (FDA) | Serious condition + unmet need → rolling review |
| **Conditional MA / CMA** | EU/UK | Less comprehensive data for unmet need (specific obligations) |
