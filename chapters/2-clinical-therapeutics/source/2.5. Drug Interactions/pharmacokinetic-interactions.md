...
## 2. ADME Stages of Pharmacokinetics
...
## 3. Mermaid Algorithm — PK Interaction Framework
...
flowchart TD
    ...
    B -->|Metabolism| E[CYP450 induction/inhibition<br/>UGT, FMO]
    B -->|Excretion| F[Renal tubular secretion<br/>P-gp, BCRP]
    C --> G[↑↓ Drug concentration]
    D --> G
    E --> G
    F --> G
    G --> H{Effect clinically<br/>significant?}
...
### 4.3 Metabolism Interactions (CYP450)
