...
## 3. ️⃣ P — Potassium & Concentrated Electrolytes
...
### Prevention Strategies (Forcing Functions Priority)
...
## 5. ️⃣ N — Narcotics/Opioids (Injectable)
...
## 6. ️⃣ C — Chemotherapy (Cytotoxics)
...
### Prevention Strategies (Highest Level)
...
## 7. ️⃣ H — Heparins & Anticoagulants

### Specific Risks by Class
...
## 8. ️⃣ ISMP Additional High-Alert Classes (Beyond PINCH)
...
## 9. ️⃣ Unified Prevention Framework for ALL High-Alert Drugs

```mermaid
flowchart TD
    A[High-Alert Drug] --> B{Can we eliminate<br>ward storage?}
    B -->|Yes| C[Forcing Function:<br>Remove from ward]
    B -->|No| D{Can we standardise<br>concentration/prep?}
    D -->|Yes| E[Standardisation:<br>Pre-mixed, pharmacy-prep]
    D -->|No| F{Can we automate<br>with hard stops?}
    F -->|Yes| G[Automation:<br>CPOE, Smart pumps, BCMA]
    F -->|No| H[Redundancy:<br>Independent double-check]
    H --> I[Monitoring:<br>Specific parameters, frequency]
    I --> J[Patient Education:<br>Self-monitoring, alerts]
```

### Independent Double-Check — When Mandatory
