...
## 2. 🧠 Core Concept: Drug Development Timeline
...
## 3. ️⃣ Preclinical Development

### Required Studies (ICH M3/M6)
...
### Phase IV — Post-Marketing / Real-World
| Aspect | Details |
|--------|---------|
...
## 5. ️⃣ Regulatory Approval Pathways
...
### EU (EMA) — Centralised vs National
| Procedure | Scope |
|-----------|-------|
...
## 6. ️⃣ Common Technical Document (CTD) — Dossier Structure
...
## 7. ️⃣ Pharmacovigilance — Post-Marketing Safety
...
flowchart TD
    ...
    C -->|Yes| D[Risk Assessment<br>CIOMS/WHO criteria]
    D --> E[Risk Minimisation]
    E --> F1[Label Update<br>(SmPC/PIL)]
    E --> F2[RMP Update<br>(Additional monitoring)]
...
## 8. ️⃣ Generic vs Biosimilar Approval

### Generic Medicines (Small Molecules)
...
## 9. ️⃣ Special Regulatory Designations
...
## 10. ️⃣ UK Health Technology Assessment (HTA) — NICE

### NICE Technology Appraisal (TA) Process
```mermaid
flowchart TD
    A[Topic Selection] --> B[Scope Development]
    B --> C[Evidence Submission<br/>(Company + Independent)]
    C --> D[Assessment Group<br/>(Critique + Economic Model)]
    D --> E[Appraisal Committee<br/>(Clinical + Economic)]
    E --> F[Draft Guidance]
    F --> G[Consultation]
    G --> H[Final Guidance]
...
## 11. ️⃣ Prescribing in the UK — Regulatory Framework
...
## 12. 🔟 Pharmacovigilance in Clinical Practice
...
```mermaid
mindmap
  root((Drug Development<br>& Regulation))
    Preclinical
      PK/PD/Tox
      Allometric scaling
      NOAEL → MRSD
