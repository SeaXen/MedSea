# Rational Prescribing: Definition, Aims & P-Drug Concept
...
## 3. Mermaid Algorithm — WHO 6-Step Prescribing Model

```mermaid
flowchart TD
    A[Step 1: Define the patient's problem] --> B[Step 2: Specify therapeutic objective]
    B --> C[Step 3: Choose standard P-treatment]
    C --> D[Verify suitability of P-drug<br/>Contraindications, Interactions, Cost]
    D -->|Suitable| E[Step 4: Write prescription]
    D -->|Not suitable| F[Step 3b: Choose alternative]
    F --> C
    E --> G[Step 5: Give information<br/>drug, indication, side effects, duration]
    G --> H[Step 6: Monitor<br/>efficacy, safety, adherence]
    H --> I{Therapy effective<br/>and safe?}
...
### 4.2 4 ESC Criteria for P-Drug Selection
...
### 4.3 Seven "Rights" of Prescribing (Mnemonic: **"DR.T.RAMP"**)
