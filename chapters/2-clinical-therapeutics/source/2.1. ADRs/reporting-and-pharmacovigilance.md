# ADR Reporting & Pharmacovigilance (Yellow Card, Black Triangle, PSUR)
...
## 3. Mermaid Algorithm — Pharmacovigilance Workflow

```mermaid
flowchart TD
    A[ADR occurs in patient] --> B[Healthcare professional identifies]
    B --> C[YELLOW CARD to MHRA<br/>or national PV centre]
    C --> D[National PV database<br/>VigiBase - WHO Uppsala]
    D --> E[Signal detection<br/>PRR, ROR, EBCPV]
...
### 4.1 Yellow Card Scheme (UK MHRA)
...
### 4.3 Pharmacovigilance Tools & Methods
...
### 4.4 Signal Detection — Quantitative Methods
...
### 4.5 Pharmacovigilance — National & International
...
### 4.6 Causality Assessment in PV
