...
## 3. Mermaid Algorithm — ADR Workup
...
## 4. Comparison Tables — Drug-Induced Disease by System

### 4.1 Drug-Induced Skin Reactions
...
### 4.3 Drug-Induced Renal Disease (Mnemonic "**NAKED Pee**")
...
### 4.4 Drug-Induced Pulmonary Disease
...
### 4.5 Drug-Induced Cardiac Disease
...
### 4.7 Drug-Induced Haematological Disease (Mnemonic "**PANICS**")
...
### 4.8 Drug-Induced Neurological Disease (Mnemonic "**SLANT**")
...
### 4.9 Drug-Induced Endocrine Disease (Mnemonic "**GHOSTS**")
