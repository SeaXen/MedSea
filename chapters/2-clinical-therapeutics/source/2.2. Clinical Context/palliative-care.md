# Clinical Context: Palliative Care (Syringe Drivers)
...
## 2. 🧠 Core Concept: Anticipatory Prescribing (Last Days of Life)

### 5 Key Symptoms → 5 Drug Classes (GSF/NHS Standard)
...
## 3. ️⃣ Opioid Conversion — Oral / IV → Subcutaneous
...
## 5. ️⃣ Drug Compatibility — Syringe Driver (Dickman / PCF)

### ✅ COMPATIBLE Combinations (Common Palliative Mixes)
...
### ❌ INCOMPATIBLE / PRECIPITATION RISK
...
## 6. ️⃣ Symptom-Specific Management

### Pain — Opioid Choice by Renal Function
...
### Nausea & Vomiting — Receptor-Based Choice
...
## 7. ️⃣ Renal & Hepatic Adjustments in Palliative Care
...
## 8. ️⃣ Anticipatory Prescribing Chart (Standard UK)
...
## 9. ️⃣ Common Syringe Driver Recipes (24h, WFI)
...
flowchart TD
    ...
    C -->|Yes| D[Start Syringe Driver<br/>Regular 24h dose = PRN usage × 3-4<br/>Keep PRN breakthrough = 1/6-1/10 24h dose]
    C -->|No| E[Continue PRN; Review 4-12h]
    D --> F[Check Compatibility (Dickman)<br/>WFI diluent (NaCl 0.9% for Alfentanil/Ketamine)<br/>Volume ≤ syringe capacity]
    F --> G[Site SC; Rate mL/hr; Change q24h;<br/>Monitor: Pain, Sedation, RR, Site]
```
...
```mermaid
mindmap
  root((Palliative Care<br>Syringe Driver))
