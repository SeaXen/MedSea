...
## 2. 🧠 Core Concept: Barrier Categories
...
flowchart TD
    ...
    B --> B1[Psychological attachment<br>Fear of withdrawal/relapse<br>Lack of awareness<br>Therapeutic relationship<br>Cognitive impairment<br>Health literacy]
    C --> C1[Inertia / Status quo bias<br>Fear of harm / litigation<br>Lack of knowledge/confidence<br>Time constraints<br>Guideline conflict<br>Therapeutic relationship]
    D --> D1[Fragmented care<br>Lack of medication review<br>IT/EMR limitations<br>Incentive structures<br>Formulary restrictions<br>Transitions of care gaps]
    E --> E1[Withdrawal syndromes<br>Disease rebound<br>No clear taper protocol<br>Long half-life / active metabolites<br>Patient on "specialist" drug]
    F --> F1[Duty of care vs autonomy<br>Informed consent complexity<br>Capacity assessment<br>Advance directives<br>Medico-legal fear]
```

---

## 3. ️⃣ Patient-Level Barriers: The PATIENT Framework
...
## 4. ️⃣ Prescriber-Level Barriers: The PRESCRIBER Framework
...
### Additional Prescriber Barriers
...
## 5. ️⃣ System / Organisational Barriers
...
## 8. ️⃣ Enablers / Facilitators: Overcoming Barriers
...
flowchart LR
    ...
    A --> A1[Policy: Deprescribing KPIs<br>Funding: Pharmacist posts<br>Guidelines: National deprescribing guidance]
    B --> B1[Protected review time<br>MDT medication review clinic<br>EMR deprescribing module<br>Audit & feedback]
    C --> C1[Pharmacist-led reviews<br>Nurse prescribing support<br>Specialist liaison pathways<br>Shared care agreements]
    D --> D1[Communication skills training<br>Decision aids<br>Patient education materials<br>Reflective practice]
```

### Evidence-Based Enablers (What Works)
...
## 9. ️⃣ Deprescribing Conversation Framework: The 5-Step Approach
...
### Step 3: Explore (Shared Decision-Making)
| Technique | Example |
|-----------|---------|
...
## 10. ️⃣ Special Populations: Extra Barriers
...
```mermaid
mindmap
  root((Barriers to<br>Deprescribing))
    Patient (PATIENT)
