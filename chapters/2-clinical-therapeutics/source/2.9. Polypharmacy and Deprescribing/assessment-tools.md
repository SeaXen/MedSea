# Polypharmacy Assessment Tools: STOPP/START, Beers, ACB, DBI, FORTA
...
## 2. 🧠 Core Concept: Tool Comparison

```mermaid
flowchart TD
    A[Polypharmacy Assessment Tools] --> B[Explicit Criteria<br>List-based, disease/drug-specific]
    A --> C[Implicit Criteria<br>Judgment-based, patient-centred]
    A --> D[Burden Metrics<br>Quantitative scores]
    A --> E[Benefit/Harm Rating<br>Label-based]
    
    B --> B1[STOPP/START v3<br>**65 STOPP (PIMs), 41 START (PPOs)**<br>Organ-system based<br>Evidence-graded]
    B --> B2[Beers Criteria 2023<br>**5 categories, ~100 drugs**<br>US-focused, regularly updated<br>Strong/Weak recommendation]
    
    C --> C1[MAI (Medication Appropriateness Index)<br>10 criteria, judgment-based<br>Time-consuming]
    
    D --> D1[ACB Scale<br>**Additive score 0-3 per drug**<br>Anticholinergic burden only<br>Threshold ≥3]
    D --> D2[DBI (Drug Burden Index)<br>**Dose-weighted sedative + anticholinergic**<br>Formula: Σ D/(D+δ)<br>Threshold ≥1]
    
    E --> E1[FORTA Classification<br>**A/B/C/D labels per drug-indication**<br>A=Indispensable, B=Beneficial, C=Questionable, D=Avoid<br>Positive list (beneficial) + Negative list (avoid)]
```

---

## 3. ️⃣ STOPP/START v3 (2023) — The Gold Standard for Hospital/Geriatrics
...
### High-Yield STOPP Criteria (Memorise These for Exam)
...
### High-Yield START Criteria (Omissions = PPOs)
...
## 4. ️⃣ Beers Criteria 2023 (American Geriatrics Society) — US-Focused, 5 Categories

### Category 1: Potentially Inappropriate in **Most** Older Adults
| Drug/Class | Reason |
|------------|--------|
...
### Category 2: Potentially Inappropriate in **Specific Diseases/Conditions**
...
### Category 3: Use with **Caution** (Monitoring Required)
...
### Category 4: Drug-Drug Interactions to **Avoid**
...
### Category 5: Dose Adjustment Required in **Renal Impairment**
...
## 5. ️⃣ Anticholinergic Cognitive Burden (ACB) Scale
...
## 6. ️⃣ Drug Burden Index (DBI) — Dose-Weighted Metric
...
## 7. ️⃣ FORTA (Fit fOR The Aged) Classification — Benefit/Harm Labelling
...
### High-Yield FORTA Examples (Selected)
...
## 8. ️⃣ Tool Comparison: When to Use Which
...
```mermaid
mindmap
  root((Polypharmacy<br>Assessment Tools))
    STOPP/START v3
