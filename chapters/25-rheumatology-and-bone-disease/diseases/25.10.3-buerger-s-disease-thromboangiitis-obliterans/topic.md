---
tags: [medicine, rheumatology, davidson, buerger, thromboangiitis, vasculitis, fcps, mrcp]
chapter: Rheumatology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 26: Rheumatology and bone disease
heading: Vasculitis
topic_group: Secondary vasculitides
topic: Buerger's Disease (Thromboangiitis Obliterans)
...
```mermaid
flowchart TD
    A[Tobacco Smoking\nCigarettes, Bidi, Cannabis] --> B[Genetic Susceptibility\nHLA-A9, B5]
    B --> C[Endothelial Injury\nDirect toxin, oxidative stress]
    C --> D[Immune Activation\nT-cell, Anti-endothelial Ab]
    D --> E[Segmental Inflammatory Infiltrate\nPolymorphonuclear cells, microabscesses]
    E --> F[Highly Cellular Intraluminal Thrombus\nwith microabscesses]
    F --> G[Vessel Wall Integrity Preserved\nCompared to Atherosclerosis]
    F --> H[Distal Small/Medium Vessels\nTibial, Peroneal, Radial, Ulnar, Digital]
    H --> I[Ischaemia of Extremities\nClaudication, Ulceration, Gangrene]
    I --> J[Collateral Formation\nCorkscrew Martorell sign]
```
...
```mermaid
mindmap
  root((Buerger's Disease))
    Definition
      Non_atherosclerotic
      Segmental_vasculitis
      Small_medium_vessels
      Cellular_thrombus_microabscesses
    Epidemiology
      Young_under_45
      Male_75_90
      Smoker_99
      Middle_East_Asia_India
    Pathogenesis
      Tobacco_smoking
      Genetic_HLA_A9_B5
      Endothelial_injury
      Cellular_intraluminal_thrombus
      Wall_preserved
    Clinical_Triad
      In_step_claudication
      Raynauds
      Migratory_thrombophlebitis
    Other_Features
      Digital_ulceration
      Gangrene
      Allen_test_positive
      Shiny_hairless_skin
      Distal_pulses_absent
      Proximal_pulses_preserved
    Diagnosis_Olin
      Under_45
      Smoker
      Distal_ischemia
      Exclude_autoimmune
      Exclude_hypercoagulable
      Exclude_atherosclerotic
    Imaging
      Angiography_corkscrew
      Martorell_sign
      Segmental_occlusion
      Distal_smooth
      ABPI_low
    ...
    Management
      ...
      Amputation_last
    Prognosis
      Smoking_cessation_5_percent_amputation
      Continued_50_percent_amputation
      No_visceral_disease
```
