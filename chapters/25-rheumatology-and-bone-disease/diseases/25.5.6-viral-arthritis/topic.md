---
tags: [medicine, rheumatology, davidson, viral-arthritis, fcps, mrcp]
...
```mermaid
flowchart TD
    A[Acute Polyarthritis] --> B{Systemic Viral Features?\nRash, Fever, Pharyngitis,\nConjunctivitis, Hepatitis}
    B -->|Yes| C[Viral Arthritis Likely]
    B -->|No| D[Consider RA/SpA/Crystal]
    C --> E[Check Serology:\nIgM Acute, IgG Past]
    D --> E
    E --> F{RF / Anti-CCP}
    F -->|Negative| G[Viral / Self-Limiting]
    F -->|Positive| H[RA / Chronic]
    G --> I[Management: Symptomatic\nTreat Underlying Virus]
    H --> J[DMARD / Biologic]
```
...
mindmap
  root((Viral Arthritis))
    ...
    Hepatitis_B
      Serum_Sickness
      Pre_Jaundice_Arthritis
      PAN_Association
      HBsAg_anti_HBc_IgM
    Hepatitis_C
      Cryoglobulinaemia
      Purpura_Neuropathy_MPGN
      Low_C4
      DAA_Cure
    Alphaviruses
      Chikungunya
