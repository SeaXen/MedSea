---
tags: [medicine, rheumatology, davidson, relapsing-polychondritis, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA-DR4, DR6] --> B[Environmental Trigger\nInfection, Trauma]
    B --> C[Autoimmune Response\nAnti-Type II Collagen\nT-cell Mediated]
    C --> D[Cartilage Inflammation\nChondrolysis\nMatrix Destruction]
    D --> E[Clinical RP\nEar, Nose, Airway,\nJoints, Eyes, Inner Ear]
    D --> F[Tracheobronchial\nCollapse → Airway Obstruction]
```
...
```mermaid
mindmap
  root((Relapsing Polychondritis))
    Sites
      Ear_Auricular_Chondritis
        Lobules_Spared
        Cauliflower_Ear
      Nasal_Chondritis
        Saddle_Nose
      ...
      Ocular
        Scleritis_Uveitis
      Joints
        Non_Erosive_Polyarthritis
      Audiovestibular
        Hearing_Loss_Vertigo
    Criteria
      McAdam_6_Features
      Damiani_3_OR_1Bio_OR_2Steroid
    Associations
      GPA_MPA
      Behcets
      SLE_RA
    ...
    Treatment
      ...
      MTX_AZA_Sparing
      CYC_Severe
      Biologics_Refractory
      Airway_ENT_Trach_Stent
```
