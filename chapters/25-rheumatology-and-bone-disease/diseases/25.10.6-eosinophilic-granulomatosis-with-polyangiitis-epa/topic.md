---
tags: [medicine, rheumatology, davidson, egpa, churg-strauss, fcps, mrcp]
...
topic: Eosinophilic granulomatosis with polyangiitis (EGPA)
...
```mermaid
mindmap
  root((EGPA / Churg-Strauss))
    Classic_Triad
      Asthma
      Eosinophilia_gt_1.5
      Vasculitis
    Phases
      Prodromal_Asthma_Rhinitis
      Eosinophilic_Infiltrative
      Vasculitic
    ANCA_Status
      Positive_40-60%
        Vasculitic_Phenotype
      Negative_40-60%
        Eosinophilic_Cardiac
    Cardiac
      Myocarditis
      Cardiomyopathy
      Leading_Death
