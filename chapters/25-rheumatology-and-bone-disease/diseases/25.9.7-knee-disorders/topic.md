---
tags: [medicine, rheumatology, davidson, knee, bursitis, baker-cyst, fcps, mrcp]
  ...
  root((Knee Disorders))
    Bursae
      ...
      Baker_Cyst
        Popliteal_Swelling
        Valving_Mechanism
        Rupture_Pseudothrombophlebitis
    Tendinopathy
      Patellar_Jumper_Knee
      Quadriceps
      Achilles
    ITBS
      Runners
    ...
    Aspiration
      Medial_Approach
      Crystals_Culture_Count
    Internal_Derangement
      Meniscal_Tears
      Ligaments_ACL_PCL_MCL_LCL
      Chondromalacia
      OCD
    Differential
      Pes_Anserine_vs_Meniscus
      Baker_vs_DVT
      ITBS_vs_Pes_Anserine
```
