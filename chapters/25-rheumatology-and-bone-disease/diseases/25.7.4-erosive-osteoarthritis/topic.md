---
tags: [medicine, rheumatology, davidson, osteoarthritis, erosive, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Erosive OA X-ray] --> B[Central Erosions]
    A --> C[Gull-Wing Appearance]
    A --> D[Saw-Tooth Pattern]
    A --> E[Preserved Subchondral Bone]
    A --> F[Osteophytes + Bony Enlargement]
    B --> B1[Collapse of central subchondral bone]
    C --> C1[V-shaped central erosions = gull wings]
    D --> D1[Serrated joint margins]
```
...
mindmap
  root((Erosive Osteoarthritis))
    ...
    Radiology
      ...
      Gull_Wing
      Saw_Tooth
      Preserved_Subchondral_Bone
      Osteophytes
    Serology
      RF_Negative
      Anti_CCP_Negative
      ANA_Usually_Negative
    Differential
      RA_MCP_Marginal
      PsA_Asymmetric_Nail
      CPPD_Chondrocalcinosis
      Gout_1st_MTP
    Course
      Self_Limiting_2-5yr
      Burns_Out
