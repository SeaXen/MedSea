---
tags: [medicine, rheumatology, davidson, mctd, fcps, mrcp]
...
topic: Mixed connective tissue disease (MCTD)
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA-DR4, DR2] --> B[Environmental Trigger\nViral, Silica, Drugs]
    B --> C[Anti-U1-RNP Production\nHigh Titre, Speckled ANA]
    C --> D[Immune Complex Deposition\nComplement Activation]
    D --> E[Multi-System Inflammation\nSLE-like + SSc-like + PM-like]
    E --> F[Clinical MCTD\nRaynaud's, Puffy Fingers,\nSynovitis, Myositis, ILD, PAH]
```
...
```mermaid
mindmap
  root((Mixed Connective Tissue Disease))
    Defining_Antibody
      High_Titre_anti_U1_RNP
      Speckled_ANA
    Overlap_Features
      SLE
        Arthritis
