---
tags: [medicine, rheumatology, davidson, behcet, fcps, mrcp]
  ...
  root((Behçet's Disease))
    ...
    Clinical
      Mucocutaneous
        Oral_Ulcers
        Genital_Ulcers
        Skin_Pseudofolliculitis_EN
      Ocular
        Anterior_Uveitis_Hypopyon
        Posterior_Uveitis
        Retinal_Vasculitis
      Vascular
        Venous_DVT_CVST
        Arterial_PA_Aneurysm
      Neuro
        Parenchymal_Brainstem
        Vascular_CVST
      GI
        Ileocaecal_Ulcers
    Diagnosis
