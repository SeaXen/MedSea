---
tags: [medicine, rheumatology, davidson, osteoarthritis, fcps, mrcp]
...
topic_group: Common regional musculoskeletal problems
...
```mermaid
flowchart LR
    A[Mechanical Stress\nObesity, Injury, Malalignment] --> B[Cartilage Homeostasis Disruption]
    B --> C[Chondrocyte Activation\nMMPs, ADAMTS, Cytokines]
    C --> D[Cartilage Degradation\nCollagen II, Aggrecan Loss]
    D --> E[Subchondral Bone Changes\nSclerosis, Cysts, Osteophytes]
    E --> F[Synovial Inflammation\nLow-grade, Cytokines]
    F --> G[Whole-Joint Failure\nPain, Stiffness, Dysfunction]
    H[Genetics\nCOL2A1, GDF5, IGF1] --> B
    I[Metabolic Factors\nAdipokines, Diabetes] --> B
```
...
mindmap
  root((Osteoarthritis))
    Definition
      ...
      Not_just_cartilage
    Epidemiology
      Most_common_arthritis
      Age >45
      F > M
      Obesity_risk
    Pathophysiology
      Mechanical_stress
      Chondrocyte_catabolism
      Subchondral_bone
      Low_grade_synovitis
    Clinical
      Mechanical_pain
    ...
    Diagnosis
      ...
      KL_Grading_0-4
      Weight_bearing_Xray
      Poor_symptom_correlation
    Management
      Core_Exercise_Weight_Education
      Topical_NSAID_1st
      Oral_NSAID_COX2_PPI_2nd
      IA_Steroid_Flare
      Surgery_TKR_THR
    Variants
      Erosive_OA
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 25: Rheumatology — Osteoarthritis*

**Q1.** What is the most appropriate first-line therapy for Osteoarthritis?
  ...
  > **Answer: A** — Mandatory for ALL
  >
  > *Source:* G --> No  I[Optimise Medical + Review]
```
