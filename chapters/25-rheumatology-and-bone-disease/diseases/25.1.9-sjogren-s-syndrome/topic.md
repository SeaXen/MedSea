---
tags: [medicine, rheumatology, davidson, sjogren, fcps, mrcp]
...
```mermaid
mindmap
  root((Sjögren's Syndrome))
    Primary_vs_Secondary
      Primary_Isolated
      Secondary_RA_SLE_SSc_PBC
    Autoantibodies
      Anti_Ro_SSA_70%
      Anti_La_SSB_40%_Specific
      ANA_RF_Positive
      Cryoglobulins
    ACR_EULAR_2016
      Anti_Ro_3
    ...
    Lymphoma
      5-10%_Lifetime
      Risk: Parotid, Low_C4, Cryoglobulins
      MALT_Indolent
    Management
      Symptomatic_Tears_Saliva
      Pilocarpine_Cevimeline
      HCQ_Fatigue
      RTX_Vasculitis
```
