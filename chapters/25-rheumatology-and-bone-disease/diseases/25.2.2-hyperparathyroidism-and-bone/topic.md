---
tags: [medicine, rheumatology, davidson, hyperparathyroidism, fcps, mrcp]
...
topic: Hyperparathyroidism and bone
...
```mermaid
mindmap
  root((Hyperparathyroidism))
    Primary_PhpT
      High_Ca_High_PTH
      Adenoma_85%
      Bone_Osteitis_Fibrosa
      Subperiosteal_Resorption
      Brown_Tumours
      Surgery_Criteria
      FHH_Differentiation
    Secondary
      Low_Normal_Ca_High_PTH
      CKD_VitD_Def
      Management_Treat_Cause
    Tertiary
      High_Ca_High_PTH
      Post_Transplant
      Autonomous
    ...
    MEN_Syndromes
      MEN1_3Ps
      MEN2A_MTC_Pheo_Parathyroid
      MEN2B_No_Parathyroid
    Complications
      Hungry_Bone_Syndrome
      Stones
      Osteoporosis
      Chondrocalcinosis
```
