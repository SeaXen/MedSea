---
tags: [medicine, rheumatology, davidson, spa, ankylosing, spondylitis, fcps, mrcp]
...
topic: Seronegative Spondyloarthritis (SpA) — Integrated Overview
...
```mermaid
flowchart TD
    A[SpA Diagnosis] --> B[1st Line: NSAIDs\nFull dose, 2-4 week trial\nNaproxen 500mg BD, Celecoxib 200mg BD]
    B --> C{NSAID Response?}
    C -->|Yes| D[Continue NSAID\n+ physiotherapy\n+ DMARD if peripheral]
    C -->|No| E[2nd Line: Biologics\nAnti-TNF: ADA/IFX/ETA/CZP/GOL\nOR Anti-IL-17: SEC/IXE]
    D --> F[Monitor: BASDAI/ASDAS\nBASFI, MRI]
    E --> F
...
mindmap
  root((SpA Overview))
    ...
    Diagnosis
      ...
      MRI_early
    Treatment
      NSAIDs_continuous_first
      Anti_TNF_adalimumab_preferred_uveitis_IBD
      Anti_IL_17_PSEUDO_IBD
      JAKi
      Exercise_core
    EAMs
      AAU
