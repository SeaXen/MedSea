---
tags: [medicine, rheumatology, davidson, igg4, fcps, mrcp]
...
topic_group: Other granulomatous conditions
...
```mermaid
mindmap
  root((IgG4-Related Disease))
    Pathophysiology
      Th2_Polarisation
      Tfh_Tfr_Dysregulation
      IgG4_Class_Switch
      Storiform_Fibrosis
      Obliterative_Phlebitis
    Diagnostic_Criteria
      ACR_EULAR_2019
      Score_ge_20
      Clinical_Serological_Histological
    Serology
      IgG4_gt_135
      Normal_in_30%
      Not_Diagnostic
    Histology_Gold_Standard
      Storiform_Fibrosis
      Obliterative_Phlebitis
      IgG4_Cells_gt_10
      Ratio_gt_40%
