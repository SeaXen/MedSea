---
tags: [medicine, rheumatology, davidson, takayasu, large-vessel-vasculitis, fcps, mrcp]
chapter: Rheumatology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 26: Rheumatology and bone disease
heading: Vasculitis
topic_group: Primary systemic vasculitides overview
...
```mermaid
flowchart TD
    A[Genetic Susceptibility\nHLA-B52, HLA-DR] --> B[Trigger\nInfection TB, Unknown]
    B --> C[Granulomatous Inflammation\nAortic wall + branches]
    C --> D[Adventitial T-cell Infiltration\nGiant cells, Granulomas]
    D --> E[Medial Destruction\nElastic fibre fragmentation]
    E --> F[Intimal Hyperplasia\n+ Fibrosis]
    F --> G[Stenosis/Occlusion\nof vessel lumen]
    E & F --> H[Aneurysmal Dilatation\nAortic root = AR]
    G & H --> I[Ischaemia\nClaudication, TIA, BP diff]
    I --> J[Takayasu Arteritis\nClinical Manifestations]
```
...
```mermaid
mindmap
  root((Takayasu Arteritis))
    Definition
      Granulomatous_large_vessel
      Aorta_branches
      Pulseless_disease
    Epidemiology
      Young_women_under_40
      F_8_to_1
      Asian_HLA_B52
    Pathology
      Granulomatous_panarteritis
      Giant_cells
      Medial_destruction
    Clinical
      Constitutional_systemic
      Asymmetric_BP
      Absent_pulses
      Bruits
      Claudication_arm
