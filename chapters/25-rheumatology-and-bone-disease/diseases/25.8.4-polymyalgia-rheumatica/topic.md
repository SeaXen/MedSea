---
tags: [medicine, rheumatology, davidson, pmr, polymyalgia-rheumatica, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA-DR4] --> B[Environmental Trigger\nInfection, Ageing Immune System]
    B --> C[Systemic Inflammation\nIL-6, IL-1, TNF, IFN-γ]
    C --> D[Proximal Girdle Involvement\nShoulder/Pelvic Synovitis/Bursitis]
    D --> E[Pain/Stiffness\nMorning >45min]
    C --> F[Acute Phase Response\nESR/CRP >> Normal]
    E --> G[GCA Overlap\n40-50% share pathology]
```
...
mindmap
  root((Polymyalgia Rheumatica))
    ...
    Pathophysiology
      IL6_driven
      Proximal_bursitis_tenosynovitis
      No_true_vasculitis
    Clinical
      Bilateral_girdle_pain_stiffness
      Morning_stiffness_gt_45min
      Constitutional
      Limited_active_ROM
    Diagnosis
      EULAR_ACR_2012
    ...
    Management
      Pred_15-20mg
      Dramatic_response_48-72h
      Taper_slow
      Bone_protection
      GCA_screen_every_visit
    Relapse
      30-50%
      Return_to_prev_dose
      Steroid_sparing_MTX_TCZ
    Differentials
      LORA
      Rotator_cuff
      Fibromyalgia
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 25: Rheumatology — Polymyalgia rheumatica*

**Q1.** What is the most appropriate first-line therapy for Polymyalgia rheumatica?

  - **A.** Initial + Prednisolone + Dramatic response within
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Initial + Prednisolone + Dramatic response within
  >
  > *Source:* **Initial**   **Prednisolone 15-20mg daily**   2-4 weeks   **Dramatic response within 48-72h = diagnostic**
