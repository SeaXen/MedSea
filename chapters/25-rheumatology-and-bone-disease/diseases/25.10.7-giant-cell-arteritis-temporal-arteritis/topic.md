---
tags: [medicine, rheumatology, davidson, gca, temporal-arteritis, fcps, mrcp]
...
topic: Giant cell arteritis (temporal arteritis)
...
```mermaid
mindmap
  root((Giant Cell Arteritis))
    Epidemiology
      Age_gt_50
      Peak_70-80
      F:M_2-3:1
    Pathophysiology
      Granulomatous_vasculitis
      Giant_cells
      Internal_elastic_lamina_fragmentation
      Skip_lesions
    Clinical
      Cranial
        Headache_temporal
