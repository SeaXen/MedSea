---
tags: [medicine, rheumatology, davidson, crps, complex-regional-pain-syndrome, fcps, mrcp]
...
```mermaid
mindmap
  root((Complex Regional Pain Syndrome))
    Types
      Type_I_RSD
        No_Nerve_Injury
      Type_II_Causalgia
    ...
    Stages
      Stage_1_Warm
      Stage_2_Cool_Dystrophic
      Stage_3_Cold_Atrophic
    Pathophysiology
      Peripheral_Sensitisation
      Sympathetic_Coupling
      Central_Sensitisation
      Cortical_Reorganisation
    Diagnosis
      Budapest
      Bone_Scan_Triple
      MRI_Marrow_Oedema
      Sympathetic_Block
    Treatment
      PT_Desensitisation_Mirror
      Graded_Motor_Imagery
      Bisphosphonates
      Sympathetic_Block
      SCS_Refractory
    Prognosis
