...
mindmap
  root((Gout))
    Epidemiology
      Men_40-60
      Women_postmenopausal
      M:F 4:1
      Hyperuricaemia_risk
    Pathophysiology
      Urate_overproduction
      Urate_underexcretion
      MSU_crystals
      NLRP3_inflammasome
      IL-1beta
    Clinical
      ...
      Chronic_tophaceous
        Tophi
        Punched-out_erosions
        Preserved_JSN
    Diagnosis
      2015_ACR_EULAR
      Synovial_fluid_GOLD
      MSU_needles_negative_birefringence
      Serum_urate_target
      Imaging_US_DECT
    Acute_Treatment
      Colchicine_low_dose
