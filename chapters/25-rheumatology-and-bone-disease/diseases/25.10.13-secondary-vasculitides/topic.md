---
tags: [medicine, rheumatology, davidson, secondary-vasculitis, fcps, mrcp]
...
```mermaid
mindmap
  root((Secondary Vasculitis))
    CTD_Associated
      SLE_Leukocytoclastic
      RA_Mononeuritis_Multiplex
      Sjogrens_Cryoglobulinaemia
      SSc_Rare
    Infection_Associated
      HCV_Cryoglobulinaemia_Type_II_III
      HBV_PAN
      SBE_Immune_Complex
      HIV_Rare
    Malignancy_Associated
      Paraneoplastic
      Castleman_Pemphigus
    Drug_Induced
      PTU_Hydralazine_Minocycline
      Levamisole_Cocaine
      TNF_Inhibitors
      Allopurinol
    Cryoglobulinaemia
    ...
    Management_Principle
      ...
      HCV_DAA
      Drug_Stop_Steroids
      CTD_Immunosuppression
      HepB_Antivirals_PLEX
```
