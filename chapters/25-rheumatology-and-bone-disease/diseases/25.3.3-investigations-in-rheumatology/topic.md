...
topic: Investigations in rheumatology
...
```mermaid
flowchart TD
    A[Joint Aspiration] --> B{Appearance}
    B -->|Clear, viscous| C[Normal / OA / Trauma]
    B -->|Turbid, low viscosity| D{Cell Count}
    B -->|Bloody| E[Trauma / Haemophilia / Tumour / Anticoagulation]
    B -->|Purulent| F[Septic until proven otherwise]
    D -->|<2000 WBC| G[Non-inflammatory: OA / Trauma]
    D -->|2000-50,000 WBC| H[Inflammatory: RA / SLE / PsA / Viral / Lyme]
    D -->|>50,000 WBC| I[Septic / Crystal / Gout / CPPD]
    H --> J{Crystals?}
    I --> J
    J -->|Negatively birefringent needles| K[Gout - MSU]
    J -->|Positively birefringent rhomboids| L[CPPD - Pseudogout]
    J -->|No crystals| M[Culture + PCR for infection]
```
...
```mermaid
mindmap
  root((Investigations in Rheumatology))
    Blood_Screening
      FBC
      ESR_CRP
      U_E_Cr
