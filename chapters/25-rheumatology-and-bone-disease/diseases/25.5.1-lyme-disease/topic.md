---
tags: [medicine, rheumatology, davidson, lyme-disease, fcps, mrcp]
  ...
  root((Lyme Disease))
    ...
    Stages
      Stage_1_EM
        Target_Lesion
        Clinical_Dx
      Stage_2_Disseminated
        Multiple_EM
        Facial_Palsy_Bilateral
        Meningitis
        Carditis_AV_Block
      Stage_3_Late
        Arthritis_Knee
    ...
    Treatment
      Doxycycline_Early
      Ceftriaxone_CNS_Arthritis
      Amoxicillin_Pregnancy
      PTLDS_Symptomatic
    Complications
      Antibiotic_Refractory_Arthritis
      PTLDS
      Chronic_Neuro
```
