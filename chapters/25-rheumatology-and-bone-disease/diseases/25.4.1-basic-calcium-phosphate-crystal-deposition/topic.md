---
tags: [medicine, rheumatology, davidson, basic-calcium-phosphate, fcps, mrcp]
...
topic: Basic calcium phosphate crystal deposition
...
```mermaid
mindmap
  root((Basic Calcium Phosphate))
    Crystal_Types
      Hydroxyapatite_HA
      Octacalcium_Phosphate_OCP
      Tricalcium_Phosphate_TCP
    Identification
      Non_Birefringent
      Alizarin_Red_S
      von_Kossa
    ...
    Syndromes
      ...
      Calcific_Tendonitis
        ...
        Self_Limiting
      Acute_BCP_Arthritis
      Calcific_Periarthritis
    Differential
      Gout_MSU_Negative
      CPPD_Rhomboid_Positive
      Septic
      Rotator_Cuff_Tear
    Management
      NSAIDs
