---
tags: [medicine, rheumatology, davidson, paget, fcps, mrcp]
...
mindmap
  root((Paget's Disease of Bone))
    Epidemiology
      ...
      SQSTM1_Mutation
    Pathophysiology
      Osteoclast_Hyperactivity
      Disorganised_Formation
      Mosaic_Bone
    Three_Phases
      Osteolytic_Hot
      Mixed_Cotton_Wool
    ...
    Diagnosis
      ALP_Elevated
      Xray_Lytic_Mixed_Sclerotic
      Bone_Scan_Hot_Spots
    Treatment
      Zoledronate_5mg_IV
      Risedronate_Alendronate
      Vit_D_Pre_Replete
    Complications
      Fractures
      OA
