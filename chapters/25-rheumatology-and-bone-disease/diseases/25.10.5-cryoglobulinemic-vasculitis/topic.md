---
tags: [medicine, rheumatology, davidson, cryoglobulinemia, vasculitis, hcv, fcps, mrcp]
chapter: Rheumatology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 26: Rheumatology and bone disease
heading: Vasculitis
topic_group: Secondary vasculitides
...
see_also:
  ...
  - "[[Sjogren's syndrome]]"
  - "[[Primary systemic vasculitides overview]]"
...
```mermaid
flowchart TD
    A[HCV Infection\nHepatocyte] --> B[Chronic HCV\nB-cell stimulation]
    B --> C[Production of IgM\nwith Rheumatoid Factor activity\nAnti-IgG]
    C --> D[Circulating Immune Complexes\nIgM-IgG]
    D --> E[Deposition in Small Vessels\nSkin, Kidney, Nerve]
    D --> F[Cold Precipitation\nin Distal Vessels\nEars, Fingers, Toes]
    E & F --> G[Complement Activation\nC1q → C4 consumption]
    G --> H[Leukocyte Recruitment\nNecrotising Vasculitis]
    H --> I[Organ Damage\nPurpura, GN, Neuropathy]
```
...
```mermaid
flowchart TD
    A[Mixed Cryoglobulinemia + HCV+] --> B[Step 1: HCV Eradication\nDAAs 12 weeks]
    B --> C{Response?}
    C -->|Yes| D[Monitor Cryocrit, C4, Renal]
    C -->|No| E[Step 2: Add Rituximab\nor immunosuppress]
    A2[HCV-Negative\nor Severe] --> F[Step 2: Rituximab + Pred\nor Plasmapheresis]
    F --> G{Response?}
    G -->|Yes| H[Maintenance Rituximab\nor AZA]
    G -->|No| I[Step 3: CYC, MMF, plasmapheresis]
```
...
```mermaid
mindmap
  root((Cryoglobulinemic Vasculitis))
    Definition
      Cryoglobulins_precipitate_below_37
      Redissolve_on_warming
    Classification
      Type_I_monoclonal_malignancy
      Type_II_mixed_HCV_most_common
      Type_III_mixed_polyclonal_autoimmune
    Pathogenesis
      HCV_chronic_infection
      B_cell_stimulation_RF_IgM
      IgM_IgG_immune_complex
      Cold_precipitation_distal
      Complement_C1q_C4
      Vasculitis_small_vessel
    Clinical_Meltzer_Triad
      Palpable_purpura
      Arthralgia
      Weakness
    Organ_Manifestations
      Skin_purpura_livedo
      Kidney_MPGN_type_1
      Nerve_mononeuritis_multiplex
      Joint_arthralgia
      Constitutional
      Liver_HCV_hepatitis
      Type_1_hyperviscosity
    Diagnosis
      Cryocrit_draw_warm_37
      Low_C4_hallmark
      RF_positive
      HCV_serology_RNA
      Skin_leukocytoclastic
      Renal_MPGN_subendothelial
    Differential
      ANCA_vasculitis
      IgA_vasculitis
      SLE_vasculitis
      ...
      Type_1_different
    Management
      HCV_DAAs_first_12_weeks
      Rituximab_severe_HCV_neg
      Steroids_bridge
      CYC_refractory
      Plasmapheresis_hyperviscosity
    Complications
      CKD_ESRD
      Chronic_neuropathy
      B_cell_NHL_35x
      Hyperviscosity_Type_1
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 25: Rheumatology — Cryoglobulinemic vasculitis*

**Q1.** Which of the following features is most specific or characteristic of Cryoglobulinemic vasculitis?
  ...
  > **Answer: A** — ANA
  >
  > *Source:* | Total complement activity |
| **RF** | **Positive** (high) | Anti-IgG autoantibody (IgM type) |
| **ANA** | Often positive (low titre) | Non-specific |
| **Anti-CCP** | Negative | Differentiate from

**Q2.** What is the most appropriate first-line therapy for Cryoglobulinemic vasculitis?

  - **A.** Treat underlying haematological disease (WM, MM, CLL)
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Treat underlying haematological disease (WM, MM, CLL)
  >
  > *Source:* **Treat underlying haematological disease** (WM, MM, CLL)
