---
tags: [medicine, rheumatology, davidson, antiphospholipid-syndrome, aps, fcps, mrcp]
...
```mermaid
flowchart LR
    aPL[aPL: LA, aCL, anti-β2GPI] --> B[Anti-β2GPI Binds\nβ2GPI on Endothelium/Platelets]
    B --> C[Endothelial Activation\nTF Expression, ↓ NO, ↑ Adhesion]
    C --> D[Complement Activation\nC5a → Neutrophil Recruitment]
    D --> E[Platelet Activation\nAggregation, Microparticles]
    E --> F[Prothrombotic State\nArterial/Venous/Small Vessel]
...
mindmap
  root((Antiphospholipid Syndrome))
    Classification
      Primary
      Secondary_SLE_RA_SSc_Sjogrens
    Sydney_Criteria
      Clinical_Thrombosis_Pregnancy
      Lab_LA_aCL_anti_b2GPI_x2_12wks
    Triple_Positivity
      LA + aCL + anti_b2GPI
      Highest_Thrombosis_Risk
    Thrombotic
      Venous_DVT_PE_Unusual
      Arterial_Stroke_MI
      Small_Vessel_Livedo
    Obstetric
      Recurrent_Loss
