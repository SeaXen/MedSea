---
tags: [medicine, rheumatology, davidson, glucocorticoid-induced-osteoporosis, fcps, mrcp]
...
```mermaid
mindmap
  root((Glucocorticoid-Induced Osteoporosis))
    Threshold
      Pred_ge_7.5mg
      Duration_ge_3mo
      Start_DAY_1
    Pathophysiology
      Osteoblast_Suppression
      Osteoclast_Pro-Longation
      Ca_Malabsorption
      Gonadal_Suppression
      Falls_Risk
    Assessment
    ...
    Special
      Children_Z_Scores
      Transplant_Early_DEXA
      Denosumab_No_Holiday
    Monitoring
      DEXA_1-2yr
      Height_Annual
      Adherence
