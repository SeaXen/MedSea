---
tags: [medicine, rheumatology, davidson, rs3pe, pmr, elderly, fcps, mrcp]
...
topic_group: Polymyalgia-like syndromes
topic: RS3PE Syndrome
...
```mermaid
flowchart TD
    A[Unknown Trigger\nInfection? Malignancy?] --> B[Immune Activation\nT-cell, Macrophage]
    B --> C[Synovitis\nWrist, MCP, PIP, Flexor Tenosynovium]
    B --> D[Vasculopathy\nIncreased VEGF\nCapillary leak]
    C & D --> E[Pitting Oedema\nDorsum of hands and feet]
    B --> F[Peri-articular Inflammation\nConnective tissue]
...
mindmap
  root((RS3PE))
    Definition
      Remitting_Seronegative_Symmetrical
      Synovitis_Pitting_Edema
      Elderly_onset
    Demographics
      Age_above_65
      Male_female_2_3_1
    Diagnostic_Criteria
      Age_above_65
      Bilateral_hand_foot_oedema
      Symmetrical_polyarthritis
      RF_CCP_negative
      No_erosions
      Steroid_response
    Pathogenesis
    ...
    Investigations
      ...
      RF_CCP_negative
      No_erosions_X_ray
      US_flexor_tenosynovitis
      Screen_malignancy_PSA_CXR
    Malignancy
      5_20_percent
      Solid_tumours_prostate_gastric_lung_breast
      Haematological_rare
      Paraneoplastic_possible
    Management
      Pred_10_15_mg_dramatic_response
      Taper_6_12_months
      HCQ_mild
      MTX_rare
      Treat_malignancy_underlying
    Prognosis
      Excellent_with_steroids
      Self_limiting
      Refractory_reassess
```
