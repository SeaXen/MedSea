---
tags: [medicine, rheumatology, davidson, drug-induced-lupus, sle, fcps, mrcp]
...
topic: Drug-Induced Lupus Erythematosus (DILE)
...
```mermaid
flowchart TD
    A[Drug Exposure\nProcainamide, Hydralazine, etc.] --> B[Genetic Susceptibility\nSlow Acetylator NAT2\nHLA-DR4]
    B --> C[Drug Metabolism\nHapten formation\nBioactivation to reactive metabolite]
    C --> D[Loss of Tolerance\nAnti-histone Antibodies 95%]
    C --> E[Neutrophil Activation\nNeutrophil extracellular traps]
    C --> F[Complement Activation\nType III hypersensitivity]
    D & E & F --> G[DILE Clinical Features\nArthralgia, Myalgia, Serositis]
    A --> H[TNF Inhibitor Special\nBlockade of TNF leads to\nIFN-α overproduction]
...
mindmap
  root((Drug-Induced Lupus))
    ...
    Drug_specific
      Minocycline_hepatic
      TNF_i_cutaneous_anti_dsDNA
      Checkpoint_multi_organ
    Diagnosis
      Drug_exposure
      ANA_positive
      Anti_histone_95
    ...
    Differential_SLE
      ...
      Chronic
    Management
      Drug_withdrawal_essential
      NSAIDs
      HCQ_persistent
      Low_pred_severe
      Switch_TNF_i_class
    Prognosis
      Resolution_days_weeks
      ANA_persistence_months
      Very_low_mortality
      Recurrence_on_rechallenge
```
