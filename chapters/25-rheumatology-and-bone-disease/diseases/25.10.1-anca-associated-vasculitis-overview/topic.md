---
tags: [medicine, rheumatology, davidson, vasculitis, anca, aav, fcps, mrcp]
...
topic: ANCA-Associated Vasculitis (AAV) — Integrated Overview
...
```mermaid
flowchart TD
    A[Genetic Susceptibility\nHLA-DPB1, PRTN3, MPO SNPs, α1-AT] --> B[Triggering Event\nInfection, Drug, Silica, Autoantigen]
    B --> C[Loss of Tolerance\nANCA Production\nPR3-ANCA or MPO-ANCA]
    C --> D[Neutrophil Priming\nTNF, C5a, GM-CSF]
    D --> E[Neutrophil Activation\nANCA binds PR3/MPO on surface]
    E --> F[Endothelial Damage\nDegranulation, ROS, NETosis]
    F --> G[Small Vessel Necrosis\nCapillaries, Venules, Arterioles]
    G --> H[Organ Manifestations\nKidney: pauci-immune GN\nLung: alveolar haemorrhage\nENT: necrotising granulomas\nNerve: mononeuritis multiplex\nSkin: palpable purpura]
```
...
```mermaid
flowchart TD
    A[New AAV Diagnosis\nBiopsy-confirmed, exclude infection] --> B{Organ-Threatening?\nCr >150 / DAH / nerve / CNS / cardiac}
    B -->|Yes| C[Induction:\nCYC IV or PO × 6-9mo\nOR RTX 375/m² ×4\n+ Pred 1mg/kg → taper]
    B -->|No| D[Induction:\nMTX or MMF or RTX\n+ lower-dose Pred]
    C --> E[Maintenance:\nRTX 500mg q6mo × 2-4y\nOR AZA 2mg/kg\nOR MMF\n+ low-dose Pred ≤5mg]
    D --> E
...
mindmap
  root((AAV Overview))
    ...
    Diagnosis
      ANCA_IIF_ELISA
      Renal_biopsy_pauci_immune
      Nasal_granulomas_GPA
      Exclude_infection
    Classification
      ACR_EULAR_2022
      GPA_MPA_EGPA
