---
tags: [medicine, rheumatology, davidson, chronic-pain, fibromyalgia, fcps, mrcp]
...
topic_group: Chronic pain syndromes and fibromyalgia
topic: Chronic Pain Syndromes and Fibromyalgia — Integrated Overview
...
```mermaid
flowchart TD
    A[Predisposing Factors\nGenetics, Female sex, Early life stress] --> B[Central Pain Amplification\nAltered CNS pain processing]
    B --> C[Increased Facilitation\nNMDA wind-up, Temporal summation, Pronociceptive 5-HT/NA imbalance]
    B --> D[Decreased Inhibition\nLoss of descending 5-HT/NA pathways, Low opioid receptor availability]
    C & D --> E[Allodynia\nPain from non-painful stimuli]
    C & D --> F[Hyperalgesia\nExaggerated pain response]
    C & D --> G[Sensory Augmentation\nLight, sound, smell, touch]
    C & D --> H[Comorbid Central Sensitivity\nIBS, Migraine, TMD, IC, CFS]
```
...
```mermaid
flowchart TD
    A[Fibromyalgia / CWP Diagnosis] --> B[Step 1: Foundation
Patient education + validation]
    B --> C[Step 2: Lifestyle
Graded aerobic + strengthening exercise + sleep hygiene + pacing]
    C --> D[Step 3: Psychological
CBT for chronic pain + mindfulness + acceptance]
    D --> E[Step 4: Pharmacotherapy
Duloxetine OR Pregabalin OR Amitriptyline]
    E --> F[Step 5: Specialist
Pain clinic, multidisciplinary programme, neuromodulation]
```
...
```mermaid
mindmap
  root((Chronic Pain Syndromes))
    Central_Sensitisation
      Wind_up_NMDA
      Loss_descending_inhibition
      Augmented_sensory
      Autonomic_HPA_dysregulation
    Fibromyalgia
      WPI_SSS_ACR_2016
      Tender_points_no_longer
      Fatigue_cognitive_sleep
      Comorbid_CSS
    CWP
      4_of_5_regions
      3_months
    ...
    CRPS
      ...
      Type_1_no_nerve
      Type_2_with_nerve
      Warm_dystrophic_atrophic
      Vitamin_C_500mg_prevention
    Differential
      RA_PsA_AS
      PMR
      Hypothyroid
    ...
    Management
      ...
      Graded_exercise_core
      CBT_mindfulness
      Duloxetine_pregabalin_amitriptyline
      Pain_clinic
    Avoid
      Opioids
      Steroids
