---
tags: [medicine, rheumatology, davidson, pseudogout, cppd, fcps, mrcp]
chapter: Rheumatology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 26: Rheumatology and bone disease
heading: Crystal Arthropathies
topic_group: Crystal arthritis
topic: Pseudogout (CPPD deposition disease)
...
mindmap
  root((Pseudogout / CPPD))
    ...
    Aetiology
      Ageing
      OA
      Metabolic_Haemochromatosis_HPT_HypoMg_Hypophosphatasia
      Genetic_ANKH
      Dialysis
    Clinical
      Acute_Pseudogout
      Chronic_Arthropathy
      Asymptomatic_Chondrocalcinosis
      Crowned_Dens
      Tenosynovitis
    Crystal_ID
      Rhomboid_Rectangular
      Weak_Positive_Birefringence
      Blue_Parallel
    Imaging
      Chondrocalcinosis
      Menisci_TFCC_Pubic
      Chronic_Arthropathy_Wrist_Knee_Hip
    Associations_Screen
      Ferritin_TSAT
      PTH_Ca_PO4
      Magnesium
      ALP
    Management
      Acute_NSAID_Colchicine_IA_Steroid
      No_ULT
      Treat_Underlying
      Chronic_Symptomatic
```
