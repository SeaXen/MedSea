---
tags: [medicine, rheumatology, davidson, cogan, vasculitis, eye, ear, fcps, mrcp]
...
```mermaid
flowchart TD
    A[Unknown Trigger\nInfection? Autoantigen?] --> B[Immune Response\nCross-reactivity with\ncorneal + inner ear antigens]
    B --> C[Interstitial Keratitis\nCorneal stromal inflammation]
    B --> D[Audiovestibular Dysfunction\nCochlear + vestibular damage]
    C & D --> E[Systemic Vasculitis\nAortitis, Medium-vessel vasculitis]
    E --> F[Organ Manifestations\nAortic, Aortic valve, Renal, Skin, Nerve]
```
...
```mermaid
flowchart TD
    A[Cogan Syndrome Diagnosis] --> B[Acute: High-Dose Steroids\nMethylpred 1g IV × 3 days\nOR Pred 1-2 mg/kg/day]
    B --> C[Add Steroid-Sparing DMARD\nMTX 20-25 mg/week\nOR AZA 2 mg/kg\nOR MMF 2-3 g/day]
    C --> D{Response?}
    D -->|Yes| E[Taper Pred Slowly\nOver 6-12 months]
    D -->|No| F[Biologics\nAnti-TNF ADA, IFX\nOR Tocilizumab 162 mg SC weekly]
    F --> G{Response?}
    G -->|Yes| E
    G -->|No| H[Cyclophosphamide\nOR IVIG, Plasmapheresis]
```
...
```mermaid
mindmap
  root((Cogan's Syndrome))
    Definition
      Interstitial_keratitis
      Vestibuloauditory_dysfunction
      Rare_vasculitis
    Types
      Typical_within_2_years
      Atypical_other_ocular_or_late
    Demographics
      Young_adult_20_40
      Very_rare
    Eye
      ...
      Red_eye
    Ear
      SNHL_sudden_bilateral
      Vertigo
      Tinnitus
      Deafness_50_80_percent
    Systemic
      Aortitis_10_15_percent
      Aortic_regurgitation
      Medium_vessel_vasculitis
      Constitutional
    Diagnosis
      Exclusion
      ANCA_neg
    ...
    Differential
      ...
      Acoustic_neuroma
    Management
      High_dose_steroids_IMMEDIATE
      Methylpred_1g_3_days
      Pred_1_2_mg_kg
      MTX_AZA_MMF
      Tocilizumab_anti_IL6
      Anti_TNF_adalimumab
      Cochlear_implant_deafness
    Prognosis
      Chronic_relapsing
      Deafness_main_morbidity
      Vision_preserved_with_Rx
      Low_mortality
```
