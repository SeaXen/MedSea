...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA-DRB1 Shared Epitope] --> B[Environmental Trigger\nSmoking, Infection, Microbiome]
    B --> C[Loss of Tolerance\nACPA/RF Production]
    C --> D[Synovial Inflammation\nImmune Cell Infiltration]
    D --> E[Pannus Formation\nFibroblast-like Synoviocytes]
    E --> F[Cartilage/Bone Destruction\nMMPs, RANKL/OPG]
    F --> G[Joint Deformity\nDisability]
```
