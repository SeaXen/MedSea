---
tags: [medicine, rheumatology, davidson, shoulder, rotator-cuff, frozen-shoulder, fcps, mrcp]
...
mindmap
  root((Shoulder Disorders))
    ...
    Frozen_Shoulder
      Global_Restriction
      Active_Equals_Passive
      External_Rotation_Loss
      Diabetes_Thyroid
      Stages_Freezing_Frozen_Thawing
    Impingement
      Painful_Arc_60_120
      Hawkins_Neer
    ...
    Imaging
      Xray_OA_Calcific
      US_Dynamic_RC_Bursa
      MRI_Gold_Standard_Tears
    Management
      PT_RC_Strengthening
      IA_Steroid_Subacromial
      Surgery_RCT_Frozen
```
