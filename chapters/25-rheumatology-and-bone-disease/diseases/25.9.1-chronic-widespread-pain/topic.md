---
tags: [medicine, rheumatology, davidson, chronic-pain, fcps, mrcp]
...
mindmap
  root((Chronic Widespread Pain))
    ...
    Central_Sensitisation
      Wind_Up
      Temporal_Summation
      Allodynia_Hyperalgesia
      Descending_Inhibition_Loss
      Impaired_CPM
    Fibromyalgia
      CWP_Subset
      ACR_2016_Criteria
      WPI_SSS
      Tender_Points_Not_Required
    Comorbidities
      IBS
      CFS_ME
      Migraine
    ...
    Management
      ...
      Exercise_Core
      CBT
      Duloxetine_Pregabalin
      Amitriptyline
      Avoid_Opioids_Benzos
```
