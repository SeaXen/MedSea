---
tags: [medicine, rheumatology, davidson, osteomalacia, rickets, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Osteomalacia X-ray] --> B[Looser Zones\nPseudofractures]
    A --> C[Generalised Osteopenia]
    A --> C1[Cortical Thinning]
    B --> B1[Transverse Radiolucent Line\nPerpendicular to Cortex]
    B --> B2[Pathognomonic if Bilateral/Symmetric]
    B --> B3[Sites: Scapula, Femoral Neck, Pubic Rami, Ribs, Ulna]
    D[Rickets X-ray] --> D1[Widened Growth Plate\nCupping/Flaring/Fraying]
    D --> D2[Osteopenia]
    D --> D2[Bowed Long Bones]
```
...
mindmap
  root((Osteomalacia / Rickets))
    ...
    Phosphate_Wasting
      ...
      TIO_Tumour_FGF23
      Fanconi_Generalised
      Burosumab_Anti_FGF23
    Imaging
      Looser_Zones
      Sites_Scapula_Femur_Pubic_Ribs
      Rickets_Cupping_Flaring
    CKD_MBD
      High_PO4_Low_Ca
      High_PTH_FGF23
      Binders_VitD_Cinacalcet
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 25: Rheumatology — Osteomalacia and rickets*

**Q1.** Which of the following features is most specific or characteristic of Osteomalacia and rickets?
  ...
  > **Answer: A** — Looser Zones
  >
  > *Source:* hy** | **Waddling gait**, difficulty climbing stairs, rising from chair (osteomalacic myopathy) |
| **Looser Zones (Pseudofractures)** | **Pathognomonic** — transverse radiolucent lines perpendicular 

**Q2.** What is the most appropriate first-line therapy for Osteomalacia and rickets?

  - **A.** Calcium + 1g elemental Ca daily
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Calcium + 1g elemental Ca daily
  >
  > *Source:* **Calcium**   **1g elemental Ca daily** (diet + supplement) — essential for mineralisation  
