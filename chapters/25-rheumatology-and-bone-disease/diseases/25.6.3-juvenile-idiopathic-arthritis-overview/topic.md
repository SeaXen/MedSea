---
tags: [medicine, rheumatology, davidson, jia, fcps, mrcp]
chapter: Rheumatology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 26: Rheumatology and bone disease
heading: Inflammatory Arthritis
topic_group: Juvenile idiopathic arthritis overview
topic: Juvenile idiopathic arthritis overview
...
```mermaid
mindmap
  root((Juvenile Idiopathic Arthritis))
    ILAR_Classification
      Systemic
        Quotidian_Fever
        Salmon_Rash
    ...
    Treatment
      NSAIDs_IA_Steroids
      MTX_Anchor
      Biologics_Subtype_Guided
      Anakinra_sJIA
    Transition
      Start_12_14y
      Coordinator_Essential
```
