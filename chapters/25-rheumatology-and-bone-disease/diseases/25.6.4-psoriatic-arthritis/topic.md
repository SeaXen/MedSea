---
tags: [medicine, rheumatology, davidson, psoriatic-arthritis, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA-Cw6, HLA-B27, IL23R] --> B[Environmental Trigger\nTrauma, Infection, Stress, Obesity]
    B --> C[Skin Inflammation\nIL-23/Th17 Axis → Psoriasis]
    C --> D[Joint/Enthesis Inflammation\nShared IL-23/IL-17 Pathway]
    D --> E[6 Clinical Domains\nPeripheral, Axial, Dactylitis,\nEnthesitis, Skin/Nail, Extra-articular]
    E --> F[Structural Damage\nErosions, Pencil-in-Cup,\nAnkylosis]
```
...
```mermaid
mindmap
  root((Psoriatic Arthritis))
    Epidemiology
      15-30%_of_PsO
      Peak_30-50
      M=F
      Skin_precedes_joint_70-80%
    Pathophysiology
      IL23_IL17_axis
      Enthesitis_primary
      Koebner_phenomenon
    ...
    5_Patterns
      ...
      Mutilans
    Clinical_Signs
      Nail_Pitting_Onycholysis_Oil_Spots
      Sausage_Digit
