---
tags: [medicine, rheumatology, davidson, sle, fcps, mrcp]
...
topic_group: Systemic lupus erythematosus and related conditions
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nHLA, Complement, IFN pathway] --> B[Environmental Triggers\nUV, EBV, Silica, Drugs, Hormones]
    B --> C[Loss of Tolerance\nImpaired Clearance of Apoptotic Debris]
    C --> D[Autoantibody Production\nANA, dsDNA, Sm, aPL, Ro/La]
    D --> E[Immune Complex Formation\nCirculating + Tissue Deposition]
    E --> F[Complement Activation\nC3/C4 Consumption]
    F --> G[End-Organ Damage\nKidney, Brain, Skin, Heart, Lung, Blood]
    G --> H[Type I IFN Signature\nPlasmacytoid DC → IFN-α → Immune Activation]
```
...
```mermaid
mindmap
  root((Systemic Lupus Erythematosus))
    Epidemiology
      F:M 9:1
      15-45 years
      Afro-Caribbean/Asian > Caucasian
    Pathophysiology
      Apoptotic clearance defect
    ...
    Clinical
      Constitutional
      Musculoskeletal (Jaccoud's)
      Cutaneous (malar, discoid, SCLE, photosensitivity)
      Renal (LN Class I-VI)
      Neuropsychiatric
      Haematological (AIHA, ITP, lymphopenia)
      Serosal (pleuritis, pericarditis)
      APS
    Diagnosis
      EULAR/ACR 2019 (ANA entry + score ≥10)
      SLICC 2012 (≥4, 1 clinical + 1 immuno)
      Autoantibodies (ANA, dsDNA, Sm, Ro/La, aPL)
      Complement (C3, C4)
      Renal biopsy
    Lupus_Nephritis
      ISN/RPS 2018 Class I-VI
      Induction (MMF vs CYC)
      Maintenance (MMF/AZA/CNI)
    APS
      Sydney Criteria
      Warfarin (not DOAC)
    ...
    Management
      HCQ ALL (lifelong)
      Organ-based escalation
      Biologics (Belimumab, Anifrolumab)
    Pregnancy
      Pre-conception (quiescent ≥6mo)
      Stop teratogens (MMF, CYC, MTX, LEF)
      Safe: HCQ, AZA, Tacrolimus, Aspirin, LMWH
      Anti-Ro → fetal echo
```
