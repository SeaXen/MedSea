---
tags: [medicine, endocrinology, davidson, thyroid-eye-disease, graves-ophthalmopathy, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 20: Endocrinology (Thyroid Section)
status: full-fcps-mrcp-note
priority: HIGH
exam_relevance: "FCPS/MRCP High Yield - Thyroid Eye Disease (TED) is the most common orbital disease. Key viva topics: EUGOGO grading, medical management (steroids, teprotumumab), surgical decompression, and smokers cessation."
see_also: ["Graves Disease", "Hyperthyroidism Overview", "Thyroid Storm", "Reproductive Endocrinology/Pregnancy"]
created: 2026-06-14
modified: 2026-06-14
---
...
## 3. EUGOGO Grading & Clinical Activity Score (CAS)
...
## 3. Medical Management Algorithm
...
## 4. Surgical Rehabilitation Sequence (Fixed Order)
...
## 4. Teprotumumab (IGF-1R Antibody) — Game Changer
...
## 6. Smoking Cessation — Critical Modifiable Factor
