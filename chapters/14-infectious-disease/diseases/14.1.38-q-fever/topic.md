...
source: "/mnt/tb/Medicine/Infectious Disease/Q Fever.md"
...
mindmap
  root((Q Fever))
    ...
    Transmission
      Aerosol (parturition)
      Highly infectious (1 org)
      Cattle, sheep, goats
    Acute
      Flu-like, PNA, Hepatitis
      Phase II IgM/IgG
      Doxy 14d
    Chronic
      Endocarditis (60-70%)
      Phase I IgG ≥1:800
      Doxy + HCQ 18m
      Vascular, Osteoarticular
    Pregnancy
      Doxy NO
      TMP-SMX throughout
    Diagnosis
      Serology: Phase I/II IgG/IgM
      PCR (early/valve)
      Echo (TOE)
    Prevention
      Q-Vax (Aus)
      Skin test + serology before
      PPE occupational
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 14: Infectious Disease — Q Fever*

**Q1.** What is the most appropriate first-line therapy for Q Fever?

  - **A.** Surgery + Often required + Hydroxychloroquine
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Surgery + Often required + Hydroxychloroquine
  >
  > *Source:* **Surgery**   Valve replacement   If haemodynamic compromise, persistent sepsis, embolism   **Often required**  

> [!critical]
> **Doxycycline + Hydroxychloroquine ×18m = standard for chronic Q fever
