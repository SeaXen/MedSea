...
davidson_topic_id: "14.1.44"
topic: "Skin and Soft Tissue Infections (SSTI)"
...
source: "/mnt/tb/Medicine/Infectious Disease/Skin and Soft Tissue Infections (SSTI).md"
...
```mermaid
mindmap
  root((Skin & Soft Tissue Infections))
    Non-purulent
      Cellulitis: diffuse, poorly demarcated
      Erysipelas: well-demarcated, raised, lymphangitic
      Pathogen: β-haemolytic Strep (Group A)
      Rx: Penicillin/Cefazolin/Ceftriaxone
    Purulent
      Abscess, Furuncle, Carbuncle
      Pathogen: S. aureus (MSSA/MRSA)
      Rx: I&D PRIMARY; Abx adjunct if systemic
      MRSA risk: Doxy/TMP-SMX/Clinda oral; Vanco IV
    Necrotising Fasciitis
      SURGICAL EMERGENCY
      Clinical: Pain out of proportion, rapid, dusky/bullae, crepitus
      LRINEC ≥6 → URGENT SURGERY
      Type I: Polymicrobial (Pip-tazo/Mero + Vanco + Clinda)
      Type II: Monomicrobial (Strep/Staph/Clostridium)
      CLINDA ESSENTIAL (toxin suppression)
    Diabetic Foot
      PEDIS: 1=None, 2=Mild, 3=Mod, 4=Severe
      Mild: Fluclox/Cepha; Mod: Pip-tazo/Ceftrix+Metro±Vanco; Sev: Mero+Vanco
      Osteomyelitis: Probe-to-bone, MRI gold standard
      Offloading + Vascular assessment ESSENTIAL
    Special
      Bites: Amoxicillin-clavulanate
      Clostridial: Pen + Clinda + Surgery; C.septicum→colonoscopy
      IVDU: S.aureus, I&D + Abx
```
