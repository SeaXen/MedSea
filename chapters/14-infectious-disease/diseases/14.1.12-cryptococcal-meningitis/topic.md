...
```mermaid
mindmap
  root((Cryptococcal Meningitis))
    Risk Factors
      HIV/AIDS CD4<100 (80-90%)
      Transplant, Steroids, Sarcoidosis
      C. gattii (Immunocompetent)
    Presentation
      Subacute Meningitis (Weeks)
      Headache, Fever, Confusion
      CN Palsies, Visual Loss
      Raised ICP (>30 cm H2O)
    Diagnosis
      LP: Opening Pressure >30
      India Ink (Sens 50-80%)
      CrAg LFA (>95% Sens/Spec)
      Culture (Gold Standard)
      PCR (Rapid)
    Induction (2w)
      AmB + Flucytosine (Gold)
      LAmB if Renal Impairment
      Flucytosine 100mg/kg/d QID
    Consolidation (8w)
      Fluconazole 800mg OD
    Maintenance
      Fluconazole 200mg OD
      Stop: CD4>200 x6m + VL Suppressed
    Raised ICP
      Daily LP (Target <25)
      ...
      NO Steroids
    HIV Specific
      ART Delay: CD4<50: 4-6w, 50-100: 2-4w
      IRIS: Continue Abx + ART + Steroids
      Maint Stop: CD4>200 x6m + VL Supp
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 14: Infectious Disease — Cryptococcal Meningitis*

**Q1.** What is the most appropriate first-line therapy for Cryptococcal Meningitis?

  - **A.** Alternative + Voriconazole + Itraconazole
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Alternative + Voriconazole + Itraconazole
  >
  > *Source:* **Alternative**   **Voriconazole 200mg BD** / **Itraconazole 200mg BD**   If Fluconazole Intolerance  

> [!tip] **Fluconazole 800mg Daily** = **High Dose for CNS Penetration**.
