...
```mermaid
mindmap
  root((Fever in Returned Traveller / FUO))
    Returned Traveller
      History: Where, When, What, Vaccines, Prophylaxis
      Incubation Timeline
      Red Flags
      Empirical: Geography-Based
    FUO
      Definition: >38.3C x3 over 3wks, No Dx after 1wk
      Categories: Infection > Malignancy > Autoimmune > Misc
      Top Infectious: TB, Endocarditis, Abscess
    Workup
      First-Line: CBC, ESR/CRP, Blood Cultures x3, Urine, CXR, US
      Second-Line: Echo, CT/PET-CT, Serology, BM, Biopsy
    Empirical Rx
      Malaria Zone: Artesunate
      SE Asia: Ceftriaxone + Doxy
      Africa: Artesunate + Ceftriaxone
      Latin Am: Supportive / Leishmania Rx
    Red Flags
