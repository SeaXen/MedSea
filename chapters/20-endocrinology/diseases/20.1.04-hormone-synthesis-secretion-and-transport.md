...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 20: Endocrinology — Hormone Synthesis, Secretion & Transport*

**Q1.** Which of the following features is most specific or characteristic of Hormone Synthesis, Secretion & Transport?
  ...
  > **Answer: A** — A. Cortisol
  >
  > *Source:* **A. Cortisol** — PNMT (phenylethanolamine N-methyltransferase) is cortisol-induced and converts noradrenaline to adrenaline specifically in the adrenal medulla
