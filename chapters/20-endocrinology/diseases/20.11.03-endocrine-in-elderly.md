...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 20: Endocrinology — Endocrine in Elderly*

**Q1.** Which of the following features is most specific or characteristic of Endocrine in Elderly?
  ...
  > **Answer: A** — TSH ↑
  >
  > *Source:* **TSH ↑ (upper reference limit increases), fT4 normal** — Thyroid function in healthy ageing: typical pattern:
