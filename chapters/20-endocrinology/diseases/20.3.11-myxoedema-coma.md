...
## 5. Precipitating Factors (Ranked by Frequency)
...
## 6. Diagnostic Criteria (Clinical + Biochemical)
...
## 8. Emergency Management Protocol (First 60 Minutes)
...
## 10. Monitoring (First 24-48 Hours)
...
## 12. Long-term Management (Survivors)
...
mindmap
  root((Myxoedema Coma))
    ...
    Emergency Rx
      Levothyroxine 300-500µg IV STAT
    ...
    Prognosis
      Mortality 20-50%
      Delay >6h → 2-3x Mortality
      Age >60, GCS<8, SBP<90 → Poor Outcome
```
...
- Q: What is the definition of Endocrinology?
  A: | Definition | Severe, life-threatening decompensation of hypothyroidism with multiorgan failure |
- Q: What is 1. Hypothermia of Endocrinology?
  A: Core Temp <35°C (Rectal)
- Q: What is 2. Altered Mental Status of Endocrinology?
  A: Confusion → Stupor → Coma (GCS <8)
- Q: What is 3. Hypotension of Endocrinology?
  A: SBP <90 mmHg (Refractory to 1L Fluids)
- Q: What is Levothyroxine of Endocrinology?
  A: Full Replacement Dose (1.6 µg/kg/day)
- Q: What is Hydrocortisone of Endocrinology?
  A: Taper to Physiological (15-20mg AM + 5-10mg PM)
- Q: What is the investigation of choice for Endocrinology?
  A: TSH, fT4, Cortisol at 48h, 1wk, 1mo
- Q: What is Precipitant of Endocrinology?
  A: Treat Underlying Cause (Infection, Drugs, Non-compliance)
- Q: What is Follow-up of Endocrinology?
  A: TSH/fT4 q4-6wk until Stable; Then 6-12mo
- Q: What is 1. Hypothermia of Endocrinology?
  A: Core Temp <35°C (Rectal)
- Q: What is 2. Altered Mental Status of Endocrinology?
  A: Confusion → Stupor → Coma (GCS <8)
...
1. A patient with suspected Endocrinology presents with: Definition — Severe, life-threatening decompensation of hypothyroidism with multiorgan failure; Incidence — Rare (0.1-0.2/100,000/year); Mortality — 20-50% (Despite optimal treatment). What is the most likely diagnosis?
   A. **Endocrinology**
