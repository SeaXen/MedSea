...
### 1. Section 1: Nutrigenomics & Nutrigenetics
**Definitions:**
...
### 2. Section 2: Functional Foods Categories
...
### 3. Section 3: Probiotics — Evidence
...
### 5. Section 5: Personalised Nutrition
**Layers:**
...
### 6. Section 6: Clinical Applications
...
```mermaid
mindmap
  root((Nutrigenomics & Functional Foods))
    Nutrigenomics
      Nutrients affect genes
      MTHFR C677T (folate)
      HFE C282Y (Fe)
      LCT (lactose)
      APOE4 (Alzheimer)
