...
### 1. Section 1: Indications & Contraindications
...
### 4. Section 4: Complications & Management
...
### 6. Section 6: Peripheral vs Central PN
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 5: Nutritional Factors — Parenteral Nutrition- Indications, Access & Complications*

**Q1.** In the management of Parenteral Nutrition- Indications, Access & Complications, which of the following should be avoided or is contraindicated?

  - **A.** lipid (avoid in severe hyperTG)
  ...
  > **Answer: A** — lipid (avoid in severe hyperTG)
  >
  > *Source:* aureus, Candida, Gram-neg);** alternative access; antibiotics |
| Trace elements optional | **Additrace daily in long-term PN**; Cu ↑ in cholestasis |
| All PN patients need lipids | **Avoid lipid in 
