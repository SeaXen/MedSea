...
## 2. 2. 🧠 Core Concept: Chromosomal Architecture

```mermaid
flowchart TD
    A[Chromosomal Disorders] --> B[Aneuploidy
Numerical]
    A --> B2[Structural Rearrangements
Balanced/Unbalanced]
    A --> B3[Microdeletion/Duplication
Submicroscopic]
    A --> B4[Instability Syndromes
DNA Repair Defects]
...
### 4. Prenatal Screening for Aneuploidy
...
## 4. 4. ️⃣ Sex Chromosome Aneuploidies
...
## 5. 5. ️⃣ Structural Chromosomal Rearrangements
...
### 2. 3.1 Robertsonian Translocations
...
### 3. 3.2 Reciprocal Translocations
...
### 5. 3.4 Other Structural Variants
| Variant | Description |
|---------|-------------|
...
## 6. 6. ️⃣ Microdeletion / Microduplication Syndromes (Genomic Disorders)

### 1. Recurrent Microdeletion Syndromes (Recurrent = NAHR between LCRs)
...
### 3. Recurrent Microduplication Syndromes
...
## 7. 7. ️⃣ Chromosomal Instability Syndromes (DNA Repair Defects)
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 3: Clinical Genetics — Chromosomal Disorders*

**Q1.** Which of the following features is most specific or characteristic of Chromosomal Disorders?

  - **A.** "All translocations cause disease"
  - **B.** A feature common to many acute inflammatory conditions
  - **C.** A non-specific sign that does not localise the diagnosis
  - **D.** An investigation finding rather than a clinical feature

  > **Answer: A** — "All translocations cause disease"
  >
