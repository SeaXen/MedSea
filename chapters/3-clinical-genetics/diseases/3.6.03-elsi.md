...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 3: Clinical Genetics — ELSI*

**Q1.** Which of the following features is most specific or characteristic of ELSI?
  ...
  >
  > *Source:* y in NHS organisations |

### Anti-Discrimination Law
| Law | Protections |
|-----|-------------|
| **Equality Act 2010** | Protected characteristics (Disability includes genetic predisposition); Dire
