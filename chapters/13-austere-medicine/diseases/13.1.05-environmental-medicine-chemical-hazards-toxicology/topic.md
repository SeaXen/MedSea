---
davidson_chapter: "Chapter 13: Medicine in Austere Environments"
davidson_topic_id: "13.1.05"
topic: "Environmental Medicine - Chemical Hazards & Toxicology"
...
source: "/mnt/tb/Medicine/Environmental medicine/Environmental Medicine - Chemical Hazards & Toxicology.md"
tags: [medicine, environmental, austere, davidson, fcps, mrcp]
---
...
```mermaid
flowchart TD
    A[Chemical Hazard] --> B[Heavy Metals<br/>Pb, Hg, As, Cd, Cr, Al, Mn]
    A --> C[Pesticides/Agrochemicals<br/>OPs, Carbamates, Pyrethroids, OCPs, Herbicides]
    A --> D[Industrial Chemicals<br/>Asbestos, Silica, Benzene, VC, Dioxins, PFAS, Solvents]
    A --> E[Radiation<br/>Ionizing, Non-Ionizing, ARS, Protection]
    A --> F[Risk Assessment<br/>REACH, GHS, Conventions, BioMonitoring, OELs]
```
