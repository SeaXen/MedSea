# Outbreak Investigation in Healthcare Settings
...
### Section 1: Overview, Definition, Triggers, and Outbreak Types
...
### Section 2: The 10 Steps of Outbreak Investigation
...
```mermaid
flowchart LR
    A[Epidemic Curve] --> B[Point Source<br/>Sharp single peak<br/>1 incubation period]
    A --> C[Continuous Common Source<br/>Plateau / sustained excess]
    A --> D[Propagated<br/>Serial peaks<br/>~1 serial interval apart]
    A --> E[Mixed / Pseudo]
    B --> B1[Examples:<br/>Food poisoning, single contaminated vial]
    C --> C1[Examples:<br/>Legionella water, contaminated product in use]
    D --> D1[Examples:<br/>Norovirus, influenza, MRSA, VRE, CDI, measles]
```
...
### Section 3: Outbreak Calculations — Quick Reference
...
### Section 4: Common Healthcare Outbreaks — Clinical Features, Source, Control
...
### Section 5: Outbreak Decision Flow
...
flowchart TD
    ...
    C --> D[Case definition<br/>Confirmed/Probable/Possible]
    D --> E[Active case finding<br/>Build line list]
    E --> F[Descriptive epi<br/>Epi curve]
    F --> G{Curve shape}
    G -->|Point source| H[Retrospective cohort<br/>RR + ARL]
    G -->|Continuous| H2[Retrospective cohort<br/>Identify ongoing source]
    G -->|Propagated| I[Case-control<br/>OR]
    H --> J[WGS / typing<br/>Environmental sampling<br/>HCW screening]
    H2 --> J
    I --> J
    J --> K[Implement control<br/>Source, transmission, host]
    K --> L[Monitor epi curve<br/>Re-test hypothesis]
    L --> M[Communicate<br/>SITREPs + report]
    M --> N[Post-outbreak AAR<br/>Update policy]
```

---

### Section 6: Molecular Typing — Practical Guide
...
## 9. Flowchart: Outbreak Investigation (Detailed)
...
flowchart TD
    ...
    C --> D[Case Definition<br/>P-P-T-Clin-Lab<br/>Confirmed/Probable/Possible]
    D --> E[Active case finding<br/>Lab, ward, OH, screening]
    E --> F[Line List]
    F --> G[Descriptive epi<br/>Person/Place/Time<br/>Epidemic curve]
    G --> H{Type?}
    ...
    O --> P[Post-outbreak AAR<br/>Update policies & bundles]
```
