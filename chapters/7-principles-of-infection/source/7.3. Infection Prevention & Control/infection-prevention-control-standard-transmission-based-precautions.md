...
### Section 1: The Chain of Infection & Hierarchy of Controls
...
### Section 2: Standard Precautions — For Every Patient, Every Time
...
### Section 3: Hand Hygiene — The Cornerstone of IPC
...
### Section 5: Transmission-Based Precautions
...
### Section 6: Isolation Room Specifications
...
### Section 7: Multi-Drug Resistant Organisms (MDRO) — Bundles and Decolonisation
...
### Section 8: Protective (Reverse) Isolation for Immunocompromised Patients
...
### Section 9: Respiratory Hygiene / Cough Etiquette
...
### Section 10: Safe Injection Practices
...
### Section 11: Sharps Safety & Needlestick Injury Management
...
### Section 12: Environmental Cleaning & Disinfection
...
### Section 13: Healthcare Worker Health, Screening & Immunisation
...
### Section 15: Outbreak Control in Healthcare Settings
...
### Section 16: Special Settings & Populations
...
### Section 17: Behavioural Science, Digital Tools & Future of IPC
...
## 9. Flowchart — Precaution Selection
...
flowchart TD
  ...
  B -->|Contact| D[Contact Precautions<br/>Gloves + Gown + Single room/Cohort]
  B -->|Droplet >5µm| E[Droplet Precautions<br/>Surgical mask + Single room or ≥1m]
  B -->|Airborne <5µm| F[Airborne Precautions<br/>N95/FFP2/3 + AIIR ≥12 ACH]
  B -->|AGP e.g. intubation| G[Airborne + Contact + Eye protection<br/>FFP3 + AIIR]
  B -->|VHF EVD| H[Full barrier PPE<br/>FFP3 + Visor + Double gloves + Impermeable gown]
...
## 10. Flowchart — Needlestick Injury Management

```mermaid
flowchart TD
  A[Needlestick / Mucosal Exposure] --> B[Immediate first aid:<br/>Wash + irrigate 15-20 min]
  ...
  F --> H
  G --> H
  H -->|Positive / high risk| I[3-drug PEP within 2h, max 72h<br/>TDF/FTC + RAL/DTG x 28d]
  ...
  N -->|HBsAg+| O[Recipient anti-HBs?<br/>≥10: immune, no PEP<br/><10: HBIG + vaccine]
  N -->|Negative| P[No PEP — confirm vaccination status]

  E --> Q{Source HCV status?}
  Q -->|Positive| R[No PEP — monitor HCV RNA at 4-6w, anti-HCV at 6m<br/>Treat with DAA if seroconvert]
