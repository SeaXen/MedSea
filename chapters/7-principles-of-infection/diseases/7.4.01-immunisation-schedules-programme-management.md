...
## 4. 4. Must Know / Should Know / Nice to Know
...
### 1. Section 1: Vaccine Schedule Architecture
...
### 2. Section 2: WHO Expanded Programme on Immunization (EPI) Schedule
...
### 3. Section 3: UK NHS Routine Immunisation Schedule (2024–25)
...
### 4. Section 4: US CDC Immunisation Schedule (Highlights, 2024)
...
### 5. Section 5: Vaccines in Special Populations
...
### 6. Section 6: Live Vaccines — When to Use, When to Avoid
...
### 7. Section 7: Cold Chain — The Backbone of Programme Success
...
### 8. Section 8: Vaccine Storage, Supply Chain, and Wastage
...
### 9. Section 9: National Immunisation Programmes (NIP) — Architecture
...
### 10. Section 10: Catch-up Vaccination
...
### 11. Section 11: Adverse Events Following Immunisation (AEFI)
...
### 12. Section 12: Vaccine-Preventable Disease (VPD) Surveillance
...
### 13. Section 13: Brief — Vaccine Hesitancy at Programme Level
...
## 7. 7. Clinical Correlation / Application
...
## 8. 8. High-Yield FCPS/MRCP Points
...
## 9. 9. Common Confusions / Exam Traps
...
```mermaid
mindmap
  root((Immunisation Schedules & Programme Management))
    Schedules
      WHO EPI
        Birth BCG HepB OPV
        6 10 14 wk Pentavalent PCV Rota OPV
        9 mo MR Vitamin A
        15 mo MR2
        HPV 9-14 yr 1-dose
        R21 malaria 5-7-18 mo
      UK NHS
        Birth BCG high-risk HepB
        8 12 16 wk 6in1 PCV MenB Rota
        1 yr HibMenC MMR PCV-booster MenB-booster
        3 yr 4 mo MMR2 4in1
        12-13 yr HPV 2-dose MenACWY TdIPV
        14 yr 3in1
        Adult flu COVID PPV23 shingles
      US CDC
        Birth HepB
        2 4 6 mo DTaP Hib IPV PCV RV HepB
        12-15 mo MMR VZV HepA
        4-6 yr DTaP IPV MMR VZV
        11-12 yr Tdap MenACWY HPV
        16 yr MenACWY booster
        Annual flu COVID
      Bangladesh EPI
        BCG OPV HepB birth
        6 10 14 wk Pentavalent PCV Rota OPV
        9 15 mo MR Vitamin A
    ...
    Special Groups
      Pregnancy
        ...
        COVID-19
        RSV 28-36 wk
        Avoid MMR VZV LAIV BCG OPV
      Asplenia
        MenACWY MenB
        PCV then PPV23
        Hib flu COVID
      Complement Defect Inhibitors
        MenACWY MenB
      HIV
        PCV PPV23 flu COVID
        Live OK if CD4>=200
    ...
    Cold Chain
      2-8 degC standard
      Freeze-sensitive
        HepB DTP DTaP IPV PCV HPV HepA
      Freeze-dried
        BCG MMR VZV YF OPV
        Stored frozen or 2-8
      VVM
        Cumulative heat
        4 stages
      Shake test
        Detects freeze damage
        Frozen sediments <30s
      Equipment
        Cold rooms
        Purpose-built fridges
        Cold boxes vaccine carriers
        Conditioned ice packs
    Programme
      Coverage
        DTP3 marker
        90 national 80 district
        Zero-dose
        WUENIC
      Wastage
        Open closed
    ...
    Catch-up
      ...
      Minimum intervals
      Accelerate
      Rotavirus upper age limit
      SIA mop-up ORI
```

---

## 12. 12. Flowchart — Cold Chain Failure Response

```mermaid
flowchart TD
    A[Fridge temperature excursion detected
>8°C or <-2°C] --> B{Is reading current and reliable?}
    B -->|No - recheck| C[Verify thermometer; check loggers]
    B -->|Yes| D[Identify affected vaccines]
    D --> E{Freeze-sensitive vaccines
in fridge?}
    E -->|Yes| F[Shake test each batch
vs reference vial]
    F --> G{Sediment faster
than reference?}
    G -->|Yes - frozen| H[QUARANTINE whole batch
Report to supervisor
Document and discard]
    G -->|No| I[Continue but investigate cause]
    E -->|No| J[Heat-sensitive check:
VVM stages]
    J --> K{Any VVM at stage 4
match discard square?}
    K -->|Yes| L[Discard vial
Document]
    K -->|No| M[Check potency by VVM stage
Use first those at stage 3]
    A --> N[Document incident
AEFI-cold chain log
Root cause analysis
Preventive action]
```
...
## 13. 13. Suggested Visuals / Image Notes
...
## 14. 14. Suggested Video References
...
## 15. 15. One-Page Revision Summary
...
## 16. 16. -Day / 15-Day / 30-Day Revision Tracker
