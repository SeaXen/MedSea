...
### 1. Section 1: HIV Antiretroviral Therapy (ART)
...
### 2. Section 2: HCV Direct-Acting Antivirals (DAA)
...
### 3. Section 3: Herpesvirus Antivirals
...
### 4. Section 4: Influenza Antivirals
...
### 5. Section 5: COVID-19 Antivirals
...
```mermaid
mindmap
  root((Antiviral Agents))
    HIV
      NRTI_Tenofovir_Lamivudine
      NNRTI_Efavirenz_Rilpivirine
      INSTI_Dolutegravir_Bictegravir
      PI_Darunavir_Atazanavir
      Entry_Maraviroc_Enfuvirtide
      Capsid_Lenacapavir
    HCV
      NS3_4A_PI_Glecaprevir
      NS5A_Velpatasvir_Ledipasvir
      NS5B_Sofosbuvir
      Pan_genotypic
    Herpesvirus
      HSV_VZV_Acyclovir_Valacyclovir
      CMV_Ganciclovir_Valganciclovir
      Foscarnet_Cidofovir_Rescue
      Letermovir_CMV_prophylaxis
    Influenza
      NA_Inhibitor_Oseltamivir
      Cap_Endo_Baloxavir
    COVID_19
      Paxlovid_Nirmatrelvir_Ritonavir
      Remdesivir_RdRp
      Molnupiravir_Mutagenesis
      Dexamethasone_Tocilizumab
    HBV
      TDF_TAF
      Entecavir
      Peginterferon
