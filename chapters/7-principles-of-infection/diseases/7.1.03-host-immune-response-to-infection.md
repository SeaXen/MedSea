...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Host Immune Response to Infection*

**Q1.** Which of the following features is most specific or characteristic of Host Immune Response to Infection?
...
|------|------------|
| **Innate immunity** | Immediate (0-12h), non-specific, no memory; barriers + cellular + humoral |
| **Adaptive immunity** | Delayed (days-weeks), specific, 
