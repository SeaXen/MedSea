...
### 1. Section 1: The WHO SAGE 3Cs Model and Determinants of Vaccine Hesitancy
...
### 2. Section 2: Communication Strategies
...
### 3. Section 3: Vaccine Mandates — Ethics, Law, and Application
...
### 4. Section 4: Religious Perspectives on Vaccination
...
### 5. Section 5: Common Myths — Evidence-Based Debunking
...
## 4. 4. High-Yield FCPS/MRCP Points
...
## 5. 5. Common Confusions / Exam Traps
...
```mermaid
mindmap
  root((Vaccine Hesitancy & Communication))
    Definitions
      WHO_3Cs
      Vaccine_hesitancy_spectrum
      Mandate_ethics
    Drivers
      Religious
      Philosophical
      Mistrust_government_industry
      Social_media
      Past_experience
      Complacency
    Communication
      ...
      C_A_S_E
      Presumptive_vs_participatory
      Elicit_Provide_Elicit
      HCW_recommendation
    Common_Myths
      MMR_autism_Wakefield
      Thimerosal
      Aluminium
      mRNA_DNA
      Infertility
    ...
    Special_Groups
      ...
      Travelers
    Policy
      Mandates_Jacobson_1905
      VICP_Vaccine_compensation
      Yellow_Card_MHRA
      VAERS
      Mandate_ethics
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Vaccine Hesitancy & Communication*

**Q1.** Which of the following features is most specific or characteristic of Vaccine Hesitancy & Communication?
  ...
  > **Answer: A** — Vaccine hesitancy
  >
  > *Source:* Term | Definition |
|------|------------|
| **Vaccine hesitancy** | Delay in acceptance or refusal of vaccines despite availability of vaccination services (WHO SAGE 2014). Complex, context-specific, 
