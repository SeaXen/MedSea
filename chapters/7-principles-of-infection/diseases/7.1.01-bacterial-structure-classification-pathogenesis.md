...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Bacterial Structure, Classification & Pathogenesis*

**Q1.** Which of the following features is most specific or characteristic of Bacterial Structure, Classification & Pathogenesis?
  ...
  > *Source:* neoformans) |
| **Adhesins** | Surface proteins/pili mediating host cell binding; tissue tropism (P fimbriae → pyelonephritis) |
| **Exotoxin** | Secreted protein toxin; specific action (A-B toxins, s
