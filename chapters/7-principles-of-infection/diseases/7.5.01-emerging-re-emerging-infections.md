...
| **R<sub>t</sub> / Effective R** | R at time t accounting for immunity and interventions. Used to track outbreak control. |
...
### 1. Section 1: Framework — Definitions, Categories, Burden
...
### 2. Section 2: Drivers of Emergence — The CLIMATIC Mnemonic
...
- **HGT**: conjugative plasmids, integrons, transposons spread resistance and virulence genes (e.g., *bla*<sub>KPC</sub>, *bla*<sub>NDM</sub>, *bla*<sub>OXA-48</sub> in Enterobacterales; *bla*<sub>OXA-23</sub> in *Acinetobacter*).
...
- **Virulence factor acquisition**: *Streptococcus pyogenes* hypervirulent M1<sub>UK</sub>; *Klebsiella* K1/K2 capsular types.
...
### 3. Section 3: One Health — The Integrated Approach
...
### 4. Section 4: Zoonotic Spillover — The Cascade
...
### 5. Section 5: WHO R&D Blueprint Priority Pathogens
...
### 6. Section 6: Disease Profiles — Key Examples
...
### 8. Section 8: Preparedness, Response, and Governance
...
### 9. Section 9: Future Threats and Emerging Trends
...
## 4. 4. Tables / Comparison Charts

### 1. Table 1: Emerging vs Re-Emerging vs Deliberate
...
### 2. Table 2: Pandemic Influenza Strains
...
### 3. Table 3: Coronavirus Epidemics
...
### 4. Table 4: Climate-Disease Links
...
### 7. Table 7: Vaccine & Therapeutic Platforms for Future Threats
...
## 8. 8. Common Confusions / Exam Traps
...
```mermaid
mindmap
  root((Emerging & Re-Emerging Infections))
    Definitions
      Emerging
      Re-emerging
    ...
    One Health
      ...
      Zoonotic priority list
    WHO R and D Blueprint
      COVID-19
      CCHF
      Ebola Marburg
      Lassa
...
## 11. 11. Flowchart — Outbreak Detection to Response

```mermaid
flowchart TD
  A[Signal: clinical, lab, event-based, wastewater, genomic] --> B[Triage and verification]
  B --> C{PHEIC?}
  C -- Yes --> D[Notify WHO 24 h; declare PHEIC]
  C -- No --> E[National action]
  D --> F[GOARN deploy; EIOS/EWRS alert]
  E --> G[GOARN support if requested]
  F --> H[Joint risk assessment: One Health]
  G --> H
  H --> I[Activate R&D Blueprint CEPI pipeline]
  I --> J[Vaccine therapeutics diagnostics platform]
  J --> K[Implement IHR core capacities]
  K --> L[Control: source, transmission, host]
  L --> M[Surveillance: genomic, wastewater, serology]
  M --> N[Evaluate: AAR; IHR NAPHS update]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Emerging & Re-Emerging Infections*

**Q1.** Which of the following features is most specific or characteristic of Emerging & Re-Emerging Infections?
