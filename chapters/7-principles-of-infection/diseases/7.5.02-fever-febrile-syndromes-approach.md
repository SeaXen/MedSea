...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Fever & Febrile Syndromes- Approach*

**Q1.** Which of the following features is most specific or characteristic of Fever & Febrile Syndromes- Approach?
  ...
  > **Answer: A** — Factitious fever
  >
  > *Source:* related to a drug, unrelated to the underlying disease, resolving on withdrawal (± rechallenge) |
| **Factitious fever** | Self-induced (Munchausen) — typically absent in AM, no sweating with the spik
