...
### 2. Section 2: Viral Replication Cycle — Universal Steps
...
flowchart LR
    ...
    A1[Receptor binding
determines tropism] -.-> A
    B1[Fusion (enveloped)
Endocytosis (both)] -.-> B
    C1[Release of genome
into cytoplasm/nucleus] -.-> C
    D1[DNA: nucleus (mostly)
RNA: cytoplasm (mostly)] -.-> D
    E1[Host ribosomes
Viral polymerases] -.-> E
    F1[Nucleocapsid formation
Budding (enveloped)] -.-> F
    G1[Lysis (naked)
Budding (enveloped)] -.-> G
```
...
| *Parvo requires S-phase host | Reoviridae
Caliciviridae
Retroviridae (RT step) |

> **Poxviridae** = ONLY dsDNA virus replicating entirely in cytoplasm (carries own transcriptional machinery).

---

### 3. Section 3: Viral Pathogenesis — From Entry to Disease
...
### 4. Section 4: Key Virus Families — Clinical Syndromes High-Yield
...
## 9. 9. Flowchart: Viral Diagnostic Pathway by Syndrome

```mermaid
flowchart TD
    A[Clinical Syndrome] --> B{Sample Type}
    B -->|Respiratory| C[Nasopharyngeal Swab]
    C --> D[Multiplex PCR Panel
Flu/RSV/SARS-CoV-2/AdV/hMPV/PIV/RV/EV/Mp/Cp/Lp]
    D --> E{Result}
    ...
    J --> K[CSF Multiplex PCR
HSV/VZV/Enterovirus/Parecho/HHV-6/EBV/CMV/JEV/WNV/TBE + Bacteria]
    K --> L{Result}
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Viral Structure, Classification & Pathogenesis*

**Q1.** Which of the following features is most specific or characteristic of Viral Structure, Classification & Pathogenesis?
  ...
  > **Answer: A** — Tropism
  >
  > *Source:* Antigenic shift** | Reassortment of segmented genome (flu) → novel subtype → pandemic potential |
| **Tropism** | Specificity for certain cells/tissues determined by receptor expression + intracellula
