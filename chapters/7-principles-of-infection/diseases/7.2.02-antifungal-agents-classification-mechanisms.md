...
### 1. Section 1: Azoles — CYP51 (Lanosterol 14α-Demethylase) Inhibitors
...
### 2. Section 2: Polyenes — Amphotericin B (Ergosterol Binding)
...
### 3. Section 3: Echinocandins — Fks1 Inhibition (β-1,3-Glucan Synthase)
...
### 4. Section 4: Allylamines — Terbinafine (Squalene Epoxidase Inhibitor)
...
### 7. Section 7: Newer Antifungal Agents
...
### 8. Section 8: Pneumocystis jirovecii (PCP) — Special Considerations
...
### 9. Section 9: Combination Antifungal Therapy
...
## 4. 4. Clinical Correlation — First-Line Therapy for Major Mycoses
...
## 6. 6. High-Yield FCPS/MRCP Points
...
```mermaid
mindmap
  root((Antifungal Agents))
    Ergosterol_Synthesis
      Azoles_CYP51
        Triazoles
          Fluconazole
          Itraconazole
          ...
          Isavuconazole
      Allylamines
        Terbinafine_squalene_epoxidase
    Ergosterol_Binding
      Polyenes
        AmB_deoxycholate
        Liposomal_AmB_LAmB
    ...
    Novel_Targets
      ...
      Olorofim_DHODH
    Clinical_Use
      Candidemia_Echinocandin
      Invasive_Aspergillosis_Voriconazole
      Mucormycosis_LAmB_surgery
      Crypto_Meningitis_AmB_5FC
      TDM_Vori_Posa
      Prophylaxis_Posaconazole
    Resistance
      C_krusei_intrinsic_fluco
      C_glabrata_SDD
      C_auris_MDR
      ERG11_mutations
      FKS1_hotspots
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Antifungal Agents- Classification & Mechanisms*

**Q1.** What is the most appropriate first-line therapy for Antifungal Agents- Classification & Mechanisms?

  - **A.** Candidaemia, non-neutropenic + Echinocandin
  - **B.** An advanced/surgical therapy reserved for refractory disease
  - **C.** Symptomatic treatment only, no disease-modifying therapy
  - **D.** Empiric broad-spectrum therapy without specific indication

  > **Answer: A** — Candidaemia, non-neutropenic + Echinocandin
  >
  > *Source:* **Candidaemia, non-neutropenic**   **Echinocandin (caspofungin 70/50, micafungin 100, anidula 200/100)**   Fluconazole (if susceptible, stable); LAmB 3 mg/kg   14 days after first negative blood cultu
