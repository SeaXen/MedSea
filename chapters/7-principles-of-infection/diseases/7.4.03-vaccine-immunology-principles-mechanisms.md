...
### 1. Section 1: Vaccine Immune Response Pathway
...
### 2. Section 2: Primary vs Secondary Response
...
### 3. Section 3: Correlates of Protection (CoP)
...
### 5. Section 5: Adjuvants — Mechanisms
...
### 6. Section 6: Factors Affecting Vaccine Immunogenicity
...
### 7. Section 7: AEFI (Adverse Events Following Immunisation)
  ...
  root((Vaccine_Immunology))
    Innate_Activation
      PRR_PAMP
        ...
        RLR
      DC_Maturation
      Cytokines_TNF_IL6_type1_IFN
    Antigen_Presentation
      MHC_I_CD8
      MHC_II_CD4
      Cross_presentation_DC
    T_Cell_Response
      Th1_cellular_IFNg
      Th2_humoral_IL4
      Th17_mucosal_IL17
    ...
    Correlates_of_Protection
      Ab_titre_HAI_OPA_SBA
      Functional_neutralisation
      T_cell_ELISpot
    Herd_Immunity
      HIT_1_minus_1_R0
      R0_measles_12_18
    ...
    AEFI
      ...
      Myocarditis_mRNA
      GBS_flu_rare
      Narcolepsy_Pandemrix
      Anaphylaxis_rare
      Intussusception_rota
    Factors_Affecting
      Age
      Immunocompromise
      HLA
...
## 9. 9. Flowchart — Vaccine Immune Response Pathway

```mermaid
flowchart TD
    A[Vaccine injected IM/SC/ID/Oral/IN] --> B[Antigen + Adjuvant at site]
    B --> C[Adjuvant activates PRR on DCs/Macrophages]
    C --> D[DC maturation + Ag uptake]
    D --> E[CCR7 upregulation]
    E --> F[Draining lymph node migration]
    F --> G{MHC presentation}
    G -->|MHC I + II| H[CD4+ and CD8+ T cell priming]
    G -->|MHC II to Tfh| I[B cell activation in GC]
    H --> J[Th1/Th2/Th17/Tfh polarisation]
    J --> K[CD8+ CTL effectors + memory]
    I --> L[Affinity maturation AID + CSR]
    L --> M[Plasma cells Ab]
    L --> N[Memory B cells in BM/LN]
    M --> O[Neutralising Ab + effector functions]
    O --> P[Long-term protection]
```
...
> **Auto-generated PasTest/Mediscope-style scenario SBAs** grounded in the authored source. Each scenario tests a real clinical fact (triad, specific sign, contraindication, trial, first-line Rx) extracted from the topic. *Source: Ch 7: Principles of Infection — Vaccine Immunology- Principles & Mechanisms*

**Q1.** Which of the following features is most specific or characteristic of Vaccine Immunology- Principles & Mechanisms?
  ...
  >
  > *Source:* ven to host (maternal IgG transplacental, IVIG, HBIG, VZIG, RIG) — short-term (weeks to months) |
| **Innate immunity** | Non-specific first line (barriers, complement, macrophages, NK, DCs, PRR-PAMP 
