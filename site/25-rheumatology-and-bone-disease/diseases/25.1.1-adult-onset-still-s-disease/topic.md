---
tags: [medicine, rheumatology, davidson, stills-disease, fcps, mrcp]
...
```mermaid
flowchart LR
    A[Genetic Susceptibility\nIL-1/IL-6/IL-18 Pathway] --> B[Environmental Trigger\nInfection, Stress]
    B --> C[Innate Immune Dysregulation\nMonocyte/Macrophage Activation]
    C --> D[Cytokine Storm\nIL-1β, IL-6, IL-18, IFN-γ]
    D --> E[Systemic Inflammation\nFever, Rash, Arthritis, Hepatitis,\nCoagulopathy, Ferritin Release]
    D --> F[Macrophage Activation Syndrome\nHemophagocytosis, Cytopenias,\nHyperferritinaemia, Coagulopathy]
```
...
```mermaid
mindmap
  root((Adult-Onset Still's Disease))
    Triad
      Quotidian_Fever
      Salmon_Rash
      Polyarthritis
