---
tags: [medicine, rheumatology, davidson, pan, fcps, mrcp]
...
topic: Polyarteritis nodosa (PAN)
...
mindmap
  root((Polyarteritis Nodosa))
    ...
    Hepatitis_B
      Association
      Immune_Complex
      Management_Antivirals_PLEX_Short_Steroids
      Avoid_CYC
    Classification
      ACR_1990_3_of_10
    Diagnosis
      Angiography_String_Of_Beads
      Biopsy_Necrotising_Medium
      ANCA_Negative
    Treatment
      Non_Hep_B_CYC_Steroids
      Hep_B_Antivirals_PLEX_Short_Steroids
      Maintenance_AZA_MTX
```
