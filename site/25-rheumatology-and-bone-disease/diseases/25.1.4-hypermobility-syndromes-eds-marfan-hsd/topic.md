---
tags: [medicine, rheumatology, davidson, hypermobility, ehlers-danlos, marfan, hsd, fcps, mrcp]
...
topic: Hypermobility Syndromes (EDS, Marfan, HSD)
...
```mermaid
flowchart TD
    A[Genetic Defect\nCollagen synthesis/structure\nFBN1, COL3A1, COL5A1, TNXB] --> B[Defective Connective Tissue\nLoose, Fragile, Hyperelastic]
    B --> C[Clinical Manifestations]
    C --> D[Hypermobile Joints\nLoose ligaments, capsules]
    C --> E[Skin\nHyperextensibility, Fragility, Atrophic Scars]
    C --> F[Vascular Fragility\nAortic root dilatation\nArterial dissection\nArterial rupture]
    C --> G[Ocular\nLens dislocation, Blue sclera, Myopia]
    C --> H[Chronic Pain\nCentral sensitisation]
    C --> I[Autonomic Dysfunction\nPOTS, Tachycardia]
    C --> J[GI Dysmotility\nGERD, IBS-like, Constipation]
```
...
```mermaid
mindmap
  root((Hypermobility Syndromes))
    Spectrum
      Asymptomatic_hypermobility
      HSD
      hEDS_most_common
      Marfan
      vEDS_most_dangerous
    Diagnosis
      ...
      FBN1_Marfan
      COL3A1_vEDS
      No_genetic_test_hEDS
    EDS_Types
      Classical_skin_scars
      Vascular_arterial_rupture
      Hypermobile_chronic_pain
      Arthrochalasia_hip
      Dermatosparaxis_skin
      Kyphoscoliotic
      Brittle_cornea
      Cardiac_valvular
      Others
    ...
    Management
      ...
      PT_OT
      Pain_management
      Cardiology_surveillance
      Celiprolol_vEDS
      Beta_blocker_Marfan
      Surgery_cautious
    Pregnancy
      Marfan_continue_beta_blocker
      vEDS_C_section
      Pre_conception_counselling
    Avoid
      Contact_sports_Marfan
      Arteriography_vEDS
      Heavy_lifting
```
