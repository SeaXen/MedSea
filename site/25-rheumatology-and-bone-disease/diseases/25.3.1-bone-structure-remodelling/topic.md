---
tags: [medicine, rheumatology, davidson, bone, anatomy, physiology, fcps, mrcp]
...
topic_group: Musculoskeletal anatomy and physiology
topic: Bone Structure & Remodelling and Joint Biology
status: full-fcps-mrcp-note
priority: medium
cards: 14
created: 2026-06-11
modified: 2026-06-16
exam_relevance: [FCPS, MRCP Part 1]
see_also:
  - "[[Osteoporosis]]"
...
```mermaid
flowchart LR
    A[Activation\nOsteocyte senses\nmicrodamage/hormone] --> B[Resorption\nOsteoclast recruitment\nRANKL signaling\n2-3 weeks]
    B --> C[Reversal\nReversal cells\nCoupling factors]
...
```mermaid
flowchart TD
    A[Antigen Presentation\nCD4+ T cell + DC] --> B[Macrophage Activation\nTNF, IL-1, IL-6]
    A --> C[B Cell Activation\nAutoantibody, Cytokines]
    B & C --> D[Synovial Hyperplasia\nFLS proliferation]
    D --> E[Pannus Formation\nInvasive front]
    E --> F[Cartilage Erosion\nMMPs, Aggrecanases]
    E --> G[Bone Erosion\nRANKL → osteoclast]
    F & G --> H[Joint Destruction\nIrreversible]
```
...
```mermaid
mindmap
  root((Bone and Joint Biology))
    Bone_Types
      Cortical_80_mass
      Trabecular_20_mass_80_surface
      Trabecular_first_lost_osteoporosis
    Bone_Cells
      Osteoclast_monocyte_resorption
      Osteoblast_MSC_formation
      Osteocyte_mechanosensor
      Reversal_lining_cells
    BMU_Cycle
      Activation
      Resorption_2_3_wk
      Reversal
    ...
    Signalling
      RANKL_RANK_OPG
      Wnt_sclerostin_DKK1
      PTH_continuous_vs_intermittent
      Glucocorticoids_severe_loss
    Cartilage
      Type_II_collagen_aggrecan_water
      Chondrocytes_senescent_OA
      MMPs_aggrecanases
    Synovium
      Type_A_macrophage
      Type_B_fibroblast
      RA_pannus
    Synovial_Fluid
      Septic_WBC_50000_PMN_75
      Inflammatory_WBC_2000_50000
      Crystals
    Clinical
      Osteoporosis_RANKL_OPG
      RA_TNF_IL_RANKL_erosion
      OA_MMPs_cartilage
      Paget_chaotic_remodelling
      Osteomalacia_mineralisation
    Drug_Targets
      Bisphosphonates
      Denosumab_anti_RANKL
      Romosozumab_anti_sclerostin
      Teriparatide_anabolic
      SERMs_HRT
```
