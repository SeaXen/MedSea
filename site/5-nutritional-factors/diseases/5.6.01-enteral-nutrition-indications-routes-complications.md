...
### 5. Section 5: Complications & Management
...
mindmap
  root((Enteral Nutrition))
    ...
    Administration
      Start 30-50 mL/h
      ↑10-20 mL/h q4-6h
      Target 25-30 kcal/kg
      Bolus or continuous
    Complications
      Aspiration (head 30-45°)
      Refeeding (thiamine)
      Diarrhoea (DIFH)
      ...
      PEG infection
    Monitoring
      Daily: GRV, electrolytes
      Weekly: weight, LFT, Ca/Mg/PO4
```
