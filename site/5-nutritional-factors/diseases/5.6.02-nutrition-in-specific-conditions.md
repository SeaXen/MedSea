...
### 3. Section 3: Inflammatory Bowel Disease (IBD)
**Crohn's Disease:**
...
### 5. Section 5: Cystic Fibrosis (CF)
...
### 7. Section 7: COPD / Respiratory Disease
...
### 9. Section 9: Critical Illness / ICU
...
```mermaid
mindmap
  root((Disease-Specific Nutrition))
    CKD
      Pre-dialysis: 0.6-0.8 g protein
      Dialysis: 1.0-1.2 g
      Low K/PO4/Na
      PO4 binders
    Liver
      Cirrhosis: 1.0-1.5 g protein
      Ascites: Na <2 g
