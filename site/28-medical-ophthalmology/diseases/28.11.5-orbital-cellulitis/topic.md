---
tags: [medicine, ophthalmology, davidson, orbital cellulitis, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Orbit & Ocular Trauma
topic_group: Preseptal and Orbital Cellulitis
topic: Preseptal and Orbital Cellulitis
...
```mermaid
mindmap
  root((Preseptal & Orbital Cellulitis))
    Preseptal
      Eyelid only
      Normal VA
      No proptosis
    ...
    Orbital
      Post-septal
      Proptosis
      Painful EOM restriction
      ↓VA, RAPD
      Chemosis
      Fever
      IV AB + admit
    Causes
      Ethmoid sinusitis 70%
      Trauma
      Dental
      Dacryocystitis
      Fungal in DKA
    ...
    Management
      ...
      ± Vancomycin
      Surgical drain if abscess
      Amphotericin for Mucor
    Complications
      Vision loss
