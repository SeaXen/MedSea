---
tags: [medicine, ophthalmology, davidson, retina, hypertensive, fcps, mrcp]
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 27: Medical ophthalmology
heading: Retina & Vitreous
topic_group: Hypertensive Retinopathy
...
```mermaid
mindmap
  root((Hypertensive Retinopathy))
    Definition
      Retinal changes from HTN
      End-organ damage marker
    Classification
      KWB
        I Narrowing
        II AV nicking
        III Haemorrhage/exudate
        IV Papilloedema
      Scheie
        Alternative
    Pathophysiology
