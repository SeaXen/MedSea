...
mindmap
  root((CCB Poisoning))
    Mechanism
      ...
      Cardiac: Neg Ino/Chrono/Dromo
      Pancreas: Hyperglycemia
    Classes
      Non-DHP: Verapamil, Diltiazem (Cardiac > Vascular)
      DHP: Amlodipine, Nifedipine (Vascular > Cardiac)
    Clinical
      Hypotension + Brady/Heart Block + Hyperglycemia
      NCPE (Verapamil/Diltiazem)
    Management
      Calcium (1st Line Specific)
      HIET (Refractory)
      Vasopressors (NE, Epi)
      WBI (SR Formulations)
      ILE/ECMO (Rescue)
    Differentiation
      BB: Hypoglycemia, Bronchospasm
      CCB: Hyperglycemia, Calcium Works
```
