...
```mermaid
flowchart TD
  A[Bradycardia + Hypotension + Hypoglycemia] --> B[Beta-Blocker Poisoning]
  B --> C[ABCDE: Atropine 0.5mg IV\nGlucose Monitor q15min\nBronchodilators if Wheeze]
  C --> D[Glucagon 5-10mg IV Bolus\n+ Antiemetic\nInfusion 5-15mg/hr]
  D --> E{Hemodynamic Response?}
  E -->|No / Transient| F[HIET: Insulin 1U/kg Bolus\n+ D50W 25g\nInfusion Insulin 1-10U/kg/hr\n+ Dextrose to Glucose 150-250\nK+ Replacement >2.8]
  E -->|Yes| G[Monitor\nWean Glucagon]
  ...
  J -->|No| G
  G --> L[Observe 24h Post-Normalization\nPsych Assessment]
```
