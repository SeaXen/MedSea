...
```mermaid
mindmap
  root((Cannabinoid Poisoning))
    Natural Cannabis
      Partial CB1 Agonist
      Mild: Euphoria, Anxiety, Tachycardia, Red Eyes
      Self-Limiting (4-6h Obs)
      Hyperemesis Syndrome (Chronic)
    Synthetic Cannabinoids
      Full CB1 Agonist (10-100x Potency)
      Severe: Seizures, Hyperthermia, Rhabdo, AKI, Cardiac Ischemia, Psychosis
      Screen Misses
      No Antidote
      ICU Management
    Management
      Natural: Supportive, Benzo PRN
      Synthetic: ICU, Benzo 1st Line, Cooling, Fluids, Avoid Antipsychotics
```

## 15. Flowchart
```mermaid
flowchart TD
  A[Cannabinoid Exposure] --> B{Natural or Synthetic?}
  B -->|Natural| C[Supportive: Reassurance\nBenzo if Anxious\nAntiemetic\nObs 4-6h\nDischarge if Asymptomatic]
  B -->|Synthetic / Unknown Severe| D[ABCDE: Intubate if Coma/Seizures\nContinuous ECG\nCK, Renal, Electrolytes]
  D --> E[Benzo 1st Line:\nSeizures: Lorazepam/Diazepam\nAgitation: Lorazepam\nAVOID Antipsychotics]
  E --> F{Hyperthermia > 39°C?}
  F -->|Yes| G[Aggressive Cooling\nParalyze if Refractory]
  F -->|No| H
  E --> I{Rhabdo?\nCK > 5000}
  I -->|Yes| J[Fluids 1-2L/hr\nAlkalinize Urine\nTarget UOP 2-3 mL/kg/hr]
  I -->|No| H
  E --> K{AKI / Cardiac Ischemia?}
  K -->|Yes| L[Renal Replacement\nTrop, Cardiology\nICU]
  K -->|No| H
  H --> M[ICU Until Stable\nPsych Assessment\nDischarge When Safe]
```
