...
mindmap
  root((Raised ICP))
    ...
    Monro-Kellie
      ...
      Compensation by displacement
    Causes
      Mass: Haematoma, Tumour, Abscess
      Diffuse: TBI, Encephalitis, FHF, DKA
      CSF: Hydrocephalus
      Venous: CVST
      Extracranial: Hyponatraemia, Hypoxia, Hypercapnia
    Clinical Features
      Symptoms: Headache, Vomiting, Visual
      Signs: Papilloedema (chronic)
      Cushing's Triad: HT + Brady + Irregular RR
      Pupils: Uncal (CN III)
      Posturing: Decorticate, Decerebrate
    Herniation
      Uncal: CN III + contralateral hemiparesis
      Central: Downward pressure
      Tonsillar: Sudden death
      Subfalcine: Contralateral leg
    Management
      ABCDE + Position (30deg)
      Sedation + Analgesia
      Osmotherapy
        Mannitol 0.5-1g/kg
        Hypertonic saline 3% 150-250ml
      PaCO2 35-38 mmHg
      Treat underlying cause
      EVD for hydrocephalus
      Rescue: Hyperventilate, Barbiturates, Decompressive craniectomy
      Supportive: DVT, Seizure Ppx, Temp control
    Avoid
      LP without imaging
      Hypotonic fluids
      Steroids in TBI
...
```mermaid
flowchart TD
  A[Raised ICP Suspected] --> B[ABCDE + Head-up 30 deg + Head midline]
  B --> C[Intubate if GCS <=8 + PaCO2 35-38 mmHg]
  C --> D[Sedation + Analgesia Propofol + Fentanyl]
  D --> E[Osmotherapy: Mannitol 0.5-1g/kg OR 3% Saline 150-250ml]
  E --> F[CT Head: Identify Cause]
  F -->|Mass| G[Neurosurgical Referral + Decompression]
  F -->|Hydrocephalus| H[EVD Insertion]
  F -->|Diffuse swelling| I[Continue medical management]
  I --> J{ICP Still >25?}
  J -->|Yes| K[Rescue: Brief Hyperventilation + Paralysis]
  J -->|Refractory| L[Barbiturate coma OR Decompressive craniectomy]
```
