...
```mermaid
mindmap
  root((Acute Liver Failure))
    Definition
      INR >=1.5 + Encephalopathy
      <26 weeks, No Prior Liver Disease
      Hyperacute/Acute/Subacute
    Aetiology
      Paracetamol (Commonest)
      Viral: HAV, HEV, HBV
      Drug: INH, Valproate, Amanita
      Autoimmune, Wilson's, AFLP, Budd-Chiari
    King's College
      Paracetamol: pH<7.3 OR (INR>6.5+Cr+Enceph)
      Non-Paracetamol: INR>6.5 OR 3 of 5
    Management
      ICU, NAC, Cerebral Oedema, Coagulopathy
      Specific: NAC, Silibinin, Steroids, Delivery
