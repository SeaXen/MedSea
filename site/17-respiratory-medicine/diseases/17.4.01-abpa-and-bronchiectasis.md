...
davidson_topic_id: "17.4.01"
topic: "ABPA and bronchiectasis"
...
source: "/mnt/tb/Medicine/Respiratory/Airway Diseases/ABPA and bronchiectasis.md"
...
mindmap
  root((ABPA))
    Pathophysiology
      Th2 hypersensitivity to A. fumigatus
      Central bronchiectasis + mucoid impaction
    Diagnosis
      ISHAM Criteria (4 Major + Minor)
      IgE >1000 (Screen)
      Central Bronchiectasis (HRCT)
      High-Attenuation Mucus (HAM)
    Staging
      1 Acute → 2 Remission → 3 Exacerbation
      4 Steroid-dependent → 5 Fibrotic
    Treatment
      Steroids (0.5-0.75mg/kg)
