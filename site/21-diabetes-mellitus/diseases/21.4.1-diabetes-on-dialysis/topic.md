---
tags: [medicine, diabetes, davidson, dialysis-diabetes, fcps, mrcp]
...
see_also: ["HbA1c interpretation in CKD", "Drug dosing in renal impairment", "Frailty and individualised HbA1c targets"]
created: 2026-06-13
modified: 2026-06-13
---
...
```mermaid
flowchart TD
    A[Diabetes on Dialysis] --> B{Modality?}
    B -->|HD| C[Insulin variable; ↓ post-HD]
    B -->|PD| D[Insulin higher; glucose absorption from dialysate]
    C --> E[Pre-HD: correction if >10]
    C --> F[Post-HD: ↓ basal 25-50%; monitor 1-2h post]
    D --> G[Consistent higher dose; glucose absorption]
    E --> H[Monitor pre-HD, 1h post, bedtime]
    F --> H
    G --> H
    H --> I[GA/Fructosamine q3mo; CGM if available]
```
