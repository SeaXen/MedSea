...
```mermaid
mindmap
  root((Paraneoplastic Cerebellar Degeneration))
    Antibodies
      Anti-Yo PCA1
        Breast
        Ovary
    ...
    Management
      ...
      Rehab speech SALT physio
    Prognosis
      Poor irreversible Purkinje loss
      Best with anti-Tr Hodgkin
      Tumour control improves
```
