...
topic: Paraneoplastic Encephalitis
...
```mermaid
mindmap
  root((Paraneoplastic Encephalitis))
    Antibodies
      Intracellular onconeuronal
        Anti-Hu ANNA-1 SCLC
        Anti-Ma2 Testicular
        Anti-CRMP5 CV2 SCLC Thymoma
        Anti-Ri ANNA-2 Breast
      Surface neuronal often non-PNS
        Anti-NMDAR Ovarian teratoma
        Anti-LGI1 Thymoma
        Anti-CASPR2 Thymoma
        Anti-GABA-B SCLC
        Anti-AMPAR Thymoma Lung
    Clinical syndromes
      Limbic encephalitis
      ...
      Morvan syndrome
    Investigations
      MRI brain FLAIR medial temporal
      CSF pleocytosis OCB
      EEG slow waves delta brush NMDAR
      Antibody panel serum CSF
      PET-CT cancer search
      Testicular US mammogram CT chest
    Management
      Treat underlying tumour
      First line steroids IVIG PLEX
      Second line rituximab cyclophosphamide
      Steroid sparing MMF azathioprine
      Long term rehab supportive
    Prognosis
      Better with surface antibodies
      Worse intracellular
      Tumour control critical
```
