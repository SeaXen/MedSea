---
tags: [medicine, neurology, davidson, meningitis, infection, emergency, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Meningitis
topic_group: Acute meningitis framework
...
related:
  ...
  - "[[Acute meningitis framework|Acute meningitis framework]]"
  - "[[Viral meningitis]]"
  - "[[Meningococcal sepsis red flags]]"
---
...
```mermaid
flowchart TD
  A[Suspected acute bacterial meningitis] --> B[ABCDE, blood cultures, dexamethasone, empirical IV antibiotics]
  B --> C{Any contraindication to immediate LP?}
  C -->|No| D[Perform LP promptly]
  D --> E[Send CSF: opening pressure, cells, protein, glucose with paired plasma glucose, Gram stain, culture]
  C -->|Yes| F[Delay LP and do urgent neuroimaging / stabilization]
  F --> G[Contraindications include focal deficit, new seizures, markedly reduced GCS, papilledema, signs of mass effect, cardiorespiratory instability, coagulopathy, local infection at puncture site]
  G --> H[Continue antibiotics; perform LP later if/when safe]
```
...
mindmap
  root((Bacterial meningitis))
    ...
    Organisms
      Pneumococcus
      Meningococcus
      Listeria in elderly or immunocompromised
    Emergency steps
      ABCDE
      Blood cultures
      Dexamethasone
      Empirical IV antibiotics
    LP decision
      Immediate LP if stable
      CT first if focal deficit or raised ICP concern
      Defer LP if shock or uncontrolled seizures
    CSF
      Neutrophils
      High protein
      Low glucose
