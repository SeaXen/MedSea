...
references:
  clinical: ['Davidson 24th Ed Ch25', "Adams & Victor's Principles of Neurology", 'ENMC 2003 Dermatomyositis Criteria', 'PasTest', 'MRCP Notes']
...
```mermaid
flowchart TD
    A[Unknown Trigger] --> B[Complement Activation C3]
    B --> C[Capillary Injury - Microangiopathy]
    C --> D[Perifascicular Atrophy]
    C --> E[Perivascular CD4+ T cells, B cells]
    A --> F[IFN-α/β/γ Signature]
    F --> G[MHC-I upregulation]
    G --> H[Muscle fibre injury]
```
