...
---
tags: [medicine, neurology, davidson, multiple-sclerosis, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Neuro-inflammatory Diseases
topic_group: Multiple sclerosis spectrum
topic: Relapsing-remitting and progressive multiple sclerosis patterns
exam: [FCPS, MRCP]
...
related:
  ...
  - "[[../Neuro-inflammatory Diseases|Neuro-inflammatory Diseases]]"
  - "[[Multiple sclerosis spectrum|Multiple sclerosis spectrum]]"
---
...
```mermaid
flowchart TD
  A[Patient with CNS episodes or progressive myelopathy] --> B{Relapses with recovery?}
  B -->|Yes| C[Consider RRMS and look for dissemination in space and time]
  B -->|No, steady progression| D[Consider PPMS or SPMS and exclude cord compression / mimics]
  C --> E[MRI brain and spinal cord]
  D --> E
  E --> F{MRI typical for demyelination?}
  F -->|Yes| G[Use CSF oligoclonal bands and clinical course to support diagnosis]
  F -->|No| H[Reconsider mimics: NMOSD, MOGAD, B12 deficiency, vasculitis, tumor, cervical myelopathy]
  G --> I[Classify RRMS vs SPMS vs PPMS]
  I --> J[Acute relapse treatment + disease-modifying therapy + rehabilitation]
```
