...
topic: Multifocal Motor Neuropathy
...
```mermaid
mindmap
  root((Multifocal Motor<br/>Neuropathy))
    Definition
      Pure motor
      Asymmetric focal
      LMN signs only
    ...
    Clinical Features
      ...
      Wasting in territory
      Reduced reflexes focal
      No sensory deficit
      Slowly progressive
    Diagnosis
      NCS persistent motor conduction block outside entrapment sites
      Anti-GM1 antibodies 30-50%
      EMG denervation in affected muscles
      MRI may show nerve enhancement
      CSF usually normal
    ...
    Prognosis
      ...
      Disability accumulates if untreated
```
