...
```mermaid
mindmap
  root((Normal Pressure Hydrocephalus))
    Definition
      Communicating_Hydrocephalus
      Normal_CSF_Pressure
      Reversible_Dementia
    Triad_Wet_Wobbly_Wacky
      Gait_Apraxia_First
      Magnetic_Gait_Shuffling
      Urinary_Incontinence_Urgency
      Cognitive_Slowing_Apathy
      Bradyphrenia_Executive_Dysfunction
    Pathophysiology
      Impaired_CSF_Absorption
      Ventriculomegaly_Normal_Pressure
      AD_Pathology_in_30_to_50_pct
      iNPH_vs_sNPH
    Imaging_MRI
      Evans_Index_gt_0_3
      Callosal_Angle_lt_90
      DESH_Sign
      Flow_Void_Aqueduct
      Temporal_Horns_Enlarged
      Periventricular_Hyperintensity
    Investigations
      MRI_Brain_Gold_Standard
      CSF_Tap_Test_Miller_Fisher
      External_Lumbar_Drain
      CSF_Opening_Pressure_lt_25
      Infusion_Test_Rout
    Differential
      Parkinson_Disease
      Normal_Ageing_Atrophy
      Alzheimer_Disease
    ...
    Treatment
      VP_Shunt_First_Line
      Programmable_Valve
      Lumboperitoneal_Shunt
      ETV_Less_Effective
      Physio_OT_Support
    Shunt_Response
      Gait_60_to_80_pct
      Bladder_50_to_60_pct
      Cognition_30_to_50_pct
      Best_if_Tap_Test_Positive
      Best_if_Gait_Predominant
      Best_if_Short_Duration
    Complications
      Subdural_Haematoma
      Shunt_Infection
      Overdrainage_Underdrainage
      Shunt_Malfunction
      Seizures
```
