---
tags: [medicine, neurology, examination, fcps, mrcp]
chapter: Neurology
...
related: ['Neurological History Taking', 'Cranial Nerve Examination', 'Motor System Examination', 'Sensory System Examination', 'Coordination & Gait Examination', 'Higher Cortical Function Assessment']
...
```mermaid
flowchart TD
    A[Examination] --> B[Pattern Recognition]
    B --> C{UMN or LMN?}
    C -->|UMN| D[Brain/Spinal Cord Lesion]
    C -->|LMN| E[Nerve/Root/Muscle Lesion]
    C -->|Mixed| F[MND / B12]
    C -->|Cerebellar| G[Cerebellum / Peduncles]
    C -->|Extrapyramidal| H[Basal Ganglia]
    D --> I[Brisk Reflexes + Babinski + Spasticity]
    E --> J[Absent Reflexes + Wasting + Fasciculations]
    F --> K[Combined UMN+LMN]
    G --> L[Ataxia + Intention Tremor + Dysmetria]
    H --> M[Bradykinesia + Rigidity + Tremor]
```
...
```mermaid
flowchart TD
    A[History] --> B[End-of-Bed]
    B --> C[Higher Cortical]
    C --> D[Cranial Nerves]
    D --> E[Motor: Tone/Power/Reflexes]
    E --> F[Sensory]
    F --> G[Coordination]
    G --> H[Gait/Stance]
    H --> I{UMN or LMN pattern?}
    I -->|UMN| J[Brain/Cord Lesion]
    I -->|LMN| K[Nerve/Root/Muscle]
    I -->|Cerebellar| L[Cerebellar Lesion]
    I -->|Extrapyramidal| M[Basal Ganglia]
    I -->|Mixed| N[MND / B12]
    J --> O[Imaging / Lesion Localisation]
    K --> O
    L --> O
    M --> O
    N --> O
...
flowchart TD
    ...
    I -->|UMN| J[Brain/Cord]
    I -->|LMN| K[Nerve/Root/Muscle]
    I -->|Cerebellar| L[Cerebellum]
    I -->|Extrapyramidal| M[Basal Ganglia]
    I -->|Mixed| N[MND/B12]
    J --> O[Localisation + Differential]
    K --> O
    L --> O
    M --> O
    N --> O
    O --> P[Investigations]
    P --> Q[Diagnosis + Management]
```
