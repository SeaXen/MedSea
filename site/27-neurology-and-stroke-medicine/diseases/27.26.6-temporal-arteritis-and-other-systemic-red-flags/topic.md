---
tags: [medicine, neurology, davidson, headache, giant-cell-arteritis, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Headache Syndromes
topic_group: Secondary headache red flags
topic: Temporal arteritis and other systemic red flags
status: full-note
---
...
```mermaid
flowchart TD
A[New headache age >50] --> B{Jaw claudication / scalp tenderness / visual symptoms?}
B -- Yes --> C[Suspect giant cell arteritis]
C --> D[Send ESR CRP FBC platelets LFTs]
C --> E[Start corticosteroids immediately]
E --> F[Urgent ultrasound and/or biopsy]
B -- No --> G[Consider other secondary headache causes]
```
