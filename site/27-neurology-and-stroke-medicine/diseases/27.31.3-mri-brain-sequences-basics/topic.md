---
tags: [medicine, neurology, davidson, neuroimaging, mri, sequences, t1, t2, flair, dwi, gadolinium, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Neuroimaging
topic_group: MRI-based imaging
topic: MRI brain sequences basics
exam: [FCPS, MRCP]
...
```mermaid
flowchart TD
A[Need brain imaging] --> B{Emergency unstable / bleed / rapid triage needed?}
B -->|Yes| C[CT first]
B -->|No| D{Need tissue characterization / demyelination / posterior fossa detail / encephalitis / epilepsy workup?}
D -->|Yes| E[MRI brain]
E --> F[Read by sequence: T1 -> T2/FLAIR -> DWI/ADC -> SWI -> post-contrast if available]
D -->|No| G[Use clinical context to choose imaging pathway]
```
