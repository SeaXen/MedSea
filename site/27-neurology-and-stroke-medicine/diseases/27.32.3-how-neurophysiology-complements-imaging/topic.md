---
tags: [medicine, neurology, davidson, neurophysiology, imaging-correlation, eeg, emg, evoked-potentials, fcps, mrcp]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Neurophysiological Testing
topic_group: Evoked potentials and specialized testing
topic: How neurophysiology complements imaging
exam: [FCPS, MRCP]
...
related:
  ...
  - "[[../Neurophysiological Testing|Neurophysiological Testing]]"
  - "[[Evoked potentials and specialized testing]]"
  - "[[When to request EEG]]"
...
```mermaid
flowchart TD
A[Neurological syndrome] --> B[Clinical localization]
B --> C{Main question}
C -->|Structural lesion?| D[CT/MRI]
C -->|Functional abnormality?| E[Neurophysiology]
D --> F{Symptoms explained fully?}
E --> F
F -->|Yes| G[Integrate and manage]
F -->|No| H[Use both modalities together]
H --> I[Refine level, mechanism, severity]
```
...
```mermaid
flowchart LR
A[Symptom complex] --> B[Localize clinically]
B --> C[Need structural answer?]
C -->|Yes| D[CT/MRI]
C -->|No or incomplete| E[Neurophysiology]
D --> F[Combine with EEG/NCS-EMG/EP as needed]
E --> F
F --> G[Final clinicoradiophysiological diagnosis]
```
