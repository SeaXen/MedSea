---
tags: [medicine, stroke-medicine, davidson, full-note, dysphagia, aspiration]
...
topic_group: Stroke severity and bedside assessment
topic: Dysphagia screening and aspiration risk
...
```mermaid
flowchart TD
A[All acute stroke patients] --> B[NPO until dysphagia screen]
B --> C{Alert and can participate?}
C -- No --> D[Keep NPO, IV/enteral support, urgent SALT review]
C -- Yes --> E[Bedside dysphagia screen by trained staff]
E --> F{Pass?}
F -- Yes --> G[Start recommended oral intake + supervision]
F -- No --> H[Keep NPO, give meds by safe route, speech and language assessment]
H --> I[Consider NG feeding if intake delay expected]
G --> J[Monitor for cough, wet voice, fever, poor intake]
I --> J
```
