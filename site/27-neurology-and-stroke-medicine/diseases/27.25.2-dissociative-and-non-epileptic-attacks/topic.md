---
tags: [medicine, neurology, davidson, functional-neurological-disorder, dissociative-attacks, pnes, full-note]
chapter: Neurology
davidson_part: Part 3: Clinical Medicine
davidson_chapter: Chapter 28: Neurology
heading: Functional Neurological Disorder
topic_group: Presentations
topic: Dissociative and non-epileptic attacks
status: full-note
---
...
```mermaid
flowchart TD
A[Seizure-like attack] --> B[Stabilize ABC and exclude acute emergency]
B --> C{Features strongly epileptic?}
C -- Yes --> D[Manage as possible epilepsy/status]
C -- No / uncertain --> E[History + witness + semiology review]
E --> F[Targeted EEG/video-EEG if needed]
F --> G[Positive diagnosis of dissociative attack]
G --> H[Explanation + MDT treatment]
```
