...
```mermaid
mindmap
  root((Stiff Person Syndrome))
    Variants
      Classic SPS
      Partial SPS stiff limb
      Progressive encephalomyelitis with rigidity
    Antibodies
      Anti GAD65 70 percent
        Type 1 diabetes
        Autoimmune thyroid
    ...
    Investigations
      ...
      Anti GAD65 titre very high
      Anti amphiphysin if cancer suspected
      MRI brain spine
      CSF OCB
      PET CT if amphiphysin
      Mammogram CT chest
    Management
      Diazepam first line
      Baclofen add on
