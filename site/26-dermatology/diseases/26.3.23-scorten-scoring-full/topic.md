...
SCORTEN (Score of Toxic Epidermal Necrolysis) is a 7-item prognostic score for SJS/TEN that predicts mortality. Calculated within 24 hours of admission. Each parameter scores 1 point. Total 0-7. Higher score = higher mortality. Used to guide management (e.g., transfer to burns unit) and counsel patients/families.

## Clinical Features and Presentation

SCORTEN scoring presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| BSA detached | ≥10% (1 point) |
| BUN | ≥28 mg/dL or ≥10 mmol/L (1 point) |
| Glucose | ≥252 mg/dL or ≥14 mmol/L (1 point) |
| Bicarbonate | Less than 20 mEq/L (1 point) |
| Score 0-1 | Mortality 3% |
| Score 2 | Mortality 12% |
| Score 3 | Mortality 35% |
| Score 4 | Mortality 58% |
| Score ≥5 | Mortality 90% |
| Use | Prognostication, transfer decision, family counselling |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| N/A | It's a scoring system |

## Viva Questions

1. **Q:** Define SCORTEN scoring and outline its classification.
   **A:** SCORTEN (Score of Toxic Epidermal Necrolysis) is a 7-item prognostic score for SJS/TEN that predicts mortality. Calculated within 24 hours of admission. Each parameter scores 1 point. Total 0-7. Highe

2. **Q:** What are the key clinical features of SCORTEN scoring?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of SCORTEN scoring.
...
1. **SCORTEN** = Age ≥40, Malignancy, HR ≥120, BSA ≥10%, BUN ≥28, Glucose ≥252, Bicarb <20
...
| **Topic** | **SCORTEN scoring** |
|-----------|-----------|
| **Definition** | SCORTEN (Score of Toxic Epidermal Necrolysis) is a 7-item prognostic score for SJS/TEN that predicts |
| **Key Features** | ≥40 years (1 point) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of SCORTEN scoring?
   A. ≥40 years (1 point)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Age: ≥40 years (1 point)*
2. **Q:** What is the first-line treatment for SCORTEN scoring?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for SCORTEN scoring?
...
4. **Q:** What is the most important complication of SCORTEN scoring?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of SCORTEN scoring?
   A. Prognostication, transfer decision, family counselling
...
## SBA Questions (5)
1. **Scenario:** Patient with SCORTEN scoring; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** SCORTEN scoring failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of SCORTEN scoring?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for SCORTEN scoring?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in SCORTEN scoring?
   A. Prognostication, transfer decision, family counselling
...
- **Q:** Key fact about SCORTEN scoring?
  **A:** ≥40 years (1 point)
- **Q:** Another key point?
  **A:** Yes (1 point)
...
- **Q:** Key histological/serological feature?
  **A:** ≥28 mg/dL or ≥10 mmol/L (1 point)

## Answer Key with Explanations

### MCQs
1. **A** — Age: ≥40 years (1 point)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Use: Prognostication, transfer decision, family counselling
...
5. **A** — Prognostication, transfer decision, family counselling
