...
topic: Rothmund-Thomson syndrome
...
Rothmund-Thomson syndrome (RTS) is a rare autosomal recessive disorder due to RECQL4 mutation (helicase). Features: poikiloderma (triad: photosensitive rash in infancy → telangiectasia, atrophy, hyper/hypopigmentation), short stature, skeletal abnormalities (radial ray defects, absent thumbs), juvenile cataracts, increased risk of osteosarcoma and skin cancers (BCC, SCC). Treatment: sun protection, surveillance for malignancy, orthopaedic management.

## Clinical Features and Presentation

Rothmund-Thomson syndrome presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Gene | RECQL4 (helicase) |
| Poikiloderma | Photosensitive rash in infancy → telangiectasia, atrophy, pigment changes |
| Site | Face (butterfly), extensor limbs |
| Skeletal | Radial ray defects, absent thumbs, short stature |
| Eye | Juvenile cataracts (50%) |
| Cancer | Osteosarcoma (30x), BCC, SCC |
| Treatment | Sun protection, surveillance, orthopaedic |
| Differential | Bloom (BLM, no poikiloderma), Werner, Cockayne |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Bloom syndrome | Different gene, no poikiloderma |

## Viva Questions

1. **Q:** Define Rothmund-Thomson syndrome and outline its classification.
   **A:** Rothmund-Thomson syndrome (RTS) is a rare autosomal recessive disorder due to RECQL4 mutation (helicase). Features: poikiloderma (triad: photosensitive rash in infancy → telangiectasia, atrophy, hyper

2. **Q:** What are the key clinical features of Rothmund-Thomson syndrome?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Rothmund-Thomson syndrome.
...
| **Topic** | **Rothmund-Thomson syndrome** |
|-----------|-----------|
| **Definition** | Rothmund-Thomson syndrome (RTS) is a rare autosomal recessive disorder due to RECQL4 mutation (helic |
| **Key Features** | RECQL4 (helicase) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Rothmund-Thomson syndrome?
   A. RECQL4 (helicase)
   ...
   **Answer: A**
2. **Q:** What is the first-line treatment for Rothmund-Thomson syndrome?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Rothmund-Thomson syndrome?
...
5. **Q:** What is the key histological/serological feature?
   A. Bloom (BLM, no poikiloderma), Werner, Cockayne
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Rothmund-Thomson syndrome; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Rothmund-Thomson syndrome?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Rothmund-Thomson syndrome?
   A. Bloom (BLM, no poikiloderma), Werner, Cockayne
...
- **Q:** Key fact about Rothmund-Thomson syndrome?
  **A:** RECQL4 (helicase)
- **Q:** Another key point?
  **A:** Photosensitive rash in infancy → telangiectasia, atrophy, pigment changes
- **Q:** Most important complication?
  **A:** Face (butterfly), extensor limbs
- **Q:** First-line treatment?
  **A:** Radial ray defects, absent thumbs, short stature
- **Q:** Key histological/serological feature?
  **A:** Juvenile cataracts (50%)

## Answer Key with Explanations

### MCQs
1. **A** — Gene: RECQL4 (helicase)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Differential: Bloom (BLM, no poikiloderma), Werner, Cockayne
...
5. **A** — Bloom (BLM, no poikiloderma), Werner, Cockayne
