...
heading: Emergencies
topic: Acute flares of autoimmune bullous disease
...
Acute flares of autoimmune bullous diseases (BP, PV, EBA, MMP) are dermatological emergencies with rapid blistering, extensive skin loss, risk of infection, fluid/electrolyte imbalance, and high mortality. Pemphigus vulgaris (PV) mortality 5-15%; bullous pemphigoid (BP) mortality 10-30% (elderly, comorbidity). Treatment: STOP any triggering drugs, hospital admission (burns unit for extensive), supportive care, high-dose systemic steroids (prednisolone 0.5-1mg/kg/day, IV methylpred for severe), steroid-sparing agents (azathioprine, mycophenolate, methotrexate, cyclophosphamide, rituximab [PV first-line], IVIG, dapsone, doxycycline [BP]). Topical clobetasol (BP first-line per BLISTER trial).

## Clinical Features and Presentation

Acute flares of autoimmune bullous disease presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| PV | Mortality 5-15%; rituximab first-line (RITUX 3 trial) |
| BP | Mortality 10-30% (elderly); topical clobetasol first-line (BLISTER) |
| MMP | Scarring, ocular; dapsone, immunosuppression |
| EBA | Difficult; colchicine, dapsone, IVIG, rituximab |
| Treatment | Stop triggers; supportive; high-dose steroids; steroid-sparing |
| Steroid-sparing | Azathioprine, MMF, MTX, cyclophosphamide, rituximab, IVIG, dapsone, doxycycline |
| Rituximab | PV first-line (NICE; RITUX 3) |
| Topical clobetasol | BP first-line (BLISTER); potent topical steroid |
| Complications | Infection, fluid/electrolyte, mortality |
...
1. **Q:** Define Acute flares of autoimmune bullous disease and outline its classification.
   **A:** Acute flares of autoimmune bullous diseases (BP, PV, EBA, MMP) are dermatological emergencies with rapid blistering, extensive skin loss, risk of infection, fluid/electrolyte imbalance, and high morta

2. **Q:** What are the key clinical features of Acute flares of autoimmune bullous disease?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Acute flares of autoimmune bullous disease.
...
| **Topic** | **Acute flares of autoimmune bullous disease** |
|-----------|-----------|
| **Definition** | Acute flares of autoimmune bullous diseases (BP, PV, EBA, MMP) are dermatological emergencies with r |
| **Key Features** | Mortality 5-15%; rituximab first-line (RITUX 3 trial) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Acute flares of autoimmune bullous disease?
   A. Mortality 5-15%; rituximab first-line (RITUX 3 trial)
...
5. **Q:** Key histological/serological feature?
   A. Infection, fluid/electrolyte, mortality
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Acute flares of autoimmune bullous disease?
  **A:** Mortality 5-15%; rituximab first-line (RITUX 3 trial)
- **Q:** Another key point?
  **A:** Mortality 10-30% (elderly); topical clobetasol first-line (BLISTER)
- **Q:** Most important complication?
  **A:** Scarring, ocular; dapsone, immunosuppression
- **Q:** First-line treatment?
  **A:** Difficult; colchicine, dapsone, IVIG, rituximab
- **Q:** Key histological/serological feature?
  **A:** Stop triggers; supportive; high-dose steroids; steroid-sparing

## Answer Key with Explanations

### MCQs
1. **A** — PV: Mortality 5-15%; rituximab first-line (RITUX 3 trial)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Complications: Infection, fluid/electrolyte, mortality
...
5. **A** — Infection, fluid/electrolyte, mortality
