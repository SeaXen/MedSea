...
topic: Drug-induced pseudoporphyria
...
Drug-induced pseudoporphyria is a photodistributed bullous disorder identical to PCT but with normal porphyrins. Most common drug cause: NSAIDs (naproxen, ibuprofen, ketoprofen). Other drugs: tetracyclines, furosemide, voriconazole, retinoids. Chronic renal failure and haemodialysis are also causes. Resolves with drug withdrawal.

## Clinical Features and Presentation

Drug-induced pseudoporphyria presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Most common drug | NSAIDs (naproxen most common) |
| Other drugs | Tetracyclines, furosemide, voriconazole, retinoids |
| Renal failure | Common non-drug cause |
| Porphyrins | Normal (key distinguishing from PCT) |
| Clinical | Identical to PCT: photosensitivity, fragility, bullae on dorsum hands, milia |
| Histology | Subepidermal bullae with festooning |
| Treatment | Stop drug; sun protection; N-acetylcysteine |
| Differential | PCT (elevated uroporphyrins), EBA, BP |
| Resolution | Weeks-months after drug withdrawal |
| Voriconazole | Strong association (chronic use) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| PCT | Elevated uroporphyrins in urine |

## Viva Questions

1. **Q:** Define Drug-induced pseudoporphyria and outline its classification.
   **A:** Drug-induced pseudoporphyria is a photodistributed bullous disorder identical to PCT but with normal porphyrins. Most common drug cause: NSAIDs (naproxen, ibuprofen, ketoprofen). Other drugs: tetracyc

2. **Q:** What are the key clinical features of Drug-induced pseudoporphyria?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Drug-induced pseudoporphyria.
...
1. **Pseudoporphyria drugs** = NSAIDs (naproxen), tetracyclines, voriconazole, furosemide
...
| **Topic** | **Drug-induced pseudoporphyria** |
|-----------|-----------|
| **Definition** | Drug-induced pseudoporphyria is a photodistributed bullous disorder identical to PCT but with normal |
| **Key Features** | NSAIDs (naproxen most common) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Drug-induced pseudoporphyria?
   A. NSAIDs (naproxen most common)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Most common drug: NSAIDs (naproxen most common)*
2. **Q:** What is the first-line treatment for Drug-induced pseudoporphyria?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Drug-induced pseudoporphyria?
...
4. **Q:** What is the most important complication of Drug-induced pseudoporphyria?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Drug-induced pseudoporphyria?
   A. Strong association (chronic use)
...
## SBA Questions (5)
1. **Scenario:** Patient with Drug-induced pseudoporphyria; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Drug-induced pseudoporphyria failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Drug-induced pseudoporphyria?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Drug-induced pseudoporphyria?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Drug-induced pseudoporphyria?
   A. Strong association (chronic use)
...
- **Q:** Key fact about Drug-induced pseudoporphyria?
  **A:** NSAIDs (naproxen most common)
- **Q:** Another key point?
  **A:** Tetracyclines, furosemide, voriconazole, retinoids
- **Q:** Most important complication?
  **A:** Common non-drug cause
- **Q:** First-line treatment?
  **A:** Normal (key distinguishing from PCT)
- **Q:** Key histological/serological feature?
  **A:** Identical to PCT: photosensitivity, fragility, bullae on dorsum hands, milia

## Answer Key with Explanations

### MCQs
1. **A** — Most common drug: NSAIDs (naproxen most common)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Voriconazole: Strong association (chronic use)
...
5. **A** — Strong association (chronic use)
