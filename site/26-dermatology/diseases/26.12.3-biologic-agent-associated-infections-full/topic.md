...
topic: Biologic agent-associated infections
...
Biologic agents (anti-TNF, anti-IL17/23, anti-IL4/13, rituximab) increase risk of infections, especially reactivation (TB, hepatitis B) and opportunistic (PJP, fungal, viral). Anti-TNF: TB reactivation (screening IGRA), HBV reactivation, fungal (histoplasmosis, coccidioidomycosis), PJP. Rituximab: HBV reactivation, PML (rare), hypogammaglobulinaemia. IL-17 inhibitors: mucocutaneous candidiasis. Pre-biologic screening: TB, hepatitis B/C, HIV, baseline FBC, LFT, chest X-ray. Monitoring during treatment: signs of infection.

## Clinical Features and Presentation

Biologic agent-associated infections presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Anti-TNF | TB reactivation, HBV, fungal (histoplasma), PJP |
| Rituximab | HBV reactivation, PML, hypogammaglobulinaemia |
| Anti-IL17 | Mucocutaneous candidiasis |
| Anti-IL4/13 (dupilumab) | Conjunctivitis, eosinophilia (rare) |
| Anti-IL23 | Generally low infection risk |
| Screening | TB (IGRA), hepatitis B/C, HIV, FBC, LFT, CXR |
| Monitoring | Watch for infection; PJP prophylaxis if high risk |
| JAK inhibitors | Herpes zoster (shingrix before), BK virus |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Disease flare vs infection | Often difficult clinically |

## Viva Questions

1. **Q:** Define Biologic agent-associated infections and outline its classification.
   **A:** Biologic agents (anti-TNF, anti-IL17/23, anti-IL4/13, rituximab) increase risk of infections, especially reactivation (TB, hepatitis B) and opportunistic (PJP, fungal, viral). Anti-TNF: TB reactivatio

2. **Q:** What are the key clinical features of Biologic agent-associated infections?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Biologic agent-associated infections.
...
| **Topic** | **Biologic agent-associated infections** |
|-----------|-----------|
| **Definition** | Biologic agents (anti-TNF, anti-IL17/23, anti-IL4/13, rituximab) increase risk of infections, especi |
| **Key Features** | TB reactivation, HBV, fungal (histoplasma), PJP |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Biologic agent-associated infections?
   A. TB reactivation, HBV, fungal (histoplasma), PJP
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Biologic agent-associated infections?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Biologic agent-associated infections?
...
5. **Q:** What is the key histological/serological feature?
   A. Herpes zoster (shingrix before), BK virus
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Biologic agent-associated infections; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Biologic agent-associated infections?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Biologic agent-associated infections?
   A. Herpes zoster (shingrix before), BK virus
...
- **Q:** Key fact about Biologic agent-associated infections?
  **A:** TB reactivation, HBV, fungal (histoplasma), PJP
- **Q:** Another key point?
  **A:** HBV reactivation, PML, hypogammaglobulinaemia
- **Q:** Most important complication?
  **A:** Mucocutaneous candidiasis
- **Q:** First-line treatment?
  **A:** Conjunctivitis, eosinophilia (rare)
- **Q:** Key histological/serological feature?
  **A:** Generally low infection risk

## Answer Key with Explanations

### MCQs
1. **A** — Anti-TNF: TB reactivation, HBV, fungal (histoplasma), PJP
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — JAK inhibitors: Herpes zoster (shingrix before), BK virus
...
5. **A** — Herpes zoster (shingrix before), BK virus
