...
heading: Emergencies
topic: Sweet syndrome (acute febrile neutrophilic dermatosis)
...
Sweet syndrome (acute febrile neutrophilic dermatosis) is a paraneoplastic or reactive neutrophilic dermatosis with abrupt onset of tender, erythematous, well-demarcated papules, plaques, or nodules, with fever, leucocytosis with neutrophilia, and characteristic dense dermal neutrophilic infiltrate on biopsy. Associations: malignancy (AML, MDS, solid), IBD, infection (URTI, GI), drugs (G-CSF, ATRA, TMP-SMX, OCP), pregnancy, autoimmune. Treatment: systemic corticosteroids (prednisolone 0.5-1mg/kg 2-4w then taper), potassium iodide, colchicine, dapsone, ciclosporin. Often dramatic response to steroids.

## Clinical Features and Presentation

Sweet syndrome (acute febrile neutrophilic dermatosis) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Type | Acute febrile neutrophilic dermatosis |
| Lesion | Tender, erythematous, well-demarcated papules/plaques/nodules |
| Systemic | Fever, leucocytosis with neutrophilia |
| Associations | Malignancy (AML, MDS), IBD, infection, drugs (G-CSF, ATRA, TMP-SMX, OCP), pregnancy |
| Histology | Dense dermal neutrophilic infiltrate, no vasculitis |
| Diagnosis | 2 major + 2 minor (both major = typical; classic = both major + 2 minor) |
| Major | Abrupt onset tender erythematous plaques/nodules; histology neutrophilic infiltrate |
| Minor | Fever >38; association (malignancy, IBD, pregnancy, drug, infection); excellent steroid response; abnormal labs (ESR, CRP, leucocytes); 3 of 4: ESR >20, CRP elevated, leucocytes >8, neutrophils >70% |
| Treatment | Systemic steroids 0.5-1mg/kg 2-4w; colchicine, dapsone, KI |
| Malignancy | Screen: FBC, blood film, age-appropriate |
...
1. **Q:** Define Sweet syndrome (acute febrile neutrophilic dermatosis) and outline its classification.
   **A:** Sweet syndrome (acute febrile neutrophilic dermatosis) is a paraneoplastic or reactive neutrophilic dermatosis with abrupt onset of tender, erythematous, well-demarcated papules, plaques, or nodules, 

2. **Q:** What are the key clinical features of Sweet syndrome (acute febrile neutrophilic dermatosis)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Sweet syndrome (acute febrile neutrophilic dermatosis).
...
| **Topic** | **Sweet syndrome (acute febrile neutrophilic dermatosis)** |
|-----------|-----------|
| **Definition** | Sweet syndrome (acute febrile neutrophilic dermatosis) is a paraneoplastic or reactive neutrophilic  |
| **Key Features** | Acute febrile neutrophilic dermatosis |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Sweet syndrome (acute febrile neutrophilic dermatosis)?
...
5. **Q:** Key histological/serological feature?
   A. Screen: FBC, blood film, age-appropriate
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Sweet syndrome (acute febrile neutrophilic dermatosis)?
  **A:** Acute febrile neutrophilic dermatosis
- **Q:** Another key point?
  **A:** Tender, erythematous, well-demarcated papules/plaques/nodules
- **Q:** Most important complication?
  **A:** Fever, leucocytosis with neutrophilia
- **Q:** First-line treatment?
  **A:** Malignancy (AML, MDS), IBD, infection, drugs (G-CSF, ATRA, TMP-SMX, OCP), pregnancy
- **Q:** Key histological/serological feature?
  **A:** Dense dermal neutrophilic infiltrate, no vasculitis

## Answer Key with Explanations

### MCQs
1. **A** — Type: Acute febrile neutrophilic dermatosis
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Malignancy: Screen: FBC, blood film, age-appropriate
...
5. **A** — Screen: FBC, blood film, age-appropriate
