...
Neurofibromatosis type 1 (NF1, von Recklinghausen) is an autosomal dominant neurocutaneous disorder due to NF1 mutation (chromosome 17q11.2, neurofibromin). Diagnosis (≥2 criteria): ≥6 café-au-lait macules (CALMs, >5mm prepubertal, >15mm postpubertal), ≥2 neurofibromas or 1 plexiform, axillary/inguinal freckling (Crowe sign), optic pathway glioma, ≥2 Lisch nodules (iris hamartomas), distinctive osseous lesion (sphenoid dysplasia, tibial pseudoarthrosis), first-degree relative. Increased risk: MPNST (malignant peripheral nerve sheath tumour), pheochromocytoma, scoliosis, hypertension, learning difficulties.

## Clinical Features and Presentation

Neurofibromatosis type 1 presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| CALMs | ≥6 (>5mm prepubertal, >15mm postpubertal) |
| Neurofibromas | Cutaneous (soft fleshy papules/nodules) and plexiform (bag of worms, deeper) |
| Crowe | Axillary/inguinal freckling (pathognomonic) |
| Lisch | Iris hamartomas (slit lamp) |
| Optic glioma | Optic pathway glioma (visual loss) |
| Skeletal | Sphenoid dysplasia, tibial pseudoarthrosis, scoliosis |
| MPNST | Malignant peripheral nerve sheath tumour; pain, rapid growth, neurological deficit |
| Pheochromocytoma | 1-5%; hypertension |
| Surveillance | Annual BP, ophthalmology, neuro exam; MRI for symptoms |
| Treatment | Selumetinib (MEK inhibitor) for inoperable plexiform; surgery for symptomatic |
...
1. **Q:** Define Neurofibromatosis type 1 and outline its classification.
   **A:** Neurofibromatosis type 1 (NF1, von Recklinghausen) is an autosomal dominant neurocutaneous disorder due to NF1 mutation (chromosome 17q11.2, neurofibromin). Diagnosis (≥2 criteria): ≥6 café-au-lait ma

2. **Q:** What are the key clinical features of Neurofibromatosis type 1?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Neurofibromatosis type 1.
...
| **Topic** | **Neurofibromatosis type 1** |
|-----------|-----------|
| **Definition** | Neurofibromatosis type 1 (NF1, von Recklinghausen) is an autosomal dominant neurocutaneous disorder  |
| **Key Features** | NF1 (neurofibromin, 17q11.2) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Neurofibromatosis type 1?
   A. NF1 (neurofibromin, 17q11.2)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Neurofibromatosis type 1?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Neurofibromatosis type 1?
...
5. **Q:** What is the key histological/serological feature?
   A. Selumetinib (MEK inhibitor) for inoperable plexiform; surgery for symptomatic
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Neurofibromatosis type 1; first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Neurofibromatosis type 1?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Neurofibromatosis type 1?
   A. Selumetinib (MEK inhibitor) for inoperable plexiform; surgery for symptomatic
...
- **Q:** Key fact about Neurofibromatosis type 1?
  **A:** NF1 (neurofibromin, 17q11.2)
- **Q:** Another key point?
  **A:** ≥6 (>5mm prepubertal, >15mm postpubertal)
- **Q:** Most important complication?
  **A:** Cutaneous (soft fleshy papules/nodules) and plexiform (bag of worms, deeper)
- **Q:** First-line treatment?
  **A:** Axillary/inguinal freckling (pathognomonic)
- **Q:** Key histological/serological feature?
  **A:** Iris hamartomas (slit lamp)

## Answer Key with Explanations

### MCQs
1. **A** — Gene: NF1 (neurofibromin, 17q11.2)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Treatment: Selumetinib (MEK inhibitor) for inoperable plexiform; surgery for symptomatic
...
5. **A** — Selumetinib (MEK inhibitor) for inoperable plexiform; surgery for symptomatic
