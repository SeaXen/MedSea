...
heading: Emergencies
topic: Anaphylaxis with cutaneous involvement
...
Anaphylaxis is a severe, life-threatening, systemic hypersensitivity reaction with rapid onset (minutes-hours). Features: skin/mucosal (urticaria, angioedema, flushing), respiratory (wheeze, stridor, hoarseness, dyspnoea), cardiovascular (hypotension, syncope, shock), GI (vomiting, abdominal pain, incontinence). Common triggers: foods (peanut, nuts, shellfish, milk, egg), drugs (antibiotics, NSAIDs, anaesthetics), insect stings (bee, wasp), latex, exercise, idiopathic. Treatment: IM adrenaline (epinephrine 0.5 mg = 0.5 mL of 1:1000) into anterolateral thigh, repeat every 5-15 min, oxygen, IV fluids, antihistamines (H1 ± H2), corticosteroids (slow onset, 4-6h), bronchodilators. Observation 4-24h (biphasic risk 1-20%). Discharge with adrenaline auto-injector (EpiPen), allergy referral.

## Clinical Features and Presentation

Anaphylaxis with cutaneous involvement presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Definition | Severe, life-threatening, rapid onset systemic HS |
| Triggers | Foods (peanut), drugs (antibiotics, NSAIDs), stings, latex |
| Skin | Urticaria, angioedema, flushing |
| Respiratory | Wheeze, stridor, hoarseness, dyspnoea |
| CV | Hypotension, syncope, shock |
| Treatment | IM adrenaline 0.5mg (0.5mL of 1:1000) anterolateral thigh |
| Repeat | Every 5-15 min if needed |
| Adjunct | O2, IV fluids, antihistamines (H1, H2), steroids, bronchodilators |
| Biphasic | 1-20% risk; observe 4-24h |
| Discharge | EpiPen, allergy referral |
...
1. **Q:** Define Anaphylaxis with cutaneous involvement and outline its classification.
   **A:** Anaphylaxis is a severe, life-threatening, systemic hypersensitivity reaction with rapid onset (minutes-hours). Features: skin/mucosal (urticaria, angioedema, flushing), respiratory (wheeze, stridor, 

2. **Q:** What are the key clinical features of Anaphylaxis with cutaneous involvement?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Anaphylaxis with cutaneous involvement.
...
| **Topic** | **Anaphylaxis with cutaneous involvement** |
|-----------|-----------|
| **Definition** | Anaphylaxis is a severe, life-threatening, systemic hypersensitivity reaction with rapid onset (minu |
| **Key Features** | Severe, life-threatening, rapid onset systemic HS |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Anaphylaxis with cutaneous involvement?
   A. Severe, life-threatening, rapid onset systemic HS
...
- **Q:** Key fact about Anaphylaxis with cutaneous involvement?
  **A:** Severe, life-threatening, rapid onset systemic HS
- **Q:** Another key point?
  **A:** Foods (peanut), drugs (antibiotics, NSAIDs), stings, latex
- **Q:** Most important complication?
  **A:** Urticaria, angioedema, flushing
- **Q:** First-line treatment?
  **A:** Wheeze, stridor, hoarseness, dyspnoea
- **Q:** Key histological/serological feature?
  **A:** Hypotension, syncope, shock

## Answer Key with Explanations

### MCQs
1. **A** — Definition: Severe, life-threatening, rapid onset systemic HS
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Discharge: EpiPen, allergy referral
