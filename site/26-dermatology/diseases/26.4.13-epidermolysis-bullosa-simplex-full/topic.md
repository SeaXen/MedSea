...
Epidermolysis bullosa simplex (EBS) is the mildest form of EB, with blistering at the basal layer (intraepidermal). Caused by mutations in KRT5 or KRT14 (keratin 5/14), leading to cytoskeletal fragility. Most common form of EB. Localised (Weber-Cockayne, palms/soles) and generalised severe (Dowling-Meara, herpetiform) forms.
...
| Category | Key Points |
|----------|------------|
| Inheritance | Mostly autosomal dominant (de novo in 30%) |
| Genes | KRT5 (keratin 5) and KRT14 (keratin 14) |
| Split | Intra-basal layer (intraepidermal) |
| Healing | Without scarring (in most forms) |
| Localised (Weber-Cockayne) | Palms/soles only; worsens in hot weather and with friction |
| Generalised severe (Dowling-Meara) | Herpetiform grouped blisters; nails dystrophy; improves with age |
| Other forms | EB simplex generalised intermediate (Koebner) |
| Electron microscopy | Cytolysis of basal keratinocytes |
| Immunofluorescence antigen mapping | BP180/230 stain roof and floor (markers for level) |
| Management | Avoid friction, cooling; wound care; no specific therapy; genetic counselling |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| EB junctional | More severe, blisters at lamina lucida, mortality in infancy |

## Viva Questions

1. **Q:** Define Epidermolysis bullosa simplex and outline its classification.
   **A:** Epidermolysis bullosa simplex (EBS) is the mildest form of EB, with blistering at the basal layer (intraepidermal). Caused by mutations in KRT5 or KRT14 (keratin 5/14), leading to cytoskeletal fragili

2. **Q:** What are the key clinical features of Epidermolysis bullosa simplex?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Epidermolysis bullosa simplex.
...
1. **EBS types** = Weber-Cockayne localised, Koebner generalised intermediate, Dowling-Meara generalised severe
...
|-----------|---------------|
| **Paediatric** | Often presents at birth or in infancy with friction-induced blisters |

## One-Page Revision Card

| **Topic** | **Epidermolysis bullosa simplex** |
|-----------|-----------|
| **Definition** | Epidermolysis bullosa simplex (EBS) is the mildest form of EB, with blistering at the basal layer (i |
| **Key Features** | Mostly autosomal dominant (de novo in 30%) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Epidermolysis bullosa simplex?
   A. Mostly autosomal dominant (de novo in 30%)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Inheritance: Mostly autosomal dominant (de novo in 30%)*
2. **Q:** What is the first-line treatment for Epidermolysis bullosa simplex?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Epidermolysis bullosa simplex?
...
4. **Q:** What is the most important complication of Epidermolysis bullosa simplex?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Epidermolysis bullosa simplex?
   A. Avoid friction, cooling; wound care; no specific therapy; genetic counselling
...
## SBA Questions (5)
1. **Scenario:** Patient with Epidermolysis bullosa simplex; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Epidermolysis bullosa simplex failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Epidermolysis bullosa simplex?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Epidermolysis bullosa simplex?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Epidermolysis bullosa simplex?
   A. Avoid friction, cooling; wound care; no specific therapy; genetic counselling
...
- **Q:** Key fact about Epidermolysis bullosa simplex?
  **A:** Mostly autosomal dominant (de novo in 30%)
- **Q:** Another key point?
  **A:** KRT5 (keratin 5) and KRT14 (keratin 14)
- **Q:** Most important complication?
  **A:** Intra-basal layer (intraepidermal)
- **Q:** First-line treatment?
  **A:** Without scarring (in most forms)
- **Q:** Key histological/serological feature?
  **A:** Palms/soles only; worsens in hot weather and with friction

## Answer Key with Explanations

### MCQs
1. **A** — Inheritance: Mostly autosomal dominant (de novo in 30%)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Management: Avoid friction, cooling; wound care; no specific therapy; genetic counselling
...
5. **A** — Avoid friction, cooling; wound care; no specific therapy; genetic counselling
