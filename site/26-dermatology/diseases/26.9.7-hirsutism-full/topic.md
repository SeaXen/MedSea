...
Hirsutism is excessive terminal hair growth in androgen-dependent areas (face, chest, back, abdomen) in women. Often a sign of hyperandrogenism (PCOS most common, idiopathic hirsutism, congenital adrenal hyperplasia, androgen-secreting tumour, Cushing's). Modified Ferriman-Gallwey score ≥8 indicates hirsutism. Investigations: testosterone, DHEA-S, androstenedione, 17-OHP, SHBG; PCOS workup. Treatment: combined OCP, spironolactone, finasteride, eflornithine cream, laser/electrolysis.
...
| Category | Key Points |
|----------|------------|
| Definition | Excess terminal hair in androgen-dependent areas (women) |
| Modified Ferriman-Gallwey | Score ≥8 = hirsutism (9 areas) |
| Causes | PCOS (most common, 70-80%), idiopathic, CAH, androgen-secreting tumour, Cushing's, drugs |
| Investigations | Testosterone, DHEA-S, androstenedione, 17-OHP, SHBG, prolactin, TSH |
| PCOS | Hyperandrogenism + anovulation + polycystic ovaries (Rotterdam) |
| Idiopathic | Normal androgens, ethnic variation (Mediterranean, South Asian) |
| Treatment | OCP (anti-androgen, e.g., co-cyprindiol/drospirenone), spironolactone, finasteride, eflornithine, laser/electrolysis |
| Vaniqa | Eflornithine (topical ornithine decarboxylase inhibitor) |
| Investigation | Rapid onset or virilisation: androgen-secreting tumour (ovarian/adrenal) |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Hypertrichosis | Non-androgen dependent, generalised |

## Viva Questions

1. **Q:** Define Hirsutism and outline its classification.
   **A:** Hirsutism is excessive terminal hair growth in androgen-dependent areas (face, chest, back, abdomen) in women. Often a sign of hyperandrogenism (PCOS most common, idiopathic hirsutism, congenital adre

2. **Q:** What are the key clinical features of Hirsutism?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Hirsutism.
...
1. Hirsutism = PCOS + Ferriman-Gallwey + OCP + spironolactone
...
| **Topic** | **Hirsutism** |
|-----------|-----------|
| **Definition** | Hirsutism is excessive terminal hair growth in androgen-dependent areas (face, chest, back, abdomen) |
| **Key Features** | Excess terminal hair in androgen-dependent areas (women) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Hirsutism?
   A. Excess terminal hair in androgen-dependent areas (women)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Definition: Excess terminal hair in androgen-dependent areas (women)*
2. **Q:** What is the first-line treatment for Hirsutism?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Hirsutism?
...
4. **Q:** What is the most important complication of Hirsutism?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Hirsutism?
   A. Rapid onset or virilisation: androgen-secreting tumour (ovarian/adrenal)
...
- **Q:** Key fact about Hirsutism?
  **A:** Excess terminal hair in androgen-dependent areas (women)
- **Q:** Another key point?
  **A:** Score ≥8 = hirsutism (9 areas)
- **Q:** Most important complication?
  **A:** PCOS (most common, 70-80%), idiopathic, CAH, androgen-secreting tumour, Cushing's, drugs
- **Q:** First-line treatment?
  **A:** Testosterone, DHEA-S, androstenedione, 17-OHP, SHBG, prolactin, TSH
- **Q:** Key histological/serological feature?
  **A:** Hyperandrogenism + anovulation + polycystic ovaries (Rotterdam)

## Answer Key with Explanations

### MCQs
1. **A** — Definition: Excess terminal hair in androgen-dependent areas (women)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Investigation: Rapid onset or virilisation: androgen-secreting tumour (ovarian/adrenal)
...
5. **A** — Rapid onset or virilisation: androgen-secreting tumour (ovarian/adrenal)
