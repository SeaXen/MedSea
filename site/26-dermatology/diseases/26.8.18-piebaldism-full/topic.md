...
Piebaldism is a rare autosomal dominant disorder with congenital absence of melanocytes in defined skin areas. Stable, well-demarcated depigmented patches (white forelock in 80-90%, depigmentation of forehead, chest, abdomen, limbs). Caused by KIT mutations. Distinguish from vitiligo (acquired, progressive) and Waardenburg (with hearing loss, heterochromia). No treatment needed; sunscreens, cosmetic cover.

## Clinical Features and Presentation

Piebaldism presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Cause | KIT mutation (autosomal dominant) |
| White forelock | 80-90% (poliosis) |
| Distribution | Midline forehead, chest, abdomen, mid-extremities; spares midline back, hands, feet |
| Stable | Does not change (vs vitiligo progressive) |
| Histology | Absent melanocytes in depigmented areas |
| Differential | Vitiligo (acquired, progressive), Waardenburg (with hearing loss), tuberous sclerosis (ash-leaf) |
| Treatment | Sun protection, cosmetic camouflage; no specific therapy |
| Cancer risk | No increased risk |
| Associated | Occasional café-au-lait, freckling in normal skin |
...
1. **Q:** Define Piebaldism and outline its classification.
   **A:** Piebaldism is a rare autosomal dominant disorder with congenital absence of melanocytes in defined skin areas. Stable, well-demarcated depigmented patches (white forelock in 80-90%, depigmentation of 

2. **Q:** What are the key clinical features of Piebaldism?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Piebaldism.
...
1. **Piebaldism** = White forelock + depigmented patches; KIT mutation
...
| **Topic** | **Piebaldism** |
|-----------|-----------|
| **Definition** | Piebaldism is a rare autosomal dominant disorder with congenital absence of melanocytes in defined s |
| **Key Features** | KIT mutation (autosomal dominant) |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Piebaldism?
   A. KIT mutation (autosomal dominant)
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Cause: KIT mutation (autosomal dominant)*
2. **Q:** What is the first-line treatment for Piebaldism?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Piebaldism?
...
4. **Q:** What is the most important complication of Piebaldism?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Piebaldism?
   A. Occasional café-au-lait, freckling in normal skin
...
- **Q:** Key fact about Piebaldism?
  **A:** KIT mutation (autosomal dominant)
- **Q:** Another key point?
  **A:** 80-90% (poliosis)
- **Q:** Most important complication?
  **A:** Midline forehead, chest, abdomen, mid-extremities; spares midline back, hands, feet
- **Q:** First-line treatment?
  **A:** Does not change (vs vitiligo progressive)
- **Q:** Key histological/serological feature?
  **A:** Absent melanocytes in depigmented areas

## Answer Key with Explanations

### MCQs
1. **A** — Cause: KIT mutation (autosomal dominant)
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Associated: Occasional café-au-lait, freckling in normal skin
...
5. **A** — Occasional café-au-lait, freckling in normal skin
