...
topic: Skin cancers (SCC, BCC, Merkel cell - increased risk)
...
HIV (and other immunocompromised) have increased risk of skin cancers: SCC (most common, more aggressive, more in sun-exposed, transplant/HIV), BCC (slightly increased), Merkel cell carcinoma (markedly increased in HIV, transplant, B-cell lymphoma), melanoma (modestly increased), Kaposi sarcoma (HHV-8). SCC in HIV may be more aggressive, with higher risk of recurrence and metastasis. Treatment: standard (excision, Mohs, photodynamic); prevention: sun protection, ART, regular skin exams.

## Clinical Features and Presentation

Skin cancers (SCC, BCC, Merkel cell - increased risk) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| SCC | Most common, more aggressive in HIV |
| BCC | Slightly increased |
| MCC | Markedly increased (HIV, transplant, CLL) |
| Melanoma | Modestly increased |
| Treatment | Standard + ART |
| Prevention | Sun protection, ART, regular skin exams |
| SCC | Higher risk of recurrence/metastasis in HIV |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| N/A | Histology distinguishes |

## Viva Questions

1. **Q:** Define Skin cancers (SCC, BCC, Merkel cell - increased risk) and outline its classification.
   **A:** HIV (and other immunocompromised) have increased risk of skin cancers: SCC (most common, more aggressive, more in sun-exposed, transplant/HIV), BCC (slightly increased), Merkel cell carcinoma (markedl

2. **Q:** What are the key clinical features of Skin cancers (SCC, BCC, Merkel cell - increased risk)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Skin cancers (SCC, BCC, Merkel cell - increased risk).
...
| **Topic** | **Skin cancers (SCC, BCC, Merkel cell - increased risk)** |
|-----------|-----------|
| **Definition** | HIV (and other immunocompromised) have increased risk of skin cancers: SCC (most common, more aggres |
| **Key Features** | Most common, more aggressive in HIV |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Skin cancers (SCC, BCC, Merkel cell - increased risk)?
   A. Most common, more aggressive in HIV
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**
2. **Q:** What is the first-line treatment for Skin cancers (SCC, BCC, Merkel cell - increased risk)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy?
   ...
   E. Eye exam only
   **Answer: A**
4. **Q:** What is the most important complication of Skin cancers (SCC, BCC, Merkel cell - increased risk)?
...
5. **Q:** What is the key histological/serological feature?
   A. Higher risk of recurrence/metastasis in HIV
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
## SBA Questions (5)
1. **Scenario:** Patient with Skin cancers (SCC, BCC, Merkel cell - increased risk); first-line investigation?
...
2. **Scenario:** Failed topical therapy; next step?
   ...
   **Answer: A**
3. **Scenario:** Complication of Skin cancers (SCC, BCC, Merkel cell - increased risk)?
...
4. **Scenario:** Pre-treatment screening before systemic therapy?
   ...
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Skin cancers (SCC, BCC, Merkel cell - increased risk)?
   A. Higher risk of recurrence/metastasis in HIV
...
- **Q:** Key fact about Skin cancers (SCC, BCC, Merkel cell - increased risk)?
  **A:** Most common, more aggressive in HIV
- **Q:** Another key point?
  **A:** Slightly increased
- **Q:** Most important complication?
  **A:** Markedly increased (HIV, transplant, CLL)
...
### MCQs
1. **A** — SCC: Most common, more aggressive in HIV
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — SCC: Higher risk of recurrence/metastasis in HIV
...
5. **A** — Higher risk of recurrence/metastasis in HIV
