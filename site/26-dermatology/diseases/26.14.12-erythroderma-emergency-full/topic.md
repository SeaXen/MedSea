...
Erythroderma (exfoliative dermatitis) is a dermatological emergency with inflammation and erythema + scaling affecting >90% BSA. Acute or chronic. Causes: pre-existing skin disease (60% — eczema, psoriasis, PRP, pemphigus foliaceus), drugs (10-20% — DRESS, SJS/TEN, morbilliform), malignancy (5-15% — CTCL/Sézary, leukaemia, lymphoma, solid), idiopathic (10-15%). Systemic: fever, chills, lymphadenopathy, high-output cardiac failure (elderly), dehydration, electrolyte imbalance (hypocalcaemia, hypomagnesaemia), hypoalbuminaemia, hypothermia, sepsis, ARDS. Treatment: hospital admission, IV fluids, electrolytes, temperature regulation, emollients, topical steroids, treat underlying cause, monitor for sepsis.

## Clinical Features and Presentation

Erythroderma emergency presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Causes | Eczema, psoriasis, drugs, CTCL, idiopathic |
| Systemic | Hypothermia, dehydration, sepsis, high-output CCF, electrolyte |
| Mortality | 5-40% |
| Admission | Yes |
| Treatment | Supportive: IV fluids, electrolytes, emollients, topical steroids, temperature |
| Investigate | Skin biopsy, bloods, imaging, TCR clonality |
| Specific | Treat underlying cause: drugs (stop, supportive), CTCL (photopheresis, biologics), psoriasis (acitretin, biologics) |
| Complications | Sepsis, CCF, ARDS |
...
1. **Q:** Define Erythroderma emergency and outline its classification.
   **A:** Erythroderma (exfoliative dermatitis) is a dermatological emergency with inflammation and erythema + scaling affecting >90% BSA. Acute or chronic. Causes: pre-existing skin disease (60% — eczema, psor

2. **Q:** What are the key clinical features of Erythroderma emergency?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Erythroderma emergency.
...
| **Topic** | **Erythroderma emergency** |
|-----------|-----------|
| **Definition** | Erythroderma (exfoliative dermatitis) is a dermatological emergency with inflammation and erythema + |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Erythroderma emergency?
...
- **Q:** Key fact about Erythroderma emergency?
  **A:** Erythema + scaling >90% BSA
- **Q:** Another key point?
  **A:** Eczema, psoriasis, drugs, CTCL, idiopathic
- **Q:** Most important complication?
  **A:** Hypothermia, dehydration, sepsis, high-output CCF, electrolyte
...
5. **A** — Complications: Sepsis, CCF, ARDS
