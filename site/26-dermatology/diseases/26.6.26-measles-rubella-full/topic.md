...
Measles (rubeola) is a highly contagious paramyxovirus causing fever, cough, coryza, conjunctivitis (3 C's), Koplik spots (pathognomonic buccal), and maculopapular rash starting face (behind ears) → trunk → limbs. Rubella (German measles) is a togavirus causing mild illness with lymphadenopathy (posterior auricular, suboccipital) and rash (face → trunk). Both vaccine-preventable (MMR).

## Clinical Features and Presentation

Measles, rubella presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Measles | Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash |
| Koplik spots | Pathognomonic: white spots on buccal mucosa |
| Rash | Maculopapular; face (behind ears) → trunk → limbs; becomes confluent |
| Complications | Otitis media, pneumonia, encephalitis, SSPE (years later) |
| Vitamin A | WHO recommends vitamin A supplementation (reduces mortality) |
| Rubella | Togavirus; mild illness, posterior auricular/suboccipital lymphadenopathy, rash |
| Congenital rubella | Maternal infection in 1st trimester → cataracts, deafness, cardiac defects (PDA) |
| MMR vaccine | Live attenuated; 2 doses; 95% effective |
| Pregnancy | Avoid in pregnancy; check rubella IgG before pregnancy |
| Measles outbreak | Low vaccination rates; spread in unvaccinated populations |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Kawasaki disease | Children, fever, conjunctivitis, rash, lymphadenopathy |

## Viva Questions

1. **Q:** Define Measles, rubella and outline its classification.
   **A:** Measles (rubeola) is a highly contagious paramyxovirus causing fever, cough, coryza, conjunctivitis (3 C's), Koplik spots (pathognomonic buccal), and maculopapular rash starting face (behind ears) → t

2. **Q:** What are the key clinical features of Measles, rubella?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Measles, rubella.
...
1. **Measles** = 3 C's + Koplik spots; MMR vaccine
...
| **Topic** | **Measles, rubella** |
|-----------|-----------|
| **Definition** | Measles (rubeola) is a highly contagious paramyxovirus causing fever, cough, coryza, conjunctivitis  |
| **Key Features** | Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Measles, rubella?
   A. Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Measles: Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash*
2. **Q:** What is the first-line treatment for Measles, rubella?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Measles, rubella?
...
4. **Q:** What is the most important complication of Measles, rubella?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Measles, rubella?
   A. Low vaccination rates; spread in unvaccinated populations
...
## SBA Questions (5)
1. **Scenario:** Patient with Measles, rubella; first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Measles, rubella failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Measles, rubella?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Measles, rubella?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Measles, rubella?
   A. Low vaccination rates; spread in unvaccinated populations
...
- **Q:** Key fact about Measles, rubella?
  **A:** Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash
- **Q:** Another key point?
  **A:** Pathognomonic: white spots on buccal mucosa
- **Q:** Most important complication?
  **A:** Maculopapular; face (behind ears) → trunk → limbs; becomes confluent
- **Q:** First-line treatment?
  **A:** Otitis media, pneumonia, encephalitis, SSPE (years later)
- **Q:** Key histological/serological feature?
  **A:** WHO recommends vitamin A supplementation (reduces mortality)

## Answer Key with Explanations

### MCQs
1. **A** — Measles: Paramyxovirus; fever, 3 C's (cough, coryza, conjunctivitis), Koplik spots, rash
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Measles outbreak: Low vaccination rates; spread in unvaccinated populations
...
5. **A** — Low vaccination rates; spread in unvaccinated populations
