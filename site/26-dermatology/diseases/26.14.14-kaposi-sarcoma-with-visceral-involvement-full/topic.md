...
heading: Emergencies
topic: Kaposi sarcoma with visceral involvement
...
Kaposi sarcoma (KS) with visceral involvement (lung, GI, lymph nodes, liver) is a serious complication, especially in epidemic (AIDS) KS, but also classic and iatrogenic. Pulmonary KS: dyspnoea, cough, hypoxaemia, pleural effusions; chest X-ray: perihilar/lower zone infiltrates, nodules. GI KS: bleeding, obstruction, protein-losing enteropathy, perforation. Treatment: ART (HIV-KS first), systemic chemotherapy (liposomal doxorubicin, paclitaxel), immunotherapy (PD-1/PD-L1 inhibitors, anti-CTLA-4), radiotherapy, anti-angiogenic (thalidomide, lenalidomide). Prognosis: visceral KS worse than mucocutaneous.

## Clinical Features and Presentation

Kaposi sarcoma with visceral involvement presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Visceral | Lung (dyspnoea, hypoxaemia), GI (bleeding, obstruction), LN, liver |
| Pulmonary | CXR: perihilar/lower zone infiltrates, nodules |
| GI | Bleeding, obstruction, protein-losing |
| HIV | ART first |
| Systemic | Liposomal doxorubicin, paclitaxel |
| Immunotherapy | Pembrolizumab, nivolumab |
| Anti-angiogenic | Thalidomide, lenalidomide |
| Prognosis | Worse than mucocutaneous KS |
| Monitoring | Chest X-ray, CT, bronchoscopy (lung); endoscopy (GI) |
...
1. **Q:** Define Kaposi sarcoma with visceral involvement and outline its classification.
   **A:** Kaposi sarcoma (KS) with visceral involvement (lung, GI, lymph nodes, liver) is a serious complication, especially in epidemic (AIDS) KS, but also classic and iatrogenic. Pulmonary KS: dyspnoea, cough

2. **Q:** What are the key clinical features of Kaposi sarcoma with visceral involvement?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Kaposi sarcoma with visceral involvement.
...
| **Topic** | **Kaposi sarcoma with visceral involvement** |
|-----------|-----------|
| **Definition** | Kaposi sarcoma (KS) with visceral involvement (lung, GI, lymph nodes, liver) is a serious complicati |
| **Key Features** | Lung (dyspnoea, hypoxaemia), GI (bleeding, obstruction), LN, liver |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Kaposi sarcoma with visceral involvement?
   A. Lung (dyspnoea, hypoxaemia), GI (bleeding, obstruction), LN, liver
...
5. **Q:** Key histological/serological feature?
   A. Chest X-ray, CT, bronchoscopy (lung); endoscopy (GI)
   B. Always normal
   C. Non-specific
   D. Only late
   E. No test
...
- **Q:** Key fact about Kaposi sarcoma with visceral involvement?
  **A:** Lung (dyspnoea, hypoxaemia), GI (bleeding, obstruction), LN, liver
- **Q:** Another key point?
  **A:** CXR: perihilar/lower zone infiltrates, nodules
- **Q:** Most important complication?
  **A:** Bleeding, obstruction, protein-losing
- **Q:** First-line treatment?
  **A:** ART first
- **Q:** Key histological/serological feature?
  **A:** Liposomal doxorubicin, paclitaxel

## Answer Key with Explanations

### MCQs
1. **A** — Visceral: Lung (dyspnoea, hypoxaemia), GI (bleeding, obstruction), LN, liver
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Monitoring: Chest X-ray, CT, bronchoscopy (lung); endoscopy (GI)
...
5. **A** — Chest X-ray, CT, bronchoscopy (lung); endoscopy (GI)
