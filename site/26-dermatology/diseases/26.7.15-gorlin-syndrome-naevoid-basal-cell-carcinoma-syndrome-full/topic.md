# Gorlin syndrome (naevoid basal cell carcinoma syndrome)_full
...
topic: Gorlin syndrome (naevoid basal cell carcinoma syndrome)
...
Gorlin syndrome (naevoid basal cell carcinoma syndrome, NBCCS) is an autosomal dominant disorder with multiple BCCs from young age, palmar/plantar pits, odontogenic keratocysts of jaw, skeletal abnormalities (bifid ribs, frontal bossing, calcified falx cerebri), and macrocephaly. Caused by PTCH1 mutation (sonic hedgehog pathway). BCCs may number in hundreds. Treatment of BCCs: surgical excision, Mohs, photodynamic therapy; vismodegib/sonidegib (smoothened inhibitors) for advanced or many BCCs.

## Clinical Features and Presentation

Gorlin syndrome (naevoid basal cell carcinoma syndrome) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Gene | PTCH1 (Patched 1) — sonic hedgehog pathway |
| BCCs | Multiple from young age; may be hundreds |
| Palmar/plantar pits | Punctate depressions (characteristic) |
| Odontogenic keratocysts | Jaw cysts (mandible) |
| Skeletal | Bifid ribs, frontal bossing, calcified falx cerebri, macrocephaly |
| Medulloblastoma | Increased risk (especially desmoplastic) |
| Treatment of BCCs | Surgical excision, Mohs, PDT; vismodegib/sonidegib (Hedgehog inhibitors) |
| Screening | Annual skin exam, jaw X-ray, brain MRI (medulloblastoma) |
...
|--------------|------------------------|
| Sporadic BCC | Single, older age |

## Viva Questions

1. **Q:** Define Gorlin syndrome (naevoid basal cell carcinoma syndrome) and outline its classification.
   **A:** Gorlin syndrome (naevoid basal cell carcinoma syndrome, NBCCS) is an autosomal dominant disorder with multiple BCCs from young age, palmar/plantar pits, odontogenic keratocysts of jaw, skeletal abnorm

2. **Q:** What are the key clinical features of Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Gorlin syndrome (naevoid basal cell carcinoma syndrome).
...
1. **Gorlin** = PTCH1; multiple BCCs + jaw cysts + palmoplantar pits
...
| **Topic** | **Gorlin syndrome (naevoid basal cell carcinoma syndrome)** |
|-----------|-----------|
| **Definition** | Gorlin syndrome (naevoid basal cell carcinoma syndrome, NBCCS) is an autosomal dominant disorder wit |
| **Key Features** | Autosomal dominant |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   ...
   **Answer: A**  *Inheritance: Autosomal dominant*
2. **Q:** What is the first-line treatment for Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
...
4. **Q:** What is the most important complication of Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   A. Counselling
...
## SBA Questions (5)
1. **Scenario:** Patient with Gorlin syndrome (naevoid basal cell carcinoma syndrome); first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Gorlin syndrome (naevoid basal cell carcinoma syndrome) failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
   A. Counselling
...
- **Q:** Key fact about Gorlin syndrome (naevoid basal cell carcinoma syndrome)?
  **A:** Autosomal dominant
- **Q:** Another key point?
  **A:** PTCH1 (Patched 1) — sonic hedgehog pathway
- **Q:** Most important complication?
  **A:** Multiple from young age; may be hundreds
- **Q:** First-line treatment?
  **A:** Punctate depressions (characteristic)
- **Q:** Key histological/serological feature?
  **A:** Jaw cysts (mandible)

## Answer Key with Explanations

### MCQs
1. **A** — Inheritance: Autosomal dominant
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Genetics: Counselling
