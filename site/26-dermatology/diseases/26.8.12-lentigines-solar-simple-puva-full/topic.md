...
topic: Lentigines (solar, simple, PUVA)
...
Lentigines (singular: lentigo) are benign, well-circumscribed, pigmented macules due to increased melanocytes at the basal layer. Solar lentigines (age spots, liver spots) from chronic UV exposure; simple lentigines (not UV related); PUVA lentigines (PUVA therapy). Distinguished from ephelides (freckles, normal melanocyte number) and melanoma. Treatment: sun protection, cryotherapy, laser (Q-switched), topical lightening.

## Clinical Features and Presentation

Lentigines (solar, simple, PUVA) presents with characteristic features as defined in Davidson 24e Ch 29. The key clinical features are summarised below. The disease is recognised by its morphology, distribution pattern, and course. Severity may be assessed using disease-specific scoring systems where applicable. Always consider the full differential when assessing a patient.
...
| Category | Key Points |
|----------|------------|
| Solar | Age spots, liver spots; UV-induced; sun-exposed sites; older adults |
| Simple | Not UV-related; can occur anywhere; childhood/adult |
| PUVA | From PUVA therapy; persists years after treatment |
| Histology | Increased melanocytes at basal layer; elongated rete ridges |
| Dermoscopy | Uniform pigment network; sharp border; moth-eaten border (solar) |
| Differential | Ephelides (normal melanocytes), lentigo maligna (atypical), melanoma |
| Treatment | Sun protection, cryotherapy, Q-switched laser, topical retinoids |
| Multiple | Noonan syndrome (LEOPARD), Peutz-Jeghers, Carney complex |
| Malignant | No (lentigo simplex); lentigo maligna is melanoma in situ |

## Differential Diagnosis

| Differential | Distinguishing Feature |
|--------------|------------------------|
| Ephelides | Normal melanocyte number, sun-induced |

## Viva Questions

1. **Q:** Define Lentigines (solar, simple, PUVA) and outline its classification.
   **A:** Lentigines (singular: lentigo) are benign, well-circumscribed, pigmented macules due to increased melanocytes at the basal layer. Solar lentigines (age spots, liver spots) from chronic UV exposure; si

2. **Q:** What are the key clinical features of Lentigines (solar, simple, PUVA)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Lentigines (solar, simple, PUVA).
...
1. **Lentigo** = Increased melanocytes; solar/simple/PUVA
...
| **Topic** | **Lentigines (solar, simple, PUVA)** |
|-----------|-----------|
| **Definition** | Lentigines (singular: lentigo) are benign, well-circumscribed, pigmented macules due to increased me |
| **Key Features** | Age spots, liver spots; UV-induced; sun-exposed sites; older adults |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Lentigines (solar, simple, PUVA)?
   A. Age spots, liver spots; UV-induced; sun-exposed sites; older adults
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Solar: Age spots, liver spots; UV-induced; sun-exposed sites; older adults*
2. **Q:** What is the first-line treatment for Lentigines (solar, simple, PUVA)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Lentigines (solar, simple, PUVA)?
...
4. **Q:** What is the most important complication of Lentigines (solar, simple, PUVA)?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Lentigines (solar, simple, PUVA)?
   A. No (lentigo simplex); lentigo maligna is melanoma in situ
...
## SBA Questions (5)
1. **Scenario:** Patient with Lentigines (solar, simple, PUVA); first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Lentigines (solar, simple, PUVA) failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Lentigines (solar, simple, PUVA)?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Lentigines (solar, simple, PUVA)?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Lentigines (solar, simple, PUVA)?
   A. No (lentigo simplex); lentigo maligna is melanoma in situ
...
- **Q:** Key fact about Lentigines (solar, simple, PUVA)?
  **A:** Age spots, liver spots; UV-induced; sun-exposed sites; older adults
- **Q:** Another key point?
  **A:** Not UV-related; can occur anywhere; childhood/adult
- **Q:** Most important complication?
  **A:** From PUVA therapy; persists years after treatment
- **Q:** First-line treatment?
  **A:** Increased melanocytes at basal layer; elongated rete ridges
- **Q:** Key histological/serological feature?
  **A:** Uniform pigment network; sharp border; moth-eaten border (solar)

## Answer Key with Explanations

### MCQs
1. **A** — Solar: Age spots, liver spots; UV-induced; sun-exposed sites; older adults
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Malignant: No (lentigo simplex); lentigo maligna is melanoma in situ
...
5. **A** — No (lentigo simplex); lentigo maligna is melanoma in situ
