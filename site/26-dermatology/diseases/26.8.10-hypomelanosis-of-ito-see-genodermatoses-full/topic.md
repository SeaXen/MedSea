...
topic: Hypomelanosis of Ito (see Genodermatoses)
...
# Hypomelanosis of Ito (see Genodermatoses)
...
Hypomelanosis of Ito (incontinentia pigmenti achromians) is a neurocutaneous syndrome with streaked, whorled, or patchy hypopigmentation following Blaschko's lines, often with associated neurological, musculoskeletal, and ocular abnormalities. Sporadic; chromosomal mosaicism. Pigmentary mosaicism is the predominant feature.
...
| Category | Key Points |
|----------|------------|
| Pattern | Streaked, whorled hypopigmentation along Blaschko's lines |
| Chromosomal mosaicism | Various (X chromosome, autosomes) |
| CNS | Seizures, intellectual disability, autism |
| Musculoskeletal | Asymmetry, scoliosis, limb defects |
| Eye | Coloboma, nystagmus |
| Skin | Bilateral, asymmetric |
| Onset | Birth or early childhood |
| Differential | Vitiligo, incontinentia pigmenti (different stage) |
...
|--------------|------------------------|
| Incontinentia pigmenti | Verrucous/hyperpigmented stages |

## Viva Questions

1. **Q:** Define Hypomelanosis of Ito (see Genodermatoses) and outline its classification.
   **A:** Hypomelanosis of Ito (incontinentia pigmenti achromians) is a neurocutaneous syndrome with streaked, whorled, or patchy hypopigmentation following Blaschko's lines, often with associated neurological,

2. **Q:** What are the key clinical features of Hypomelanosis of Ito (see Genodermatoses)?
   **A:** See the high-yield table above.

3. **Q:** Describe the stepwise management of Hypomelanosis of Ito (see Genodermatoses).
...
1. **Hypomelanosis Ito** = Blaschko lines + CNS/eye/musculoskeletal
...
| **Topic** | **Hypomelanosis of Ito (see Genodermatoses)** |
|-----------|-----------|
| **Definition** | Hypomelanosis of Ito (incontinentia pigmenti achromians) is a neurocutaneous syndrome with streaked, |
| **Key Features** | Streaked, whorled hypopigmentation along Blaschko's lines |
...
## MCQs (5)
1. **Q:** Which of the following is a key feature of Hypomelanosis of Ito (see Genodermatoses)?
   A. Streaked, whorled hypopigmentation along Blaschko's lines
   B. Always self-limiting
   C. Caused by bacterial infection only
   D. Restricted to palms and soles only
   E. No investigation needed
   **Answer: A**  *Pattern: Streaked, whorled hypopigmentation along Blaschko's lines*
2. **Q:** What is the first-line treatment for Hypomelanosis of Ito (see Genodermatoses)?
...
3. **Q:** Which pre-treatment screening is essential before systemic therapy for Hypomelanosis of Ito (see Genodermatoses)?
...
4. **Q:** What is the most important complication of Hypomelanosis of Ito (see Genodermatoses)?
   ...
   E. No complications
   **Answer: A**
5. **Q:** What is the key histological/serological feature of Hypomelanosis of Ito (see Genodermatoses)?
...
## SBA Questions (5)
1. **Scenario:** Patient with Hypomelanosis of Ito (see Genodermatoses); first-line investigation?
   A. Clinical diagnosis ± biopsy if atypical  B. Antibiotics  C. CT  D. None  E. Steroids only
   **Answer: A**
2. **Scenario:** Hypomelanosis of Ito (see Genodermatoses) failed topical therapy; next step?
   A. Phototherapy or systemic  B. More topical  C. Observation  D. Surgery  E. Antifungals
   **Answer: A**
3. **Scenario:** Complication of Hypomelanosis of Ito (see Genodermatoses)?
   A. Secondary infection and complications  B. Malignancy  C. Renal failure  D. Cardiac arrest  E. None
   **Answer: A**
4. **Scenario:** Pre-treatment screening before systemic therapy for Hypomelanosis of Ito (see Genodermatoses)?
   A. TB, hep B/C, HIV  B. Pregnancy  C. ECG  D. None  E. Eye exam
   **Answer: A**
5. **Scenario:** Most characteristic histological finding in Hypomelanosis of Ito (see Genodermatoses)?
   A. Decreased melanin, normal melanocyte count
...
- **Q:** Key fact about Hypomelanosis of Ito (see Genodermatoses)?
  **A:** Streaked, whorled hypopigmentation along Blaschko's lines
- **Q:** Another key point?
  **A:** Various (X chromosome, autosomes)
- **Q:** Most important complication?
  **A:** Seizures, intellectual disability, autism
- **Q:** First-line treatment?
  **A:** Asymmetry, scoliosis, limb defects
- **Q:** Key histological/serological feature?
  **A:** Coloboma, nystagmus

## Answer Key with Explanations

### MCQs
1. **A** — Pattern: Streaked, whorled hypopigmentation along Blaschko's lines
2. **A** — Topical first-line
3. **A** — Pre-biologic screening
4. **A** — Secondary infection most common
5. **A** — Histology: Decreased melanin, normal melanocyte count
...
5. **A** — Decreased melanin, normal melanocyte count
