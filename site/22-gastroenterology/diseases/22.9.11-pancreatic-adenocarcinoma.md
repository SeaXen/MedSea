...
## 14. Non-curative / advanced disease
...
```mermaid
mindmap
  root((Pancreatic Adenocarcinoma))
    Definition
      Exocrine malignant tumor, usually head
    Key Features
      Painless jaundice, weight loss, Courvoisier, new diabetes, back pain
    Diagnosis
      Pancreas protocol CT + CA 19-9 + EUS/FNA
    Management
      Resectable: surgery + adjuvant; Unresectable: chemo/palliation
    Complications
      Biliary/duodenal obstruction, metastasis, cachexia, thrombosis
```
