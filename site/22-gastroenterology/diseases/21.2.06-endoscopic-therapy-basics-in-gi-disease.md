...
## 4. Common High-Yield Indications
...
## 6. Contraindication / Escalation Logic
...
```mermaid
flowchart TD
A[GI lesion/complication] --> B{Amenable to endoscopic therapy?}
B -- Yes --> C[Stabilize + perform targeted therapy]
B -- No --> D[Alternative pathway: surgery/radiology/medical]
C --> E[Check outcome and complications]
```
