...
```mermaid
flowchart TD
A[Dysphagia to solids and liquids] --> B[Consider achalasia]
B --> C[Endoscopy to exclude structural disease]
C --> D[Contrast/manometric confirmation]
D --> E[LES-directed therapy]
```
