...
## 10. Investigations
## 11. Stepwise investigation logic
...
## 18. Drug Interactions / Contraindications / Cautions
### PPI cautions
...
## 22. FCPS/MRCP High-Yield Points
...
```mermaid
flowchart TD
A[Heartburn/regurgitation] --> B{Alarm features?}
B -- Yes --> C[Upper GI endoscopy / urgent evaluation]
B -- No --> D[Empirical PPI + lifestyle advice]
D --> E{Response?}
E -- Yes --> F[Continue then step down to lowest effective therapy]
E -- No --> G[Check adherence and timing]
G --> H{Still symptomatic?}
H -- Yes --> I[Endoscopy +/- reflux testing +/- manometry]
H -- No --> F
```

## 27. Suggested Visuals / Image Notes
...
## 28. One-Minute Revision Prompts
...
## 30. Must Know / Should Know / Nice to Know
### Must Know
- definition
