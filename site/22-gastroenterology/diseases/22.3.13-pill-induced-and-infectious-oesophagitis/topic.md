...
```mermaid
flowchart TD
A[Odynophagia / retrosternal pain] --> B{Recent culprit drug?}
B -- Yes --> C[Pill-induced oesophagitis likely]
B -- No --> D{Immunocompromised?}
D -- Yes --> E[Infectious oesophagitis likely]
D -- No --> F[Consider reflux/other causes and scope if needed]
```
