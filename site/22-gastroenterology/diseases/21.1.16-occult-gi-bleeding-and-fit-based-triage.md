...
## 5. Clinical Clues Suggesting Occult GI Bleeding
...
```mermaid
flowchart TD
A[Occult blood-loss clues] --> B{Major red flags present?}
B -- Yes --> C[Urgent lower-GI / relevant GI evaluation]
B -- No --> D[FIT-based symptomatic triage where appropriate]
D --> E{FIT positive or ongoing concern?}
E -- Yes --> C
E -- No --> F[Reassess clinically if symptoms persist]
```
