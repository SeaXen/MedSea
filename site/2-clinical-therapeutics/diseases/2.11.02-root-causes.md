...
## 2. 2. 🧀 Swiss Cheese Model (Reason, 1990)
...
## 3. 3. ⚡ Active Errors vs Latent Conditions
...
## 4. 4. 👤 Human Factors — Error Taxonomy (Reason)
...
## 5. 5. 🏥 System / Organisational Factors
...
## 6. 6. 🎯 High-Risk Situations (Error Traps)
...
## 7. 7. 🔬 Root Cause Analysis (RCA) Methods

### 1. 1. 5 Whys (Simple, Iterative)
```mermaid
flowchart TD
...
### 1. Short Question (5 marks): *"Swiss Cheese Model and Active vs Latent errors."*
...
### 2. Viva (1 min): *"Nurse gives 10x insulin. 5 Whys analysis?"*
...
### 3. Ward Round (30 sec): *"Junior doctor prescribes NSAID for HF patient. Why? System fix?"*
