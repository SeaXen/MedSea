...
## 2. 2. Definition: "High-Risk Combination"
...
## 3. 3. Mermaid Algorithm — Approach to High-Risk Combo

```mermaid
flowchart TD
    A[Two drugs co-prescribed] --> B{Check BNF/Stockley
is this on
high-risk list?}
...
### 1. 4.1 Warfarin Interactions (Mnemonic: "**WATCH OUT**")
...
### 2. 4.2 DOAC (Direct Oral Anticoagulant) Interactions
...
### 3. 4.3 Immunosuppressant (Ciclosporin, Tacrolimus) Interactions
...
### 4. 4.4 Lithium Interactions (Mnemonic: "**NAT**")
...
### 5. 4.5 Serotonin Syndrome (Mnemonic: "**MAOI + any serotonergic = SS**")
...
### 6. 4.6 QT-Prolonging Combinations (Torsades Risk)
...
### 7. 4.7 Epilepsy Drug Interactions (AEDs)
...
### 8. 4.8 Antiretroviral Interactions
...
### 9. 4.9 Methotrexate High-Risk Combinations
...
### 10. 4.10 Digoxin High-Risk Combinations
