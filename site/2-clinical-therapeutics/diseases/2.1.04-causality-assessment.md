...
## 3. 3. Mermaid Algorithm — Causality Assessment Workflow

```mermaid
flowchart TD
    A[Suspected ADR event] --> B[Comprehensive history
drugs, timeline, symptoms]
    B --> C[Apply causality algorithm
Naranjo OR WHO-UMC OR RUCAM]
    C --> D{Algorithm score?}
...
### 1. 4.1 Naranjo Algorithm (Most Widely Used)
...
### 2. 4.2 WHO-UMC Causality Categories
...
### 3. 4.3 Naranjo vs WHO-UMC vs RUCAM
...
### 4. 4.4 Dechallenge & Rechallenge Definitions
