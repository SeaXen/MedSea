...
## 2. 2. CYP450 Quick Reference Table (EXAM ESSENTIAL)
...
St John's Wort]
    ...
    subgraph CYP2C19
        S3[Clopidogrel (activation)+++
PPIs
Citalopram
Diazepam
Voriconazole]
        I3[Omeprazole/Esomeprazole +++
Fluoxetine
Fluvoxamine
Voriconazole]
        N3[Rifampicin +++
...
## 4. 4. High-Yield Interaction Management Algorithms

### 1. Warfarin + CYP2C9/3A4 Interactions
...
### 2. DOAC + CYP3A4/P-gp Interactions
...
### 3. Tacrolimus / Ciclosporin / Sirolimus / Everolimus + CYP3A4/P-gp Interactions
...
### 4. Simvastatin / Atorvastatin + CYP3A4 Interactions
...
## 5. 5. Clinical Decision-Making Flowcharts

### 1. Warfarin + Antibiotic Prescribing
```mermaid
flowchart TD
