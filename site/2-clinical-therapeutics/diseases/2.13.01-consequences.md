...
## 2. 2. 📊 Major Consequences — Detail

### 1. 1. Adverse Drug Events (ADEs)
| Statistic | Reference |
|----------|-----------|
...
### 3. 3. Cognitive Impairment & Delirium
| Mechanism | Examples |
|-----------|----------|
...
### 6. 6. Prescribing Cascades — **Critical to Recognise**
...
### 8. 8. Functional Decline & Frailty
| Effect | Mechanism |
|--------|-----------|
...
## 6. 6. 🧠 Mind Map (Mermaid)

```mermaid
mindmap
  root((Polypharmacy Consequences))
    ADEs
      5-10% admissions
      30-50% preventable
      +5-10% ADE per drug
    ...
    Falls
      ≥4 drugs ↑ risk
      ≥10 drugs 2x risk
      BZD, Antipsychotics, Opioids, Hypotensives
    Cognitive
      ACB ≥3
      Delirium
    ...
    Prescribing Cascade
      ...
      CCB→oedema→diuretic
      Anticholinergic→constipation→laxative
      Metoclopramide→EPS→levodopa
    Non-Adherence
      Pill burden #1 cause
      >3-4 drugs drops sharply
      Cost, complexity, side effects
    Functional Decline
      ↓ ADL/IADL
      ↓ Mobility, Cognition, Nutrition
      Frailty cycle
    Cost
      Direct healthcare
      Medication cost
...
## 9. 9. 📝 Exam Answer Modes

### 1. Short Question (5 marks): *"List 5 consequences of polypharmacy with mechanisms."*
...
### 2. Viva (1 min): *"What is a prescribing cascade? Give 4 examples."*
