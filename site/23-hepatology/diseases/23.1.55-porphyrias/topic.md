---
tags: [hepatology, inherited_metabolic, porphyrias, acute_porphyria, cutaneous_porphyria, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Porphyrias - classification, acute vs cutaneous, diagnosis (PBG, ALA, porphyrins), management - FCPS/MRCP classic"
see_also: ["Inherited and Metabolic Liver Disease/Wilson Disease", "Inherited and Metabolic Liver Disease/Haemochromatosis", "Inherited and Metabolic Liver Disease/Alpha-1 antitrypsin deficiency", "Acute Liver Failure/Definition and Aetiology"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Haem Biosynthesis Pathway (Key Enzymes)
...
```mermaid
flowchart TD
    A[Suspect Porphyria] --> B{Clinical Picture}
    B -->|Acute Neurovisceral: Abdo pain + Neuropathy + Psychiatric| C[Urinary PBG + ALA + Porphyrins]
    C --> D{PBG ↑↑?}
    D -->|Yes| E[Acute Porphyria: AIP, VP, HCP]
    D -->|No| F[Unlikely Acute Porphyria]
    E --> G[Fecal Porphyrins + Plasma Fluorometry + Erythrocyte Enzymes]
    G --> H{AIP: PBGD Low, Fecal Normal}
    G --> I{VP: Plasma Peak 626nm, Fecal Proto+Copro}
    G --> J{HCP: Fecal Copro III ↑}
    B -->|Cutaneous Photosensitivity| K[Urinary/Fecal Porphyrins + Plasma]
    K --> L{PCT: Urinary Uro↑, Hepato↑, Fecal Isocopro↑}
    K --> M{EPP: RBC Proto↑↑, Plasma Proto↑}
    K --> N{CEP: Urinary Uro I↑↑, RBC Uro↑}
```
...
mindmap
  root((Porphyrias))
    Acute Hepatic
      AIP: PBGD low, PBG/ALA up, fecal normal
      VP: Plasma 626nm, fecal proto+copro, PHOTOSENSITIVITY
      HCP: Fecal copro III up, PHOTOSENSITIVITY
      ADP: ALAD defect, ultra rare
    Cutaneous Hepatic
      PCT: Most common, UROD, Uro up, Venesection/Chloroquine, HCV/Alcohol/Iron
      HEP: UROD homozygous, severe
    Cutaneous Erythropoietic
      EPP: FECH, Childhood pain, RBC proto up, Afamelanotide
      CEP: UROS, Severe, Uro I up
      XLP: ALAS2, X-linked
    Acute Attack Management
      STOP DRUGS
      IV Glucose (suppress ALAS1)
      Haemin 3-4mg/kg x4d (repress ALAS1)
      Supportive
    Acute Attack Management
      STOP DRUGS
      IV Glucose (suppress ALAS1)
