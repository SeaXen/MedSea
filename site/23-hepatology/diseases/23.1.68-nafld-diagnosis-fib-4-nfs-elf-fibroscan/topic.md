---
tags: [hepatology, nafld, nash, diagnosis, fibroscan, elf, fib4, apri, biopsy, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "NAFLD diagnosis - non-invasive fibrosis assessment (FIB-4, NFS, ELF, FibroScan), liver biopsy indications - FCPS/MRCP diagnostic pathway"
see_also: ["Non-Alcoholic Fatty Liver Disease/NAFLD Spectrum (NAFL vs NASH)", "Non-Alcoholic Fatty Liver Disease/NAFLD Risk Factors and Pathophysiology", "Non-Alcoholic Fatty Liver Disease/NAFLD Management (Lifestyle, Pharmacotherapy, Bariatric Surgery)", "Non-Alcoholic Fatty Liver Disease/NAFLD HCC Risk and Surveillance"]
created: 2025-06-13
modified: 2025-06-13
---

# NAFLD Diagnosis: Non-Invasive Fibrosis Assessment & Biopsy
...
## Diagnostic Algorithm (EASL 2024 / AASLD 2023)
...
| Test | Sensitivity (F4) | Specificity (F4) | Best For |
|------|------------------|------------------|----------|
| **FibroScan LSM** | 85-95% | 85-95% | **Best Overall** |
| **FIB-4** | 70-80% | 70-80% | First-Line Screening |
| **NFS** | 75-85% | 75-85% | NAFLD-Specific |
| **ELF** | 85-95% | 85-95% | Best Blood Test |
| **APRI** | 60-75% | 70-85% | Simple, Cheap |
| **Biopsy** | **Gold Standard** | **Gold Standard** | Definitive Diagnosis |

---

## Diagnostic Criteria Summary (EASL 2024 / AASLD 2023)

| Step | Action | Tool |
|------|--------|------|
| **1. Identify Steatosis** | US / MRI-PDFF | US (Sensitivity 85% if >20% fat) |
| **2. Exclude Alternatives** | Alcohol, Viral, Drug, Autoimmune, Genetic | History, Serology |
| **3. Assess Fibrosis Risk** | **FIB-4 First** | <1.3 Low, >2.67 High |
| **4. Second-Line** | FibroScan / ELF | LSM: <8, 8-12, >12 kPa |
| **5. Biopsy (Selective)** | Indeterminate / Atypical / Trial | METAVIR + NAS Score |
...
| **FibroScan LSM** | **<7 F0-F1, 7-9.5 F2, 9.5-12.5 F3, >12.5 F4** |
...
4. **What are the indications for liver biopsy in NAFLD?**
4. **What are the contraindications to liver biopsy?**
5. **What is METAVIR F4?**
5. **What is the difference between CAP and LSM?**
...
| Biopsy in NAFLD | Not Routine — Only if Indeterminate/Atypical/Clinical Trials |
