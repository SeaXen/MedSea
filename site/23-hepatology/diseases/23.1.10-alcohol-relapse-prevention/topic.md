---
tags: [hepatology, dic, dil, drug_induced, alcohol_relapse, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Alcohol relapse prevention - pharmacological (acamprosate, naltrexone, disulfiram, baclofen), psychosocial - FCPS/MRCP essential for ALD management"
see_also: ["Alcoholic Liver Disease/Alcoholic Liver Disease", "Alcoholic Liver Disease/Corticosteroid therapy (prednisolone)", "Alcoholic Liver Disease/Abstinence and nutritional support", "Alcoholic Liver Disease/Alcoholic hepatitis scoring (Maddrey DF, Glasgow, ABIC, Lille)"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Pharmacological Agents for Relapse Prevention
...
```mermaid
mindmap
  root((Alcohol Relapse Prevention))
    Acamprosate
    ...
    Naltrexone
      Craving Reduction
      50mg OD / 380mg IM Monthly
      Contra: Opioids, Acute Hepatitis
      Safe in Child A/B at 50mg
    Disulfiram
      Aversion Therapy
      ALDH Inhibitor
    ...
    Baclofen
      GABA-B Agonist
      Safe in Cirrhosis (Renal)
      10-20mg TDS
      Off-label but Evidence
    Psychosocial
      CBT, MI, AA, CRA
      Essential Adjunct
    Selection Algorithm
      ...
      Liver Disease → Acamprosate/Baclofen
      Opioids → No Naltrexone
```
