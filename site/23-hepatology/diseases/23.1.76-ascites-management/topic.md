---
tags: [hepatology, portal_hypertension, ascites, management, diuretics, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Ascites management with diuretics - spironolactone/furosemide ratio, doses, monitoring - FCPS/MRCP core"
see_also: ["Portal Hypertension and Complications/Ascites diagnosis and SAAG", "Portal Hypertension and Complications/Refractory ascites", "Portal Hypertension and Complications/Spontaneous bacterial peritonitis (SBP)", "Portal Hypertension and Complications/Hepatorenal Syndrome"]
created: 2025-06-13
modified: 2025-06-13
---

# Ascites Management: Diuretics, LVP, TIPS
...
## Diuretic Therapy: Stepwise Approach
...
## Refractory Ascites (ICA Definition)
...
```mermaid
flowchart TD
    A[Refractory Ascites] --> B[Serial LVP + Albumin 8g/L]
    ...
    F --> G{HE or Shunt Failure?}
    G -->|Yes| H[Reduce shunt / TIPS revision / Transplant]
    G -->|No| I[Continue surveillance]
    E --> J[Transplant Evaluation - DEFINITIVE]
```
...
mindmap
  root((Ascites Management))
    ...
    Monitoring
      Weight daily
      Na, K, Cr, Urea weekly
      Target loss 0.5-1 kg/day
    Complications
      Hyponatremia: Fluid restrict, stop furo
      Hyperkalemia: Hold spiro
      AKI: Hold both
      HE: Reduce diuretics
    LVP
      Tense ascites
