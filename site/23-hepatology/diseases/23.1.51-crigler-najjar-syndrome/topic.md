---
tags: [hepatology, inherited_metabolic, crigler_najjar, kernicterus, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Crigler-Najjar syndrome - severe unconjugated hyperbilirubinaemia, kernicterus risk, differentiation from Gilbert - FCPS/MRCP must-know"
see_also: ["Inherited and Metabolic Liver Disease/Gilbert Syndrome", "Inherited and Metabolic Liver Disease/Dubin-Johnson vs Rotor Syndrome", "Jaundice and LFT Interpretation/Isolated hyperbilirubinaemia"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Differential: Crigler-Najjar vs Gilbert
...
mindmap
  root((Crigler-Najjar))
    Type 1
      Null UGT1A1 mutations
      Bilirubin >340
      No phenobarbital response
      Kernicterus HIGH
      Phototherapy lifelong
      Transplant curative
    Type 2 (Arias)
      Missense mutations
      Bilirubin 100-340
      PHENOBARBITAL RESPONDS
      Kernicterus LOW
      Intermittent phototherapy
    Kernicterus
      Acute: Opisthotonus, seizures
      Chronic: Choreoathetosis, gaze palsy, hearing loss
      Risk: Bilirubin >340, prematurity, sepsis, acidosis
    Phototherapy
      Blue light 420-470nm
      Lumirubin + configurational isomers
      Water-soluble excretion
    Differential
      vs Gilbert: Bilirubin level, benign vs severe
      vs Haemolysis: Reticulocyte count
```
