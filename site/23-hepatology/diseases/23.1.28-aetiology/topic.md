---
tags: [hepatology, chronic_liver_disease, cirrhosis, aetiology, alld, nafld, viral, autoimmune, inherited, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Aetiology of cirrhosis - alcohol, viral, NAFLD, autoimmune, genetic - FCPS/MRCP comprehensive aetiological knowledge"
see_also: ["Chronic Liver Disease and Cirrhosis/Definition and classification", "Chronic Liver Disease and Cirrhosis/Compensated vs decompensated cirrhosis", "Alcoholic Liver Disease/Alcoholic Liver Disease", "Viral Hepatitis/Hepatitis B", "Viral Hepatitis/Hepatitis C", "Non-Alcoholic Fatty Liver Disease/Non-Alcoholic Fatty Liver Disease", "Autoimmune Liver Disease/Autoimmune hepatitis (AIH)", "Inherited and Metabolic Liver Disease/Wilson Disease", "Inherited and Metabolic Liver Disease/Haemochromatosis"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Global Aetiological Distribution

```mermaid
pie title Cirrhosis Aetiology (Global Approximate)
    "Alcohol" : 30
    "HCV" : 25
    "HBV" : 20
    "NAFLD/NASH" : 15
    "Autoimmune (AIH/PBC/PSC)" : 5
    "Genetic (Wilson, HH, Alpha-1 AT)" : 3
    "Other (Drug, Cardiac, Cryptogenic)" : 7
```
...
## Major Aetiologies: Diagnostic Features
...
flowchart TD
    ...
    A --> F[Genetic: Wilson, HH, Alpha-1 AT]
    A --> G[Other: Drug, Cardiac, Cryptogenic]
```
...
## Aetiology-Based Cirrhosis Features Summary
