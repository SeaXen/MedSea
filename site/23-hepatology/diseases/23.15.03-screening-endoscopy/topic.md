...
```mermaid
mindmap
  root((Screening Endoscopy))
    Indications
      All New Cirrhosis
      Decompensated = Always
    Baveno VII Rule-Out
      LSM <20 kPa + Plt >150 = No Endoscopy
      High-Risk Varices NPV 97%
      Not for NASH-only
    Variceal Grades
      Grade 1: <5mm
      Grade 2: 5-10mm
    ...
    Prophylaxis Indicated
      Grade 2/3 Always
      Grade 1 + Red Signs/Child C
    Surveillance
      No Varices: Comp 2-3y, Decomp 1-2y
      Grade 1 No Proph: Same
      Post-EVL: 6-12m
      On NSBB: 1-2y
```
