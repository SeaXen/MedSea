---
tags: [hepatology, portal_hypertension, precipitating_factors, hepatic_encephalopathy, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Precipitating factors for HE - infection, bleed, electrolytes, drugs, constipation - FCPS/MRCP common triggers"
see_also: ["Portal Hypertension and Complications/Hepatic Encephalopathy", "Portal Hypertension and Complications/Management (lactulose, rifaximin)", "Portal Hypertension and Complications/Spontaneous bacterial peritonitis (SBP)", "Portal Hypertension and Complications/Acute variceal bleeding management"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Common Precipitating Factors (Frequency Order)
...
## Systematic Approach to Precipitant Identification

```mermaid
flowchart TD
    A[New/Worsening HE] --> B[Identify Precipitants]
    B --> C[History: Drug Changes, Bowel Habits, Bleeding, Fever]
    B --> D[Exam: Fever, Abdominal Signs, Bleeding Stigmata, Asterixis]
    B --> E[Investigations]
    E --> F[FBC, CRP, Blood Cultures]
    E --> G[U&E, LFTs, Coagulation, Ammonia]
    E --> H[ABG, Lactate, Glucose]
    E --> I[Urinalysis, Urine Culture]
    E --> J[Chest X-ray, Ascitic Fluid Analysis if Ascites]
    E --> K[Drug Chart Review]
    F & G & H & I & J & K --> L{Precipitant Identified?}
    L -->|Yes| M[Treat Precipitant + Lactulose/Rifaximin]
    L -->|No| N[Empirical Treatment + Continued Search]
```
...
## FCPS/MRCP "Must-Know" Precipitant List
...
```mermaid
mindmap
  root((HE Precipitants))
    Frequency Order
      Infection: SBP #1 (30-50%)
      GI Bleed #2 (20-30%)
      Electrolytes: K↓, Na↓, Alkalosis (15-20%)
      Constipation #4 (10-15%)
      Drugs: Benzo, Opioid, Diuretic, PPI (10%)
      Renal/HRS (10%)
      Hypoxia (5-10%)
      TIPS Dysfunction (5-10%)
      LVP No Albumin (5-10%)
      Alcohol Binge (5-10%)
    SBCD Mnemonic
      S: Sepsis/SBP
