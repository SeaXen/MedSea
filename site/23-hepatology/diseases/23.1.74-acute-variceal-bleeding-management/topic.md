---
tags: [hepatology, portal_hypertension, acute_variceal_bleed, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Acute variceal bleeding management - resuscitation, vasoactives, endoscopy, antibiotics, TIPS - FCPS/MRCP emergency hepatology"
see_also: ["Portal Hypertension and Complications/Varices", "Portal Hypertension and Complications/Primary prophylaxis (NSBB vs EVL)", "Portal Hypertension and Complications/Secondary prophylaxis", "Portal Hypertension and Complications/Gastric varices (glue injection)"]
created: 2025-06-13
modified: 2025-06-13
---
...
## Post-Bleed Secondary Prophylaxis (Start Day 5-7)
...
```mermaid
mindmap
  root((Acute Variceal Bleed Management))
    Resuscitation (0-6h)
      Airway (Intubate if GCS≤8)
      2 Large-bore IVs
      Hb 7-8 g/dL
      Vasoactives: Terlipressin 2mg q4-6h
      Ceftriaxone 1g IV
    Endoscopy (<12h)
      EVL for oesophageal varices
      Glue for GOV2/IGV1
      Sengstaken if failed (bridge)
    Post-Endoscopy
      Vasoactives 2-5 days
      Ceftriaxone 5-7 days
      Hb 7-8 g/dL
      Monitor Hb, INR, Lactate
    Failure Management
