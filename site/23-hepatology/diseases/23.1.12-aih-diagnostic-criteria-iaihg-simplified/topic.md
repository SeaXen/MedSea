---
tags: [hepatology, autoimmune_liver, aih, iai_gh, criteria, fcps, mrcp]
davidson_chapter: Chapter 24
status: full-fcps-mrcp-note
priority: high
exam_relevance: "AIH diagnostic criteria (simplified IAIHG) - essential for FCPS/MRCP diagnosis and differentiation from other causes"
see_also: ["Autoimmune Liver Disease/Autoimmune hepatitis (AIH)", "Autoimmune Liver Disease/AIH treatment", "Autoimmune Liver Disease/AIH in pregnancy", "Autoimmune Liver Disease/Overlap syndromes", "Acute Liver Failure/Autoimmune hepatitis presenting as ALF"]
created: 2025-06-13
modified: 2025-06-13
---

# AIH Diagnostic Criteria (IAIHG Simplified)
...
## Original IAIHG Criteria (1993, Revised 1999) — For Reference
...
## Autoantibody Patterns: Type 1 vs Type 2
...
## Essential Exclusions (Must Rule Out)
...
## Histopathology: Typical vs Compatible
...
```mermaid
flowchart TD
    A[Suspect AIH: Elevated AST/ALT, Hypergammaglobulinemia, Autoantibodies] --> B[Exclude Viral, Drug, Alcohol, Metabolic]
    B --> C[Check Autoantibodies: ANA, SMA, LKM1, SLA/LP]
    C --> D[Check IgG]
    D --> E[Liver Biopsy if feasible]
    E --> F[Calculate Simplified Score]
    F --> G{Score ≥6?}
    G -->|≥7| H[Definite AIH]
    G -->|6| I[Probable AIH]
    G -->|<6| J[Consider other diagnoses / Repeat testing]
    H --> K[Treat]
    I --> K
```
...
## AIH in Acute Liver Failure (Simplified Criteria Adaptation)
