...
## 4. Why Bowel Preparation Matters
...
## 6. Red Flags / High-Urgency Contexts
...
## 7. Contraindication / Caution Logic
...
## 9. Differential / Clinical Use-Cases
- colorectal cancer
- polyps / adenomas
- IBD / colitis
...
```mermaid
flowchart TD
A[Lower-GI diagnostic question] --> B{Need full colon assessment?}
B -- Yes --> C[Plan colonoscopy]
C --> D[Optimize bowel prep + medication safety]
D --> E[Perform exam / biopsy / therapy]
E --> F{Prep adequate?}
F -- No --> G[Reassess / repeat strategy if needed]
```
