...
## 5. Contraindication / Caution Logic
...
## 6. Preparation / Practical Points
...
## 8. Differential / When Not to Use Reflexively
...
```mermaid
flowchart TD
A[Upper-GI symptoms/problem] --> B{Alarm feature or therapeutic need?}
B -- Yes --> C[Endoscopy indicated]
B -- No --> D[Consider conservative/alternative pathway]
C --> E{Emergency / urgent / elective?}
E --> F[Stabilize first if unstable]
```
