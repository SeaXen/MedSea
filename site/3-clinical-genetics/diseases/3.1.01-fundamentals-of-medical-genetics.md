...
## 2. 2. 🧠 Core Concept: From DNA to Phenotype

```mermaid
flowchart LR
    A[DNA (Gene)] --> B[Transcription
Pre-mRNA]
    B --> C[Splicing
Exons/Introns]
    C --> D[Mature mRNA]
...
## 3. 3. ️⃣ DNA, Genes & Genome Organisation
...
## 4. 4. ️⃣ Chromosome Structure & Analysis
...
## 5. 5. ️⃣ Cell Division & Genetic Variation
...
### 4. Linkage Disequilibrium (LD) & Haplotypes
| Concept | Definition |
|---------|------------|
...
## 8. 8. 🎤 Viva Questions (Expected Answers)
