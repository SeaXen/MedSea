...
davidson_topic_id: "14.1.22"
topic: "Hospital-Acquired and Ventilator-Associated Pneumonia (HAP-VAP)"
...
source: "/mnt/tb/Medicine/Infectious Disease/Hospital-Acquired and Ventilator-Associated Pneumonia (HAP-VAP).md"
...
mindmap
  root((HAP / VAP))
    ...
    MDR Risk Factors
      ...
      Known colonisation
    Diagnosis
      New infiltrate + clinical signs
      Quantitative cultures: BAL ≥10⁴, PSB ≥10³
      CPIS ≥6 supportive
    Empirical Rx
      Low MDR: single β-lactam
      High MDR: Anti-Pseudo β-lactam + Anti-MRSA
    De-escalation (48-72h)
      Negative quant → STOP
      Positive → narrow targeted
      IV→Oral if stable
    Duration
      7 days standard
    VAP Bundle
      HOB 30-45°, Sedation hold+SBT
      Subglottic suction, CHX, Cuff pressure
    Pathogen-Specific
      MRSA: Vanco/Linezolid
      Pseudomonas: Anti-Pseudo β-lactam
      CRE: CAV/MV/IR/Plazomicin
      Acinetobacter: Meropenem/Sulbactam/Polymyxin
