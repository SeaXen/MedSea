---
tags: [hepatology, anaemia, folate, macrocytic, megaloblastic, fcps, mrcp]
davidson_chapter: Chapter 25
status: full-fcps-mrcp-note
priority: high
exam_relevance: "Folate deficiency - common macrocytic anaemia, differs from B12 in neurology, pregnancy importance - FCPS/MRCP high-yield"
see_also: ["Anaemia and Red Cell Disorders/Macrocytic Anaemia", "Anaemia and Red Cell Disorders/Vitamin B12 Deficiency Anaemia", "Anaemia and Red Cell Disorders/Megaloblastic Anaemia", "Inherited and Metabolic Liver Disease/Porphyrias"]
created: 2025-06-14
modified: 2025-06-14
---
...
```mermaid
flowchart TD
    A[Macrocytic Anaemia] --> B[Check B12 & Folate]
    B --> C{B12 Low?}
    C -->|Yes| D[B12 Deficiency]
    C -->|No| E{Folate Low?}
    E -->|Yes| F[Folate Deficiency]
    E -->|No| G[Other Macrocytic Causes]
    C -->|No| H{Folate Low?}
    H -->|Yes| I[Folate Deficiency]
    H -->|No| J[Other Causes: Liver, Alcohol, Drugs, MDS]
```
