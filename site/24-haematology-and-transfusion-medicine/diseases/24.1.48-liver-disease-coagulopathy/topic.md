---
tags: [medicine, davidson, hematology, liver-disease-coagulopathy, cirrhosis, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: High-yield | MRCP: Core | Cirrhosis coagulopathy, balanced haemostasis, PT/INR vs APTT, thrombocytopenia, vitamin K, FFP, TEG/ROTEM"
see_also: "[[Vitamin K Deficiency]], [[DIC]], [[DVT/PE & Cancer-associated Thrombosis]], [[Transfusion Reactions]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
flowchart TD
    A[Liver Disease/Cirrhosis] --> B[↓ Hepatocyte Synthetic Function]
    B --> C1[↓ Pro-coagulant Factors: II, V, VII, IX, X, XI, XII, Fibrinogen]
    B --> C2[↓ Anti-coagulant Factors: Protein C, Protein S, Antithrombin]
    B --> C3[↓ Thrombopoietin → ↓ Platelet Production]
    B --> C4[Portal Hypertension → Splenomegaly → Platelet Sequestration]
    B --> C5[↓ Clearance of Activated Factors/Fibrinolytic Inhibitors]
    C1 & C2 & C3 & C4 & C5 --> D[**Rebalanced Haemostasis**]
    D --> E1[**Bleeding Risk**: Low platelets, Low factors, Abnormal fibrinogen]
    D --> E2[**Thrombosis Risk**: ↓ AT/PC/PS, ↑ Factor VIII, ↑ vWF, Endothelial dysfunction]
    E1 & E2 --> F[**Net Effect: Unpredictable** - Can bleed OR clot]
```
