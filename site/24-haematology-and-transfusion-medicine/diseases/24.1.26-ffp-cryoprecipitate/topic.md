---
tags: [medicine, davidson, hematology, ffp, cryoprecipitate, transfusion, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | FFP indications, dosing, Cryoprecipitate for fibrinogen, factor replacement, MTP, DIC, massive transfusion"
see_also: "[[Red Cell Transfusion]], [[Platelet Transfusion]], [[Massive Transfusion Protocol]], [[DIC]], [[Transfusion Reactions]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
flowchart TD
    A[Warfarin Patient with Bleeding/High INR] --> B{INR & Clinical}
    B -->|**Life-threatening Bleed / Surgery**| C[**PCC 25-50 IU/kg** + **Vitamin K 10mg IV**]
    B -->|**Major Bleed, INR >2**| C
    B -->|**Minor Bleed, INR 2-4**| D[**Vitamin K 1-2mg IV/PO**]
    B -->|**No Bleed, INR 4.5-10**| E[**Vitamin K 2-5mg PO**]
    B -->|**No Bleed, INR >10**| F[**Vitamin K 5-10mg PO** + Consider PCC]
    C --> G[**FFP 15mL/kg ONLY if PCC Unavailable**]
```
...
```mermaid
mindmap
  root((FFP & Cryoprecipitate))
    FFP
      All Factors 100%
      250mL/unit, 4 units adult
      Indications: Warfarin, DIC, MTP, Liver, TTP
      Dose: 15-20mL/kg
    Cryoprecipitate
      Fibrinogen 150-300mg/unit
      Factor VIII, vWF, Factor XIII
      15mL/unit, 1 pool = 10 units
      Indications: Hypofibrinogenaemia, Factor XIII, vWD
    Dosing
      FFP: 4 units = INR ↓15-30%
      Cryo: 1 pool = Fibrinogen ↑1 g/L
    Warfarin Reversal
      PCC 1st Line
      FFP 2nd Line (if no PCC)
      Vit K Always
    MTP
      1:1:1 Ratio
      Add Cryo if Fib <1.5
