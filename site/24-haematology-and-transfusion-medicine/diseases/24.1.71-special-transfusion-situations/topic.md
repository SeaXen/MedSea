---
tags: [medicine, davidson, hematology, transfusion, obstetric, paediatric, sickle-cell, thalassaemia, cell-salvage, apheresis, fcps, mrcp]
davidson_chapter: Chapter 25: Haematology and Transfusion Medicine
status: full-fcps-mrcp-note
priority: high
exam_relevance: "FCPS: Essential | MRCP: Core | Obstetric haemorrhage, neonatal transfusion, sickle cell/thalassaemia exchange, intraoperative cell salvage, apheresis indications"
see_also: "[[Red Cell Transfusion]], [[Platelet Transfusion]], [[Massive Transfusion Protocol]], [[Sickle Cell Disease]], [[Thalassaemia]]"
created: 2025-06-17
modified: 2025-06-17
---
...
```mermaid
mindmap
  root((Special Transfusion Situations))
    Obstetric
      PPH: TXA 1g/3h, Fib>2g/L
      MTP: Cryo in 1st pack
      Cell Salvage: CS>1000mL, Anti-D
    Neonatal/Paediatric
      Top-up: 10-15mL/kg
      Thresholds: Preterm<28w Hb<120-140
      Exchange: 160mL/kg (2x Vol)
      Special: CMV-, Irrad, HbS-, Fresh/Washed
    Sickle Cell
      Simple: Hb 100 (Avoid >110)
      Exchange: HbS<30%, Hb~100
      Chronic: HbS<30%, Hb 90-105
      Pre-op: Low=Simple, High=Exchange
    Thalassaemia
      Pre-tx Hb 90-105, 3-4wk interval
      Iron Chelation: DFO/DFP/DFX
      Extended Matching (Kell, Duffy, Kidd)
    Cell Salvage
      Indications: Cardiac, Ortho, Vascular, Trauma, OB
      Contra: Malignancy, Amniotic Fluid, Sepsis
      Process: Suction → Centrifuge → Wash → Leucodeplete
    Apheresis
      Cat I: TTP, Anti-GBM, Hyperviscosity
      RCE: HbS<30%, Malaria, Babesia
