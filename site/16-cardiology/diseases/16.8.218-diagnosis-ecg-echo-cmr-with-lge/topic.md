...
davidson_topic_id: "16.8.218"
topic: "Diagnosis_ECG_echo_CMR_with_LGE"
...
source: "/mnt/tb/Medicine/Cardiology/09_Cardiomyopathies/Diagnosis_ECG_echo_CMR_with_LGE.md"
tags: [medicine, cardiology, davidson, fcps, mrcp]
---

# Diagnosis ECG echo CMR with LGE
...
**Q1.** What is the most common aetiology of Diagnosis ECG echo CMR with LGE?
...
**Q2.** First-line investigation for Diagnosis ECG echo CMR with LGE:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Diagnosis ECG echo CMR with LGE:
...
**Q4.** Which is a contraindication to therapy in Diagnosis ECG echo CMR with LGE?
A. Renal dysfunction
...
**Q5.** The most common complication of Diagnosis ECG echo CMR with LGE is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Diagnosis ECG echo CMR with LGE. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Diagnosis ECG echo CMR with LGE on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Diagnosis ECG echo CMR with LGE
2. Discuss the pathophysiology of Diagnosis ECG echo CMR with LGE
3. What are the diagnostic criteria for Diagnosis ECG echo CMR with LGE?
4. Outline the management approach to Diagnosis ECG echo CMR with LGE
5. What are the complications and prognosis of Diagnosis ECG echo CMR with LGE?
6. What are the latest guidelines for Diagnosis ECG echo CMR with LGE?
7. How is Diagnosis ECG echo CMR with LGE managed in special populations?
8. Compare Diagnosis ECG echo CMR with LGE with related conditions
...
**File:** Diagnosis_ECG_echo_CMR_with_LGE.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
