...
davidson_topic_id: "16.17.106"
topic: "TAVI_vs_SAVR_risk_scores_heart_team"
...
source: "/mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/TAVI_vs_SAVR_risk_scores_heart_team.md"
...
```mermaid
flowchart TD
    A[Valve Injury: Hemodynamic Stress, Inflammation, Lipid Deposition] --> B[Osteogenic Differentiation]
    B --> C[Calcific Nodule Formation]
    C --> D[Leaflet Stiffening → Outflow Obstruction]
    D --> E[Pressure Overload → LV Hypertrophy]
    E --> F[Diastolic Dysfunction → LA Enlargement]
    F --> G[Symptoms: Angina, Syncope, HF]
    G --> H[Sudden Death Risk if Untreated]
