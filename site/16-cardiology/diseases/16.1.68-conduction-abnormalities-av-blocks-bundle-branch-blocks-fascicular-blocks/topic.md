<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Conduction_abnormalities_AV_blocks_bundle_branch_blocks_fascicular_blocks.md | section: 16.1 | hub: cardiac-investigations -->

# Conduction abnormalities AV blocks bundle branch blocks fascicular blocks
...
**Conduction abnormalities AV blocks bundle branch blocks fascicular blocks**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Conduction abnormalities AV blocks bundle branch blocks fascicular blocks?
...
**Q2.** First-line investigation for Conduction abnormalities AV blocks bundle branch blocks fascicular blocks:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Conduction abnormalities AV blocks bundle branch blocks fascicular blocks:
...
**Q4.** Which is a contraindication to therapy in Conduction abnormalities AV blocks bundle branch blocks fascicular blocks?
A. Renal dysfunction
...
**Q5.** The most common complication of Conduction abnormalities AV blocks bundle branch blocks fascicular blocks is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Conduction abnormalities AV blocks bundle branch blocks fascicular blocks. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Conduction abnormalities AV blocks bundle branch blocks fascicular blocks on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Conduction abnormalities AV blocks bundle branch blocks fascicular blocks
2. Discuss the pathophysiology of Conduction abnormalities AV blocks bundle branch blocks fascicular blocks
3. What are the diagnostic criteria for Conduction abnormalities AV blocks bundle branch blocks fascicular blocks?
4. Outline the management approach to Conduction abnormalities AV blocks bundle branch blocks fascicular blocks
5. What are the complications and prognosis of Conduction abnormalities AV blocks bundle branch blocks fascicular blocks?
6. What are the latest guidelines for Conduction abnormalities AV blocks bundle branch blocks fascicular blocks?
7. How is Conduction abnormalities AV blocks bundle branch blocks fascicular blocks managed in special populations?
8. Compare Conduction abnormalities AV blocks bundle branch blocks fascicular blocks with related conditions
...
**File:** Conduction_abnormalities_AV_blocks_bundle_branch_blocks_fascicular_blocks.md
