<!-- Source: /mnt/tb/Medicine/Cardiology/03_Chronic_Coronary_Syndromes/Coronary_flow_reserve_(CFR),_index_of_microcirculatory_resistance_(IMR).md | section: 16.3 | hub: chronic-coronary-syndromes -->

# Coronary flow reserve , index of microcirculatory resistance
...
**Q1.** What is the most common aetiology of Coronary flow reserve , index of microcirculatory resistance?
...
**Q2.** First-line investigation for Coronary flow reserve , index of microcirculatory resistance:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Coronary flow reserve , index of microcirculatory resistance:
...
**Q4.** Which is a contraindication to therapy in Coronary flow reserve , index of microcirculatory resistance?
A. Renal dysfunction
...
**Q5.** The most common complication of Coronary flow reserve , index of microcirculatory resistance is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Coronary flow reserve , index of microcirculatory resistance. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Coronary flow reserve , index of microcirculatory resistance on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Coronary flow reserve , index of microcirculatory resistance
2. Discuss the pathophysiology of Coronary flow reserve , index of microcirculatory resistance
3. What are the diagnostic criteria for Coronary flow reserve , index of microcirculatory resistance?
4. Outline the management approach to Coronary flow reserve , index of microcirculatory resistance
5. What are the complications and prognosis of Coronary flow reserve , index of microcirculatory resistance?
6. What are the latest guidelines for Coronary flow reserve , index of microcirculatory resistance?
7. How is Coronary flow reserve , index of microcirculatory resistance managed in special populations?
8. Compare Coronary flow reserve , index of microcirculatory resistance with related conditions
...
**File:** Coronary_flow_reserve_,_index_of_microcirculatory_resistance.md
