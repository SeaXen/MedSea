<!-- Source: /mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/STEMI_(primary_PCI__90_min,_fibrinolysis_if_PCI__120_min).md | section: 16.16 | hub: cardiac-emergencies -->
...
**Q1.** What is the most common aetiology of STEMI?
...
**Q2.** First-line investigation for STEMI:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for STEMI:
...
**Q4.** Which is a contraindication to therapy in STEMI?
A. Renal dysfunction
...
**Q5.** The most common complication of STEMI is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of STEMI. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with STEMI on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify STEMI
2. Discuss the pathophysiology of STEMI
3. What are the diagnostic criteria for STEMI?
4. Outline the management approach to STEMI
5. What are the complications and prognosis of STEMI?
6. What are the latest guidelines for STEMI?
7. How is STEMI managed in special populations?
8. Compare STEMI with related conditions
