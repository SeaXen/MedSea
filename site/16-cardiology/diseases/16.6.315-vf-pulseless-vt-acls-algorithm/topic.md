...
davidson_topic_id: "16.6.315"
topic: "VF_pulseless_VT_(ACLS_algorithm)"
...
source: "/mnt/tb/Medicine/Cardiology/16_Cardiac_Emergencies/VF_pulseless_VT_(ACLS_algorithm).md"
...
**Q1.** What is the most common aetiology of VF pulseless VT?
...
**Q2.** First-line investigation for VF pulseless VT:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for VF pulseless VT:
...
**Q4.** Which is a contraindication to therapy in VF pulseless VT?
A. Renal dysfunction
...
**Q5.** The most common complication of VF pulseless VT is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of VF pulseless VT. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with VF pulseless VT on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify VF pulseless VT
2. Discuss the pathophysiology of VF pulseless VT
3. What are the diagnostic criteria for VF pulseless VT?
4. Outline the management approach to VF pulseless VT
5. What are the complications and prognosis of VF pulseless VT?
6. What are the latest guidelines for VF pulseless VT?
7. How is VF pulseless VT managed in special populations?
8. Compare VF pulseless VT with related conditions
