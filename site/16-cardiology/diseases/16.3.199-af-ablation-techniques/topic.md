...
davidson_topic_id: "16.3.199"
topic: "AF_ablation_techniques"
...
source: "/mnt/tb/Medicine/Cardiology/08_Arrhythmias/AF_ablation_techniques.md"
...
**Q1.** What is the most common aetiology of AF ablation techniques?
...
**Q2.** First-line investigation for AF ablation techniques:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for AF ablation techniques:
...
**Q4.** Which is a contraindication to therapy in AF ablation techniques?
A. Renal dysfunction
...
**Q5.** The most common complication of AF ablation techniques is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of AF ablation techniques. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with AF ablation techniques on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify AF ablation techniques
2. Discuss the pathophysiology of AF ablation techniques
3. What are the diagnostic criteria for AF ablation techniques?
4. Outline the management approach to AF ablation techniques
5. What are the complications and prognosis of AF ablation techniques?
6. What are the latest guidelines for AF ablation techniques?
7. How is AF ablation techniques managed in special populations?
8. Compare AF ablation techniques with related conditions
...
**File:** AF_ablation_techniques.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
