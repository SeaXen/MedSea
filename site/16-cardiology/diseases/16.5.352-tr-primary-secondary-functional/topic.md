<!-- Source: /mnt/tb/Medicine/Cardiology/05_Valvular_Heart_Disease/TR_primary_secondary_functional.md | section: 16.5 | hub: valvular-heart-disease -->

# TR primary secondary functional
...
**Q1.** What is the most common aetiology of TR primary secondary functional?
...
**Q2.** First-line investigation for TR primary secondary functional:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for TR primary secondary functional:
...
**Q4.** Which is a contraindication to therapy in TR primary secondary functional?
A. Renal dysfunction
...
**Q5.** The most common complication of TR primary secondary functional is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of TR primary secondary functional. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with TR primary secondary functional on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify TR primary secondary functional
2. Discuss the pathophysiology of TR primary secondary functional
3. What are the diagnostic criteria for TR primary secondary functional?
4. Outline the management approach to TR primary secondary functional
5. What are the complications and prognosis of TR primary secondary functional?
6. What are the latest guidelines for TR primary secondary functional?
7. How is TR primary secondary functional managed in special populations?
8. Compare TR primary secondary functional with related conditions
...
**File:** TR_primary_secondary_functional.md
