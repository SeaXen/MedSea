...
davidson_topic_id: "16.3.187"
topic: "Pacemaker_modes_programming_follow_up"
...
source: "/mnt/tb/Medicine/Cardiology/08_Arrhythmias/Pacemaker_modes_programming_follow_up.md"
tags: [medicine, cardiology, davidson, fcps, mrcp]
---

# Pacemaker modes programming follow up
...
**Pacemaker modes programming follow up**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of Pacemaker modes programming follow up?
...
**Q2.** First-line investigation for Pacemaker modes programming follow up:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Pacemaker modes programming follow up:
...
**Q4.** Which is a contraindication to therapy in Pacemaker modes programming follow up?
A. Renal dysfunction
...
**Q5.** The most common complication of Pacemaker modes programming follow up is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Pacemaker modes programming follow up. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Pacemaker modes programming follow up on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Pacemaker modes programming follow up
2. Discuss the pathophysiology of Pacemaker modes programming follow up
3. What are the diagnostic criteria for Pacemaker modes programming follow up?
4. Outline the management approach to Pacemaker modes programming follow up
5. What are the complications and prognosis of Pacemaker modes programming follow up?
6. What are the latest guidelines for Pacemaker modes programming follow up?
7. How is Pacemaker modes programming follow up managed in special populations?
8. Compare Pacemaker modes programming follow up with related conditions
...
**File:** Pacemaker_modes_programming_follow_up.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
