...
davidson_topic_id: "16.3.188"
topic: "CRT_(biventricular_pacing)_optimization"
...
source: "/mnt/tb/Medicine/Cardiology/08_Arrhythmias/CRT_(biventricular_pacing)_optimization.md"
...
**Q1.** What is the most common aetiology of CRT  optimization?
...
**Q2.** First-line investigation for CRT  optimization:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for CRT  optimization:
...
**Q4.** Which is a contraindication to therapy in CRT  optimization?
A. Renal dysfunction
...
**Q5.** The most common complication of CRT  optimization is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of CRT  optimization. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with CRT  optimization on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify CRT  optimization
2. Discuss the pathophysiology of CRT  optimization
3. What are the diagnostic criteria for CRT  optimization?
4. Outline the management approach to CRT  optimization
5. What are the complications and prognosis of CRT  optimization?
6. What are the latest guidelines for CRT  optimization?
7. How is CRT  optimization managed in special populations?
8. Compare CRT  optimization with related conditions
