<!-- Source: /mnt/tb/Medicine/Cardiology/01_Cardiac_Investigations/Cardiac_catheterization_(right_left_heart,_coronary_angiography).md | section: 16.1 | hub: cardiac-investigations -->
...
**Q1.** What is the most common aetiology of Cardiac catheterization?
...
**Q2.** First-line investigation for Cardiac catheterization:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for Cardiac catheterization:
...
**Q4.** Which is a contraindication to therapy in Cardiac catheterization?
A. Renal dysfunction
...
**Q5.** The most common complication of Cardiac catheterization is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of Cardiac catheterization. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with Cardiac catheterization on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify Cardiac catheterization
2. Discuss the pathophysiology of Cardiac catheterization
3. What are the diagnostic criteria for Cardiac catheterization?
4. Outline the management approach to Cardiac catheterization
5. What are the complications and prognosis of Cardiac catheterization?
6. What are the latest guidelines for Cardiac catheterization?
7. How is Cardiac catheterization managed in special populations?
8. Compare Cardiac catheterization with related conditions
...
**File:** Cardiac_catheterization.md
