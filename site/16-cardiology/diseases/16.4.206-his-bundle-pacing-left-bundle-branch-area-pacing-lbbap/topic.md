...
davidson_topic_id: "16.4.206"
topic: "His_bundle_pacing_Left_bundle_branch_area_pacing_LBBAP"
...
source: "/mnt/tb/Medicine/Cardiology/08_Cardiac_Devices_EP/His_bundle_pacing_Left_bundle_branch_area_pacing_LBBAP.md"
tags: [medicine, cardiology, davidson, fcps, mrcp]
---

# His bundle pacing Left bundle branch area pacing LBBAP
...
**His bundle pacing Left bundle branch area pacing LBBAP**: Bradycardia — heart rate <60 bpm in adults. **Sinus** (sinus node dysfunction, vagal, drugs) vs **AV block** (1st, 2nd Mobitz I/II, 3rd, high-grade). **Significant** if symptomatic (syncope, fatigue, dyspnoea, HF) or pauses >3s (awake) or >5s (asleep). **Chronotropic incompetence**: HR fails to rise with exertion. **Sick sinus syndrome**: combination of SSS components.
...
**Q1.** What is the most common aetiology of His bundle pacing Left bundle branch area pacing LBBAP?
...
**Q2.** First-line investigation for His bundle pacing Left bundle branch area pacing LBBAP:
A. ECG
B. Echocardiography
C. Cardiac MRI
...
**Q3.** Most appropriate first-line therapy for His bundle pacing Left bundle branch area pacing LBBAP:
...
**Q4.** Which is a contraindication to therapy in His bundle pacing Left bundle branch area pacing LBBAP?
A. Renal dysfunction
...
**Q5.** The most common complication of His bundle pacing Left bundle branch area pacing LBBAP is:
A. Heart failure
B. Arrhythmia
C. Thromboembolism
D. Death
...
**SBA1.** A 55-year-old presents with features of His bundle pacing Left bundle branch area pacing LBBAP. Most appropriate next step?
A. Discharge
...
**SBA2.** Patient with His bundle pacing Left bundle branch area pacing LBBAP on optimal therapy develops new symptoms. What is the next step?
...
1. Define and classify His bundle pacing Left bundle branch area pacing LBBAP
2. Discuss the pathophysiology of His bundle pacing Left bundle branch area pacing LBBAP
3. What are the diagnostic criteria for His bundle pacing Left bundle branch area pacing LBBAP?
4. Outline the management approach to His bundle pacing Left bundle branch area pacing LBBAP
5. What are the complications and prognosis of His bundle pacing Left bundle branch area pacing LBBAP?
6. What are the latest guidelines for His bundle pacing Left bundle branch area pacing LBBAP?
7. How is His bundle pacing Left bundle branch area pacing LBBAP managed in special populations?
8. Compare His bundle pacing Left bundle branch area pacing LBBAP with related conditions
...
**File:** His_bundle_pacing_Left_bundle_branch_area_pacing_LBBAP.md
**Status:** full-fcps-mrcp-note
**Tags:** #medicine #cardiology #davidson #fcps #mrcp
