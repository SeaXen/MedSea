# Tubulointerstitial Diseases — Drug-Induced Tubulointerstitial Injury

<callout icon="🩺" color="red_bg">
**Topic:** Tubulointerstitial Diseases — Drug-Induced Tubulointerstitial Injury — Nephrology & Urology
...
## 6. Diagnostic Approach for Suspected Drug Injury
...
```mermaid
mindmap
  root((Drug-Induced Tubulointerstitial Injury))
    AIN
      NSAIDs
      Antibiotics[β-lactams, quinolones, rifampicin]
      PPIs
      Diuretics
      Allopurinol
      ICIs
    ...
    Chronic
      ...
      Lithium[DI + CIN]
      Cisplatin[Chronic CIN]
      Tenofovir_TDF[Fanconi]
      Aristolochic_acid[CKD + UCC]
      Heavy_metals
```
