...
## 4. 4. Classification / Occupational Disease Categories
...
```mermaid
flowchart TD
    A[Hazard] --> B[1. Elimination\nMost Effective]
    B --> C[2. Substitution]
    C --> D[3. Engineering Controls]
    D --> E[4. Administrative Controls]
    E --> F[5. PPE\nLeast Reliable]
...
## 5. 5. Diagnosis & Investigations (Exposure Assessment)
...
## 6. 6. Differential Diagnosis (Environmental/Occupational Confusions)
...
## 7. 7. Management (Climate Health & Prevention)
...
```mermaid
mindmap
  root((Environmental & Occupational))
    Environmental
      Air Pollution 7M deaths
      WASH 1.4M
      Lead 1M
      PM2.5, NO2, O3
    Occupational
      750K deaths/yr
      1.8M UK illnesses
      Hierarchy: Eliminate > Substitute > Engineering > Admin > PPE
    Diseases
      Respiratory: Asbestosis, Silicosis, CWP, Asthma
